...
public class ItemLookupNoWildCardListener extends ControllerAdapter {
	...
	public void beforeModelSearched(ControllerEvent event) throws ControllerListenerException {
		...
		try {					
			...
			Expression expr2 = ExpressionUtilities.getNotNullExpression(controller.getFieldName(IEntityAlias.ITEM_SERIAL_NUMBER));
