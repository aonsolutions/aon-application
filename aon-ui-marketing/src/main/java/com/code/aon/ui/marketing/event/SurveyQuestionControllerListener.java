...
public class SurveyQuestionControllerListener extends ControllerAdapter implements IMarketingConstants {
	...
	public void afterBeanCreated(ControllerEvent event)
		...
		try {
			...
			String surveyId = controller.getFieldName(IEntityAlias.SURVEY_QUESTION_SURVEY_ID);
			criteria.addEqualExpression( surveyId, survey.getId() );
			String position = controller.getFieldName(IEntityAlias.SURVEY_QUESTION_POSITION);
