...
public abstract class AbstractDomainMysqlDB extends AbstractMysqlDB  {
	...
	*/
	 ...
	 * @returns domain's ID
	*/
	protected Integer getDomainForPos( Integer customer , Integer department , Integer workplace){
		Integer domain = null;
	 ...
	 * @throws SQLException
	*/
	public int insertPos(Integer department, Integer workplace, String name, String series, Integer customer, Short display_mode, Integer num_rows, Integer num_cols, Boolean pin_pad, String commerce, String signature_password, String terminal, String port_configuration, String pos_version, Boolean active)
	throws SQLException {
		Integer domain = getDomainForPos( customer , department , workplace);
		Integer id =  super.insertPos( domain != null ? domain : getDefaultDomain(), department, workplace, name, series, customer, display_mode, num_rows, num_cols, pin_pad, commerce, signature_password, terminal, port_configuration, pos_version, active );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertPos(Integer domain, Integer department, Integer workplace, String name, String series, Integer customer, Short display_mode, Integer num_rows, Integer num_cols, Boolean pin_pad, String commerce, String signature_password, String terminal, String port_configuration, String pos_version, Boolean active)
	throws SQLException {
		Integer id =  super.insertPos(domain, department, workplace, name, series, customer, display_mode, num_rows, num_cols, pin_pad, commerce, signature_password, terminal, port_configuration, pos_version, active);
		posDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param contract Contrato
	 * @param start_date Fecha de inicio liquidación
	 * @param end_date Fecha de finalizacion liquidación
	 ...
	 * @param issue_date Fecha de emisión
	 * @param remuneration Remuneración mensual
	 ...
	 * @param money_irpf_base Salario en dinero sujeto a retención I.R.P.F
	 * @param inkind_irpf_base Salario en especie sujeto a retención I.R.P.F
	 * @param irpf_base Base sujeta a retención I.R.P.F
	 * @param social_security_contributions Aportaciones a la Seguridad Social
	 * @param total_irpf Total retención aplicada 
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertPos_shift(Integer pos, Short shift, String username, Timestamp start_time, Timestamp end_time, Double initial_amount, String remarks)
	throws SQLException {
		Integer domain = getDomainForPos_shift( pos);
		Integer id =  super.insertPos_shift( domain != null ? domain : getDefaultDomain(), pos, shift, username, start_time, end_time, initial_amount, remarks );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertPos_shift(Integer domain, Integer pos, Short shift, String username, Timestamp start_time, Timestamp end_time, Double initial_amount, String remarks)
	throws SQLException {
		Integer id =  super.insertPos_shift(domain, pos, shift, username, start_time, end_time, initial_amount, remarks);
		pos_shiftDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertRsupplier(Integer domain, Integer registry, Integer supplier, String target_external_code, Integer tariff, Integer pay_method, Integer number_of_pymnts, Integer days_to_first_pymnt, Integer days_between_pymnts, String pymnt_days, Integer bank, String bank_account)
	throws SQLException {
		Integer id =  super.insertRsupplier(domain, registry, supplier, target_external_code, tariff, pay_method, number_of_pymnts, days_to_first_pymnt, days_between_pymnts, pymnt_days, bank, bank_account);
		rsupplierDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertCertifica2_batch_detail(Integer certifica2_batch, Integer contract, String suspension_cause_code)
	throws SQLException {
		Integer domain = getDomainForCertifica2_batch_detail( certifica2_batch , contract);
		Integer id =  super.insertCertifica2_batch_detail( domain != null ? domain : getDefaultDomain(), certifica2_batch, contract, suspension_cause_code );
		if ( domain != null ) { 
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertCertifica2_batch_detail(domain, certifica2_batch, contract, suspension_cause_code);
		certifica2_batch_detailDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param issue_date Fecha de emisión
	 * @param annual_remuneration Retribuciones totales (dinerarias y en especie). Importe íntegro
	 * @param irregular_18_2_reduction Reducciones por irregularidad ( Atr. 18.2 LIRPF)
	 * @param irregular_18_3_reduction Reducciones por irregularidad ( Atr. 18.3: Disposiciones transitorias 11ª y 12 ª de la LIRPF)
	 * @param deduccibles_expenses Gastos deducibles ( Atr 19.2, letras a, b y c de la LINRPF: Seguridad Social, Mutualidades ...)
	 * @param spousal_support Pension compensatoria a favor del cónyuge. Importe fijado judicialmente
	 * @param food_annuity Anualidades por alimentos en favor de los hijos. Importe fijado judicialmente
	 * @param deduct_home_loan Comunicación de pagos por la adquisión o rehabilitación de la vivienda habitual utilizando financiación ajena
	 * @param request_irpf Tipo de retención solicitado
	 * @param contract_type Contrato o relación
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertNewsletter(String name, Timestamp date, Short layout, Boolean active, String subject, Integer scope, Boolean highlightFirst, Integer template)
	throws SQLException {
		Integer domain = getDomainForNewsletter( template , scope);
		Integer id =  super.insertNewsletter( domain != null ? domain : getDefaultDomain(), name, date, layout, active, subject, scope, highlightFirst, template );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertNewsletter(Integer domain, String name, Timestamp date, Short layout, Boolean active, String subject, Integer scope, Boolean highlightFirst, Integer template)
	throws SQLException {
		Integer id =  super.insertNewsletter(domain, name, date, layout, active, subject, scope, highlightFirst, template);
		newsletterDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param rbank Identificador de la Cuenta Bancaria de la Compañia
	 * @returns domain's ID
	*/
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertProject_attach(Integer project, Short mimeType, String description, Blob data, Short security_level, Date attach_date)
	throws SQLException {
		Integer domain = getDomainForProject_attach( project);
		Integer id =  super.insertProject_attach( domain != null ? domain : getDefaultDomain(), project, mimeType, description, data, security_level, attach_date );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertProject_attach(Integer domain, Integer project, Short mimeType, String description, Blob data, Short security_level, Date attach_date)
	throws SQLException {
		Integer id =  super.insertProject_attach(domain, project, mimeType, description, data, security_level, attach_date);
		project_attachDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param title Cargo
	 * @param organizationAddress Dirección de la Organización
	 * @param organizationPostalCode Codigo postal de la Organización
	 * @param organizationCity Localidad de la Organización
	 * @param organizationState Estado de la Organización
	 * @param organizationPhone Telefono de la Organización
	 * @param organizationFax Fax de la Organización
	 * @param web Web
	 * @returns auto-generated key
	 * @throws SQLException
	*/
	...
	*/
	 ...
	 * @param start_date Fecha de inicio 
	 * @param end_date Fecha de finalizacion
	 * @param month Mes de la deducción
	 * @returns auto-generated key
	 * @throws SQLException
	*/
	...
	*/
	 ...
	 * @returns domain's ID
	*/
	protected Integer getDomainForPurchase( Integer bank , Integer carrier , Integer pay_method , Integer project , Integer address , Integer scope , Integer supplier , Integer workplace){
		Integer domain = null;
			if ( ( domain = getDomainForBankPk( bank ) ) != null )
				return domain;
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertPurchase(domain, project, supplier, series, number, address, discount_expr, issue_date, pay_method, document_type, security_level, status, comments, remarks, workplace, scope, number_of_pymnts, days_to_first_pymnt, days_between_pymnts, pymnt_days, bank, bank_account, email_communication, carrier, shipping_alternative_address, shipping_alternative_address2, shipping_alternative_zip, shipping_alternative_city, shipping_alternative_phone, shipping_alternative_recipient, shipping_contact, shipping_period);
		purchaseDomains.put(id, domain );
		return id;
	}
	...
	*/
	...
	/**
	 * Fs_renting
	 * @param rbank Banco de la Compañia
	 * @returns domain's ID
	*/
	...
	*/
	 ...
	 * @param children Numero de niños
	...
	*/
	 ...
	 * @param id Identificador unico
	 * @param contract Identificador del contrato
	 * @param reason Causa de regularización
	 * @param effective_date Fecha de entrada en vigor
	 * @param paid_irpf Retenciones practicadas con anterioridad a la regularización.
	 * @param paid_remuneration Retribuciones ya satisfechas con anterioridad a la regularización.
	 * @param prior_annual_irpf Retenciones anuales anteriores a la regularización.
	 * @param prior_annual_remuneration Retribucines anulaes consideradas con anterioridad a la regularización.
	 * @param prior_base_irpf Base para calcular el tipo de retención determinado antes de la regularización.
	 * @param prior_irpf Tipo de retención aplicado antes de la regularización.
	 * @param prior_in_ceuta_melilla Los rendimientos anteriores a la regularización fueron obtenidos en Ceuta o Melilla
	 * @param prior_minimun_personal_family Mínimo personal y familiar para calcular el tipo de retención determinado antes de la regularización.
	 * @param prior_deduct_home_loan En algún momento antes de la regularización se aplico la minoración por pagos por la adquisión o rehabilitación de la vivienda
	 * @param prior_deduct_home_loan_amount Importe de la minoración por pagos por la adquisión o rehabilitación de la vivienda antes de la regularización
	 * @returns auto-generated key
	 * @throws SQLException
	*/
	...
	*/
	...
	/**
	 * Cashflow_forecast
	 * @param rbank Identificador de Banco de la Compañia
	 * @returns domain's ID
	*/
	...
	*/
	...
	throws SQLException {
		...
		Integer id =  super.insertIncome( domain != null ? domain : getDefaultDomain(), project, reference_code, supplier, address, issue_time, pay_method, security_level, status, comments, remarks, workplace, scope, number_of_pymnts, days_to_first_pymnt, days_between_pymnts, pymnt_days, bank, bank_account );
		if ( domain != null ) { 
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertIncome(domain, project, reference_code, supplier, address, issue_time, pay_method, security_level, status, comments, remarks, workplace, scope, number_of_pymnts, days_to_first_pymnt, days_between_pymnts, pymnt_days, bank, bank_account);
		incomeDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param contract Identificador del contrato
	 * @param effective_date Fecha de entrada en vigor
	 * @param base_irpf Base para calcular el tipo de retención
	 * @param minimun_personal_family Mínimo personal y familiar para calcular el tipo de retención
	 * @param deduct_home_loan_amount Minoración por pagos de préstamo para vivienda habitual
	 * @param deduct_80_bis Deduccion Arttículo 80 bis LIRPF
	 * @param irpf Tipo retención apliclabe 
	 * @param annual_irpf Importe anual de las retenciones e ingresos a cuenta
	 * @param annual_remuneration Retribuciones anuales. Importe íntegro
	 * @param irregular_18_2_reduction Reducciones por irregularidad ( Art. 18.2 LIRPF). Importe
	 * @param irregular_18_3_reduction Reducciones por irregularidad ( Art. 18.3: DD.TT 11ª y 12 ª de la LIRPF). Importe
	 ...
	 * @param work_prolongation_reduction Reducciones por prolongación de la actividad 
	 ...
	 * @param two_or_more_descendents_min Por tener más de dos descendientes con derecho a mínimo
	 * @param spousal_support Pension compensatoria a favor del cónyuge. Importe anual
	 * @param food_annuity Anualidades por alimentos en favor de los hijos. Importe anual
	 * @param minimun_personal Mínimo personal
	 * @param minimun_ascendents Mínimo por descendientes
	 * @param minimun_descendents Mínimo por descendientes
	 * @param minimun_disability Mínimo por discapacidad
	 * @param descendents_minor_3_total Descendientes computados menores de tres años. Total
	 * @param descendents_minor_3_entirely Descendientes computados menores de tres años. Por entero
	 ...
	 * @param descendents_first Detalle del cómputo de descendientes. Hijo 1º
	 * @param descendents_second Detalle del cómputo de descendientes. Hijo 2º
	 * @param descendents_third Detalle del cómputo de descendientes. Hijo 3º
	 * @param descendents_fourth_subsequent_total Detalle del cómputo de descendientes. Hijo 4º y sucesivos. Total
	 * @param descendents_fourth_subsequent_entirely Detalle del cómputo de descendientes. Hijo 4º y sucesivos. Por entero
	 * @param ascendents_minor_75_total Ascendientes computados menores de 75 años. Total
	 * @param ascendents_minor_75_entirely Ascendientes computados menores de 75 años. Por entero
	 * @param ascendents_mayor_75_total Ascendientes computados mayores de 75 años. Total
	 * @param ascendents_mayor_75_entirely Ascendientes computados mayores de 75 años. Por entero
	...
	*/
	 ...
	 * @param incoming_security Seguridad de conexión del correo entrante
	 ...
	 * @param outgoing_security Seguridad de conexión del correo saliente
	...
	*/
	...
	/**
	 * Contact
	 * @param contact_data Identificador de la Información del Contacto
	 * @param user_id Identificador del Usuario
	 * @returns domain's ID
	*/
	...
	*/
	...
	/**
	 * Campaign
	 * @param campaign_type Identificador del Tipo de Campaña
	 * @param process Identificador del Proceso
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertContrata_batch(Timestamp date, Short status, Short type)
	throws SQLException {
		Integer domain = getDomainForContrata_batch();
		Integer id =  super.insertContrata_batch( domain != null ? domain : getDefaultDomain(), date, status, type );
		if ( domain != null ) { 
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertContrata_batch(domain, date, status, type);
		contrata_batchDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param id Identificador unico
	 * @param salary Recibo del pago de salarios
	 * @param type Tipo de deducción Salarial
	...
	*/
	 ...
	 * @returns domain's ID
	*/
	protected Integer getDomainForInvoice( Integer rectification_invoice , Integer pos_shift , Integer project , Integer raddress , Integer registry , Integer scope , Integer seller){
		Integer domain = null;
	...
	*/
	...
	throws SQLException {
		...
		Integer id =  super.insertContract( domain != null ? domain : getDefaultDomain(), person, workplace, enterprise_ccc, start_date, end_date, calendar, description, sepe_status, registration, seniority_date, enterprise_activity, ss_regime, agreement_level_category, model, category_description, ss_status );
		if ( domain != null ) { 
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertContract(domain, person, workplace, enterprise_ccc, start_date, end_date, calendar, description, sepe_status, registration, seniority_date, enterprise_activity, ss_regime, agreement_level_category, model, category_description, ss_status);
		contractDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @throws SQLException
	*/
	public int insertSepe_batch_attach(Integer source_batch, Short source_type, Short mimeType, String description, Blob data, Short type, Integer scope, Date attach_date)
	throws SQLException {
		Integer domain = getDomainForSepe_batch_attach( scope);
		Integer id =  super.insertSepe_batch_attach( domain != null ? domain : getDefaultDomain(), source_batch, source_type, mimeType, description, data, type, scope, attach_date );
		if ( domain != null ) { 
	...
	*/
	...
	throws SQLException {
		Integer id =  super.insertSepe_batch_attach(domain, source_batch, source_type, mimeType, description, data, type, scope, attach_date);
		sepe_batch_attachDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @returns domain's ID
	*/
	protected Integer getDomainForRitem( Integer item , Integer registry){
		Integer domain = null;
			if ( ( domain = getDomainForItemPk( item ) ) != null )
				return domain;
			if ( ( domain = getDomainForRegistryPk( registry ) ) != null )
	 ...
	 * @throws SQLException
	*/
	public int insertRitem(Integer registry, Integer item, Short status)
	throws SQLException {
		Integer domain = getDomainForRitem( item , registry);
		Integer id =  super.insertRitem( domain != null ? domain : getDefaultDomain(), registry, item, status );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertRitem(Integer domain, Integer registry, Integer item, Short status)
	throws SQLException {
		Integer id =  super.insertRitem(domain, registry, item, status);
		ritemDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @returns domain's ID
	*/
	protected Integer getDomainForHotel( Integer item_advance , Integer item_no_show , Integer item_penalty , Integer scope , Integer service_catalogue , Integer workplace){
		Integer domain = null;
	 ...
	 * @throws SQLException
	*/
	public int insertHotel(String code, Integer scope, Integer workplace, String phone, String fax, String email, String web, Integer service_catalogue, Integer item_advance, Integer item_no_show, Integer item_penalty, Short sheet_changing, Boolean active)
	throws SQLException {
		Integer domain = getDomainForHotel( item_advance , item_no_show , item_penalty , scope , service_catalogue , workplace);
		Integer id =  super.insertHotel( domain != null ? domain : getDefaultDomain(), code, scope, workplace, phone, fax, email, web, service_catalogue, item_advance, item_no_show, item_penalty, sheet_changing, active );
		if ( domain != null ) { 
	 ...
	 * @throws SQLException
	*/
	public int insertHotel(Integer domain, String code, Integer scope, Integer workplace, String phone, String fax, String email, String web, Integer service_catalogue, Integer item_advance, Integer item_no_show, Integer item_penalty, Short sheet_changing, Boolean active)
	throws SQLException {
		Integer id =  super.insertHotel(domain, code, scope, workplace, phone, fax, email, web, service_catalogue, item_advance, item_no_show, item_penalty, sheet_changing, active);
		hotelDomains.put(id, domain );
		return id;
	}
	...
	*/
	 ...
	 * @param passwordExpiration Fecha de Expiracion de la Contraseña
	 ...
	 * @param initAction Nombre la acicón de inicio del Usuario
	 * @returns auto-generated key
	 * @throws SQLException
	*/
