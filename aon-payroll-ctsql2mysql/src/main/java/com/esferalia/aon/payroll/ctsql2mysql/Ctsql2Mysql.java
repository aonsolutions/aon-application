...
public class Ctsql2Mysql {
	...
	protected boolean parseArgs(String[] args) {
		...
		OptionBuilder.withType(String.class);
		OptionBuilder.withDescription("traspasar �nicamente estas empresas");
		...
		OptionBuilder.withType(String.class);
		OptionBuilder.withDescription("clave gen�rica para todos los usuarios");
		...
		OptionBuilder
				.withDescription("Tablas de ctsql que lanzan la sincronizaci�n ( s�lo para el demonio ). ");
		...
		OptionBuilder.withValueSeparator((char) 0);
		OptionBuilder
				.withDescription("Comandos despues de la sincronizaci�n ( s�lo para el demonio ). ");
		Option commandsOption = OptionBuilder.create("command");

		OptionBuilder.isRequired(false);
		OptionBuilder.hasArg(false);
		OptionBuilder
				.withDescription("A�adir a la base de datos existente. No borrar la base de datos.");
