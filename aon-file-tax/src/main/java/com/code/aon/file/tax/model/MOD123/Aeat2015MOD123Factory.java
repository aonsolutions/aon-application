...
public class Aeat2015MOD123Factory implements IMOD123Factory {
	...
	private class Aeat2011MOD115 extends AbstractFileFiller {
		...
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD123/2015_AEAT_Declaration.xml";
		...
		public Aeat2011MOD115(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			...
			InputStream input = MOD123.class.getResourceAsStream(DECLARATION_METADATA);
