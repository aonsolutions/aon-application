...
public class Aeat2015MOD130Factory implements IMOD130Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2015MOD130 fileFiller = new Aeat2015MOD130(declarations,pw);
	...
	private class Aeat2015MOD130 extends AbstractFileFiller {
		private static final String DECLARATION = "Declaration";
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD130/2015_AEAT_Declaration.xml";
		
		
		private List<Declaration> declarations;
		
		public Aeat2015MOD130(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
