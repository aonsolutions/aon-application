...
public class Aeat2013MOD311Factory implements IMOD311Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2013MOD311 fileFiller = new Aeat2013MOD311(declarations,pw);
	...
	private class Aeat2013MOD311 extends AbstractFileFiller {
		private static final String DECLARATION = "Declaration";
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD311/2013_AEAT_Declaration.xml";
		
		
		private List<Declaration> declarations;
		
		public Aeat2013MOD311(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
			if (declarations == null || declarations.size() == 0)  {
				throw new IllegalArgumentException("Declaration can not be null!");
			}
			this.declarations = declarations;
			InputStream input = MOD311.class.getResourceAsStream(DECLARATION_METADATA);
