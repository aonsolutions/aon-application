...
public class Aeat2013MOD131Factory implements IMOD131Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2013MOD131 fileFiller = new Aeat2013MOD131(declarations,pw);
	...
	private class Aeat2013MOD131 extends AbstractFileFiller {
		private static final String DECLARATION = "Declaration";
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD131/2013_AEAT_Declaration.xml";
		
		
		private List<Declaration> declarations;
		
		public Aeat2013MOD131(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
			if (declarations == null || declarations.size() == 0)  {
				throw new IllegalArgumentException("Declaration can not be null!");
			}
			this.declarations = declarations;
			InputStream input = MOD131.class.getResourceAsStream(DECLARATION_METADATA);
