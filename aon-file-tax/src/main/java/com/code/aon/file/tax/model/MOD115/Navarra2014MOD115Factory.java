...
public class Navarra2014MOD115Factory implements IMOD115Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Navarra2014MOD115 fileFiller = new Navarra2014MOD115(declarations,pw);
	...
	private class Navarra2014MOD115 extends AbstractFileFiller {
		private static final String DECLARATION = "Declaration";
		private static final String DECLARATION1 = "Declaration1";
		private static final String DECLARATION1_METADATA = "/com/code/aon/file/tax/model/MOD115/2014_NAVARRA_Declaration1.xml";
		private static final String DECLARATION2 = "Declaration2";
		private static final String DECLARATION2_METADATA = "/com/code/aon/file/tax/model/MOD115/2014_NAVARRA_Declaration2.xml";
		private static final String DECLARATION3 = "Declaration3";
		private static final String DECLARATION3_METADATA = "/com/code/aon/file/tax/model/MOD115/2014_NAVARRA_Declaration3.xml";
		
		
		private List<Declaration> declarations;
		
		public Navarra2014MOD115(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
