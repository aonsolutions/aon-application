...
public class Alava2011MOD115Factory implements IMOD115Factory {
	...
	private void addModelo(Element dec, Declaration declaration) {
		...
		addClave(mod, 9,declaration.getBoxes().get(Mod115Key.C09.getValue()));
		addClave(mod,10,declaration.getBoxes().get(Mod115Key.C10.getValue()));
		addClave(mod,11,declaration.getBoxes().get(Mod115Key.C11.getValue()));
	}
