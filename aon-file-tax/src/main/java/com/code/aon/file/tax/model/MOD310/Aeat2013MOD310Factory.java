...
public class Aeat2013MOD310Factory implements IMOD310Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2013MOD310 fileFiller = new Aeat2013MOD310(declarations,pw);
	...
	private class Aeat2013MOD310 extends AbstractFileFiller {
		private static final String DECLARATION = "Declaration";
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD310/xml/2013_AEAT_Declaration.xml";
		
		
		private List<Declaration> declarations;
		
		public Aeat2013MOD310(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
			if (declarations == null || declarations.size() == 0)  {
				throw new IllegalArgumentException("Declaration can not be null!");
			}
			this.declarations = declarations;
			InputStream input = MOD310.class.getResourceAsStream(DECLARATION_METADATA);
