...
public class Bizkaia2015MOD303Factory implements IMOD303Factory {
	@Override
	...
	private class Bizkaia2012MOD303 extends AbstractFileFiller {
		...
		private static final String HEADER_METADATA = "/com/code/aon/file/tax/model/MOD303/2015_BIZKAIA_R01.xml";
		private static final String BANK_DATA = "BankData";
		private static final String BANK_DATA_METADATA = "/com/code/aon/file/tax/model/MOD303/2015_BIZKAIA_RA3.xml";
		private static final String DEPONENT = "Deponent";
		private static final String DEPONENT_METADATA = "/com/code/aon/file/tax/model/MOD303/2015_BIZKAIA_R05.xml";
		...
		private List<Entry> getEntries(Declaration d) {
			...
			// IVA DEVENGADO
			// *************
			String[] percents = new String[]{"4.0","10.0","21.0"};
			...
			percents = new String[]{"0.5","1.4","5.2","1.75"};
			...
			entries.add( new Entry().setCode(46).setType(EntryType.IM).setAmountD( 0.0 ));
			entries.add( new Entry().setCode(47).setType(EntryType.IM).setAmountD( 0.0 ));
			...
			percents = new String[]{"4.0","10.0","21.0","?"};
