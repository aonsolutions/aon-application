...
<xsl:stylesheet version="1.0"
  ...
  <xsl:param name="today">11/05/2006</xsl:param>
  ...
  <xsl:attribute-set name="page-footer">
    ...
    <xsl:attribute name="border-top">solid black 0.50pt</xsl:attribute>
  ...
  <xsl:attribute-set name="hr">
    <xsl:attribute name="border">0.2px inset</xsl:attribute>
    <xsl:attribute name="space-before">0.20em</xsl:attribute>
    <xsl:attribute name="space-after">0.40em</xsl:attribute>
  </xsl:attribute-set>
...
-->
  ...
  <xsl:attribute-set name="ul-label-3">
    <xsl:attribute name="font-weight">bold 0.9em</xsl:attribute>
...
-->
  ...
  <xsl:template match="html:body">
	...
	<fo:table table-layout="fixed" width="103%" 
...
-->
  ...
  <xsl:template match="html:form | html:dir | html:menu">
  ...
  <xsl:template match="html:fieldset">
      <fo:block space-before="1em" space-after="1em" >
      	<xsl:value-of select="./html:legend" />
