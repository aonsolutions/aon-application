...
public class IngenetDataSource {
	...
	private static IngenetDataSource DS;
	...
	private IngenetDataSource() {
	}

	public static IngenetDataSource getInstance() throws AonConnectionException {
		synchronized (INSTANCE_MONITOR) {
			if (DS == null) {
				DS = new IngenetDataSource();
			}
		}
		return DS;
	}
	...
	private DataSource createDatasource(String schema) throws AonConnectionException {
		try {
			IngenetConnectionInfo ci = IngenetConnectionInfo.getDefaultConnectionInfo();
