...
public interface IAccountBridgeAlias {
	...
	/** 
	* DAOConstantsEntry for AccountEntryBankStatement entity.
	*/ 
	DAOConstantsEntry ACCOUNT_ENTRY_BANK_STATEMENT_ENTRY = DAOConstants.getDAOConstant(AccountEntryBankStatement.class);

	/** 
	* Alias value: AccountEntryBankStatement_accountEntry_id
	* Hibernate value: AccountEntryBankStatement.accountEntry.id
	*/
	String  ACCOUNT_ENTRY_BANK_STATEMENT_ACCOUNT_ENTRY_ID = ACCOUNT_ENTRY_BANK_STATEMENT_ENTRY.getAliasNames()[0];

	/** 
	* Alias value: AccountEntryBankStatement_bankStatement_id
	* Hibernate value: AccountEntryBankStatement.bankStatement.id
	*/
	String  ACCOUNT_ENTRY_BANK_STATEMENT_BANK_STATEMENT_ID = ACCOUNT_ENTRY_BANK_STATEMENT_ENTRY.getAliasNames()[1];

	/** 
	* Alias value: AccountEntryBankStatement_id
	* Hibernate value: AccountEntryBankStatement.id
	*/
	String  ACCOUNT_ENTRY_BANK_STATEMENT_ID = ACCOUNT_ENTRY_BANK_STATEMENT_ENTRY.getAliasNames()[2];
	...
	*/
	...
	/** 
	* DAOConstantsEntry for BankConceptAccount entity.
	*/ 
	DAOConstantsEntry BANK_CONCEPT_ACCOUNT_ENTRY = DAOConstants.getDAOConstant(BankConceptAccount.class);

	/** 
	* Alias value: BankConceptAccount_account_id
	* Hibernate value: BankConceptAccount.account.id
	*/
	String  BANK_CONCEPT_ACCOUNT_ACCOUNT_ID = BANK_CONCEPT_ACCOUNT_ENTRY.getAliasNames()[0];

	/** 
	* Alias value: BankConceptAccount_bankConcept_id
	* Hibernate value: BankConceptAccount.bankConcept.id
	*/
	String  BANK_CONCEPT_ACCOUNT_BANK_CONCEPT_ID = BANK_CONCEPT_ACCOUNT_ENTRY.getAliasNames()[1];

	/** 
	* Alias value: BankConceptAccount_id
	* Hibernate value: BankConceptAccount.id
	*/
	String  BANK_CONCEPT_ACCOUNT_ID = BANK_CONCEPT_ACCOUNT_ENTRY.getAliasNames()[2];
