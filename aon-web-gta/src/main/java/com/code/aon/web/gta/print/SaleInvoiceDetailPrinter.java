package com.code.aon.web.gta.print;
...
public class SaleInvoiceDetailPrinter {

	private static final Logger LOGGER = Logger.getLogger(SaleInvoiceDetailPrinter.class.getName());

	public SaleInvoiceDetailPrinter getInstance() {
		return new SaleInvoiceDetailPrinter();
	}
