...
public class OCRFieldJSON {
	...
	public static JSONObject to(OCRField field) {
		...
		return new JSONObject()
			.putOpt(OCRNames.NAME, field.getName().orElse(null))
			.putOpt(OCRNames.PREFIX, field.getPrefix().orElse(null))
			.putOpt(OCRNames.INDEX, field.getIndex().orElse(null))
			.putOpt(OCRNames.GROUP_INDEX, field.getGroupIndex().orElse(null))
			.putOpt(OCRNames.SPLIT_INDEX, field.getSplitIndex().orElse(null))
		;
	}
}
