...
public class TrainningBases2019Update implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainningBases2019Update TRAINNINGBASES2019UPDATE = new TrainningBases2019Update();

	private TrainningBases2019Update() {
	}
