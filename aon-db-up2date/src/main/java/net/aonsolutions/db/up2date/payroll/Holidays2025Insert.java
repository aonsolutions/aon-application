...
public class Holidays2025Insert implements Update {

	public static final Holidays2025Insert HOLIDAYS2025INSERT = new Holidays2025Insert();
	
	private Holidays2025Insert() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( config -> {
			...
			InputStreamReader holidys2025In = 
			new InputStreamReader(Holidays2025Insert.class.getResourceAsStream("holidays2025.csv"), StandardCharsets.UTF_8); 
			Scanner scanner = new Scanner(holidys2025In).useDelimiter(Pattern.compile("\\s*[,\\n]\\s*"));
