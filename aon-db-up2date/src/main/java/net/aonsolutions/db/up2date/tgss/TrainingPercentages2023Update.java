...
public class TrainingPercentages2023Update implements Update {

	private static final int DOMAIN = -101;

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainingPercentages2023Update TRAINNINGPERCENTAGES2023UPDATE = new TrainingPercentages2023Update();

	private TrainingPercentages2023Update() {
	}
