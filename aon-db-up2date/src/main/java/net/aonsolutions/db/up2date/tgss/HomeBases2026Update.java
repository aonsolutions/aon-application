...
public class HomeBases2026Update implements Update {

	public static final HomeBases2026Update HOMEBASES2026UPDATE = new HomeBases2026Update();
	...
	public void upgrade(Connection connection) {
		...
		.set(SYSTEM_DATA.START_DATE, DSL.date(start2026Date))
