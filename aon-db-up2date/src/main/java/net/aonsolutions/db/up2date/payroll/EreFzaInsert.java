...
public class EreFzaInsert implements Update {

	public static final EreFzaInsert EREFZAINSERT = new EreFzaInsert();
	
	private EreFzaInsert() {
	}
	...
	public void upgrade(Connection connection) {
		...
		.and(PAYMENT_CONCEPT.CODE.eq("ERE_FZA"))
		) >= 1;
		...
		dslContext.transaction( (config) -> {
			...
			.set(PAYMENT_CONCEPT.CODE, "ERE_FZA")
			.returning()
			.fetchOne()
			.getId();
