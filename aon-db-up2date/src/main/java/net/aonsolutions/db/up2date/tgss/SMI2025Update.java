...
public class SMI2025Update implements Update {

	public static SMI2025Update SMI2025UPDATE = new SMI2025Update();

	private static final String SMI = "SMI";
	
	private SMI2025Update() {
		super();
	}
	...
	public void upgrade(Connection connection) {
		...
		UpdateConditionStep<SystemDataRecord> close2024SMI = 
		dslContext
		.update(SYSTEM_DATA)
		...
		InsertSetMoreStep<SystemDataRecord> insert2025SMI = 
		dslContext
		...
		.set(SYSTEM_DATA.EXPRESSION, "1184.00" )
		...
		dslContext.transaction( config -> {
			...
			close2024SMI.execute();
			insert2025SMI.execute();
