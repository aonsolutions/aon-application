...
public class EnterpriseDataAddAudit implements Update {
	
	public static final EnterpriseDataAddAudit ENTERPRISE_DATA_ADD_AUDIT = new EnterpriseDataAddAudit();

	private EnterpriseDataAddAudit() {
		super();
	}
	...
	public void upgrade(Connection connection) {
		...
		String sql = "ALTER TABLE `enterprise_data` "
		...
		String sql2 = "ALTER TABLE `enterprise_data` "
			+ "ADD COLUMN `creation_date` datetime DEFAULT NULL COMMENT 'Fecha de creacion'";
		String sql3 = "ALTER TABLE `enterprise_data` "
		...
		String sql4 = "ALTER TABLE `enterprise_data` "
