...
public class TrainingBases2018Fix implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainingBases2018Fix TRAININGBASES2018FIX = new TrainingBases2018Fix();
	
	private TrainingBases2018Fix() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( (config) -> {
			...
			updateFOGASACosts.execute();
			updateFPCosts.execute();
