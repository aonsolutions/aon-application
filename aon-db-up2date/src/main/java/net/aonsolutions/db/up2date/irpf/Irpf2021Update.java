...
public class Irpf2021Update implements Update {
	...
	public static Irpf2021Update IRPF2021UPDATEII = new Irpf2021Update();
	
	private Irpf2021Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		.update(GEOZONE_IRPF)
		.set(GEOZONE_IRPF.END_DATE, _2020EndDate)
