...
public class TrainingPercentages2024Update implements Update {

	private static final int DOMAIN = -101;

	public static final TrainingPercentages2024Update TRAINNINGPERCENTAGES2023UPDATE = new TrainingPercentages2024Update();

	private TrainingPercentages2024Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( config -> {
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2024Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGP > 0.00 ? 1323.00 * (isdef PORCENTAJE_DESMPL ? PORCENTAJE_DESMPL : PORCENTAJE_DESMPL=1.55)/100 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 1323.00 * (isdef PORCENTAJE_DESMPL_E ? PORCENTAJE_DESMPL_E : PORCENTAJE_DESMPL_E=5.50)/100 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
