...
public class BasesMin2024Update implements Update {

	public static BasesMin2024Update BASESMIN2024UPDATE = new BasesMin2024Update();
	...
	public void upgrade(Connection connection) {
		...
		InsertOnDuplicateStep<SystemDataRecord> insert2024ProvisionalBases = 
		dslContext
		...
		, "1260.00", "("+PROVISIONAL_BASES+" ? 1323.00 : 1260.00)")	// 4,5,6,7
		,   "42.00", "("+PROVISIONAL_BASES+" ? 44.10 : 42.00)")		// 8,9,10,11
		,	 
		...
		dslContext.transaction( (config) -> {
			...
			insert2024ProvisionalBases.execute();
