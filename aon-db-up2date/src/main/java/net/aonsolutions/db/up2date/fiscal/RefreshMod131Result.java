...
public class RefreshMod131Result implements Update {
	
	public static final RefreshMod131Result REFRESH_MOD131_RESULT = new RefreshMod131Result();

	private RefreshMod131Result() {
	}
