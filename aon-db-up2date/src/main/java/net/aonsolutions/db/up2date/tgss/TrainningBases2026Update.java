...
public class TrainningBases2026Update implements Update {

	public static final TrainningBases2026Update TRAINNINGBASES2026UPDATE = new TrainningBases2026Update();
	...
	public void upgrade(Connection connection) {
		...
		UpdateConditionStep<SystemDataRecord> close2025CgcBasesMin =
		dslContext
		.update(SYSTEM_DATA)
