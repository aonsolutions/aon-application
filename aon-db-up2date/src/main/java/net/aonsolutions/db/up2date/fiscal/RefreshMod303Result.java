...
public class RefreshMod303Result implements Update {
	
	public static final RefreshMod303Result REFRESH_MOD303_RESULT = new RefreshMod303Result();

	private RefreshMod303Result() {
	}
