...
public class TrainingPercentages2021Update implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainingPercentages2021Update TRAINNINGPERCENTAGES2021UPDATE = new TrainingPercentages2021Update();

	private TrainingPercentages2021Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( (config) -> {
			...
			.set(SYSTEM_COST.EXPRESSION, "3.46" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
