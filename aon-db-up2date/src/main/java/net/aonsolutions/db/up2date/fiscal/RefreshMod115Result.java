...
public class RefreshMod115Result implements Update {
	
	public static final RefreshMod115Result REFRESH_MOD115_RESULT = new RefreshMod115Result();

	private RefreshMod115Result() {
	}
