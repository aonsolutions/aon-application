...
public class TrainningPercentages2019Update implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainningPercentages2019Update TRAINNINGPERCENTAGES2019UPDATE = new TrainningPercentages2019Update();

	private TrainningPercentages2019Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		boolean	upgraded =
			...
			.and(SYSTEM_COST.END_DATE.isNull())) == 0;
