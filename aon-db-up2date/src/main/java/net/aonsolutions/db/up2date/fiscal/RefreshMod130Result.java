...
public class RefreshMod130Result implements Update {
	
	public static final RefreshMod130Result REFRESH_MOD130_RESULT = new RefreshMod130Result();

	private RefreshMod130Result() {
	}
