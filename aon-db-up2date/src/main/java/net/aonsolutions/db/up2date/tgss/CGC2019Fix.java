...
public class CGC2019Fix implements Update {

	private static final String PORCENTAJE_CORTA_DURACION = "PORCENTAJE_CORTA_DURACION";

	public static final CGC2019Fix CGC2019FIX = new CGC2019Fix();
