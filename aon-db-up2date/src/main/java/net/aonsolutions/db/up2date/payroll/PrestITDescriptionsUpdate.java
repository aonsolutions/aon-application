...
public class PrestITDescriptionsUpdate implements Update {

	public static final PrestITDescriptionsUpdate PRESTITDESCRIPTIONSUPDATE = new PrestITDescriptionsUpdate();
	
	private PrestITDescriptionsUpdate() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( (config) -> {
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_COMUN_4_15} DÍAS DE IT POR EC DEL 4º AL 15º DÍA")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(prestItConceptId))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_COMUN_16_20} DÍAS DE IT POR EC DEL 16º AL 20º DÍA")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(prestItConceptId))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_COMUN_21} DÍAS DE IT POR EC A PARTIR DE 21º DÍA")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(prestItConceptId))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_COMUN_CARENCIA} DÍAS DE IT POR EC PERIODO DE CARENCIA")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(prestItConceptId))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_PROFESIONAL} DÍAS DE IT POR AT/EP")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(prestItConceptId))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_COMUN_366} DÍAS DE IT POR EC PAGO DIRECTO")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			...
			dslContext
			.update(SYSTEM_PAYMENT)
			.set(SYSTEM_PAYMENT.DESCRIPTION, "@{DIAS_ENFERMEDAD_PROFESIONAL_366} DÍAS DE IT POR AT/EP PAGO DIRECTO")
			.where(SYSTEM_PAYMENT.DOMAIN.eq(0))
			.and(SYSTEM_PAYMENT.PAYMENT_CONCEPT.eq(pagoDirectoConceptId))
