...
public class FellowsPercentages2025Update implements Update {

	private static final int DOMAIN = -105;

	public static final FellowsPercentages2025Update FELLOWSPERCENTAGES2024UPDATE = new FellowsPercentages2025Update();

	private FellowsPercentages2025Update() {
	}
