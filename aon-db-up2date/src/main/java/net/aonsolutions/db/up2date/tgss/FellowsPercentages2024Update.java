...
public class FellowsPercentages2024Update implements Update {

	private static final int DOMAIN = -105;

	public static final FellowsPercentages2024Update FELLOWSPERCENTAGES2023UPDATE = new FellowsPercentages2024Update();

	private FellowsPercentages2024Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( config -> {
			...
			.set(SYSTEM_DEDUCTION.END_DATE, end2023Date)
			...
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGC > 0.00 ? 10.69 : 0.00" )
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGC_E > 0.00 ? 53.61 : 0.00" )
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2024Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGC > 0.00 ? 1323.00 * PORCENTAJE_MEI/100 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGC_E > 0.00 ? 1323.00 * PORCENTAJE_MEI_E/100 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2024Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGP > 0.00 ? 0.26 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 2.00 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 4.07 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 3.82 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 3.56 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
