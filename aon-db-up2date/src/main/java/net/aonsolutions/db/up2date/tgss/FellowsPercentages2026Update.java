...
public class FellowsPercentages2026Update implements Update {

	private static final int DOMAIN = -105;

	public static final FellowsPercentages2026Update FELLOWSPERCENTAGES2026UPDATE = new FellowsPercentages2026Update();

	private FellowsPercentages2026Update() {
	}
