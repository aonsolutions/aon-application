...
public class HomeBases2025Update implements Update {

	public static final HomeBases2025Update HOMEBASES2025UPDATE = new HomeBases2025Update();
	...
	public void upgrade(Connection connection) {
		...
		.set(SYSTEM_DATA.START_DATE, DSL.date(start2025Date))
