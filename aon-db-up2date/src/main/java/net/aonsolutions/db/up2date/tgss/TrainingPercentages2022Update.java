...
public class TrainingPercentages2022Update implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final TrainingPercentages2022Update TRAINNINGPERCENTAGES2022UPDATE = new TrainingPercentages2022Update();

	private TrainingPercentages2022Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		dslContext.transaction( (config) -> {
			...
			.set(SYSTEM_COST.EXPRESSION, "47.28" )
			...
			.set(SYSTEM_COST.EXPRESSION, "3.59" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
