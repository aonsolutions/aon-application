...
public class TrainingPercentages2025Update implements Update {

	private static final int DOMAIN = -101;

	public static final TrainingPercentages2025Update TRAINNINGPERCENTAGES2025UPDATE = new TrainingPercentages2025Update();

	private TrainingPercentages2025Update() {
	}
	...
	public void upgrade(Connection connection) {
		...
		boolean	upgraded =
			...
			.and(SYSTEM_COST.START_DATE.eq(start2025Date))) > 0;
		...
		dslContext.transaction( config -> {
			...
			.set(SYSTEM_DEDUCTION.END_DATE, end2024Date)
			...
			.set(SYSTEM_DEDUCTION.START_DATE, start2025Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGC > 0.00 ? 11.16 : 0.00" )
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGC_E > 0.00 ? 55.97 : 0.00" )
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2025Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGC > 0.00 ? 1.72 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGC_E > 0.00 ? 8.86 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2025Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGP > 0.00 ? 0.27 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 2.09 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
			...
			.set(SYSTEM_DEDUCTION.DOMAIN, DOMAIN)
			.set(SYSTEM_DEDUCTION.START_DATE, start2025Date)
			.set(SYSTEM_DEDUCTION.EXPRESSION, "TOTAL_BASE_CGP > 0.00 ? 1381.20 * (isdef PORCENTAJE_DESMPL ? PORCENTAJE_DESMPL : PORCENTAJE_DESMPL=1.55)/100 : 0.00" )
			.set(SYSTEM_DEDUCTION.END_DATE, DSL.castNull(SYSTEM_DEDUCTION.END_DATE))
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 1381.20 * (isdef PORCENTAJE_DESMPL_E ? PORCENTAJE_DESMPL_E : PORCENTAJE_DESMPL_E=5.50)/100 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute();
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 4.25 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 3.99 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
			...
			.set(SYSTEM_COST.EXPRESSION, "TOTAL_BASE_CGP_E > 0.00 ? 3.72 : 0.00" )
			.set(SYSTEM_COST.END_DATE, DSL.castNull(SYSTEM_COST.END_DATE))
			.execute()
			;
