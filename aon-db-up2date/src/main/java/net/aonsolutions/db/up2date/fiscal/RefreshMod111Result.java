...
public class RefreshMod111Result implements Update {
	
	public static final RefreshMod111Result REFRESH_MOD111_RESULT = new RefreshMod111Result();

	private RefreshMod111Result() {
	}
						...
						if (resultKey != null) {
							...
							if (result != null) {
								dslContext.update(FS_MODEL)
									...
									.set(FS_MODEL.DECLARATION_TYPE, (declarationType == null? null : Byte.valueOf(declarationType.value())))
