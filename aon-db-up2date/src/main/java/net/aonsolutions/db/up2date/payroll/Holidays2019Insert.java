...
public class Holidays2019Insert implements Update {

	public static final Holidays2019Insert HOLIDAYS2019INSERT = new Holidays2019Insert();
	
	private Holidays2019Insert() {
	}
	...
	public void upgrade(Connection connection) {
		...
		.and(HOLIDAY_DETAIL.DATE.ge(_2019StartDate))
		) >= 1;
		...
		dslContext.transaction( (config) -> {
			...
			new InputStreamReader(Holidays2019Insert.class.getResourceAsStream("holidays2019.csv"), Charset.forName("utf-8")); 
