...
public class FellowsBases2019Fix implements Update {

	public static final FellowsBases2019Fix FELLOWSBASES2019FIX = new FellowsBases2019Fix();
	
	private FellowsBases2019Fix() {
	}
