...
public class TrainningBases2025Update implements Update {

	public static final TrainningBases2025Update TRAINNINGBASES2025UPDATE = new TrainningBases2025Update();
	...
	public void upgrade(Connection connection) {
		...
		UpdateConditionStep<SystemDataRecord> close2024CgcBasesMin =
		dslContext
		.update(SYSTEM_DATA)
