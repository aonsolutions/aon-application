...
public class FellowsPercentages2022Update implements Update {

	private static final String BASE_CGP_MIN = "BASE_CGP_MIN";

	public static final FellowsPercentages2022Update FELLOWSPERCENTAGES2022UPDATE = new FellowsPercentages2022Update();

	private FellowsPercentages2022Update() {
	}
