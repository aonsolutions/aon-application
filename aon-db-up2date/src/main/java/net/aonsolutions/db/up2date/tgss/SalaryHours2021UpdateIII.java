...
public class SalaryHours2021UpdateIII implements Update {

	public static SalaryHours2021UpdateIII SALARYHOURS2021UPDATEIII = new SalaryHours2021UpdateIII();
	...
	public void upgrade(Connection connection) {
		...
		UpdateConditionStep<SystemDataRecord> close2019SalaryHours =
		dslContext
		.update(SYSTEM_DATA)
		...
		InsertOnDuplicateStep<SystemDataRecord> insertSeptember2021SalaryHours = 
		dslContext
		...
		dslContext.transaction( (config) -> {
			...
			close2019SalaryHours.execute();
			
			insertSeptember2021SalaryHours.execute();
