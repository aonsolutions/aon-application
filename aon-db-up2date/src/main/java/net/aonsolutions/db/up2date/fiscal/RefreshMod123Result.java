...
public class RefreshMod123Result implements Update {
	
	public static final RefreshMod123Result REFRESH_MOD123_RESULT = new RefreshMod123Result();

	private RefreshMod123Result() {
	}
