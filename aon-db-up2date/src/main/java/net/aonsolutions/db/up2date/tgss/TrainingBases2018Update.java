...
public class TrainingBases2018Update implements Update {
	...
	private static final Logger LOGGER  = Logger.getLogger(TrainingBases2018Update.class.getName());
	...
	public void upgrade(Connection connection) {
		...
		if ( upgraded )
			...
			.and(SYSTEM_DEDUCTION.START_DATE.eq(startDate2018))) == 1;
...
//			.and(SYSTEM_DEDUCTION.START_DATE.eq(startDate2018))) == 1;
		...
		if ( upgraded )
			...
			.and(SYSTEM_COST.START_DATE.eq(startDate2018))) == 1;
...
//			.and(SYSTEM_COST.START_DATE.eq(startDate2018))) == 1;
		...
		.set( SYSTEM_DEDUCTION.END_DATE, endDate2017)
		...
		.update(SYSTEM_COST)
		.set( SYSTEM_COST.END_DATE, endDate2017)
		...
		.set(SYSTEM_DEDUCTION.START_DATE, startDate2018)
...
//		;
		...
		.set(SYSTEM_COST.START_DATE, startDate2018)
...
//			insertDesmplCost.execute();
			...
			LOGGER.info(" COTIZACIÓN POR CONTRATOS PARA LA FORMACIÓN Y EL APRENDIZAJE 2018 ");
