...
public class Holidays2022Insert implements Update {

	public static final Holidays2022Insert HOLIDAYS2022INSERT = new Holidays2022Insert();
	
	private Holidays2022Insert() {
	}
	...
	public void upgrade(Connection connection) {
		...
		Date _2022StartDate = new Date(calendar.getTimeInMillis());
		...
		.and(HOLIDAY_DETAIL.DATE.ge(_2022StartDate))
		) >= 1;
		...
		dslContext.transaction( (config) -> {
			...
			new InputStreamReader(Holidays2022Insert.class.getResourceAsStream("holidays2022.csv"), Charset.forName("utf-8")); 
