...
import { AonMaker, Address } from '../../../models/models';
@Component({
  templateUrl: './address-dialog.component.html',
  styleUrls: ['./address-dialog.component.css'],
})
export class AddressDialogComponent implements OnDestroy {

  address: Address = AonMaker.createAddress();

  constructor(public dialogRef: MatDialogRef<AddressDialogComponent>,
              @Inject(MAT_DIALOG_DATA) public data: Address) {
    this.address = AonMaker.createAddress(data);
  }
  ...
  isSpain(): boolean {
    return this.address.country === 'ES';
  }
