...
public class TbaiEmisionArabaTest {
	...
	private Invoice buildInvoice() {
		...
		invoiceDetail.setDiscountExpression("10.0");
	...
	private Certificate getCertificate() throws IOException {
		InputStream is = TbaiEmisionArabaTest.class.getResourceAsStream(CERT_NAME);
...
//	
	...
	public void SuccessTest() {
		try (final InputStream certificateInputStream = TbaiEmisionGipuzkoaTest.class.getResourceAsStream("FNMT_AON.p12")){
			...
			TbaiConfiguration config = getTbaiConfiguration();
			...
			createEmisionTBAI(company, invoice, config);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void createEmisionTBAI(Company company, Invoice invoice, TbaiConfiguration tbaiConfiguration)
		...
		response = tbaiMain.sendXML(uri, tbaiConfiguration, xml);
