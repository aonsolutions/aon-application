...
class Aon {
   ...
   */
    ...
    static String get(String domainName, String userLogin, String path, Map<String, ?> params) throws URISyntaxException, IOException, InterruptedException {
    	return get(domainName, userLogin, PREDEFINED_TOKEN, path, params);
    }

    static JSONObject postJSON(String domainName, String userLogin, String token, String path, JSONObject jsonObject)
    ...
    static JSONObject postJSON(String domainName, String userLogin,  String path, JSONObject jsonObject)
    	    throws URISyntaxException, IOException, InterruptedException {
    	return postJSON(domainName, userLogin, PREDEFINED_TOKEN, path, jsonObject);
    }
