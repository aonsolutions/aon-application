...
//		},
		AON_10_KLARITXU ("/net/aonsolutions/aon/tedi/test/pdf/AON-10-KLARITXU.pdf") {
			@Override public Date getDate() {return Date.from(LocalDateTime.of(2020, 11, 19, 0, 0).atZone(ZoneId.systemDefault()).toInstant());}
			@Override public String getReference(){ return "202002350"; }
			@Override public String getSenderDocument() {return "B01602135";}
			@Override public String getReceiverDocument() {return "B01487271";}
			@Override public int getTaxNumber() {return 2;}
			@Override public Double getTaxBase10() {return 26.86;}
			@Override public Double getTaxQuota10() {return 2.69;}
			@Override public Double getTaxBase21() {return 3.31;}
			@Override public Double getTaxQuota21() {return 0.7;}
			@Override public Double getTotal(){ return 33.56; }
		}
		;
