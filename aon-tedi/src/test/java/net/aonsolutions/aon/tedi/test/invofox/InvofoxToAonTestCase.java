...
public class InvofoxToAonTestCase extends AbstractTediTest {
	...
	void getEmitidaDocument() {
		String companyId = "6480556355f159000abb18eb";
		String documentId = "666aa172e6996f264d186eeb";
		OCRDocumentsParams params = OCRDocumentsParams.get().withCompany( companyId );
		OCRDocumentResponse document = OCRInvofox.getDocument(X_API_KEY, API_URL, documentId);
