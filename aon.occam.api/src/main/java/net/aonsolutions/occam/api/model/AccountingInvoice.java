...
//		return getInvoice()
//			.map(Invoice::getHeader)
//			.map(h -> h.getTransaction())
//			.orElse(null);
//	}
//
...
//	private void setWithholdingAccount(Account acc) {
//		getWithholdingData().setAccount(acc);
//	}	
//	private void setWithholdingBase(Double base) {
//		getWithholdingData().setBase(base);
//	}
//	private void setWithholdingPercent(Double percent) {
//		getWithholdingData().setPercentage(percent);
//	}
//	private void setWithholdingQuota(Double quota) {
//		getWithholdingData().setQuota(quota);
//	}
//	private void setWithholdingType(WithholdingType type) {
//		getWithholdingData().setWithholdingType(type);
//	}
//	private boolean isWithholdingQuotaEdited() {
//		return getWithholdingData().isQuotaEdited();
//	}
//	private void setWithholdingQuotaEdited(boolean edited) {
...
//		return prepayments;
//	}
//	private AccountingInvoice setPrepayments(boolean prepayments) {
//		this.prepayments = prepayments;
//		return this;
//	}
//
//	private LinkedList<InvoiceRegistry> getPosibleRegistries() {
//		return posibleRegistries;
//	}
//	private AccountingInvoice setPosibleRegistries(LinkedList<InvoiceRegistry> posibleRegistries) {
