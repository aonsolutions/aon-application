...
public class FiscalModelUtils {
	...
	@FunctionalInterface
	private interface IFiscalModelTypeName<T extends FiscalModel> {
		boolean accept(T mod);
	}
	...
	private enum FiscalModelTypeName {
		...
		private String name;
		private IFiscalModelTypeName<FiscalModel> accepter;
		
		private FiscalModelTypeName( String name, IFiscalModelTypeName<FiscalModel> getter) {
			this.name = name;
		...
		private <T extends FiscalModel> boolean accept(T mod) {
			return this.accepter.accept(mod);
		}
		private static String getName(FiscalModel mod) {
	...
	public static <T extends FiscalModel> String getModelName(T fm) {
		String name = FiscalModelTypeName.getName(fm);
		return AonStringUtils.isNotBlank(name)?name:fm.getModel().getName();
	}
	
	public static <T extends FiscalModel> String getPeriodDescription(T fm) {
		String description = "";
