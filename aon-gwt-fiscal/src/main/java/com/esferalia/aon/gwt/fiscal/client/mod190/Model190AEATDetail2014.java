...
public class Model190AEATDetail2014 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190AEATDetail2014( Model190Callback callback, Mod190 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod190Detail>() {
			...
			public void onSelection(SelectionEvent<Mod190Detail> event) {
				Model190AEAT2014DetailPanel panel = new Model190AEAT2014DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
