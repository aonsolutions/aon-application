...
public class Model110Bizkaia extends Model111Base {
	...
	public Model110Bizkaia(Mod111 mod111, Model111Callback callback) {
		...
		IFiscalModelAdmonPanelCallback<Mod111, Model111ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod111, Model111ModuleOptions>() {
				...
				public Mod111 getModel() {
					return Model110Bizkaia.this.getModel();
				}
				...
				public String getModelInformationURL() {
					return "https://www.bizkaia.eus/ogasuna/ereduak/modelos.asp?textomodelo=110&idioma=CA&aceptar=Buscar&Tem_Codigo=2093&dpto_biz=5&codpath_biz=5%7C3587%7C2093";
				}
		};
