...
import com.esferalia.aon.gwt.fiscal.client.mod390.e2022.Page03.Mod390DetailKeyGroup;
...
public class Mod3902022ExcelAction extends AbsExcelAction {
	
	private Mod3902022 mod390;
	
	public Mod3902022ExcelAction(Mod3902022 mod390) {
		super();
		this.mod390 = mod390;
	}
	...
	protected void printModelInfo() {
		...
		cellCount = 0;
		try {
			InputStream inputStream = Mod3902022ExcelAction.class.getResourceAsStream(
	...
	public void accept(Mod3902022 m390) {
		...
		for (Mod390DetailKeyGroup key : Mod390DetailKeyGroup.values()) {
			...
			for (Mod3902022DetailKey key2 : key.getKeys())		
    ...
    private void addEnsure(String s1, String s2, Mod3902022 m390, Mod3902022DetailKey key ) {
    	
		row = sheet.createRow(rowCount++);
		
		// Algunas lineas van en negrita
		boolean isBold = (key == Mod3902022DetailKey.C0047 || key == Mod3902022DetailKey.C0064 || key == Mod3902022DetailKey.C0065);
		...
		CellUtil.createCell(row, cellCount++, key == Mod3902022DetailKey.C0065 ? s2.toUpperCase() : s2, style);
		
		// Base - Determinadas casillas solo llevan cuota
		if (key == Mod3902022DetailKey.C0047 || key == Mod3902022DetailKey.C0063 || key == Mod3902022DetailKey.C0522 || key == Mod3902022DetailKey.C0064 || key == Mod3902022DetailKey.C0065 )
