		...
		for (IAccUtilitiesItem it :  result.getItems()) {
			...
			if (seriesInfo != null && seriesInfo.length > 0) {
				for (String series : seriesInfo) {
					...
					seriesPanel.setStyleName(AON.CSS.aonFixedFont());
					String msg = "Serie: " 
			...
			reg.setStyleName(AON.CSS.aonPaddingLeft());
			...
			AonTableButton regenerate = new AonTableButton("Regenerar",AON.CSS.aonIconFix());
