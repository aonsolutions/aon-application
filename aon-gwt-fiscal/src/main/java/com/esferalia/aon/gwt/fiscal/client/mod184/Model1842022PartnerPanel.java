...
import com.esferalia.aon.gwt.fiscal.client.mod184.Model184Partner2022.IModel184PartnerCallback;
...
public class Model1842022PartnerPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model1842022PartnerPanel(Mod184Partner partner, IModel184PartnerCallback callback) {
		...
		Model1842022PartnerPanel.setValue(key, subkey, partner, callback);
