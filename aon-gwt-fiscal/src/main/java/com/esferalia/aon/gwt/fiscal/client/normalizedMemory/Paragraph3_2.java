...
public class Paragraph3_2 extends ResizeComposite {
	...
	public void init() {
		inma.getSchema(enterprise.getDocument(),"MA3",enterprise.getDomain(), false, new AsyncCallback<Map<String, String>>() {
			...
			t.addChangeHandler(new ChangeHandler() {
				...
				public void onChange(ChangeEvent event) {
					...
					if(n<=1){
						...
						inma.updateSchema(enterprise.getDocument(),enterprise.getDomain(),key2, d2.toString() , new AsyncCallback<Void>() {
							@Override
							public void onFailure(Throwable caught) {}
							@Override
