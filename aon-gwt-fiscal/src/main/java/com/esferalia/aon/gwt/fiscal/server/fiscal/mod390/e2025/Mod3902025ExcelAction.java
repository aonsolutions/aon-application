...
import com.esferalia.aon.gwt.fiscal.client.mod390.e2025.Page03.Mod390DetailKeyGroup;
...
public class Mod3902025ExcelAction extends AbsExcelAction {
	
	private Mod3902025 mod390;
	
	public Mod3902025ExcelAction(Mod3902025 mod390) {
		super();
		this.mod390 = mod390;
	}
	...
	protected void printModelInfo() {
		...
		cellCount = 0;
		try {
			InputStream inputStream = Mod3902025ExcelAction.class.getResourceAsStream(
	...
	public void accept(Mod3902025 m390) {
		...
		for (Mod390DetailKeyGroup key : Mod390DetailKeyGroup.values()) {
			...
			for (Mod3902025DetailKey key2 : key.getKeys())		
    ...
    private void addEnsure(String s1, String s2, Mod3902025 m390, Mod3902025DetailKey key ) {
    	
		row = sheet.createRow(rowCount++);
		
		// Algunas lineas van en negrita
		boolean isBold = (key == Mod3902025DetailKey.C0047 || key == Mod3902025DetailKey.C0064 || key == Mod3902025DetailKey.C0065);
		...
		CellUtil.createCell(row, cellCount++, key == Mod3902025DetailKey.C0065 ? s2.toUpperCase() : s2, style);
		
		// Base - Determinadas casillas solo llevan cuota
		if (key == Mod3902025DetailKey.C0047 || key == Mod3902025DetailKey.C0063 || key == Mod3902025DetailKey.C0522 || key == Mod3902025DetailKey.C0064 || key == Mod3902025DetailKey.C0065 )
		...
		if (m390.ensure(key).getPercent() == 0 &&
				key != Mod3902025DetailKey.C0701 &&
				key != Mod3902025DetailKey.C0705 &&
				key != Mod3902025DetailKey.C0709 &&
				key != Mod3902025DetailKey.C0713 &&
				key != Mod3902025DetailKey.C0717 &&
				key != Mod3902025DetailKey.C0721 //&&
//				key != Mod3902025DetailKey.C0664 
				) 
			CellUtil.createCell(row, cellCount++, "", style);
