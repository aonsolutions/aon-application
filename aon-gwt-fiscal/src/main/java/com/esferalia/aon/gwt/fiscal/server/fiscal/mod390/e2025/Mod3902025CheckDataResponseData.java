...
@WebServlet(name = "Mod3902025 Check Data Reponse Data", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902025CheckDataResponseData" })
public class Mod3902025CheckDataResponseData extends HttpServlet {

	private static final long serialVersionUID = -6856819434843894765L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Mod3902025 mod3902025 = MODEL3902025.get(occam, params.getMod());
			if (mod3902025 == null) {
				ModelAdmonUtils.giveExceptionBack(resp, "Declaración no encontrada" );
			}
			ModelAdmonUtils.giveDataResponseDataBack(resp, params, mod3902025);			
