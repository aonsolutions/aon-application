...
public class CreditorBox extends ResizeComposite implements HasValue<String>
	...
	private FiscalMSServiceAsync SERVICE;
	...
	public CreditorBox(final String domainName, final String user , final int domain) {
		this(domainName,user,domain,true);
	}
	
	public CreditorBox(final String domainName, final String user, final int domain, boolean showDescription) {
