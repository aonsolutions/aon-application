...
public class Model390HFIdentificationData extends ScrollPanel {

	public interface IModel390HFIdentificationDataCallback {
		String getDocument();
	...
	public Model390HFIdentificationData(IModel390HFIdentificationDataCallback callback) {
