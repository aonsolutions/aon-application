...
public interface Mod3902014ServiceAsync {
	...
	void getMod3902014(String domainName, Integer domain,Mod390 mod390, AsyncCallback<Mod3902014> callback);
	void getById(String domainName, Integer domain,Integer id, AsyncCallback<Mod3902014> callback);
