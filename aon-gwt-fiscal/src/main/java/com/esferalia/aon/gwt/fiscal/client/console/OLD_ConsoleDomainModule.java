...
public class OLD_ConsoleDomainModule extends AonLayoutPanel {
/*
	...
	abstract class AbsConsoleDomainTableCallback implements ConsoleDomainTableCallback {
		public void showError(String message) {
			OLD_ConsoleDomainModule.this.showErrorPanel(message);			
		}
		public void showInfo(String message) {
			OLD_ConsoleDomainModule.this.showInfoPanel(message);			
		}
	}
	

	public OLD_ConsoleDomainModule(ConsoleModuleOptions options) {
