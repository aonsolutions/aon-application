...
public enum Model3032021GIPUZKOAAdditionalDataScript implements IModelScript<Mod303Key> {
...
//	,ADC03 (Mod303Key.GP_C032.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C032},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC03 (Mod303Key.GP_C051.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C051},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC04 (Mod303Key.GP_C052.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C052},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC05 (Mod303Key.GP_C053.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C053},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC06 (Mod303Key.GP_C054.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C054},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	
	,ADC07 ("Exclusivamente para aquellos sujetos pasivos acogidos al R\u00E9gimen especial del criterio de caja y para aquellos que sean destinatarios de operaciones afectadas por el mismo:",null,TITLE)
	,ADC08 ("Importes de las entregas de bienes y prestaciones de servicios a las que habi\u00E9ndoles sido aplicado el R\u00E9gimen especial del criterio de caja hubieran resultado devengadas conforme a la regla general de devengo"
			,new Mod303Key[]{Mod303Key.GP_C047,Mod303Key.GP_C048},OUT_ACCRUAL_INVOICE,DIFF_OUT_ACCRUAL_INVOICE)	
	,ADC09 ("Importes de adquisiciones de bienes y servicios a las que sea de aplicaci\u00F3n o afecte el R\u00E9gimen especial del criterio de caja"
	...
	private Model3032021GIPUZKOAAdditionalDataScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this(label,keys,null,infoKeys);	
	}
	
	private Model3032021GIPUZKOAAdditionalDataScript(String label, Mod303Key[] keys, KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
