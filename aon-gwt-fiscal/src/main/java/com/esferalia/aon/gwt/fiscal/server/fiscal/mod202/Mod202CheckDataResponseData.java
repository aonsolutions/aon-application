...
@WebServlet(name = "Mod202 Check Data Reponse Data", urlPatterns = { "/aon_gwt_fiscal/ms/Mod202CheckDataResponseData" })
public class Mod202CheckDataResponseData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Mod202 mod202 = MODEL202.getMod202(occam, params.getMod());
			if (mod202 == null) {
				ModelAdmonUtils.giveExceptionBack(resp, "Declaración no encontrada" );
			}
			ModelAdmonUtils.giveDataResponseDataBack(resp, params, mod202);			
