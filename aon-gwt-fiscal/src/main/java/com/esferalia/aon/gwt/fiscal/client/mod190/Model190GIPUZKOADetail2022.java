...
public class Model190GIPUZKOADetail2022 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190GIPUZKOADetail2022( Model190Callback callback, Mod190 model,Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod190Detail>() {
			...
			public void onSelection(SelectionEvent<Mod190Detail> event) {
				Model190GIPUZKOA2022DetailPanel panel = new Model190GIPUZKOA2022DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
