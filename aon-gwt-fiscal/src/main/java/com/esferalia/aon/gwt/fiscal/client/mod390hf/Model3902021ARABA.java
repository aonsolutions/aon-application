...
import com.esferalia.aon.gwt.fiscal.shared.mod390.Model3902021ARABAAdditionalDataScript;
...
public class Model3902021ARABA extends Model390HFBase {
	 
	public Model3902021ARABA(Model390HFCallback callback,Mod390HF mod390HF) {
		...
		IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions>() {
					...
					public Mod390HF getModel() {
						return Model3902021ARABA.this.getModel();
					}
