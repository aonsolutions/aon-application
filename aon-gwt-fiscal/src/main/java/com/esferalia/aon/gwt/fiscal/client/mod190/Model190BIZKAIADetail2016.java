...
public class Model190BIZKAIADetail2016 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190BIZKAIADetail2016( Model190Callback callback, Mod190 model,Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod190Detail>() {
			...
			public void onSelection(SelectionEvent<Mod190Detail> event) {
				Model190BIZKAIA2016DetailPanel panel = new Model190BIZKAIA2016DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
