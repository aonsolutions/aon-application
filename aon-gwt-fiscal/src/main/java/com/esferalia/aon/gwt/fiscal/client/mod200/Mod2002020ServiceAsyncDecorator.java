...
public class Mod2002020ServiceAsyncDecorator implements Mod2002020ServiceAsync {
	...
	@Override
	public void fillMod2002020AccountingData(String domainName, int domain, String user, Mod2002020 mod200, String data,
			AsyncCallback<Mod2002020> callback) {
		AON.start();
		fsa.fillMod2002020AccountingData(domainName, domain, user, mod200, data,
				new AsyncCallbackWrapper<Mod2002020>(callback));
	}
