...
public class InvoiceProcessOutputPanel extends AonCards {
	...
	public InvoiceProcessOutputPanel( InvoiceProcessOutput output ) {
		...
		this.addCard( new AonCard(false, null, getPanel("Total I.V.A.", AON.FMT.format(output.getTotalVAT() ))));
		this.addCard( new AonCard(false, null, getPanel("Total I.R.P.F.", AON.FMT.format(output.getTotalRetention() ))));
