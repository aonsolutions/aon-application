...
public class Model190ARABADetail2016 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190ARABADetail2016( Model190Callback callback, Mod190 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod190Detail>() {
			...
			public void onSelection(SelectionEvent<Mod190Detail> event) {
				Model190ARABA2016DetailPanel panel = new Model190ARABA2016DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
