...
public interface InvoiceCommunicationService extends RemoteService {
	...
	ICResponse altaLroe140(String domainName, int domainId, String user, Invoice invoice, AEATParams aeatParams);
	String bajaLroe140(String domainName, int domainId, String user, Invoice invoice, AEATParams aeatParams) throws Exception;
	ICResponse altaLroe240(String domainName, int domainId, String user, Invoice invoice, AEATParams aeatParams);
	...
	List<InvoiceTracking> getInvoiceTrackingList(String domainName, int domainId, String login, Integer invoice);
