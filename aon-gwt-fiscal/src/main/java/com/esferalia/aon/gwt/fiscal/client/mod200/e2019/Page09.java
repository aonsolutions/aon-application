...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2019.Mod2002019LQ579Key;
...
/**/			if (key == Mod2002019Key.LQ554) {
					row = paintKeyBreakdownLink(table,row,Mod2002019Key.LQ554,Mod2002019LQ554Key.values(),HEADERS_1);
				}
				if (key == Mod2002019Key.LQ561) {
					row = paintKeyBreakdownLink(table,row,Mod2002019Key.LQ561,Mod2002019LQ561Key.values(),HEADERS_2);
				}
/**/			if (key == Mod2002019Key.LQ579) {
					row = paintKeyBreakdownLink(table,row,Mod2002019Key.LQ579,Mod2002019LQ579Key.values(),null);
				}
/**/			if (key == Mod2002019Key.LQ1032 
					...
					row = paintKeyBreakdownLink(table,row,Mod2002019Key.LQ1032,Mod2002019LQ1032Key.values(),HEADERS_3);
				}
/**/			if (key == Mod2002019Key.LQ547 && !callback.getMod200Object().getMod200().isCooperativa()) {
					row = paintKeyBreakdownLink(table,row,Mod2002019Key.LQ547,Mod2002019LQ547Key.values(),HEADERS_2);
				}
/**/			if (key == Mod2002019Key.LQ1033) {
					row = paintKeyBreakdownLinkLQ1033(table,row,Mod2002019Key.LQ1033.getDescription());
				}
			}
		}
	}
	...
	protected int paintKeyBreakdownLinkLQ1033(final FlexTable tab,int row,final String label) {
		...
		int r = 1;
		int col = 0;
		for (IMod200KeysProvider key : Mod2002019LQ1033_1Key.values()) {
			...
			for (final IMod200Key k : key.getKeys() ) {
				if (k != null && k!= Mod2002019Key.LQ1033){
		...
		r = 1;
		col = 0;
		for (IMod200KeysProvider key : Mod2002019LQ1033_2Key.values()) {
			Label desc = new Label(key.getDescription() );
	...
	protected boolean isDisabled(IMod200Key key) {
		if (key == Mod2002019Key.LQ1032 
				&& (callback.getMod200Object().getMod200().isChecked(Mod2002019Key.C0009) 
				|| callback.getMod200Object().getMod200().isChecked(Mod2002019Key.C0010))) {
			return false;
		}
		if (key == Mod2002019Key.LQ562 
				&& (callback.getMod200Object().getMod200().isChecked(Mod2002019Key.C0030) 
				|| callback.getMod200Object().getMod200().isChecked(Mod2002019Key.C0047))) {
			return false;
		}
		if ((key == Mod2002019Key.LQ520 || key == Mod2002019Key.LQ521) && 
			(callback.getMod200Object().getMod200().isChecked(Mod2002019Key.C0064))) {
			return true;
		}
