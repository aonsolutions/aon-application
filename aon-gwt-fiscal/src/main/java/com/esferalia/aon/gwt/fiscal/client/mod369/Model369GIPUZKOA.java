...
public class Model369GIPUZKOA extends Model369Base {

	public Model369GIPUZKOA(Model369Callback cbk,Mod369 mod369, Integer selectedIncomeIndex,Integer selectedPartnerIndex) {
		super(cbk,mod369);
		...
		IFiscalModelAdmonPanelCallback<Mod369, Model369ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod369, Model369ModuleOptions>() {
				...
				public Mod369 getModel() {
					return Model369GIPUZKOA.this.getModel();
				}
