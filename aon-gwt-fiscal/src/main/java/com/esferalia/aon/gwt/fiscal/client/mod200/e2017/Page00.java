...
import static com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017Character.CHARACTERS_KEYS;
import static com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017Character.CHARACTER_ALSO_CHECK_MAP;
import static com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017Character.CHARACTER_INCOMPATIBILITY_MAP;
...
import com.esferalia.aon.gwt.fiscal.client.mod200.e2017.Mod2002017Object.IMod200ChangeListener;
...
public class Page00 extends PageAbs {
	public static final HashSet<Mod2002017Key> NOT_SUPPORTED_CHARACTERS = new HashSet<Mod2002017Key>();
	static {
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0003);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0004);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0007);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0024);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0025);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0035);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0036);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0058);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002017Key.C0061);
	};

	public static final Mod2002017Key[] DECLARATION_CHARACTERS_BLOCK1 = new Mod2002017Key[] {
		 Mod2002017Key.C0001,Mod2002017Key.C0002,Mod2002017Key.C0003
		,Mod2002017Key.C0004,Mod2002017Key.C0005,Mod2002017Key.C0011
		,Mod2002017Key.C0013,Mod2002017Key.C0014,Mod2002017Key.C0017
		,Mod2002017Key.C0018,Mod2002017Key.C0019,Mod2002017Key.C0021
		,Mod2002017Key.C0023,Mod2002017Key.C0024,Mod2002017Key.C0025
		,Mod2002017Key.C0031,Mod2002017Key.C0032,Mod2002017Key.C0036
		,Mod2002017Key.C0048,Mod2002017Key.C0058,Mod2002017Key.C0060
		,Mod2002017Key.C0066
	};

	public static final Mod2002017Key[] DECLARATION_CHARACTERS_BLOCK2 = new Mod2002017Key[] {
	 	 Mod2002017Key.C0006,Mod2002017Key.C0015,Mod2002017Key.C0022
		,Mod2002017Key.C0028,Mod2002017Key.C0047,Mod2002017Key.C0035
		,Mod2002017Key.C0049,Mod2002017Key.C0029,Mod2002017Key.C0033
		,Mod2002017Key.C0034,Mod2002017Key.C0038,Mod2002017Key.C0046
		,Mod2002017Key.C0012,Mod2002017Key.C0064,Mod2002017Key.C0057
		,Mod2002017Key.C0020,Mod2002017Key.C0062
	};
	
	public static final Mod2002017Key[] DECLARATION_CHARACTERS_BLOCK3 = new Mod2002017Key[] {
		 Mod2002017Key.C0007,Mod2002017Key.C0009,Mod2002017Key.C0010
		,Mod2002017Key.C0016,Mod2002017Key.C0026,Mod2002017Key.C0027
		,Mod2002017Key.C0030,Mod2002017Key.C0039,Mod2002017Key.C0043
		,Mod2002017Key.C0045,Mod2002017Key.C0063,Mod2002017Key.C0071
		,Mod2002017Key.C0059,Mod2002017Key.C0065,Mod2002017Key.C0067
		,Mod2002017Key.C0070,Mod2002017Key.C0072,Mod2002017Key.C0073
	};
	
	private Map<Mod2002017Key, CheckBox> inputs = new HashMap<Mod2002017Key, CheckBox>();
	...
	public Page00( Model200PageCallback callback ) {
		...
		callback.getMod200Object().register( new IMod200ChangeListener() {
			...
			@Override
			public void mod200Changed(Mod2002017 mod200) {
				DoubleVariable2017 sv = mod200.getVariable(Mod2002017Key.C0027);
				if (sv != null && inputs.containsKey( Mod2002017Key.C0027 )) {
					inputs.get( Mod2002017Key.C0027 ).setValue( AonMathUtils.equals(sv.getValue() , 1.0) );
				}
			}
		});
	}
	...
	public void dump() {
		...
		DoubleVariable2017 dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002017Key.C0041);
		Double value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002017Key.C0042);
		value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		for (Mod2002017Key key : CHARACTERS_KEYS) {
			DoubleVariable2017 sv = callback.getMod200Object().getMod200().getKeysMap().get(key);
	...
	protected void initializeTable() {
		c061.setText(Mod2002017Key.C0061.getDescription());
		inputs.put(Mod2002017Key.C0061, c061);
	...
	private int initializeBlock(FlexTable table,int row, Mod2002017Key[] declarationCharatersBlock) {
		...
		for (final Mod2002017Key key : declarationCharatersBlock ) {
			BoxLabel l = new BoxLabel( key.getCode( adm ) , Model2002017.BOX_LENGTH );
	...
	private void changeAvailability(Mod2002017Key key) {
		boolean enabled = inputs.get(key).getValue();
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002017Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002017Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
