...
@WebServlet(name = "Supplier Report PDF Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/SupplierReportPDFServlet" })
public class SupplierReportPDFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition",
					"attachment; filename=\"Proveedores." + MimeType.PDF.getExtension() + "\";");
