...
public enum MemoryKey implements Serializable, IsSerializable {
	...
	private MemoryKey(int code) {
		this(Integer.toString(code));
	}
	
	private MemoryKey(String code) {
		this.code = code;
	}
	...
	public String getDescription() {
		return MemoryDescription.DESCRIPTION_MAP.get(this.toString());
	}
