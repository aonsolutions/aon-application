...
public class Model184Partner2025 extends DockLayoutPanel implements IModel184Partner {
	...
	public Model184Partner2025( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model1842025PartnerPanel panel = new Model1842025PartnerPanel(event.getSelectedItem(), new IModel184PartnerCallback() {
