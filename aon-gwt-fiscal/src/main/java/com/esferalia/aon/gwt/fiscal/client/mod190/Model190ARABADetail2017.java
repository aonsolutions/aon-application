...
public class Model190ARABADetail2017 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190ARABADetail2017( Model190Callback callback, Mod190 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod190Detail>() {
			...
			public void onSelection(SelectionEvent<Mod190Detail> event) {
				Model190ARABA2017DetailPanel panel = new Model190ARABA2017DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
