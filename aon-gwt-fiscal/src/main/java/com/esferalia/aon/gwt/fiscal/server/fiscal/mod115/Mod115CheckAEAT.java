...
@WebServlet(name = "Mod115 Check AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod115CheckAEAT" })
public class Mod115CheckAEAT extends HttpServlet {
	
	private static final Logger LOGGER = Logger.getLogger(Mod115CheckAEAT.class.getName()); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String year = AonNumberUtils.toString(mod115.getYear());
					
			String urlParameters = MessageFormat.format("NIF={0}&ANR={1}&MOD=115&EJF={2}&PER={3}&FED={4}&FEH={5}&HOD={6}&HOH={7}"
					,mod115.getDocument()
					,mod115.getFullName()
					,year
