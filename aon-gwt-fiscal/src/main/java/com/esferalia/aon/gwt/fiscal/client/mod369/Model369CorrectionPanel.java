...
//import com.esferalia.aon.gwt.fiscal.client.mod369.Model369Correction.IModel369CorrectionCallback;
...
//public class Model369CorrectionPanel extends SimpleLayoutPanel implements Focusable {
//
//	@Override
...
//////		
//////		private Mod369PartnerKey(String description, String[] subkeys, String[] subkeyDescriptions) {
...
////
////	public Model369CorrectionPanel(Mod369DetailCorrection partner, IModel369CorrectionCallback callback) {
...
////		tab1.setWidget(1, 2, new Model369SmallerLabel(AON.MSG.partType()));
////		tab1.setWidget(1, 3, new Model369SmallerLabel(AON.MSG.province()));
////		tab1.setWidget(1, 4, new Model369SmallerLabel(AON.MSG.country()));
////
////		subkey.setWidth("100px");
////
////		key.setWidth("100px");
////		for (Mod369PartnerKey k : Mod369PartnerKey.values()) {
////			key.addItem(k.getDescription(),k.getValue());
////		}
////		
////		Model369CorrectionPanel.setValue(key, subkey, partner, callback);
////		
////		key.addChangeHandler(event -> {
////			subkey.clear();
////			Mod369PartnerKey keyEnum = Mod369PartnerKey.values()[key.getSelectedIndex()];
...
////
//// 		tab2.setWidget(1, 0, new Model369SmallerLabel(AON.MSG.document()));
////		tab2.setWidget(1, 1, new Model369SmallerLabel(AON.MSG.representativeDocument()));
////		tab2.setWidget(1, 2, new Model369SmallerLabel(AON.MSG.fullName()));
////
...
////		cellContainer.add(new Model369SmallerLabel(AON.MSG.memberDays()));
...
////		
//// 		tab2.setWidget(4, 0, new Model369SmallerLabel(AON.MSG.partPercent()));
////		tab2.setWidget(4, 1, new Model369SmallerLabel(AON.MSG.amount()));
////		tab2.setWidget(4, 2, new Model369SmallerLabel(AON.MSG.reduction()));
////		
...
//// 		
//// 		tab2.setWidget(8, 0, new Model369SmallerLabel(AON.MSG.nature()));
//// 		tab2.setWidget(8, 1, new Model369SmallerLabel(AON.MSG.buildingLocation()));
//// 		tab2.setWidget(8, 1, new Model369SmallerLabel(AON.MSG.cadasdralReference()));
////
////		nature.addItem("-","");
...
////		
////		
//// 		tab2.setWidget(10, 0, new Model369SmallerLabel(AON.MSG.declaredKey()));
//// 		tab2.setWidget(10, 1, new Model369SmallerLabel(AON.MSG.assetPercent()));
//// 		tab2.setWidget(10, 2, new Model369SmallerLabel(AON.MSG.assetDays()));
////
//// 		declaredKey.addItem("-","");
...
////
//// 		tab3.setWidget(1, 0, new Model369SmallerLabel(
//// 				"Rendimiento Neto Previo de AAEE en estimaci\u00F3n objetiva (excepto agr\u00ED..."));
////		tab3.setWidget(1, 1, new Model369SmallerLabel(
...
////	}
////	
////	private static void setValue(ListBox key, ListBox subKey, Mod369Partner detail, IModel369PartnerCallback callback) {
////		if (AonStringUtils.isBlank( detail.getKey())) {
////			detail.setKey(Mod369PartnerKey.A.toString());
////			callback.onValueChanged(detail);
////		}
////		Mod369PartnerKey keyEnum = Mod369PartnerKey.valueOf(detail.getKey());
...
////	}
////
////	private void enableWidgets(Mod369Partner partner ) {
