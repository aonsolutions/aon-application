...
import com.esferalia.aon.occam.api.model.fiscal.mod303.Model3032026ARABAResultScript;
...
class Model303ARABA2026 extends Model303Base {
	...
	private CheckBox arC913;
	
	protected Model303ARABA2026(Mod303 mod303,Model303Callback callback) {
	...
	private void paintDeclarationTab(TabLayoutPanel tabPanel) {
		...
		arC913 = paintCheck(Mod303Key.AR_C913,table);	// Sujeto pasivo con derecho a deducir pago a cuenta de entregas de gasolinas, gasóleos y biocarburantes posteriores a la ultimación del régimen de depósito distinto del aduanero
	...
	private void paintResultTab(TabLayoutPanel tabPanel) {
		...
		paintDeclaration(table,Model3032026ARABAResultScript.values(),3);
	}
		...
		IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions>() {
					...
					public Mod303 getModel() {
						return Model303ARABA2026.this.getModel();
					}
