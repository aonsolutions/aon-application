...
public class Page03 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002018Key key : Mod2002018Constants.BALANCE_ACTIVE_KEYS) {
	...
	protected boolean isDisabled(Mod2002018Key key) {
		if (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002018Key.BA111
			 || key == Mod2002018Key.BA115
			 || key == Mod2002018Key.BA138 
			 || key == Mod2002018Key.BA177 ) {
				return true;
			}
		}
