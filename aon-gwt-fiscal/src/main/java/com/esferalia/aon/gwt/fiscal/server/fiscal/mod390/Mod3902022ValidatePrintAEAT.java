...
@WebServlet(name = "Mod390 2022 Validate Print AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902022ValidatePrintAEAT" })
public class Mod3902022ValidatePrintAEAT extends HttpServlet {

	private static final Logger LOGGER = Logger.getLogger(Mod3902022ValidatePrintAEAT.class.getName()); 
	...
	private enum AeatUrl {
		URL_2022 {
			...
			@Override
			protected boolean accept(Mod3902022 mod390) {
				return true;
			}
			...
			@Override
			protected String getUrlParameters(Mod3902022 mod390) throws IOException {
		...
		private static AeatUrl getAeatUrl(Mod3902022 mod390) {
		...
		protected abstract boolean accept( Mod3902022 mod390);
		protected abstract String getUrl();
		protected abstract String getUrlParameters(Mod3902022 mod390) throws IOException;
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902022 mod390 = MODEL3902022.get(occam, ModelAdmonUtils.getFiscalModelId(aeatParams));
