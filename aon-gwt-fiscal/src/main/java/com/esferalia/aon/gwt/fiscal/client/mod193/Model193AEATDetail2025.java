...
public class Model193AEATDetail2025 extends DockLayoutPanel implements IModel193Detail {
	...
	public Model193AEATDetail2025( Model193Callback callback, Mod193 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model193AEAT2025DetailPanel panel = new Model193AEAT2025DetailPanel(event.getSelectedItem(), new IModel193DetailCallback() {
