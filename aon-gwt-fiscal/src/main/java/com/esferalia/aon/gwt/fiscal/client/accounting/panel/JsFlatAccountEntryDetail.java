...
public class JsFlatAccountEntryDetail extends JavaScriptObject {
	...
	public final native Integer getEntrySecurityLevel() /*-{
	...
	public final native Double getDebitBalance() /*-{
		return this.debitBalance;
	}-*/;
	public final native Double getUnpaidBalance() /*-{
		return this.unpaidBalance;
	}-*/;
	public final native Double getInitialDebitBalance() /*-{
		return this.initialDebitBalance;
	}-*/;
	public final native Double getInitialUnpaidBalance() /*-{
		return this.initialUnpaidBalance;
	}-*/;
