...
public class Model184Income2015 extends DockLayoutPanel implements IModel184Income {
	...
	public Model184Income2015( Model184BaseCallback callback, Integer selectedIndex ) {
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Income>() {
			...
			public void onSelection(SelectionEvent<Mod184Income> event) {
				Model1842015IncomePanel panel = new Model1842015IncomePanel(event.getSelectedItem(), new IModel184IncomeCallback() {
