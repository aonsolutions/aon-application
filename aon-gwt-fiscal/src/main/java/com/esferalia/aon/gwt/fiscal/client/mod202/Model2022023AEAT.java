...
import com.esferalia.aon.gwt.fiscal.shared.mod202.Model2022023AEATScript;
...
public class Model2022023AEAT extends Model202Base {
	
	
	public Model2022023AEAT(Mod202 mod202,Model202Callback callback) {
	...
	protected void paintParticularyRow(FlexTable table, Model202Callback callback, IModelScript<Mod202Key> script) {
		if (script == Model2022023AEATScript.C01) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.C02) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.C03) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.C04) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.C05) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R01) {
			paintDateRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R02) {
			paintCNAERow(table, callback, script);
		} else if (script == Model2022023AEATScript.R04) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R05) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R06) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R07) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R08) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R09) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R10) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R17) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R_1) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R18) {
			paintR18(table, callback, script);
		} else if (script == Model2022023AEATScript.R19) {
			paintR19(table, callback, script);
		} else if (script == Model2022023AEATScript.R21) {
			paintR21(table, callback, script);
		} else if (script == Model2022023AEATScript.R61) {
			paintCheckRow(table, callback, script);
		} else if (script == Model2022023AEATScript.R62) {
