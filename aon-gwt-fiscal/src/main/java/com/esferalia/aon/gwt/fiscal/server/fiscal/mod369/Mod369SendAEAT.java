...
@WebServlet(name = "Mod369 Send AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod369SendAEAT" })
public class Mod369SendAEAT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			ModelAdmonUtils.sendOnlineTGVI(resp, aeatParams, mod369);
		} catch (Exception e) {
