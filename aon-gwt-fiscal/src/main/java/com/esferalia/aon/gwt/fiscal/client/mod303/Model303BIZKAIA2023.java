...
class Model303BIZKAIA2023 extends Model303Base {
	
	
	protected Model303BIZKAIA2023(Mod303 mod303,Model303Callback callback) {
		...
		IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions>() {
					...
					public Mod303 getModel() {
						return Model303BIZKAIA2023.this.getModel();
					}
