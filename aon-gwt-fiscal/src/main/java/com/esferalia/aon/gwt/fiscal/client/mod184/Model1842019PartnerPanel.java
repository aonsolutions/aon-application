...
import com.esferalia.aon.gwt.fiscal.client.mod184.Model184Partner2019.IModel184PartnerCallback;
...
public class Model1842019PartnerPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model1842019PartnerPanel(Mod184Partner partner, IModel184PartnerCallback callback) {
		...
		Model1842019PartnerPanel.setValue(key, subkey, partner, callback);
