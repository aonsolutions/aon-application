...
public class Mod202CheckAEAT extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(Mod202CheckAEAT.class.getName()); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String year = AonNumberUtils.toString(mod202.getYear());
					
			String urlParameters = MessageFormat.format("NIF={0}&ANR={1}&MOD=202&EJF={2}&PER={3}&FED={4}&FEH={5}&HOD={6}&HOH={7}"
					,mod202.getDocument()
					,mod202.getFullName()
					,year
					,mod202.getPeriod().getName()
					,year+"0101"
					,year+"2021"
					,"0000"
					,"2359"
