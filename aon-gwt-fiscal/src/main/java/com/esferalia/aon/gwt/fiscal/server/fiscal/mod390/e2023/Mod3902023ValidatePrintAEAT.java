...
@WebServlet(name = "Mod390 2023 Validate Print AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902023ValidatePrintAEAT" })
public class Mod3902023ValidatePrintAEAT extends HttpServlet {

	private static final Logger LOGGER = Logger.getLogger(Mod3902023ValidatePrintAEAT.class.getName()); 
	...
	private enum AeatUrl {
		URL_2023 {
			...
			@Override
			protected boolean accept(Mod3902023 mod390) {
				return true;
			}
			...
			@Override
			protected String getUrlParameters(Mod3902023 mod390) throws IOException {
		...
		private static AeatUrl getAeatUrl(Mod3902023 mod390) {
		...
		protected abstract boolean accept( Mod3902023 mod390);
		protected abstract String getUrl();
		protected abstract String getUrlParameters(Mod3902023 mod390) throws IOException;
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902023 mod390 = MODEL3902023.get(occam, ModelAdmonUtils.getFiscalModelId(aeatParams));
