...
import com.esferalia.aon.gwt.fiscal.client.mod190.Model190BIZKAIADetail2016.IModel190DetailCallback;
...
public class Model190BIZKAIA2016DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190BIZKAIA2016DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190BIZKAIA2016DetailPanel.enableOrDisableIlPanel(key, subkey, ilPanel);
				Model190BIZKAIA2016DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
