...
//	private AonDoubleBox f01D1 = new AonDoubleBox();  // Reducción DANA 
...
//	private AonDoubleBox f02D1 = new AonDoubleBox();  // Reducción DANA 
...
//	private AonDoubleBox f03D1 = new AonDoubleBox();  // Reducción DANA 
...
//	private AonDoubleBox f04D1 = new AonDoubleBox();  // Reducción DANA 
...
//	private AonDoubleBox f05D1 = new AonDoubleBox();  // Reducción DANA 
	...
	public Page04(Model3902025Callback callback) {
		super(callback);
		paint();
		setValue();
	}
...
//			.addCell(f05D1)
		...
		tab2.addRow()
			.addCell(new Label(AON.MSG.box79Msg()), AON.CSS.aonBold(), AON.CSS.aonBorderBottom(), AON.CSS.aonWidthAuto())
		...
		tab4.addRow()
			.addCell(new Label(AON.MSG.box83Msg()), AON.CSS.aonBold(), AON.CSS.aonBorderBottom(), AON.CSS.aonWidthAuto())
