...
public class Model349ARABA extends Model349Base {
	...
	public Model349ARABA(Model349Callback cbk,Mod349 mod349,Integer selectedIndex) {
		super(cbk, mod349);
		...
		IFiscalModelAdmonPanelCallback<Mod349, Model349ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod349, Model349ModuleOptions>() {
					...
					public Mod349 getModel() {
						return Model349ARABA.this.getModel();
					}
					...
					public String getModelInformationURL() {
						return "https://egoitza.araba.eus/es/-/modelo-349?inheritRedirect=true&redirect=%2Fes%2Fbuscador-de-modelos%3Fcategory%3D6041000";
					}
			};
