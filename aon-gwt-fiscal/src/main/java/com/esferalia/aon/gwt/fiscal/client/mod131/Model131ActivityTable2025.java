...
import com.esferalia.aon.gwt.fiscal.client.mod131.Model1312025Activities.IModel131ActivitiesCallback;
...
class Model131ActivityTable2025 extends FlowPanel implements HasSelectionHandlers<Mod131Activity> {
	
	private Integer selectedIndex;
	private AonDisplayGrid grid;
	
	protected Model131ActivityTable2025(IModel131ActivitiesCallback callback) {
	...
	protected void paint( IModel131ActivitiesCallback callback ) {
		...
		for (Mod131Activity act : callback.getModel().getActivities()) {
			...
			actRow.addClickHandler(event -> {
				...
				actRow.addStyleName(AON.CSS.aonBackgroundLigthBlue());
				SelectionEvent.<Mod131Activity>fire(Model131ActivityTable2025.this, act);
			});
			i++;
		}
