...
class Page08 extends PageAbs {
	...
	public Page08(Model3902025Callback callback) {
		super(callback);
		paint();
		setValue();
	}
	...
	private void paint() {
		...
		tab.addRow()
			.addCell(new Label("Entregas intracomunitarias de bienes y servicios"),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		...
		tab.addRow()
			.addCell(new Label("Operaciones no sujetas por reglas de localizaci\u00F3n (excepto las incluidas en la casilla 126)"),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		...
		tab.addRow()
			.addCell(new Label("Operaciones no sujetas por reglas de localizaci\u00F3n acogidas a los reg\u00EDmenes especiales de ventanilla \u00FAnica"),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		...
		tab.addRow()
			.addCell(new Label("Operaciones sujetas y acogidas a los reg\u00EDmenes especiales de ventanilla \u00FAnica"),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		...
		tab.addRow()
			.addCell(new Label("Entregas de bienes inmuebles, operaciones financieras y relativas al oro de inversi\u00F3n no habituales"),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		...
		tab.addRow()
			.addCell(new Label(AON.MSG.box108Msg()), AON.CSS.aonBold(), AON.CSS.aonBorderBottom(), AON.CSS.aonWidthAuto())
