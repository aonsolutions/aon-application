...
public class CustomerModuleNew implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(CustomerModuleNew.class.getName());
	...
	private CustomerModulePanel customerModulePanel;
	...
	public void moduleLoad() {
		...
		options.getParentWidget().add(customerModulePanel);
	}
