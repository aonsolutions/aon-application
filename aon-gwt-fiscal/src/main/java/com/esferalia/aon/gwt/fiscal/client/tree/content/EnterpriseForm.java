...
public class EnterpriseForm extends ResizeComposite implements IFiscalTreeContent<Enterprise> {
	...
	ITreeNodeCallback<Enterprise> callback;
	...
	@Override
	public void setCallback(ITreeNodeCallback<Enterprise> callback) {
