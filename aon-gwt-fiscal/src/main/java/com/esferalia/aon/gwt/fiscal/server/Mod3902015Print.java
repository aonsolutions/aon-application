...
import com.esferalia.aon.occam.server.fiscal.format.mod390.Mod3902015Writer;
...
public class Mod3902015Print extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902015 mod390 = AON.getMod3902015(domainName, domainId, AonServletUtils.getLoggedUser(), id);
