...
public class InvoiceModelReportModuleOptions extends  ModuleOptions<InvoiceModelReportModuleOptions> {
	...
	public InvoiceModelReportModuleOptions setExternalCallback(ModuleCallback externalCallback) {
