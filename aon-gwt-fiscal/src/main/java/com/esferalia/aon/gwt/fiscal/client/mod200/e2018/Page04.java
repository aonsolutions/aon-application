...
public class Page04 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002018Key key : Mod2002018Constants.BALANCE_PASIVE_KEYS) {
	...
	protected boolean isDisabled(Mod2002018Key key) {
		if (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002018Key.BP191 
 			 || key == Mod2002018Key.BP195
			 || key == Mod2002018Key.BP202 
			 || key == Mod2002018Key.BP211
			 || key == Mod2002018Key.BP230
			 || key == Mod2002018Key.BP240
			 ) {
				return true;
			}
		}
