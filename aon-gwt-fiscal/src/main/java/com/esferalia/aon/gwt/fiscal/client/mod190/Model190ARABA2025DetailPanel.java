...
import com.esferalia.aon.gwt.fiscal.client.mod190.Model190ARABADetail2025.IModel190DetailCallback;
import com.esferalia.aon.occam.api.model.fiscal.Mod190Detail;
import com.esferalia.aon.occam.api.model.type.Mod1902025ArabaKey;
...
public class Model190ARABA2025DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190ARABA2025DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		key.setWidth("40px");
		for (Mod1902025ArabaKey k : Mod1902025ArabaKey.values()) {
			key.addItem(k.getDescription(),k.getValue());
		}
		
		Model190ARABA2025DetailPanel.setValue(key, subkey, detail);
		
		key.addChangeHandler( event -> {
			subkey.clear();
			Mod1902025ArabaKey keyEnum = Mod1902025ArabaKey.values()[key.getSelectedIndex()];
	...
	private static void setValue(ListBox key, ListBox subKey, Mod190Detail detail) {
		if (AonStringUtils.isBlank( detail.getKey())) {
			detail.setKey(Mod1902025ArabaKey.A.toString());
		}
		Mod1902025ArabaKey keyEnum = Mod1902025ArabaKey.valueOf(detail.getKey());
	...
	private void enableOrDisableAdditionalDataPanel(ListBox key, ListBox subKey, Panel panel) {
		...
		boolean abc = Mod1902025ArabaKey.A == keyEnum || Mod1902025ArabaKey.B == keyEnum || Mod1902025ArabaKey.C == keyEnum;
		boolean ae01 = Mod1902025ArabaKey.A == keyEnum || (Mod1902025ArabaKey.E == keyEnum && "01".equals(subk));
		boolean fghi = (Mod1902025ArabaKey.F == keyEnum) ||
				       (Mod1902025ArabaKey.G == keyEnum && ("01".equals(subk) || "02".equals(subk) || "03".equals(subk) || "04".equals(subk) || "05".equals(subk) || "06".equals(subk) || "08".equals(subk))) ||
					   (Mod1902025ArabaKey.H == keyEnum) ||
					   (Mod1902025ArabaKey.I == keyEnum);
		boolean l051027 = Mod1902025ArabaKey.L == keyEnum && ("05".equals(subk) || "10".equals(subk) || "27".equals(subk));
		boolean l29 = Mod1902025ArabaKey.L == keyEnum && "29".equals(subk);
