...
public class Model190BIZKAIA2017DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190BIZKAIA2017DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190BIZKAIA2017DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190BIZKAIA2017DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
