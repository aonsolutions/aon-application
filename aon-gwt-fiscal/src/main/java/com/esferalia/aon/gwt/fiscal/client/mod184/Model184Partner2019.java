...
public class Model184Partner2019 extends DockLayoutPanel implements IModel184Partner {
	...
	public Model184Partner2019( Model184BaseCallback callback, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Partner>() {
			...
			public void onSelection(SelectionEvent<Mod184Partner> event) {
				Model1842019PartnerPanel panel = new Model1842019PartnerPanel(event.getSelectedItem(), new IModel184PartnerCallback() {
					...
					public void onDuplicate(Mod184Partner partner) {
						table.duplicate(callback,partner);
					}
				});
