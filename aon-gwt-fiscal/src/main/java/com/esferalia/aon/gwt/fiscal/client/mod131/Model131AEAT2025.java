...
class Model131AEAT2025 extends Model131AEAT {
	
	private Model1312025Activities activities;
	
	Model131AEAT2025(Mod131 mod131, Model131Callback callback) {
	...
	protected void paintLiquidationTab(TabLayoutPanel tabPanel, final Model131Callback callback) {
		activities = new Model1312025Activities(callback.getOptions(),() -> getModel());
