...
public class SupplierModuleNew implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(SupplierModuleNew.class.getName());
	...
	private SupplierModulePanel supplierModulePanel;
	...
	public void moduleLoad() {
		...
		supplierModulePanel = new SupplierModulePanel(options) {

			@Override
			protected void onSupplierCreate(SupplierFull supplierFull) {
				// TODO Auto-generated method stub
				
			}};
		
		options.getParentWidget().add(supplierModulePanel);
	}
