...
public class ScopeTemporaryAuthorizationEntryModule implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(ScopeTemporaryAuthorizationEntryModule.class.getName());
	...
	private static ScopeTemporaryAuthorizationPanel scopeTemporaryAuthorizationPanel;
	...
	private void moduleLoad() {
		...
		scopeTemporaryAuthorizationPanel = new ScopeTemporaryAuthorizationPanel(options);
		
		options.getParentWidget().add(scopeTemporaryAuthorizationPanel);
	}
