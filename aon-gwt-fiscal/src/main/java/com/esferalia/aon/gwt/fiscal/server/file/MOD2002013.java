...
public class MOD2002013  extends AbstractFileFiller{
	...
	public MOD2002013(Mod2002013File mod200File, MOD200Format format, PrintWriter writer) throws FileNotFoundException, UnsupportedEncodingException {
		super(writer);
		if (mod200File == null)  {
		...
		for (String resource : format.getResources() ) {
			InputStream input = MOD2002013.class.getResourceAsStream(resource);
...
//			createLine("DP200024",properties);
	...
	private boolean isValid(Mod2002013File mod200File) {
		return true;
	}
