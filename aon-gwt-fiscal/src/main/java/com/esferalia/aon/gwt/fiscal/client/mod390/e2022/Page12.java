...
class Page12 extends ResizeComposite {
	...
	public Page12(final Model390Callback callback, Model3902022Callback cbk2022) {
		super();
		...
		IFiscalModelAdmonPanelCallback<Mod390, Model390ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod390, Model390ModuleOptions>() {
				...
				public String getValidatePrintAction() {
					return GWT.getHostPageBaseURL() +"aon_gwt_fiscal/ms/Mod3902022ValidatePrintAEAT";					
				}

				@Override
				public String getDownloadFileAction() {
					return "/aon_gwt_fiscal/Model3902022File";
				}

				@Override
				public String getSendAction() {
					return GWT.getHostPageBaseURL() +"aon_gwt_fiscal/ms/Mod3902022SendAEAT";
				}

				@Override
				public void sendSuccessfully() {
					Model3902022.MOD3902022_SERVICE.get(callback.getOptions().getOccam(), getModel(), new AsyncCallback<Mod3902022>() {
						@Override
						public void onSuccess(Mod3902022 selected) {
							if (selected == null) {
								callback.showError(AON.MSG.unableToFindDeclaration());
							} else {
								cbk2022.setModel(selected);
								cbk2022.refreshDeclarationToolbarPanel();
				...
				public String getCheckAction() {
					return GWT.getHostPageBaseURL() +"aon_gwt_fiscal/ms/Mod3902022CheckAEAT";
				}

				@Override
				public String getCheckDataResponseDataAction() {
					return GWT.getHostPageBaseURL() +"aon_gwt_fiscal/ms/Mod3902022CheckDataResponseData";
				}
