...
public class Model184Income2019 extends DockLayoutPanel implements IModel184Income {
	...
	public Model184Income2019( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Income>() {
			...
			public void onSelection(SelectionEvent<Mod184Income> event) {
				Model1842019IncomePanel panel = new Model1842019IncomePanel(event.getSelectedItem(), new IModel184IncomeCallback() {
