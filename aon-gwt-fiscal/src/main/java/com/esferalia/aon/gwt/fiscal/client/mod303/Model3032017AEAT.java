...
class Model3032017AEAT extends Model303AEAT {
	...
	protected Model3032017AEAT(Mod303 mod303,Model303Callback callback) {
	...
	private Model303AEATActivityTable getActivityTable() {
		...
		activityTable.addSelectionHandler(event -> {
			...
			Model303AEATActivity2016 actPanel = new Model303AEATActivity2016(activityCallback, getMod303().isLastPeriod());
