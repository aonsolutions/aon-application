...
public class Model2002017 extends ResizeComposite  {
	...
	protected interface Model200PageCallback {
		public Mod2002017Object getMod200Object();
	}
	
	private PageAbs[] PAGES = new PageAbs[20];
	private int P00 = 0;
	
	interface Model2002017Binder extends
			UiBinder<Widget, Model2002017> {
	}

	private static final Model2002017Binder binder = GWT
			.create(Model2002017Binder.class);

	protected Mod2002017Object mod200Object;
	...
	public Model2002017(Model200ModuleOptions options, Model200Callback mod200Callback) {
...
//		});
		...
		errorPage.addSelectionHandler( new  SelectionHandler<ValidationMessage2017>() {
			
			@Override
			public void onSelection(SelectionEvent<ValidationMessage2017> event) {
				ValidationMessage2017 msg = event.getSelectedItem();
				if ( msg.getPage() >= 0 ) {
...
//	}
	...
	protected void paintHeaderTable(final Mod2002017 mod200) {
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002017> {
		PopupPanel popup;
	...
	public void startModel(final Mod2002017Object modObject ) {
	...
	void onInitializeClick(ClickEvent event) {
		...
		mod200Object.initializeMod200(new AsyncCallback<Mod2002017>() {
			@Override
			public void onSuccess(Mod2002017 result) {
				popup.hide();
				dump(false);
			...
			new ConfirmDialogCallback() {
				...
				public void onAccept() {
					diskForm.setAction(GWT.getHostPageBaseURL()
							+ "/aon_gwt_fiscal/Model2002017AccountingFile");
	...
	void onAeatFileButtonClick(ClickEvent event) {
		...
		cd.confirm("Se va a proceder a la generaci\u00F3n de un fichero\n"
			...
			new ConfirmDialogCallback() {
				...
				public void onAccept() {
					diskForm.setAction(GWT.getHostPageBaseURL()
							+ "/aon_gwt_fiscal/Model2002017File");
					modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
					domainIdHidden.setValue(String.valueOf(options.getDomain()));
					domainNameHidden.setValue(options.getDomainName());
					diskForm.submit();
	...
	void onAeatPrintButtonClick(ClickEvent event) {
		...
		cd.confirm("La impresi\u00F3n se genera en los servidores de la Agencia Tributaria "
			...
			,new ConfirmDialogCallback() {
				...
				public void onAccept() {
					diskForm.setAction(GWT.getHostPageBaseURL()
							+ "/aon_gwt_fiscal/Model2002017Print");
					modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
					domainIdHidden.setValue(String.valueOf(options.getDomain()));
					domainNameHidden.setValue(options.getDomainName());
					diskForm.submit();
