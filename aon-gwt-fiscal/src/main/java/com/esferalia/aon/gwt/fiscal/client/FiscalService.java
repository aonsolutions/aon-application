...
public interface FiscalService extends RemoteService {
	...
	String generateMod190File(Integer id, int year, int administration) throws AonSQLException;
	...
	String generateMod180File(Integer id, int year, int administration) throws AonSQLException;
}
