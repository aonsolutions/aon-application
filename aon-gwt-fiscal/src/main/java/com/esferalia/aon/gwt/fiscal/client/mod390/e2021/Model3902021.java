...
public class Model3902021 extends DockLayoutPanel  {
	
	private static final Integer DEFAULT_YEAR = 2020;
	private static final  String MOD390_2021_DRAFT = "/aon_gwt_fiscal/Model3902021Draft";
			
	protected static final Mod3902021ServiceAsync MOD3902021_SERVICE;
	static {
		Mod3902021ServiceAsync mod3902021ServiceRaw = GWT.create(Mod3902021Service.class);
		MOD3902021_SERVICE = new Mod3902021ServiceAsyncDecorator(mod3902021ServiceRaw);
	}
	
	class Model3902021Callback {
		void markAsDirty() {
	...
	public Model3902021(final Model390Callback mod390Callback, Mod390 mod390) {
		...
		popup.center();
		try {
			MOD3902021_SERVICE.get(getCallback().getOptions().getOccam(), mod390, new AsyncCallback<Mod3902021>() {
				@Override
	...
	public Mod3902021 getModel() {
		return model;
	}
	public void setModel(Mod3902021 model) {
		this.model = model;
	}
	...
	private Widget getToolbar() {
		...
		saveButton.addClickHandler(event -> {
			...
			try {
				...
				MOD3902021_SERVICE.save(getCallback().getOptions().getOccam(),getModel(), new AsyncCallback<Mod3902021>() {
					@Override
		...
		deleteButton.addClickHandler(event -> {
			...
			cd.confirm(AON.MSG.confirmDeclarationDeleteAction(), new AonConfirmDialogCallback() {
				...
				public void onAccept() {
					MOD3902021_SERVICE.delete(getCallback().getOptions().getOccam(), getModel(), new AsyncCallback<Void>() {
						@Override
		...
		draftButton.addClickHandler(event -> submitForm(MOD390_2021_DRAFT));
	...
	private Widget getLinksPanel() {
		...
		Model3902021Callback cbk = new Model3902021Callback();
