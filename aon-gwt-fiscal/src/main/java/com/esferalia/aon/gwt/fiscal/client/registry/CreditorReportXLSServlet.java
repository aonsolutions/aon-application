...
@WebServlet(name = "Creditor Report XLS Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/CreditorReportXLSServlet" })
public class CreditorReportXLSServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			report.printReport("Acreedores");
			OutputStream out = resp.getOutputStream();
			resp.setContentType(MimeType.MS_EXCEL.getName());
			resp.setHeader("Content-disposition",
					"attachment; filename=\"Acreedores." + MimeType.MS_EXCEL_2007.getExtension() + "\";");
			...
			Stream<CreditorFull> stream = AON.getCreditors(occam, params, 0, Integer.MAX_VALUE)
