...
@WebServlet(name = "Mod3902024 Check AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902024CheckAEAT" })
public class Mod3902024CheckAEAT extends HttpServlet {
	
	private static final long serialVersionUID = 6970933212729785953L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			ModelAdmonUtils.checkAEAT(resp, aeatParams, mod3902024);
		} catch (Exception e) {
