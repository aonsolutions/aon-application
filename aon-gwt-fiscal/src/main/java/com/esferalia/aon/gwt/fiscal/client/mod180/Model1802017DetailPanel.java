...
import com.esferalia.aon.gwt.fiscal.client.mod180.Model180Detail2017.IModel180DetailCallback;
...
public class Model1802017DetailPanel extends SimpleLayoutPanel implements Focusable {
	
	private static final String WIDTH_150PX = "150px";
	private static final String WIDTH_100PX = "100px";

	private final class ValueChangeHandlerImplementation implements ValueChangeHandler<Integer> {
		private final IModel180DetailCallback callback;
		private final Mod180Detail detail;
		private final AonIntegerBox accrualYear;

		private ValueChangeHandlerImplementation(IModel180DetailCallback callback, Mod180Detail detail,
				AonIntegerBox accrualYear) {
	...
	public Model1802017DetailPanel(Mod180Detail detail, IModel180DetailCallback callback) {
		...
		accrualYear.addValueChangeHandler(new ValueChangeHandlerImplementation(callback, detail, accrualYear));
