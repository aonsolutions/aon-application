...
class Page11 extends PageAbs {
    ...
    private static String TEXT_ROW_01 = "IVA deducible en operaciones interiores: Bienes y servicios corrientes";	
    private static String TEXT_ROW_02 = "IVA deducible en operaciones interiores: Bienes de inversi\u00F3n";	
    private static String TEXT_ROW_03 = "IVA deducible en importaciones: Bienes corrientes";	
    private static String TEXT_ROW_04 = "IVA deducible en importaciones: Bienes de inversi\u00F3n";
    private static String TEXT_ROW_05 = "IVA deducible en adquisiciones intracomunitarias: Bienes y servicios corrientes";
    private static String TEXT_ROW_06 = "IVA deducible en adquisiciones intracomunitarias: Bienes de inversi\u00F3n";
    private static String TEXT_ROW_07 = "Compensaci\u00F3n en r\u00E9gimen especial de la agricultura, ganader\u00EDa y pesca";
    private static String TEXT_ROW_08 = "Rectificaci\u00F3n de deducciones";
    private static String TEXT_ROW_09 = "Regularizaci\u00F3n de bienes de inversi\u00F3n";
    private static String TEXT_ROW_10 = "Suma de deducciones";
	...
	public Page11(Model3902025Callback callback) {
		super(callback);
		setValue();
		paint();
	}
	...
	private void paint() {
		...
		addRow(tab, TEXT_ROW_01, 139, 140, box139, box140);
		addRow(tab, TEXT_ROW_02, 141, 142, box141, box142);
		addRow(tab, TEXT_ROW_03, 143, 144, box143, box144);
		addRow(tab, TEXT_ROW_04, 145, 146, box145, box146);
		addRow(tab, TEXT_ROW_05, 147, 148, box147, box148);
		addRow(tab, TEXT_ROW_06, 149, 150, box149, box150);
		addRow(tab, TEXT_ROW_07, 151, 152, box151, box152);
		addRow(tab, TEXT_ROW_08, 640, 153, box640, box153);
		addRow(tab, TEXT_ROW_09, 154, box154);
		addRow(tab, TEXT_ROW_10, 155, box155);
...
//			.addCell(box155,AON.CSS.aonWidth120());
		...
		addRow(tab1, TEXT_ROW_01, 156, 157, box156, box157);
		addRow(tab1, TEXT_ROW_02, 158, 159, box158, box159);
		addRow(tab1, TEXT_ROW_03, 160, 161, box160, box161);
		addRow(tab1, TEXT_ROW_04, 162, 163, box162, box163);
		addRow(tab1, TEXT_ROW_05, 164, 165, box164, box165);
		addRow(tab1, TEXT_ROW_06, 166, 167, box166, box167);
		addRow(tab1, TEXT_ROW_07, 168, 169, box168, box169);
		addRow(tab1, TEXT_ROW_08, 641, 170, box641, box170);
		addRow(tab1, TEXT_ROW_09, 171, box171);
		addRow(tab1, TEXT_ROW_10, 172, box172);
...
//			.addCell(box172,AON.CSS.aonWidth120());
		...
		addRow(tab2, TEXT_ROW_01, 173, 174, box173, box174);
		addRow(tab2, TEXT_ROW_02, 175, 176, box175, box176);
		addRow(tab2, TEXT_ROW_03, 177, 178, box177, box178);
		addRow(tab2, TEXT_ROW_04, 179, 180, box179, box180);
		addRow(tab2, TEXT_ROW_05, 181, 182, box181, box182);
		addRow(tab2, TEXT_ROW_06, 183, 184, box183, box184);
		addRow(tab2, TEXT_ROW_07, 185, 186, box185, box186);
		addRow(tab2, TEXT_ROW_08, 642, 187, box642, box187);
		addRow(tab2, TEXT_ROW_09, 188, box188);
		addRow(tab2, TEXT_ROW_10, 189, box189);
...
//			.addCell(box189,AON.CSS.aonWidth120());
	...
	private void checkIfNullSetZero(AonDoubleBox box) {
		if (box.getValue() == null) {
			box.setValue(0.0, false);
		}
	}

	private void addRow(AonDisplayTable tab, String description, int boxNumber, AonDoubleBox box) {
		addRow(tab, description, 0, boxNumber, null, box);
	}
	private void addRow(AonDisplayTable tab, String description, int boxNumber1, int boxNumber2, AonDoubleBox box1, AonDoubleBox box2) {
		AonDisplayTableRow row = tab.addRow();
		
		if (boxNumber2==155 || boxNumber2==172 || boxNumber2==189) {
			row.addCell(new Label(description), AON.CSS.aonWidthAuto(), AON.CSS.aonBorderBottom(), AON.CSS.aonBold());
			box2.setEnabled(false);
		} else {
			row.addCell(new Label(description), AON.CSS.aonWidthAuto(), AON.CSS.aonBorderBottom());
		}
		
		if (box1 == null) {
			row.addCell(new Label(), AON.CSS.aonWidth40(), AON.CSS.aonBorderBottom())
			   .addCell(new Label(), AON.CSS.aonWidth120(), AON.CSS.aonBorderBottom());
		} else {
			row.addCell(new AonBoxLabel(boxNumber1), AON.CSS.aonWidth40())
			   .addCell(box1, AON.CSS.aonWidth120());
		}
		
		row.addCell(new AonBoxLabel(boxNumber2), AON.CSS.aonWidth40())
		   .addCell(box2, AON.CSS.aonWidth120());
	}
