...
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902025ARABARScript1;
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902025ARABAScript2;
...
public class Model390HF2025ARABA extends Model390HFBase {
	 
	public Model390HF2025ARABA(Model390HFCallback callback,Mod390HF mod390HF) {
	...
	private void paintGeneralRegimenTab(TabLayoutPanel tabPanel) {
		...
		paintDeclaration(table, Model3902025ARABARScript1.values(), 8); // IVA DEVENGADO		
		paintScript(table, Model3902025ARABAScript2.values(), 8);       // IVA DEDUCIBLE
		...
		IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions>() {
					...
					public Mod390HF getModel() {
						return Model390HF2025ARABA.this.getModel();
					}
