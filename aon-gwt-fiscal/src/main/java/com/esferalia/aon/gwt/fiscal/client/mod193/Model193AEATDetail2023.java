...
public class Model193AEATDetail2023 extends DockLayoutPanel implements IModel193Detail {
	...
	public Model193AEATDetail2023( Model193Callback callback, Mod193 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod193Detail>() {
			...
			public void onSelection(SelectionEvent<Mod193Detail> event) {
				Model193AEAT2023DetailPanel panel = new Model193AEAT2023DetailPanel(event.getSelectedItem(), new IModel193DetailCallback() {
