...
@WebServlet(name = "Mod3902023 Check AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902023CheckAEAT" })
public class Mod3902023CheckAEAT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			ModelAdmonUtils.checkAEAT(resp, aeatParams, mod3902023);
		} catch (Exception e) {
