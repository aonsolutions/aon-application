...
public class Page06 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002017Key key : Mod2002017Constants.ECPN_INCOME_KEYS) {
	...
	protected boolean isDisabled(Mod2002017Key key) {
		if (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002017Key.T0336 || key == Mod2002017Key.T0346) {
				return true;
			}
		}
	...
	protected boolean isAvailable() {
		return super.isAvailable()
  		  && (callback.getMod200Object().getMod200().isNotChecked(Mod2002017Key.C0052));
	}
}
