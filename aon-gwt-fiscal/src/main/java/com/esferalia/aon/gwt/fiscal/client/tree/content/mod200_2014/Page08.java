...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2014.Mod2002014Correction;
...
public class Page08 extends PageAbs {
	...
	private ListDataProvider<Mod2002014Correction> dataProvider;
	private NoSelectionModel<Mod2002014Correction> model;	
	...
	CellTable<Mod2002014Correction> correctionTable;
	...
	public Page08() {
		...
		correctionTable = new CellTable<Mod2002014Correction>(1,aonTableStyle);
		...
		dataProvider = new ListDataProvider<Mod2002014Correction>();
		dataProvider.addDataDisplay(correctionTable);
		model = new NoSelectionModel<Mod2002014Correction>();
		model.addSelectionChangeHandler(new SelectionChangeEvent.Handler(){
			@Override
			public void onSelectionChange(SelectionChangeEvent event) {
				Mod2002014Correction mc = model.getLastSelectedObject();
		...
		getInputs().put(Mod2002014Key.LQ500, c500);
		getInputs().put(Mod2002014Key.LQ301, c301);
		getInputs().put(Mod2002014Key.LQ302, c302);
		getInputs().put(Mod2002014Key.LQ501, c501);
		getInputs().put(Mod2002014Key.I0417, c417);
		getInputs().put(Mod2002014Key.D0418, c418);
		getLabels().put(Mod2002014Key.LQ500, c500Label);
		getLabels().put(Mod2002014Key.LQ301, c301Label);
		getLabels().put(Mod2002014Key.LQ302, c302Label);
		getLabels().put(Mod2002014Key.LQ501, c501Label);
		getLabels().put(Mod2002014Key.I0417, c417Label);
		getLabels().put(Mod2002014Key.D0418, c418Label);
	}
	
	private void addKeyColumn() {
		Column<Mod2002014Correction, String> keyColumn = new Column<Mod2002014Correction, String>(
				new TextCell()) {
			@Override
			public String getValue(Mod2002014Correction mc) {
	...
	private void addIncreaseBoxColumn() {
		Column<Mod2002014Correction, String> increaseBoxColumn = new Column<Mod2002014Correction, String>(
				new TextCell()) {
			@Override
			public String getValue(Mod2002014Correction mc) {
	...
	private void addIncreaseColumn() {
		Column<Mod2002014Correction, String> increaseColumn = new Column<Mod2002014Correction, String>(
				new TextCell()) {
			@Override
			public String getValue(Mod2002014Correction mc) {
				if (mc.getKey().isIncreaseEnabled() && mc.getIncrease() != null) {
	...
	private void addDecreaseBoxColumn() {
		Column<Mod2002014Correction, String> decreaseBoxColumn = new Column<Mod2002014Correction, String>(
				new TextCell()) {
			@Override
			public String getValue(Mod2002014Correction mc) {
	...
	private void addDecreaseColumn() {
		Column<Mod2002014Correction, String> decreaseColumn = new Column<Mod2002014Correction, String>(
				new TextCell()) {
			@Override
			public String getValue(Mod2002014Correction mc) {
				if (mc.getKey().isDecreaseEnabled() && mc.getDecrease() != null) {
	...
	private void addRemoveColumn() {
		...
		Column<Mod2002014Correction,String> col = new Column<Mod2002014Correction,String>(removeButton) {
		  public String getValue(Mod2002014Correction object) {
		    return AON.MSG.deleteAction();
		  }
		};
		col.setFieldUpdater(new FieldUpdater<Mod2002014Correction, String>() {
		    public void update(int index, Mod2002014Correction ca, String value) {
	...
	private void changeKey(Mod2002014Key key, double value) {
		if (key != null) {
	...
	void onNewCorrection(ClickEvent event) {
		if (correctionType.getSelectedIndex() == 0) {
			...
			Mod2002014CorrectionKey key = Mod2002014CorrectionKey.values()[correctionType.getSelectedIndex() - 1];
			Mod2002014Correction mc = null;
			for (Mod2002014Correction mod200Correction : dataProvider.getList()) {
	...
	public void onChangeC500(ChangeEvent event) {
		onChange(Mod2002014Key.LQ500, c500);
	}
	@UiHandler("c301")
	public void onChangeC301(ChangeEvent event) {
		onChange(Mod2002014Key.LQ301, c301);
	}
	@UiHandler("c302")
	public void onChangeC302(ChangeEvent event) {
		onChange(Mod2002014Key.LQ302, c302);
	}
	@UiHandler("c501")
	public void onChangeC501(ChangeEvent event) {
		onChange(Mod2002014Key.LQ501, c501);
	}
	@UiHandler("c417")
	public void onChangeC417(ChangeEvent event) {
		onChange(Mod2002014Key.I0417, c417);
	}
	@UiHandler("c418")
	public void onChangeC418(ChangeEvent event) {
		onChange(Mod2002014Key.D0418, c418);
	}
	
	private void onChange(Mod2002014Key key, DoubleBox text) {
	...
	protected void initializeTable() {
		Mod2002014 mod200 = this.mod200Object.getMod200();
		for (int i = 0; i < correctionType.getItemCount(); i++) {
			correctionType.removeItem(i);	
		}
		correctionType.addItem("--------------");
		for (Mod2002014CorrectionKey key : Mod2002014CorrectionKey.values()) {
			correctionType.addItem(
		...
		for (Mod2002014Key key : getInputs().keySet() ) {
			DoubleVariable2014 d = mod200.getKey(key);
			Double value = 0.0;
		...
		for (Mod2002014CorrectionKey key : Mod2002014CorrectionKey.values()) {
			...
			if (dec != null && dec != 0) {
				mc = mc!=null?mc:new Mod2002014Correction();
				mc.setKey(key);
				mc.setDecrease(dec);
			}
			if (mc != null) {
