...
public class Model190GIPUZKOADetail2024 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190GIPUZKOADetail2024( Model190Callback callback, Mod190 model,Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model190GIPUZKOA2024DetailPanel panel = new Model190GIPUZKOA2024DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
