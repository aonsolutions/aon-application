...
class InvoiceTabLayout extends AonTabLayoutPanel {
	...
	InvoiceTabLayout(InvoiceFeeModuleOptions opts, Invoice invoice) {
		super(26, Unit.PX);
		this.setWidth("100%");
		...
		;
		InvoicePanel invoicePanel = new InvoicePanel( options, invoice );
		this.add(invoicePanel, new AonCloseTab(AON.MSG.invoice(), false));
		
		InvoiceConsoleTextPanel documentPanel = new InvoiceConsoleTextPanel( invoice );
		this.add(documentPanel, new AonCloseTab(AON.MSG.document(), false));
	}
