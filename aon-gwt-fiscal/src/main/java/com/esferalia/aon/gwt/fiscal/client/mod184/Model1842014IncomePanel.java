...
import com.esferalia.aon.gwt.fiscal.client.mod184.Model184Income2014.IModel184IncomeCallback;
...
public class Model1842014IncomePanel extends SimpleLayoutPanel implements Focusable {
	...
	private static enum Mod184IncomeKey {
		...
		,L ("L - Exceso de rentas negativas obtenidas en pa\u00EDses sin convenio con Espa\u00F1a."
			...
			,new String[] {
				...
				,"G - Ganancias y p\u00E9rdidas patrimoniales derivadas de transmisiones de elementos patrimoniales con per\u00EDodo de generaci\u00F3n."
				,"M - Ganancias y p\u00E9rdidas patrimoniales derivadas de transmisiones de elementos patrimoniales con per\u00EDodo de generaci\u00F3n inferior o igual al a\u00F1o."
			})
		,M ("M - Ganancias y p\u00E9rdidas patrimoniales derivadas de transmisiones de elementos patrimoniales con periodo de generaci\u00F3n inferior o igual al a\u00F1o."
				,new String[] {"01","02","03","04"}
				,new String[] {			
				 "01 - Ganancias generadas en Espa\u00F1a"
				,"02 - P\u00E9rdidas generadas en Espa\u00F1a"
	...
	public Model1842014IncomePanel(Mod184Income income, IModel184IncomeCallback callback) {
		...
		Model1842014IncomePanel.setValue(key, subkey, income);
		...
		tab2.getColumnFormatter().setWidth(1, "250px");
	...
	private void enableWidgets(Mod184Income income ) {
		country.setEnabled(
			 ...
			 || ("M".equals(income.getKey()) && "03".equals(income.getSubKey())) 
			 || ("M".equals(income.getKey()) && "04".equals(income.getSubKey())) 
		);
