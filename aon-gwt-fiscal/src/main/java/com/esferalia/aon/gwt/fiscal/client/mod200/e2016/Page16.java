...
public class Page16 extends PageAbs {
	...
	protected void initializeTable() {
		...
		for (int i = 0; i < Mod2002016Constants.CANARIAS_KEYS.length; i++) {
			...
			paintDescription(table, Mod2002016Constants.CANARIAS_KEYS_DESCRIPTIONS[i], row, 0, false);
	...
	protected boolean isDisabled(Mod2002016Key key) {
		if (key == Mod2002016Key.RC020 || key == Mod2002016Key.RC021)  {
			return callback.getMod200Object().getMod200().isNotChecked(Mod2002016Key.C0045);
		}
