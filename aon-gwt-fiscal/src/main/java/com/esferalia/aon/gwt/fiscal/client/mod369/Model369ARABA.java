...
public class Model369ARABA extends Model369Base {

	public Model369ARABA(Model369Callback cbk, Mod369 mod369,Integer selectedIncomeIndex,Integer selectedPartnerIndex) {
		super(cbk,mod369);
		...
		IFiscalModelAdmonPanelCallback<Mod369, Model369ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod369, Model369ModuleOptions>() {
				...
				public Mod369 getModel() {
					return Model369ARABA.this.getModel();
				}
