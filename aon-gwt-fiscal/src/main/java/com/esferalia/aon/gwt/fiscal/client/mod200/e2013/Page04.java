...
public class Page04 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002013Key key : Mod2002013Constants.BALANCE_PASIVE_KEYS) {
	...
	protected boolean isDisabled(Mod2002013Key key) {
		if (mod200Object.getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002013Key.BP191 
 			 || key == Mod2002013Key.BP195
			 || key == Mod2002013Key.BP202 
			 || key == Mod2002013Key.BP211
			 || key == Mod2002013Key.BP230
			 || key == Mod2002013Key.BP240
			 ) {
				return true;
			}
		}
