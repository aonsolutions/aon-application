...
import com.esferalia.aon.occam.api.model.fiscal.modules.Modules2025.FarmerIVA;
...
class Model303AEAT2025ActivityFarmerSelection extends ScrollPanel implements HasSelectionHandlers<FarmerIVA>{

	Model303AEAT2025ActivityFarmerSelection() {
		...
		for (FarmerIVA epi : FarmerIVA.values()) {
			...
			row.addClickHandler(event -> {
				SelectionEvent.fire(Model303AEAT2025ActivityFarmerSelection.this, epi);
			});	
		}
