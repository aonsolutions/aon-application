...
public class EnterpriseMatrixPanel extends ResizeComposite implements IFiscalTreeContent<EnterpriseYear>{
	...
	ITreeNodeCallback<EnterpriseYear> callback;
	EnterpriseYear enterpriseYear;
	...
	@Override
	public void select(EnterpriseYear enterpriseYear) {
		this.enterpriseYear = enterpriseYear;
		year.setVisible(this.enterpriseYear.getYear() == null);
		yearLabel.setVisible(this.enterpriseYear.getYear() == null);
		search();
	}
	
	@Override
	public void setCallback(ITreeNodeCallback<EnterpriseYear> callback) {
		this.callback = callback;
	}

	private void search() {
		int yr = enterpriseYear.getYear() == null
				?Integer.parseInt( year.getSelectedValue() )
				:enterpriseYear.getYear();
		FiscalTree.FISCAL_SERVICE.getFiscalPanel(FiscalTree.getCurrentDomainName(),
				this.enterpriseYear.getEnterprise().getDomain(), yr
