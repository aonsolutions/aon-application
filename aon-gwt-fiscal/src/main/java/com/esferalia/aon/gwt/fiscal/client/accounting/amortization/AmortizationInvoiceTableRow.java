...
class AmortizationInvoiceTableRow extends AonDisplayGridRow {
	...
	AmortizationInvoiceTableRow(AmortizationModuleOptions opts, AmortizationPanelCallback callback, AmortizationInvoice ami) {
	...
	static void fillHeader(AonDisplayGridHeaderRow headerRow) {
		headerRow
			...
			.addCell(new Label("Ver"),AON.CSS.aonWidth30())
			.addCell(new Label("Cont"),AON.CSS.aonWidth30())
			...
			.addCell(new Label("Doc.Tit."),AON.CSS.aonWidth100())
