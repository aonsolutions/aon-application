...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2018.ValidationMessage2018.MessageType;
...
public class ErrorPage extends ResizeComposite implements HasSelectionHandlers<ValidationMessage2018>{
	...
	private ListDataProvider<ValidationMessage2018> dataProvider;
	private CellTable<ValidationMessage2018> table;
	...
	public ErrorPage( ) {
		...
		table = new CellTable<ValidationMessage2018>(1, Model200Table.TABLE_STYLE);
		table.setKeyboardPagingPolicy(KeyboardPagingPolicy.CURRENT_PAGE);
		table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
		NoSelectionModel<ValidationMessage2018> model = new NoSelectionModel<ValidationMessage2018>();
		...
		dataProvider= new ListDataProvider<ValidationMessage2018>();
	...
	public void clearMessages() {
		dataProvider.setList( new LinkedList<ValidationMessage2018>());
		table.setPageSize(10);
		table.redraw();
	}
	public void addErrorMsg(List<ValidationMessage2018> messages) {
	...
	private void addMessage(String message,MessageType type) {
		addMessage(new ValidationMessage2018(-1,null,message,null,type));
	}
	
	private void addMessage(ValidationMessage2018 msg) {
	...
	private void addPageColumn() {
		Column<ValidationMessage2018,String> col = new TextColumn<ValidationMessage2018>() {

			@Override
			public String getValue(ValidationMessage2018 errorMessage) {
	...
	private void addIconColumn() {
		final Column<ValidationMessage2018, ImageResource> iconColumn = new Column<ValidationMessage2018, ImageResource>(
				new ImageResourceCell()) {
			@Override
			public ImageResource getValue(ValidationMessage2018 model) {
	...
	@Override
	public HandlerRegistration addSelectionHandler(SelectionHandler<ValidationMessage2018> handler) {
