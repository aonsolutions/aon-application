...
class Model303AEATActivity2016 extends DockLayoutPanel implements HasValueChangeHandlers<Mod303Activity> {
	...
	protected Model303AEATActivity2016(final IMod303ActivityCallback callback, boolean lastPeriod) {
		super(Unit.PX);
		...
		final Model303AEATActivity2016Panel epigraphPanel = new Model303AEATActivity2016Panel();
		epigraphPanel.addSelectionHandler( new SelectionHandler<Modules2016.Epigraph>() {
