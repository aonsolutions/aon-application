...
public enum Model3032021_2AEATAdditionalDataScript implements IModelScript<Mod303Key> {
	...
	,ADC03 ("Operaciones no sujetas por reglas de localizaci\u00F3n (excepto las incluidas en la casilla 123)."
		,new Mod303Key[]{null					,Mod303Key.CT_C120},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC04 ("Operaciones sujetas con inversi\u00F3n del sujeto pasivo."
		,new Mod303Key[]{null					,Mod303Key.CT_C122},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC05 ("Operaciones no sujetas por reglas de localizaci\u00F3n acogidas a los reg\u00EDmenes especiales de ventanilla \u00FAnica."
		,new Mod303Key[]{null					,Mod303Key.CT_C123},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC06 ("Operaciones sujetas y acogidas a los reg\u00EDmenes especiales de ventanilla \u00FAnica."
		,new Mod303Key[]{null					,Mod303Key.CT_C124},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
