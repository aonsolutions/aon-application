...
public class DomainIntegrityCheck extends MainEntryPoint {
	...
	public static void run() {
		GWT.runAsync(DomainIntegrityCheck.class, new RunAsyncCallback() {
			...
			public void onSuccess() {
				DomainIntegrityCheck domainIntegrityCheck = new DomainIntegrityCheck();
