...
public class Model2002015 extends ResizeComposite  {
	...
	public void startModel(final Mod2002015TreeObject treeObject, final AsyncCallback<Mod2002015> cb) {
		...
		popup.setAnimationEnabled(true);
		popup.center();
		AsyncCallback<Mod2002015> callback = new AsyncCallback<Mod2002015>() {
			@Override
			public void onSuccess(Mod2002015 result) {
				cb.onSuccess(result);
	...
	private void populatePages(Mod2002015TreeObject mod200Object) {
		page00.populate(mod200Object);
