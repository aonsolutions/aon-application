...
public class Page13 extends PageAbs {
	...
	interface PageBinder extends UiBinder<Widget, Page13> {}
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (final Mod2002015Key key : Mod2002015Constants.DEDUCIBLE_LIMITATION_KEYS_1) {
			...
			if (mod200Object.isVisible(key)) {
				...
				if (col == 0) {
					...
					paintDescription(table2
						, Mod2002015Constants.DEDUCIBLE_LIMITATION_KEYS_DESCRIPTIONS1[row-1]
						,row, 0, (col == 5));
				}
...
//		++row;
		...
		row = 0;
		for (final Mod2002015Key key : Mod2002015Constants.DEDUCIBLE_LIMITATION_KEYS_5) {
			if (mod200Object.isVisible(key)) {
