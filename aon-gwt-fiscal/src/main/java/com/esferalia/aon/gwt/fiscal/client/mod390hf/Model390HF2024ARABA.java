...
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902024ARABARScript1;
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902024ARABAScript2;
...
public class Model390HF2024ARABA extends Model390HFBase {
	 
	public Model390HF2024ARABA(Model390HFCallback callback,Mod390HF mod390HF) {
	...
	private void paintDeclarationTab(TabLayoutPanel tabPanel) {
		...
		paintCheck(Mod390Key.AR_C918,table);	// ¿Está inscrito en el Registro de devolución mensual (Art. 30 RIVA)?
		...
		paintCheck(Mod390Key.AR_C907 ,table);	// ¿Ha sido declarado en concurso de acreedores en el presente periodo de liquidación?
	...
	private void paintGeneralRegimenTab(TabLayoutPanel tabPanel) {
		...
		paintDeclaration(table, Model3902024ARABARScript1.values(), 8); // IVA DEVENGADO		
		paintScript(table, Model3902024ARABAScript2.values(), 8);       // IVA DEDUCIBLE
		...
		IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions>() {
					...
					public Mod390HF getModel() {
						return Model390HF2024ARABA.this.getModel();
					}
