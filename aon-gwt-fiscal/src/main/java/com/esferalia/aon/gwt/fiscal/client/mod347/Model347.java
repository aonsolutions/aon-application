...
public class Model347 extends MainEntryPoint {
	...
	protected static interface IModel347Callback{
		...
		void onCancel();
		void onSelect(Mod347 mod347, Integer selectedIndexDeclared, Integer selectedIndexAsset, int tabPanelIndex);
	...
	private void select(Mod347 selected, Integer selectedIndexDeclared, Integer selectedIndexAsset, int tabPanelIndex) {
		cleanErrorPanel();
		if ( selected.isAEAT() ) {
			declarationContainer.setWidget( new Model347AEAT(selected,new Model347Callback(),selectedIndexDeclared,selectedIndexAsset,tabPanelIndex));
		} else if ( selected.isAraba() ) {
			declarationContainer.setWidget( new Model347ARABA(selected,new Model347Callback(),selectedIndexDeclared,selectedIndexAsset,tabPanelIndex));			
		} else if ( selected.isBizkaia() ) {
			declarationContainer.setWidget( new Model347BIZKAIA(selected,new Model347Callback(),selectedIndexDeclared,selectedIndexAsset,tabPanelIndex));			
		} else if ( selected.isGipuzkoa() ) {
			declarationContainer.setWidget( new Model347GIPUZKOA(selected,new Model347Callback(),selectedIndexDeclared,selectedIndexAsset,tabPanelIndex));			
		} else if ( selected.isNavarra() ) {
			declarationContainer.setWidget( new Model347NAVARRA(selected,new Model347Callback(),selectedIndexDeclared,selectedIndexAsset,tabPanelIndex));			
		} else {
