...
public class Model303AEATActivity2018Panel extends CustomDialog {
	...
	public Model303AEATActivity2018Panel(SelectionCallBack callback) {
		this();
		this.callback = callback;
	}

	public Model303AEATActivity2018Panel() {
		setVisible(false);
