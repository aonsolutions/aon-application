...
public class Page12 extends PageAbs {
	...
	protected void initializeTable() {
		...
		paintTable(table3, Mod2002017Constants.LIQUIDATION_V_KEYS_4, 2, null);
		paintTable(table4, Mod2002017Constants.LIQUIDATION_V_KEYS_5, 3, null);
	}
	
	private void paintTable(FlexTable table, Mod2002017Key[][] liquidationKeys, int numCols, String header) {
		table.setWidth("100%");
		table.setCellSpacing(0);
