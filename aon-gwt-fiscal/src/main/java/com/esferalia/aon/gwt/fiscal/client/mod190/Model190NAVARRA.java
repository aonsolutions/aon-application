...
public class Model190NAVARRA extends Model190Base {
	...
	public Model190NAVARRA(Model190ModuleOptions options,Mod190 mod190,Model190Callback cbk,Integer selectedIndex) {
	...
	protected void paintPerceptorsTab(TabLayoutPanel tabPanel, Integer selectedIndex) {
		if ( getCallback().getMod190().getYear() >= 2021) {
			setDetailManager( new Model190NAVARRADetail2021( getCallback() , selectedIndex ));
		}
