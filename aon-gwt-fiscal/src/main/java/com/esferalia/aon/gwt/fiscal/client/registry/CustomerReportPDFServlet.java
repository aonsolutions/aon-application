...
@WebServlet(name = "Customer Report PDF Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/CustomerReportPDFServlet" })
public class CustomerReportPDFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition",
					"attachment; filename=\"Clientes." + MimeType.PDF.getExtension() + "\";");
