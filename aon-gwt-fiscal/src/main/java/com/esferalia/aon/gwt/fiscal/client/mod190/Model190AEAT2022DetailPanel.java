...
import com.esferalia.aon.gwt.fiscal.client.mod190.Model190AEATDetail2022.IModel190DetailCallback;
...
public class Model190AEAT2022DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190AEAT2022DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190AEAT2022DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(event -> {
			...
			Model190AEAT2022DetailPanel.enableOrDisableIlPanel(key, subkey, ilPanel);
			Model190AEAT2022DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
			callback.onValueChanged(detail);
		});
	...
	private static void enableOrDisableAdditionalDataPanel(ListBox key, ListBox subKey, Panel  panel) {
		...
		panel.setVisible( 
					Mod1902022Key.A == keyEnum
				|| (Mod1902022Key.B == keyEnum && "01".equals(subk))
				|| (Mod1902022Key.B == keyEnum && "02".equals(subk))
				|| (Mod1902022Key.B == keyEnum && "04".equals(subk))
				||  Mod1902022Key.C == keyEnum
