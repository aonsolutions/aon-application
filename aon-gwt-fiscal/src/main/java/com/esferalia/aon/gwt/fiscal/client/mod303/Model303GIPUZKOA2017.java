...
class Model303GIPUZKOA2017 extends Model303Base {
	
	protected Model303GIPUZKOA2017(Mod303 mod303,Model303Callback callback) {
		...
		IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions>() {
					...
					public Mod303 getModel() {
						return Model303GIPUZKOA2017.this.getModel();
					}
