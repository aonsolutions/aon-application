...
@WebServlet(name = "Mod3902025 Check AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902025CheckAEAT" })
public class Mod3902025CheckAEAT extends HttpServlet {
	
	private static final long serialVersionUID = -7151000884578887094L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			ModelAdmonUtils.checkAEAT(resp, aeatParams, mod3902025);
		} catch (Exception e) {
