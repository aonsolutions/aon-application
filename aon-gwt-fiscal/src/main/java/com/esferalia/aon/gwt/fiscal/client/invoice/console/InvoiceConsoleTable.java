	...
	private void onSearch(InvoiceConsoleModuleOptions opts, InvoiceConsoleParams params) {
		...
		InvoiceConsoleModule.INVOICE_SERVICE.getInvoices(opts.getOccam(), params, new AsyncCallback<LinkedList<InvoiceConsole>>() {
			...
			public void paintRow(InvoiceConsole invConsole, AonDisplayGridRow row) {
				...
				AonTableButton debugInvoice = new AonTableButton("DEBUG",AON.CSS.aonIconKeyboardArrowRight());
				...
				debugInvoice.addClickHandler( event -> debugInvoice(opts,inv, invoiceCallback));
