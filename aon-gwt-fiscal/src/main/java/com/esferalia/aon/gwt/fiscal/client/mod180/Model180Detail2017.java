...
public class Model180Detail2017 extends DockLayoutPanel implements IModel180Detail {
	...
	public Model180Detail2017( Model180BaseCallback callback, Integer selectedIndex ) {
		...
		table.addSelectionHandler( new SelectionHandler<Mod180Detail>() {
			...
			public void onSelection(SelectionEvent<Mod180Detail> event) {
				Model1802017DetailPanel panel = new Model1802017DetailPanel(event.getSelectedItem(), new IModel180DetailCallback() {
