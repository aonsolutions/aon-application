...
public interface IRequestParamsNames {
	...
	String ACCUMULATED_ACCOUNT = "accumulatedAccount";
	...
	String ALLOCATION_ACCOUNT = "allocationAccount";
	String AMORTIZATION_PARAMS = "amortizationParams";
	...
	String DEADLINE_FILLED = "deadlineFilled";
	String DEBIT = "debit";
	...
	String FROM_INITIAL_DATE = "fromInitialDate";
