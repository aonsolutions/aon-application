...
public abstract class JsVatComputeInfoGridPanel extends FlowPanel {
	
	private final Label title;
	private final Label subTitle;
	
	public JsVatComputeInfoGridPanel() {
		title = new Label();
	...
	public JsVatComputeInfoGridPanel setCaption( String title) {
		super.setTitle(title);
		this.title.setText(title);
		return this;
	}
	public JsVatComputeInfoGridPanel setSubTitle( String subTitle) {
		this.subTitle.setText(subTitle);	
		return this;
	}
	
	public JsVatComputeInfoGridPanel addContent(JsVatComputeInfo info) {
	...
	private HTMLPanel getFormula(JsVatComputeInfo info) {
		int i = 0;
	...
	private HTMLPanel getResult(JsVatComputeInfo info) {
		int i = 0;
		String pattern = info.getPattern();
