...
@WebServlet(name = "Mod3902022 Draft", urlPatterns = { "/aon_gwt_fiscal/Model3902022Draft" })
public class Mod3902022Draft extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902022ExcelAction action = new Mod3902022ExcelAction(mod390);
