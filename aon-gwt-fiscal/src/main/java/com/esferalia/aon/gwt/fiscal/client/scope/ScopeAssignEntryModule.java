...
public class ScopeAssignEntryModule implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(ScopeAssignEntryModule.class.getName());
	...
	private static ScopeAssignPanel scopeAssignPanel;
	...
	private void moduleLoad() {
		...
		scopeAssignPanel = new ScopeAssignPanel(options);
		
		options.getParentWidget().add(scopeAssignPanel);
	}
