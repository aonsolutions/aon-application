...
public class Model190AEATDetail2025 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190AEATDetail2025( Model190Callback callback, Mod190 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model190AEAT2025DetailPanel panel = new Model190AEAT2025DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
