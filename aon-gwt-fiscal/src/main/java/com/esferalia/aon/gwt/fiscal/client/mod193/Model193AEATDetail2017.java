...
public class Model193AEATDetail2017 extends DockLayoutPanel implements IModel193Detail {
	...
	public Model193AEATDetail2017( Model193BaseCallback callback, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod193Detail>() {
			...
			public void onSelection(SelectionEvent<Mod193Detail> event) {
				Model193AEAT2017DetailPanel panel = new Model193AEAT2017DetailPanel(event.getSelectedItem(), new IModel193DetailCallback() {
