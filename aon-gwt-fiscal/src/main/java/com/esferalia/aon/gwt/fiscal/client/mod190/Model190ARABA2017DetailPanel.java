...
import com.esferalia.aon.gwt.fiscal.client.mod190.Model190ARABADetail2017.IModel190DetailCallback;
...
public class Model190ARABA2017DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190ARABA2017DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190ARABA2017DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190ARABA2017DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
