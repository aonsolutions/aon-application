...
public class Model190NAVARRA2021DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190NAVARRA2021DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190NAVARRA2021DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190NAVARRA2021DetailPanel.enableOrDisableIlPanel(key, subkey, ilPanel);
				Model190NAVARRA2021DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
