...
public class PageF1F extends PageAbs {

	interface PageBinder extends UiBinder<Widget, PageF1F> {
	}
	...
	public PageF1F(Enterprise enterprise, NormalizedMemory nm) {
		super();
	...
	private void table(){
		...
		table.setWidget(row, 1, new Label("Descripci\u00F3n del negocio"));
