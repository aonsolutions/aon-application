...
public class Model184Partner2023 extends DockLayoutPanel implements IModel184Partner {
	...
	public Model184Partner2023( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model1842023PartnerPanel panel = new Model1842023PartnerPanel(event.getSelectedItem(), new IModel184PartnerCallback() {
