...
public class Model184Income2016 extends ResizeComposite {
	...
	interface Model184Income2014Binder extends UiBinder<Widget, Model184Income2016> {}
	...
	public void selectDetail() {
		...
		vatAccrualPayment.setValue(getDetail().isVatAccrualPayment());
	...
	@UiHandler("vatAccrualPayment")
	void onChangeVatAccrualPayment(ClickEvent event) {
		getDetail().setVatAccrualPayment(vatAccrualPayment.getValue());
		markAsDirty();
	}
