...
public class Model184Income2016 extends DockLayoutPanel implements IModel184Income {
	...
	public Model184Income2016( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Income>() {
			...
			public void onSelection(SelectionEvent<Mod184Income> event) {
				Model1842016IncomePanel panel = new Model1842016IncomePanel(event.getSelectedItem(), new IModel184IncomeCallback() {
