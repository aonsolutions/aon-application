...
public class Model190BIZKAIADetail2025 extends DockLayoutPanel implements IModel190Detail {
	...
	public Model190BIZKAIADetail2025( Model190Callback callback, Mod190 model, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( event -> {
			Model190BIZKAIA2025DetailPanel panel = new Model190BIZKAIA2025DetailPanel(event.getSelectedItem(), new IModel190DetailCallback() {
