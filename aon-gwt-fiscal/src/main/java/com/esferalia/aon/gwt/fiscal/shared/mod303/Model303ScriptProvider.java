...
public class Model303ScriptProvider {
	...
	public static IModelScript<Mod303Key>[] obtainScript(Mod303 mod303) {
		...
		if (mod303.getYear() > 2014) {
			if (mod303.isAEAT() && (mod303.getYear() > 2021 || (mod303.getYear() == 2021 && mod303.getPeriod().isLastSemester()))) {
				ms = Model3032021_2PrintAEATScript.values();
			} else if (mod303.isAEAT() && mod303.getYear() == 2021 && mod303.getPeriod().isFirstSemester()) {
