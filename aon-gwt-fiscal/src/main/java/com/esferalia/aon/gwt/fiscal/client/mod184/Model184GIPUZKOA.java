...
public class Model184GIPUZKOA extends Model184Base {
	...
	public Model184GIPUZKOA(Model184Callback cbk,Mod184 mod184, Integer selectedIncomeIndex,Integer selectedPartnerIndex) {
		super(cbk,mod184);
		...
		IFiscalModelAdmonPanelCallback<Mod184, Model184ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod184, Model184ModuleOptions>() {
				...
				public Mod184 getModel() {
					return Model184GIPUZKOA.this.getModel();
				}
