...
public class Model123Bizkaia extends Model123Base {
	...
	public Widget getInfoPanel(Mod123 mod123) {
		...
		panel.add(getAnchorPanel(mod123,"Impreso Rellenable." 
		...
		panel.add(getAnchorPanel(mod123 ,"Instrucciones"
			,"http://www.bizkaia.eus/fitxategiak/05/ogasuna/ereduak/Argitaratu/123EurBilInst.pdf"));
		panel.add(getAnchorPanel(mod123,"Orden Foral 1.330/2000, de 27 de abril"
			,"http://www.bizkaia.eus/Lehendakaritza/Bao_Bob/2000/06/20000601a104.pdf"));
		panel.add(getAnchorPanel(mod123,"Enlace a las fechas de vencimiento en el a\u00F1o vigente"
			,"http://www.bizkaia.eus/ogasuna/egutegia/egutegia_anual.asp?id=0&Modelos=249&Age_Codigo=25/02/2016&Tem_Codigo=5346"));
		panel.add(getAnchorPanel(mod123,"Enlace a la gu\u00EDa de informaci\u00F3n tributaria GURE GIDA"
