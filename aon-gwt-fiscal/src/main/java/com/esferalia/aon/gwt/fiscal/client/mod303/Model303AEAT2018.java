...
class Model303AEAT2018 extends Model303AEAT {
	...
	protected Model303AEAT2018(Mod303 mod303,Model303Callback callback) {
	...
	private Model303AEATActivityTable getActivityTable() {
		...
		activityTable.addSelectionHandler(event ->  {
			...
			Model303AEATActivity2018 actPanel = new Model303AEATActivity2018(activityCallback, getModel().isLastPeriod());
