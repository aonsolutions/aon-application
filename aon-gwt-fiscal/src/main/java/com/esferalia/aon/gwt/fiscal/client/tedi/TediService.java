...
public interface TediService extends RemoteService {
	...
	LinkedList<TediResult> getVerifiedInvoices(String domainName, String user, int domain) throws AonCoreException;
	TediResult getInvoice(String domainName, String user, int domain, String uuid) throws AonCoreException;
