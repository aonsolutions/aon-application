...
class Page01 extends PageAbs {
	...
	public Page01(Model3902025Callback callback) {
		super(callback);
		paint();
		setValue();
	}
...
//			.addCell(new Label(""),AON.CSS.aonWidth20());
			.addCell(new Label(AON.MSG.description()),AON.CSS.aonWidth400())
...
//		tab.addRow()
//			.addCell(new Label(AON.MSG.document()), AON.CSS.aonTableLabel(), AON.CSS.aonWidth300())
//			.addCell(mergedDeclarationDocument);
//		tab.addRow()
//			.addCell(new Label(AON.MSG.companyName()), AON.CSS.aonTableLabel(), AON.CSS.aonWidthAuto())
//			.addCell(mergedDeclarationName);
		tab.addRow()
			.addCell(new Label(AON.MSG.document()), AON.CSS.aonWidth300())
			.addCell(mergedDeclarationDocument);
		tab.addRow()
