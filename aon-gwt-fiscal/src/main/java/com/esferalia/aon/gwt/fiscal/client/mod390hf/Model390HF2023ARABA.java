...
public class Model390HF2023ARABA extends Model390HFBase {
	 
	public Model390HF2023ARABA(Model390HFCallback callback,Mod390HF mod390HF) {
	...
	private void paintGeneralRegimenTab(TabLayoutPanel tabPanel) {
		...
		paintDeclaration(table,Model3902023ARABARScript1.values(),8);
		
		paintScript(table,Model3902023ARABAScript2.values() ,8);
		...
		IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions>() {
					...
					public Mod390HF getModel() {
						return Model390HF2023ARABA.this.getModel();
					}
