...
@WebServlet(name = "Creditor XLS Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/CreditorXLSServlet" })
public class CreditorXLSServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition", "attachment; filename=\"ACREEDORES."+ MimeType.MS_EXCEL_2007.getExtension()+ "\";");
