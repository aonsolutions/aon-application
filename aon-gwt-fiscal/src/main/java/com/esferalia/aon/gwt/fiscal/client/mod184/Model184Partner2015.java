...
public class Model184Partner2015 extends DockLayoutPanel implements IModel184Partner {
	...
	public Model184Partner2015( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Partner>() {
			...
			public void onSelection(SelectionEvent<Mod184Partner> event) {
				Model1842015PartnerPanel panel = new Model1842015PartnerPanel(event.getSelectedItem(), new IModel184PartnerCallback() {
