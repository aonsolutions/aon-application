...
class Model303AEAT2023Activity extends DockLayoutPanel implements HasValueChangeHandlers<Mod303Activity> {
	...
	private Widget getModulesStaffDataPanel(IModel303AEATActivityCallback<Mod303Activity> callback) {
		...
		tab.addRow()
			.addCell( new Label("Horas anuales"), AON.CSS.aonBold(), AON.CSS.aonWidth600() )
			.addCell( new Label("") );
		...
		tab1.addRow()
			.addCell( new Label(AON.MSG.ownerHours()), AON.CSS.aonBorderBottom() )
			.addCell( ownerHours);
		...
		flowPanel.add(AonGroupPanel.get(AON.MSG.header1Table3(), tab));
		flowPanel.add(AonGroupPanel.get(AON.MSG.noSalariedStaff(), tab1));
		
		Label msg1 = new Label(AON.MSG.actMsg1());
		msg1.setStyleName(AON.CSS.aonBold());
		msg1.addStyleName(AON.CSS.aonMarginTop());
		flowPanel.add(msg1);
		
		Label msg2 = new Label(AON.MSG.actMsg2());
		msg2.setStyleName(AON.CSS.aonMarginTop());
		flowPanel.add(msg2);
	...
	private Widget getModulesDeskDataPanel(IModel303AEATActivityCallback<Mod303Activity> callback) {
		...
		tab.addHeaderRow()
			.addCell( new Label("Capacidad"), AON.CSS.aonWidth150())
			.addCell( new Label("Mesas"), AON.CSS.aonWidth150(), AON.CSS.aonTextRight())
			.addCell( new Label("Días"), AON.CSS.aonWidth150() )
		;	
	...
	private void paintDeskRow(IModel303AEATActivityCallback<Mod303Activity> callback, AonDisplayTable tab, Model303AEAT2023ActivityDesk d) {
		...
		tab.addRow()
			...
			.addCell(d.days, AON.CSS.aonTextRight())
			;
	}
