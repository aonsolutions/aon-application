...
public class Model190ARABA2016DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190ARABA2016DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190ARABA2016DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190ARABA2016DetailPanel.enableOrDisableIlPanel(key, subkey, ilPanel);
				Model190ARABA2016DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
