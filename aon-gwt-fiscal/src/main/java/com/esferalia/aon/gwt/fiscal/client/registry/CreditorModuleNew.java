...
public class CreditorModuleNew implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(CreditorModuleNew.class.getName());
	...
	private CreditorModulePanel creditorModulePanel;
	...
	public void moduleLoad() {
		...
		creditorModulePanel = new CreditorModulePanel(options) {

			@Override
			protected void onCreditorCreate(CreditorFull creditor) {
				// TODO Auto-generated method stub
				
			}};
		
		options.getParentWidget().add(creditorModulePanel);
	}
