...
public enum Model3902017PrintARABAScript implements IModelScript<Mod390Key> {
	...
	,ADC03 (Mod390Key.AR_C154.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C154})
	,ADC04 (Mod390Key.AR_C155.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C155})
	,ADC05 (Mod390Key.AR_C156.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C156})
	,ADC06 (Mod390Key.AR_C157.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C157})
	,ADC07 (Mod390Key.AR_C158.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C158})
	,ADC08 (Mod390Key.AR_C210.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C210})
	,ADC09 (Mod390Key.AR_C211.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C211})
	,ADC10 (Mod390Key.AR_C212.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C212})
	,ADC11 (Mod390Key.AR_C161.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C161})
	,ADC12 (Mod390Key.AR_C162.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C162})
	,ADC13 (Mod390Key.AR_C163.getDescription() 	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C163})
	,ADC14 (Mod390Key.AR_C167.getDescription()	,new Mod390Key[]{null			  ,null				,Mod390Key.AR_C167})
	,ADC15 ("Exclusivamente para aquellos sujetos pasivos acogidos al R\u00E9gimen especial del criterio de caja y para "
			+"aquellos que sean destinatarios de operaciones afectadas por el mismo:",null)
	,ADC16 (getDescription(Mod390Key.AR_C262)	,new Mod390Key[]{null			  ,Mod390Key.AR_C262,Mod390Key.AR_C263})	
	,ADC17 (getDescription(Mod390Key.AR_C264)	,new Mod390Key[]{null			  ,Mod390Key.AR_C264,Mod390Key.AR_C265})
	;
