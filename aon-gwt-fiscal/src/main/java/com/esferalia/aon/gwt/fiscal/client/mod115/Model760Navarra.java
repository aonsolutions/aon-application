...
public class Model760Navarra extends Model115Base {
	...
	private static final String DOWNLOAD_TEXT = "Descargar fichero para su presentaci\u00F3n.";
	
	public Model760Navarra(IFiscalModelCallback<Mod115> callback, AonData aonData) {
