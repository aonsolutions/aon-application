...
//		double aa02 = getModel().getAmount(Mod421Key.CT_A02);
...
//		}
//		if (getModel().isLastPeriod()) {
//			double aa11 = getModel().getAmount(Mod421Key.CT_A11);
//			if (event.getItem() == LAST_PERIOD_INFORMATION_TAB && aa11 == 0) {
//				event.cancel();
//				AonMessageDialog.warning("Para rellenar estos datos, debe rellenar la casilla \""+Mod421Key.CT_A11.getDescription()+ "\" en la solapa \"Declaraci\u00F3n\"");
//			}
//		}
//	}
...
//			paintDeclaration(table,Model4212025ATCGeneralRegimeScript1.values(),8);
//		else
//			paintDeclaration(table,Model4212024T3ATCGeneralRegimeScript1.values(),8);
//		container.add(table);
//		
//		table = new FlexTable();
//		table.setWidth("100%");
...
//		paintDeclaration(table,Model4212022ATCGeneralRegimeScript2.values(),6);
//		container.add(table);
//		
...
//		if (getModel().isLastPeriod()) {
//			paintDeclaration(table,Model4212026ATCSimplifiedRegime4TScript.values(),3);
//		} else {
//			paintDeclaration(table,Model4212026ATCSimplifiedRegimeScript.values(),3);
//		}
...
//		if (getModel().isLastPeriod() && AonMathUtils.isNotZero(getModel().getAmount(Mod421Key.CT_C110))) {
...
//			l781.addClickHandler(event -> getFieldsMap().get(Mod421Key.CT_C78).setValue(0.0,true));
//			
...
//			l782.addClickHandler(event -> getFieldsMap().get(Mod421Key.CT_C78).setValue(getModel().getAmount(Mod421Key.CT_C110),true));
//
...
//				double c66 = AonNumberUtils.todouble( getFieldsMap().get(Mod421Key.CT_C66).getValue());
//				double c77 = AonNumberUtils.todouble( getFieldsMap().get(Mod421Key.CT_C77).getValue());
//				double amount = AonMathUtils.round(c66+c77); 
//				getFieldsMap().get(Mod421Key.CT_C78).setValue(amount,true);
//			});
//			
...
//			paintEmptyRow(table);
//			paintEmptyRow(table);
//			paintScript(table,Model4212024T3ATCResultScript2.values(),3);
//		}
...
//		paintDeclaration(table,Model4212022ATCAdditionalDataScript.values(),3);
//	}
...
//		a12.addItem(SI_1, "1");
//		a12.addItem(NO_2, "2");
//		paintListBox(a12, Mod421Key.CT_A12, table);
		
//		cm2 = paintCheck(Mod421Key.CM_002,table);	// Inscrito en el Registro de devolución mensual (Art. 30 RIVA)
//		paintA02(Mod421Key.CT_A02,table);			// Tributa exclusivamente en régimen simplificado
//		a03 = paintCheck(Mod421Key.CT_A03,table);	// Autoliquidación conjunta
//		a07 = paintCheck(Mod421Key.CT_A07,table);	// Acogido al régimen especial del criterio de Caja (art. 163 undecies LIVA)
//		a08 = paintCheck(Mod421Key.CT_A08,table);	// Destinatario de operaciones acogidas al régimen especial del criterio de caja
//		
//		a09 = paintCheck(Mod421Key.CT_A09,table);	// Opción por la aplicación de la prorrata especial
//		a10 = paintCheck(Mod421Key.CT_A10,table);	// Revocación de la opción por la aplicación de la prorrata especial
		
		x03 = paintCheck(Mod421Key.X03,table);	// Concurso de acreedores 
//		a05 = paintDate (Mod421Key.CT_A05,table);	// Fecha en que se dictó el auto de declaración de concurso
...
//		paintListBox(a06, Mod421Key.CT_A06, table);
...
//		a13.addItem(SI_1, "1");
//		a13.addItem(NO_2, "2");
//		paintListBox(a13, Mod421Key.CT_A13, table);
...
//		a14.addItem(SI_1, "1");
//		a14.addItem(NO_2, "2");
//		paintListBox(a14, Mod421Key.CT_A14, table);
...
//		paintListBox(a11, Mod421Key.CT_A11, table);
//		a11.setEnabled(getModel().isLastPeriod());
//		if (getModel().isLastPeriod()) {
//			a11.addChangeHandler( event -> {
//				if (a11.getSelectedIndex() != 0 && (
//					AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_U1D))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_U2D))								
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_U3D))								
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_U4D))
//				 || AonMathUtils.isNotZero( getModel().getAmount(Mod421Key.CT_C88))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_P1C))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_P2C))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_P3C))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_P4C))
//				 || AonStringUtils.isNotBlank(getModel().getDescription(Mod421Key.CT_P5C)))) {
//
//					Mod421Key[] keys = new Mod421Key[]{
//							 Mod421Key.CT_U1D,Mod421Key.CT_U1C,Mod421Key.CT_U1E
//							,Mod421Key.CT_U2D,Mod421Key.CT_U2C,Mod421Key.CT_U2E
//							,Mod421Key.CT_U3D,Mod421Key.CT_U3C,Mod421Key.CT_U3E
//							,Mod421Key.CT_U4D,Mod421Key.CT_U4C,Mod421Key.CT_U4E
//							,Mod421Key.CT_U5D,Mod421Key.CT_U5C,Mod421Key.CT_U5E
//							
//							,Mod421Key.CT_U13,Mod421Key.CT_C89,Mod421Key.CT_C90,Mod421Key.CT_C91,Mod421Key.CT_C92
//							,Mod421Key.CT_C107
//							,Mod421Key.CT_C80,Mod421Key.CT_C81,Mod421Key.CT_C93,Mod421Key.CT_C94
//							,Mod421Key.CT_C83,Mod421Key.CT_C84,Mod421Key.CT_C85,Mod421Key.CT_C86,Mod421Key.CT_C95
//							,Mod421Key.CT_C96,Mod421Key.CT_C97,Mod421Key.CT_C98,Mod421Key.CT_C79,Mod421Key.CT_C99 
//							,Mod421Key.CT_C88
//							
//							,Mod421Key.CT_P1C,Mod421Key.CT_P1I,Mod421Key.CT_P1D,Mod421Key.CT_P1T,Mod421Key.CT_P1P
//							,Mod421Key.CT_P2C,Mod421Key.CT_P2I,Mod421Key.CT_P2D,Mod421Key.CT_P2T,Mod421Key.CT_P2P
//							,Mod421Key.CT_P3C,Mod421Key.CT_P3I,Mod421Key.CT_P3D,Mod421Key.CT_P3T,Mod421Key.CT_P3P
//							,Mod421Key.CT_P4C,Mod421Key.CT_P4I,Mod421Key.CT_P4D,Mod421Key.CT_P4T,Mod421Key.CT_P4P
//							,Mod421Key.CT_P5C,Mod421Key.CT_P5I,Mod421Key.CT_P5D,Mod421Key.CT_P5T,Mod421Key.CT_P5P
//					};
//					for (Mod421Key key : keys) {
...
//			r00 = paintCheck(Mod421Key.CT_R00,table);	// Rectificativa - Como consecuencia de la presentación de la autoliquidación rectificativa solicito dar de baja/modificar la domiciliación efectuada
//			r01 = paintCheck(Mod421Key.CT_R01,table);	// Rectificativa - Motivo de la rectificación: Rectificaciones (excepto incluidas en el motivo siguiente)
//			r02 = paintCheck(Mod421Key.CT_R02,table);	// Rectificativa - Motivo de la rectificación: Discrepancia criterio administrativo
		}	
...
//	private void paintA02(Mod421Key key, FlexTable table) {
//		a02 = new ListBox();
...
//		
//		paintActivityRow(tab,Mod421Key.CT_U1D,Mod421Key.CT_U1C,Mod421Key.CT_U1E);
//		paintActivityRow(tab,Mod421Key.CT_U2D,Mod421Key.CT_U2C,Mod421Key.CT_U2E);
//		paintActivityRow(tab,Mod421Key.CT_U3D,Mod421Key.CT_U3C,Mod421Key.CT_U3E);
//		paintActivityRow(tab,Mod421Key.CT_U4D,Mod421Key.CT_U4C,Mod421Key.CT_U4E);
//		paintActivityRow(tab,Mod421Key.CT_U5D,Mod421Key.CT_U5C,Mod421Key.CT_U5E);
//		
//		actContainer.add(tab);
//		table.setWidget(1, 0, actContainer);
//		table.getFlexCellFormatter().setColSpan(1, 0, 4);
//		
//		paintCheck(Mod421Key.CT_U13, table);
//		
//		paintScript(table,Model4212022ATC390nfoScript.values(),3);
//		
...
//		
//		paintProrrateRow(tab2,Mod421Key.CT_P1C,Mod421Key.CT_P1I,Mod421Key.CT_P1D,Mod421Key.CT_P1T,Mod421Key.CT_P1P);
//		paintProrrateRow(tab2,Mod421Key.CT_P2C,Mod421Key.CT_P2I,Mod421Key.CT_P2D,Mod421Key.CT_P2T,Mod421Key.CT_P2P);
//		paintProrrateRow(tab2,Mod421Key.CT_P3C,Mod421Key.CT_P3I,Mod421Key.CT_P3D,Mod421Key.CT_P3T,Mod421Key.CT_P3P);
//		paintProrrateRow(tab2,Mod421Key.CT_P4C,Mod421Key.CT_P4I,Mod421Key.CT_P4D,Mod421Key.CT_P4T,Mod421Key.CT_P4P);
//		paintProrrateRow(tab2,Mod421Key.CT_P5C,Mod421Key.CT_P5I,Mod421Key.CT_P5D,Mod421Key.CT_P5T,Mod421Key.CT_P5P);
//
...
//	private void paintProrrateRow(FlexTable tab, Mod421Key cnaeKey, Mod421Key amountKey, Mod421Key amountRightKey, Mod421Key typeKey, Mod421Key percentKey) {
...
//	private void paintActivityRow(FlexTable tab, Mod421Key desKey, Mod421Key keyKey, Mod421Key epiKey) {
//		int row = tab.getRowCount();
//
