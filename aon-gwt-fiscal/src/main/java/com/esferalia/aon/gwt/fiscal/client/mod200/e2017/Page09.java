...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ1032Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ1033_1Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ1033_2Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ547Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ554Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ561Key;
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.Mod2002017LQ579Key;
...
/**/			if (key == Mod2002017Key.LQ554) {
					row = paintKeyBreakdownLink(table,row,AON.MSG.cooperativeRegime()
							,Mod2002017LQ554Key.values(),HEADERS_1);
				}
				if (key == Mod2002017Key.LQ561) {
					row = paintKeyBreakdownLink(table,row,Mod2002017Key.LQ561.getDescription()
							,Mod2002017LQ561Key.values(),HEADERS_2);
				}
/**/			if (key == Mod2002017Key.LQ579) {
					row = paintKeyBreakdownLink(table,row,Mod2002017Key.LQ579.getDescription()
							,Mod2002017LQ579Key.values(),null);
				}

				 
/**/			if (key == Mod2002017Key.LQ1032 
					...
					row = paintKeyBreakdownLink(table,row,Mod2002017Key.LQ1032.getDescription()
							,Mod2002017LQ1032Key.values(),HEADERS_3);
				}
/**/			if (key == Mod2002017Key.LQ547 && !callback.getMod200Object().getMod200().isCooperativa()) {
					row = paintKeyBreakdownLink(table,row,Mod2002017Key.LQ547.getDescription()
							,Mod2002017LQ547Key.values(),HEADERS_2);
				}
/**/			if (key == Mod2002017Key.LQ1033) {
					row = paintKeyBreakdownLinkLQ1033(table,row,Mod2002017Key.LQ1033.getDescription());
				}
	...
	protected int paintKeyBreakdownLinkLQ1033(final FlexTable tab,int row,final String label) {
		...
		int r = 1;
		int col = 0;
		for (IMod200KeysProvider key : Mod2002017LQ1033_1Key.values()) {
			...
			col = 1;
			for (final Mod2002017Key k : key.getKeys() ) {
				if (k != null){
		...
		r = 1;
		col = 0;
		for (IMod200KeysProvider key : Mod2002017LQ1033_2Key.values()) {
			Label desc = new Label(key.getDescription() );
