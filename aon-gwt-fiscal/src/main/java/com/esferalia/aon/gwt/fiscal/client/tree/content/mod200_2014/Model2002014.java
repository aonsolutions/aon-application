...
public class Model2002014 extends ResizeComposite  {
	...
	protected Mod2002014TreeObject mod200Object;
...
//	Button aeatPrintButton;
	...
	protected void paintHeaderTable(final Mod2002014 mod200) {
		...
		headerTable.getFlexCellFormatter().addStyleName(1, 0, TreeNode.getAdministrationBG(mod200.getAdministration()));
...
//		aeatPrintButton.setVisible(mod200Object.isInitialized() && mod200Object.getMod200().getId() != null);
	...
	public void startModel(final Mod2002014TreeObject treeObject, final AsyncCallback<Mod2002014> callback) {
		...
		popup.setAnimationEnabled(true);
		popup.center();
		mod200Object.getMod200ByYear( new AsyncCallback<Mod2002014>() {
			@Override
			public void onSuccess(Mod2002014 result) {
	...
	private void populatePages(Mod2002014TreeObject mod200Object) {
		page00.populate(mod200Object);
