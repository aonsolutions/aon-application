...
import com.esferalia.aon.gwt.fiscal.client.mod190.Model190GIPUZKOADetail2016.IModel190DetailCallback;
...
public class Model190GIPUZKOA2016DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190GIPUZKOA2016DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		Model190GIPUZKOA2016DetailPanel.setValue(key, subkey, detail);
		...
		key.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				Model190GIPUZKOA2016DetailPanel.enableOrDisableIlPanel(key, subkey, ilPanel);
				Model190GIPUZKOA2016DetailPanel.enableOrDisableAdditionalDataPanel(key, subkey, additionalDataPanel);
				callback.onValueChanged(detail);
			}
		});
