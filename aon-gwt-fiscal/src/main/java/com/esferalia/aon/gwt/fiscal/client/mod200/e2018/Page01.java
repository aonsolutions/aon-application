...
public class Page01 extends PageAbs {
	...
	public void dump() {
		...
		this.fiscalGroup.setEnabled( 
				callback.getMod200Object().getMod200().isChecked(Mod2002018Key.C0009) 
			  || callback.getMod200Object().getMod200().isChecked(Mod2002018Key.C0010));	
		...
		this.dominantIdentificationNumber.setEnabled(callback.getMod200Object().getMod200().isChecked(Mod2002018Key.C0010));	
