...
import com.esferalia.aon.gwt.fiscal.client.mod184.Model184Partner2014.IModel184PartnerCallback;
...
public class Model1842014PartnerPanel extends SimpleLayoutPanel implements Focusable {
	
	private static final String WIDTH_150PX = "150px";
	private static final String PERDIDAS = "02 - P\u00E9rdidas.";
	private static final String GANANCIAS = "01 - Ganancias.";
	...
	public Model1842014PartnerPanel(Mod184Partner partner, IModel184PartnerCallback callback) {
		...
		Model1842014PartnerPanel.setValue(key, subkey, partner);
