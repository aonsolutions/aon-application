...
class Model303AEATActivity2018 extends DockLayoutPanel implements HasValueChangeHandlers<Mod303Activity> {
	...
	protected Model303AEATActivity2018(final IMod303ActivityCallback callback, boolean lastPeriod) {
		super(Unit.PX);
		...
		tabLayoutPanel.add(modulesPanel, TAB_TEMPLATE.render(AON.MSG.modules(), AON.CSS.aonIconList()));
	...
	private void paintModuleRow(Mod303Activity act,FlexTable table, final int index, Label description, 
		...
		table.getCellFormatter().setStyleName(row, 0, AON.CSS.aonFontSmall());
		...
		table.getCellFormatter().setStyleName(row, 2, AON.CSS.aonFontSmall());
