...
class Model303AEAT2021 extends Model303AEAT {
	...
	protected Model303AEAT2021(Mod303 mod303,Model303Callback callback) {
	...
	private void paintDeclarationTab(TabLayoutPanel tabPanel) {
		...
		if (getModel().isLastPeriod()) {
			a11.addChangeHandler( event -> lastPeriodChangeListener(a11));
		}
	...
	private void lastPeriodChangeListener(ListBox a11) {
		if (a11.getSelectedIndex() != 0 && (AonStringUtils.isNotBlank(getModel().getDescription(Mod303Key.CT_U1D))
