...
public class Mod2002015Object implements Serializable {
	...
	public Mod2002015Object(String currentDomainName,Mod2002015 mod200) {
	...
	public void initializeMod200(final AsyncCallback<Mod2002015> callback) {
		Model200.getMod2002015Service().initializeMod2002015(domainName,mod200.getDomain(),mod200, new AsyncCallback<Mod2002015>() {
	...
	public void save(final AsyncCallback<Mod2002015> callback) {
		Model200.getMod2002015Service().saveMod2002015(domainName,mod200.getDomain(),mod200, new AsyncCallback<Mod2002015>() {
	...
	public void delete(final AsyncCallback<Void> callback) {
		Model200.getMod2002015Service().deleteMod2002015(domainName,mod200.getDomain(),mod200.getId(), new AsyncCallback<Void>() {
...
//		Model200.getMod2002015Service().getMod2002015ById(domainName,mod200.getDomain(), getId(), new AsyncCallback<Mod2002015>() {
//			
//			@Override
//			public void onSuccess(Mod2002015 result) {
//				mod200 = result;
...
//		Model200.getMod2002015Service().createMod2002015(domainName,mod200.getDomain(), mod200.getYear(), new AsyncCallback<Mod2002015>() {
//			
//			@Override
//			public void onSuccess(Mod2002015 result) {
//				mod200 = result;
...
//	}
	...
	public void fillMod2002015AccountingData(final AsyncCallback<Mod2002015> callback) {
		Model200.getMod2002015Service().fillMod2002015AccountingData(mod200, new AsyncCallback<Mod2002015>() {
	...
	public void validate(final AsyncCallback<Mod2002015> callback) {
		Model200.getMod2002015Service().validateMod2002015(mod200, new AsyncCallback<Mod2002015>() {
	...
	public void dumpAEAT(final AsyncCallback<String> callback) {
		Model200.getMod2002015Service().dumpAEATMod2002015(mod200, new AsyncCallback<String>() {
	...
	public void getCompanyBanks(final AsyncCallback<LinkedList<CompanyBank>> callback) {
		Model200.getMod2002015Service().getCompanyBanks(domainName,mod200.getDomain(),new AsyncCallback<LinkedList<CompanyBank>>() {
