...
import com.esferalia.aon.gwt.fiscal.shared.mod303.Model3032017ARABAScript2;
...
class Model303ARABA2017 extends Model303Base {
	
	protected Model303ARABA2017(Mod303 mod303,Model303Callback callback) {
		...
		IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod303, Model303ModuleOptions>() {
					...
					public Mod303 getModel() {
						return Model303ARABA2017.this.getModel();
					}
