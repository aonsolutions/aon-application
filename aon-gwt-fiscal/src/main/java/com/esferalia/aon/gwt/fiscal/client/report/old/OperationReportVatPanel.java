...
class OperationReportVatPanel extends ScrollPanel{
	...
	private JsOperationVatGridPanel grid = new JsOperationVatGridPanel();
	
	public OperationReportVatPanel(OperationReportModuleOptions options, OperationParams params) {
