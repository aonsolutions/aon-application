...
class Model303AEAT2026 extends Model303AEAT {
	...
	protected Model303AEAT2026(Mod303 mod303,Model303Callback callback) {
	...
	private void paintResultTab(TabLayoutPanel tabPanel) {
		...
		paintDeclaration(table,Model3032026AEATResultScript.values(),3);
