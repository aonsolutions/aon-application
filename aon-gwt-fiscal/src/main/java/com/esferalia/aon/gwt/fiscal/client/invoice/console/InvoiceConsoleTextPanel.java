...
public class InvoiceConsoleTextPanel extends ScrollPanel {
	...
	private InvoiceConsoleTextPanel finances(Invoice invoice, StringBuilder out) {
		...
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.rightPad("FORMA PAGO", 10));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.rightPad("CUENTA BANACARIA", 40));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.rightPad("ESTADO", 10));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad("IMPORTE", 17));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(" ", getLineSize() - buf.length()));
	...
	private void finance(Finance finance, StringBuilder out) {
		...
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.center(AonStringUtils.abbreviate(finance.getPayMethodName(),10), 10));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.center(AonStringUtils.abbreviate((finance.getBankAccount()==null?"":finance.getBankAccount().getIban()),40), 40));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.center(AonStringUtils.abbreviate(FinanceStatus.safeDescriptionOf(finance.getFinanceStatus()),10), 10));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(AON.FMT.format(finance.getAmount()), 17));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(" ", getLineSize() - buf.length()));
		buf.append(VERTICAL_BAR);
		println(out,buf.toString());
