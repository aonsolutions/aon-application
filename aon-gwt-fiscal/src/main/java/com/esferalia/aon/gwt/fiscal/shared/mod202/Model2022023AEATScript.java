...
public enum Model2022023AEATScript implements IModelScript<Mod202Key> {
	...
	,R_1 (Mod202Key.X20.getDescription(),new Mod202Key[]{Mod202Key.X20},NONE)
	...
	private Model2022023AEATScript(String label, Mod202Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
