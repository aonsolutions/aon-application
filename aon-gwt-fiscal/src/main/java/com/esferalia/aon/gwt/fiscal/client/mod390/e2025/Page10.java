...
class Page10 extends PageAbs {
	...
	public Page10(Model3902025Callback callback) {
		super(callback);
		paint();
		setValue();
	}
	...
	private void paint() {
		...
		basePanel.add(getTitle(AON.MSG.prorrata()));
		...
		basePanel.add(tab);
		tab.addRow()
			.addCell( new Label("CNAE2025"),AON.CSS.aonBold(),AON.CSS.aonBorderBottom(),AON.CSS.aonWidth80())
...
//			.addCell( new Label(AON.MSG.activityDescription()),AON.CSS.aonBold(),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
			.addCell( new Label(AON.MSG.activityDescription()),AON.CSS.aonBold(),AON.CSS.aonBorderBottom(),AON.CSS.aonWidth200())
			...
			//.addCell( new Label(""),AON.CSS.aonBold(),AON.CSS.aonBorderBottom(),AON.CSS.aonWidth20())
			.addCell( new Label(""),AON.CSS.aonBold(),AON.CSS.aonBorderBottom(),AON.CSS.aonWidthAuto())
		;
		...
		for ( int i = 0; i < getModel().getProrratas().size(); i++) {
			...
			cnaeDescription.setMaxLength(50);
			cnaeDescription.setVisibleLength(50);
			...
			cnaeButton.addClickHandler(event -> {
				AonCnae2025Panel cnaePanel = new AonCnae2025Panel();
				cnaePanel.addSelectionHandler(event1 -> {
					CNAE2025 c = event1.getSelectedItem();
