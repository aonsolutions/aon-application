...
public interface SiiService extends RemoteService {
	...
	String refresh140(String domainName, int domainId, String user, Invoice invoice, AEATParams aeatParams);
	String refresh240(String domainName, int domainId, String user, Invoice invoice, AEATParams aeatParams);
