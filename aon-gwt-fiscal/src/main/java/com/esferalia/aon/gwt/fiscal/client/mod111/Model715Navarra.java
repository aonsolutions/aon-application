...
public class Model715Navarra extends Model111Base {
	...
	public Model715Navarra(Mod111 mod111, Model111Callback callback) {
		...
		IFiscalModelAdmonPanelCallback<Mod111, Model111ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod111, Model111ModuleOptions>() {
				...
				public Mod111 getModel() {
					return Model715Navarra.this.getModel();
				}
				...
				public String getModelInformationURL() {
					return "https://www.navarra.es/es/tramites/on/-/line/Retenciones?back=true&pageBackId=5722676";
				}
		};
