...
public class Mod111CheckAEAT extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(Mod111CheckAEAT.class.getName()); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String year = AonNumberUtils.toString(mod111.getYear());
					
			String urlParameters = MessageFormat.format("NIF={0}&ANR={1}&MOD=111&EJF={2}&PER={3}&FED={4}&FEH={5}&HOD={6}&HOH={7}"
					,mod111.getDocument()
					,mod111.getFullName()
					,year
