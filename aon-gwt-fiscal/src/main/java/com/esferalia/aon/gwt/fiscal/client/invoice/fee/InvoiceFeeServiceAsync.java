...
public interface InvoiceFeeServiceAsync {
	...
	// ***************************************** [SEARCH]
	// **************************************************
	void getProductsSuggestion(Occam occam, Integer searchDomain, String productQuery, AsyncCallback<LinkedList<Item>> callback) throws AonCoreException;

	// **************************************************
	// ************************************** [INVOICING]
	// **************************************************
	void getInvoices(Occam occam, FeeBillingParams params, AsyncCallback<LinkedList<Invoice>> callback) throws AonCoreException;
}
