...
public class Model193AEATDetail2015 extends DockLayoutPanel implements IModel193Detail {
	...
	public Model193AEATDetail2015( Model193BaseCallback callback, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod193Detail>() {
			...
			public void onSelection(SelectionEvent<Mod193Detail> event) {
				Model193AEAT2015DetailPanel panel = new Model193AEAT2015DetailPanel(event.getSelectedItem(), new IModel193DetailCallback() {
