...
public class Model347NAVARRA extends Model347Base {
	...
	public Model347NAVARRA(Model347ModuleOptions options, Mod347 mod347, Model347Callback cbk, Integer selectedIndexDeclared, Integer selectedIndexAsset, int tabPanelIndex) {
	...
	protected LinkedList<Pair<String, String>> getInformationLinks() {
		...
		list.add(new Pair<String, String>("Informaci\u00F3n general." 
				,"http://www.navarra.es/home_es/servicios/ficha/1791/Declaracion-anual-de-operaciones-con-terceras-personas-(F50-347)"));
		return list;
	}
