...
public class MailAccountEntryModule implements EntryPoint {
	
	private static final Logger LOGGER = Logger.getLogger(MailAccountEntryModule.class.getName());
	...
	private static MailAccountEntryPanel mailAccountEntryPanel;
	...
	private void moduleLoad() {
		...
		mailAccountEntryPanel = new MailAccountEntryPanel(options);
		
		options.getParentWidget().add(mailAccountEntryPanel);
	}
