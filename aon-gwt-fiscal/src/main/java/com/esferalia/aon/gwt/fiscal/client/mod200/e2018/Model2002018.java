...
public class Model2002018 extends ResizeComposite  {
	...
	protected interface Model200PageCallback {
		public Mod2002018Object getMod200Object();
	}
	
	private PageAbs[] PAGES = new PageAbs[20];
	private int P00 = 0;
	
	interface Model2002018Binder extends
			UiBinder<Widget, Model2002018> {
	}

	private static final Model2002018Binder binder = GWT
			.create(Model2002018Binder.class);

	protected Mod2002018Object mod200Object;
	...
	public Model2002018(Model200Callback mod200Callback) {
		...
		errorPage.addSelectionHandler( new  SelectionHandler<ValidationMessage2018>() {
			
			@Override
			public void onSelection(SelectionEvent<ValidationMessage2018> event) {
				ValidationMessage2018 msg = event.getSelectedItem();
				if ( msg.getPage() >= 0 ) {
...
//	}
	...
	protected void paintHeaderTable(final Mod2002018 mod200) {
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002018> {
		PopupPanel popup;
	...
	public void startModel(final Mod2002018Object modObject ) {
	...
	void onInitializeClick(ClickEvent event) {
		...
		mod200Object.initializeMod200(new AsyncCallback<Mod2002018>() {
			@Override
			public void onSuccess(Mod2002018 result) {
				popup.hide();
				dump(false);
...
//							+ "/aon_gwt_fiscal/Model2002018AccountingFile");
//					modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
//					domainIdHidden.setValue(String.valueOf(Model200.getCurrentDomain()));
//					domainNameHidden.setValue(Model200.getCurrentDomainName());
//					diskForm.submit();
					submitForm("/aon_gwt_fiscal/Model2002018AccountingFile");
				}
			}
		);
	}
	...
	void onAeatFileButtonClick(ClickEvent event) {
		...
		cd.confirm("Se va a proceder a la generaci\u00F3n de un fichero\n"
			...
			new ConfirmDialogCallback() {
				...
				public void onAccept() {
//					diskForm.setAction(GWT.getHostPageBaseURL()
//							+ "/aon_gwt_fiscal/Model2002018File");
//					modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
//					domainIdHidden.setValue(String.valueOf(Model200.getCurrentDomain()));
//					domainNameHidden.setValue(Model200.getCurrentDomainName());
//					diskForm.submit();
					submitForm("/aon_gwt_fiscal/Model2002018File");
				}
			}
		);
	}
	...
	void onAeatPrintButtonClick(ClickEvent event) {
		...
		cd.confirm("La impresi\u00F3n se genera en los servidores de la Agencia Tributaria "
			...
			,new ConfirmDialogCallback() {
				...
				public void onAccept() {
//					diskForm.setAction(GWT.getHostPageBaseURL()
//							+ "/aon_gwt_fiscal/Model2002018Print");
//					modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
//					domainIdHidden.setValue(String.valueOf(Model200.getCurrentDomain()));
//					domainNameHidden.setValue(Model200.getCurrentDomainName());
//					diskForm.submit();
					submitForm("/aon_gwt_fiscal/Model2002018Print");
				}
			}
		);
	}
	...
	void onImportAccountingButtonClick(ClickEvent event) {
		UploadDialog ud = new UploadDialog(AON.MSG.importAccounting(),GWT.getModuleBaseURL() +"Mod2002018AccountingUpload") {
			...
			protected void onAccept() {
				mod200Object.fillMod2002018AccountingData(new AsyncCallback<Mod2002018>() {
					@Override
					public void onSuccess(Mod2002018 result) {
						hide();
					}
