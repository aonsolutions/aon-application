...
public class Model184Partner2016 extends DockLayoutPanel implements IModel184Partner {
	...
	public Model184Partner2016( Model184Callback callback, Mod184 mod184, Integer selectedIndex ) {
		super(Unit.PX);
		...
		table.addSelectionHandler( new SelectionHandler<Mod184Partner>() {
			...
			public void onSelection(SelectionEvent<Mod184Partner> event) {
				Model1842016PartnerPanel panel = new Model1842016PartnerPanel(event.getSelectedItem(), new IModel184PartnerCallback() {
