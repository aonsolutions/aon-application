...
public class AmortizationModule implements EntryPoint {
	...
	public static void run() {
		GWT.runAsync(AmortizationModule.class, new RunAsyncCallback() {
			
			@Override
			public void onFailure(Throwable reason) {
				Window.alert(AON.MSG.loadError("AmortizationModule"));
			}
			
			@Override
			public void onSuccess() {
				AmortizationModule module = new AmortizationModule();
				module.onModuleLoad();
			}
		});
	}
