...
import com.esferalia.aon.gwt.fiscal.client.mod200.e2020.Mod2002020Object.IMod200ChangeListener;
...
public abstract class PageAbs extends ResizeComposite {
	...
	protected int paintKey(FlexTable tab,final Mod2002020Key key,int row) {
	...
	protected int paintKeyBreakdownLink(final FlexTable tab, int row, Mod2002020Key breakdownKey, IMod200KeysProvider[] keysProvider, String[] headers) {
...
//		if (breakdownKey == Mod2002020Key.BN565) {
//			addCheckBox(Mod2002020Key.BN565A, tableDetail, r);
//			++r;
//			addCheckBox(Mod2002020Key.BN565B, tableDetail, r);
//		}
	...
	protected void paintKeysProvider(IMod200KeysProvider[] keysProvider, final FlexTable tab, int row) {
		for (IMod200KeysProvider kp : keysProvider) {
			...
			for (IMod200Key key : kp.getKeys()) {				 
				if (key != null && callback.getMod200Object().isVisible((Mod2002020Key) key)) {
