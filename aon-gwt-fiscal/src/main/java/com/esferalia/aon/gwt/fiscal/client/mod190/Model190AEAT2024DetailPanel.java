...
public class Model190AEAT2024DetailPanel extends SimpleLayoutPanel implements Focusable {
	...
	public Model190AEAT2024DetailPanel(Mod190Detail detail, IModel190DetailCallback callback) {
		...
		compInfancia.addItem(
				"1 - La prestaci\u00F3n incluye cuant\u00EDas complemento de ayuda para la infancia previsto en el IMV");
		compInfancia.addItem(
				"2 - La prestaci\u00F3n NO incluye cuant\u00EDas complemento de ayuda para la infancia previsto en el IMV");
