...
@WebServlet(name = "Customer PDF Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/CustomerPDFServlet" })
public class CustomerPDFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition","attachment; filename=\"CLIENTES."+MimeType.PDF.getExtension()+"\";");
			...
			new CustomerReportPDF( occam ).print(out,
				AON.getCustomers(occam,params,0,Integer.MAX_VALUE)
