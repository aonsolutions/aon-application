...
@WebServlet(name = "Mod390HF Box Info Print", urlPatterns = { "/aon_gwt_fiscal/ms/Model390HFBoxInfoPrint" })
public class Mod390HFBoxInfoPrint extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			Occam occam = new Occam()
				...
				.setDomain(domainId)
				.setUser(user);
			Mod390HF mod = MODEL390HF.get(occam,id);

			String keyString = req.getParameter("mod390HFBox");
			Mod390Key key = Mod390Key.valueOf(keyString);
			String fileName = "MOD390_" + AonStringUtils.defaultIfBlank(key.getBoxCode(), keyString);
			...
			Stream<VatContext> stream = MODEL390HF.getInfo(occam, mod, key); 
