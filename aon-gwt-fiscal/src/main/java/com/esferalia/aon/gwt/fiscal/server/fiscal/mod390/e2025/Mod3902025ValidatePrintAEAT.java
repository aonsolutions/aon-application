...
@WebServlet(name = "Mod390 2025 Validate Print AEAT", urlPatterns = { "/aon_gwt_fiscal/ms/Mod3902025ValidatePrintAEAT" })
public class Mod3902025ValidatePrintAEAT extends HttpServlet {

	private static final long serialVersionUID = -8183269144157025464L;
	private static final Logger LOGGER = Logger.getLogger(Mod3902025ValidatePrintAEAT.class.getName()); 

	private enum AeatUrl {
		URL_2025 {

			@Override
			protected boolean accept(Mod3902025 mod390) {
				return true;
			}
			...
			@Override
			protected String getUrlParameters(Mod3902025 mod390) throws IOException {
				ByteArrayOutputStream output = new ByteArrayOutputStream();
				PrintWriter writer = new PrintWriter(output, true, StandardCharsets.ISO_8859_1);
				Mod3902025Writer.fillWriter(mod390, writer);
		...
		private static AeatUrl getAeatUrl(Mod3902025 mod390) {
		...
		protected abstract boolean accept(Mod3902025 mod390);
		protected abstract String getUrl();
		protected abstract String getUrlParameters(Mod3902025 mod390) throws IOException;
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902025 mod390 = MODEL3902025.get(occam, ModelAdmonUtils.getFiscalModelId(aeatParams));
