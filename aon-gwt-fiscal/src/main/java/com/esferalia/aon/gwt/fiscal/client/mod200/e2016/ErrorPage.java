...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2016.ValidationMessage2016.MessageType;
...
public class ErrorPage extends ResizeComposite implements HasSelectionHandlers<ValidationMessage2016>{
	...
	private CellTable<ValidationMessage2016> table;
	...
	public ErrorPage( ) {
		...
		NoSelectionModel<ValidationMessage2016> model = new NoSelectionModel<ValidationMessage2016>();
	...
	public void clearMessages() {
		dataProvider.setList( new LinkedList<ValidationMessage2016>());
	...
	private void addMessage(String message,MessageType type) {
		addMessage(new ValidationMessage2016(-1,null,message,null,type));
	}
	...
	private void addIconColumn() {
		final Column<ValidationMessage2016, ImageResource> iconColumn = new Column<ValidationMessage2016, ImageResource>(
				new ImageResourceCell()) {
			@Override
			public ImageResource getValue(ValidationMessage2016 model) {
	...
	@Override
	public HandlerRegistration addSelectionHandler(SelectionHandler<ValidationMessage2016> handler) {
