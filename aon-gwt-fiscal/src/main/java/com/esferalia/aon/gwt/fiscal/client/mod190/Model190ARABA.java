...
public class Model190ARABA extends Model190Base {
	...
	public Model190ARABA(Model190Callback cbk,Mod190 mod190,Integer selectedIndex) {
		super(cbk,mod190);
		...
		IFiscalModelAdmonPanelCallback<Mod190, Model190ModuleOptions> cbk = 
			new IFiscalModelAdmonPanelCallback<Mod190, Model190ModuleOptions>() {
				...
				public Mod190 getModel() {
					return Model190ARABA.this.getModel();
				}
				...
				public String getModelInformationURL() {
					return "https://egoitza.araba.eus/es/-/modelo-190";
				}
		};
