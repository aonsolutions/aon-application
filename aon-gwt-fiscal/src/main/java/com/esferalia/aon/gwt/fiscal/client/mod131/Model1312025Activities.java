...
class Model1312025Activities extends DockLayoutPanel implements HasValueChangeHandlers<Mod131>{
	...
	private Model131ActivityTable2025 activityTable;
	private Model131Activity2025 activityPanel;
	private SimpleLayoutPanel contentLayoutPanel;
	
	Model1312025Activities( Model131ModuleOptions options, IModel131ActivitiesCallback callback ) {
		super(Unit.PX);
		...
		activityTable = new Model131ActivityTable2025(callback);
	...
	private void selectActivity(Model131ModuleOptions options, IModel131ActivitiesCallback callback, int index) {
		activityPanel = new Model131Activity2025( new IModel131ActivityCallback() {
			@Override
			...
			public void onAccept() {
				ValueChangeEvent.<Mod131>fire(Model1312025Activities.this, callback.getModel());
			}
		...
		activityPanel.addValueChangeHandler(ve -> ValueChangeEvent.<Mod131>fire(Model1312025Activities.this, callback.getModel()));
