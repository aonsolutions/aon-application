...
public class Page17 extends PageAbs {
	...
	protected void initializeTable() {
		...
		++row;
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_1.length; i++) {
			Mod2002019Key[] keys = Mod2002019Constants.DOTACION_KEYS_1[i];
			paintDescription(table, Mod2002019Constants.DOTACION_KEYS_DESCRIPTIONS_1[i], row, 0, (row==Mod2002019Constants.DOTACION_KEYS_1.length-1));
		...
		++row;
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_2.length; i++) {
			Mod2002019Key key = Mod2002019Constants.DOTACION_KEYS_2[i]; 
			if (key != null && callback.getMod200Object().isVisible(key)) {
		...
		++row;
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_3.length; i++) {
			Mod2002019Key[] keys = Mod2002019Constants.DOTACION_KEYS_3[i];
			paintDescription(table2, Mod2002019Constants.DOTACION_KEYS_DESCRIPTIONS_3[i], row, 0, (row==4));
			for (int x = 0; x < keys.length; x++) {
				Mod2002019Key key = keys[x]; 
				if (key != null && callback.getMod200Object().isVisible(key)) {
		...
		++row;
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_4.length; i++) {
			Mod2002019Key[] keys = Mod2002019Constants.DOTACION_KEYS_4[i];
			paintDescription(table3, Mod2002019Constants.DOTACION_KEYS_DESCRIPTIONS_4[i], row, 0, (row==Mod2002019Constants.DOTACION_KEYS_4.length-1));
			for (int x = 0; x < keys.length; x++) {
				Mod2002019Key key = keys[x]; 
				if (key != null && callback.getMod200Object().isVisible(key)) {
		...
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_5.length; i++) {
			Mod2002019Key key = Mod2002019Constants.DOTACION_KEYS_5[i]; 
			if (key != null && callback.getMod200Object().isVisible(key)) {
		...
		++row;
		for (int i = 0; i < Mod2002019Constants.DOTACION_KEYS_6.length; i++) {
			Mod2002019Key[] keys = Mod2002019Constants.DOTACION_KEYS_6[i];
			paintDescription(table5, Mod2002019Constants.DOTACION_KEYS_DESCRIPTIONS_4[i], row, 0, (row==Mod2002019Constants.DOTACION_KEYS_6.length-1));
			for (int x = 0; x < keys.length; x++) {
				Mod2002019Key key = keys[x]; 
				if (key != null && callback.getMod200Object().isVisible(key)) {
