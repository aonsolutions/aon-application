...
class Model303AEAT2020 extends Model303AEAT {
	...
	protected Model303AEAT2020(Mod303 mod303,Model303Callback callback) {
		...
		if (getModel().isLastPeriod()) {
			a11.addChangeHandler( event ->  {
				if (a11.getSelectedIndex() != 0) {
					if (AonStringUtils.isNotBlank(getModel().getDescription(Mod303Key.CT_U1D))
