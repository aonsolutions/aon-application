...
public class Page03 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002017Key key : Mod2002017Constants.BALANCE_ACTIVE_KEYS) {
	...
	protected boolean isDisabled(Mod2002017Key key) {
		if (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002017Key.BA111
			 || key == Mod2002017Key.BA115
			 || key == Mod2002017Key.BA138 
			 || key == Mod2002017Key.BA177 ) {
				return true;
			}
		}
