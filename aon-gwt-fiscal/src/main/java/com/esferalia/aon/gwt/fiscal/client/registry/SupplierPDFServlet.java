...
@WebServlet(name = "Supplier PDF Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/SupplierPDFServlet" })
public class SupplierPDFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition","attachment; filename=\"PROVEEDORES."+MimeType.PDF.getExtension()+"\";");
			...
			new SupplierReportPDF( occam ).print(out,
				AON.getSuppliers(occam,params,0,Integer.MAX_VALUE)
