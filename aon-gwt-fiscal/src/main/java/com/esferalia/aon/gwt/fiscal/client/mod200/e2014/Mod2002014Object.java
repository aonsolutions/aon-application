...
public class Mod2002014Object implements Serializable {
	...
	public Mod2002014Object(String currentDomainName,Mod2002014 mod200) {
	...
	public void initializeMod200(final AsyncCallback<Mod2002014> callback) {
		Model200.getMod2002014Service().initializeMod2002014(domainName,mod200.getDomain(),mod200, new AsyncCallback<Mod2002014>() {
	...
	public void save(final AsyncCallback<Mod2002014> callback) {
		Model200.getMod2002014Service().saveMod2002014(domainName,mod200.getDomain(),mod200, new AsyncCallback<Mod2002014>() {
	...
	public void delete(final AsyncCallback<Void> callback) {
		Model200.getMod2002014Service().deleteMod2002014(domainName,mod200.getDomain(),mod200.getId(), new AsyncCallback<Void>() {
	...
	public void fillMod2002014AccountingData(final AsyncCallback<Mod2002014> callback) {
		Model200.getMod2002014Service().fillMod2002014AccountingData(mod200, new AsyncCallback<Mod2002014>() {
	...
	public void calculate() {
		Model200.getMod2002014Service().calculateMod2002014(mod200, new AsyncCallback<Mod2002014>() {
	...
	public void validate(final AsyncCallback<Mod2002014> callback) {
		Model200.getMod2002014Service().validateMod2002014(mod200, new AsyncCallback<Mod2002014>() {
	...
	public void dumpAEAT(final AsyncCallback<String> callback) {
		Model200.getMod2002014Service().dumpAEATMod2002014(mod200, new AsyncCallback<String>() {
	...
	public void getCompanyBanks(final AsyncCallback<LinkedList<CompanyBank>> callback) {
		Model200.getMod2002014Service().getCompanyBanks(domainName,mod200.getDomain(),new AsyncCallback<LinkedList<CompanyBank>>() {
