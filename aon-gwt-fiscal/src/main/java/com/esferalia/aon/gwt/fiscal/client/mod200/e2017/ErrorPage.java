...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2017.ValidationMessage2017.MessageType;
...
public class ErrorPage extends ResizeComposite implements HasSelectionHandlers<ValidationMessage2017>{
	...
	private ListDataProvider<ValidationMessage2017> dataProvider;
	private CellTable<ValidationMessage2017> table;
	...
	public ErrorPage( ) {
		...
		table = new CellTable<ValidationMessage2017>(1, Model200Table.TABLE_STYLE);
		table.setKeyboardPagingPolicy(KeyboardPagingPolicy.CURRENT_PAGE);
		table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
		NoSelectionModel<ValidationMessage2017> model = new NoSelectionModel<ValidationMessage2017>();
		...
		dataProvider= new ListDataProvider<ValidationMessage2017>();
	...
	public void clearMessages() {
		dataProvider.setList( new LinkedList<ValidationMessage2017>());
		table.setPageSize(10);
		table.redraw();
	}
	public void addErrorMsg(List<ValidationMessage2017> messages) {
	...
	private void addMessage(String message,MessageType type) {
		addMessage(new ValidationMessage2017(-1,null,message,null,type));
	}
	
	private void addMessage(ValidationMessage2017 msg) {
	...
	private void addPageColumn() {
		Column<ValidationMessage2017,String> col = new TextColumn<ValidationMessage2017>() {

			@Override
			public String getValue(ValidationMessage2017 errorMessage) {
	...
	private void addIconColumn() {
		final Column<ValidationMessage2017, ImageResource> iconColumn = new Column<ValidationMessage2017, ImageResource>(
				new ImageResourceCell()) {
			@Override
			public ImageResource getValue(ValidationMessage2017 model) {
	...
	@Override
	public HandlerRegistration addSelectionHandler(SelectionHandler<ValidationMessage2017> handler) {
