...
public class OLD_Model390Table extends CellTable<Mod390> {
	...
	public OLD_Model390Table(SelectionChangeEvent.Handler handler) {
	...
	private void addAdministrationColumn() {
		final Column<Mod390, ImageResource> iconColumn = new Column<Mod390, ImageResource>(
			...
			@Override
			public ImageResource getValue(Mod390 mod390) {
				Administration adm = mod390.getAdministration(); 
