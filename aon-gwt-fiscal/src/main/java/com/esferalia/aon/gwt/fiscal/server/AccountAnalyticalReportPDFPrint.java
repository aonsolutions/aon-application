...
import net.aonsolutions.aon.accounting.report.AccountAnalyticalReportPDF;

@WebServlet(name = "AccountAnalytical Report PDF Print", urlPatterns = { "/aon_gwt_fiscal/roms/AccountAnalyticalReportPDFPrint" })
public class AccountAnalyticalReportPDFPrint extends HttpServlet {

	private static final long serialVersionUID = 3875333944949188887L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			AccountAnalyticalReportPDF reportPDF = new AccountAnalyticalReportPDF();
			reportPDF.printAnalyticalReport(resp.getOutputStream(), params);
			resp.flushBuffer();
		} catch (Throwable e) {
