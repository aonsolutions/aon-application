...
import com.esferalia.aon.occam.api.model.fiscal.mod200_2020.ValidationMessage2020.MessageType;
...
public class ErrorPage extends ResizeComposite implements HasSelectionHandlers<ValidationMessage2020>{
	...
	private ListDataProvider<ValidationMessage2020> dataProvider;
	private CellTable<ValidationMessage2020> table;
	...
	public ErrorPage( ) {
		...
		table = new CellTable<ValidationMessage2020>(1, Model200Table.TABLE_STYLE);
		table.setKeyboardPagingPolicy(KeyboardPagingPolicy.CURRENT_PAGE);
		table.setKeyboardSelectionPolicy(KeyboardSelectionPolicy.DISABLED);
		NoSelectionModel<ValidationMessage2020> model = new NoSelectionModel<ValidationMessage2020>();
		...
		dataProvider= new ListDataProvider<ValidationMessage2020>();
	...
	public void clearMessages() {
		dataProvider.setList( new LinkedList<ValidationMessage2020>());
		table.setPageSize(10);
		table.redraw();
	}
	public void addErrorMsg(List<ValidationMessage2020> messages) {
	...
	private void addMessage(String message,MessageType type) {
		addMessage(new ValidationMessage2020(-1,null,message,null,type));
	}
	
	private void addMessage(ValidationMessage2020 msg) {
	...
	private void addPageColumn() {
		Column<ValidationMessage2020,String> col = new TextColumn<ValidationMessage2020>() {

			@Override
			public String getValue(ValidationMessage2020 errorMessage) {
	...
	private void addIconColumn() {
		final Column<ValidationMessage2020, ImageResource> iconColumn = new Column<ValidationMessage2020, ImageResource>(
				new ImageResourceCell()) {
			@Override
			public ImageResource getValue(ValidationMessage2020 model) {
	...
	@Override
	public HandlerRegistration addSelectionHandler(SelectionHandler<ValidationMessage2020> handler) {
