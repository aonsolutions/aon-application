...
class Page06 extends PageAbs {
	...
	public Page06(Model3902025Callback callback) {
		super(callback);
		paint();
		setValue();
	}
	...
	private void paint() {
		...
		tab.addRow()
			.addCell(new Label(AON.MSG.commonTerritoryDeclarationResult()), AON.CSS.aonBold(), AON.CSS.aonBorderBottom(), AON.CSS.aonWidthAuto())
