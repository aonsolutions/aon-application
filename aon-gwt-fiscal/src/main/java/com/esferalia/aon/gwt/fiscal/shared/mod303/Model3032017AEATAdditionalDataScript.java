...
public enum Model3032017AEATAdditionalDataScript implements IModelScript<Mod303Key> {
	...
	,ADC01 ("Entregas intracomunitarias de bienes y servicios"
		,new Mod303Key[]{null					,Mod303Key.CT_C59},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC02 ("Exportaciones y operaciones asimiladas"
		,new Mod303Key[]{null					,Mod303Key.CT_C60},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
	,ADC03 ("Operaciones no sujetas o con inversi\u00F3n del sujeto pasivo que originan el derecho a deducci\u00F3n"
		,new Mod303Key[]{null					,Mod303Key.CT_C61},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},INVOICE,DIFF_INVOICE)
