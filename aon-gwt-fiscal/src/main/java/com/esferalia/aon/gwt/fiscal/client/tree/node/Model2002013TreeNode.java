...
import com.esferalia.aon.gwt.fiscal.client.tree.content.mod200_2013.Model2002013;
...
import com.esferalia.aon.gwt.fiscal.client.tree.content.mod200_2013.Page13;
import com.esferalia.aon.gwt.fiscal.client.tree.content.mod200_2013.Page14;
...
public class Model2002013TreeNode extends TreeNode<Mod2002013TreeObject>  {
	...
	private Model2002013 model2002013 =  new Model2002013();
	private boolean expanded = false;
	
	public abstract class PageTreeNode extends TreeNode<Mod2002013> {
		...
		@Override
		public Mod2002013 getTreeObject() {
			return (Mod2002013) this.getUserObject();
		}

		@Override
		public TreeNode<Mod2002013> render(HasTreeItems parent, Mod2002013 notToBeUsed) {
	    	parent.addItem(this);
	...
	public PageTreeNode PAGE00 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Page00 widget = (Page00) model2002013.getDeckPanel().getWidget(1);
			widget.dump(Model2002013TreeNode.this.getTreeObject());
			Model2002013TreeNode.this.select( fiscalTree, 1);
		}
	};
	public PageTreeNode PAGE01 = new PageTreeNode() {
		...
		@Override
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page01 widget = (Page01) model2002013.getDeckPanel().getWidget(2);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 2);
			} else {
	...
	public PageTreeNode PAGE02 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page02 widget = (Page02) model2002013.getDeckPanel().getWidget(3);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 3);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE03 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page03 widget = (Page03) model2002013.getDeckPanel().getWidget(4);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 4);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE04 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page04 widget = (Page04) model2002013.getDeckPanel().getWidget(5);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 5);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE05 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page05 widget = (Page05) model2002013.getDeckPanel().getWidget(6);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 6);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE06 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page06 widget = (Page06) model2002013.getDeckPanel().getWidget(7);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 7);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE07 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page07 widget = (Page07) model2002013.getDeckPanel().getWidget(8);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 8);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE08 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page08 widget = (Page08) model2002013.getDeckPanel().getWidget(9);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 9);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE09 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page09 widget = (Page09) model2002013.getDeckPanel().getWidget(10);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 10);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE10 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page10 widget = (Page10) model2002013.getDeckPanel().getWidget(11);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 11);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE11 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page11 widget = (Page11) model2002013.getDeckPanel().getWidget(12);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 12);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE12 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page12 widget = (Page12) model2002013.getDeckPanel().getWidget(13);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 13);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE13 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page13 widget = (Page13) model2002013.getDeckPanel().getWidget(14);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 14);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public PageTreeNode PAGE14 = new PageTreeNode() {
		...
		protected void selectPage(FiscalTree fiscalTree) {
			Mod2002013TreeObject mod200Object = Model2002013TreeNode.this.getTreeObject();
			if (mod200Object.isInitialized()) {
				Page14 widget = (Page14) model2002013.getDeckPanel().getWidget(15);
				widget.dump(Model2002013TreeNode.this.getTreeObject());
				Model2002013TreeNode.this.select( fiscalTree, 15);
			} else {
				Window.alert( AON.MSG.mustInitialzeMod200());
			}
		}
	...
	public void select(final FiscalTree fiscalTree) {
		if (!expanded) {
			model2002013.startModel(getTreeObject(), new AsyncCallback<Mod2002013>(){

				@Override
				public void onSuccess(Mod2002013 result) {
			    	TreeItem page00 = PAGE00.render(Model2002013TreeNode.this, null);
			    	...
			    	PAGE13.render(Model2002013TreeNode.this, null);
			    	PAGE14.render(Model2002013TreeNode.this, null);
			    	setState(true);
					expanded = true;
					model2002013.getDeckPanel().remove(0);
					model2002013.getDeckPanel().insert(fiscalTree.getGenericContent(Model2002013TreeNode.this), 0);
					// select(fiscalTree, 0);
					fiscalTree.renderGenericContent(Model2002013TreeNode.this);
	...
	public void select(final FiscalTree fiscalTree, final int index) {
		fiscalTree.setContent(model2002013);
		model2002013.getDeckPanel().showWidget(index);
	}
	...
	public void setLabel(Mod2002013TreeObject mod200Obj) {
		Mod2002013 mod200 = mod200Obj.getMod200();
