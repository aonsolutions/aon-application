...
public class Mod131CheckAEAT extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(Mod131CheckAEAT.class.getName()); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String year = AonNumberUtils.toString(mod131.getYear());
					
			String urlParameters = MessageFormat.format("NIF={0}&ANR={1}&MOD=131&EJF={2}&PER={3}&FED={4}&FEH={5}&HOD={6}&HOH={7}"
					,mod131.getDocument()
					,mod131.getFullName()
					,year
					,mod131.getPeriod().getName()
					,year+"0101"
					,year+"1311"
					,"0000"
					,"2359"
