...
import com.esferalia.aon.occam.server.fiscal.format.mod130.Mod130Writer;
import com.esferalia.aon.watson.server.io.AonIOUtils;

@SuppressWarnings("serial")
@WebServlet(name = "Mod130 Print AEAT", urlPatterns = { "/aon_gwt_fiscal/Model130PrintAEAT" })
public class Mod130PrintAEAT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			downloadPDF(req, resp, mod130, fileName, output.toByteArray());
	...
	private void downloadPDF(HttpServletRequest req, HttpServletResponse resp,
			Mod130 mod130,String fileName, byte[] content) throws IOException, KeyManagementException, NoSuchAlgorithmException {
		...
		String urlParameters = "HID=IE51300A" 
				+"&IDI=ES"
				+"&LEV=000000000000"
				+"&FIC=" + encodedFile
				+"&RUT="
