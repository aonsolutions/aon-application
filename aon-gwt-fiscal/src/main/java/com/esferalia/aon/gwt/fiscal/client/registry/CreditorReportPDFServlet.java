...
@WebServlet(name = "Creditor Report PDF Servlet", urlPatterns = { "/aon_gwt_fiscal/roms/CreditorReportPDFServlet" })
public class CreditorReportPDFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			resp.setHeader("Content-disposition",
					"attachment; filename=\"Acreedores." + MimeType.PDF.getExtension() + "\";");
