...
public class Model347GIPUZKOA extends Model347Base {
	...
	public Model347GIPUZKOA(Model347Callback cbk, Mod347 mod347, Integer selectedIndexDeclared, Integer selectedIndexAsset, int tabPanelIndex ) {
		super(cbk, mod347);
		...
		IFiscalModelAdmonPanelCallback<Mod347, Model347ModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod347, Model347ModuleOptions>() {
					...
					public Mod347 getModel() {
						return Model347GIPUZKOA.this.getModel();
					}
					...
					public String getModelInformationURL() {
						return "https://www.gipuzkoa.eus/es/web/ogasuna/impuestos/modelo/347";
					}
			};
