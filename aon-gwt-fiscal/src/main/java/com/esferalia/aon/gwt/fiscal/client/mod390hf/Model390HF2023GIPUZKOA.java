...
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902025GIPUZKOAAdditionalDataScript;
import com.esferalia.aon.occam.api.model.fiscal.mod390hf.Model3902025GIPUZKOARScript1;
...
public class Model390HF2023GIPUZKOA extends Model390HFBase {
	
	public Model390HF2023GIPUZKOA(Model390HFCallback callback,Mod390HF mod390HF) {
	...
	private void paintGeneralRegimenTab(TabLayoutPanel tabPanel) {
		...
		if (getModel().getYear() >= 2025)
			paintDeclaration(table, Model3902025GIPUZKOARScript1.values(),8);
	...
	private void paintAdditionalDataTab(TabLayoutPanel tabPanel) {
		...
		if (getModel().getYear() >= 2025)
			paintDeclaration(table,Model3902025GIPUZKOAAdditionalDataScript.values(),10);
		else if (getModel().getYear() == 2024)
		...
		IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions> cbk = 
				new IFiscalModelAdmonPanelCallback<Mod390HF, Model390HFModuleOptions>() {
					...
					public Mod390HF getModel() {
						return Model390HF2023GIPUZKOA.this.getModel();
					}
