...
public class Page04 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (Mod2002020Key key : Mod2002020Constants.BALANCE_PASIVE_KEYS) {
	...
	protected boolean isDisabled(IMod200Key key) {
		if (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL) {
			if (key == Mod2002020Key.BP191 
 			 || key == Mod2002020Key.BP195
			 || key == Mod2002020Key.BP202 
			 || key == Mod2002020Key.BP211
			 || key == Mod2002020Key.BP230
			 || key == Mod2002020Key.BP240
			 ) {
				return true;
			}
		}
