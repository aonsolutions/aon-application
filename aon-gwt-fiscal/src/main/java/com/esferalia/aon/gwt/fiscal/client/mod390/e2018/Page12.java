...
public class Page12 extends FlowPanel implements IMod3902018Page {

	final Mod3902018ServiceAsync MOD390Service = GWT.create(Mod3902018Service.class);
	IMod3902018CallBack callback;

	protected static final String MODEL390_FILE = "/aon_gwt_fiscal/Model3902018File";
	protected static final String MODEL390_PRINT_AEAT = "/aon_gwt_fiscal/ms/Model3902018PrintAEAT";
	...
	private Mod3902018 model;
	private API API;

	public Page12(Mod3902018 m390, AonData aonData,IMod3902018CallBack callback) {
		super();
	...
	protected void submitForm(String action) {
		...
		mod390Hidden.setValue(String.valueOf(getModel().getId()));
		domainIdHidden.setValue(String.valueOf(getCallback().getDomainId()));
	...
	protected void submitAEAT(String action, String cert, String pass, String document, String name) {
		...
		domainIdAeatHidden.setValue(String.valueOf(getCallback().getDomainId()));
	...
	public IMod3902018CallBack getCallback() {
		return callback;
	}
