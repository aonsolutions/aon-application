...
public class Model184Income2014 extends ResizeComposite {
	...
	public static enum Mod184IncomeKey {
		...
		private Mod184IncomeKey(String[] subkeys) {
			this.subkeys = subkeys;
		}
		private Mod184IncomeKey() {
			this(null);
		}
	...
	private void enableWidgets() {
		country.setEnabled(
			 ...
			 || ("F".equals(getDetail().getKey()) 
					 && ("03".equals(getDetail().getSubKey()) 
                      || "04".equals(getDetail().getSubKey())))
			 || ("G".equals(getDetail().getKey()) 
					 && ("03".equals(getDetail().getSubKey()) 
                      || "04".equals(getDetail().getSubKey()) 
                      || "06".equals(getDetail().getSubKey())
                      || "08".equals(getDetail().getSubKey())) )
			 || ("L".equals(getDetail().getKey()) 
					 && ("A".equals(getDetail().getSubKey()) 
	                  || "C".equals(getDetail().getSubKey()) 
	                  || "D".equals(getDetail().getSubKey())
	                  || "E".equals(getDetail().getSubKey())
	                  || "F".equals(getDetail().getSubKey())
	                  || "G".equals(getDetail().getSubKey())
	                  || "M".equals(getDetail().getSubKey())) )
		...
		accountingResult.setEnabled(
			   ("A".equals(getDetail().getKey()) 
					  && ("01".equals(getDetail().getSubKey()) 
					   || "02".equals(getDetail().getSubKey())))
			|| ("B".equals(getDetail().getKey()) )
			|| ("C".equals(getDetail().getKey()) 
						  && ("01".equals(getDetail().getSubKey()) 
						   || "02".equals(getDetail().getSubKey())))
			|| ("D".equals(getDetail().getKey()) && "01".equals(getDetail().getSubKey()) && getDetail().getRegime() == 1)
			|| ("D".equals(getDetail().getKey()) && "01".equals(getDetail().getSubKey()) && getDetail().getRegime() == 2)
