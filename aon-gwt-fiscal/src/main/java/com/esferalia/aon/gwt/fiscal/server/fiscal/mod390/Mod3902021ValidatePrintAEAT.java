...
public class Mod3902021ValidatePrintAEAT extends HttpServlet {
	...
	private enum AeatUrl {
		URL_2021 {
			...
			@Override
			protected boolean accept(Mod3902021 mod390) {
				return true;
			}
			...
			@Override
			protected String getUrlParameters(Mod3902021 mod390) throws IOException {
		...
		private static AeatUrl getAeatUrl(Mod3902021 mod390) {
		...
		protected abstract boolean accept( Mod3902021 mod390);
		protected abstract String getUrl();
		protected abstract String getUrlParameters(Mod3902021 mod390) throws IOException;
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod3902021 mod390 = MODEL3902021.get(occam, ModelAdmonUtils.getFiscalModelId(aeatParams));
