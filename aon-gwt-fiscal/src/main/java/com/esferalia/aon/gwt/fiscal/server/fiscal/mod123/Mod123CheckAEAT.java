...
public class Mod123CheckAEAT extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(Mod123CheckAEAT.class.getName()); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			String year = AonNumberUtils.toString(mod123.getYear());
					
			String urlParameters = MessageFormat.format("NIF={0}&ANR={1}&MOD=123&EJF={2}&PER={3}&FED={4}&FEH={5}&HOD={6}&HOH={7}"
					,mod123.getDocument()
					,mod123.getFullName()
					,year
