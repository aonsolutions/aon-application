...
import com.esferalia.aon.gwt.fiscal.client.mod390.e2021.Page03.Mod390DetailKeyGroup;
...
public class Mod3902021ExcelAction extends AbsExcelAction {
	
	private Mod3902021 mod390;
	
	public Mod3902021ExcelAction(Mod3902021 mod390) {
		super();
		this.mod390 = mod390;
	}
	...
	protected void printModelInfo() {
		...
		cellCount = 0;
		try {
			InputStream inputStream = Mod3902021ExcelAction.class.getResourceAsStream(
	...
	public void accept(Mod3902021 m390) {
		...
		for (Mod390DetailKeyGroup key : Mod390DetailKeyGroup.values()) {
			...
			for (Mod3902021DetailKey key2 : key.getKeys())		
    ...
    private void addEnsure(String s1, String s2, Mod3902021 m390, Mod3902021DetailKey key ) {
    	
		row = sheet.createRow(rowCount++);
		
		// Algunas lineas van en negrita
		boolean isBold = (key == Mod3902021DetailKey.C0047 || key == Mod3902021DetailKey.C0064 || key == Mod3902021DetailKey.C0065);
		...
		CellUtil.createCell(row, cellCount++, key == Mod3902021DetailKey.C0065 ? s2.toUpperCase() : s2, style);
		
		// Base - Determinadas casillas solo llevan cuota
		if (key == Mod3902021DetailKey.C0047 || key == Mod3902021DetailKey.C0063 || key == Mod3902021DetailKey.C0522 || key == Mod3902021DetailKey.C0064 || key == Mod3902021DetailKey.C0065 )
