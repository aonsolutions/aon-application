...
public class Model200 extends MainEntryPoint {
	...
	interface IValidationMessageSelectioinHandler {
		void validationMessageSelected(ValidationMessage2013 msg);
	}
	...
	private void startModel() {
		...
		mod200.getMod200(new AsyncCallback<Mod2002013>() {
	...
	private void initialize(final PopupAsyncCallback callback) {
		...
		callback.setPopup(popup);
		deckPanel.page00.populate(mod200);
		mod200.initializeMod200(new AsyncCallback<Mod2002013>() {
			@Override
			public void onSuccess(Mod2002013 result) {
				dump();
