...
public abstract class PageAbs extends ResizeComposite {
	...
	private Map<Mod2002013Key, DoubleTextBox> inputs = new HashMap<Mod2002013Key, DoubleTextBox>();
	private Map<Mod2002013Key, BoxLabel> labels = new HashMap<Mod2002013Key, BoxLabel>();
	...
	public Map<Mod2002013Key, DoubleTextBox> getInputs() {
		return inputs;
	}
