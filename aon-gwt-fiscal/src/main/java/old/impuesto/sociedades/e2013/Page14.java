...
public class Page14 extends PageAbs {
	...
	protected void initializeTable() {
		...
		table.getFlexCellFormatter().setStyleName(0, 0, RESOURCES.css().aonFiscalBorderBottom());
		...
		table.getFlexCellFormatter().setStyleName(1, 0, RESOURCES.css().aonFiscalBorderBottom());
		panel = new FlowPanel();
		...
		table.getFlexCellFormatter().setStyleName(2, 0, RESOURCES.css().aonFiscalBorderBottom());
		panel = new FlowPanel();
		code = new BoxLabel(key.getCode( mod200Object.getAdministration() ));
		panel.add(code);
		text = new DoubleTextBox();
