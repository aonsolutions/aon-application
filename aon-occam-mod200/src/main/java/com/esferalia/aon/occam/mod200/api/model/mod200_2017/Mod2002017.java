...
public class Mod2002017 implements IFiscalModel {
	...
	private EnumMap<Mod2002017Key,DoubleVariable2017> keysMap = new EnumMap<Mod2002017Key,DoubleVariable2017>(Mod2002017Key.class);
	private EnumMap<Mod2002017Key,DoubleVariable2017> draftMap = new EnumMap<Mod2002017Key,DoubleVariable2017>(Mod2002017Key.class);
	private EnumMap<Mod2002017Key,Boolean> visibleMap = new EnumMap<Mod2002017Key,Boolean>(Mod2002017Key.class);

	private LinkedList<ValidationMessage2017> messages;
	...
	public EnumMap<Mod2002017Key, DoubleVariable2017> getKeysMap() {
		return keysMap;
	}
	public void setKeysMap(EnumMap<Mod2002017Key, DoubleVariable2017> keysMap) {
		this.keysMap = keysMap;
	}
	public EnumMap<Mod2002017Key, DoubleVariable2017> getDraftMap() {
		return draftMap;
	}
	public void setDraftMap(EnumMap<Mod2002017Key, DoubleVariable2017> draftMap) {
		this.draftMap = draftMap;
	}
	public EnumMap<Mod2002017Key, Boolean> getVisibleMap() {
		return visibleMap;
	}
	...
	public void setVisibleMap(EnumMap<Mod2002017Key, Boolean> visibleMap) {
	...
	public LinkedList<ValidationMessage2017> getMessages() {
		return messages;
	}
	public void setMessages(LinkedList<ValidationMessage2017> messages) {
		this.messages = messages;
	}
	public DoubleVariable2017 getKey(Mod2002017Key key) {
		return keysMap.get(key);
	}
	public boolean isChecked(Mod2002017Key key) {
		DoubleVariable2017 dv = keysMap.get(key); 
		return dv != null && (AonMathUtils.round(dv.getValue()) == 1.0);
	}
	public boolean isNotChecked(Mod2002017Key key) {
		return !isChecked(key);
	}
	public boolean isCooperativa() {
		return isChecked(Mod2002017Key.C0017) || isChecked(Mod2002017Key.C0018) || isChecked(Mod2002017Key.C0019);
	}
	
	public void addVariable(Mod2002017Key key, Number d) {
		DoubleVariable2017 dv = new DoubleVariable2017(key);
		dv.setValue(d==null?0:d.doubleValue());
		keysMap.put( dv.getKey(),dv );
	}

	public void addVariable(DoubleVariable2017 t) {
		keysMap.put( t.getKey(), t);
	}
	public void removeVariable(DoubleVariable2017 t) {
		keysMap.remove(t.getKey());
	}
	
	public void addDraftVariable(DoubleVariable2017 t) {
		draftMap.put( t.getKey(), t);
	}
	public void removeDraftariable(DoubleVariable2017 t) {
		draftMap.remove(t.getKey());
	}

	public DoubleVariable2017 getVariable(Mod2002017Key key) {
		DoubleVariable2017 var = getDraftMap().get(key);
		if (var == null ) {
	...
	public Double getDoubleValue(Mod2002017Key key) {
		...
		DoubleVariable2017 v = keysMap.get(key);
		if (v==null) {
			return new Double(0);
		}
		Object o = v.getValue();
	...
	public void listDraftVariables() {
		for (DoubleVariable2017 dv : getDraftMap().values()) {
