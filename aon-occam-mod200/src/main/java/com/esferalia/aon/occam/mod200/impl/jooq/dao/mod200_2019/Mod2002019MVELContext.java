package com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2019;

import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0001;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0002;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0003;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0004;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0005;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0006;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0009;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0010;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0012;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0013;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0014;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0015;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0017;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0018;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0019;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0021;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0022;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0024;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0025;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0030;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0034;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0036;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0038;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0046;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0047;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0048;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0049;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0057;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0058;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0063;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0064;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0066;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0071;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0072;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0078;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0079;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0080;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0081;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.C0082;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ520;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ521;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ552;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ553;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ554;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ558;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ559;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ560;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2019.Mod2002019Key.LQ562;
...
public class Mod2002019MVELContext implements Map<String, Object> { // extends AccMiningMVELContext {
	
	private Map<String, AccountBalance> accounts;
	private Map<String, Object> context;
	private EnumMap<Mod2002019Key,String> expressionMap = new EnumMap<Mod2002019Key,String>(Mod2002019Key.class);
	...
	public Mod2002019MVELContext(Mod2002019 mod200,IAccMiningKeyAccept resolver) {
	...
	public EnumMap<Mod2002019Key,String> getExpressionMap() {
		return expressionMap;
	}

	public void setExpressionMap(EnumMap<Mod2002019Key,String> expressionMap) {
	...
	public Object get(Object keyObject) {
		try {
			// Comprobar si la clave es de Mod2002019Key
			Mod2002019Key key = Mod2002019Key.valueOf((String) keyObject);
			return getContainsKey(key) ? context.get(keyObject) : evaluate(key);
			
		} catch (Exception e) {			
			// Si no lo es comprobar si es de Mod2002019KeyDC
			Mod2002019KeyDC key = Mod2002019KeyDC.valueOf((String) keyObject);
			return getContainsKey(key) ? context.get(keyObject) : evaluate(key);
		}
	...
	public Object evaluateExpression(Mod2002019Key key,String expression) {
		return mvelEval(key,expression);
	}
	public boolean validateExpression(Mod2002019Key key,String expression) {
	...
	public Double getValue(Mod2002019Key key) {
	...
	private Double roundKey(Mod2002019Key key) {
	...
	public double computeLQ1230() throws AonCoreException {
		if (!context.containsKey(Mod2002019Key.LQ1230.toString())) {
			return 0.0;
		}
		return isGroup()?getValue(Mod2002019Key.LQ1230):0.0;
	}
	public double computeLQ1231() throws AonCoreException {
		if (!context.containsKey(Mod2002019Key.LQ1231.toString())) {
			return 0.0;
		}
		return isGroup()?getValue(Mod2002019Key.LQ1231):0.0;
	}

	public double computeLQ1032() throws AonCoreException {
		if (isGroup() && getContainsKey(Mod2002019Key.LQ1032)) {
			return getValue(Mod2002019Key.LQ1032);
		}
		if (isGroup()) {
			return 0.0;
		}		
		double lq1135 = roundKey(Mod2002019Key.LQ1135);
		double lq1471 = roundKey(Mod2002019Key.LQ1471);
		double lq1745 = roundKey(Mod2002019Key.LQ1745);
		double lq1986 = roundKey(Mod2002019Key.LQ1986);
		return round(lq1135+lq1471+lq1745+lq1986);
	}

	public double computeD1004() throws AonCoreException {
		if (getContainsKey(Mod2002019Key.D1004)) {
			double d1004 = getValue(Mod2002019Key.D1004);
	...
	public double computeLQ562() throws AonCoreException {
		...
		double lq1330 = roundKey(Mod2002019Key.LQ1330);
	...
	public double computeLQ550() throws AonCoreException {
		if (isChecked(C0022) || isChecked(Mod2002019Key.C0009) || isChecked(Mod2002019Key.C0010)) {
			if (isChecked(C0022)) {
				double lq578 = roundKey(Mod2002019Key.LQ578);
				double lq579 = roundKey(Mod2002019Key.LQ579);
				if (!isChecked(Mod2002019Key.C0009) && !isChecked(Mod2002019Key.C0010)) {
					if (lq578 > 0) {
						return lq578 + lq579;
					} else {
						return lq579;
					...
					double lq1030 = roundKey(Mod2002019Key.LQ1030);
					double lq1031 = roundKey(Mod2002019Key.LQ1031);
				...
				double lq1029 = roundKey(Mod2002019Key.LQ1029);
				double lq1030 = roundKey(Mod2002019Key.LQ1030);
				if (isCooperativa()) {
		...
		double lq501 = roundKey(Mod2002019Key.LQ501);
		double i0417 = roundKey(Mod2002019Key.I0417);
	 	double d0418 = roundKey(Mod2002019Key.D0418);
		return lq501 + i0417 - d0418;
	}
	
	public double computeLM1249() throws AonCoreException {
		double lm1250 = roundKey(Mod2002019Key.LM1250); 
		double lm1251 = roundKey(Mod2002019Key.LM1251);
		double lm1252 = roundKey(Mod2002019Key.LM1252);
		double lm1253 = roundKey(Mod2002019Key.LM1253);
		double lm1254 = roundKey(Mod2002019Key.LM1254);
		double lm1256 = roundKey(Mod2002019Key.LM1256);
		double lm1258 = roundKey(Mod2002019Key.LM1258);
		double lm1259 = roundKey(Mod2002019Key.LM1259);
	...
	private double computePreBN599() throws AonCoreException {
		double BN592  = roundKey(Mod2002019Key.BN592 );
		double BN1785 = roundKey(Mod2002019Key.BN1785);
		double BN1786 = roundKey(Mod2002019Key.BN1786);
		double BN1787 = roundKey(Mod2002019Key.BN1787);
		double BN1788 = roundKey(Mod2002019Key.BN1788);
		double BN1789 = roundKey(Mod2002019Key.BN1789);
		double BN1790 = roundKey(Mod2002019Key.BN1790);
		double BN1791 = roundKey(Mod2002019Key.BN1791);
		double BN1792 = roundKey(Mod2002019Key.BN1792);
		double BN1793 = roundKey(Mod2002019Key.BN1793);
		double BN1794 = roundKey(Mod2002019Key.BN1794);
		double BN1795 = roundKey(Mod2002019Key.BN1795);
		double BN1796 = roundKey(Mod2002019Key.BN1796);
		double BN1797 = roundKey(Mod2002019Key.BN1797);
		double BN1798 = roundKey(Mod2002019Key.BN1798);
		double BN597  = roundKey(Mod2002019Key.BN597 );
		double BN1799 = roundKey(Mod2002019Key.BN1799);
	...
	public double computeBN599() throws AonCoreException {	
		if (isChecked(Mod2002019Key.C0028)) {
			double TR625 = roundKey(Mod2002019Key.TR625);
	...
	public double computeTR420() throws AonCoreException {
		if (isChecked(Mod2002019Key.C0028)) {
			double TR626 = roundKey(Mod2002019Key.TR626);
	...
	public double computeTR421() throws AonCoreException {
		if (isChecked(Mod2002019Key.C0028)) {
			double TR627 = roundKey(Mod2002019Key.TR627);
	...
	public double computeTR426() throws AonCoreException {
		if (isChecked(Mod2002019Key.C0028)) {
			double TR628 = roundKey(Mod2002019Key.TR628);
	...
	public double computeTR427() throws AonCoreException {
		if (isChecked(Mod2002019Key.C0028)) {
			double TR629 = roundKey(Mod2002019Key.TR629);
	...
	public double computeUT1330() throws AonCoreException {
		...
		if (isChecked(Mod2002019Key.C0013) || isChecked(Mod2002019Key.C0014))
		{
			double x = roundKey(Mod2002019Key.LQ1330);
			...
			if (x != roundKey(Mod2002019Key.UT1330))
			{		
