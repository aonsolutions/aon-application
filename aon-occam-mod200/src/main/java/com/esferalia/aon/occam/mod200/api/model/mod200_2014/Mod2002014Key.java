...
public enum Mod2002014Key implements IMod200Key {
	...
	//  Entidades navieras en reǵimen de tributación en función del tonelaje
	,LQ578(578)
	,LQ579(579)
	,LQ0N1("0N1")
	,LQ630(630)
	...
	,LQ547(547)
		...
		,LQ699(699)
		,LQ671(671)
		// Fin Detalle de la compensación de bases imponibles negativas	
	,LQ552(552)
	...
	// Sólo agrupaciones interés económico y UTE's
	,LQ555(555)
	,LQ556(556)
	// Sólo ZEC
	,LQ559(559)
	...
	,BN569(569)
	,BN570(570)
		// Deducciones doble imposición interna 2007-2013
		,BN101(101)
		,BN102(102)
		,BN696(696)
		,BN697(697)
		...
		,BN118(118)
	,BN571(571)
		// Deducciones doble imposición interna - DI interna 2014
		,BN119(119)
		,BN120(120)
		,BN121(121)
		,BN122(122)
		...
		,BN133(133)
	,BN572(572)
		// Deducciones doble imposición internacional ejerc. anteriores
		,BN151(151)
		,BN152(152)
		,BN711(711)
		,BN712(712)
		...
		,BN162(162)
	,BN573(573)
		// Deducciones doble imposición internacional 2013 
		,BN163(163)
		,BN164(164)
		,BN165(165)
		,BN166(166)
...
;
	...
	private Mod2002014Key(int code) {
		this(Integer.toString(code));
	}
	
	private Mod2002014Key(String code) {
		this.code = code;
	}
