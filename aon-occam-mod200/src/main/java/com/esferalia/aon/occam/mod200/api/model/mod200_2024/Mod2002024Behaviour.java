...
public class Mod2002024Behaviour {
	...
	static { 
		...
		BEHAVIOUR_KEYS_MAP.put(Mod2002024Key.LQ031,new Boolean[]{FALSE,TRUE});
		...
		BEHAVIOUR_KEYS_MAP.put(Mod2002024Key.LQ466 ,new Boolean[]{FALSE,TRUE});
	...
	static { 
		...
		BEHAVIOUR_KEYS_MAP.put(Mod2002024Key.TR466, new Boolean[]{FALSE,TRUE});
