...
//                                                                                      //
// IMPORTANTE:                                                                          //   
// Además de este enumerado, tambien existe el enumerado Mod2002024KeyDC que lleva      //
...
public enum Mod2002024Key implements IMod200Key {
...
// --------------- PAGINA 26 --------------- //	
	...
	// SE PONEN EN OTRO ENUMERADO (Mod2002024KeyDC) PORQUE SI LOS AÑADIMOS AQUI TENEMOS ERROR DE CODE TOO LARGE

	;
	
	public String getCode() {
		
		String code = Mod2002024Code.CODE_MAP.get(this);
	...
	public String getDescription() {
		return Mod2002024Description.DESCRIPTION_MAP.get(this);
	}
	
	public static Mod2002024Key safeValueOf(String str) {
		for (Mod2002024Key key : values()) {
