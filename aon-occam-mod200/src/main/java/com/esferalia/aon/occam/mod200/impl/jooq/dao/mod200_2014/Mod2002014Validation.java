package com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2014;

import static com.esferalia.aon.occam.mod200.api.model.mod200_2014.Mod2002014Key.*;
...
public class Mod2002014Validation {
	// Á --> \u00C1 á --> \u00E1
	// É --> \u00C9 é --> \u00E9
	// Í --> \u00CD í --> \u00ED
	// Ó --> \u00D3 ó --> \u00F3
	...
	public static List<ValidationMessage2014> VALIDATION_EXPRESSION_LIST = new LinkedList<ValidationMessage2014>();
	...
	static { // PAGE 08
		...
		for (Mod2002014CorrectionKey ck : Mod2002014CorrectionKey.values()) {
			Mod2002014Key key = ck.getIncrease();
			if (key != null) {
				VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,key
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0392
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0389
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0390
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0371
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0311
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0313
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0323
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0312
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0314
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0324
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0387
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0388
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0396
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0385
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0386
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0397
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0398
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0373
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0374
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0403
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0404
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0383
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0384
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0368
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0409
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0410
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0411
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0412
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0400
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0379
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0380
			,MessageFormat.format(INV_BOX_MSG,D0380.getDescription(),
				C0020.getDescription()+"\" ni \"" 
				+ C0035.getDescription()+"\" \"ni \"" 
				+ C0037.getDescription())
			,"round(D0380) == 0.0 || (round(D0380) > 0.0 && (C0020 || C0035 || C0037))"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0377
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0378
			,MessageFormat.format(INV_BOX_MSG,D0378.getDescription(),
				C0031.getDescription()+"\" \"ni \"" + C0032.getDescription())
			,"round(D0378) == 0.0 || (round(D0378) > 0.0 && (C0031 || C0032))"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0381
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0382
			,MessageFormat.format(INV_BOX_MSG,D0382.getDescription(),
				C0033.getDescription()+"\" \"ni \"" + C0034.getDescription())
			,"round(D0382) == 0.0 || (round(D0382) > 0.0 && (C0033 || C0034))"));
		
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,LQ301
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,LQ302
...
//				,"(C0006 || C0056) && (round(I0504) != 0 || round(D0505) != 0)"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0369
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0370
				,MessageFormat.format(INCOMPATIBLE_MSG,D0370.getDescription()
					,C0013.getDescription() +"\" y/o \"" + C0014.getDescription())
				,"round(D0370) != 0.0?(C0013 || C0014):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,I0256
				,MessageFormat.format(INCOMPATIBLE_MSG,I0256.getDescription()
					,C0013.getDescription() +"\" y/o \"" + C0014.getDescription())
				,"round(I0256) != 0.0?(C0013 || C0014):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE08,D0278
	...
	static {	// PAGE 09
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ578
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ579
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ631
...
//				,"C0027?LQ552<=0:LQ552>0"));
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ641
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ644
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ647
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ650
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ653
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ656
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ659
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ662
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ665
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ668
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ747
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ276
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ609
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ705
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ014
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ726
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ553
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE09,LQ559
	...
	static {// PAGE 10
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN581,MSG_581
				,"BN581 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN583,MSG_581
				,"BN583 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN585,MSG_581
				,"BN585 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN584,MSG_581
				,"BN584 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN588,MSG_581
				,"BN588 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN590,MSG_581
				,"BN590 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN082,MSG_581
				,"BN082 != 0?(BN118 > 0 || BN133 > 0 || BN162 > 0 || BN174 > 0):true"));

		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN697
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN847
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN283
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN703
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN187
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN026
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN715
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN737
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN712
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN638
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN894
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN286
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN826
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN002
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN029
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN718
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN723
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN741
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN136
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN585
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE10,BN592
	...
	static {	// PAGE 12
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE12,ID653
	...
	static { // PAGE 13 		
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM255
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM260
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM258
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM175 
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM176 
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM177 
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM178 
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM179 
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM970
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM262
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM265
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM266
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM258
				...
				,"LM258==(LM970+LM262)"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM522
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2014(PAGE13,LM271
