...
import static com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2015.Mod2002015Initialization.INITIALIZE_EXPRESSION_MAP;
import static com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2015.Mod2002015Validation.VALIDATION_EXPRESSION_LIST;
...
import com.esferalia.aon.occam.mod200.api.model.mod200_2015.Mod2002015Character;
	...
	private static void fillRegistryLists(Mod2002015 mod200, AONContext ctx) {
		...
		for (FsModel200RegistryRecord reg : res) {
			if (reg.getType() == 0) {
				...
				cp.setValueCorrection(AonNumberUtils.zeroIfNull(reg.getAValue()));
				cp.setLossReversion(AonNumberUtils.zeroIfNull(reg.getBValue()));
				cp.setAccountingElimination(AonNumberUtils.zeroIfNull(reg.getCcValue()));
				cp.setCorrectionEffect(AonNumberUtils.zeroIfNull(reg.getCValue()));
				cp.setCorrectionsBalance(AonNumberUtils.zeroIfNull(reg.getDValue()));
