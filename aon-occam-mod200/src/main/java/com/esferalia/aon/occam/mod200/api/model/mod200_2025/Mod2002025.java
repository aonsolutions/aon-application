...
public class Mod2002025 extends Mod200 {
	
	private static final long serialVersionUID = 2606096525126357199L;
...
//	}
	...
	public boolean isCooperativa() {
		return isChecked(Mod2002025Key.C0017) || isChecked(Mod2002025Key.C0018) || isChecked(Mod2002025Key.C0019);
	}
	...
	public Mod2002025 setUltimateGroupName(String ultimateGroupName) {
	...
	public Mod2002025 setUltimateResidenceCountry(Country ultimateResidenceCountry) {
	...
	public Mod2002025 setUltimateResidenceDocument(String ultimateResidenceDocument) {
