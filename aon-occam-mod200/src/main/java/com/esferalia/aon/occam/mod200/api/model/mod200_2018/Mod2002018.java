...
public class Mod2002018 implements IFiscalModel {
	...
	private EnumMap<Mod2002018Key,DoubleVariable2018> keysMap = new EnumMap<Mod2002018Key,DoubleVariable2018>(Mod2002018Key.class);
	private EnumMap<Mod2002018Key,DoubleVariable2018> draftMap = new EnumMap<Mod2002018Key,DoubleVariable2018>(Mod2002018Key.class);
	private EnumMap<Mod2002018Key,Boolean> visibleMap = new EnumMap<Mod2002018Key,Boolean>(Mod2002018Key.class);

	private LinkedList<ValidationMessage2018> messages;
	...
	public EnumMap<Mod2002018Key, DoubleVariable2018> getKeysMap() {
		return keysMap;
	}
	public void setKeysMap(EnumMap<Mod2002018Key, DoubleVariable2018> keysMap) {
		this.keysMap = keysMap;
	}
	public EnumMap<Mod2002018Key, DoubleVariable2018> getDraftMap() {
		return draftMap;
	}
	public void setDraftMap(EnumMap<Mod2002018Key, DoubleVariable2018> draftMap) {
		this.draftMap = draftMap;
	}
	public EnumMap<Mod2002018Key, Boolean> getVisibleMap() {
		return visibleMap;
	}
	...
	public void setVisibleMap(EnumMap<Mod2002018Key, Boolean> visibleMap) {
	...
	public LinkedList<ValidationMessage2018> getMessages() {
		return messages;
	}
	public void setMessages(LinkedList<ValidationMessage2018> messages) {
		this.messages = messages;
	}
	public DoubleVariable2018 getKey(Mod2002018Key key) {
		return keysMap.get(key);
	}
	public boolean isChecked(Mod2002018Key key) {
		DoubleVariable2018 dv = keysMap.get(key); 
		return dv != null && (AonMathUtils.round(dv.getValue()) == 1.0);
	}
	public boolean isNotChecked(Mod2002018Key key) {
		return !isChecked(key);
	}
	public boolean isCooperativa() {
		return isChecked(Mod2002018Key.C0017) || isChecked(Mod2002018Key.C0018) || isChecked(Mod2002018Key.C0019);
	}
	
	public void addVariable(Mod2002018Key key, Number d) {
		DoubleVariable2018 dv = new DoubleVariable2018(key);
		dv.setValue(d==null?0:d.doubleValue());
		keysMap.put( dv.getKey(),dv );
	}

	public void addVariable(DoubleVariable2018 t) {
		keysMap.put( t.getKey(), t);
	}
	public void removeVariable(DoubleVariable2018 t) {
		keysMap.remove(t.getKey());
	}
	
	public void addDraftVariable(DoubleVariable2018 t) {
		draftMap.put( t.getKey(), t);
	}
	public void removeDraftariable(DoubleVariable2018 t) {
		draftMap.remove(t.getKey());
	}

	public DoubleVariable2018 getVariable(Mod2002018Key key) {
		DoubleVariable2018 var = getDraftMap().get(key);
		if (var == null ) {
	...
	public Double getDoubleValue(Mod2002018Key key) {
		if (!keysMap.containsKey(key)){
			return new Double(0);	
		}
		DoubleVariable2018 v = keysMap.get(key);
		if (v==null) {
			return new Double(0);
		}
		Object o = v.getValue();
	...
	public void listDraftVariables() {
		for (DoubleVariable2018 dv : getDraftMap().values()) {
