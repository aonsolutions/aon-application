...
//                                                                                      //
// IMPORTANTE:                                                                          //   
// Además de este enumerado, tambien existe el enumerado Mod2002022KeyDC que lleva      //
...
public enum Mod2002022Key implements IMod200Key {
...
// --------------- PAGINA 1 --------------- // 	
	...
	,C0011	,C0024  ,C0078
			,C0025	,C0056
					...
					,C0083  // FALTA - NO ESTOY SEGURO EN QUE APARTADO VA
	...
	,C0007	,C0030	,C0059		
	,C0009  ,C0039  ,C0065
	,C0010  ,C0043  ,C0084   // FALTA - AÑADEN LA CASILLA 77 QUE ANTES ESTABA EN ESTADOS DE CUENTAS (ECPN PYMES), PERO EN ESTADOS DE CUENTAS TIENEN 2 CASILLAS REPETIDAS ??
	,C0081  ,C0045  ,C0072
	,C0082	,C0063  ,C0073
	,C0016  ,C0071  ,C0037 		
	,C0026  ,C0070  ,C0044
...
//	SALGA PUBLICADA LA ORDEN
	...
	,BN394 	,BN436 	,BN437 	,BN438 	,BN2076  // FALTA - DUPLICIDAD DE CLAVES
...
// --------------- PAGINA 16 BIS --------------- //	
	...
	,BN237	,BN238	,BN239
	,BN711	,BN712	,BN2077  // FALTA - DUPLICIDAD DE CLAVES
	,BN2335	,BN2336	,BN2337
	,BN2338	,BN2339	,BN2340
	,BN2341	,BN2342	,BN2343
	,BN2344	,BN2345	,BN2346
	,BN244	,BN245	,BN2497
	,BN2078 ,BN1913 ,BN766  // FALTA - DUPLICIDAD DE CLAVES		
	,BN880	,BN881	
	,BN866	,BN867	,BN870
	,BN939	,BN940	,BN941
	,BN191	,BN192	,BN193
...
// --------------- PAGINAS 17, 18 Y 18 BIS --------------- //
	...
	,BN986	,BN810	,BN507
	,BN557  ,BN591	,BN594
	,BN2081 ,BN2082 ,BN2083  // FALTA - DUPLICIDAD DE CLAVES
	,BN2297 ,BN2298 ,BN2299
	,BN1617	,BN1618	,BN1619
	,BN1620	,BN1621	,BN1622
	,BN2084 ,BN2085 ,BN2086  // FALTA - DUPLICIDAD DE CLAVES
	,BN2300 ,BN2500 ,BN2087
	,BN1850	,BN1851	,BN1852
	,BN1853	,BN1854	,BN1855		
	,BN2088 ,BN2089 ,BN2090  // FALTA - DUPLICIDAD DE CLAVES
...
//	,BN1874	,BN1875	,BN1876
	,BN1907	,BN1908	,BN1909  // FALTA - DUPLICIDAD DE CLAVES
	,BN1910	,BN1911	,BN1912  // FALTA - DUPLICIDAD DE CLAVES
	...
	,BN878  ,BN879  ,BN882
	,BN902  ,BN906  ,BN1870
	,BN1914 ,BN955  ,BN956  // FALTA - DUPLICIDAD DE CLAVES
	,BN957  ,BN1087 ,BN1088
...
// --------------- PAGINA 26 --------------- //	
	...
	// SE PONEN EN OTRO ENUMERADO (Mod2002022KeyDC) PORQUE SI LOS AÑADIMOS AQUI TENEMOS ERROR DE CODE TOO LARGE
	...
	public static Mod2002022Key safeValueOf(String str) {
		for (Mod2002022Key key : values()) {
