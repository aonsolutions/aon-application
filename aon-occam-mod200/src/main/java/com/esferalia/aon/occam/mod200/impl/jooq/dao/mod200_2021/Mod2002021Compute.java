...
//	public static EnumMap<Mod2002021Key,String> COMPUTE_EXPRESSION_MAP = new EnumMap<Mod2002021Key,String>(Mod2002021Key.class);
	...
	static {
		...
		// PARTICIPACIONES		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1501,"computeP1501()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1502,"computeP1502()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1503,"computeP1503()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1504,"computeP1504()");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1505,"computeP1505()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1506,"computeP1506()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1809,"computeP1809()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1810,"computeP1810()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1507,"computeP1507()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.P1508,"computeP1508()");
	...
	static { 
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0500,"PG500");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0336,"isEcpnNormal()?(T0337+T0338):(T0336)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0345,"(T0336+T0339+T0340+T0341+T0342+T0343+T0344)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0346,"isEcpnNormal()?(T0347+T0348):(T0346)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0354,"(T0346+T0349+T0350+T0351+T0352+T0353)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.T0355,"(T0500+T0345+T0354)");
	...
	static { 
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC425,"(TC383+TC397+TC411)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC426,"(TC384+TC398+TC412)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC428,"(TC386+TC400+TC414)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC429,"(TC387+TC401+TC415)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC427,"(TC385+TC399+TC413)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC430,"(TC388+TC402+TC416)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC431,"(TC389+TC403+TC417)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC435,"(TC393+TC407+TC421)");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC467,"isEcpnPymes()?(TC481+TC495):(0.0)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC468,"isEcpnPymes()?(TC482+TC496):(0.0)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC469,"isEcpnPymes()?(TC483+TC497):(0.0)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC470,"isEcpnPymes()?(TC484+TC498):(0.0)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC471,"isEcpnPymes()?(TC485+TC499):(0.0)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC477,"isEcpnPymes()?(TC491+TC505):(0.0)");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC509,"isEcpnNormal()?(TC523+TC537+TC551+TC565+TC579+TC593+TC607):(TC523+TC537+TC607)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC510,"isEcpnNormal()?(TC524+TC538+TC552+TC566+TC580+TC594+TC608):(TC524+TC538+TC608)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC511,"isEcpnNormal()?(TC525+TC539+TC553+TC567+TC581+TC595+TC609):(TC525+TC539+TC609)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC512,"isEcpnNormal()?(TC526+TC540+TC554+TC568+TC582+TC596+TC610):(TC526+TC540+TC610)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC513,"isEcpnNormal()?(TC527+TC541+TC555+TC569+TC583+TC597+TC611):(TC527+TC541+TC611)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC514,"isEcpnNormal()?(TC528+TC542+TC556+TC570+TC584+TC598+TC612):(TC528+TC542+TC612)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC515,"isEcpnNormal()?(TC529+TC543+TC557+TC571+TC585+TC599+TC613):(TC529+TC543+TC613)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC519,"isEcpnNormal()?(TC533+TC547+TC561+TC575+TC589+TC603+TC617):(TC533+TC547+TC617)");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC621,"(TC718+TC732)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC622,"(TC719+TC733)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC623,"(TC720+TC734)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC624,"(TC721+TC735)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC625,"(TC722+TC736)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC626,"(TC723+TC737)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC627,"(TC724+TC738)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC631,"(TC728+TC742)");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC635,"isEcpnPymes()?(TC425+TC439+TC453+TC467+TC509+TC621):(TC425+TC439+TC509+TC621)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC636,"isEcpnPymes()?(TC426+TC440+TC454+TC468+TC510+TC622):(TC426+TC440+TC510+TC622)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC637,"isEcpnPymes()?(TC427+TC441+TC455+TC469+TC511+TC623):(TC427+TC441+TC511+TC623)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC638,"isEcpnPymes()?(TC428+TC442+TC456+TC470+TC512+TC624):(TC428+TC442+TC512+TC624)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC639,"isEcpnPymes()?(TC429+TC443+TC457+TC471+TC513+TC625):(TC429+TC443+TC513+TC625)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC640,"isEcpnPymes()?(TC430+TC444+TC458+TC472+TC514+TC626):(TC430+TC444+TC514+TC626)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC641,"isEcpnPymes()?(TC431+TC445+TC515+TC627):(TC431+TC445+TC515+TC627)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC645,"isEcpnPymes()?(TC435+TC449+TC463+TC477+TC519+TC631):(TC435+TC449+TC519+TC631)");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC435,"(TC422+TC423+TC424+TC425+TC426+TC427+TC428+TC429+TC430+TC431+TC432+TC433+TC434)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC449,"(TC436+TC437+TC438+TC439+TC440+TC441+TC442+TC443+TC444+TC445+TC446+TC448)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC463,"(TC450+TC451+TC452+TC453+TC454+TC455+TC456+TC457+TC458+TC461+TC462)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC477,"(TC464+TC465+TC466+TC467+TC468+TC469+TC470+TC471+TC472+TC475+TC476)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC491,"(TC478+TC479+TC480+TC481+TC482+TC483+TC484+TC485+TC486+TC489+TC490)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC505,"(TC492+TC493+TC494+TC495+TC496+TC497+TC498+TC499+TC502+TC503+TC504)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC519,"(TC506+TC507+TC508+TC509+TC510+TC511+TC512+TC513+TC514+TC515+TC516+TC517+TC518)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC533,"(TC520+TC521+TC522+TC523+TC524+TC525+TC526+TC527+TC528+TC529+TC530+TC531+TC532)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC547,"(TC534+TC535+TC536+TC537+TC538+TC539+TC540+TC541+TC542+TC543+TC544+TC545+TC546)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC561,"(TC548+TC549+TC550+TC551+TC552+TC553+TC554+TC555+TC556+TC557+TC558+TC560)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC575,"(TC562+TC563+TC564+TC565+TC566+TC567+TC568+TC569+TC570+TC571+TC572+TC574)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC589,"(TC576+TC577+TC578+TC579+TC580+TC581+TC582+TC583+TC584+TC585+TC586+TC588)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC603,"(TC590+TC591+TC592+TC593+TC594+TC595+TC596+TC597+TC598+TC599+TC600+TC602)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC617,"(TC604+TC605+TC606+TC607+TC608+TC609+TC610+TC611+TC612+TC613+TC614+TC615+TC616)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC631,"(TC618+TC619+TC620+TC621+TC622+TC623+TC624+TC625+TC626+TC627+TC628+TC629+TC630)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC728,"(TC715+TC716+TC717+TC718+TC719+TC720+TC721+TC722+TC723+TC724+TC725+TC726+TC727)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC742,"(TC729+TC730+TC731+TC732+TC733+TC734+TC735+TC736+TC737+TC738+TC739+TC740+TC741)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TC645,"(TC632+TC633+TC634+TC635+TC636+TC637+TC638+TC639+TC640+TC641+TC642+TC643+TC644)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1231,"computeLQ1231()");
		...
		for (Mod2002021CorrectionKey key : Mod2002021CorrectionKey.values()) {
			// Aumento
			if (key.getIncrease() != null) {
				String detailKeys = "";
				Mod2002021KeyDC[] detailIncrease = key.getDetailIncrease();
				for (int i=1; i<=3; i++) {
					Mod2002021KeyDC key2 = detailIncrease[i];
					if (key2!=null) {
			...
			if (key.getDecrease() != null) {
				String detailKeys = "";
				Mod2002021KeyDC[] detailDecrease = key.getDetailDecrease();
				for (int i=1; i<=3; i++) {
					Mod2002021KeyDC key2 = detailDecrease[i];
					if (key2!=null) {
						if (!detailKeys.isEmpty()) 
							detailKeys = detailKeys + "+";
						detailKeys = detailKeys + key2.toString();
    	...
    	COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2305, dc2305);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2309, dc2309);

		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2302, dc2302);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2304, dc2304);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2308, dc2308);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2306, dc2306);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.DC2310, dc2310);
		
		// Total correcciones al resultado de la cuenta de pérdidas y ganancias
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.I0417, i0417);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.D0418, d0418);
		
        COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.I0417B,"I0417");
        COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.D0418B,"D0418");
	...
	static {
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ578,"C0022?(LQ501+LQ1230-LQ1231+I0417-D0418):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ579,"C0022?(LQ630+(LQ631-LQ632)):0.0");
	...
	static { 
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1029,"(C0009 || C0010)?(LQ501+LQ1230-LQ1231+I0417-D0418):(0.0)");
		
		// Base imponible
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ550,"computeLQ550()");
		
		// Casilla 1032: Reserva de capitalización
		addBreakdown(Mod2002021LQ1032Key.values(), Mod2002021Key.LQ1032);

		// Casilla 547: Compensación de bases imponibles negativas de períodos anteriores
		addBreakdown(Mod2002021LQ547Key.values(), Mod2002021Key.LQ547);
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1049,"LQ1048");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.CPE12,"(isCooperativa())?CP0E6+CP0E7-CP0E8-CP0E9+CPE10+CPE11:0.0");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN736,"(BN103A==0||BN920==0||LQ562==0)?(BN735):(round(BN735*BN103A/BN920))");
		addPreBreakdownDoubleImposition(Mod2002021BN570Key.values(), Mod2002021Key.BN570, Mod2002021Key.BN103A);
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN204 ,"(BN103B==0||BN203==0 ||LQ562==0)?(BN199 ):(round(BN199 *BN103B/BN203 ))");
		addPreBreakdownDoubleImposition(Mod2002021BN1344Key.values(), Mod2002021Key.BN1344, Mod2002021Key.BN103B);
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN135,"(BN103C==0||BN926==0||LQ562==0)?(BN134):(round(BN134*BN103C/BN926))");
		addPreBreakdownDoubleImposition(Mod2002021BN572Key.values(), Mod2002021Key.BN572, Mod2002021Key.BN103C);
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN209 ,"(BN103D==0||BN208==0 ||LQ562==0)?(BN207) :round(BN207 *BN103D/BN208 )");
		addPreBreakdownDoubleImposition(Mod2002021BN571Key.values(),Mod2002021Key.BN571, Mod2002021Key.BN103D);
		...
		addBreakdown(Mod2002021BN573Key.values(),Mod2002021Key.BN573);
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN582,"(LQ562+LQ1038)-(BN567+BN568+BN563+BN566+BN576+BN569+BN570+BN1344+BN1280+BN572+BN571+BN573+BN575+BN577+BN581)");
	}
	...
	static { 
		...
		addBreakdown(Mod2002021BN585Key.values(), Mod2002021Key.BN585);
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN233 ,"round(BN232 *0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1124,"round(BN1123*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1128,"round(BN1127*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1427,"round(BN1426*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1431,"round(BN1430*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1711,"round(BN1710*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1715,"round(BN1714*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1969,"round(BN1968*0.8)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1973,"round(BN1972*0.8)");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1095,"round(BN1094*0.8)");
		...
		addBreakdown(Mod2002021BN082Key.values(),Mod2002021Key.BN082);
		
		// Casilla 1040: Deducción por reversión de medidas temporales DT 37ª.1 LIS
		addPreBreakdownTemporaryMeasures(Mod2002021BN1040Key.values(), Mod2002021Key.BN1040);
		...
		addPreBreakdownTemporaryMeasures(Mod2002021BN1041Key.values(), Mod2002021Key.BN1041);
		addBreakdown(Mod2002021BN1041Key.values(), Mod2002021Key.BN1041);
		
		// Cuota líquida positiva
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN592,
	...
	static {
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1766, "BN1785+BN1787+BN1789+BN1791+BN1793+BN1795+BN597+BN1798");	
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1784, "BN1786+BN1788+BN1790+BN1792+BN1794+BN1796+BN1797+BN1799");
		
		// Desglose Tributación Conjunta
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR050, "C0028?(TR051+TR052+TR053+TR054+TR055+TR056):0.0");
		                                                
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR626, "(C0028 && round(TR050-TR051) != 0.0)?round(TR052*100/(TR050-TR051)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR627, "(C0028 && round(TR050-TR051) != 0.0)?round(TR053*100/(TR050-TR051)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR628, "(C0028 && round(TR050-TR051) != 0.0)?round(TR054*100/(TR050-TR051)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR629, "(C0028 && round(TR050-TR051) != 0.0)?round(TR055*100/(TR050-TR051)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR625, "(C0028 && round(TR050-TR051) != 0.0)?(100.00-(TR626+TR627+TR628+TR629)):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR420, "computeTR420()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR421, "computeTR421()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR426, "computeTR426()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR427, "computeTR427()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR600, "C0028?(TR420+TR421+TR426+TR427):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR602, "C0028?(TR402+TR442+TR443+TR444):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR604, "C0028?(TR445+TR446+TR447+TR448):0.0");		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR606, "C0028?(TR449+TR451+TR450+TR465):0.0");		
		                                                
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR474, "C0028?(TR420-(TR402+TR445+TR449)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR475, "C0028?(TR421-(TR442+TR446+TR450)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR476, "C0028?(TR426-(TR443+TR447+TR451)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR477, "C0028?(TR427-(TR444+TR448+TR465)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR612, "C0028?(TR474+TR475+TR476+TR477):0.0");
		                                                
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR616, "C0028?(TR482+TR483+TR484+TR485 ):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR642, "C0028?(TR913+TR914+TR915+TR916 ):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR618, "C0028?(TR486+TR487+TR488+TR489 ):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1332, "C0028?(TR1334+TR1335+TR1336+TR1337):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1333, "C0028?(TR1338+TR1339+TR1340+TR1341):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1624, "C0028?(TR474+TR482+TR913+TR486-TR1334-TR1338):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1625, "C0028?(TR475+TR483+TR914+TR487-TR1335-TR1339):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1629, "C0028?(TR476+TR484+TR915+TR488-TR1336-TR1340):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1630, "C0028?(TR477+TR485+TR916+TR489-TR1337-TR1341):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1587, "C0028?(TR1624+TR1625+TR1629+TR1630):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1583, "C0028?(TR1607+TR1608+TR1609+TR1610):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1585, "C0028?(TR1611+TR1612+TR1613+TR1623):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR494, "C0028?(TR1624-TR1607+TR1611):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR495, "C0028?(TR1625-TR1608+TR1612):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR496, "C0028?(TR1629-TR1609+TR1613):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR497, "C0028?(TR1630-TR1610+TR1623):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR622, "C0028?(TR494+TR495+TR496+TR497):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2480, "C0028?(TR1631+TR1632+TR1633+TR1634):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2482, "C0028?(TR1635+TR1636+TR1637+TR1641):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2484, "C0028?(TR1642+TR1643+TR1644+TR1645):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1646, "C0028 && C0037?(TR1624-TR1635+TR1642):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1647, "C0028 && C0037?(TR1625-TR1636+TR1643):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1648, "C0028 && C0037?(TR1629-TR1637+TR1644):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1649, "C0028 && C0037?(TR1630-TR1641+TR1645):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2486, "C0028 && C0037?(TR1646+TR1647+TR1648+TR1649):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2488, "C0028?(TR1650+TR1651+TR1652+TR1653):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1654, "C0028 && C0037?(TR1646-TR1650):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1655, "C0028 && C0037?(TR1647-TR1651):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1656, "C0028 && C0037?(TR1648-TR1652):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1657, "C0028 && C0037?(TR1649-TR1653):0.0");		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR3242, "C0028 && C0037?(TR1654+TR1655+TR1656+TR1657):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1043, "C0028?(TR1300+TR1301+TR1302+TR1303):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1044, "C0028?(TR1305+TR1306+TR1307+TR1308):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR3245, "C0028?(TR1658+TR1659+TR1660+TR1661):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR3319, "C0028?(TR1662+TR1663+TR1664+TR1665):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2491, "C0028?(TR1666+TR1667+TR1668+TR1669):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2494, "C0028?(TR1670+TR1671+TR1672+TR1673):0.0");
		
		// Cuota del ejercicio a ingresar o a devolver 
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN599, "C0028?(TR625/100*(BN592-LQ1766-LQ1784)):(BN592-LQ1766-LQ1784)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN600, "TR600");
		
		// Cuota diferencial
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN602, "TR602");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN604, "TR604");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN606, "TR606");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN611, "BN599-(BN601+BN603+BN605)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN612, "TR612");
		
		// Resultado de la autoliquidación
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN616, "TR616");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN642, "TR642");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN618, "TR618");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1332, "TR1332");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1333, "TR1333");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1234B,"BN083+BN1332"); 
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1200,"(BN1039M-BN1039)+(BN2314M-BN2314)");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1042,"(C0028)?(BN1200-BN1333):(BN1200)");  
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1586, "BN611+BN615+BN633+BN617-BN083-BN1042");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ1587, "TR1587");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2480, "C0037?TR2480:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2482, "C0037?TR2482:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2484, "C0037?TR2484:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2485, "C0037?LQ1586-LQ2481+LQ2483:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2486, "C0037?TR2486:0.0");
		
		// Líquido a ingresar incluido el 1er fraccionamiento del art. 19.1 LIS
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2488, "C0037?TR2488:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2489, "C0037?LQ2485-LQ2487:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3242, "C0037?TR3242:0.0");
		
		// Conversión de activos por impuesto diferido en crédito exigible frente a la Administración tributaria
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1043, "TR1043");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1044, "TR1044");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3245, "TR3245");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3319, "TR3319");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2491, "TR2491");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2494, "TR2494");	
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM150, "BN1020+BN1043"); 
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM506, "BN1021+BN1044"); 
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3243, "LQ3244+LQ3245");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3317, "LQ3318+LQ3319");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3320, "LQ2490+LQ2491");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2492, "LQ2493+LQ2494");
		
		
		// TRIBUTACION CONJUNTA
		
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN600, "(C0028 && TR625 != 0 && TR625 != 100)?(TR600) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN602, "(C0028 && TR625 != 0 && TR625 != 100)?(TR602) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN604, "(C0028 && TR625 != 0 && TR625 != 100)?(TR604) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN606, "(C0028 && TR625 != 0 && TR625 != 100)?(TR606) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN612, "(C0028 && TR625 != 0 && TR625 != 100)?(TR612) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN616, "(C0028 && TR625 != 0 && TR625 != 100)?(TR616) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN642, "(C0028 && TR625 != 0 && TR625 != 100)?(TR642) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN618, "(C0028 && TR625 != 0 && TR625 != 100)?(TR618) :(0.0)");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN620, "(C0028 && TR625 != 0 && TR625 != 100)?(TR620) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1332,"(C0028 && TR625 != 0 && TR625 != 100)?(TR1332):(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1333,"(C0028 && TR625 != 0 && TR625 != 100)?(TR1333):(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN622, "(C0028 && TR625 != 0 && TR625 != 100)?(TR622) :(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1043,"(C0028 && TR625 != 0 && TR625 != 100)?(TR1043):(0.0)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1044,"(C0028 && TR625 != 0 && TR625 != 100)?(TR1044):(0.0)");
//		
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1200,"(BN1039M-BN1039)+(BN2314M-BN2314)");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1042,"(C0028)?(BN1200-BN1333):(BN1200)");
//		
//		// Resultado de la autoliquidación (Adm.Forales)				
//		// 01587 = 00612 + 00616 + 00642 + 00618 - 01332 - 01333
//		
//		// Líquido a ingresar o a devolver (D.Forales)
//		// 00622 = 01587 - 01583 + 01585
//		
//		// Resultado de la autoliquidación incluido el 1er fraccionamiento del art. 19.1 LIS (D.Forales)
//		// 02486 = 01587 - 02482 + 02484
		
//		// Cuota diferencial (D. Forales / Navarra)
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN612, "C0028?BN600-(BN602+BN604+BN606):0.0");
//		
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1234B,"BN083 +BN1332");
//		
//		// Liquido a ingresar o a devolver (D. Forales / Navarra)
//		//COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN622,"C0028?(BN612+BN616+BN642+BN618+BN620-BN1332-BN1333):0.0");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN622,"C0028?(BN612+BN616+BN642+BN618-BN1332-BN1333):0.0");
	}
	
	static { 
		
		//  Limitación en la deducibilidad de gastos financieros.
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1240,"isLimitEnabled()?(LM1242+LM1243):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1246,"isLimitEnabled()?(LM1242+LM1245):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1248,"isLimitEnabled()?((LM1247>=LM1246)?0.0:(LM1246-LM1247)):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1250,"isLimitEnabled()?PG296:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1251,"isLimitEnabled()?PG284:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1252,"isLimitEnabled()?PG285:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1253,"isLimitEnabled()?PG287:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1249,"isLimitEnabled()?computeLM1249():0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1260,"isLimitEnabled()?LM1243+LM1257:0.0");

		 // Limitación en la deducibilidad de gastos financieros. Gastos financieros pendientes de deducir
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1191,"LM1188-LM1189");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1196,"LM1193-LM1194");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1201,"LM1198-LM1199");		
		addBreakdown(Mod2002021LM1212Key.values(), Mod2002021Key.LM1212, false);

		// Pendiente de adición por límite beneficio operativo no aplicado
		addBreakdown(Mod2002021LM538Key.values(), Mod2002021Key.LM538);
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1517,"LM1515-LM1516-LM1585");
	}
	...
	static {
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1527,"LM1524-LM1525-LM1526");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1528,"LM1527");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1534,"LM1531+LM1532+LM1533");
		addBreakdown(Mod2002021LM1535Key.values(), Mod2002021Key.LM1535, false);
		
		// Activos por impuesto diferido (AID). Art. 130 LIS
		addBreakdown(Mod2002021LM1561Key.values(), Mod2002021Key.LM1561, false);
		
		// Conversión de activos por impuesto diferido en crédito exigible frente a la Admón. tributaria		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM393,"LM1537+LM1567");
		// LA HE SUBIDO ARRIBA EN EL CALCULO DE LA ULTIMA PAGINA DE LA LIQUIDACION
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM150,"BN1020+BN1043"); 
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM506,"BN1021+BN1044"); 

		// Exceso cuota líquida positiva (art. 130.1 y DT 33ª.4 LIS)
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM2280,"LM2277-LM2278-LM2279");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM2430,"LM2427-LM2428-LM2429");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1138,"LM1134-LM1135-LM1136");
		addBreakdown(Mod2002021LM1579Key.values(), Mod2002021Key.LM1579, false);
	...
	static { 
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.ID650,"LQ500>0?LQ500:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.ID653,"ID650+ID651+ID652");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.ID654,"ID1270+ID1271+ID1522");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.ID666,"ID654+ID655+ID656+ID658+ID659+ID660+ID662+ID664+ID665");
		
		// Dotaciones por deterioro de créditos u otros activos ...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LM1164,"LM1162-LM1163");
		addBreakdown(Mod2002021LM1494Key.values(), Mod2002021Key.LM1494, false);
		
		// Régimen especial de la reserva para inversiones en Canarias
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC093,"RC089-RC094-RC095");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC048,"RC097-RC098-RC047");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC527,"RC524-RC525-RC526");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC925,"RC922-RC923-RC924");		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC996,"RC1165-RC928-RC938");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC1175,"RC927-RC1174");
		
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC996,"RC927-RC928-RC938-RC2441");
//		//COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC2441,"RC2442-RC2443+RC2444-RC2445+RC2446-RC2447+RC2449+RC2450-RC2451");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.RC2441,"RC2444-RC2445+RC2446-RC2447-RC2451");
...
// TODO AQUI ESTAMOS -----------------------------------------------------------------------		
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.UT500,"(C0013 || C0014)?LQ500:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.UT552,"(C0013 || C0014)?LQ552:0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.UT1330,"computeUT1330()");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR642 ,"C0028?(TR913 +TR914 +TR915 +TR916 ):0.0");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR618 ,"C0028?(TR486 +TR487 +TR488 +TR489 ):0.0");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR620 ,"C0028?(TR490 +TR491 +TR492 +TR493 ):0.0");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1332,"C0028?(TR1334+TR1335+TR1336+TR1337):0.0");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1333,"C0028?(TR1338+TR1339+TR1340+TR1341):0.0");
//		
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR494 ,"C0028?(TR474 + TR482 + TR913 + TR486 + TR490 - TR1334 - TR1338 ):0.0");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR495 ,"C0028?(TR475 + TR483 + TR914 + TR487 + TR491 - TR1335 - TR1339 ):0.0");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR496 ,"C0028?(TR476 + TR484 + TR915 + TR488 + TR492 - TR1336 - TR1340 ):0.0");
////		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR497 ,"C0028?(TR477 + TR485 + TR916 + TR489 + TR493 - TR1337 - TR1341 ):0.0");
//		
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR622 ,"C0028?(TR494 +TR495 +TR496 +TR497 ):0.0");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1043,"C0028?(TR1300+TR1301+TR1302+TR1303):0.0");
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1044,"C0028?(TR1305+TR1306+TR1307+TR1308):0.0");
...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.C0027,"computeC0027()");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.C0027,"round(LQ552)>0?0.0:1.0");
	}
	...
	private static void addBreakdown(IMod200KeysProvider[] keysProvider, Mod2002021Key totalRowKey, boolean computeTotalCol, Mod2002021Key fromKey, Mod2002021Key toKey) {
		...
		for (IMod200KeysProvider kp : keysProvider) {
			...
			if (Arrays.asList(keys).contains(totalRowKey)) {
				...
				for (int i = 0; i < totalRow.length; i++) {
					if (keys[i] != null) 
						COMPUTE_EXPRESSION_MAP.put((Mod2002021Key) keys[i],totalRow[i]);					
				}
				break;
			}
			else { 
	...
	private static void addBreakdown(IMod200KeysProvider[] keysProvider, Mod2002021Key totalRowKey, boolean computeTotalCol) {
	...
	private static void addPreBreakdownDoubleImposition(IMod200KeysProvider[] keysProvider, Mod2002021Key totalRowKey, Mod2002021Key taxRateKey) {
	...
	private static void addPreBreakdownBN082() {
		...
		for (IMod200KeysProvider kp : Mod2002021BN082Key.values()) {
			...
			if (Arrays.asList(keys).contains(Mod2002021Key.BN082)) {
				// Fila que lleva los totales
				break;
			}
			else { 
				// Resto de filas, se calcula la columna 2
				Mod2002021Key key1 = (Mod2002021Key) keys[0];
				Mod2002021Key key2 = (Mod2002021Key) keys[1];
	...
	private static void addPreBreakdownTemporaryMeasures(IMod200KeysProvider[] keysProvider, Mod2002021Key totalRowKey) {
		...
		for (IMod200KeysProvider kp : keysProvider) {
			...
			if (Arrays.asList(keys).contains(totalRowKey)) {				
				...
				Mod2002021Key key1 = (Mod2002021Key) keys[0];  // Base de deducción
				Mod2002021Key key2 = (Mod2002021Key) keys[1];  // Importe generado/pendiente al principio del período				
