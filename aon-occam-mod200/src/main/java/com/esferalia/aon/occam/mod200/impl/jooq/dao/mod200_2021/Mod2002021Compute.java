...
//		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.BN1095,"round(BN1094*0.8)");
	...
	static {
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1646, "C0028?(TR1624-TR1635+TR1642):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1647, "C0028?(TR1625-TR1636+TR1643):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1648, "C0028?(TR1629-TR1637+TR1644):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1649, "C0028?(TR1630-TR1641+TR1645):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2486, "C0028?(TR1646+TR1647+TR1648+TR1649):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR2488, "C0028?(TR1650+TR1651+TR1652+TR1653):0.0");
		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1654, "C0028?(TR1646-TR1650):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1655, "C0028?(TR1647-TR1651):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1656, "C0028?(TR1648-TR1652):0.0");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR1657, "C0028?(TR1649-TR1653):0.0");		
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.TR3242, "C0028?(TR1654+TR1655+TR1656+TR1657):0.0");
		...
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2480, "TR2480");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2482, "TR2482");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2484, "TR2484");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2485, "LQ1586-LQ2481+LQ2483");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2486, "TR2486");
		
		// Líquido a ingresar incluido el 1er fraccionamiento del art. 19.1 LIS
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2488, "TR2488");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ2489, "LQ2485-LQ2487");
		COMPUTE_EXPRESSION_MAP.put(Mod2002021Key.LQ3242, "TR3242");
