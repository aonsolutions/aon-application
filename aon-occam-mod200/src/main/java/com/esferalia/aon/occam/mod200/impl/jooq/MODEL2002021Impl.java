...
public class MODEL2002021Impl implements IMODEL2002021 {
	...
	@Override
	public Mod2002021 initializeNewMod2002021(AONContext ctx, Mod2002021 mod200) {
		return Mod2002021DAO.initializeNewMod200(ctx,mod200);
	}
	...
	@Override
	public Mod2002021 getMod2002021ByYear(AONContext ctx, int year) {
		return Mod2002021DAO.getByYear(ctx,year);
	}
	...
	@Override
	public String dumpAEATMod2002021(Mod2002021 mod200) {
		return Mod2002021DAO.dumpAEAT(mod200);
	}
