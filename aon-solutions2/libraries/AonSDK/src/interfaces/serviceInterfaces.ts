import { ICollectable, IEnterprise, IMessage, IMark, IProductStatus, IProductCode, IProductType, IProductClass, IProductCategory, ITax, IIRPF, IInvoiceCategory, IInvoiceSerie, IInvoiceTransactionType, IRegistryEnterprise, IUser, IDocument, IBank, ITaxModel } from "./modelsInterfaces";
...
export interface ITaxModelSpecificMethods {
    payTaxModelWithNRC(model: ITaxModel, nrc: string): Promise<IResponse<boolean>>;
    payTaxModelWithBank(model: ITaxModel, bank: IBank): Promise<IResponse<boolean>>;
}