...
if(messages.size() == 0){
    messages.add(new Message('Asesor1','Asunto 1','sunt in culpa qui officia deserunt',new Date("2023-06-12 12:00"),TypeMessage.CONSULTA,StatusMessage.ABIERTA, new Date("2023-08-24 23:30"), false));
    messages.add(new Message('Asesor2','Asunto 1','sunt in culpa qui officia deserunt',new Date("2023-06-26 14:00"),TypeMessage.CONSULTA,StatusMessage.ABIERTA, new Date("2023-08-24 23:30"), true));
    messages.add(new Message('Asesor3','Asunto 1','sunt in culpa qui officia deserunt',new Date("2023-07-16 15:00"),TypeMessage.CONSULTA,StatusMessage.CERRADA, new Date("2023-08-24 23:30"), true));
    ...
    messages.add(new Message('Asesor2','Asunto 3','sunt in culpa qui officia deserunt',new Date("2023-06-19 12:25"),TypeMessage.TAREA,StatusMessage.PENDIENTE,new Date("2023-08-28 22:30")));
