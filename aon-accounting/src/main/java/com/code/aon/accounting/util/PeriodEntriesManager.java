...
public class PeriodEntriesManager {
	...
	private Account getResultAcount() throws ManagerBeanException {
		IManagerBean accountBean = BeanManager.getManagerBean(Account.class);
		Criteria c = new Criteria();
		c.addEqualExpression(accountBean.getFieldName(IAccountAlias.ACCOUNT_CODE), "129");
		...
		c = new Criteria();
		c.addEqualExpression(accountBean.getFieldName(IAccountAlias.ACCOUNT_CODE), "1290");
		...
		c = new Criteria();
		c.addEqualExpression(accountBean.getFieldName(IAccountAlias.ACCOUNT_CODE), "129000000");
		iter = accountBean.getList(c).iterator();
