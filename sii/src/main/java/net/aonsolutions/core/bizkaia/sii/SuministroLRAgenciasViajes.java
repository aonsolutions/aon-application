...
@XmlRootElement(name = "SuministroLRAgenciasViajes", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class SuministroLRAgenciasViajes
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRAgenciasViajes",  namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
