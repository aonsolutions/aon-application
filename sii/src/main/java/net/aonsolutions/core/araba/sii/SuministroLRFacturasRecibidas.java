...
@XmlRootElement(name = "SuministroLRFacturasRecibidas", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd")
public class SuministroLRFacturasRecibidas
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRFacturasRecibidas", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd", required = true)
