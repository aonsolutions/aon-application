...
@XmlRootElement(name = "SuministroLRDetOperacionIntracomunitaria", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd")
public class SuministroLRDetOperacionIntracomunitaria
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRDetOperacionIntracomunitaria", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd", required = true)
