...
@XmlType(name = "FacturaRespuestaType", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", propOrder = {
    "tipoFactura",
    "tipoRectificativa",
    "facturasAgrupadas",
...
public class FacturaRespuestaType {
    ...
    public static class FacturasAgrupadas {
        ...
        @XmlElement(name = "IDFacturaAgrupada", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", required = true)
    ...
    public static class FacturasRectificadas {
        ...
        @XmlElement(name = "IDFacturaRectificada", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", required = true)
