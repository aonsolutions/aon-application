...
for jar in /usr/share/java/aon-conexflow/*.jar ; do 
...
case $1 in
	help)
  		...
  		echo "aon ConexFlow command-line client."
	...
	list) 
    	$JAVA -classpath $CLASSPATH com.code.aon.conexflow.rpm.ProjectReservationList "${@:2}" 
    	;;
