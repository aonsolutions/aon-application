...
import com.code.aon.amazon.apis.sessionInfo.SessionEnterpriseInfo;
import com.code.aon.amazon.apis.sessionInfo.SessionInfo;
import com.google.api.client.auth.oauth2.AuthorizationCodeFlow;

public class AmazonAuthorizationCodeServlet extends HttpServlet {
	...
	public static String getAct(){
	  ...
	  protected void service(HttpServletRequest req, HttpServletResponse resp)
	      ...
	      String authorizationUrl = "https://www.amazon.com/ap/oa"
	  ...
	  protected  String getRedirectUri(HttpServletRequest req)
		  ...
		  String key = req.getServerName();
			...
			String action= AmazonAuthorizationServletUtils.getScheme(req)+"://"+key+ ( port != null ? ":" + port: "" )+req.getContextPath()+"/j_security_check"; 
			name=key;
			act=action;
		  ...
		  return AmazonAuthorizationServletUtils.getAuth2CallbackUri(req);
	  }

	  /** Returns the user ID for the given HTTP servlet request. */
	  protected  String getUserId(HttpServletRequest req) throws ServletException, IOException{
		  return AmazonAuthorizationServletUtils.getPrincipalShortName(req);
	  }

	  protected  String getClientId() throws ServletException, IOException{
		  return AmazonAuthorizationServletUtils.getClientId();
	  }
