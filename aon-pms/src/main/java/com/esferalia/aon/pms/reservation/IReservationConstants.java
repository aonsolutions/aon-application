...
public interface IReservationConstants {
	...
	String PREPAID_EXCEPTION_SELLER = "PREPAID_EXCEPTION_SELLER";
	String PREPAID_EXCEPTION_AGENCY = "PREPAID_EXCEPTION_AGENCY";
	String PREPAID_EXCEPTION_COMPANY = "PREPAID_EXCEPTION_COMPANY";
	...
	String CONEXFLOW_PREAUTH_CHECK_OK_PATTERN = "CONEXFLOW%_%-CHECK#%";
	String CONEXFLOW_PREAUTH_FAIL_PATTERN = "CONEXFLOW%_P-FAIL%";
	String CONEXFLOW_PREAUTH_CHECK_FAIL_PATTERN = "CONEXFLOW%_%-CHECK-FAIL#%";
	String CONEXFLOW_PREAUTH_CANCELLED_PATTERN = "CONEXFLOW%_P-CANCEL#%";
	...
	String CONEXFLOW_CANCEL_OK_PATTERN = "CONEXFLOW%_A#%";
	String CONEXFLOW_CANCEL_FAIL_PATTERN = "CONEXFLOW%_A-FAIL#%";
	String CONEXFLOW_FAIL_PATTERN = "CONEXFLOW%_%-FAIL#%";
	String CONEXFLOW_CREATE_TOKEN_PATTERN = "CONEXFLOW_(%)_T#";
	String CONEXFLOW_REMOVE_TOKEN_PATTERN = "CONEXFLOW_(%)_B#";
	String CONEXFLOW_NOT_REFUNDABLE_PATTERN = "CONEXFLOW%_V#%_ANT_TNR";
	String CONEXFLOW_PAYSLIP_PATTERN = "CONEXFLOW%PAYSLIP#%";

	String REDSYS_PAYSLIP_PATTERN = "REDSYS%PAYSLIP#%";
	String REDSYS_SALE_OK_PATTERN = "REDSYS%_V#%";
