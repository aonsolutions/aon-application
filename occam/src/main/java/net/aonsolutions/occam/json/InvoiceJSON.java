...
public class InvoiceJSON {
	...
	public static JSONObject to(Invoice invoice) {
		...
		return new JSONObject()
			...
			.putOpt(AonNames.ACTIVITY, ActivityJSON.to(invoice.getActivity().orElse(null)))
			...
			.putOpt(AonNames.DOCUMENT_TYPE, AonObjectUtils.ifNotNullDo(invoice.getDocumentType(), Object::toString ))
			.putOpt(AonNames.DOCUMENT_COUNTRY, AonObjectUtils.ifNotNullDo(invoice.getDocumentCountry(), Object::toString ))
			.putOpt(AonNames.NAME, invoice.getName())
			.putOpt(AonNames.SCOPE, AonObjectUtils.ifOptionalPresent(invoice.getScope(), ScopeJSON::to ) )
			.putOpt(AonNames.TYPE, AonObjectUtils.ifNotNullDo(invoice.getType(), Object::toString ))
			.putOpt(AonNames.TRANSACTION, AonObjectUtils.ifNotNullDo(invoice.getTransaction(), Object::toString ))			
