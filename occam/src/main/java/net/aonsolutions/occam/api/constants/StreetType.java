...
import static net.aonsolutions.occam.api.constants.AonLanguage.BASQUE;
import static net.aonsolutions.occam.api.constants.AonLanguage.CATALAN;
import static net.aonsolutions.occam.api.constants.AonLanguage.GALICIAN;
import static net.aonsolutions.occam.api.constants.AonLanguage.SPANISH;
import static net.aonsolutions.occam.api.constants.AonLanguage.VALENCIAN;
...
public enum StreetType {
	...
	public static Optional<StreetType> safeValueOf( Integer i ) {
		if (i == null) return Optional.empty();
		if (i < 0 || i >= StreetType.values().length) return Optional.empty();
		return Optional.of( StreetType.values()[i]);
	}
	
	public static Optional<StreetType> safeValueOf( String i ) {
