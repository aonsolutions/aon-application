...
import https.www2_agenciatributaria_gob_es.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.suministroinformacion.CountryMiembroType;
...
public class OperacionesIntracomunitarias extends SIIBuilt{
	...
	protected SuministroLRDetOperacionIntracomunitaria suministroOperacionesIntracomunitarias(Domain domain, String login, Company company, Integer invoiceId, LinkedList<VatContext> contextList, String tipoOp, Boolean mod, String terceros) {
		...
		oit.setEstadoMiembro(CountryMiembroType.valueOf(vat.getRegistryDocumentCountry().getAeatCode()));
