...
import https.sii_araba_eus.documentos.suministroinformacion.DesgloseFacturaRecibidasType.DesgloseIVA;
import https.sii_araba_eus.documentos.suministroinformacion.DesgloseFacturaRecibidasType.InversionSujetoPasivo;
import https.sii_araba_eus.documentos.suministroinformacion.DesgloseRectificacionType;
import https.sii_araba_eus.documentos.suministroinformacion.DetalleIVARecibida2Type;
import https.sii_araba_eus.documentos.suministroinformacion.DetalleIVARecibidaType;
...
import https.sii_araba_eus.documentos.suministroinformacion.IDFacturaRecibidaType.IDEmisorFactura;
...
import https.sii_araba_eus.documentos.suministroinformacion.PagosType;
...
public class FacturasRecibidas extends SIIBuilt{
	...
	protected byte[] getRespuestaSuministroFacturasRecibidas(RespuestaLRFRecibidasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRFRecibidasType");
	...
	protected byte[] getRespuestaBajaFacturasRecibidas(RespuestaLRBajaFRecibidasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRBajaFRecibidasType");
...
//			frt.setCuotaDeducible("0"); // TODO
	...
	protected byte[] getRespuestaSuministroFacturasRecibidasPagos(RespuestaLRPagosRecibidasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRPagosRecibidasType");
	...
	private PersonaFisicaJuridicaType contraparte(VatContext vat) {
		...
		if((vat.getRegistryDocumentCountry() == null || vat.getRegistryDocumentCountry().equals(Country.ES))
			...
			otro.setCodigoPais(CountryType2.valueOf(vat.getRegistryDocumentCountry().getIso2()));
			otro.setID(vat.getRegistryDocument());
			if(vat.isIntracommunity()) otro.setIDType(IDType.NIF_IVA.getName());
			else otro.setIDType(vat.getRegistryDocumentCountry().equals(Country.ES) ? 
