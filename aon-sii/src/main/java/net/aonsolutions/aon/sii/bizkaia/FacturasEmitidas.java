...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.CausaExencionType;
...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.CuponType;
...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.FacturaExpedidaType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.FacturaExpedidaType.DatosInmueble;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.FacturaExpedidaType.TipoDesglose;
...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDFacturaExpedidaType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDFacturaExpedidaType.IDEmisorFactura;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDOtroType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.MacrodatoType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.NoSujetaType;
...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaPrestacionType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaPrestacionType.Exenta;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaPrestacionType.NoExenta;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaPrestacionType.NoExenta.DesgloseIVA;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.TipoConDesgloseType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.TipoOperacionSujetaNoExentaType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.TipoSinDesglosePrestacionType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.TipoSinDesgloseType;
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.VariosDestinatariosType;
...
public class FacturasEmitidas extends SIIBuilt {
	...
	//			fet.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaEmitidasType._16.getName());
			...
			if(!fet.getTipoFactura().equals(ClaveTipoFacturaType.F_2) && !fet.getTipoFactura().equals(ClaveTipoFacturaType.F_4) 
				...
				if(vat.isService() && !vat.isIntracommunity()){
					...
					if(!noExenta.isEmpty()){
						eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta.DesgloseIVA diva2 = new eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta.DesgloseIVA();
						noExentaMap.keySet().stream().forEach(key -> {
						...
						eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta noExenta2 = new eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta();
						noExenta2.setDesgloseIVA(diva2);
						noExenta2.setTipoNoExenta(vat.isOtherISP()
								? TipoOperacionSujetaNoExentaType.S_2
								: TipoOperacionSujetaNoExentaType.S_1);
						st2.setNoExenta(noExenta2); 
					}
				...
				eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta.DesgloseIVA diva = new eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta.DesgloseIVA();
				eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta noExenta1 = new eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.SujetaType.NoExenta();
				if(AonMathUtils.isNotZero(exenta)) {
					if(vat.isOtherISP()) {
						DetalleIVAEmitidaType diet = new DetalleIVAEmitidaType();
						diet.setBaseImponible(Double.toString(AonMathUtils.round(exenta))); 
	...
	protected BajaLRFacturasEmitidas bajaFacturasEmitidas(Company company, Integer invoiceId, LinkedList<VatContext> vatList, String terceros) {
		...
		idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
		idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
		eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDFacturaExpedidaBCType.IDEmisorFactura emisor = new eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDFacturaExpedidaBCType.IDEmisorFactura();
		emisor.setNIF(company.getDocument());
		idFactura.setIDEmisorFactura(emisor);
		factura.setIDFactura(idFactura);
