...
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.DesgloseFacturaRecibidasType.DesgloseIVA;
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.DesgloseFacturaRecibidasType.InversionSujetoPasivo;
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.DesgloseRectificacionType;
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.DetalleIVARecibida2Type;
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.DetalleIVARecibidaType;
...
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.IDFacturaRecibidaType.IDEmisorFactura;
...
public class FacturasRecibidas extends SIIBuilt {
	...
	protected BajaLRFacturasRecibidas bajaFacturasRecibidas(Company company, Integer invoiceId,
		...
		https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.IDFacturaRecibidaNombreBCType.IDEmisorFactura emisor = new https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.IDFacturaRecibidaNombreBCType.IDEmisorFactura();
