...
public class OperacionesIntracomunitarias extends SIIBuilt {
	...
	protected byte[] getRespuestaSuministroOperacionesIntracomunitarias(RespuestaLROComunitariasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.respuestasuministro", "RespuestaLROComunitariasType");
	...
	protected byte[] getRespuestaBajaOperacionesIntracomunitarias(RespuestaLRBajaOComunitariasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.respuestasuministro", "RespuestaLRBajaOComunitariasType");
	...
	protected SuministroLRDetOperacionIntracomunitaria suministroOperacionesIntracomunitarias(Domain domain, String login, Company company, Integer invoiceId, LinkedList<VatContext> contextList, String tipoOp, Boolean mod, String terceros) {
		...
		oit.setDireccionOperador(address.getFullAddress() != null && !address.getFullAddress().equals("") 
