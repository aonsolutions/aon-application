...
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.CountryMiembroType;
...
import https.egoitza_gipuzkoa_eus.ogasuna.sii.ficheros.suministroinformacion.OperacionIntracomunitariaType;
...
public class OperacionesIntracomunitarias extends SIIBuilt {
	 ...
	 * @param invoiceList
	 */
	protected SuministroLRDetOperacionIntracomunitaria suministroOperacionesIntracomunitarias(Domain domain,
			String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList,
			String tipoOp, Boolean mod, String terceros, String auth) {
		...
		invoiceList.stream().forEach(invoice -> {
			...
			oit.setDireccionOperador(
					address.getFullAddress() != null && !address.getFullAddress().equals("") ? address.getFullAddress()
							: "Sin direcci\u00f3n");
	...
	protected BajaLRDetOperacionIntracomunitaria bajaOperacionesIntracomunitarias(Company company,
			LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
