...
import net.aonsolutions.core.araba.sii.BajaLRBienesInversion;
import net.aonsolutions.core.araba.sii.BajaLRDetOperacionIntracomunitaria;
import net.aonsolutions.core.araba.sii.BajaLRFacturasEmitidas;
import net.aonsolutions.core.araba.sii.BajaLRFacturasRecibidas;
import net.aonsolutions.core.araba.sii.BienDeInversionType;
import net.aonsolutions.core.araba.sii.CabeceraSii;
import net.aonsolutions.core.araba.sii.CabeceraSiiBaja;
import net.aonsolutions.core.araba.sii.CabeceraSiiCobrosPagos;
import net.aonsolutions.core.araba.sii.CausaExencionType;
import net.aonsolutions.core.araba.sii.ClaveOperacionType;
import net.aonsolutions.core.araba.sii.ClaveTipoComunicacionType;
import net.aonsolutions.core.araba.sii.ClaveTipoFacturaType;
import net.aonsolutions.core.araba.sii.CobrosType;
import net.aonsolutions.core.araba.sii.CountryMiembroType;
import net.aonsolutions.core.araba.sii.CountryType2;
import net.aonsolutions.core.araba.sii.CuponType;
import net.aonsolutions.core.araba.sii.DatosInmuebleType;
import net.aonsolutions.core.araba.sii.DatosPagoCobroType;
import net.aonsolutions.core.araba.sii.DesgloseFacturaRecibidasType;
import net.aonsolutions.core.araba.sii.DesgloseFacturaRecibidasType.InversionSujetoPasivo;
import net.aonsolutions.core.araba.sii.DesgloseRectificacionType;
import net.aonsolutions.core.araba.sii.DetalleIVAEmitidaPrestacionType;
import net.aonsolutions.core.araba.sii.DetalleIVAEmitidaType;
import net.aonsolutions.core.araba.sii.DetalleIVARecibida2Type;
import net.aonsolutions.core.araba.sii.DetalleIVARecibidaType;
import net.aonsolutions.core.araba.sii.EmitidaPorTercerosType;
import net.aonsolutions.core.araba.sii.FacturaExpedidaType;
import net.aonsolutions.core.araba.sii.FacturaExpedidaType.DatosInmueble;
import net.aonsolutions.core.araba.sii.FacturaExpedidaType.TipoDesglose;
import net.aonsolutions.core.araba.sii.FacturaRecibidaType;
import net.aonsolutions.core.araba.sii.FacturaType.FacturasAgrupadas;
import net.aonsolutions.core.araba.sii.FacturaType.FacturasRectificadas;
import net.aonsolutions.core.araba.sii.IDFacturaARType;
import net.aonsolutions.core.araba.sii.IDFacturaComunitariaType;
import net.aonsolutions.core.araba.sii.IDFacturaExpedidaBCType;
import net.aonsolutions.core.araba.sii.IDFacturaExpedidaType;
import net.aonsolutions.core.araba.sii.IDFacturaExpedidaType.IDEmisorFactura;
import net.aonsolutions.core.araba.sii.IDFacturaRecibidaNombreBCType;
import net.aonsolutions.core.araba.sii.IDFacturaRecibidaType;
import net.aonsolutions.core.araba.sii.IDOtroType;
import net.aonsolutions.core.araba.sii.LRAgenciasViajesType;
import net.aonsolutions.core.araba.sii.LRBajaBienesInversionType;
import net.aonsolutions.core.araba.sii.LRBajaExpedidasType;
import net.aonsolutions.core.araba.sii.LRBajaOperacionIntracomunitariaType;
import net.aonsolutions.core.araba.sii.LRBajaRecibidasType;
import net.aonsolutions.core.araba.sii.LRBienesInversionType;
import net.aonsolutions.core.araba.sii.LRCobrosEmitidasType;
import net.aonsolutions.core.araba.sii.LRCobrosMetalicoType;
import net.aonsolutions.core.araba.sii.LRFacturasRecibidasType;
import net.aonsolutions.core.araba.sii.LROperacionIntracomunitariaType;
import net.aonsolutions.core.araba.sii.LROperacionesSegurosType;
import net.aonsolutions.core.araba.sii.LRPagosEmitidasType;
import net.aonsolutions.core.araba.sii.LRfacturasEmitidasType;
import net.aonsolutions.core.araba.sii.NoSujetaType;
import net.aonsolutions.core.araba.sii.OperacionIntracomunitariaType;
import net.aonsolutions.core.araba.sii.PagosType;
import net.aonsolutions.core.araba.sii.PersonaFisicaJuridicaESType;
import net.aonsolutions.core.araba.sii.PersonaFisicaJuridicaType;
import net.aonsolutions.core.araba.sii.RegistroSii.PeriodoImpositivo;
import net.aonsolutions.core.araba.sii.RespuestaLRAgenciasViajesType;
import net.aonsolutions.core.araba.sii.RespuestaLRBajaBienesInversionType;
import net.aonsolutions.core.araba.sii.RespuestaLRBajaFEmitidasType;
import net.aonsolutions.core.araba.sii.RespuestaLRBajaFRecibidasType;
import net.aonsolutions.core.araba.sii.RespuestaLRBajaOComunitariasType;
import net.aonsolutions.core.araba.sii.RespuestaLRBienesInversionType;
import net.aonsolutions.core.araba.sii.RespuestaLRCobrosEmitidasType;
import net.aonsolutions.core.araba.sii.RespuestaLRFEmitidasType;
import net.aonsolutions.core.araba.sii.RespuestaLRFRecibidasType;
import net.aonsolutions.core.araba.sii.RespuestaLRIMetalicoType;
import net.aonsolutions.core.araba.sii.RespuestaLROComunitariasType;
import net.aonsolutions.core.araba.sii.RespuestaLROperacionesSegurosType;
import net.aonsolutions.core.araba.sii.RespuestaLRPagosRecibidasType;
import net.aonsolutions.core.araba.sii.SujetaPrestacionType;
import net.aonsolutions.core.araba.sii.SujetaType;
import net.aonsolutions.core.araba.sii.SujetaType.Exenta;
import net.aonsolutions.core.araba.sii.SujetaType.NoExenta;
import net.aonsolutions.core.araba.sii.SujetaType.NoExenta.DesgloseIVA;
import net.aonsolutions.core.araba.sii.SuministroLRAgenciasViajes;
import net.aonsolutions.core.araba.sii.SuministroLRBienesInversion;
import net.aonsolutions.core.araba.sii.SuministroLRCobrosEmitidas;
import net.aonsolutions.core.araba.sii.SuministroLRCobrosMetalico;
import net.aonsolutions.core.araba.sii.SuministroLRDetOperacionIntracomunitaria;
import net.aonsolutions.core.araba.sii.SuministroLRFacturasEmitidas;
import net.aonsolutions.core.araba.sii.SuministroLRFacturasRecibidas;
import net.aonsolutions.core.araba.sii.SuministroLROperacionesSeguros;
import net.aonsolutions.core.araba.sii.SuministroLRPagosRecibidas;
import net.aonsolutions.core.araba.sii.TipoConDesgloseType;
import net.aonsolutions.core.araba.sii.TipoOperacionSujetaNoExentaType;
import net.aonsolutions.core.araba.sii.TipoSinDesglosePrestacionType;
import net.aonsolutions.core.araba.sii.TipoSinDesgloseType;
import net.aonsolutions.core.araba.sii.VariosDestinatariosType;


public class SIIArabaBuilt {

	public static SIIArabaBuilt getInstance() {
		return new SIIArabaBuilt();
	}
	
	public SIIArabaBuilt() {
	...
	//			fet.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaEmitidasType._16.getName());
			...
			if(!fet.getTipoFactura().equals(ClaveTipoFacturaType.F_2) && !fet.getTipoFactura().equals(ClaveTipoFacturaType.F_4) 
				...
				//	nst3.setImporteTAIReglasLocalizacion(""); // TODO
					...
					net.aonsolutions.core.araba.sii.SujetaPrestacionType.Exenta exenta3 = new net.aonsolutions.core.araba.sii.SujetaPrestacionType.Exenta();
					...
					if(!noExenta.isEmpty()){
						net.aonsolutions.core.araba.sii.SujetaPrestacionType.NoExenta.DesgloseIVA diva3 = new net.aonsolutions.core.araba.sii.SujetaPrestacionType.NoExenta.DesgloseIVA();
						...
						net.aonsolutions.core.araba.sii.SujetaPrestacionType.NoExenta noExenta3 = new net.aonsolutions.core.araba.sii.SujetaPrestacionType.NoExenta();
	...
	protected BajaLRFacturasEmitidas bajaFacturasEmitidas(Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.araba.sii.IDFacturaExpedidaBCType.IDEmisorFactura emisor = new net.aonsolutions.core.araba.sii.IDFacturaExpedidaBCType.IDEmisorFactura();
			emisor.setNIF(company.getDocument());
			idFactura.setIDEmisorFactura(emisor);
			factura.setIDFactura(idFactura);
	...
	protected SuministroLRFacturasRecibidas suministroFacturasRecibidas(Domain domain, String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList, 
		...
		invoiceList.stream().forEach(invoice -> {
			...
			net.aonsolutions.core.araba.sii.IDFacturaRecibidaType.IDEmisorFactura emisor = new net.aonsolutions.core.araba.sii.IDFacturaRecibidaType.IDEmisorFactura();
	...
	//			frt.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaRecibidasType._14.getName());
		...
		// TODO			drt.setCuotaRecargoRectificado(Double.toString(vat.getRectified().getSurchargeQuota()));  
			...
			if(!noExenta.isEmpty()){
				...
				net.aonsolutions.core.araba.sii.DesgloseFacturaRecibidasType.DesgloseIVA diva = new net.aonsolutions.core.araba.sii.DesgloseFacturaRecibidasType.DesgloseIVA();
				noExentaMap.keySet().stream().forEach(key -> {
	...
	protected BajaLRFacturasRecibidas bajaFacturasRecibidas(Company company,LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.araba.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura emisor = new net.aonsolutions.core.araba.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura();
