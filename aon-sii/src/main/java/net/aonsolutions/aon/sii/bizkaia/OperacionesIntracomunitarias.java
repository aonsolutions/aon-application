...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.CountryMiembroType;
...
import eus.bizkaia.ogasuna.sii.documentos.suministroinformacion.IDFacturaComunitariaType.IDEmisorFactura;
	...
	// ------------------- SUMINISTRO OPERACIONES INTRACOMUNITARIAS
		...
		protected byte[] getRespuestaSuministroOperacionesIntracomunitarias(RespuestaLROComunitariasType suministro) {
			...
			try {
				...
				QName qName = new QName("eus.bizkaia.ogasuna.sii.documentos.respuestasuministro", "RespuestaLROComunitariasType");
		...
		protected byte[] getRespuestaBajaOperacionesIntracomunitarias(RespuestaLRBajaOComunitariasType suministro){
			...
			try {
				...
				QName qName = new QName("eus.bizkaia.ogasuna.sii.documentos.respuestasuministro", "RespuestaLRBajaOComunitariasType");
