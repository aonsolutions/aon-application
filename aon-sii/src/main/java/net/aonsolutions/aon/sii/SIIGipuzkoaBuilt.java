...
import net.aonsolutions.core.gipuzkoa.sii.BajaLRFacturasRecibidas;
import net.aonsolutions.core.gipuzkoa.sii.BienDeInversionType;
import net.aonsolutions.core.gipuzkoa.sii.CabeceraSii;
import net.aonsolutions.core.gipuzkoa.sii.CabeceraSiiBaja;
import net.aonsolutions.core.gipuzkoa.sii.CabeceraSiiCobrosPagos;
import net.aonsolutions.core.gipuzkoa.sii.CausaExencionType;
import net.aonsolutions.core.gipuzkoa.sii.ClaveOperacionType;
import net.aonsolutions.core.gipuzkoa.sii.ClaveTipoComunicacionType;
import net.aonsolutions.core.gipuzkoa.sii.ClaveTipoFacturaType;
import net.aonsolutions.core.gipuzkoa.sii.CobrosType;
import net.aonsolutions.core.gipuzkoa.sii.CountryMiembroType;
import net.aonsolutions.core.gipuzkoa.sii.CountryType2;
import net.aonsolutions.core.gipuzkoa.sii.CuponType;
import net.aonsolutions.core.gipuzkoa.sii.DatosInmuebleType;
import net.aonsolutions.core.gipuzkoa.sii.DatosPagoCobroType;
import net.aonsolutions.core.gipuzkoa.sii.DesgloseFacturaRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.DesgloseFacturaRecibidasType.InversionSujetoPasivo;
import net.aonsolutions.core.gipuzkoa.sii.DesgloseRectificacionType;
import net.aonsolutions.core.gipuzkoa.sii.DetalleIVAEmitidaPrestacionType;
import net.aonsolutions.core.gipuzkoa.sii.DetalleIVAEmitidaType;
import net.aonsolutions.core.gipuzkoa.sii.DetalleIVARecibida2Type;
import net.aonsolutions.core.gipuzkoa.sii.DetalleIVARecibidaType;
import net.aonsolutions.core.gipuzkoa.sii.EmitidaPorTercerosType;
import net.aonsolutions.core.gipuzkoa.sii.FacturaExpedidaType;
import net.aonsolutions.core.gipuzkoa.sii.FacturaExpedidaType.DatosInmueble;
import net.aonsolutions.core.gipuzkoa.sii.FacturaExpedidaType.TipoDesglose;
import net.aonsolutions.core.gipuzkoa.sii.FacturaRecibidaType;
import net.aonsolutions.core.gipuzkoa.sii.FacturaType.FacturasAgrupadas;
import net.aonsolutions.core.gipuzkoa.sii.FacturaType.FacturasRectificadas;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaARType;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaComunitariaType;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaExpedidaBCType;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaExpedidaType;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaExpedidaType.IDEmisorFactura;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaNombreBCType;
import net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaType;
import net.aonsolutions.core.gipuzkoa.sii.IDOtroType;
import net.aonsolutions.core.gipuzkoa.sii.LRAgenciasViajesType;
import net.aonsolutions.core.gipuzkoa.sii.LRBajaBienesInversionType;
import net.aonsolutions.core.gipuzkoa.sii.LRBajaExpedidasType;
import net.aonsolutions.core.gipuzkoa.sii.LRBajaOperacionIntracomunitariaType;
import net.aonsolutions.core.gipuzkoa.sii.LRBajaRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.LRBienesInversionType;
import net.aonsolutions.core.gipuzkoa.sii.LRCobrosEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.LRCobrosMetalicoType;
import net.aonsolutions.core.gipuzkoa.sii.LRFacturasRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.LROperacionIntracomunitariaType;
import net.aonsolutions.core.gipuzkoa.sii.LROperacionesSegurosType;
import net.aonsolutions.core.gipuzkoa.sii.LRPagosEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.LRfacturasEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.NoSujetaType;
import net.aonsolutions.core.gipuzkoa.sii.OperacionIntracomunitariaType;
import net.aonsolutions.core.gipuzkoa.sii.PagosType;
import net.aonsolutions.core.gipuzkoa.sii.PersonaFisicaJuridicaESType;
import net.aonsolutions.core.gipuzkoa.sii.PersonaFisicaJuridicaType;
import net.aonsolutions.core.gipuzkoa.sii.RegistroSii.PeriodoImpositivo;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRAgenciasViajesType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRBajaBienesInversionType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRBajaFEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRBajaFRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRBajaOComunitariasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRBienesInversionType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRCobrosEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRFEmitidasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRFRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRIMetalicoType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLROComunitariasType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLROperacionesSegurosType;
import net.aonsolutions.core.gipuzkoa.sii.RespuestaLRPagosRecibidasType;
import net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType;
import net.aonsolutions.core.gipuzkoa.sii.SujetaType;
import net.aonsolutions.core.gipuzkoa.sii.SujetaType.Exenta;
import net.aonsolutions.core.gipuzkoa.sii.SujetaType.NoExenta;
import net.aonsolutions.core.gipuzkoa.sii.SujetaType.NoExenta.DesgloseIVA;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRAgenciasViajes;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRBienesInversion;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRCobrosEmitidas;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRCobrosMetalico;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRDetOperacionIntracomunitaria;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRFacturasEmitidas;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRFacturasRecibidas;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLROperacionesSeguros;
import net.aonsolutions.core.gipuzkoa.sii.SuministroLRPagosRecibidas;
import net.aonsolutions.core.gipuzkoa.sii.TipoConDesgloseType;
import net.aonsolutions.core.gipuzkoa.sii.TipoOperacionSujetaNoExentaType;
import net.aonsolutions.core.gipuzkoa.sii.TipoSinDesglosePrestacionType;
import net.aonsolutions.core.gipuzkoa.sii.TipoSinDesgloseType;
import net.aonsolutions.core.gipuzkoa.sii.VariosDestinatariosType;


public class SIIGipuzkoaBuilt {

	public static SIIGipuzkoaBuilt getInstance() {
		return new SIIGipuzkoaBuilt();
	}
	
	public SIIGipuzkoaBuilt() {
	...
	//			fet.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaEmitidasType._16.getName());
			...
			if(!fet.getTipoFactura().equals(ClaveTipoFacturaType.F_2) && !fet.getTipoFactura().equals(ClaveTipoFacturaType.F_4) 
				...
				//	nst3.setImporteTAIReglasLocalizacion(""); // TODO
					...
					net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.Exenta exenta3 = new net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.Exenta();
					...
					if(!noExenta.isEmpty()){
						net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.NoExenta.DesgloseIVA diva3 = new net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.NoExenta.DesgloseIVA();
						...
						net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.NoExenta noExenta3 = new net.aonsolutions.core.gipuzkoa.sii.SujetaPrestacionType.NoExenta();
	...
	protected BajaLRFacturasEmitidas bajaFacturasEmitidas(Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.gipuzkoa.sii.IDFacturaExpedidaBCType.IDEmisorFactura emisor = new net.aonsolutions.core.gipuzkoa.sii.IDFacturaExpedidaBCType.IDEmisorFactura();
			emisor.setNIF(company.getDocument());
			idFactura.setIDEmisorFactura(emisor);
			factura.setIDFactura(idFactura);
	...
	protected SuministroLRFacturasRecibidas suministroFacturasRecibidas(Domain domain, String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList, 
		...
		invoiceList.stream().forEach(invoice -> {
			...
			net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaType.IDEmisorFactura emisor = new net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaType.IDEmisorFactura();
	...
	//			frt.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaRecibidasType._14.getName());
		...
		// TODO			drt.setCuotaRecargoRectificado(Double.toString(vat.getRectified().getSurchargeQuota()));  
			...
			if(!noExenta.isEmpty()){
				...
				net.aonsolutions.core.gipuzkoa.sii.DesgloseFacturaRecibidasType.DesgloseIVA diva = new net.aonsolutions.core.gipuzkoa.sii.DesgloseFacturaRecibidasType.DesgloseIVA();
				noExentaMap.keySet().stream().forEach(key -> {
	...
	protected BajaLRFacturasRecibidas bajaFacturasRecibidas(Company company,LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura emisor = new net.aonsolutions.core.gipuzkoa.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura();
	...
	protected SuministroLRBienesInversion suministroBienesInversion(Domain domain, String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList, Boolean mod, String terceros, String auth) {
		...
		invoiceList.stream().forEach(invoice -> {
			...
			net.aonsolutions.core.gipuzkoa.sii.IDFacturaComunitariaType.IDEmisorFactura emisor = new net.aonsolutions.core.gipuzkoa.sii.IDFacturaComunitariaType.IDEmisorFactura();
			emisor.setNombreRazon(vat.getRegistryName());
			if(vat.getRegistryDocumentCountry().equals(Country.ES)){
				emisor.setNIF(vat.getRegistryDocument());
			} else {
