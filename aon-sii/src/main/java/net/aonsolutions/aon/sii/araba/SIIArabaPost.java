...
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaBienBajaType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaBienType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaComunitariaBajaType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaComunitariaType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaExpedidaBajaType;
...
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLRAgenciasViajesType;
...
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLRFRecibidasType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLRIMetalicoType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLROComunitariasType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLROperacionesSegurosType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLRPagosRecibidasType;
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaRecibidaBajaType;
...
import https.sii_araba_eus.documentos.suministrolr.SuministroLRPagosRecibidas;
...
public class SIIArabaPost extends SIIPost{
	...
	public static SIIArabaPost getInstance(InvoiceCommunicationConfiguration icc) {
		return new SIIArabaPost(icc);
	}
	

	public SIIArabaPost(InvoiceCommunicationConfiguration icc) {
		super(icc);
	}
	...
	public JSONArray suministroFacturasEmitidas(Domain domain, String login, Company company, Integer invoiceId, 
			LinkedList<VatContext> contextList, String terceros, String uri, LinkedList<VatContext> list, SendType type) throws JAXBException, ParserConfigurationException, SOAPException, IOException {
