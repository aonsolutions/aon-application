...
public class OperacionesTrascendenciaTributaria extends SIIBuilt{
	...
	protected byte[] getRespuestaSuministroCobrosMetalico(RespuestaLRIMetalicoType suministro) {
		...
		try {
			...
			QName qName = new QName("https.www2_agenciatributaria_gob_es.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.respuestasuministro", "RespuestaLRIMetalicoType");
	...
	protected byte[] getRespuestaSuministroOperacionesSeguros(RespuestaLROperacionesSegurosType suministro) {
		...
		try {
			...
			QName qName = new QName("https.www2_agenciatributaria_gob_es.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.respuestasuministro", "RespuestaLROperacionesSegurosType");
	...
	protected byte[] getRespuestaSuministroAgenciasViajes(RespuestaLRAgenciasViajesType suministro){
		...
		try {
			...
			QName qName = new QName("https.www2_agenciatributaria_gob_es.static_files.common.internet.dep.aplicaciones.es.aeat.ssii.fact.ws.respuestasuministro", "RespuestaLRAgenciasViajesType");
