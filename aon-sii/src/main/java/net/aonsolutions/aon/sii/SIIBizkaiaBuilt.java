...
import net.aonsolutions.core.bizkaia.sii.BajaLRBienesInversion;
import net.aonsolutions.core.bizkaia.sii.BajaLRDetOperacionIntracomunitaria;
import net.aonsolutions.core.bizkaia.sii.BajaLRFacturasEmitidas;
import net.aonsolutions.core.bizkaia.sii.BajaLRFacturasRecibidas;
import net.aonsolutions.core.bizkaia.sii.BienDeInversionType;
import net.aonsolutions.core.bizkaia.sii.CabeceraSii;
import net.aonsolutions.core.bizkaia.sii.CabeceraSiiBaja;
import net.aonsolutions.core.bizkaia.sii.CabeceraSiiCobrosPagos;
import net.aonsolutions.core.bizkaia.sii.CausaExencionType;
import net.aonsolutions.core.bizkaia.sii.ClaveOperacionType;
import net.aonsolutions.core.bizkaia.sii.ClaveTipoComunicacionType;
import net.aonsolutions.core.bizkaia.sii.ClaveTipoFacturaType;
import net.aonsolutions.core.bizkaia.sii.CobrosType;
import net.aonsolutions.core.bizkaia.sii.CountryMiembroType;
import net.aonsolutions.core.bizkaia.sii.CountryType2;
import net.aonsolutions.core.bizkaia.sii.CuponType;
import net.aonsolutions.core.bizkaia.sii.DatosInmuebleType;
import net.aonsolutions.core.bizkaia.sii.DatosPagoCobroType;
import net.aonsolutions.core.bizkaia.sii.DesgloseFacturaRecibidasType;
import net.aonsolutions.core.bizkaia.sii.DesgloseFacturaRecibidasType.InversionSujetoPasivo;
import net.aonsolutions.core.bizkaia.sii.DesgloseRectificacionType;
import net.aonsolutions.core.bizkaia.sii.DetalleIVAEmitidaPrestacionType;
import net.aonsolutions.core.bizkaia.sii.DetalleIVAEmitidaType;
import net.aonsolutions.core.bizkaia.sii.DetalleIVARecibida2Type;
import net.aonsolutions.core.bizkaia.sii.DetalleIVARecibidaType;
import net.aonsolutions.core.bizkaia.sii.EmitidaPorTercerosType;
import net.aonsolutions.core.bizkaia.sii.FacturaExpedidaType;
import net.aonsolutions.core.bizkaia.sii.FacturaExpedidaType.DatosInmueble;
import net.aonsolutions.core.bizkaia.sii.FacturaExpedidaType.TipoDesglose;
import net.aonsolutions.core.bizkaia.sii.FacturaRecibidaType;
import net.aonsolutions.core.bizkaia.sii.FacturaType.FacturasAgrupadas;
import net.aonsolutions.core.bizkaia.sii.FacturaType.FacturasRectificadas;
import net.aonsolutions.core.bizkaia.sii.IDFacturaARType;
import net.aonsolutions.core.bizkaia.sii.IDFacturaComunitariaType;
import net.aonsolutions.core.bizkaia.sii.IDFacturaExpedidaBCType;
import net.aonsolutions.core.bizkaia.sii.IDFacturaExpedidaType;
import net.aonsolutions.core.bizkaia.sii.IDFacturaExpedidaType.IDEmisorFactura;
import net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaNombreBCType;
import net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaType;
import net.aonsolutions.core.bizkaia.sii.IDOtroType;
import net.aonsolutions.core.bizkaia.sii.LRAgenciasViajesType;
import net.aonsolutions.core.bizkaia.sii.LRBajaBienesInversionType;
import net.aonsolutions.core.bizkaia.sii.LRBajaExpedidasType;
import net.aonsolutions.core.bizkaia.sii.LRBajaOperacionIntracomunitariaType;
import net.aonsolutions.core.bizkaia.sii.LRBajaRecibidasType;
import net.aonsolutions.core.bizkaia.sii.LRBienesInversionType;
import net.aonsolutions.core.bizkaia.sii.LRCobrosEmitidasType;
import net.aonsolutions.core.bizkaia.sii.LRCobrosMetalicoType;
import net.aonsolutions.core.bizkaia.sii.LRFacturasRecibidasType;
import net.aonsolutions.core.bizkaia.sii.LROperacionIntracomunitariaType;
import net.aonsolutions.core.bizkaia.sii.LROperacionesSegurosType;
import net.aonsolutions.core.bizkaia.sii.LRPagosEmitidasType;
import net.aonsolutions.core.bizkaia.sii.LRfacturasEmitidasType;
import net.aonsolutions.core.bizkaia.sii.NoSujetaType;
import net.aonsolutions.core.bizkaia.sii.OperacionIntracomunitariaType;
import net.aonsolutions.core.bizkaia.sii.PagosType;
import net.aonsolutions.core.bizkaia.sii.PersonaFisicaJuridicaESType;
import net.aonsolutions.core.bizkaia.sii.PersonaFisicaJuridicaType;
import net.aonsolutions.core.bizkaia.sii.RegistroSii.PeriodoImpositivo;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRAgenciasViajesType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRBajaBienesInversionType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRBajaFEmitidasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRBajaFRecibidasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRBajaOComunitariasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRBienesInversionType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRCobrosEmitidasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRFEmitidasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRFRecibidasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRIMetalicoType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLROComunitariasType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLROperacionesSegurosType;
import net.aonsolutions.core.bizkaia.sii.RespuestaLRPagosRecibidasType;
import net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType;
import net.aonsolutions.core.bizkaia.sii.SujetaType;
import net.aonsolutions.core.bizkaia.sii.SujetaType.Exenta;
import net.aonsolutions.core.bizkaia.sii.SujetaType.NoExenta;
import net.aonsolutions.core.bizkaia.sii.SujetaType.NoExenta.DesgloseIVA;
import net.aonsolutions.core.bizkaia.sii.SuministroLRAgenciasViajes;
import net.aonsolutions.core.bizkaia.sii.SuministroLRBienesInversion;
import net.aonsolutions.core.bizkaia.sii.SuministroLRCobrosEmitidas;
import net.aonsolutions.core.bizkaia.sii.SuministroLRCobrosMetalico;
import net.aonsolutions.core.bizkaia.sii.SuministroLRDetOperacionIntracomunitaria;
import net.aonsolutions.core.bizkaia.sii.SuministroLRFacturasEmitidas;
import net.aonsolutions.core.bizkaia.sii.SuministroLRFacturasRecibidas;
import net.aonsolutions.core.bizkaia.sii.SuministroLROperacionesSeguros;
import net.aonsolutions.core.bizkaia.sii.SuministroLRPagosRecibidas;
import net.aonsolutions.core.bizkaia.sii.TipoConDesgloseType;
import net.aonsolutions.core.bizkaia.sii.TipoOperacionSujetaNoExentaType;
import net.aonsolutions.core.bizkaia.sii.TipoSinDesglosePrestacionType;
import net.aonsolutions.core.bizkaia.sii.TipoSinDesgloseType;
import net.aonsolutions.core.bizkaia.sii.VariosDestinatariosType;


public class SIIBizkaiaBuilt {

	public static SIIBizkaiaBuilt getInstance() {
		return new SIIBizkaiaBuilt();
	}
	
	public SIIBizkaiaBuilt() {
	...
	//			fet.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaEmitidasType._16.getName());
			...
			if(!fet.getTipoFactura().equals(ClaveTipoFacturaType.F_2) && !fet.getTipoFactura().equals(ClaveTipoFacturaType.F_4) 
				...
				//	nst3.setImporteTAIReglasLocalizacion(""); // TODO
					...
					net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.Exenta exenta3 = new net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.Exenta();
					...
					if(!noExenta.isEmpty()){
						net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.NoExenta.DesgloseIVA diva3 = new net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.NoExenta.DesgloseIVA();
						...
						net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.NoExenta noExenta3 = new net.aonsolutions.core.bizkaia.sii.SujetaPrestacionType.NoExenta();
	...
	protected BajaLRFacturasEmitidas bajaFacturasEmitidas(Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.bizkaia.sii.IDFacturaExpedidaBCType.IDEmisorFactura emisor = new net.aonsolutions.core.bizkaia.sii.IDFacturaExpedidaBCType.IDEmisorFactura();
			emisor.setNIF(company.getDocument());
			idFactura.setIDEmisorFactura(emisor);
			factura.setIDFactura(idFactura);
	...
	protected SuministroLRFacturasRecibidas suministroFacturasRecibidas(Domain domain, String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList, 
		...
		invoiceList.stream().forEach(invoice -> {
			...
			net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaType.IDEmisorFactura emisor = new net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaType.IDEmisorFactura();
	...
	//			frt.setClaveRegimenEspecialOTrascendencia(ClaveRegimenEspecialOTrascendenciaRecibidasType._14.getName());
		...
		// TODO			drt.setCuotaRecargoRectificado(Double.toString(vat.getRectified().getSurchargeQuota()));  
			...
			if(!noExenta.isEmpty()){
				...
				net.aonsolutions.core.bizkaia.sii.DesgloseFacturaRecibidasType.DesgloseIVA diva = new net.aonsolutions.core.bizkaia.sii.DesgloseFacturaRecibidasType.DesgloseIVA();
				noExentaMap.keySet().stream().forEach(key -> {
	...
	protected BajaLRFacturasRecibidas bajaFacturasRecibidas(Company company,LinkedList<Integer> invoiceList, LinkedList<VatContext> vatList, String terceros, String auth) {
		...
		invoiceList.stream().forEach(i -> {
			...
			idFactura.setFechaExpedicionFacturaEmisor(AonDateUtils.format(vat.getIssueDate(), "dd-MM-yyyy"));
			idFactura.setNumSerieFacturaEmisor(vat.getReferenceCode());
			net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura emisor = new net.aonsolutions.core.bizkaia.sii.IDFacturaRecibidaNombreBCType.IDEmisorFactura();
	...
	protected SuministroLRBienesInversion suministroBienesInversion(Domain domain, String login, Company company, LinkedList<Integer> invoiceList, LinkedList<VatContext> contextList, Boolean mod, String terceros, String auth) {
		...
		invoiceList.stream().forEach(invoice -> {
			...
			net.aonsolutions.core.bizkaia.sii.IDFacturaComunitariaType.IDEmisorFactura emisor = new net.aonsolutions.core.bizkaia.sii.IDFacturaComunitariaType.IDEmisorFactura();
			emisor.setNIF(vat.getRegistryDocument());
			emisor.setNombreRazon(vat.getRegistryName());
			idFactura.setIDEmisorFactura(emisor);
