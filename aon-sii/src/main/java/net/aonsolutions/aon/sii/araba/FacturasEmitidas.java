...
import https.sii_araba_eus.documentos.respuestasuministro.RespuestaLRFEmitidasType;
...
import https.sii_araba_eus.documentos.suministroinformacion.CausaExencionType;
import https.sii_araba_eus.documentos.suministroinformacion.ClaveTipoComunicacionType;
import https.sii_araba_eus.documentos.suministroinformacion.ClaveTipoFacturaType;
import https.sii_araba_eus.documentos.suministroinformacion.CobrosType;
import https.sii_araba_eus.documentos.suministroinformacion.CountryType2;
import https.sii_araba_eus.documentos.suministroinformacion.CuponType;
...
import https.sii_araba_eus.documentos.suministroinformacion.FacturaExpedidaType;
import https.sii_araba_eus.documentos.suministroinformacion.FacturaExpedidaType.DatosInmueble;
import https.sii_araba_eus.documentos.suministroinformacion.FacturaExpedidaType.TipoDesglose;
import https.sii_araba_eus.documentos.suministroinformacion.FacturaType.FacturasAgrupadas;
import https.sii_araba_eus.documentos.suministroinformacion.FacturaType.FacturasRectificadas;
import https.sii_araba_eus.documentos.suministroinformacion.IDFacturaARType;
...
import https.sii_araba_eus.documentos.suministroinformacion.SujetaPrestacionType;
import https.sii_araba_eus.documentos.suministroinformacion.SujetaPrestacionType.Exenta;
import https.sii_araba_eus.documentos.suministroinformacion.SujetaPrestacionType.NoExenta;
import https.sii_araba_eus.documentos.suministroinformacion.SujetaPrestacionType.NoExenta.DesgloseIVA;
import https.sii_araba_eus.documentos.suministroinformacion.SujetaType;
import https.sii_araba_eus.documentos.suministroinformacion.TipoConDesgloseType;
import https.sii_araba_eus.documentos.suministroinformacion.TipoOperacionSujetaNoExentaType;
import https.sii_araba_eus.documentos.suministroinformacion.TipoSinDesglosePrestacionType;
import https.sii_araba_eus.documentos.suministroinformacion.TipoSinDesgloseType;
import https.sii_araba_eus.documentos.suministroinformacion.VariosDestinatariosType;
...
import https.sii_araba_eus.documentos.suministrolr.SuministroLRCobrosEmitidas;
...
public class FacturasEmitidas extends SIIBuilt{
	...
	protected byte[] getRespuestaSuministroFacturasEmitidas(RespuestaLRFEmitidasType suministro){
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRFEmitidasType");
	...
	protected byte[] getRespuestaBajaFacturasEmitidas(RespuestaLRBajaFEmitidasType suministro){
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRBajaFEmitidasType");
	...
	protected byte[] getRespuestaSuministroFacturasEmitidasCobros(RespuestaLRCobrosEmitidasType suministro) {
		...
		try {
			...
			QName qName = new QName("https.sii_araba_eus.documentos.respuestasuministro", "RespuestaLRCobrosEmitidasType");
