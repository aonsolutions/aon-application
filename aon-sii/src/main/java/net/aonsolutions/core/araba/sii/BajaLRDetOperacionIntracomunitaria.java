...
@XmlRootElement(name = "BajaLRDetOperacionIntracomunitaria", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd")
public class BajaLRDetOperacionIntracomunitaria
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaDetOperacionIntracomunitaria", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd", required = true)
