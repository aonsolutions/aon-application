 ...
 *       &lt;sequence>
 *         &lt;element name="RegistroLRBajaOperacionesSeguros" type="{https://sii.araba.eus/documentos/SuministroLR.xsd}LRBajaRegistroLROperacionesSegurosType" maxOccurs="10000"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "BajaLROperacionesSeguros", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd")
public class BajaLROperacionesSeguros
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaOperacionesSeguros", namespace = "https://sii.araba.eus/documentos/SuministroLR.xsd", required = true)
