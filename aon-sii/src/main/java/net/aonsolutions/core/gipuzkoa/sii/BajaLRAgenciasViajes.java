...
@XmlRootElement(name = "BajaLRAgenciasViajes", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd")
public class BajaLRAgenciasViajes
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaAgenciasViajes", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd", required = true)
