...
@XmlRootElement(name = "BajaLRFacturasEmitidas", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd")
public class BajaLRFacturasEmitidas
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaExpedidas", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd", required = true)
