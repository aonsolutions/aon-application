...
@XmlRootElement(name = "BajaLRCobrosMetalico", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd")
public class BajaLRCobrosMetalico
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaCobrosMetalico", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd", required = true)
