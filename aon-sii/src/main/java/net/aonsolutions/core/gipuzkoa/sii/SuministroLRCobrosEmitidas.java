...
@XmlRootElement(name = "SuministroLRCobrosEmitidas", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd")
public class SuministroLRCobrosEmitidas
    extends SuministroInformacionCobrosPagos
{

    @XmlElement(name = "RegistroLRCobros", namespace = "https://egoitza.gipuzkoa.eus/ogasuna/sii/ficheros/SuministroLR.xsd", required = true)
