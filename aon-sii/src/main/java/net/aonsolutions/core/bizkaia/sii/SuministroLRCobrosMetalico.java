...
@XmlRootElement(name = "SuministroLRCobrosMetalico", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class SuministroLRCobrosMetalico
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRCobrosMetalico",  namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
