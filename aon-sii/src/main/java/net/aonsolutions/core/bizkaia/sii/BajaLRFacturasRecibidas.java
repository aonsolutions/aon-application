...
@XmlRootElement(name = "BajaLRFacturasRecibidas", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class BajaLRFacturasRecibidas
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaRecibidas", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
