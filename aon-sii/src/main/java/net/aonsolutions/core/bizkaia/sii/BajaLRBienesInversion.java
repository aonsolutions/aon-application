...
@XmlRootElement(name = "BajaLRBienesInversion", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class BajaLRBienesInversion
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaBienesInversion", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
