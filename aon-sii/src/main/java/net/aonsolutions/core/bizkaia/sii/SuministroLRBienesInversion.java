...
@XmlRootElement(name = "SuministroLRBienesInversion",  namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class SuministroLRBienesInversion
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRBienesInversion",  namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
