...
@XmlRootElement(name = "SuministroLRFacturasEmitidas", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class SuministroLRFacturasEmitidas
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRFacturasEmitidas",  namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
