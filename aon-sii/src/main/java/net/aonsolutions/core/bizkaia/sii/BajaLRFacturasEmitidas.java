...
@XmlRootElement(name = "BajaLRFacturasEmitidas", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class BajaLRFacturasEmitidas
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaExpedidas", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
