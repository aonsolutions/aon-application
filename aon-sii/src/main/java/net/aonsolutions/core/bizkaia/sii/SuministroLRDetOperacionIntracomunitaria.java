...
@XmlRootElement(name = "SuministroLRDetOperacionIntracomunitaria", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class SuministroLRDetOperacionIntracomunitaria
    extends SuministroInformacion
{

    @XmlElement(name = "RegistroLRDetOperacionIntracomunitaria", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
