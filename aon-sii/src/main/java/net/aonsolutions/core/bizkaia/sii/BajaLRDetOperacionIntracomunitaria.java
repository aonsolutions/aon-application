...
@XmlRootElement(name = "BajaLRDetOperacionIntracomunitaria", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd")
public class BajaLRDetOperacionIntracomunitaria
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaDetOperacionIntracomunitaria", namespace = "http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd", required = true)
