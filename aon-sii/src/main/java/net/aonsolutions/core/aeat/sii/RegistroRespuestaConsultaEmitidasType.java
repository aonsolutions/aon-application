...
@XmlType(name = "RegistroRespuestaConsultaEmitidasType", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaConsultaLR.xsd", propOrder = {
    "idFactura",
    "datosFacturaEmitida",
    "datosPresentacion",
    "estadoFactura",
