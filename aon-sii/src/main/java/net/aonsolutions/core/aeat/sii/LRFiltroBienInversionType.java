...
@XmlType(name = "LRFiltroBienInversionType", namespace = "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/ConsultaLR.xsd", propOrder = {
    "idFactura",
    "fechaPresentacion",
    "facturaModificada",
    "identificacionBien",
