...
import net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.CtaCot;
import net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.DatoSolicitado;
import net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.DatosLiquidacion;
import net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.Fecha;
import net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.FechaHoraRecaudacion;
