...
//	}
	...
	private ETI createETIRecord( List<Contract> contractList ) throws PayrollException, ManagerBeanException {
		ETI eti = new ETI();
...
//		eti.setClave(Integer.parseInt(usuario.getAutorizacion()));
	...
	private EMP createEMPrecord(Enterprise enterprise, List<Contract> contractList) throws PayrollException, ManagerBeanException {
		EMP emp = new EMP();
	...
	private TRA createTRARecord(Contract contract) throws PayrollException, ManagerBeanException {
		TRA tra = new TRA();
