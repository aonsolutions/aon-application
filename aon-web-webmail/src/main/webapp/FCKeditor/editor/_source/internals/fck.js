...
function FCKFocusManager_FireOnBlur()
{
	...
	FCKFocusManager_UpdateLinkedField();
}
...
// JORGE *******************
//Para que al ser modificado el EditingArea se actualize el textarea (no funciona el onSubmit) 

function FCKFocusManager_UpdateLinkedField()
{
	FCK.UpdateLinkedField();
}

// JORGE *******************
//Para que al ser modificado el textarea se actualize el EditingArea 

function reloadEditingArea() 
{
	if (FCK.EditingArea) FCK.SetHTML( FCK.GetLinkedFieldValue(), true ) ;
}
