...
public class ContrataProrrogasWriter {
	...
	private IProrrogaType createProrroga(IProrrogaType prorrogaType, ContrataParams params) throws ManagerBeanException{
	 ...
	 * 
	 */
	private DATOSGENERALESPRORROGATYPE createDatosGeneralesProrroga(ContrataParams params) {
		// TODO
	 ...
	 * 
	 */
	private DATOSADICIONALESPRORROGATYPE createDatosAdicionalesProrroga(ContrataParams params) {
		// TODO
