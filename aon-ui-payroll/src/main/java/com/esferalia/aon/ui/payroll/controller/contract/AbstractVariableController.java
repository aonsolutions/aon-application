...
public abstract class AbstractVariableController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AbstractVariableController.class.getName());
	...
	public AbstractVariableController(IController controller) {
