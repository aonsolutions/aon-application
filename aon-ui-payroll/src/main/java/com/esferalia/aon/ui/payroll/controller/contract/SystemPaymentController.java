...
public class SystemPaymentController extends ContractDetailVariableController implements IPaymentHandler {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(SystemPaymentController.class.getName());
	...
	public void onSelect(ActionEvent event) {
		...
		setEnableExpressionEdition( StringUtils.isNotBlank(((SystemPayment)getTo()).getExpression()) );
	}
...
//		}
	...
	private SystemPaymentVariableHandler handler;
	...
	@Override
	public SystemPaymentVariableHandler getHandler() {
		if(handler==null){
			handler = new SystemPaymentVariableHandler(this);
		}
		return handler;
	}
	@Override
