...
public class Cnae2009MaestroController extends PayrollBasicController implements IPayrollConstants {
	...
	public void initializeOcupacionesModel(){
		...
		Cnae2009Maestro cm = (Cnae2009Maestro)getTo();
	...
	public void onOcupacionRemove(ValueChangeEvent event) {
		...
		String ocupacionesCnae =((Cnae2009Maestro)getTo()).getOcupacion();
	...
	public void onOcupacionAdd(ValueChangeEvent event) {
		ocupacion = (String)event.getOldValue();
		((Cnae2009Maestro)getTo()).setOcupacion(((Cnae2009Maestro)getTo()).getOcupacion()+ocupacion);
