...
public class ContingencyBases {
	...
	public static class ContingencyBasesBuilder {
		...
		public ContingencyBasesBuilder setNo_struct_ap_enterprise(Optional<Double> noStructApEnterprise) {
			this.noStructApEnterprise = noStructApEnterprise;
			return this;
		}

		public ContingencyBasesBuilder setIrpf_esp(Optional<Double> irpfEsp) {
			this.irpfEsp = irpfEsp;
			return this;
		}

		public ContingencyBasesBuilder setIrpf_retrib_diner(Optional<Double> irpfRetribDiner) {
