...
import com.esferalia.aon.in.payroll.pdf.templates.regex.A3Regex;
			...
			while(!matcher.matches()) {
				...
				if(matcher.matches()) {
					if(matcher.group("devengos")!=null) {
						Double amount=PdfParsingTools.payrollDoubleParser(AonStringUtils.trimToNull(matcher.group("devengos")));
...
//								}
						...
						Double amount=PdfParsingTools.payrollDoubleParser(AonStringUtils.trimToNull(matcher.group("deducciones")));
						String description=AonStringUtils.trimToNull(matcher.group("concept"));
						description=PdfParsingTools.removeSpace(description, 19);
						...
						Double type=null;
						try {
							type = PdfParsingTools.payrollDoubleParser(AonStringUtils.trimToNull(matcher.group("tipo")));
						} catch (NullPointerException e) {}
			...
			try {
				Double cgcBase=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(2)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			try {
				Double rawCgcBase=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(2)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			try {
				Double cgpBase=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(3)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			try {
				Double totalIrpf=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(4)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			try {
				Double totalPayment=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(5)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			try {
				Double totalDeduction=Double.parseDouble(PdfParsingTools.removeSpace(AonStringUtils.trimToNull(remnbases.get(6)).replaceAll("\\.", "").replaceAll("[,]", "."), -1));
			...
			Double individualApport = PdfParsingTools.payrollDoubleParser(AonStringUtils.trimToNull(matcher.group("apport")));
