...
public class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println();
        printTextArt("Felicidades Navidad", 18, ASCIIArtFont.ART_FONT_SERIF,"\u25A0");
        System.out.println();
         
        System.out.println();
        printTextArt("Felicidades", ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_MONO,"@");
        System.out.println();
     ...
     * @throws Exception
     */
    public static String[] generateAsciiArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
     ...
     * @throws Exception
     */
    private static void printTextArt(String artText, int textHeight) throws Exception {
        
	String[] asciiArt  = generateAsciiArt(artText, textHeight, ASCIIArtFont.ART_FONT_COURIER, DEFAULT_ART_SYMBOL);
	...
	String[] asciiArt  = generateAsciiArt(artText, textHeight, fontType, artSymbol);
	for (int i = 0; i < asciiArt.length; i++) {
	    System.out.println(asciiArt[i]);
	}
    }
