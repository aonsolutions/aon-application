...
public interface IdcHighlighterListener {
	...
	default void onEnterpriseRegime(String regime, IdcHighlighter idcHighlighter) throws IOException{};
	default void onEnterpriseActivity(String code, String description, IdcHighlighter idcHighlighter) throws IOException{};
	
	default void onStart(String date, IdcHighlighter idcHighlighter) throws IOException{};
	default void onEnd(String date, IdcHighlighter idcHighlighter) throws IOException{};
	...
	default void onContractCCC(String ccc, IdcHighlighter idcHighlighter) throws IOException{};
	default void onRLCE(String rlce, IdcHighlighter idcHighlighter) throws IOException{};
	default void onQuoteGroup(String group, String monthly, IdcHighlighter idcHighlighter) throws IOException{};
	...
	default void onOccupation(String ocupation, String description, IdcHighlighter idcHighlighter) throws IOException{};
