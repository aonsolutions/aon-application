...
public class SettlementBundle extends ListResourceBundle {
	...
	public Object[][] getContents() {return contents;}
	 private Object[][] contents = { 
	   	...
	   	{ "EMPLOYEE", "De otra parte, $employeeName, con NIF: $employeeNif, que viene prestando sus servicios como empleado/a con la categoría de $employeeCategory, desde el $employeeAntiquity."},
	   	{ "DECLARE", "DECLARAN:"},
	   	{ "DECLARATION", "Que causa baja en la misma con fecha $endDate, por el motivo de $endCause y percibe en este momento la cantidad de $textTotal EUROS ($totalAmount\u20AC) por los servicios prestados y por la totalidad de los que le puedan corresponder derivados de esta relación laboral hasta el día que causó baja en la misma, y por los conceptos que a continuación se detallan."},
