...
public class EnterprisePayrollEntry {
	...
	public Optional<String> getEmpleadoSS() {
		return empleadoSS;
	}
	...
	public Optional<String> getTipoSS() {
		return tipoSS;
	}

	public Optional<Double> getDevengado() {
		return devengado;
	}

	public Optional<Double> getDevengadoSS() {
		return devengadoSS;
	}

	public Optional<Double> getSsTrab() {
		return ssTrab;
	}

	public Optional<Double> getSsTrabSS() {
		return ssTrabSS;
	}

	public Optional<Double> getIrpf() {
		return irpf;
	}

	public Optional<Double> getIrpfSS() {
		return irpfSS;
	}

	public Optional<Double> getDeducciones() {
		return deducciones;
	}
	...
	public Optional<Double> getSsEmpr() {
		return ssEmpr;
	}

	public Optional<Double> getSsEmprSS() {
		return ssEmprSS;
	}

	public Optional<Double> getCosteTotal() {
		return costeTotal;
	}

	public Optional<Double> getCosteTotalSS() {
		return costeTotalSS;
	}

	public Optional<Double> getSsTotal() {
		return ssTotal;
	}

	public Optional<Double> getSsTotalSS() {
		return ssTotalSS;
	}

	public Optional<Double> getBonificaciones() {
	...
	// SETTERS
	public void setEmpleado(Optional<String> empleado) {
		this.empleado = empleado;
	}

	public void setEmpleadoSS(Optional<String> empleadoSS) {
	...
	public void setTipoSS(Optional<String> tipoSS) {
		this.tipoSS = tipoSS;
	}

	public void setDevengado(Optional<Double> devengado) {
		this.devengado = devengado;
	}

	public void setDevengadoSS(Optional<Double> devengadoSS) {
		this.devengadoSS = devengadoSS;
	}

	public void setSsTrab(Optional<Double> ssTrab) {
		this.ssTrab = ssTrab;
	}

	public void setSsTrabSS(Optional<Double> ssTrabSS) {
		this.ssTrabSS = ssTrabSS;
	}

	public void setIrpf(Optional<Double> irpf) {
		this.irpf = irpf;
	}

	public void setIrpfSS(Optional<Double> irpfSS) {
		this.irpfSS = irpfSS;
	}

	public void setDeducciones(Optional<Double> deducciones) {
		this.deducciones = deducciones;
	}

	public void setDeduccionesSS(Optional<Double> deduccionesSS) {
	...
	public void setLiquidoSS(Optional<Double> liquidoSS) {
		this.liquidoSS = liquidoSS;
	}

	public void setSsEmpr(Optional<Double> ssEmpr) {
		this.ssEmpr = ssEmpr;
	}

	public void setSsEmprSS(Optional<Double> ssEmprSS) {
		this.ssEmprSS = ssEmprSS;
	}

	public void setCosteTotal(Optional<Double> costeTotal) {
		this.costeTotal = costeTotal;
	}

	public void setCosteTotalSS(Optional<Double> costeTotalSS) {
		this.costeTotalSS = costeTotalSS;
	}

	public void setSsTotal(Optional<Double> ssTotal) {
		this.ssTotal = ssTotal;
	}

	public void setSsTotalSS(Optional<Double> ssTotalSS) {
		this.ssTotalSS = ssTotalSS;
	}
	...
	public boolean HasSs() {
		return empleadoSS.isPresent() || tipoSS.isPresent() || devengadoSS.isPresent() || ssTrabSS.isPresent()
				|| irpfSS.isPresent() || deduccionesSS.isPresent() || liquidoSS.isPresent() || ssEmprSS.isPresent()
				|| ssTotalSS.isPresent() || bonificacionesSS.isPresent();
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(empleado, that.empleado) && Objects.equals(tipo, that.tipo)
				&& Objects.equals(devengado, that.devengado) && Objects.equals(ssTrab, that.ssTrab)
				&& Objects.equals(irpf, that.irpf) && Objects.equals(deducciones, that.deducciones)
				&& Objects.equals(liquido, that.liquido) && Objects.equals(ssEmpr, that.ssEmpr)
				&& Objects.equals(costeTotal, that.costeTotal) && Objects.equals(ssTotal, that.ssTotal)
				&& Objects.equals(empleadoSS, that.empleadoSS) && Objects.equals(tipoSS, that.tipoSS)
