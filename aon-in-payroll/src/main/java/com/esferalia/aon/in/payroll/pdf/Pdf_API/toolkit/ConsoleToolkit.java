...
public class ConsoleToolkit {
	...
	public static void log_info		(String message) 	{System.out.println(tabulate("[Info] "  	+ message));}
	public static void log_warning	(String message)  	{System.out.println(tabulate("[Warning] " 	+ message));}
	public static void log_error	(String message) 	{System.err.println(tabulate("[Error] " 	+ message));}
}
