...
import static com.esferalia.aon.in.payroll.pdf.maker.PdfMaker.printDemoInvoice;
import static com.esferalia.aon.in.payroll.pdf.maker.PdfMaker.printInvoice;
import static com.esferalia.aon.in.payroll.pdf.maker.invoice.InvoiceTemplate.create;
...
public class InvoiceTest {
	...
	public void EnterpriseBillCreationTest() {
		...
		for (int i = 1; i < 20; i++)
			entries.add(new InvoiceEntry(
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris."
							+ i,
					99999999.99, 99999999.99, 100, 99999999.99));
		...
		Invoice bill = new Invoice(InvoiceTest.class.getResourceAsStream("TestLayer.png"), true, "1239022342",
				new Date(), "59153583F", "AON SOLUTIONS", "Plaza Castilla 15, 6A", "Villabajo", entries, taxes,
				finances, 75, 105, InvoiceTest.class.getResourceAsStream("qrcode.png"));

		System.out.println(" Setting up invoice.....");
		try
		{
			System.out.println(" Printing PDF file..... \n");
			create(new ByteArrayOutputStream(), bill, true);
			System.out.println(" >> DONE.");
		} catch (IOException e)
		{
			fail("Can not read test resources");
	...
	public void EnterpriseBillCreationTestWithJSONTest() throws FileNotFoundException {
		...
		config.setAdjustImage(true).setDetailed(true)
				.setBackgroundImage(InvoiceTest.class.getResourceAsStream("TestLayer.png")).setHeader(105)
				.setFooter(75);
		System.out.println(" Setting up invoice.....");
		...
		try
		{
			...
			System.out.println(" Printing PDF file.....");
			printInvoice(new ByteArrayOutputStream(), InvoiceTest.class.getResourceAsStream("factura.json"), config,
	...
	public void EnterpriseBillCreationDemoTest() {
		...
		try
		{
			printDemoInvoice(new ByteArrayOutputStream(), config, InvoiceTest.class.getResourceAsStream("qrcode.png"));
		} catch (CanNotCreatePdfException e)
		{
			System.out.println(" Printing PDF file.....");
			fail("Can not create pdf");
		...
		{
			fail("Can not access test resources");
		}
	}
