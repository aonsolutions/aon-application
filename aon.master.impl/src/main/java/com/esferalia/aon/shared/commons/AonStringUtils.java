...
public class AonStringUtils {
	...
	public static boolean equals(final CharSequence cs1, final CharSequence cs2) {
		...
		return AonCharSequenceUtils.regionMatches(cs1, false, 0, cs2, 0,
	...
	public static boolean equalsIgnoreCase(final CharSequence str1,
		...
		if (str1 == null || str2 == null) {
			...
			return AonCharSequenceUtils.regionMatches(str1, true, 0, str2, 0,
					str1.length());
		}
	}
	...
	public static int indexOf(final CharSequence seq, final int searchChar) {
		...
		return AonCharSequenceUtils.indexOf(seq, searchChar, 0);
	}
	...
	public static int indexOf(final CharSequence seq, final int searchChar,
		...
		return AonCharSequenceUtils.indexOf(seq, searchChar, startPos);
	}
	...
	public static int indexOf(final CharSequence seq,
		...
		return AonCharSequenceUtils.indexOf(seq, searchSeq, 0);
	}
	...
	public static int indexOf(final CharSequence seq,
		...
		return AonCharSequenceUtils.indexOf(seq, searchSeq, startPos);
	}
	...
	public static int lastIndexOf(final CharSequence seq, final int searchChar) {
		...
		return AonCharSequenceUtils.lastIndexOf(seq, searchChar, seq.length());
	}
	...
	public static int lastIndexOf(final CharSequence seq, final int searchChar,
		...
		return AonCharSequenceUtils.lastIndexOf(seq, searchChar, startPos);
	}
	...
	public static int lastIndexOf(final CharSequence seq,
		...
		return AonCharSequenceUtils.lastIndexOf(seq, searchSeq, seq.length());
	}
	...
	public static int lastIndexOf(final CharSequence seq,
		...
		return AonCharSequenceUtils.lastIndexOf(seq, searchSeq, startPos);
	}
	...
	public static boolean contains(final CharSequence seq, final int searchChar) {
		...
		return AonCharSequenceUtils.indexOf(seq, searchChar, 0) >= 0;
	}
	...
	public static boolean contains(final CharSequence seq,
		...
		return AonCharSequenceUtils.indexOf(seq, searchSeq, 0) >= 0;
	}
	...
	public static boolean containsAny(final CharSequence cs,
		...
		return containsAny(cs, AonCharSequenceUtils.toCharArray(searchChars));
	}
	...
	public static int indexOfAnyBut(final CharSequence seq,
		...
		for (int i = 0; i < strLen; i++) {
			...
			if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
				...
				if (chFound
						&& AonCharSequenceUtils.indexOf(searchChars, ch2, 0) < 0) {
					return i;
				}
			} else {
				if (!chFound) {
	...
	public static int indexOfAny(final CharSequence str,
		...
		for (int i = 0; i < sz; i++) {
			...
			tmp = AonCharSequenceUtils.indexOf(str, search, 0);
	...
	public static int lastIndexOfAny(final CharSequence str,
		...
		for (int i = 0; i < sz; i++) {
			...
			tmp = AonCharSequenceUtils.lastIndexOf(str, search, str.length());
			if (tmp > ret) {
				ret = tmp;
			}
		}
	...
	public static String[] substringsBetween(final String str,
		...
		if (strLen == 0) {
			return AonArrayUtils.EMPTY_STRING_ARRAY;
		}
	...
	public static String removePattern(final String source, final String regex) {
		return replacePattern(source, regex, AonStringUtils.EMPTY);
	}
	...
	public static String chomp(final String str) {
		...
		if (str.length() == 1) {
			...
			if (ch == AonCharUtils.CR || ch == AonCharUtils.LF) {
				return EMPTY;
			}
			return str;
		}
		...
		if (last == AonCharUtils.LF) {
			if (str.charAt(lastIdx - 1) == AonCharUtils.CR) {
				lastIdx--;
			}
		} else if (last != AonCharUtils.CR) {
			lastIdx++;
		}
	...
	public static int countMatches(final CharSequence str,
		...
		int count = 0;
		int idx = 0;
		while ((idx = AonCharSequenceUtils.indexOf(str, sub, idx)) != INDEX_NOT_FOUND) {
			count++;
			idx += sub.length();
		}
		return count;
	...
	public static boolean isAsciiPrintable(final CharSequence cs) {
		...
		final int sz = cs.length();
		for (int i = 0; i < sz; i++) {
			if (AonCharUtils.isAsciiPrintable(cs.charAt(i)) == false) {
				return false;
			}
		}
		return true;
	...
	public static boolean startsWithAny(final CharSequence string,
		...
		if (isEmpty(string) || AonArrayUtils.isEmpty(searchStrings)) {
			return false;
		}
	...
	private static boolean endsWith(final CharSequence str,
		...
		return AonCharSequenceUtils.regionMatches(str, ignoreCase, strOffset,
