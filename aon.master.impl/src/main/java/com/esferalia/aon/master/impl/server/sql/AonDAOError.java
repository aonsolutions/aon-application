...
public enum AonDAOError {
	...
	,ACCOUNT_PERIOD_INVALID_STATUS("Valor incorrecto para el enumerado 'Estado' ({0})")
	// ACCOUNT_ENTRY
	...
	,ACCOUNT_ENTRY_INVALID_STATUS("Valor incorrecto para el enumerado 'Tipo de asiento' ({0})")
	,ACCOUNT_ENTRY_INVALID_SEC_LEVEL("Valor incorrecto para el enumerado 'Nivel de seguridad - Confidencial' ({0})")
	...
	private String msg;
	private AonDAOError(String msg) {
		this.msg = msg;
	}
