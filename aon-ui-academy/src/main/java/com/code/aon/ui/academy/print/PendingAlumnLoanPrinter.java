...
public class PendingAlumnLoanPrinter implements ICollectionProvider{
	...
	public Collection getCollection() {
		...
		try {
			...
			criteria.addNullExpression(bean.getFieldName(IEntityAlias.ALUMN_LOAN_END_DATE));
			GregorianCalendar calendar = new GregorianCalendar();
			calendar.add(GregorianCalendar.DATE, -15);
			criteria.addLessThanExpression(bean.getFieldName(IEntityAlias.ALUMN_LOAN_LOAN_DATE), calendar.getTime());
