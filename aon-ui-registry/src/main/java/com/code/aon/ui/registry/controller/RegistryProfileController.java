...
public class RegistryProfileController extends LinesController {
	
	private static final long serialVersionUID = AonVersion.SERIAL_VERSION_UID;

	private static final Logger LOGGER = LoggerFactory.getLogger(RegistryProfileController.class.getName());
	...
	public Integer getQuestionValueId( RegistryProfile tp ) {
		try {		
