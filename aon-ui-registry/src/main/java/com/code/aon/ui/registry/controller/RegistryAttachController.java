...
public class RegistryAttachController extends LinesController {

	private static final Logger LOGGER = Logger.getLogger(RegistryAttachController.class.getName());
	...
	public RegistryAttachController() {
		this.maximumSize = -1;
	}
	...
	private void writeAttachment(RegistryAttachment attachment, HttpServletResponse response) {
		try {
    ...
    public void downloadAttachment( ActionEvent event ) throws NumberFormatException, ManagerBeanException {
        ...
        RegistryAttachment attachment = (RegistryAttachment) getManagerBean().get(Integer.valueOf(id));
