...
public class JsPurchase extends JavaScriptObject {

	protected JsPurchase() {}	public static final ProvidesKey<JsPurchase> PROVIDES_KEY = new ProvidesKey<JsPurchase>() {
		@Override
		public Object getKey(JsPurchase carrierPacking) {
