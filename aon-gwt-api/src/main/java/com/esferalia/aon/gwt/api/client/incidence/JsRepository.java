...
public class JsRepository extends JavaScriptObject {
	...
	public final native String getCloneUrl() /*-{
	...
	public final native int getWatchers() /*-{
		return this.watchers;
	}-*/;

	public final String getWatchersS() {
		return String.valueOf(getWatchers());
	}
	...
	public final native boolean isFork() /*-{
		return this.fork;
	}-*/;
	...
	public final native String getSshUrl() /*-{
		return this.ssh_url;
	}-*/;
	...
	public final native int getForks() /*-{
		return this.forks;
	}-*/;

	public final String getForksS() {
		return String.valueOf(getForks());
	}
	...
	public final native String getSvnUrl() /*-{
		return this.svn_url;
	}-*/;

	public final native boolean isPrivate() /*-{
		return this["private"];
	}-*/;
	...
	public final native int openIssues() /*-{
		return this.open_issues;
	}-*/;

	public final String openIssuesString() {
		return String.valueOf(openIssues());
	}
	...
	public final Date getPushedAt() {
		return DateTimeFormat.getFormat(PredefinedFormat.ISO_8601).parse(
				this.getPushedAtString());
	}

	public final native String getPushedAtString() /*-{
