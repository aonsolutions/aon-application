...
public class Warehouse extends Methods{
	...
	public void downloadUdapaTag(Integer id, Double pos, Double[] cals,  String[] dests, String var, String obv, String sup){
		String str = "domain="+ getDomainName() + "&login="+getUserName() + "&id="+id + "&position=" + pos  + "&supplier=" + sup 
