...
import com.esferalia.aon.gwt.viewer.server.OpenDocument2ImageServlet;
 ...
 */
public class PageDrawer extends org.apache.pdfbox.pdfviewer.PageDrawer{
    ...
    protected void processTextPosition( TextPosition text )
    {
        try
        {
            ...
            try{
            	...
            	OpenDocument2ImageServlet.fontError = true;
            }
