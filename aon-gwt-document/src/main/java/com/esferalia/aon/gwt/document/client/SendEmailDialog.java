...
//	@UiField Button sendMailButton;
	...
	MailAccountList maList;
	private void table(MailAccountList mal,String url) {
		...
		SuggestBox sb1 = new SuggestBox(Utils.createOracleContact(mal.getContactList()));
		sb1.setStyleName("aon-inputText");
		sb1.setWidth("100%");
		grid.setWidget(1, 0, new Label("Para"));
		grid.setWidget(1, 1, sb1);
		
		SuggestBox sb2 = new SuggestBox(Utils.createOracleContact(mal.getContactList()));
		sb2.setStyleName("aon-inputText");
		sb2.setWidth("100%");
		grid.setWidget(2, 0, new Label("Cc"));
		grid.setWidget(2, 1, sb2);
		
		SuggestBox sb3 = new SuggestBox(Utils.createOracleContact(mal.getContactList()));
		...
		Button cancel = new Button();cancel.setStyleName("aon-icon-cancel2 aon-gwt-upload");
		hp.add(cancel);
		hp.add(new Label("lote.zip"));
		Label l = new Label("Finalizado");
		l.addStyleName("aon-green");
		hp.add(l);
        ...
        vp.add(hp);
		vp.add(mupload);
		grid.setWidget(5, 0, new Label("Adjuntar Archivos"));
