...
//			reader.selectPages(range);
			...
			try {
				setPdfFieldValue(PdfFieldPractice.ENTERPRISE_DIR_STAFF_NAME.getValue(),rDirStaff.getName());
				setPdfFieldValue(PdfFieldPractice.ENTERPRISE_DIR_STAFF_NIF.getValue(),rDirStaff.getDocument());
				...
				setPdfFieldValue(PdfFieldPractice.ENTERPRISE_DIR_STAFF_CHARGE.getValue(),rDirStaddCharge);
			...
			if(contract.getEnterpriseCCC()!=null){
				setPdfFieldValue(PdfFieldPractice.CCC_REG1.getValue(),contract.getEnterpriseCCC().getActivity().getQuoteRegimeCode().substring(0, 1));
				setPdfFieldValue(PdfFieldPractice.CCC_REG2.getValue(),contract.getEnterpriseCCC().getActivity().getQuoteRegimeCode().substring(1, 2));
				setPdfFieldValue(PdfFieldPractice.CCC_REG3.getValue(),contract.getEnterpriseCCC().getActivity().getQuoteRegimeCode().substring(2, 3));
				setPdfFieldValue(PdfFieldPractice.CCC_REG4.getValue(),contract.getEnterpriseCCC().getActivity().getQuoteRegimeCode().substring(3, 4));
