...
public class FAB {
	...
	public String getIndicativoGrupoCotizacionDiario() {
		return indicativoGrupoCotizacionDiario;
	}
	...
	public void setCondicionDesempleado(String condicionDesempleado) {
		this.condicionDesempleado = condicionDesempleado;
	}
	public String getMujerSubrepresentada() {
		return mujerSubrepresentada;
	}
	...
	public void setMujerReincorporada(String mujerReincorporada) {
		this.mujerReincorporada = mujerReincorporada;
	}
	public String getIncapacitadoReadmitido() {
		return incapacitadoReadmitido;
	}
	...
	public void setRentaActivaInsercion(String rentaActivaInsercion) {
		this.rentaActivaInsercion = rentaActivaInsercion;
	}
	public String getCostratadasPostAlumbramiento() {
		return costratadasPostAlumbramiento;
	}
