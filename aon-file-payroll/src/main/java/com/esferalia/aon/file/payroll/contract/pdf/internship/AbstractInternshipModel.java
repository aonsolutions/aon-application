...
public abstract class AbstractInternshipModel implements IContractPdfDocument<IContrataParams> {
	
	private static final long serialVersionUID = AonVersion.SERIAL_VERSION_UID;
	
	public final static String CONTRACT_DOCUMENT_PATH = "com/esferalia/aon/file/payroll/contract/internshipPdf/";
