package com.code.aon.faces.component.richfaces.aonScroller;
...
public class AonScrollerHandler extends TagHandler {

	
	private static final Logger LOGGER = LoggerFactory.getLogger(ParamHandler.class);

	private static final String TEMPLATE_PATH = "com/code/aon/faces/component/richfaces/aonScroller/";

	private static final String TEMPLATE = TEMPLATE_PATH + "aonScroller.xhtml";
	 ...
	 *            the config
	 */
	public AonScrollerHandler(TagConfig config) {
		super(config);
