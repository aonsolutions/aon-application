...
public class AonIOUtils {
     ...
     * before using {@link AONIOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
     ...
     * @see AONIOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
    ...
    public static byte[] toByteArray(URI uri) throws IOException {
        return AonIOUtils.toByteArray(uri.toURL());
    }
    ...
    public static byte[] toByteArray(URL url) throws IOException {
        ...
        try {
            return AonIOUtils.toByteArray(conn);
        } finally {
            close(conn);
        }
    }
    ...
    public static byte[] toByteArray(URLConnection urlConn) throws IOException {
        ...
        try {
            return AonIOUtils.toByteArray(inputStream);
        } finally {
            inputStream.close();
        }
    }
