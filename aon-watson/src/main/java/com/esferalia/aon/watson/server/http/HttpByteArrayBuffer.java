 ...
 * @since 4.0
 */
final class HttpByteArrayBuffer implements Serializable {
    ...
    /**
     * Creates an instance of {@link HttpByteArrayBuffer} with the given initial
     * capacity.
     *
     * @param capacity the capacity
     */
    HttpByteArrayBuffer(final int capacity) {
        super();
     ...
     * @since 4.1
     */
    int indexOf(final byte b, final int from, final int to) {
        int beginIndex = from;
        if (beginIndex < 0) {
            beginIndex = 0;
        }
