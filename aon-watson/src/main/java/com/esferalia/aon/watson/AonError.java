...
public enum AonError implements Serializable{
	...
	,ACCOUNT_DUPLICATED_CODE_IN_CHILD("No se puede crear/modificar la cuenta ({0}) porque ya existe una con el mismo c\u00F3digo en el dominio \"{1}\"")
	...
	,INVOICE_CANT_ANNUL_RECORDED("No es posible anular la factura porque est\u00E1 contabilizada. Descontabilice primero la factura.")	
	,INVOICE_CANT_ANNUL_RECTIFIED("No es posible anular la factura porque est\u00E1 rectificada. Anule primero la factura rectificativa.")
	,INVOICE_CANT_ANNUL_DUA_LINKED("No es posible anular la factura porque est\u00E1 vinculada a un documento DUA.")
	,INVOICE_CANT_ANNUL_SII("No es posible anular la factura porque no est\u00E1 anulada en el SII. Dar de baja la factura en el SII.")
	,INVOICE_CANT_ANNUL_TBAI("No es posible anular la factura porque no est\u00E1 anulada en Ticket Bai. Dar de baja la factura en Ticket Bai.")
	,INVOICE_CANT_ANNUL_VERIFACTU("No es posible anular la factura porque no est\u00E1 anulada en Verifactu. Dar de baja la factura en Verifactu.")
	,INVOICE_CANT_ANNUL_MODEL("Imposible anular, la factura ha sido declarada en modelos fiscales: {0}")
	,INVOICE_CANT_ANNUL_FINANCE("No es posible anular la factura porque est\u00E1 vinculada a un vencimiento no pendiente.")
	,INVOICE_CANT_ANNUL_AMORTIZATION("No es posible anular la factura porque est\u00E1 vinculada a la ficha de amortizaci\u00F3n \"{0}\"")
