package com.esferalia.aon.watson.server.codec;
...
import com.esferalia.aon.watson.server.io.Charsets;

public class AonDigestUtils {
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#MD2
     * @since 1.7
     */
    public static MessageDigest getMd2Digest() {
        return getDigest(AonMessageDigestAlgorithms.MD2);
    }
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#MD5
     */
    public static MessageDigest getMd5Digest() {
        return getDigest(AonMessageDigestAlgorithms.MD5);
    }
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#SHA_1
     * @since 1.7
     */
    public static MessageDigest getSha1Digest() {
        return getDigest(AonMessageDigestAlgorithms.SHA_1);
    }
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#SHA_256
     */
    public static MessageDigest getSha256Digest() {
        return getDigest(AonMessageDigestAlgorithms.SHA_256);
    }
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#SHA_384
     */
    public static MessageDigest getSha384Digest() {
        return getDigest(AonMessageDigestAlgorithms.SHA_384);
    }
     ...
     *             built-in algorithm
     * @see AonMessageDigestAlgorithms#SHA_512
     */
    public static MessageDigest getSha512Digest() {
        return getDigest(AonMessageDigestAlgorithms.SHA_512);
    }
    ...
    public static String md2Hex(final byte[] data) {
        return AonHex.encodeHexString(md2(data));
    }
    ...
    public static String md5Hex(final byte[] data) {
        return AonHex.encodeHexString(md5(data));
    }
    ...
    public static String sha1Hex(final byte[] data) {
        return AonHex.encodeHexString(sha1(data));
    }
    ...
    public static String sha256Hex(final byte[] data) {
        return AonHex.encodeHexString(sha256(data));
    }
    ...
    public static String sha384Hex(final byte[] data) {
        return AonHex.encodeHexString(sha384(data));
    }
    ...
    public static String sha512Hex(final byte[] data) {
        return AonHex.encodeHexString(sha512(data));
    }
