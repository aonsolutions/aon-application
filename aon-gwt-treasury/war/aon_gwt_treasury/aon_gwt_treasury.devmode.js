...
var __gwtModuleFunction = $wnd.aon_gwt_treasury;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.aon_gwt_treasury=");
    idx += (13 + "aon_gwt_treasury".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=aon_gwt_treasury-0.js
