...
public class S3EventObject {
	...
	public void setKey(String key, S3EventObject s3UploadEventObject) {
		this.key = key;
	}
	...
	public void setTime(Date time, S3EventObject s3UploadEventObject) {
		this.time = time;
	}
	...
	public void setSize(Integer size, S3EventObject s3UploadEventObject) {
		this.size = size;
	}
	...
	public void setBucket(String bucket, S3EventObject s3UploadEventObject) {
		this.bucket = bucket;
	}
	...
	public void setContentType(String contentType, S3EventObject s3UploadEventObject) {
		this.contentType = contentType;
	}
	
	
	protected static Date getEventTime(Map<String, ?> r) {
