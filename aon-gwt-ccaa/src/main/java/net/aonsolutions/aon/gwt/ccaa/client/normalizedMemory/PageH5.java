...
public class PageH5 extends PageAbs {
	...
	private void init() {
		...
		LMA8099010.setText("Los abajo firmantes, como Administradores de la "
				...
				+ "Decreto 1514/2007 de 16 de Noviembre).");
		if (getMap().containsKey(D2DepositHeaderKey.IMA8099000.getCode())) {
			String value = getMap().get(D2DepositHeaderKey.IMA8099000.getCode());
			IMA8099000.setValue(value.equals("1"));
		}
		if (getMap().containsKey(D2DepositHeaderKey.IMA8099010.getCode())) {
			String value = getMap().get(D2DepositHeaderKey.IMA8099010.getCode());
