...
public class PageF1H extends PageAbs {

	interface PageBinder extends UiBinder<Widget, PageF1H> {
	}
	...
	public PageF1H(Deposit2 deposit) {
		super(deposit);
	...
	private void table(){
		...
		int row = 0;
		table.setWidget(row, 0, new Label("Sociedad Comunicante"));
		...
		table.setWidget(row, 1, new Label("Fecha Comunicaci\u00F3n"));
		...
		table.setWidget(row, 2, new Label("Porcentaje de participaci\u00F3n en su capital a esa fecha"));
		...
		table.setWidget(row, 3, new Label("Fecha Reducci\u00F3n"));
		...
		table.setWidget(row, 4, new Label("Porcentaje Posterior"));
