...
public class PageM7_2 extends PageAbs {
	...
	public PageM7_2(Deposit deposit) {
		super(deposit);
	...
	protected void initializeTable() {
		table2Label.setText("Vencimientos de las deudas al cierre del ejercicio " + getYear());
		table4Label.setText("Lineas de descuento y p\u00f3lizas al cierre del ejercicio " + getYear());
