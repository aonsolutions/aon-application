...
import net.aonsolutions.aon.gwt.udapa.client.quality.QualityPrincipal;
import net.aonsolutions.aon.gwt.udapa.client.quality.UdapaQuality;

public class PaturpatGridPanel extends ResizeComposite implements RequiresResize {

	interface GridBinder extends UiBinder<Widget, PaturpatGridPanel> {
	}
	...
	public PaturpatGridPanel(PaturpatQuality parent, LinkedList<JsDataResponse> list) {
		this.parent = parent;		
	...
	private void initTableColumns(final SelectionModel<JsDataResponse> selectionModel, ListHandler<JsDataResponse> sortHandler) {
		...
		Column<JsDataResponse,String> issueDateColumn = new Column<JsDataResponse, String>(new TextCell()) {
			...
			public String getValue(JsDataResponse object) {
				if(object.getDate() != null && !"".equals(object.getDate())){
					Date date = Utils.parseDateTime(object.getDate());
	...
	/*	Column<JsDataResponse, String> supplierColumn = new Column<JsDataResponse, String>(new TextCell()) {
		...
		*/
		...
		sortHandler.setComparator(productColumn,new Comparator<JsDataResponse>() {
			...
			@Override
			public int compare(JsDataResponse o1, JsDataResponse o2) {
				String a = o1.getProduct(); 
				String b = o2.getProduct(); 
				return a.compareTo(b);
			}
		});
