...
public class CashCalculatorController implements ICollectionProvider {
	...
	public boolean isInitialAmount() {
		return initialAmount;
	}
	public void setInitialAmount(boolean initialAmount) {
	...
	public class CashCountUnit {
		...
		public CashCountUnit(String unit, int amount){
			this.unit = unit;
			this.amount = amount;
		}
