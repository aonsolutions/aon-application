...
# Version: 1.2.1
# Created by: girazu
# Creation Date: 15/10/2007 17:36
...
CREATE TABLE `alarm` (
  ...
  `description` varchar(64) collate latin1_spanish_ci NOT NULL COMMENT 'Descripcion de la Alarma',
...
CREATE TABLE `mail_account` (
  ...
  `email` varchar(255) collate latin1_spanish_ci NOT NULL COMMENT 'Identificado del Empleado',
  `protocol` varchar(255) collate latin1_spanish_ci default NULL,
  `host` varchar(255) collate latin1_spanish_ci default NULL,
  `incoming_host` varchar(255) collate latin1_spanish_ci default NULL,
  `incoming_port` int(4) default NULL,
  `incoming_ssl` bit(1) default NULL,
  `outgoing_verification` bit(1) default NULL,
  `outgoing_host` varchar(255) collate latin1_spanish_ci default NULL,
  `outgoing_port` int(4) default NULL,
  `outgoing_ssl` bit(1) default NULL,
  `mail_username` varchar(255) collate latin1_spanish_ci default NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Mail Acount';
...
CREATE TABLE `email` (
  ...
  `mail_account` int(4) NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `mail_account` (`mail_account`),
  CONSTRAINT `email_fk` FOREIGN KEY (`mail_account`) REFERENCES `mail_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='email';
...
CREATE TABLE `qualification` (
  ...
  `min_value` int(4) NOT NULL COMMENT 'Limite inferior de la Calificacion',
  `max_value` int(4) NOT NULL COMMENT 'Limite superior de la Calificacion',
  PRIMARY KEY  (`id`)
...
CREATE TABLE `signature` (
  `id` int(4) NOT NULL auto_increment,
  `mail_account` int(4) NOT NULL COMMENT 'mail_account',
  `signature` text collate latin1_spanish_ci COMMENT 'firma',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='signature';
...
CREATE TABLE `web_info` (
  ...
  `schedule` varchar(64) collate latin1_spanish_ci default NULL COMMENT 'Horario',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Informacion asociada a la empresa que se mostrara en la fich';
...
CREATE FUNCTION `inventarioCategoriaFecha`(d DATE, c INT)
    ...
    SQL SECURITY DEFINER
    COMMENT ''
RETURN (SELECT IF (SUM(inventory_detail.cost) IS NULL, 0, SUM(inventory_detail.cost * inventory_detail.actual_quantity))
...
INSERT INTO `db_version` (`version_number`) VALUES ('1.2.1');
