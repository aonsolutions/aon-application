...
public class ExclusionController extends PayrollBasicController {
	...
	public void onSearch(ActionEvent event) {
		try {
			...
			if(searchFecfin != null){
				...
				getCriteria().addEqualExpression(getFieldName(IPayrollAlias.EXCLUSION_FECFIN), searchFecfin);
			}
