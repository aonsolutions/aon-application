...
public class Number2Text {
	...
	private String millon(int numero) {
		...
		if (numero >= 2000000 && numero < 10000000) {
			flag = 1;
			num_letramm = unidad(numero / 1000000).concat(" millones ").concat(
					cienmiles(numero % 1000000));
		}
		if (numero < 1000000)
	...
	private String decmillon(int numero) {
		...
		if (numero > 10000000 && numero < 20000000) {
			flag = 1;
			num_letradmm = decena(numero / 1000000).concat("millones ").concat(
					cienmiles(numero % 1000000));
		}
		if (numero >= 20000000 && numero < 100000000) {
			flag = 1;
			num_letradmm = decena(numero / 1000000).concat(" milllones ").concat(
	...
	public static void main(String Arg[]) {
		int num = 0;
		Number2Text numero = new Number2Text(num);
