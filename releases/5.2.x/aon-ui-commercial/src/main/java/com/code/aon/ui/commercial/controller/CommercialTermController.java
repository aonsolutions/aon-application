...
public class CommercialTermController extends BasicController {
	...
	public	Integer calculateNextLine(boolean general) throws ManagerBeanException {
		...
		criteria.addEqualExpression(commercialTermBean.getFieldName(ICommercialAlias.COMMERCIAL_TERM_GENERAL), general);
		Projection projection = Projection.max(commercialTermBean.getFieldName(ICommercialAlias.COMMERCIAL_TERM_LINE));
