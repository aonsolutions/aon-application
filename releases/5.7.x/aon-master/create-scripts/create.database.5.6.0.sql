...
# Version: 5.6.0
# Created by: girazu
# Creation Date: 01/11/2010 17:34
...
#
# Structure for the `contract_tracking` table : 
#
...
CREATE TABLE `course_academicskill` (
  ...
  `weight` int(4) NOT NULL default '0' COMMENT 'Peso de la Aptitud para calcular la Nota media',
  PRIMARY KEY  (`id`),
  KEY `course` (`course`),
...
INSERT INTO `db_version` (`version_number`) VALUES ('5.6.0');
