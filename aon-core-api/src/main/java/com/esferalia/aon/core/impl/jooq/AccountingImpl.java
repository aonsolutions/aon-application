package com.esferalia.aon.core.impl.jooq;
...
import com.esferalia.aon.core.api.IAccounting;
import com.esferalia.aon.core.api.model.Account;
import com.esferalia.aon.core.api.model.AccountEntry;
import com.esferalia.aon.core.api.model.AccountEntryDetail;
...
import com.esferalia.aon.core.api.model.type.AccountPeriodStatus;
import com.esferalia.aon.core.commons.AonCoreException;
import com.esferalia.aon.core.commons.AonError;
import com.esferalia.aon.core.impl.jooq.dao.AccountDAO;
import com.esferalia.aon.core.impl.jooq.dao.AccountEntryDAO;
import com.esferalia.aon.core.impl.jooq.dao.AccountPeriodDAO;
...
public class AccountingImpl implements IAccounting {
	...
	private AccountEntry getAccountEntry(AONContext ctx, SalaryAccountEntry sae) {
		...
		sae.getLines()
			.stream()
			.filter( line -> line.getType() == SalaryAccountEntryLineType.SALARY )
			.forEach( line -> {
				AccountEntryDetail aed = new AccountEntryDetail();
				aed.setAccount(line.getAccount());
				aed.setDebit(line.getAmount());
				ae.addDetail( aed );
			});
		return ae;
	}
