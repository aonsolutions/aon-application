...
public class ERE1C {
	 ...
	 */
	public enum ERE1C_2 {
		PEDIDO_NORMA_220("220"),
		PEDIDO_ABIERT_221("221"),
		PEDIDO_URGENT_224("224"),
		PEDIDO_PARCIA_226("226"),
		PEDIDO_EN_CONSIGN_227("227"),
		PROPUESTA_DE_PEDIDO_DEL_PROVEEDO_22E("22E"),
		;
	...
	public enum ERE1C_4 {
		...
		CONFIRMACIO_42("42"),
		PROVISIONA_46("46"),
		FECHA_HORA_DOCUMENTO__137___102_203___EL_FORMATO_ACEPTADO_ES_CCYYMMDD_O_CCYYMMDDHHMM_5("5"),
		;
	...
	public enum ERE1C_6_7 {
		ENTREGA_FECHA_HORA__REQUERID_2("2"),
		ENVIADO_FECHA_Y_O_HOR_11("11"),
		ENTREGA_FECHA_HORA__ADELANTAD_64("64"),
		ENTREGA_FECHA_HORA__ATRASAD_63("63"),
		;
	...
	public enum ERE1C_10 {
		CONDICIONES_DE_COMPRA_DEL_GRUP_71E("71E"),
		CANCELAR_PEDIDO_SI_NO_ES_POSIBLE_LA_ENTREGA_TOTAL_EN_LAS_FECHAS_SOLICITADA_72E("72E"),
		ENTREGA_SUJETA_A_AUTORIZACION_FINA_73E("73E"),
		FACTURAR_PERO_NO_REABASTECE_81E("81E"),
		ENVIAR_PERO_NO_FACTURA_82E("82E"),
		ENTREGAR_EL_PEDIDO_ENTER_83E("83E"),
		;
	...
	public enum ERE1C_14_15 {
		NUMERO_DE_AUTORIZACION__EAN_CODE_ATZ("ATZ"),
		NUMERO_DE_REFERENCIA_DEL_CLIENT_CR("CR"),
		NUMERO_DE_CONTRAT_CT("CT"),
		NUMERO_DE_LICENCIA_DE_IMPORTACIO_IP("IP"),
		NUMERO_DE_ACUERDO_DE_PROMOCIO_PD("PD"),
		ULTIMO_NUMERO_DE_REFERENCIA_DEL_CLIENT_UC("UC"),
		;
	...
	public enum ERE1C_18 {
		DEFINIDO_POR_EL_COMPRADOR_Y_EL_PROVEEDO_DF("DF"),
		PORTES_PAGADOS_PERO_CARGADOS_AL_CLIENT_PC("PC"),
		PORTES_PAGADO_PP("PP"),
		;
