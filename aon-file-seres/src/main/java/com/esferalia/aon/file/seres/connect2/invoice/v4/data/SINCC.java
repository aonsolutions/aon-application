package com.esferalia.aon.file.seres.connect2.invoice.v4.data;
...
public class SINCC {
	...
	private String numeroDeFactura_Referencia_Ampliada_;
	private Double importeRetenido;
	private String motivoDeLaRetencion;
	private Integer fechaDocumento_rectificado_sustituido;
	private Integer fechaDeServicio_95E_;
	...
	private static Pattern PATTERN_SINCC_numeroDeFactura_Referencia_Ampliada_ = Pattern.compile("^.{370}(.{35}).*");
	private static Pattern PATTERN_SINCC_importeRetenido = Pattern.compile("^.{405}(.{18}).*");
	private static Pattern PATTERN_SINCC_motivoDeLaRetencion = Pattern.compile("^.{423}(.{3}).*");
	private static Pattern PATTERN_SINCC_fechaDocumento_rectificado_sustituido = Pattern.compile("^.{426}(.{8}).*");
	private static Pattern PATTERN_SINCC_fechaDeServicio_95E_ = Pattern.compile("^.{434}(.{8}).*");
	...
	public void parse(String value) {
		...
		if((m = PATTERN_SINCC_numeroDeFactura_Referencia_Ampliada_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setNumeroDeFactura_Referencia_Ampliada_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCC_importeRetenido.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setImporteRetenido(Double.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCC_motivoDeLaRetencion.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setMotivoDeLaRetencion(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCC_fechaDocumento_rectificado_sustituido.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setFechaDocumento_rectificado_sustituido(Integer.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCC_fechaDeServicio_95E_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setFechaDeServicio_95E_(Integer.valueOf(m.group(1).trim()));
		}
	}
	...
	/**
	 * 30 - Número de Factura (Referencia ampliada): Se cumplimentará con el número de factura.
		Contendrá el mismo valor que el campo 3, con la diferencia que este campo tiene una longitud de
		35. Este campo se ha añadido para los cargos y abonos que envía El Corte Inglés, en los cuales
		la referencia del documento es mayor de 17 posiciones. Solo se utilizará para la recepción de
		facturas, nunca para el envío.
	 */
	public String getNumeroDeFactura_Referencia_Ampliada_() {
		return numeroDeFactura_Referencia_Ampliada_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>30</td> <td>Número de factura (Referencia Ampliada)</td> <td>C</td> <td>35</td> <td>371</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setNumeroDeFactura_Referencia_Ampliada_(String numeroDeFactura_Referencia_Ampliada_) {
		this.numeroDeFactura_Referencia_Ampliada_ = numeroDeFactura_Referencia_Ampliada_;
	}
	
	/**
	 * 31 - Motivo de la retención: El importe y el motivo de la retención solo se debe cumplimentar para envíos a EFACTURA y de forma opcional.
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>31</td> <td>Importe retenido</td> <td>N(14,3)</td> <td>8</td> <td>406</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	...
	/**
	 * 32 - Motivo de la retención
	 */
	public String getMotivoDeLaRetencion() {
		return motivoDeLaRetencion;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>32</td> <td>Motivo de la retención</td> <td>C</td> <td>3</td> <td>424</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setMotivoDeLaRetencion(String motivoDeLaRetencion) {
		this.motivoDeLaRetencion = motivoDeLaRetencion;
	}
	
	/**
	 * 33 - Fecha documento rectificado/sustituido
	 */
	public Integer getFechaDocumento_rectificado_sustituido() {
		return fechaDocumento_rectificado_sustituido;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>33</td> <td>Fecha documento rectificado/sustituido</td> <td>C</td> <td>8</td> <td>427</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setFechaDocumento_rectificado_sustituido(Integer fechaDocumento_rectificado_sustituido) {
		this.fechaDocumento_rectificado_sustituido = fechaDocumento_rectificado_sustituido;
	}
	
	/**
	 * 34 - Fecha de Servicio (95E)
	 */
	public Integer getFechaDeServicio_95E_() {
		return fechaDeServicio_95E_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>34</td> <td>Fecha de Servicio (95E)</td> <td>C</td> <td>8</td> <td>435</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setFechaDeServicio_95E_(Integer fechaDeServicio_95E_) {
		this.fechaDeServicio_95E_ = fechaDeServicio_95E_;
	}
	...
	/** 
	 * 31 - Motivo de la retención: El importe y el motivo de la retención solo se debe cumplimentar para envíos a EFACTURA y de forma opcional. Los valores posibles son:
	 */
	public enum SINCC_31 {
		PAGO_A_CUENTA("PGC"),
		PAGO_EN_ESPECIE("PGE")
		;
		...
		public static SINCC_31 enumByValue(String value) {
			return Arrays.asList(values()).stream()
					.filter(o -> (o.getValue().equalsIgnoreCase(value)))
					.findFirst().orElse(null);
		}
