...
public class ORSPT {
	...
	private static Pattern PATTERN_ORSPT_calificadorDelTemaDeTexto = Pattern.compile("^.{6}(.{6}).*");
	private static Pattern PATTERN_ORSPT_texto1 = Pattern.compile("^.{12}(.{70}).*");
	private static Pattern PATTERN_ORSPT_texto2 = Pattern.compile("^.{82}(.{70}).*");
	private static Pattern PATTERN_ORSPT_texto3 = Pattern.compile("^.{152}(.{70}).*");
	private static Pattern PATTERN_ORSPT_texto4 = Pattern.compile("^.{222}(.{70}).*");
	private static Pattern PATTERN_ORSPT_texto5 = Pattern.compile("^.{292}(.{70}).*");

	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_ORSPT_calificadorDelTemaDeTexto.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalificadorDelTemaDeTexto(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ORSPT_texto1.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTexto1(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ORSPT_texto2.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTexto2(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ORSPT_texto3.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTexto3(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ORSPT_texto4.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTexto4(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ORSPT_texto5.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>2</td> <td>Texto 1</td> <td>C</td> <td>70</td> <td>13</td> <td>M</td>
	 * 	</tr>
	 * </table>
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>3</td> <td>Texto 2</td> <td>C</td> <td>70</td> <td>83</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>4</td> <td>Texto 3</td> <td>C</td> <td>70</td> <td>153</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>5</td> <td>Texto 4</td> <td>C</td> <td>70</td> <td>223</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>6</td> <td>Texto 5</td> <td>C</td> <td>70</td> <td>293</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
