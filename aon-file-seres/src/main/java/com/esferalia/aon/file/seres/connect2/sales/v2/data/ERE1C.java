package com.esferalia.aon.file.seres.connect2.sales.v2.data;
...
public class ERE1C {
	...
	private String transporte_IKEA_;
	private String localización_IKEA_;
	private String numeroDeVendedor_IA_;
	private String numeroDepartamentoDeVenta_SD_;
	private String tipoDeTransporte;
	private String identificacionDelTransportista;
	private String nombreDelTransportista;
	private String calificadorDelLugarDeEntrega;
	private String lugarDeLocalizacionPorCodigoONombre;
	...
	private static Pattern PATTERN_ERE1C_transporte_IKEA_ = Pattern.compile("^.{287}(.{70}).*");
	private static Pattern PATTERN_ERE1C_localización_IKEA_ = Pattern.compile("^.{357}(.{70}).*");
	private static Pattern PATTERN_ERE1C_numeroDeVendedor_IA_ = Pattern.compile("^.{427}(.{17}).*");
	private static Pattern PATTERN_ERE1C_numeroDepartamentoDeVenta_SD_ = Pattern.compile("^.{444}(.{17}).*");
	private static Pattern PATTERN_ERE1C_tipoDeTransporte = Pattern.compile("^.{461}(.{8}).*");
	private static Pattern PATTERN_ERE1C_identificacionDelTransportista = Pattern.compile("^.{469}(.{17}).*");
	private static Pattern PATTERN_ERE1C_nombreDelTransportista = Pattern.compile("^.{486}(.{35}).*");
	private static Pattern PATTERN_ERE1C_calificadorDelLugarDeEntrega = Pattern.compile("^.{521}(.{3}).*");
	private static Pattern PATTERN_ERE1C_lugarDeLocalizacionPorCodigoONombre = Pattern.compile("^.{524}(.{70}).*");
	...
	public void parse(String value) {
		...
		if((m = PATTERN_ERE1C_transporte_IKEA_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTransporte_IKEA_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_localización_IKEA_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setLocalización_IKEA_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_numeroDeVendedor_IA_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setNumeroDeVendedor_IA_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_numeroDepartamentoDeVenta_SD_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setNumeroDepartamentoDeVenta_SD_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_tipoDeTransporte.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTipoDeTransporte(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_identificacionDelTransportista.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setIdentificacionDelTransportista(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_nombreDelTransportista.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setNombreDelTransportista(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_calificadorDelLugarDeEntrega.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalificadorDelLugarDeEntrega(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1C_lugarDeLocalizacionPorCodigoONombre.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setLugarDeLocalizacionPorCodigoONombre(String.valueOf(m.group(1).trim()));
		}
	}
	 ...
	 * 27 - Transporte (IKEA)
	 */
	public String getTransporte_IKEA_() {
		return transporte_IKEA_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>27</td> <td>Transporte (IKEA)</td> <td>C</td> <td>70</td> <td>288</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setTransporte_IKEA_(String transporte_IKEA_) {
		this.transporte_IKEA_ = transporte_IKEA_;
	}
	
	/**
	 * 28 - Localización (IKEA)
	 */
	public String getLocalización_IKEA_() {
		return localización_IKEA_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>28</td> <td>Localización (IKEA)</td> <td>C</td> <td>70</td> <td>358</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setLocalización_IKEA_(String localización_IKEA_) {
		this.localización_IKEA_ = localización_IKEA_;
	}
	
	/**
	 * 29 - Nº de vendedor (IA)
	 */
	public String getNumeroDeVendedor_IA_() {
		return numeroDeVendedor_IA_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>29</td> <td>Nº de vendedor (IA)</td> <td>C</td> <td>17</td> <td>428</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setNumeroDeVendedor_IA_(String numeroDeVendedor_IA_) {
		this.numeroDeVendedor_IA_ = numeroDeVendedor_IA_;
	}
	
	/**
	 * 30 - Nº Departamento de Venta (SD)
	 */
	public String getNumeroDepartamentoDeVenta_SD_() {
		return numeroDepartamentoDeVenta_SD_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>30</td> <td>Nº Departamento de Venta (SD)</td> <td>C</td> <td>17</td> <td>445</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setNumeroDepartamentoDeVenta_SD_(String numeroDepartamentoDeVenta_SD_) {
		this.numeroDepartamentoDeVenta_SD_ = numeroDepartamentoDeVenta_SD_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>31</td> <td>Tipo de Transporte</td> <td>C</td> <td>8</td> <td>462</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	...
	/**
	 * 32 - Identificación del transportista
	 */
	public String getIdentificacionDelTransportista() {
		return identificacionDelTransportista;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>32</td> <td>Identificación del transportista</td> <td>C</td> <td>17</td> <td>470</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setIdentificacionDelTransportista(String identificacionDelTransportista) {
		this.identificacionDelTransportista = identificacionDelTransportista;
	}
	
	/**
	 * 33 - Nombre del transportista
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>33</td> <td>Nombre del transportista</td> <td>C</td> <td>35</td> <td>487</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	...
	/**
	 * 34 - Calificador del lugar de entrega
	 */
	public String getCalificadorDelLugarDeEntrega() {
		return calificadorDelLugarDeEntrega;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>34</td> <td>Calificador del lugar de entrega</td> <td>C</td> <td>3</td> <td>522</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setCalificadorDelLugarDeEntrega(String calificadorDelLugarDeEntrega) {
		this.calificadorDelLugarDeEntrega = calificadorDelLugarDeEntrega;
	}
	
	/**
	 * 35 - Lugar de localización por código ó nombre
	 */
	public String getLugarDeLocalizacionPorCodigoONombre() {
		return lugarDeLocalizacionPorCodigoONombre;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>35</td> <td>Lugar de localización por código ó nombre</td> <td>C</td> <td>70</td> <td>525</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setLugarDeLocalizacionPorCodigoONombre(String lugarDeLocalizacionPorCodigoONombre) {
		this.lugarDeLocalizacionPorCodigoONombre = lugarDeLocalizacionPorCodigoONombre;
	}
