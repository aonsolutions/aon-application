...
public class SINCL {
	...
	/** 
	 * 11 - Cantidad: Cantidad Facturada. Si se trata de un artículo de media variable, indica el no de unidades en kilos, litros o en la unidad de medida que corresponda.
	 */ 
