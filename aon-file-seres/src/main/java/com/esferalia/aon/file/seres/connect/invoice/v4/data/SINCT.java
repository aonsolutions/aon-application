...
public class SINCT {
	...
	private static Pattern PATTERN_SINCT_calificadorDelTemaDeTexto = Pattern.compile("^.{6}(.{6}).*");
	private static Pattern PATTERN_SINCT_texto1 = Pattern.compile("^.{12}(.{70}).*");
	private static Pattern PATTERN_SINCT_texto2 = Pattern.compile("^.{82}(.{70}).*");
	private static Pattern PATTERN_SINCT_texto3 = Pattern.compile("^.{152}(.{70}).*");
	private static Pattern PATTERN_SINCT_texto4 = Pattern.compile("^.{222}(.{70}).*");
	private static Pattern PATTERN_SINCT_texto5 = Pattern.compile("^.{292}(.{70}).*");

	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_SINCT_calificadorDelTemaDeTexto.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
	...
	/** 
	 * 2 - Calificador del tema de Texto: Este campo corresponde al elemento 4451. Los valores posibles son:
	 */ 
	...
	public enum SINCT_2 {
		...
		public static SINCT_2 enumByValue(String value) {
