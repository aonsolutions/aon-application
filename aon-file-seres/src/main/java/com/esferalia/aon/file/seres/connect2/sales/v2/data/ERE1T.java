 ...
 * 	</tr>
 * 	<tr>
 * 		 <td>ERE1T</td> <td>Observaciones cabecera</td> <td>Opcional</td> <td>N</td>
 * 	</tr>
 * </table>
 */ 
...
public class ERE1T {
	...
	private static Pattern PATTERN_ERE1T_calificadorDelTemaDeTexto = Pattern.compile("^.{6}(.{6}).*");
	private static Pattern PATTERN_ERE1T_texto1 = Pattern.compile("^.{12}(.{70}).*");
	private static Pattern PATTERN_ERE1T_texto2 = Pattern.compile("^.{82}(.{70}).*");
	private static Pattern PATTERN_ERE1T_texto3 = Pattern.compile("^.{152}(.{70}).*");
	private static Pattern PATTERN_ERE1T_texto4 = Pattern.compile("^.{222}(.{70}).*");
	private static Pattern PATTERN_ERE1T_texto5 = Pattern.compile("^.{292}(.{70}).*");

	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_ERE1T_calificadorDelTemaDeTexto.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
	...
	public enum ERE1T_2 {
		...
		public static ERE1T_2 enumByValue(String value) {
