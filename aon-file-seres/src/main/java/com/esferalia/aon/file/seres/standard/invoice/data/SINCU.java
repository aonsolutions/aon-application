 ...
 * 	</tr>
 * 	<tr>
 * 		 <td>SINCU</td> <td>Observaciones de línea de detalle</td> <td>Opcional</td> <td>N</td>
 * 	</tr>
 * </table>
 */ 
...
public class SINCU {
	...
	private String calificadorDeTipoDeTexto;
	...
	private static Pattern PATTERN_SINCU_calificadorDeTipoDeTexto = Pattern.compile("^.{6}(.{6}).*");
	private static Pattern PATTERN_SINCU_texto1 = Pattern.compile("^.{12}(.{70}).*");
	private static Pattern PATTERN_SINCU_texto2 = Pattern.compile("^.{82}(.{70}).*");
	private static Pattern PATTERN_SINCU_texto3 = Pattern.compile("^.{152}(.{70}).*");
	private static Pattern PATTERN_SINCU_texto4 = Pattern.compile("^.{222}(.{70}).*");
	private static Pattern PATTERN_SINCU_texto5 = Pattern.compile("^.{292}(.{70}).*");

	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_SINCU_calificadorDeTipoDeTexto.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalificadorDeTipoDeTexto(String.valueOf(m.group(1).trim()));
		}
	...
	/** 
	 * 2 - Calificador de tipo de texto: Este campo se utiliza para especificar el asunto de las observaciones. Este campo corresponde al elemento 4451. Los valores posibles son:
	 */ 
	public String getCalificadorDeTipoDeTexto() {
		return calificadorDeTipoDeTexto;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>2</td> <td>Calificador de tipo de texto</td> <td>C</td> <td>6</td> <td>7</td> <td>M</td>
	 * 	</tr>
	 * </table>
	 */ 
	public void setCalificadorDeTipoDeTexto(String calificadorDeTipoDeTexto) {
		this.calificadorDeTipoDeTexto = calificadorDeTipoDeTexto;
	}
	...
	public enum SINCU_2 {
		...
		public static SINCU_2 enumByValue(String value) {
