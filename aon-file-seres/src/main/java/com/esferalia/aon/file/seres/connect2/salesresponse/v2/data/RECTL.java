...
public class RECTL {
	...
	public ORSPC orspc;
	public List<ORSPT> orsptList;
	public List<ORSPP> orsppList;
	public List<ORSPI> orspiList;
	public List<ORSPV> orspvList;
	public List<ORSPD> orspdList;
	public List<ORSPL> orsplList;
	public List<ORSPU> orspuList;
	public List<ORSPG> orspgList;
	public List<ORSPE> orspeList;
	 ...
	 */
	public enum RECTL_2 {
		CONFIRMACION_DE_RECEPCION_RECADV("RECADV"),
		;
