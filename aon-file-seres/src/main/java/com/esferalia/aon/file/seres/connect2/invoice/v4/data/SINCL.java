...
public class SINCL {
	...
	private Double importeMonetarioLitigio_257_;
	private Double importeMonetarioRappel_X35_;
	private String descripciónDelArticulo_Ampliada_;
	private Double pesoNetoLinea;
	private String unidadDeMedidaPeso;
	private Double cantidadDevuelta_QTY_61;
	private String numeroDePedidoDelVendedor_VN_;
	...
	private static Pattern PATTERN_SINCL_importeMonetarioLitigio_257_ = Pattern.compile("^.{541}(.{18}).*");
	private static Pattern PATTERN_SINCL_importeMonetarioRappel_X35_ = Pattern.compile("^.{559}(.{18}).*");
	private static Pattern PATTERN_SINCL_descripciónDelArticulo_Ampliada_ = Pattern.compile("^.{577}(.{140}).*");
	private static Pattern PATTERN_SINCL_pesoNetoLinea = Pattern.compile("^.{717}(.{18}).*");
	private static Pattern PATTERN_SINCL_unidadDeMedidaPeso = Pattern.compile("^.{735}(.{3}).*");
	private static Pattern PATTERN_SINCL_cantidadDevuelta_QTY_61 = Pattern.compile("^.{738}(.{16}).*");
	private static Pattern PATTERN_SINCL_numeroDePedidoDelVendedor_VN_ = Pattern.compile("^.{754}(.{35}).*");
	...
	public void parse(String value) {
		...
		if((m = PATTERN_SINCL_importeMonetarioLitigio_257_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setImporteMonetarioLitigio_257_(Double.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_importeMonetarioRappel_X35_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setImporteMonetarioRappel_X35_(Double.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_descripciónDelArticulo_Ampliada_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setDescripciónDelArticulo_Ampliada_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_pesoNetoLinea.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setPesoNetoLinea(Double.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_unidadDeMedidaPeso.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setUnidadDeMedidaPeso(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_cantidadDevuelta_QTY_61.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCantidadDevuelta_QTY_61(Double.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SINCL_numeroDePedidoDelVendedor_VN_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setNumeroDePedidoDelVendedor_VN_(String.valueOf(m.group(1).trim()));
		}
	}
	...
	/**
	 * 43 - Importe monetario litigio: Diferencia precios (excepto rappel). Importe neto en litigio por
		línea de artículo, incluye todos los descuentos/cargos e impuestos excepto el IVA, Recargo
		equivalencia y el IGIC. Importe de regularización si es una diferencia que no se puede asignar
		al resto de líneas del cargo. Este importe lo envía El Corte Inglés en los cargos.
	 */
	public Double getImporteMonetarioLitigio_257_() {
		return importeMonetarioLitigio_257_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>43</td> <td>Importe monetario litigio (257)</td> <td>N(14,3)</td> <td>18</td> <td>542</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setImporteMonetarioLitigio_257_(Double importeMonetarioLitigio_257_) {
		this.importeMonetarioLitigio_257_ = importeMonetarioLitigio_257_;
	}
	
	/**
	 * 44 - Importe monetario Rappel: Importe del valor del Rappel para este artículo. Este importe lo envía El Corte Inglés en los cargos.
	 */
	public Double getImporteMonetarioRappel_X35_() {
		return importeMonetarioRappel_X35_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>44</td> <td>Importe monetario Rappel (X35)</td> <td>N(14,3)</td> <td>18</td> <td>560</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setImporteMonetarioRappel_X35_(Double importeMonetarioRappel_X35_) {
		this.importeMonetarioRappel_X35_ = importeMonetarioRappel_X35_;
	}
	
	/**
	 * 45 - Descripción del Articulo (Ampliada)
	 */
	public String getDescripciónDelArticulo_Ampliada_() {
		return descripciónDelArticulo_Ampliada_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>45</td> <td>Descripción del Articulo (Ampliada)</td> <td>C</td> <td>140</td> <td>578</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setDescripciónDelArticulo_Ampliada_(String descripciónDelArticulo_Ampliada_) {
		this.descripciónDelArticulo_Ampliada_ = descripciónDelArticulo_Ampliada_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>46</td> <td>Peso Neto línea</td> <td>N(14,3)</td> <td>18</td> <td>718</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>47</td> <td>Unidad de Medida Peso</td> <td>C</td> <td>3</td> <td>736</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	...
	/**
	 * 48 - Cantidad devuelta QTY+61
	 */
	public Double getCantidadDevuelta_QTY_61() {
		return cantidadDevuelta_QTY_61;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>48</td> <td>Cantidad devuelta QTY+61</td> <td>N(12,3)</td> <td>16</td> <td>739</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setCantidadDevuelta_QTY_61(Double cantidadDevuelta_QTY_61) {
		this.cantidadDevuelta_QTY_61 = cantidadDevuelta_QTY_61;
	}
	
	/**
	 * 49 - Numero de pedido del Vendedor (VN)
	 */
	public String getNumeroDePedidoDelVendedor_VN_() {
		return numeroDePedidoDelVendedor_VN_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>49</td> <td>Numero de pedido del Vendedor (VN)</td> <td>C</td> <td>35</td> <td>755</td> <td>O</td>
	 * 	</tr>
	 * </table> 
	 */
	public void setNumeroDePedidoDelVendedor_VN_(String numeroDePedidoDelVendedor_VN_) {
		this.numeroDePedidoDelVendedor_VN_ = numeroDePedidoDelVendedor_VN_;
	}
