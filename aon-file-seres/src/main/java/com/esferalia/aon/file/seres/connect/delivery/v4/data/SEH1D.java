 ...
 * 	</tr>
 * 	<tr>
 * 		 <td>SEH1D</td> <td>Información de partes</td> <td>Obligatorio</td> <td>N</td>
 * 	</tr>
 * </table>
 */ 
...
public class SEH1D {
	...
	private static Pattern PATTERN_SEH1D_calificadorDelInterlocutor = Pattern.compile("^.{6}(.{3}).*");
	private static Pattern PATTERN_SEH1D_codigoInterlocutor = Pattern.compile("^.{9}(.{17}).*");
	private static Pattern PATTERN_SEH1D_agenciaResponsableDeLaListaDeCodigos = Pattern.compile("^.{26}(.{3}).*");
	private static Pattern PATTERN_SEH1D_nombre1 = Pattern.compile("^.{29}(.{35}).*");
	private static Pattern PATTERN_SEH1D_nombre2 = Pattern.compile("^.{64}(.{35}).*");
	private static Pattern PATTERN_SEH1D_nombre3 = Pattern.compile("^.{99}(.{35}).*");
	private static Pattern PATTERN_SEH1D_nombre4 = Pattern.compile("^.{134}(.{35}).*");
	private static Pattern PATTERN_SEH1D_nombre5 = Pattern.compile("^.{169}(.{35}).*");
	private static Pattern PATTERN_SEH1D_calleYNumero1 = Pattern.compile("^.{204}(.{35}).*");
	private static Pattern PATTERN_SEH1D_calleYNumero2 = Pattern.compile("^.{239}(.{35}).*");
	private static Pattern PATTERN_SEH1D_calleYNumero3 = Pattern.compile("^.{274}(.{35}).*");
	private static Pattern PATTERN_SEH1D_calleYNumero4 = Pattern.compile("^.{309}(.{35}).*");
	private static Pattern PATTERN_SEH1D_poblacion = Pattern.compile("^.{344}(.{35}).*");
	private static Pattern PATTERN_SEH1D_provincia = Pattern.compile("^.{379}(.{9}).*");
	private static Pattern PATTERN_SEH1D_codigoPostal = Pattern.compile("^.{388}(.{9}).*");
	private static Pattern PATTERN_SEH1D_codigoPais = Pattern.compile("^.{397}(.{3}).*");
	private static Pattern PATTERN_SEH1D_calificadorReferencia1 = Pattern.compile("^.{400}(.{3}).*");
	private static Pattern PATTERN_SEH1D_referencia1 = Pattern.compile("^.{403}(.{35}).*");
	private static Pattern PATTERN_SEH1D_funcionDeContacto = Pattern.compile("^.{438}(.{3}).*");
	private static Pattern PATTERN_SEH1D_departamentoOIdentificacionDelEmpleado = Pattern.compile("^.{441}(.{17}).*");
	private static Pattern PATTERN_SEH1D_departamentoOEmpleado = Pattern.compile("^.{458}(.{35}).*");
	private static Pattern PATTERN_SEH1D_calificadorReferencia2 = Pattern.compile("^.{493}(.{3}).*");
	private static Pattern PATTERN_SEH1D_referencia2 = Pattern.compile("^.{496}(.{17}).*");

	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_SEH1D_calificadorDelInterlocutor.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
		...
		if((m = PATTERN_SEH1D_agenciaResponsableDeLaListaDeCodigos.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
		...
		if((m = PATTERN_SEH1D_calleYNumero1.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalleYNumero1(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1D_calleYNumero2.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalleYNumero2(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1D_calleYNumero3.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalleYNumero3(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1D_calleYNumero4.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
		...
		if((m = PATTERN_SEH1D_calificadorReferencia1.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setCalificadorReferencia1(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1D_referencia1.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
		...
		if((m = PATTERN_SEH1D_departamentoOIdentificacionDelEmpleado.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setDepartamentoOIdentificacionDelEmpleado(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1D_departamentoOEmpleado.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
		...
		if((m = PATTERN_SEH1D_referencia2.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>16</td> <td>Codigo postal</td> <td>C</td> <td>9</td> <td>389</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */ 
	...
	public enum SEH1D_2 {
		...
		PROVEEDOR__SU("SU"),
		PUNTO_DESDE_DONDE_SE_ENVIAN_LAS_MERCANCIAS_PW("PW"),
		...
		public static SEH1D_2 enumByValue(String value) {
	...
	public enum SEH1D_4 {
		...
		public static SEH1D_4 enumByValue(String value) {
			return Arrays.asList(values()).stream()
				.filter(o -> (o.getValue().equalsIgnoreCase(value)))
				.findFirst().orElse(null);
		}
	...
	public enum SEH1D_18_19 {
		...
		private SEH1D_18_19(String value) {
			this.value = value;
		}
		...
		public static SEH1D_18_19 enumByValue(String value) {
			return Arrays.asList(values()).stream()
				.filter(o -> (o.getValue().equalsIgnoreCase(value)))
				.findFirst().orElse(null);
		}
