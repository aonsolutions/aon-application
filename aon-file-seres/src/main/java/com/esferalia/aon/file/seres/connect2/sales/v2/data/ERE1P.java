...
public class ERE1P {
	...
	private String direccionCorreoElectronico_email_;
	...
	private static Pattern PATTERN_ERE1P_telefono = Pattern.compile("^.{513}(.{70}).*");
	private static Pattern PATTERN_ERE1P_direccionCorreoElectronico_email_ = Pattern.compile("^.{583}(.{250}).*");
	...
	public void parse(String value) {
		...
		if((m = PATTERN_ERE1P_telefono.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTelefono(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_ERE1P_direccionCorreoElectronico_email_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setDireccionCorreoElectronico_email_(String.valueOf(m.group(1).trim()));
		}
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>25</td> <td>Teléfono</td> <td>C</td> <td>70</td> <td>514</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	...
	/**
	 * 26 - Dirección correo electrónico (e-mail)
	 */
	public String getDireccionCorreoElectronico_email_() {
		return direccionCorreoElectronico_email_;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>26</td> <td>Dirección correo electrónico (e-mail)</td> <td>C</td> <td>250</td> <td>584</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */
	public void setDireccionCorreoElectronico_email_(String direccionCorreoElectronico_email_) {
		this.direccionCorreoElectronico_email_ = direccionCorreoElectronico_email_;
	}
