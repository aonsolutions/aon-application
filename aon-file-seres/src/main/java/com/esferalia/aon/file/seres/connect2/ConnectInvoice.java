...
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.RECTL;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCD;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCE;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCI;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCL;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCP;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCT;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCU;
import com.esferalia.aon.file.seres.connect2.invoice.v4.data.SINCV;
...
public class ConnectInvoice extends AbstractFileFiller {
	...
	public ConnectInvoice(RECTL rectl, PrintWriter writer) throws FileNotFoundException, UnsupportedEncodingException {
		...
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/RECTL.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCC.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCP.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCT.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCV.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCD.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCL.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCU.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCE.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectInvoice.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/invoice/v4/xml/SINCI.xml");
		DiskRegisterLoader.load(input, manager);
	}
