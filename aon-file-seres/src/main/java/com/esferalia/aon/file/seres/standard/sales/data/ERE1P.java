...
public class ERE1P {
	 ...
	 */
	public enum ERE1P_2 {
		EMISOR_DEL_MENSAJ_MS("MS"),
		RECEPTOR_DEL_MENSAJ_MR("MR"),
		PROVEEDOR_SU("SU"),
		PUNTO_DESTINO_DE_LA_MERCANCI_DP("DP"),
		DESTINATARIO_FINA_UC("UC"),
		COMPRADO_BY("BY"),
		A_QUIEN_SE_FACTUR_IV("IV"),
		SUJETO_DEL_PAGO__A_QUIEN_SE_PAGA_PE("PE"),
		PAGADOR__QUIEN_PAGA_PR("PR"),
		;
	...
	public enum ERE1P_4 {
		...
		public static ERE1P_4 enumByValue(String value) {
			return Arrays.asList(values()).stream()
				.filter(o -> (o.getValue().equalsIgnoreCase(value)))
				.findFirst().orElse(null);
		}
	...
	public enum ERE1P_18_19 {
		IDENTIFICACION_ADICIONAL_DE_LA_PART_API("API"),
		NUMERO_DE_REFERENCIA_GUBERNAMENTAL_GN("GN"),
		NUMERO_INTERNO_DE_VENDEDO_IA("IA"),
		NUMERO_INTERNO_DE_CLIENT_IT("IT"),
		NUMERO_DE_IDENTIFICACION_FISCA_VA("VA"),
		CONTACTO_INFORMACIO_IC("IC"),
		CONTACTO_PEDID_OC("OC"),
		CONTACTO_DE_ENTREG_DL("DL"),
		CONTACTO_DE_TRANSPORT_TR("TR"),
		;
