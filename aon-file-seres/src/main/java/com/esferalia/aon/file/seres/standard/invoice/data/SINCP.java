...
public class SINCP {
	...
	/** 
	 * 4 - Tipo Interlocutor: Código que identifica el tipo de código del interlocutor. Este campo se corresponde con el elemento 3055. Los valores posibles son:
	 */ 
	...
	public enum SINCP_2 {
		PROVEEDOR_SU("SU"),
		EMISOR_DE_UNA_FACTURA__QUIEN_FACTURA_II("II"),
	...
	public enum SINCP_4 {
		CODIGO_EA_9("9"),
		CODIGO_ASIGNADO_POR_EL_EMISOR_DEL_MENSAJ_91("91"),
		PERSONA_JURIDIC_J("J"),
		PERSONA_FISIC_F("F"),
		;
		...
		public static SINCP_4 enumByValue(String value) {
			return Arrays.asList(values()).stream()
				.filter(o -> (o.getValue().equalsIgnoreCase(value)))
				.findFirst().orElse(null);
		}
