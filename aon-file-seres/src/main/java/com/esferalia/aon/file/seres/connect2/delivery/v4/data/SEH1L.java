...
public class SEH1L {
	...
	private static Pattern PATTERN_SEH1L_IMD_FTG_ = Pattern.compile("^.{943}(.{70}).*");
	private static Pattern PATTERN_SEH1L_importeNetoLinea_203_con_descuentos_cargos = Pattern.compile("^.{1013}(.{19}).*");
	...
	public void parse(String value) {
		...
		if((m = PATTERN_SEH1L_IMD_FTG_.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setIMD_FTG_(String.valueOf(m.group(1).trim()));
		}
		if((m = PATTERN_SEH1L_importeNetoLinea_203_con_descuentos_cargos.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setImporteNetoLinea_203_con_descuentos_cargos(String.valueOf(m.group(1).trim()));
		}
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>56</td> <td>IMD (FTG)</td> <td>C</td> <td>70</td> <td>944</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */ 
	public void setIMD_FTG_(String IMD_FTG_) {
		this.IMD_FTG_ = IMD_FTG_;
	}
	
	/**
	 * 57 - importe neto por línea (203) : que incluye los descuentos y cargos por línea, y excluye tanto los descuentos/cargos globales como el IVA.
	 */
	public String getImporteNetoLinea_203_con_descuentos_cargos() {
		return importeNetoLinea_203_con_descuentos_cargos;
	}
	 ...
	 * 	</tr>
	 * 	<tr>
	 * 		 <td>57</td> <td>importe neto línea (203) con descuentos/cargos</td> <td>C</td> <td>19</td> <td>1014</td> <td>O</td>
	 * 	</tr>
	 * </table>
	 */ 
	...
	public enum SEH1L_37 {
		ENVIO_PARCIAL__QUE_TIENE_QUE_COMPLETARSE_BP("BP"),
		ENVIO_PARCIAL_CONSIDERADO_COMPLETO__SIN_ENVIO_SUPLEMENTARIO_CP("CP"),
		;
	...
	public enum SEH1L_48 {
		PESCADO_F01("F01"),
		PESCADO_EN_AGUAS_DULCES_F02("F02"),
		CRIADO_O_ACUICULTURA_F03("F03"),
		;
	...
	public enum SEH1L_54 {
		CONGELADO_PREVIAMENTE_FZ1("FZ1"),
		NO_CONGELADO_PREVIAMENTE_FZ2("FZ2"),
		;
