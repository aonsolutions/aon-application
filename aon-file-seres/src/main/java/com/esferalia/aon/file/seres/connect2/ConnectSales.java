...
public class ConnectSales extends AbstractFileFiller {
	...
	public ConnectSales(RECTL rectl, PrintWriter writer) throws FileNotFoundException, UnsupportedEncodingException {
		...
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/RECTL.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1C.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1T.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1P.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1I.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1V.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1D.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1L.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1U.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1G.xml");
		DiskRegisterLoader.load(input, manager);
		input = ConnectSales.class.getResourceAsStream("/com/esferalia/aon/file/seres/connect2/sales/v2/xml/ERE1E.xml");
		DiskRegisterLoader.load(input, manager);
	}
