...
public class SEH1C {
	...
	/** 
	 * 2 - Tipo de documento (351/35E): Este campo corresponde al elemento 1001. Los posibles valores son:
	 */ 
	...
	public enum SEH1C_7_8 {
		...
		ENTREGA_FECHA_HORA__PRIMER_64("64"),
		ENTREGA_FECHA_HORA__ULTIM_63("63"),
		FECHA_HORA_ENTREGA_PREVIST_191("191"),
		;
	...
	public enum SEH1C_11 {
		...
		FECHA_HORA_NUMERO_PEDIDO__171___102_203___EL_FORMATO_ACEPTADO_ES_CCYYMMDD_O_CCYYMMDDHHMM_13("13"),
		FECHA_HORA_NUMERO_ALBARAN__171___102_203___EL_FORMATO_ACEPTADO_ES_CCYYMMDD_O_CCYYMMDDHHMM_15("15"),
		;
	...
	public enum SEH1C_16_17_18 {
		NUMERO_DEL_PEDIDO__PROVEEDOR_VN("VN"),
		NUMERO_DE_ENTREGA_DEL_PEDIDO_AAJ("AAJ"),
		;
	...
	public enum SEH1C_22 {
		DEFINIDO_POR_EL_COMPRADOR_Y_POR_EL_PROVEEDOR_DF("DF"),
		PREPAGO_PERO_A_CARGO_DEL_CLIENT_PC("PC"),
		PORTES_PAGADO_PP("PP"),
		;
	...
	public enum SEH1C_23 {
		RECOGIDO_POR_EL_EMISOR_DEL_PEDIDO_RD("RD"),
		ENVIADO_POR_EL_RECEPTOR_DEL_PEDIDO_EP("EP"),
		;
	...
	public enum SEH1C_25 {
		TRANSPORTE_MARITIM_10("10"),
		TRASPORTE_FERROVIARI_20("20"),
		TRASPORTE_POR_CARRETER_30("30"),
		TRANSPORTE_AEREO_40("40"),
		TRANSPORTE_MULTIPL_60("60"),
		;
