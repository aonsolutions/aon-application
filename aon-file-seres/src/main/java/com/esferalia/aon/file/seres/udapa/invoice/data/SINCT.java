...
public class SINCT {
	...
	private static java.util.regex.Pattern PATTERN_SINCT_textosCabecera = java.util.regex.Pattern.compile("^(.{6}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_tipoFactura_325_380_381_383_385_ = java.util.regex.Pattern.compile("^.{6}(.{6}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_numeroDeFactura = java.util.regex.Pattern.compile("^.{12}(.{17}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_codigoVendedor_SU_ = java.util.regex.Pattern.compile("^.{29}(.{13}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_codigoComprador_BY_ = java.util.regex.Pattern.compile("^.{42}(.{13}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_numeroDeLinea = java.util.regex.Pattern.compile("^.{55}(.{6}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_calificadorDelTemaDelTexto = java.util.regex.Pattern.compile("^.{61}(.{6}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_texto1 = java.util.regex.Pattern.compile("^.{67}(.{70}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_texto2 = java.util.regex.Pattern.compile("^.{137}(.{70}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_texto3 = java.util.regex.Pattern.compile("^.{207}(.{70}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_texto4 = java.util.regex.Pattern.compile("^.{277}(.{70}).*");
	private static java.util.regex.Pattern PATTERN_SINCT_texto5 = java.util.regex.Pattern.compile("^.{347}(.{70}).*");

	public void parse(String value) {
		java.util.regex.Matcher m;
		if((m = PATTERN_SINCT_textosCabecera.matcher(value)).find()) {
			setTextosCabecera(m.group(1));
		}
		if((m = PATTERN_SINCT_tipoFactura_325_380_381_383_385_.matcher(value)).find()) {
			setTipoFactura_325_380_381_383_385_(m.group(1));
		}
		if((m = PATTERN_SINCT_numeroDeFactura.matcher(value)).find()) {
			setNumeroDeFactura(m.group(1));
		}
		if((m = PATTERN_SINCT_codigoVendedor_SU_.matcher(value)).find()) {
			setCodigoVendedor_SU_(m.group(1));
		}
		if((m = PATTERN_SINCT_codigoComprador_BY_.matcher(value)).find()) {
			setCodigoComprador_BY_(m.group(1));
		}
		if((m = PATTERN_SINCT_numeroDeLinea.matcher(value)).find()) {
			setNumeroDeLinea(m.group(1));
		}
		if((m = PATTERN_SINCT_calificadorDelTemaDelTexto.matcher(value)).find()) {
			setCalificadorDelTemaDelTexto(m.group(1));
		}
		if((m = PATTERN_SINCT_texto1.matcher(value)).find()) {
			setTexto1(m.group(1));
		}
		if((m = PATTERN_SINCT_texto2.matcher(value)).find()) {
			setTexto2(m.group(1));
		}
		if((m = PATTERN_SINCT_texto3.matcher(value)).find()) {
			setTexto3(m.group(1));
		}
		if((m = PATTERN_SINCT_texto4.matcher(value)).find()) {
			setTexto4(m.group(1));
		}
		if((m = PATTERN_SINCT_texto5.matcher(value)).find()) {
			setTexto5(m.group(1));
		}
	}
	 ...
	 * </table>
	 */ 
	public String getTextosCabecera() {
		return textosCabecera;
	}
	public void setTextosCabecera(String textosCabecera) {
		this.textosCabecera = textosCabecera;
	}
