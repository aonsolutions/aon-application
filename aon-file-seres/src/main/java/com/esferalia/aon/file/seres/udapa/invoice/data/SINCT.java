...
public class SINCT {
	...
	private static Pattern PATTERN_SINCT_textosCabecera = Pattern.compile("^(.{6}).*");
	...
	public void parse(String value) {
		Matcher m;
		if((m = PATTERN_SINCT_textosCabecera.matcher(value)).find() && StringUtils.isNotBlank(m.group(1))) {
			setTextosCabecera(String.valueOf(m.group(1).trim()));
		}
