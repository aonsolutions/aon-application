...
export const CREATE_EXPENSE = 'Crear despesa';
export const CREATE_INCOME = 'Crear ingrés';
export const CREATE_INVOICE = 'Crear factura';
export const CREATE_INVOICE_EXPENSE = 'Crear factura despesa';
export const CREATE_INVOICE_INCOME = 'Crear factura ingrés';
export const CREATE_INVOICE_ISSUED = 'Crear factura emesa';
export const CREATE_INVOICE_RECEIVED = 'Crear factura rebuda';
export const CREATE_INVOICE_TICKET = 'Crear tiquet';
export const CREATE_QUERY = 'Crear consulta';
export const CREATION = 'Creació';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Dades Creditor o Proveïdor';
export const DOCUMENT_CLIENT = 'Dades Client';
// export const DOCUMENTARY = 'Documental';
// export const DOCUMENTAL_FILE = 'Fitxa Documental';
export const DOCUMENTARY = 'El meu núvol'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Fitxer al meu núvol'; // De mientras, ya que se tiene que modificar todo
...
export const OTHER_EXPENSE = 'Una altra Despesa';
export const OTHER_INCOME = 'Un altre Ingrés';
...
export const PAYROLL_PANEL = 'Panell Laboral';
...
export const UPLOAD_DOCUMENT = 'Pujar al meu núvol';  // De mientras, ya que se tiene que modificar todo
