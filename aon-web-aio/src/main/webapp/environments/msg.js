...
export const ACCOUNTING_PANEL = MSG.ACCOUNTING_PANEL;
export const ACCOUNTING_DESCRIPTION = MSG.ACCOUNTING_DESCRIPTION;
...
export const CREATE_EXPENSE = MSG.CREATE_EXPENSE;
export const CREATE_INCOME = MSG.CREATE_INCOME;
export const CREATE_INVOICE = MSG.CREATE_INVOICE;
export const CREATE_INVOICE_EXPENSE = MSG.CREATE_INVOICE_EXPENSE;
export const CREATE_INVOICE_INCOME = MSG.CREATE_INVOICE_INCOME;
export const CREATE_INVOICE_ISSUED = MSG.CREATE_INVOICE_ISSUED;
export const CREATE_INVOICE_RECEIVED = MSG.CREATE_INVOICE_RECEIVED;
export const CREATE_INVOICE_TICKET = MSG.CREATE_INVOICE_TICKET;
...
export const CREATION = MSG.CREATION;
...
export const DOCUMENT_CREDITOR_SUPPLIER = MSG.DOCUMENT_CREDITOR_SUPPLIER;
export const DOCUMENT_CLIENT = MSG.DOCUMENT_CLIENT;
...
export const FISCAL_PANEL = MSG.FISCAL_PANEL;
...
export const INVOICE_EXPENSE = MSG.INVOICE_EXPENSE;
export const INVOICE_ISSUED = MSG.INVOICE_ISSUED;
export const INVOICE_INCOME = MSG.INVOICE_INCOME;
...
export const OTHER_EXPENSE = MSG.OTHER_EXPENSE;
export const OTHER_INCOME = MSG.OTHER_INCOME;
...
export const PAYROLL_PANEL = MSG.PAYROLL_PANEL;
...
export const PLAN = "Ampliar plan";
