...
export const ACCOUNTING_PANEL = 'Buchhaltungspanel';
...
export const CREATE_EXPENSE = 'Aufwand erstellen';
export const CREATE_INCOME = 'Eintrag erstellen';
export const CREATE_INVOICE = 'Rechnung erstellen';
export const CREATE_INVOICE_EXPENSE = 'Spesenabrechnung erstellen';
export const CREATE_INVOICE_INCOME = 'Einnahmenrechnung erstellen';   
export const CREATE_INVOICE_ISSUED = 'Ausgestellte Rechnung erstellen';
export const CREATE_INVOICE_RECEIVED = 'Erhaltene Rechnung erstellen';
export const CREATE_INVOICE_TICKET = 'Ticket erstellen';
export const CREATE_QUERY = 'Abfrage erstellen';
export const CREATION = 'Schaffung';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Gläubiger-oder Lieferanteninformationen';
export const DOCUMENT_CLIENT = 'Kundendaten';
// export const DOCUMENTARY = 'Documentary';
// export const DOCUMENTAL_FILE = 'Dokumentdatei';
export const DOCUMENTARY = 'Meine Cloud'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Datei in meiner Cloud'; // De mientras, ya que se tiene que modificar todo
...
export const FISCAL_PANEL = 'Finanzgremium';
...
export const INCOMES = 'Einkommen';
...
export const OTHER_EXPENSES = 'Sonstige Ausgaben';
export const OTHER_INCOMES = 'Sonstige Einkünfte';
export const OTHER_EXPENSE = 'Sonstige Kosten';
export const OTHER_INCOME = 'Sonstige Einkünfte';
...
export const PAYROLL_PANEL = 'Arbeitsgremium';
...
export const UPLOAD_DOCUMENT = 'In meine Cloud hochladen';  // De mientras, ya que se tiene que modificar todo
