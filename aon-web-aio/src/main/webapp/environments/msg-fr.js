...
export const ACCOUNTING_PANEL = 'Panneau Comptable';
export const ACCOUNTING_DESCRIPTION = 'Info. compta.';
...
export const CONTENT_INDEX = 'Manuels';
...
export const CREATE_EXPENSE = 'Créer une dépense';
export const CREATE_INCOME = 'Créer une entrée';
export const CREATE_INVOICE = 'Créer une facture';
export const CREATE_INVOICE_EXPENSE = 'Créer une facture de dépenses';
export const CREATE_INVOICE_INCOME = 'Créer une facture de revenus';
export const CREATE_INVOICE_ISSUED = 'Créer une facture émise';
export const CREATE_INVOICE_RECEIVED = 'Créer la facture reçue';
export const CREATE_INVOICE_TICKET = 'Créer un ticket';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Données sur le créancier ou le fournisseur';
export const DOCUMENT_CLIENT = 'Données client';
// export const DOCUMENTARY = 'Documentaire';
// export const DOCUMENTAL_FILE = 'Dossier Documentaire';
export const DOCUMENTARY = 'Mon cloud'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Fichier dans mon cloud'; // De mientras, ya que se tiene que modificar todo
...
export const FISCAL_PANEL = 'Panel Fiscal';
export const FILE = 'Fichier';
export const FILES = 'Fichiers';
...
export const OTHER_EXPENSE = 'Autres Dépenses';
export const OTHER_INCOME = 'Autres Revenus';
...
export const PAYROLL_PANEL = 'Panel du Travail';
...
export const UPLOAD_DOCUMENT = 'Téléverser vers mon cloud';  // De mientras, ya que se tiene que modificar todo
