...
export const AON_DASHBOARD_UPLOAD_BUTTON = 'aon-dashboard-upload-button';
export const AON_CARD = 'aon-card';
export const AON_CHAT = 'aon-chat';
export const AON_CHECKBOX = 'aon-checkbox';
export const AON_NEW_CHECKBOX = 'aon-new-checkbox';
...
export const AON_NEW_DATE = 'aon-new-date';
...
export const AON_PATURPAT = 'aon-paturpat';
export const AON_PATURPAT_APPLICATION = 'aon-paturpat-application';
export const AON_PATURPAT_APPS = 'aon-paturpat-apps';
export const AON_PATURPAT_ELABORATIONS = 'aon-paturpat-elaborations';
export const AON_PATURPAT_DELIVERIES = 'aon-paturpat-deliveries';
export const AON_PATURPAT_HOME = 'aon-paturpat-home';
export const AON_PATURPAT_MENU = 'aon-paturpat-menu';
export const AON_PATURPAT_PACKAGING = 'aon-paturpat-packaging';
export const AON_PATURPAT_SEARCH = 'aon-paturpat-search';
export const AON_RECORD_DATA = 'aon-record-data';
export const AON_RECORD_DATA_LIST = 'aon-record-data-list';
...
export const AON_INVOICE_ISSUED = 'aon-invoice-issued';
export const AON_INVOICE_PROCESSING = 'aon-invoice-processing';
...
export const AON_INVOICE_CONFIG = 'aon-invoice-config';
export const AON_INVOICE_COMMUNICATION_CONFIGURATION = 'aon-invoice-communication-configuration';
export const AON_INVOICE_COMMUNICATION_CONFIG = 'aon-invoice-communication-config';
...
export const AON_JSF_FBATCH_PAYMENT_PAYROLL = 'aon-jsf-fbatch-payment-payroll' ;
...
export const AON_JSF_COMPANY_RECORD_DATA = 'aon-jsf-company-record-data';
