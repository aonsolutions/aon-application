...
export const CREATE_EXPENSE = 'Gastua sortu';
export const CREATE_INCOME = 'Sarrera sortu';
export const CREATE_INVOICE = 'Faktura sortu';
export const CREATE_INVOICE_EXPENSE = 'Gastu-faktura sortu';
export const CREATE_INVOICE_INCOME = 'Diru-sarreren faktura sortu';
export const CREATE_INVOICE_ISSUED = 'Jaulkitako faktura sortu';
export const CREATE_INVOICE_RECEIVED = 'Jasotako faktura sortu';
export const CREATE_INVOICE_TICKET = 'Ticketa sortu';
export const CREATE_QUERY = 'Sortu kontsulta';
export const CREATION = 'Sorkuntza';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Hartzekodunaren edo Hornitzailearen Datuak';
export const DOCUMENT_CLIENT = 'Bezeroaren Datuak';
// export const DOCUMENTARY = 'Dokumentala';
// export const DOCUMENTAL_FILE = 'Fitxa Dokumentala';
export const DOCUMENTARY = 'Nire hodeia'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Fitxategia Nire hodeian'; // De mientras, ya que se tiene que modificar todo
...
export const FILES = 'Fitxategiak';
...
export const FISCAL_PANEL = 'Panel Fiskala';
...
export const OTHER_EXPENSES = 'Beste Gastu';
export const OTHER_INCOMES = 'Beste Diru-sarrerak';
export const OTHER_EXPENSE = 'Beste Gastu';
export const OTHER_INCOME = 'Beste Diru-sarrera';
...
export const PAYROLL_PANEL = 'Lan Panela';
...
export const UPLOAD_DOCUMENT = 'Nire hodeira igo';  // De mientras, ya que se tiene que modificar todo
