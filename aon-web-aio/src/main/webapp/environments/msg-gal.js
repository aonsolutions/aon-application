...
export const CREATE_EXPENSE = 'Crear gastos';
export const CREATE_INCOME = 'Crear entrada';
export const CREATE_INVOICE = 'crear factura';
export const CREATE_INVOICE_EXPENSE = 'Crear factura de gastos';
export const CREATE_INVOICE_INCOME = 'Crear factura de ingresos';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Datos do acredor ou provedor';
export const DOCUMENT_CLIENT = 'Datos do cliente';
// export const DOCUMENTARY = 'Documental';
// export const DOCUMENTAL_FILE = 'Ficha Documental';
export const DOCUMENTARY = 'A miña nube'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Ficheiro na miña nube'; // De mientras, ya que se tiene que modificar todo
...
export const OTHER_EXPENSE = 'Outro gasto';
export const OTHER_INCOME = 'Outro Ingreso';
...
export const UPLOAD_DOCUMENT = 'Subir á miña nube';  // De mientras, ya que se tiene que modificar todo
export const USER = 'Usuario';
export const USER_CATEGORIES = 'Categorias do Usuario';
