...
export const ACCOUNTING_PANEL = 'Panel Contabilidad';
...
export const CONTENT_INDEX = 'Manuales';
...
export const CREATE_INCOME = 'Crear ingreso';
export const CREATE_INVOICE = 'Crear facta';
export const CREATE_INVOICE_EXPENSE = 'Crear factura gasto';
export const CREATE_INVOICE_INCOME = 'Crear factura ingreso';
export const CREATE_INVOICE_ISSUED = 'Crear factura emitida';
export const CREATE_INVOICE_RECEIVED = 'Crear factura recibida';
export const CREATE_INVOICE_TICKET = 'Crear ticket';
export const CREATE_QUERY = 'Crear consulta';
export const CREATION = 'Creación';
...
export const DELETE_CATEGORY = 'Eliminar categoría';
export const DELETE_CONFIRM = "Estás seguro de eliminar";
export const DELETE_FILE = 'Eliminar fichero';
export const DELETE_FILE_CONFIRM = 'Estás seguro de eliminar el fichero';
export const DELETE_FOREVER = 'Eliminar definitivamente';
...
export const DELETE_TAG = 'Eliminar etiqueta';
export const DELETE_TAX = 'Eliminar impuesto';
export const DELETE_WAREHOUSE = 'Eliminar almacén';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Datos Acreedor o Proveedor';
...
export const DOCUMENTARY = 'Mi nube'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'Fichero en Mi nube'; // De mientras, ya que se tiene que modificar todo
...
export const INVOICE_EXPENSE = 'Factura Gasto';
export const INVOICE_ISSUED = 'Factura Emitida';
export const INVOICE_INCOME = 'Factura Ingreso';
...
export const OFFICE_CATEGORIES = 'Categorías del despacho';
...
export const OTHER_EXPENSE = 'Otro Gasto';
export const OTHER_INCOME = 'Otro Ingreso';
...
export const PAYROLL_PANEL = 'Panel Laboral';
...
export const UPLOAD_DOCUMENT = 'Subir a mi nube'; // De mientras, ya que se tiene que modificar todo
