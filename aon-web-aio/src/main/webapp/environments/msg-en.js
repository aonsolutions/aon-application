...
export const CONENT_INDEX = 'Content index';
...
export const CREATE_INCOME = 'Create entry';
export const CREATE_INVOICE = 'Create invoice';
export const CREATE_INVOICE_EXPENSE = 'Create expense invoice';
export const CREATE_INVOICE_INCOME = 'Create income invoice';
export const CREATE_INVOICE_ISSUED = 'Create issued invoice';
export const CREATE_INVOICE_RECEIVED = 'Create invoice received';
export const CREATE_INVOICE_TICKET = 'Create ticket';
...
export const DOCUMENT_CREDITOR_SUPPLIER = 'Creditor or Supplier Data';
export const DOCUMENT_CLIENT = 'Customer Data';
// export const DOCUMENTARY = 'Documentary';
// export const DOCUMENTAL_FILE = 'Documental File';
export const DOCUMENTARY = 'My Cloud'; // De mientras, ya que se tiene que modificar todo
export const DOCUMENTAL_FILE = 'File in My Cloud'; // De mientras, ya que se tiene que modificar todo
...
export const FISCAL_PANEL = 'Fiscal Panel';
...
export const PAYROLL_PANEL = 'Payroll Panel';
...
export const UPLOAD_DOCUMENT = 'Upload to my cloud';  // De mientras, ya que se tiene que modificar todo
