...
<%@page import="com.code.aon.ui.resources.bean.CustomizeBean"%>
<%@page import="com.code.aon.ui.common.controller.FailedLogin"%>
...
<jsp:useBean id="customize" class="com.code.aon.ui.resources.bean.CustomizeBean" scope="page"/>
<jsp:useBean id="companyDisplay" class="com.code.aon.ui.company.controller.CompanyDisplay" scope="page"/>
<%
...
customize.init(request.getServerName(), request.getContextPath());
companyDisplay.init(request.getServerName(), request.getContextPath());
...
%>	
	<head>
		...
		<link rel="stylesheet" href="/aon-aio/aonResource/com/code/aon/ui/resources/facelet/login/css/login-aon.css" />
...
<%--  
		<c:if test="#{dbUptodate.uptodate and dbUptodate.connectionAvailable}">
			<ui:include src="/com/code/aon/ui/dbutils/facelet/uptodate/uptodatePanel.xhtml" />
		</c:if>	
		<c:if test="#{!dbUptodate.connectionAvailable}">
			<ui:include src="/com/code/aon/ui/dbutils/facelet/uptodate/connectionError.xhtml" />
		</c:if>
--%>
	<div class="aon-login">
