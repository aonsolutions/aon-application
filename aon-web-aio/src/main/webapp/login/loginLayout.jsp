...
<head>
	...
	.aonButton {
	  ...
	  background: var(--aonBlue);
	  color: #ffffff;
	  font-family: var(--aonFontFamily);
	  font-size: 1rem;
	  cursor: pointer;
	  text-align: center;
	...
	.aonButton[disabled], .aonButton:disabled {
	  cursor: not-allowed;
	  background-color: #cccccc !important;
	}
	</style>
	
	<link rel="stylesheet" type="text/css" href="/css/material-symbols-outlined.css" />
	<link rel="stylesheet" type="text/css" href="/css/aon-singleton-access.css" />
