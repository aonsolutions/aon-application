...
/**
 * Funci�n para imprimir texto en la consola con color y negrita.
 ...
 * @param {boolean} [bold=false] Indica si el texto debe estar en negrita. Si no se pasa, no se aplicar� negrita.
 */
