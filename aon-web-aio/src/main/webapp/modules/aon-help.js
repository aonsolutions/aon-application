	...
	build() {
      ...
      if (this.dur.getDomain() !== null) {
        ...
        if ((this.dur.isDomainPayer())||(this.dur.isOffice())){
          ...
          contactCard.addContent(this.buildSupportData("soporte@aonSolutions.es", "Atención a usuarios", MATERIAL_ICONS.MAIL, CSS.AON_SUPPORT_USERS_EMAIL));
          contactCard.addContent(this.buildSupportData("comercial@aonSolutions.es", "Ventas y contratación", MATERIAL_ICONS.MAIL, CSS.AON_SUPPORT_SALES_EMAIL));
          contactCard.addContent(this.buildSupportData("administracion@aonSolutions.es", "Facturación, cobros y pago", MATERIAL_ICONS.MAIL, CSS.AON_SUPPORT_ADMIN_EMAIL));
          // Card de horario 
