...
export class AonElaboration extends AonElement {
...
if(!window.customElements.get(TAG.AON_ELABORATION)) {
	window.customElements.define(TAG.AON_ELABORATION, AonElaboration);
}