...
import { AonExampleObject } from './aon-example-object.js';

export class AonExampleList extends AonElement {
	...
	build() {
		...
		table.addColumn(MSG.EXAMPLE, 'string', 'example', 'auto');
...
if(!window.customElements.get(TAG.AON_EXAMPLE_LIST)) {
    window.customElements.define(TAG.AON_EXAMPLE_LIST, AonExampleList);
}