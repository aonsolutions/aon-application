...
import { AonInvoiceProcessing } from "./aon-invoice-processing.js";
  ...
  export const CREATE_INCOME_INVOICE = {
    ...
    name: MSG.ISSUED_INVOICES,
    icon: MATERIAL_ICONS.UNARCHIVE,
    fn: () => createIssuedInvoice()
  }

  export const CREATE_OTHER_INCOMES = {
    id: 'FutureCreateOtherIncomes',
    name: MSG.OTHER_INCOMES,
    icon: MATERIAL_ICONS.UNARCHIVE,
    fn: () => createOtherIncomes()
  }

  export const CREATE_EXPENSE_INVOICE = {
    id: 'FutureCreateExpenseInvoice',
    name: MSG.RECEIVED_INVOICES,
    icon: MATERIAL_ICONS.ARCHIVE,
    fn: () => createReceivedInvoice()
  }

  export const CREATE_TICKET_INVOICE = {
    id: 'FutureCreateTicketInvoice',
    name: MSG.TICKET,
    icon: MATERIAL_ICONS.RECEIPT,
    fn: () => createTicketInvoice()
  }

  export const CREATE_OTHER_EXPENSES = {
    id: 'FutureCreateOtherExpenses',
    name: MSG.OTHER_EXPENSES,
    icon: MATERIAL_ICONS.ARCHIVE,
    fn: () => createOtherExpenses()
  }

  export const FUTURE_MAIN_INCOMES_CREATE = {
    id: 'FutureIncomesCreate',
    title: MSG.CREATE,
    name: MSG.CREATE,
    options: [CREATE_INCOME_INVOICE, CREATE_OTHER_INCOMES ]
  }

  export const FUTURE_INVOICE_ISSUED_BETA = {
    id: 'Future' + CONSTANT.INVOICE_ISSUED.initCap(),
    name: MSG.ISSUED_INVOICES,
    icon: MATERIAL_ICONS.UNARCHIVE,
    fn: () => invoiceList({
      status: "accounting",
  ...
  export const FUTURE_PROFORMA_INVOICES = {
    id: 'Future' + CONSTANT.PROFORMA_INVOICES.initCap(),
    name: MSG.PROFORMA_INVOICES,
    icon: "edit_document",
    fn: () => invoiceList({ status: CONSTANT.INBOX, type: "emitida" })
  }
  ...
  export const FUTURE_RAWDOC_INBOX_RECEIVED_NEW = {
    id: 'Future' + CONSTANT.RAWDOC_INBOX_RECEIVED_NEW.initCap(),
    name: MSG.DRAFT + " F." + MSG.RECEIVEDS,
    icon: "edit_document",
    fn: () => invoiceList({ status: CONSTANT.INBOX, type: "recibida" })
  }

  export const FUTURE_INVOICE_TICKET = {
    id: 'Future' + CONSTANT.INVOICE_TICKET.initCap(),
    name: MSG.SIMPLIFIED_INVOICES,
    icon: MATERIAL_ICONS.RECEIPT,
    fn: () => invoiceList({
      status: "accounting",
  ...
  export const FUTURE_RAWDOC_INBOX_TICKET_NEW = {
    id: 'Future' + CONSTANT.RAWDOC_INBOX_TICKET_NEW.initCap(),
    name: MSG.DRAFT + " " + MSG.SIMPLIFIED+"/"+MSG.TICKETS,
    icon: "edit_note",
    fn: () => invoiceList({ status: CONSTANT.INBOX, type: "ticket" })
  }
  ...
  export const FUTURE_MAIN_EXPENSES_CREATE = {
    id: 'FutureExpensesCreate',
    title: MSG.CREATE,
    name: MSG.CREATE,
    options: [CREATE_EXPENSE_INVOICE, CREATE_TICKET_INVOICE, CREATE_OTHER_EXPENSES]
  }

  export const FUTURE_MAIN_EXPENSES_LIST = {
  ...
  export const FUTURE_MAIN_INCOMES = {
    id: 'Future' + CONSTANT.INCOMES.initCap(),
    title: MSG.INCOMES,
    name: MSG.INCOMES,
    options: [FUTURE_MAIN_INCOMES_CREATE, FUTURE_MAIN_INCOMES_LIST],
    button: {
      id: 'Future' + CONSTANT.INCOMES.initCap() + 'Info',
      title: MSG.INFO_INCOMES,
      icon: 'info',
      fn: () => info(
          MSG.INCOMES,
  ...
  export const FUTURE_MAIN_INCOMES_TRIAL = {
    id: 'Future' + CONSTANT.INCOMES.initCap(),
    title: MSG.INCOMES,
    name: MSG.INCOMES,
    options: [FUTURE_MAIN_INCOMES_CREATE, FUTURE_MAIN_INCOMES_LIST_TRIAL],
    button: {
      id: 'Future' + CONSTANT.INCOMES.initCap() + 'Info',
      title: MSG.INFO_INCOMES,
      icon: 'info',
  ...
  export const FUTURE_MAIN_EXPENSES = {
    id: 'Future' + CONSTANT.EXPENSES.initCap(),
    title: MSG.EXPENSES,
    name: MSG.EXPENSES,
    options: [FUTURE_MAIN_EXPENSES_CREATE, FUTURE_MAIN_EXPENSES_LIST], 
    button: {
      id: 'Future' + CONSTANT.EXPENSES.initCap() + 'Info',
      title: MSG.INFO_EXPENSES,
      icon: 'info',
      fn: () => info(
        MSG.EXPENSES,
  ...
  export const FUTURE_RAWDOC_PROCESSING = {
    id: 'Future' + CONSTANT.RAWDOC_PROCESSING.initCap(),
    name: MSG.PROCCESSING,
    icon: MATERIAL_ICONS.SCHEDULE,
    fn: () => invoiceProcessing()
  }

  export const FUTURE_RAWDOC_REJECT = {
    id: 'Future' + CONSTANT.RAWDOC_REJECT.initCap(),
    name: MSG.TO_REVIEW,
    icon: MATERIAL_ICONS.REPORT,
    fn: () => invoiceList( { status: CONSTANT.REJECTED })
  }
  
  export const FUTURE_RAWDOC_TRASH = {
  ...
  export const FUTURE_MAIN_DOCUMENTS = {
    id: 'Future' + CONSTANT.DOCUMENT.initCap(),
    title: MSG.PENDING,
    name: MSG.PENDING,
    options: [FUTURE_RAWDOC_PROCESSING, FUTURE_RAWDOC_REJECT, FUTURE_RAWDOC_TRASH],
    button: {
      id: 'Future' + CONSTANT.DOCUMENT.initCap() + 'Info',
      title: MSG.INFO_PENDING,
      icon: 'info',
      fn: () => info(
        MSG.PENDING,
  ...
  export const FUTURE_MAIN_DOCUMENTS_TRIAL = {
    id: 'Future' +   CONSTANT.DOCUMENT.initCap(),
    title: MSG.PENDING,
    name: MSG.PENDING,
    options: [RAWDOC_TRASH],
   ...
   export const FUTURE_MANAGEMENT = {
    id: 'Future' + CONSTANT.MANAGEMENT.initCap(),
    title: MSG.MANAGEMENT,
    name: MSG.MANAGEMENT,
    options:[ REGISTRY, CONCEPTS, CHARGES_PAYMENTS, FISCAL_DRAFT] //, CLOSING_INVOICE ]
  }

  export const FUTURE_MANAGEMENT_TRIAL = {
    id: 'Future' + CONSTANT.MANAGEMENT.initCap(),
    title: MSG.MANAGEMENT,
    name: MSG.MANAGEMENT,
    options:[ REGISTRY, CONCEPTS]
  ...
  export const getFutureOptions = (trial) => {
    return trial 
      ? [FUTURE_MAIN_INCOMES_TRIAL, FUTURE_MAIN_EXPENSES, FUTURE_MAIN_DOCUMENTS_TRIAL, FUTURE_MANAGEMENT_TRIAL]
      : [FUTURE_MAIN_INCOMES, FUTURE_MAIN_EXPENSES, FUTURE_MAIN_DOCUMENTS, FUTURE_MANAGEMENT];
  }