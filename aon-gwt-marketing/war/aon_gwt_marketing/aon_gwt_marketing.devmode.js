...
var __gwtModuleFunction = $wnd.aon_gwt_marketing;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.aon_gwt_marketing=");
    idx += (13 + "aon_gwt_marketing".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=aon_gwt_marketing-0.js
