...
public interface IEdiSupport {
	...
	public String SERES_RECEIVE_ORDER = "SERES_RECEIVE_ORDER";
	public String SERES_SEND_DESADV = "SERES_SEND_DESADV";
	public String SERES_SEND_INVOICE = "SERES_SEND_INVOICE";
