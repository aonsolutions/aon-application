...
#    AON_MASTER_JAR = "/home/ecastellano/.m2/repository/com/code/aon/aon-master/7.0-SNAPSHOT/aon-master-7.0-SNAPSHOT.jar"
    ...
    def create(self):
        ...
        try:
            ...
            if self.__arguments.is_verbose_enabled():
                print "Creacion de la base de datos satisfactoria."
    ...
    def __load_default_values(self):
        ...
        if description == "" or description == None:
            description = domain.get_domain_name();
            if self.__arguments.is_verbose_enabled():
                print "WARNING: No se ha suministrado descripcion para el dominio nuevo, se usa el nombre!"    
