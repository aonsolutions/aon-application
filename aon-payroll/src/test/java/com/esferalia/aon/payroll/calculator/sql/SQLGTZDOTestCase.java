...
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
	...
	public void testGtzdoExtrasIII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(1000.00 * ( 1.00 + 1.00/12 + 1.00/12 ), salary.getCommonBase() , DELTA);
		...
		salary = new SmartContractSalaryCalculator<Salary>( new SalaryBuilder()).calculate(ctx);
		org.junit.assertEquals(1000.00 * ( 1.00 + 1.00/12 + 1.00/12 ), salary.getCommonBase() , DELTA);
		org.junit.assertEquals(2000.00, salary.getTotalPayment(), DELTA);
...
//			System.out.println(p.getExpression() + " = " + p.getAmount());
	...
	@Test
	public void testGtzdoBRI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testGtzdoBRII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testGtzdoBRIII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startIt = add(getFirstDayOfMonth(getToday()), Calendar.DAY_OF_MONTH, 10);
		//Date endIt = AonDateUtils.add(getToday(), Calendar.DATE, 100);
	...
	@Test
	public void testGtzdoBRIV() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startIt = add(getFirstDayOfMonth(getToday()), Calendar.DAY_OF_MONTH, 10);
		Date endIt = AonDateUtils.add(getToday(), Calendar.DATE, 17);
	...
	@Test
	public void testGtzdoBRV() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testGtzdoBRVI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		ContractRecord contract = newContract(aonContext,  
				...
				, new String[] { 
						"GTZDO(BASE_REGULADORA*0.50,1,3)" ,
						"GTZDO(BASE_REGULADORA,4)" ,
						"500.00 * DIAS_TRABAJADOS / DIAS_MES",
						"500.00 * DIAS_TRABAJADOS / DIAS_MES",
						}
	...
	@Test
	public void testGtzdoBRVII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startIt = add(getFirstDayOfMonth(getToday()), Calendar.DAY_OF_MONTH, 5);
		...
		startIt = add(endIt, Calendar.DAY_OF_MONTH, 5);
		endIt = AonDateUtils.add(startIt, Calendar.DATE, 10);
	...
	@Test
	public void testGtzdoBRVIII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testGtzdoBRIX() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//				null);
	...
	@Test
	public void testGtzdoCOVID19I() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		ContractRecord contract = newContract(aonContext,  
				...
				, new String[] { 
						"isdef DIAS_ENFERMEDAD_PROFESIONAL ? GTZDO(TODO) : HIDE()" ,
						"500.00 * DIAS_TRABAJADOS / DIAS_MES",
						"500.00 * DIAS_TRABAJADOS / DIAS_MES",
						}
				, new String[] {
	...
	@Test
	public void testGtzdoCOVID19II() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testGtzdoCOVID19III() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startIt = AonDateUtils.add(getFirstDayOfMonth(getToday()), Calendar.DATE, 10);
		Date endIt = AonDateUtils.add(startIt, Calendar.DATE, 10);
	...
	@Test
	public void testGtzdoATEC() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		cleanSystemData(aonContext);
...
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
		...
		PaymentConceptRecord gtzdo = addConcept(aonContext, "GARANTIZADO", PaymentType.CRA_0055);
		addPayment(aonContext, contract, gtzdo, "isdef DIAS_ENFERMEDAD_PROFESIONAL ? /*user*/GTZDO(TODO) : REMOVE()/**/", "0.00");
		...
		Date startItI = AonDateUtils.add(getToday(), Calendar.MONTH, -2);
		Date endItI = AonDateUtils.add(getFirstDayOfMonth(getToday()), Calendar.DATE, 10);
		...
		Date startItII = AonDateUtils.add(endItI, Calendar.DATE, 1);
		Date endItII = null;
	...
	@Test
	public void testAllInOneGtzdo() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
		...
		Date startIt = set(getToday(), DAY_OF_MONTH, 10);
		Date endIt = AonDateUtils.add(getToday(), Calendar.DATE, 100);
	...
	@Test
	public void testGtzdoLack() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
		...
		Date startIt = getToday();
		Date endIt = startIt; //AonDateUtils.add(getToday(), Calendar.DATE, 100);
				...
				new HashMap<String, String>() {
					{
						...
						put(TC2.getName(), String.format("\"%s\"" ,C200.getValue()));
					}
				}, new String[] { 
						"1000.00 * DIAS_TRABAJADOS / DIAS_MES",
						"isdef DIAS_IT ? GTZDO(TODO) : REMOVE()" ,
						"isdef BASE_REGULADORA ? TRACE('BASE_REGULADORA = %f\r\n', BASE_REGULADORA ); 0.00 : REMOVE()" ,
						}
				, new String[] {
//						"BASE_CGC * 0.10", 
//						"BASE_CGP * 0.05",
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
		...
		String [] partialFactors = {"0.15", "0.25", "0.75"}; 
		
		int brDays  = 0 ;
		
		for ( int i = 0; i < 3; i++ ) {
			Date date = add(startIt, Calendar.MONTH, -2 -i);
			brDays += get( getLastDayOfMonth(date), Calendar.DAY_OF_MONTH);
			addData(aonContext, contract, getFirstDayOfMonth(date), getLastDayOfMonth(date), PARTIAL_FACTOR.getName(), partialFactors[i]);
			calculateAndSave(connection, getContractSalaryCalculatorContext(connection, getFirstDayOfMonth(date),
					getLastDayOfMonth(date), getLastDayOfMonth(date), contract));
		}
		
		Date date = add(startIt, Calendar.MONTH, -1);
		addData(aonContext, contract, getFirstDayOfMonth(date), getLastDayOfMonth(date), PARTIAL_FACTOR.getName(), "0.15");
		calculateAndSave(connection, getContractSalaryCalculatorContext(connection, getFirstDayOfMonth(date),
				getLastDayOfMonth(date), getLastDayOfMonth(date), contract));
		
		AON.getSalaries(aonContext, p -> p.getContractProperty().eq(contract.getId()))
		.forEach( salary -> System.out.println(salary.getStartDate() + " : " + salary.getTotalPayment() +", " + salary.getCommonContingenciesBase() ));

		Date startDate = getFirstDayOfMonth(getToday());
		Date endDate = getLastDayOfMonth(startDate);
		addData(aonContext, contract, startDate, endDate, PARTIAL_FACTOR.getName(), "0.50");
		ISQLContractSalaryCalculatorContext ctx = getContractSalaryCalculatorContext(connection, startDate, endDate, endDate, contract);
		...
		double br = ( 1000.00 * ( Arrays.stream(partialFactors).collect(Collectors.summingDouble(Double::parseDouble))) ) / brDays;
		
		System.out.println("BR = " + br );
		
		//@formatter:off
		assertEquals(
				 1000.00 * workedDays / monthDays * 0.50 + (br * itDays), 
				salary.getTotalPayment() 
				, DELTA);
		//@formatter:on
	...
	private static void addPrestIts(AONContext aonContext, ContractRecord contract) {
		...
		PaymentConceptRecord lackIT = addConcept(aonContext, "PERIODO_CARENCIA");
		addPayment(aonContext, contract, lackIT 
				,"/*read-only*/DIAS_ENFERMEDAD_COMUN_CARENCIA * 0.00 * BASE_REGULADORA * (isdef COEFICIENTE_IT ? COEFICIENTE_IT : 1.00)/**/"
