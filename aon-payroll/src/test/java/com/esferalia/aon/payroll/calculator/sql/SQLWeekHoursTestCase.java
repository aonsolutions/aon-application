...
public class SQLWeekHoursTestCase extends AbstractSQLTestCase {
	...
	public void testPartialTimeWeekHoursI()
						...
						SUNDAY_HOURS.getName()} ) 
		{
			...
			assertEquals(hoursVar, 1, data.size());
			assertEquals(hoursVar,startDate,data.get(0).getStartDate());
			assertEquals(hoursVar,endDate, data.get(0).getEndDate());
			assertEquals(hoursVar, 1.00, Double.parseDouble(data.get(0).getExpression()));
		}
	...
	public void testPartialTimeWeekHoursII()
		...
		) 
		{
			List<ContextData> data = datas.get(hoursVar);
			assertEquals(hoursVar, 1, data.size());
			assertEquals(hoursVar,contractStartDate,data.get(0).getStartDate());
			assertEquals(hoursVar,endDate, data.get(0).getEndDate());
			assertEquals(hoursVar, 2.00, Double.parseDouble(data.get(0).getExpression()));
		}
		...
		) 
		{
			...
			assertEquals(hoursVar,contractStartDate,data.get(0).getStartDate());
			assertEquals(hoursVar,endDate, data.get(0).getEndDate());
			assertEquals(hoursVar, 6.00, Double.parseDouble(data.get(0).getExpression()));
		}
	...
	public void testPartialTimeWeekHoursV()
		...
		) 
		{
			...
			assertEquals(hoursVar, 1, data.size());
			assertEquals(hoursVar,startDate,data.get(0).getStartDate());
			assertEquals(hoursVar,contractEndDate, data.get(0).getEndDate());
			assertEquals(hoursVar, 2.00, Double.parseDouble(data.get(0).getExpression()));
		}
...
//						put(PARTIAL_FACTOR.getName(), format("%f", 0.75));
		...
		{
			List<ContextData> data = datas.get(hoursVar);
			assertEquals(hoursVar, 2, data.size());
			
			assertEquals(hoursVar,startDate,data.get(0).getStartDate());
			assertEquals(hoursVar,add(breakDate, DAY_OF_MONTH,-1), data.get(0).getEndDate());
			assertEquals(hoursVar, 2.00, Double.parseDouble(data.get(0).getExpression()));

			assertEquals(hoursVar,breakDate,data.get(1).getStartDate());
			assertEquals(hoursVar,endDate, data.get(1).getEndDate());
			assertEquals(hoursVar, 3.00, Double.parseDouble(data.get(1).getExpression()));
		}
	...
	public void testNullTimeWeekHoursI()
				...
				SUNDAY_HOURS.getName()} ) 
		{
			...
			assertEquals(hoursVar,startDate,data.get(0).getStartDate());
			assertEquals(hoursVar,endDate, data.get(0).getEndDate());
			assertEquals(hoursVar, 0.00, Double.parseDouble(data.get(0).getExpression()));
		}
