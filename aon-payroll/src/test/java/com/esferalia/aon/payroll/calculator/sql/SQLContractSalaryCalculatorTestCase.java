...
//								ContextVariable.WORKED_HOURS,
							...
							assertEquals(var.getName(), true, salary.getContextData()
	...
	public void testBaseCgcMinPPE()
		...
		assertEquals(1300.20, salary.getTotalPayment());
		assertEquals(1481.20, salary.getCommonBase());
		assertEquals(1481.20, salary.getProfessionalBase());
		assertEquals(1300.20, salary.getIrpfBase());
	...
	public void testBaseCgcMinPPEII()
		...
		assertEquals(1000.20, salary.getTotalPayment());
		assertEquals(1481.20, salary.getCommonBase());
		assertEquals(1481.20, salary.getProfessionalBase());
		assertEquals(1000.20, salary.getIrpfBase());
	...
	public void testDeferred()
		...
		org.junit.assertEquals(666.66, salary.getTotalPayment(), 0.0001);
	}
	...
	public void testDefinedAndUndefinedVars()
		...
		org.junit.assertEquals(monthDays, totalDays, DELTA);

		
		SmartContractSalaryCalculator<Salary> calculator = new SmartContractSalaryCalculator<Salary>();
		calculator.setSalaryBuilder(new SalaryBuilder());
		ISalary salary = calculator.calculate(ctx);
		org.junit.assertEquals(1500.00, salary.getTotalPayment(), DELTA);
