	...
	public void testSalaryData()
		...
		calculator.setSalaryBuilder(new SalaryBuilder() {
			...
			public void addCost(Double amount, String description, java.util.Date start, java.util.Date end,
				...
				assertEquals(data.get("GRUPO_COTIZACION"), "01");
...
//								ContextVariable.WORKED_HOURS,
							...
							assertEquals(true, salary.getContextData()
									.containsKey(var.getName()), var.getName());
	...
	public void testDescriptionRoundVariable()
		...
		for (IPayment payment : salary.getSalaryPayments()) {
			assertEquals(payment.getDescription(), "DESCRIPTION WITH UNDEFINED VAR 33.33 12");
		}
	...
	public void testDefinedAndUndefinedVars()
		...
		assertEquals(monthDays, totalDays, DELTA);
