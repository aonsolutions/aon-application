...
public class SQLITTestCase extends AbstractSQLTestCase {
	...
	public void testDuracionIT() throws ExpressionException, SQLException,
		...
		try {
			...
			org.junit.fail(String.format("'%s' must not be defined ", ContextVariable.IT_END));
...
//				"BASE_IRPF * PORCENTAJE_IRPF/100" 
	...
	public void testPregnancyCostIT() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals( 1750.00 , salary.getCommonBase(), DELTA);
		...
		org.junit.assertEquals( 1750.00 , salary.getCommonBase(), DELTA);
		org.junit.assertEquals( 1750.00 * 0.75 , salary.getTotalPayment(), DELTA);
	...
	public void testCommonDiseaseITQuoteDaysIX() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(31, quotaDays, 0.00);
	}
	...
	public void testCommonDiseaseIT365() throws ExpressionException, SQLException,
		...
		assertEquals(get(_545Date, DAY_OF_MONTH)* 100.00 * 0.75,salary.getTotalPayment() );
		assertEquals(30.00 * 100.00, salary.getCommonBase() );
		
		assertEquals( get(_545Date, DAY_OF_MONTH)* 100.00 * 1.65 / 100.00 , 
	...
	public void testProfessionalDiseaseIT365I() throws ExpressionException, SQLException,
		...
		assertEquals((30.00* 100.00 * 23.60/100.00)+(-1)*get(_545Date, DAY_OF_MONTH)* 100.00 * 0.75, salary.getTotalEnterprise() );
...
//						"BASE_IRPF * PORCENTAJE_IRPF/100" 
	...
	public void testBaseMinITVI() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(1100.00 + ( 1000.00/6), salary.getCommonBase(), DELTA);
	}
	...
	public void testPaternityITPartialIII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals( 1750.00 * 0.75 * 0.50 , salary.getTotalPayment(), DELTA);
	...
	public void testITWithConstantII() throws ExpressionException, SQLException,
		...
		addPayment(aonContext, contract, startContract, null, paga, "PAGA EXTRA", "100.00", "_P", "_P", PaymentType.CRA_0004);
		addPayment(aonContext, contract, startContract, null, antiguedad, "ANTIG�EDAD", "50.00", "_P", "_P", PaymentType.CRA_0001);
	...
	public void testITWithConstantIV() throws ExpressionException, SQLException,
		...
		addPayment(aonContext, contract, startContract, null, antiguedad, "ANTIG�EDAD", "50.00 * DIAS_TRABAJADOS / DIAS_MES" , "_P", "_P", PaymentType.CRA_0001);
	...
	public void testITWithConstantVI() throws ExpressionException, SQLException,
		...
		addPayment(aonContext, contract, startContract, null, "PAGA EXTRA", "100.00", "_P", "_P", PaymentType.CRA_0004, SalaryType.SALARY);
		addPayment(aonContext, contract, startContract, null, "ANTIG�EDAD", "50.00", "_P", "_P", PaymentType.CRA_0001, SalaryType.SALARY);
	...
	public void testProfessionalDiseaseIT365RedefinedIV() throws ExpressionException, SQLException,
		...
		for (com.esferalia.aon.payroll.SalaryPayment payment : salary
			...
			if ( PREST_IT.equals(payment.getName() ))
				org.junit.assertNotEquals("DIAS_ENFERMEDAD_PROFESIONAL_366 * 0.00", payment.getExpression());	
		}
	...
	public void testCommonDiseaseIT365RedefinedIV() throws ExpressionException, SQLException,
		...
		for (com.esferalia.aon.payroll.SalaryPayment payment : salary
			...
			System.out.println(payment.getName() + " = " + payment.getAmount()
					+ " (" + payment.getExpression() + "," + payment.getQuote() + ")");
			if ( PREST_IT.equals(payment.getName() ))
				org.junit.assertNotEquals("DIAS_ENFERMEDAD_COMUN_366 * 0.00", payment.getExpression());	
		}
...
//			System.out.println(payment.getName() + " = " + payment.getAmount()
//					+ " (" + payment.getExpression() + "," + payment.getQuote() + ")");
			org.junit.assertEquals(DIRECT_PAY.getName(), payment.getName());	
		}
        	org.junit.assertEquals(1000.00, salary.getCommonBase(), DELTA);
        	org.junit.assertEquals(1000.00, salary.getProfessionalBase(), DELTA);
        	org.junit.assertEquals(1000.00, quote, DELTA);
	...
	public void testBaseMinITMaternity() throws ExpressionException, SQLException,
		...
		for (com.esferalia.aon.payroll.SalaryPayment payment : salary
        		...
        		System.out.println(payment.getName() + " = " + payment.getAmount()
			+ " (" + payment.getExpression() + "," + payment.getQuote() + ")");
			org.junit.assertEquals(MATERNITY.getName(), payment.getName());	
		}
        	org.junit.assertEquals(1000.00, salary.getCommonBase(), DELTA);
        	org.junit.assertEquals(1000.00, salary.getProfessionalBase(), DELTA);
        	org.junit.assertEquals(1000.00, quote, DELTA);
	...
	public void testCommonDiseaseAtLackI() throws ExpressionException, SQLException,
		...
		assertEquals( 1750.00 * 10 / monthDays * 4.70 / 100.00 , salary.getTotalDeduction(), DELTA);
		...
		assertEquals( 1750.00 * 10.00 / 100.00 , salary.getTotalEnterprise(), DELTA);
	}
	...
	public void testBasesMinITI() throws ExpressionException, SQLException,
		...
		assertEquals(1500.00, salary.getCommonBase(), DELTA);
...
//		assertEquals(1250.00, salary.getProfessionalBase());
	...
	public void testPaymentITI() throws ExpressionException, SQLException,
		...
		for ( int i = 0; i < 11 ; i++ ) {
			...
			org.junit.assertEquals( days * 1750.00/30.00 , salary.getTotalPayment(), DELTA );
...
//					+ " (" + payment.getExpression() + ")");
		...
		org.junit.assertEquals(1, prestIt1_3);
		org.junit.assertEquals(1, prestIt4_15);
		...
		org.junit.assertEquals(0, prestIt1_3);
		org.junit.assertEquals(1, prestIt4_15);
	}
	...
	public void testBaseRegulatoryAndDelays() throws ExpressionException, SQLException,
		...
		.forEach(  r ->  org.junit.assertEquals(2000.00 / 30.00, ((Number) r.getValue()).doubleValue(), DELTA));
	...
	public void testATEPBaseRegulatoryAndExtraHoursI() throws ExpressionException, SQLException,
		...
		ctx.getExpressionContext().eval(ContextVariable.REGULATORY_BASE.getName(), startIT, endDate)
		.forEach (  r ->  org.junit.assertEquals(1750.00 / 30.00  + brExtraHours , ((Number) r.getValue()).doubleValue(), DELTA));
	...
	@Test
	public void testBaseRegulatoryBOEA202426917FullTime() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		
		
		Date contractStartDate = add(getToday(), Calendar.YEAR, -1 );
		...
		Date startDate = getFirstDayOfMonth(set(getToday(), Calendar.MONTH, Calendar.APRIL ));
	...
	public void testBaseRegulatoryPartial() throws ExpressionException, SQLException,
		...
		for ( int i = 1; i < 5 ; i++ ) 	 {
			...
			calculateAndSave(connection, getContractSalaryCalculatorContext(connection, date, getLastDayOfMonth(date), getLastDayOfMonth(date), contract));
		}
		...
		ctx.getExpressionContext().eval(ContextVariable.REGULATORY_BASE.getName(), startIT, endDate)
		.forEach(  r ->  org.junit.assertEquals(( 1750.00 + 1750.00 + 2000.00 ) / 90.00 * 0.75,  ((Number) r.getValue()).doubleValue(), DELTA));

	}


	@Test
	public void testBaseRegulatoryBOEA202426917Partial() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		ctx.getExpressionContext().eval(ContextVariable.REGULATORY_BASE.getName(), startIT, endDate)
		.forEach(  r ->  org.junit.assertEquals(1750.00 / 30.00 * 0.75,  ((Number) r.getValue()).doubleValue(), DELTA));

	}

	@Test
	public void testBaseRegulatoryBOEA2024269173XX() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		ContractRecord contract = newContract(aonContext, 
				...
				new HashMap<String,String>(){
				{
					put(MONTH_DAYS.getName(), "30");
					put(TC2.getName(),
							format("\"%s\"", random(new ContractCode [] {ContractCode.C300, ContractCode.C309, ContractCode.C330, ContractCode.C350, ContractCode.C389 } ).getValue()));
		...
		ctx.getExpressionContext().eval(ContextVariable.REGULATORY_BASE.getName(), startIT, endDate)
		.forEach(  r ->  org.junit.assertEquals(1750.00 / 30.00 ,  ((Number) r.getValue()).doubleValue(), DELTA));

	}

	@Test
	public void testHomeCommonDiseaseITI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startITDate = set(getFirstDayOfMonth(getToday()), DAY_OF_MONTH,10);
		Date endITDate = set(getFirstDayOfMonth(getToday()), DAY_OF_MONTH,24);
		addIT(aonContext, contract, LeaveType.COMMON_DISEASE, startITDate,
				endITDate, null);
		...
		addCCCPayment(aonContext, CCCType.HOME_EMPLOYEES, contract.getStartDate(), prestIT, PaymentType.CRA_0001,
		...
		addCCCPayment(aonContext, CCCType.HOME_EMPLOYEES, contract.getStartDate(),prestIT, PaymentType.CRA_0001,
				String.format("BASE_REGULADORA * 0.60 * %s_4_8 * (isdef %s ? %s : 1.00)",  COMMON_DISEASE_DAYS, LEAVE_FACTOR, LEAVE_FACTOR),
				String.format("BASE_REGULADORA * %s * (isdef %s ? %s : 1.00)",  QUOTE_DAYS, LEAVE_FACTOR, LEAVE_FACTOR)
				);
		addCCCPayment(aonContext, CCCType.HOME_EMPLOYEES, contract.getStartDate(),directIT, PaymentType.CRA_0001,
				String.format("DIAS_ENFERMEDAD_COMUN_9 * 0.00",  COMMON_DISEASE_DAYS),
				String.format("BASE_REGULADORA * %s * (isdef %s ? %s : 1.00)",  QUOTE_DAYS, LEAVE_FACTOR, LEAVE_FACTOR)
				);
		...
		assertEquals(4 + 3 , salary.getSalaryPayments().size());
		org.junit.assertEquals(1750.00, salary.getCommonBase(), DELTA);
		org.junit.assertEquals(1750.00 / monthDays * ( monthDays - 15) + 1750.00 / monthDays * 5 * 0.60  , salary.getTotalPayment(), DELTA);

	}

	
	@Test
	public void testHomeATEPITI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		PaymentConceptRecord directIT = addConcept(aonContext, DIRECT_PAY.getName(),PaymentType.CRA_0000);
		addCCCPayment(aonContext, CCCType.HOME_EMPLOYEES, contract.getStartDate(),directIT, PaymentType.CRA_0001,
				String.format("%s * 0.00",  OCCUPATIONAL_DISEASE_DAYS),
				String.format("BASE_REGULADORA * %s * (isdef %s ? %s : 1.00)",  QUOTE_DAYS, LEAVE_FACTOR, LEAVE_FACTOR)
				);
		...
		assertEquals(4 + 1 , salary.getSalaryPayments().size());
		org.junit.assertEquals(1750.00, salary.getCommonBase(), DELTA);
		org.junit.assertEquals(1750.00 / monthDays * ( monthDays - 15) , salary.getTotalPayment(), DELTA);

	}

	@Test
	public void testHomeMenstruationITI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		PaymentConceptRecord directIT = addConcept(aonContext, DIRECT_PAY.getName(),PaymentType.CRA_0000);
		addCCCPayment(aonContext, CCCType.HOME_EMPLOYEES, contract.getStartDate(),directIT, PaymentType.CRA_0001,
				String.format("%s * 0.00",  ContextVariable.MENSTRUATION_DAYS),
				String.format("BASE_REGULADORA * %s * (isdef %s ? %s : 1.00)",  QUOTE_DAYS, LEAVE_FACTOR, LEAVE_FACTOR)
				);
