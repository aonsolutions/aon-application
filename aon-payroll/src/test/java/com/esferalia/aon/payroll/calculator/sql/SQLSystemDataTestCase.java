...
//						put("JORNADAS_REALES","1");
		...
		assertEquals(32.74 * 1.00, salary.getCommonBase(), "BASE_CGC_MIN");
		assertEquals(32.74 * 1.00, salary.getProfessionalBase(), "BASE_CGP_MIN");

		assertEquals(salary.getSalaryData("COTIZACION_MENSUAL"), "false");
		assertEquals(salary.getSalaryData("BASE_CGC_MIN_DIA"), "32.74");
		assertEquals(salary.getSalaryData("JORNADAS_REALES"), "1");
