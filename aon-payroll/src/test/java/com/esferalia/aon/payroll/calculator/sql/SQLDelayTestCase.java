...
//					+ " (" + payment.getExpression() + ")"));
	...
	public void testMaternityITI() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(0.00  , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(0.00  , salary.getTotalPayment(), DELTA);
		org.junit.assertEquals( 3000.00 /12 * 11  , salary.getCommonBase(), DELTA);
...
//		}
//		
//		org.junit.assertEquals(3000.00/12 * 6.3 , salary.getTotalPayment(), DELTA);
...
//		addData(aonContext, contract, contract.getStartDate(), contract.getEndDate(), CGC_BASE_MIN, "35.00");
		...
		org.junit.assertEquals(0.00  , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(0.00  , salary.getTotalPayment(), DELTA);
		org.junit.assertEquals( 0.00 , salary.getCommonBase(), DELTA);
	...
	private void testERTE(ContextVariable ere, ContextVariable ereDays, ContextVariable ereFactor) throws ExpressionException, SQLException,
		...
		// 2021-07-10
		//
		org.junit.assertEquals(100.00 * 11  , salary.getCommonBase(), DELTA);
		org.junit.assertEquals(100.00 * 2 + 100.00 * 9 / 30.00 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * 2 + 100.00 * 9 / 30.00 , salary.getTotalPayment(), DELTA);
	...
	public void testERTEIII() throws ExpressionException, SQLException,
		...
		//
		org.junit.assertEquals(100.00 * 11 , salary.getCommonBase(), DELTA);
		org.junit.assertEquals(100.00 * 1 + 100.00 * 9 / 30.00 + 50.00 * 21/30 + 50.00 * 9, salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * 1 + 100.00 * 9 / 30.00 + 50.00 * 21/30 + 50.00 * 9 , salary.getTotalPayment(), DELTA);
	...
	public void testERTEIV() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(100.00 * 1 + 100.00 * 9 / 30.00 + 50 * erteDays_50 / 30.00 + 50.00 * 6, salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * 1 + 100.00 * 9 / 30.00 + 50 * erteDays_50 / 30.00 + 50.00 * 6 , salary.getTotalPayment(), DELTA);
	...
	public void testERTEV() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals( 75*12  , salary.getCommonBase(), DELTA);
		org.junit.assertEquals(75.00*6 + 75.00/2*5 + 75.00/30*9 + 75.00/2/30*21 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(75.00*6 + 75.00/2*5 + 75.00/30*9 + 75.00/2/30*21 , salary.getTotalPayment(), DELTA);
...
//		}
//		
//		org.junit.assertEquals(250.00 * 6.3 + 125.00 * 5.7  + 1750 * 0.5, salary.getTotalPayment(), DELTA);
//		
	}
...
//				);
	...
	public void testCommonDiseaseITAndGtzdos() throws ExpressionException, SQLException,
		...
		SmartContractSalaryCalculator<Salary> delayCalculator = 
				new SmartContractSalaryCalculator<Salary>(new SalaryBuilder() {
					...
					public void addPayment(Double amount, Double quote, Double tax, String description,
						...
						if ( dayOfMonth == 1 )
							org.junit.assertEquals( 8.00, (double) amount, DELTA);
						else if ( dayOfMonth == 9 )
							org.junit.assertEquals( ( 3 * 0.60 ), (double) amount,  DELTA);
						else if ( dayOfMonth == 12 )
							org.junit.assertEquals( ( 12 * 0.15  + 12 * 0.60 ), (double) amount,  DELTA);
						else if ( dayOfMonth == 22 )
							org.junit.assertEquals( ( 5 * 0.15 + 5 * 0.60 ), (double) amount,  DELTA);
						else if ( dayOfMonth == 29 )
							org.junit.assertEquals( ( 2 * 0.25 + 2 * 0.75 ), (double) amount,  DELTA);
		...
		org.junit.assertEquals(30.00, delay.getCommonBase(), DELTA);
		org.junit.assertEquals(
		 8 							// 01 - 07 
		 + 3 * 0.60 				// 08 - 10
	...
	SalaryException {
		...
		// 2021-07-10
		//
		org.junit.assertEquals(100.00   , salary.getCommonBase(), DELTA);
		org.junit.assertEquals(100.00 * 9 / 30.00 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * 9 / 30.00 , salary.getTotalPayment(), DELTA);
	...
	SalaryException {
		...
		org.junit.assertEquals(100.00 * workedDays / 30.00 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * workedDays / 30.00 , salary.getTotalPayment(), DELTA);
	...
	SalaryException {
		...
		addPayment(aonContext, 
				...
				contract.getStartDate(), 
				contract.getEndDate(), 
				"MEJORAS PREST.SS.ENFERMEDAD COM�N", 
		...
		org.junit.assertEquals(100.00 * activeDays / 30.00 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * activeDays / 30.00 , salary.getTotalPayment(), DELTA);
	...
	SalaryException {
		...
		org.junit.assertEquals(100.00 * 24 / 30.00  + 100.00 * itDays_4_15 / 30.00 * 0.60 , salary.getIrpfBase(), DELTA);
		org.junit.assertEquals(100.00 * 24 / 30.00  + 100.00 * itDays_4_15 / 30.00 * 0.60, salary.getTotalPayment(), DELTA);
...
//		}
		...
		org.junit.assertEquals(17, delay.getSalaryPayments().size());
		
		long distinct = delay.getSalaryPayments().stream().map(p -> p.getId()).distinct().count();
		org.junit.assertEquals(1, distinct);
	...
	public void testDelaysOverrideII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(10, delay.getSalaryPayments().size());
	...
	public void testDelaysOverrideWithout() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(20, delay.getSalaryPayments().size());
...
//		}
	...
	public void testDelaysOverrideITI() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(19, delay.getSalaryPayments().size());
		...
		org.junit.assertEquals(3, cgcBases.size());
		org.junit.assertEquals(getFirstDayOfMonth(overrideITStartDate), cgcBases.get(0).getStartDate());
		org.junit.assertEquals(add(overrideITStartDate, Calendar.DAY_OF_MONTH,-1), cgcBases.get(0).getEndDate());
		
		org.junit.assertEquals(overrideITStartDate, cgcBases.get(1).getStartDate());
		org.junit.assertEquals(overrideITEndDate, cgcBases.get(1).getEndDate());
		org.junit.assertEquals(0, Double.parseDouble(cgcBases.get(1).getExpression()), 0.00);

		org.junit.assertEquals(add(overrideITEndDate, Calendar.DAY_OF_MONTH,1), cgcBases.get(2).getStartDate());
		org.junit.assertEquals(getLastDayOfMonth(overrideITStartDate), cgcBases.get(2).getEndDate());
		...
		org.junit.assertEquals(PaymentType.CRA_0012.name(), delay.getSalaryData(ContextVariable.DELAY_CAUSE.getName()));

		delay.getSalaryPayments().stream().filter( p -> p.getAmount() > 0.00 ).forEach( p -> org.junit.assertEquals(PaymentType.CRA_0012, p.getType()) );
	}
	...
	public void testDelaysOverrideITII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(18, delay.getSalaryPayments().size());
		...
		org.junit.assertEquals(2, cgcBases.size());
		org.junit.assertEquals(getFirstDayOfMonth(overrideITStartDate), cgcBases.get(0).getStartDate());
		org.junit.assertEquals(overrideITEndDate, cgcBases.get(0).getEndDate());
		org.junit.assertEquals(add(overrideITEndDate, Calendar.DAY_OF_MONTH,1), cgcBases.get(1).getStartDate());
		org.junit.assertEquals(getLastDayOfMonth(overrideITStartDate), cgcBases.get(1).getEndDate());
		...
		org.junit.assertEquals(PaymentType.CRA_0008.name(), delay.getSalaryData(ContextVariable.DELAY_CAUSE.getName()));

		delay.getSalaryPayments().stream().filter( p -> p.getAmount() > 0.00 ).forEach( p -> org.junit.assertEquals(PaymentType.CRA_0008, p.getType()) );
	}
	...
	public void testDelaysOverrideITVII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(1, cgcBases.size());
	...
	public void testDelaysOverrideITVIII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(10, partialFactors.size());
	...
	public void testDelaysOverrideQuoteITI() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(overrideITStartDate, cgcBases.get(1).getStartDate());
		org.junit.assertEquals(overrideITEndDate, cgcBases.get(1).getEndDate());
		org.junit.assertEquals(0.0, Double.parseDouble(cgcBases.get(1).getExpression()), 0.00);
	...
	public void testDelaysOverrideQuoteITII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(23, delay.getSalaryPayments().size());
	...
	public void testDelaysOverrideQuoteITIII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(24, delay.getSalaryPayments().size());
		...
		org.junit.assertEquals(4, cgcBases.size());
		org.junit.assertEquals(getFirstDayOfMonth(overrideITStartDate), cgcBases.get(0).getStartDate());
		org.junit.assertEquals(add(overrideITStartDate, Calendar.DAY_OF_MONTH,-1), cgcBases.get(0).getEndDate());
		
		org.junit.assertEquals(add(overrideITEndDate, Calendar.DAY_OF_MONTH,1), cgcBases.get(3).getStartDate());
		org.junit.assertEquals(getLastDayOfMonth(overrideITStartDate), cgcBases.get(3).getEndDate());
	...
	public void testDelaysBonusI() throws ExpressionException, SQLException,
		...
		addBonus(aonContext, contract, startDate, add(startDate, Calendar.DAY_OF_MONTH,25), "10.00", "BONIFICACI�N");
	...
	public void testDelaysWithDelays() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(100.00, delay.getTotalPayment(), 0.00);
		org.junit.assertEquals(100.00, delay.getCommonBase(), 0.00);
		org.junit.assertEquals(100.00, delay.getRawCommonBase(), 0.00);
		org.junit.assertEquals(100.00, delay.getProfessionalBase(), 0.00);
		org.junit.assertEquals(100.00, delay.getIrpfBase(), 0.00);
		...
		org.junit.assertEquals(50.00, delay.getTotalPayment(), 0.00);
		org.junit.assertEquals(50.00, delay.getCommonBase(), 0.00);
		org.junit.assertEquals(50.00, delay.getRawCommonBase(), 0.00);
		org.junit.assertEquals(50.00, delay.getProfessionalBase(), 0.00);
		org.junit.assertEquals(50.00, delay.getIrpfBase(), 0.00);
	}
...
//		System.out.println("EXPECTED :" + expected);
		...
		org.junit.assertEquals(160.00 + 1.67 * 16.00, delay.getTotalPayment(), 0.05);
		org.junit.assertEquals(160.00 + 1.67 * 16.00 , delay.getCommonBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.67 * 16.00, delay.getRawCommonBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.67 * 16.00, delay.getProfessionalBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.67 * 16.00, delay.getIrpfBase(), 0.05);
		...
		delayCalculator.setSalaryBuilder(new SalaryBuilder() {
		    ...
		    public void addPayment(Double amount, Double quote, Double tax, String description,
		            java.util.Date startDate, java.util.Date endDate, IPayment payment,
		            Map<String, ITimedVariable<?>> context) {
			org.junit.assertEquals(0.00, amount, 0.00);
...
//				+ description + "] :" + amount + " (" + payment.getExpression() + ")");
		...
		org.junit.assertEquals(0.00, delay.getTotalPayment(), 0.00);
		org.junit.assertEquals(0.00, delay.getCommonBase(), 0.00);
		org.junit.assertEquals(0.00, delay.getRawCommonBase(), 0.00);
		org.junit.assertEquals(0.00, delay.getProfessionalBase(), 0.00);
		org.junit.assertEquals(0.00, delay.getIrpfBase(), 0.00);
...
//		System.out.println("EXPECTED :" + expected);
		...
		org.junit.assertEquals(160.00 + 1.66 * 16.00, delay.getTotalPayment(), 0.05);
		org.junit.assertEquals(160.00 + 1.66 * 16.00 , delay.getCommonBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.66 * 16.00, delay.getRawCommonBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.66 * 16.00, delay.getProfessionalBase(), 0.05);
		org.junit.assertEquals(160.00 + 1.66 * 16.00, delay.getIrpfBase(), 0.05);
...
//				+ description + "] :" + amount + " (" + payment.getExpression() + ")");
	...
	public void testDelaysPPEI() throws ExpressionException, SQLException,
		...
		addCost(aonContext, contract, contract.getStartDate(), null,
				"/*read-only*/ isdef BASE_PPE ? SELF.addBonus('REDUCCI�N APORTACI�N EMPRESARIAL AL PLAN DE PENSIONES DE EMPLEO','BASE_PPE * 23.6 / 100.00 '); BASE_PPE : HIDE() /**/",
				"APORTACI�N EMPRESARIAL AL PLAN DE PENSIONES DE EMPLEO", 
				"PPE_E");
		...
		delay.getSalaryDatas().stream().filter(d -> d.getName().equals(ContextVariable.DELAY_CAUSE.getName()))
				.forEach(v -> org.junit.assertEquals(v.getExpression(), "CRA_0033"));
...
//		}
		...
		org.junit.assertEquals(0.00, delay.getTotalPayment(), DELTA);
		org.junit.assertEquals(expected, delay.getCommonBase(), DELTA);
		org.junit.assertEquals(expected, delay.getProfessionalBase(), DELTA);
		org.junit.assertEquals(0.00, delay.getIrpfBase(), DELTA);
		org.junit.assertEquals(-(4.6 / 100.00 * expected ), delay.getTotalLiquid(), DELTA);
		org.junit.assertEquals(expected, delay.getTotalEnterprise(), DELTA);
		...
		org.junit.assertEquals(4.6 / 100 * expected, ppeDelays, DELTA);
	...
	public void testDelaysPPEII() throws ExpressionException, SQLException,
		...
		for (int i = 0; i < salaryHours.size(); i++) {
			...
			org.junit.assertEquals(salaryHour, delayHour, DELTA );
...
//		}	
		...
		org.junit.assertEquals(9, delay.getSalaryPayments().size());
		...
		org.junit.assertEquals(0.00, delay.getTotalPayment(), DELTA);
		org.junit.assertEquals(expected, delay.getCommonBase(), 0.5);
		org.junit.assertEquals(expected, delay.getProfessionalBase(), 0.5);
		org.junit.assertEquals(0.00, delay.getIrpfBase(), DELTA);
		org.junit.assertEquals(-(4.6 / 100.00 * expected ), delay.getTotalLiquid(), DELTA);
		org.junit.assertEquals(expected, delay.getTotalEnterprise(), 0.5);
		
		
	}

	@Test
	public void testDelaysWithDiets() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		PaymentConceptRecord dietConpcet = addConcept(aonContext, "DIETA", PaymentType.CRA_0043);
		addPayment(aonContext, contract, contract.getStartDate(), contract.getEndDate(), dietConpcet,
				"GASTOS DE MANUTENCI�N", "FRACCIONAR(100.00)", "0.00", "0.00", PaymentType.CRA_0043);
	...
	@Test
	public void testRETADelaysI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	public void testDelaysSEPEBonusI() throws ExpressionException, SQLException,
		...
		for ( int i = 0 ; i < 10 ; i++ ) {
			...
			.ifPresentOrElse(salary -> {
				...
				org.junit.assertEquals(1, bonuses.size());
				Bonus bonus = bonuses.get(0);
				org.junit.assertEquals(128.00,bonus.getAmount(), DELTA);
				salary.getContextData().get("BONF_SEPE_E").forEach(value -> {
					System.out.println("  BONF_SEPE_E : " + value.getExpression() );
				});
			}, 
			() -> org.junit.fail("No salary found for contract " + contract.getId() + " and date " + ctx.getStartDate() ) );
		}
		...
		org.junit.assertEquals(0, bonuses.size());
		bonuses.forEach(bonus -> {
			System.out.println("   Bonus -> " + bonus.getDescription() + " : " + bonus.getAmount() );
			org.junit.assertEquals(0, bonus.getAmount(), DELTA);
		});
	...
	public void testDelaysSEPEBonusII() throws ExpressionException, SQLException,
		...
		Collection<SalaryBonus> bonuses = delay.getBonus();
		org.junit.assertEquals(10, bonuses.size());
		bonuses.forEach(bonus -> {
			System.out.println("   Bonus -> " + bonus.getDescription() + " : " + bonus.getAmount() );
			org.junit.assertEquals(6.00, bonus.getAmount(), DELTA);
		});
	...
	public void testDelaysSEPEDeductionBonusI() throws ExpressionException, SQLException,
		...
		for ( int i = 0 ; i < 10 ; i++ ) {
			...
			.ifPresentOrElse(salary -> {
				...
				org.junit.assertEquals(-28.00,bonus.getAmount(), DELTA);
			}, 
			() -> org.junit.fail("No salary found for contract " + contract.getId() + " and date " + ctx.getStartDate() ) );
		}
	...
	public void testDelaysSEPEDeductionBonusII() throws ExpressionException, SQLException,
		...
		for ( int i = 0 ; i < 10 ; i++ ) {
			...
			.ifPresentOrElse(salary -> {
				...
				org.junit.assertEquals(1, bonuses.size());
				Deduction bonus = bonuses.get(0);
				org.junit.assertEquals(-17.50,bonus.getAmount(), DELTA);
			}, 
			() -> org.junit.fail("No salary found for contract " + contract.getId() + " and date " + ctx.getStartDate() ) );
		}
		...
		bonuses.forEach(bonus -> {
			System.out.println("   Bonus -> " + bonus.getDescription() + " : " + bonus.getAmount() );
			org.junit.assertEquals(-0.1, bonus.getAmount(), DELTA);
		});
	...
	@Test
	public void testNonZeroDelaysWithDelays() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//		System.out.println("EXPECTED :" + expected);
		...
		addData(aonContext, contract, getFirstDayOfMonth(getToday()), add(startDate, DAY_OF_MONTH, -1), "NUEVO_ATRASO", "false");
		...
		delayCalculator.setSalaryBuilder(new SalaryBuilder() {
		    ...
		    public void addPayment(Double amount, Double quote, Double tax, String description,
		            java.util.Date startDate, java.util.Date endDate, IPayment payment,
		            Map<String, ITimedVariable<?>> context) {
//			org.junit.assertEquals(10.00, amount, 0.00);
//			System.out.println("[" + startDate + "..." + endDate + "] :" + payment.getName() + " [ "
//				+ description + "] :" + amount + " (" + payment.getExpression() + ")");
		        super.addPayment(amount, quote, tax, description, startDate, endDate, payment, context);
		    }
...
//				+ description + "] :" + amount + " (" + payment.getExpression() + ")");
		...
		org.junit.assertEquals(10.00 + 1.67, delay.getTotalPayment(), 0.05);
		org.junit.assertEquals(10.00 + 1.67 , delay.getCommonBase(), 0.05);
		org.junit.assertEquals(10.00 + 1.67, delay.getRawCommonBase(), 0.05);
		org.junit.assertEquals(10.00 + 1.67, delay.getProfessionalBase(), 0.05);
		org.junit.assertEquals(10.00 + 1.67, delay.getIrpfBase(), 0.05);
		...
		org.junit.assertEquals(10.00 * 6 + 1.67 * 6, delay.getTotalPayment(), 0.05);
		org.junit.assertEquals(10.00 * 6 + 1.67 * 6, delay.getCommonBase(), 0.05);
		org.junit.assertEquals(10.00 * 6 + 1.67 * 6, delay.getRawCommonBase(), 0.05);
		org.junit.assertEquals(10.00 * 6 + 1.67 * 6, delay.getProfessionalBase(), 0.05);
		org.junit.assertEquals(10.00 * 6 + 1.67 * 6, delay.getIrpfBase(), 0.05);
	}
	
	
	@Test
	public void testDelaysExtraHoursI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date overrideStartDate = add(firstDayOfMonth, MONTH, 1);
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "6.66");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA_ATRASO", "16.66");
		overrideStartDate = add(firstDayOfMonth, MONTH, 3);
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "3.33");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA_ATRASO", "13.33");
		overrideStartDate = add(firstDayOfMonth, MONTH, 6);
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "12.22");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA_ATRASO", "112.22");
	...
	@Test
	public void testDelaysExtraHoursII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		addData(aonContext, contract, contract.getStartDate(), null, "IMPORTE_HORA_EXTRA", "10.00");
		
		Date overrideStartDate = add(firstDayOfMonth, MONTH, 1);
		addData(aonContext, contract, overrideStartDate, endDate, "HORAS_EXTRA_ATRASO", "IMPORTE_HORA_EXTRA * HORAS_EXTRA");

		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "6.66");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA", "16.00");
		overrideStartDate = add(firstDayOfMonth, MONTH, 3);
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "3.33");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA", "13.00");
		overrideStartDate = add(firstDayOfMonth, MONTH, 6);
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "ATRASO", "12.22");
		addData(aonContext, contract, overrideStartDate, getLastDayOfMonth(overrideStartDate), "HORAS_EXTRA", "20.00");
		...
		delayCtx.next();
		SmartContractSalaryCalculator<Salary> delayCalculator = new SmartContractSalaryCalculator<Salary>();
		delayCalculator.setSalaryBuilder(new RoundSalaryBuilder<Salary>(new SalaryBuilder() {
			@Override
			public void addPayment(Double amount, Double quote, Double tax, String description,
					java.util.Date startDate, java.util.Date endDate, IPayment payment,
					Map<String, ITimedVariable<?>> context) {
