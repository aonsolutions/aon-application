...
public class SQLCretaTestCase extends AbstractSQLTestCase {
	...
	@Test
	public void testCretaBecariosNormal()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaBecariosEREParcialI()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaBecariosITI()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//		assertTramoIT15PrimerosDias(tramo);
	...
	@Test
	public void testCretaTITTiempoParcial()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//		org.junit.Assert.assertEquals(_603, (int)(1750.00 * 0.25 / 30.00 * 100.00), DELTA);
	...
	@Test
	public void testCretaTiempoParcialAjusteMensual()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	public void testCretaTiempoParcialAjusteMensualII()
		...
		addData(aonContext, contract, startDate, add(endDate, DAY_OF_MONTH,-2), ContextVariable.PARTIAL_FACTOR, "0.25");		
	...
	public void testCretaTrabajadoresYTramosEREFZATotalAndIT()
		...
		List<net.aonsolutions.core.tgss.creta.jaxb.bases.Tramo> bases = getTramosBases(connection, startDate, endDate, ccc, contract);
...
//		addPayment(aonContext, contract, pagaExtra, "ROUND(INPUT(\"/*user*/P_0 + P_1/**/\",\"...\"),2)");
	...
	@Test
	public void testCretaEREFZATotal()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaEREFZAOFFTotal()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaEREFZAParcial()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaEREFZOFFParcial()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaMultipleAdditionalHours()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		for ( int i = 0; i < 10 ; i++ )
			addData(aonContext, 
					contract, 
					add(startDate, Calendar.DAY_OF_MONTH, i), 
					endDate, 
	...
	@Test
	public void testCretaAdditionalHoursWithPeriods()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Dato _0537 = tramosBases.get(0).getDatosTramo().
		getDato().stream().filter(d -> d.getCodigo().equals("537"))
		.findFirst().orElseThrow( () -> new AssertionFailedError("") );
		;
		Dato _1537 = tramosBases.get(1).getDatosTramo().
		getDato().stream().filter(d -> d.getCodigo().equals("537"))
		.findFirst().orElseThrow( () -> new AssertionFailedError("") );
		;
		...
		.findFirst().orElseThrow( () -> new AssertionFailedError("") );
		Dato _12 = 
		tramosBases.get(1).getDatosTramo().
		getDato().stream().filter(d -> d.getCodigo().equals("02"))
		.findFirst().orElseThrow( () -> new AssertionFailedError("") );
	...
	@Test
	public void testCretaAdditionalHoursWithOtherConcept()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaAdditionalHoursWithoutConcept()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
	...
	@Test
	public void testCretaAdditionalHoursWithoutPayment()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//		}
	...
	public void testCretaL13I()
		...
		@SuppressWarnings("serial")
		ContractRecord contract = newContract(aonContext, ccc, ContractCode.C100, "01", CCCType.PRINCIPAL, getFirstDayOfYear(getToday()), null, category);
		

		addData(aonContext, 
				contract, 
				add(endDate, Calendar.DAY_OF_MONTH,1)
				, add(endDate, Calendar.DAY_OF_MONTH, 50 )
				, new HashMap<String, String>() {
			{
	...
	@Test
	public void testCretaITMaternityWithBonusPeriod()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		org.junit.Assert.assertEquals( 175000, Integer.parseInt(bases.get(0).getDatosTramo().getDato().get(0).getValor()));
	...
	@Test
	public void testCretaITMaternityPartialI()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		AON.getSalaryData(aonContext,
				...
				.forEach(salary -> {
					...
					Assert.assertEquals(startDate, datas.get(0).getStartDate());
					Assert.assertEquals(endDate, datas.get(0).getEndDate());
					Assert.assertEquals(1750.00 * 0.50,
							Double.parseDouble(datas.get(0).getExpression()),
							DELTA);
	...
	@Test
	public void testCretaITMaternityPartialII()
			throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		addSystemData(aonContext, contract.getStartDate(), null, new HashMap<String, String>(){
			{
				...
				put("HORAS_NOMINA","MAX(1,FLOOR([\"04\":(POR_HORAS() ? HORAS_TRABAJADAS : 1050.00 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/DIAS_MES) / 6.33 * COEFICIENTE_TRABAJADO)][GRUPO_COTIZACION]))");
			}
		});
		...
		AON.getSalaryData(aonContext,
				...
				.forEach(salary -> {
					...
					Assert.assertEquals(1750.00 * 10 /30 ,
							Double.parseDouble(datas.get(0).getExpression()),
							DELTA);
		...
		//assertDato(bases.get(0).getDatosTramo().getDato(), "C", "500", 1750.00 * 10 /30 * 100.00 );		
		//assertDato(bases.get(0).getDatosTramo().getDato(), "C", "601", 1750.00 * 10 /30 * 100.00);		
		//assertDato(bases.get(0).getDatosTramo().getDato(), "C", "535", 1750.00 * 10 /30 * 100.00);		
		//assertDato(bases.get(0).getDatosTramo().getDato(), "C", "635", 1750.00 * 10 /30 * 100.00);		
...
//		}
	...
	public void testCretaDelayIT() throws ExpressionException, SQLException,
		...
		List<net.aonsolutions.core.tgss.creta.jaxb.bases.Tramo> bTramos = 
...
//		net.aonsolutions.core.tgss.creta.jaxb.bases.Tramo tramo3 = bTramos.get(3);
	...
	public void testCretaA999()
		...
		Bases.generate(connection, 
				...
				respuestaIs, 					 
				basesOs,						//os, 
				new Bases.BasesCallback [] {
					new Bases.BasesCallback() {
						public void invalidLiquidacion(net.aonsolutions.core.tgss.creta.jaxb.bases.Liquidacion liquidacion, Exception e) {
...
//				"TRACE('DIAS_TRABAJADOS=%f\r\n', DIAS_TRABAJADOS); 0.00;"
		...
		addPayment(aonContext, contract, mtnad, 
				...
				String.format("%s * (isdef COEFICIENTE_MATERNIDAD ? COEFICIENTE_MATERNIDAD : 1.00) * BASE_REGULADORA",  QUOTE_DAYS)
				);

		addPayment(aonContext, contract, mtnad, 
				String.format("0.00 * %s",  PATERNITY_DAYS),
				String.format("%s * (isdef COEFICIENTE_PATERNIDAD ? COEFICIENTE_PATERNIDAD : 1.00) * BASE_REGULADORA",  QUOTE_DAYS) //
				);
	...
	// -------------------------------------------------------------------------
	protected net.aonsolutions.core.tgss.creta.jaxb.trabajadorestramos.TrabajadoresTramos getTrabajadoresTramos ( Connection connection, ContractRecord contract, Date startDate, Date endDate, String ccc, String tipo) throws ExpressionException, SQLException, SalaryException, JAXBException, IOException {
	...
	protected List<net.aonsolutions.core.tgss.creta.jaxb.bases.Tramo> getTramosBases ( Connection connection, Date startDate, Date endDate, String ccc, ContractRecord ...contracts ) throws ExpressionException, SQLException, SalaryException, JAXBException, IOException, EmptyBasesException, XMLStreamException, FactoryConfigurationError {
