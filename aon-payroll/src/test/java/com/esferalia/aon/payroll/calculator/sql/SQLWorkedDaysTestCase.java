...
public class SQLWorkedDaysTestCase extends AbstractSQLTestCase {
		...
		ctx.getExpressionContext()
				...
				.forEach(
						context -> {
							...
							assertTrue(String.format(TC2.getName()),
									context.containsKey(TC2.getName()));
							assertTrue(String.format(PARTIAL_FACTOR
									.getName()), context
							...
							assertTrue(String.format(AGREEMENT_HOURS
									.getName()), context
	...
	public void testContextWorkDaysMinusHolidays() throws ExpressionException, SQLException {
		...
		results.forEach( result -> {
			org.junit.assertEquals(10.00, result.getValue(), 0.00);
			org.junit.assertEquals(holidaysStartDate, result.getPeriod().getStart());
			org.junit.assertEquals(holidaysEndDate, result.getPeriod().getEnd());
		});
		...
		org.junit.assertEquals(2, results.size());
		org.junit.assertEquals(startDate, results.get(0).getPeriod().getStart());
		org.junit.assertEquals(add(holidaysStartDate, Calendar.DAY_OF_MONTH, -1), results.get(0).getPeriod().getEnd());
		org.junit.assertEquals(9.00, results.get(0).getValue(), 0.00);
		
		org.junit.assertEquals(add(holidaysEndDate, Calendar.DAY_OF_MONTH, 1), results.get(1).getPeriod().getStart());
		org.junit.assertEquals(endDate, results.get(1).getPeriod().getEnd());
		
		org.junit.assertEquals(get(endDate, Calendar.DAY_OF_MONTH) - 19, results.get(1).getValue(), 0.00);
	...
	public void testContextWorkDaysMinusHolidaysMonthlyAtFebruary() throws ExpressionException, SQLException {
		...
		org.junit.assertEquals(add(holidaysEndDate, Calendar.DAY_OF_MONTH, 1), results.get(1).getPeriod().getStart());
		org.junit.assertEquals(endDate, results.get(1).getPeriod().getEnd());
		org.junit.assertEquals(30 - 19, results.get(1).getValue(), 0.00);
...
//		.eval("100.00 * DIAS_TRABAJADOS / DIAS_MES ", startDate, endDate, Double.class);
	...
	public void testContextWorkDaysMinusHolidaysWithSections() throws ExpressionException, SQLException {
		...
		results.forEach( result -> {
			org.junit.assertEquals(1.00, result.getValue(), 0.00);
			org.junit.assertEquals(holidaysStartDate, result.getPeriod().getStart());
			org.junit.assertEquals(holidaysStartDate, result.getPeriod().getEnd());
		});
	...
	public void testContextWorkDaysMinusHolidaysBR() throws ExpressionException, SQLException, SalaryException {
		...
		org.junit.assertEquals(11.00, results.get(1).getValue(), 0.00);
		
		results =
		ctx.getExpressionContext()
		.eval("DIAS_COTIZADOS", startDate, endDate, Double.class);

		org.junit.assertEquals(3, results.size());

		org.junit.assertEquals(startDate, results.get(0).getPeriod().getStart());
		org.junit.assertEquals(add(holidaysStartDate, Calendar.DAY_OF_MONTH, -1), results.get(0).getPeriod().getEnd());
		org.junit.assertEquals(9.00, results.get(0).getValue(), 0.00);
		
		org.junit.assertEquals(holidaysStartDate, results.get(1).getPeriod().getStart());
		org.junit.assertEquals(holidaysEndDate, results.get(1).getPeriod().getEnd());
		org.junit.assertEquals(10.00, results.get(1).getValue(), 0.00);

		org.junit.assertEquals(add(holidaysEndDate, Calendar.DAY_OF_MONTH, 1), results.get(2).getPeriod().getStart());
		org.junit.assertEquals(endDate, results.get(2).getPeriod().getEnd());
		org.junit.assertEquals(11.00, results.get(2).getValue(), 0.00);
		...
		org.junit.assertEquals((1000.00 * 20 / 30.00 + 25.00 * 10.00) / 30 , results.get(0).getValue(), 0.0001);
	...
	public void testContextWorkDaysMinusHolidaysIT() throws ExpressionException, SQLException, SalaryException {
		...
		org.junit.assertEquals((1000.00 * 10 / 30.00 + 25.00 * 14.00), salary.getTotalPayment(), 0.004);
	...
	public void testTotalWorkDaysI() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(r.getValue(), AonDateUtils.get(end, Calendar.DAY_OF_MONTH) * 0.25, DELTA);
	...
	public void testTotalWorkDaysII() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(AonDateUtils.get(end, Calendar.DAY_OF_MONTH) * 0.5, r.getValue(), DELTA);
	...
	public void testTotalWorkDaysIII() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(AonDateUtils.get(end, Calendar.DAY_OF_MONTH),r.getValue(),  DELTA);
	...
	public void testTotalWorkDaysIV() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(0.00, r.getValue(), DELTA);
	...
	public void testTotalWorkDaysV() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(10, r.getValue() , DELTA);
	...
	public void testTotalWorkDaysVI() throws ExpressionException, SQLException {
		...
		totalWorkedDays.forEach( r -> {
			org.junit.assertEquals(r.getPeriod().getStart(), start);
			org.junit.assertEquals(r.getPeriod().getEnd(), end);
			org.junit.assertEquals(10 +  (AonDateUtils.get(end, Calendar.DAY_OF_MONTH) -10 ) * 0.5, r.getValue() , DELTA);
