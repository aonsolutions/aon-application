...
//				DELTA);
	...
	@Test
	public void testEREITIII() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		JooqSalaryBuilder<ISalary> jooqSalaryBuilder = 
		new JooqSalaryBuilder<ISalary>(connection) {
			@Override
		...
		.forEach(s ->  {
			...
			org.junit.assertEquals(startDate, bases.get(0).getStartDate());
			org.junit.assertEquals(add(startDate,Calendar.DAY_OF_MONTH,3), bases.get(1).getStartDate());
			org.junit.assertEquals(add(startDate,Calendar.DAY_OF_MONTH,15), bases.get(2).getStartDate());
			org.junit.assertEquals(add(startDate,Calendar.DAY_OF_MONTH,20), bases.get(3).getStartDate());
			org.junit.assertEquals(endDate, bases.get(3).getEndDate());
			
		});
	}
	
	@Test
	public void testEREITIV() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		addData(aonContext, contract, startEre, null,
				new HashMap<String, String>() {
					{
						put(getFactorVariable().getName(), "0.15");
					}
				});
	...
	@Test
	public void testEREITV() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
		...
		Date startIt = add(getFirstDayOfMonth(getToday()), Calendar.DAY_OF_MONTH, 6);
		...
		assertEquals(
				...
				+ 1750.00 * 1.10 / 30 * 12 * 0.60 * 0.85
				+ 1750.00 * 1.10 / 30 * 5 * 0.60 * 0.85
				+ 1750.00 * 1.10 / 30 * (monthDays - 26) * 0.75 * 0.85
				, salary.getTotalPayment(),
				DELTA);
		...
		.forEach(s ->  {
			...
			List<ContextData> bases =  data.get(getBaseVariable().getName());
			Collections.sort(bases,  (d1,d2) -> d1.getStartDate().compareTo(d2.getStartDate()));
			org.junit.assertEquals(5, bases.size());
			org.junit.assertEquals(startDate, bases.get(0).getStartDate());
			org.junit.assertEquals(startIt, bases.get(1).getStartDate());
			org.junit.assertEquals(add(startIt,Calendar.DAY_OF_MONTH,3), bases.get(2).getStartDate());
			org.junit.assertEquals(add(startIt,Calendar.DAY_OF_MONTH,15), bases.get(3).getStartDate());
			org.junit.assertEquals(add(startIt,Calendar.DAY_OF_MONTH,20), bases.get(4).getStartDate());
			org.junit.assertEquals(endDate, bases.get(4).getEndDate());
	...
	@Test
	public void testEREITVI() throws ExpressionException, SQLException,
			SalaryException {
		Connection connection = getConnection();
		AONContext aonContext = new AONContext(connection);
...
//				+ 1750.00 * 1.10 / 30 * 5 * 0.60 * 0.85
				+ 1750.00 * 1.10 / 30 * (monthDays - 16) * 0.85
				, salary.getTotalPayment(),
				DELTA);
		...
		.forEach(s ->  {
			...
			org.junit.assertEquals(startIt, bases.get(1).getStartDate());
			org.junit.assertEquals(add(startIt,Calendar.DAY_OF_MONTH,3), bases.get(2).getStartDate());
			org.junit.assertEquals(add(endIt,Calendar.DAY_OF_MONTH,1), bases.get(3).getStartDate());
			org.junit.assertEquals(endDate, bases.get(3).getEndDate());
...
//				DELTA);
	...
	public void testERESalaryHoursI() throws ExpressionException, SQLException,
		...
		.forEach(s -> {
			...
			org.junit.assertEquals(2, salaryHours.size());
			Collections.sort(salaryHours, (d1,d2)-> d1.getStartDate().compareTo(d2.getEndDate()));
			
			org.junit.assertEquals(startDate, salaryHours.get(0).getStartDate());
			org.junit.assertEquals(add(startEre, DAY_OF_MONTH,-1), salaryHours.get(0).getEndDate());
			org.junit.assertEquals(Math.floor(1466.40/8.83 * 10 /30) , Double.parseDouble( salaryHours.get(0).getExpression()), DELTA);
			
			
			org.junit.assertEquals(startEre, salaryHours.get(1).getStartDate());
			org.junit.assertEquals(endDate, salaryHours.get(1).getEndDate());
			org.junit.assertEquals(Math.floor(1466.40/8.83 * 20 /30 /2) , Double.parseDouble( salaryHours.get(1).getExpression()), DELTA);
		});
		;
	...
	public void testERESalaryHoursII() throws ExpressionException, SQLException,
		...
		.forEach(s -> {
			...
			org.junit.assertEquals(startDate, salaryHours.get(0).getStartDate());
			org.junit.assertEquals(add(startEre, DAY_OF_MONTH,-1), salaryHours.get(0).getEndDate());
			org.junit.assertEquals(Math.floor(1466.40/8.83 * 10 /30 /2) , Double.parseDouble( salaryHours.get(0).getExpression()), DELTA);
			
			
			org.junit.assertEquals(startEre, salaryHours.get(1).getStartDate());
			org.junit.assertEquals(endDate, salaryHours.get(1).getEndDate());
			org.junit.assertEquals(Math.floor(1466.40/8.83 * 20 /30 /2 * 0.65) , Double.parseDouble( salaryHours.get(1).getExpression()), DELTA);
		});
		;
...
//					put("DIAS_MES", "30.00");
		...
		.forEach(s -> {
			...
			org.junit.assertEquals(hours, Double.parseDouble( salaryHours.get(0).getExpression()), DELTA);
			...
			org.junit.assertEquals(Math.floor(hours * 0.75) , Double.parseDouble( salaryHours.get(1).getExpression()), DELTA);
		});
		;
...
//		}
	...
	public void testEREBRMayII() throws ExpressionException, SQLException,
		...
		org.junit.assertEquals(may, salary.getStartDate());
