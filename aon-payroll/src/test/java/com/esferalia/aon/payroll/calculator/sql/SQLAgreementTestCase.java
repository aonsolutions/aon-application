...
public class SQLAgreementTestCase extends AbstractSQLTestCase {
	...
	public void testRedefinedPaymentsI() throws ExpressionException, SQLException, SalaryException {
		...
		assertEquals(String.format("%s", TOTAL_PAYMENT), 100.00, salary.getTotalPayment());
		...
		assertNotSame("DOMAIN", agreement.getDomain(), contract.getDomain());
		...
		assertEquals(String.format("%s", TOTAL_PAYMENT), 666.00, salary.getTotalPayment());
		...
		ctx.next();
		salary = new ContractSalaryCalculator<Salary>(new SalaryBuilder()).calculate(ctx);
		assertEquals(String.format("%s", TOTAL_PAYMENT), 666.00 * 2, salary.getTotalPayment());
		...
		ctx.next();
		salary = new ContractSalaryCalculator<Salary>(new SalaryBuilder()).calculate(ctx);
		assertEquals(String.format("%s", TOTAL_PAYMENT), 666.00 * 3, salary.getTotalPayment());
	}
	...
	public void testFixedAmounts() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((3330) / 2, salary.getTotalPayment(), 0.00);
	}
	...
	public void testFixedAmountsVI() throws ExpressionException, SQLException, SalaryException {
		...
		org.junit.assertEquals((3330 + 3000/6) /2 , salary.getTotalPayment(), 0.00);
	}
	...
	public void testFixedAmountsVII() throws ExpressionException, SQLException, SalaryException {
		...
		org.junit.assertEquals(3000 + 330 + 3000/6, salary.getTotalPayment(), 0.00);
...
//				"BASE_IRPF * PORCENTAJE_IRPF / 100.00" 
		...
		;
		org.junit.assertEquals((3330 * 0.75) / 2, salary.getTotalPayment(), 0.00);
		org.junit.assertEquals((3300 / 6.0 * 0.75) / 2, salary.getExtraPayProration(), 0.00);
		...
		org.junit.assertEquals(((3330 * 0.75)/2) + ((3300 / 6.0 * 0.75) / 2) , salary.getCommonBase(), 0.00);
	}
	...
	public void testFixedAmountsIX() throws ExpressionException, SQLException, SalaryException {
		...
		org.junit.assertEquals((3330 * 0.25) / 30 * 15, salary.getTotalPayment(), DELTA);
		org.junit.assertEquals((3300 / 6 * 0.25) / 30 * 15, salary.getExtraPayProration(), DELTA);

		org.junit.assertEquals(( (3330 * 0.25) + (3300 / 6 * 0.25) ) / 30 * 15, salary.getCommonBase(), DELTA);
	}
	...
	public void testFixedAmountsX() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((3330) / 2 * 0.50, salary.getTotalPayment(), 0.00);
	}
	...
	public void testFixedAmountsXI() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((3330) * 0.50, salary.getTotalPayment(), 0.00);
	}
	...
	public void testFixedAmountsXII() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((3330) / 2, salary.getTotalPayment(), 0.00);
		org.junit.assertEquals((3300) / 12, salary.getExtraPayProration(), 0.00);
	}
	...
	public void testFixedAmountsXIII() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((3330/2)*0.5, salary.getTotalPayment(), 0.00);
		org.junit.assertEquals((3300/12)*0.5, salary.getExtraPayProration(), 0.00);
	...
	public void testFixedAmountsXIV() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals(3330/2.00 + 3330/4.00 , salary.getTotalPayment(), 0.00);
		org.junit.assertEquals(3300/12.00 + 3300/24.00, salary.getExtraPayProration(), 0.00);
	}
	...
	public void testRedefinedDataI() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((4440) / 2, salary.getTotalPayment(), 0.00);
	...
	public void testRedefinedDataIII() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((5550) / 2, salary.getTotalPayment(), 0.00);
	...
	public void testRedefinedDataIV() throws ExpressionException, SQLException, SalaryException {
		...
		;
		org.junit.assertEquals((6660) / 2, salary.getTotalPayment(), 0.00);
