...
/**
 * Nominaex generated by Expand 2.0.1
 */
@Entity
@Lines(joinProperty="emprper")
@Table(name="nominaex")
public class Nominaex  implements java.io.Serializable {

     private NominaexId id;
     private int anio;
     private int mes;
     private Date fecini;
     private Date fecfin;
     ...
     private List<Nomdtoex> nomdtoexList = new ArrayList<Nomdtoex>(0);

    public Nominaex() {
    }
	
    public Nominaex(NominaexId id, int anio, int mes, Date fecini, Date fecfin, BigDecimal importe, String fijovar, BigDecimal irpf, BigDecimal impirpf, BigDecimal liquido, BigDecimal totalDeducir) {
        this.id = id;
        this.anio = anio;
        this.mes = mes;
        this.fecini = fecini;
    ...
    public Nominaex(NominaexId id, int anio, int mes, Date fecini, Date fecfin, BigDecimal importe, String fijovar, BigDecimal irpf, BigDecimal impirpf, BigDecimal liquido, Date fecnew, Date hornew, Date fecmod, Date hormod, Date feccob, String descom, Date feccobreal, Date fecemi, String nomemp, String nomper, String direccion, String localidad, String descat, String profesion, Integer nummat, Date fecant, BigDecimal totalDeducir, Complemento complemento, Divisa divisa, Emprper emprper, List<Nomdtoex> nomdtoexList) {
       this.id = id;
       this.anio = anio;
       this.mes = mes;
       this.fecini = fecini;
       ...
       this.nomdtoexList = nomdtoexList;
    }
    ...
    public NominaexId getId() {
        return this.id;
    }
    
    public void setId(NominaexId id) {
        this.id = id;
    }
	...
	@OneToMany(cascade=CascadeType.ALL, fetch=FetchType.LAZY, mappedBy="nominaex")
    public List<Nomdtoex> getNomdtoexList() {
        return this.nomdtoexList;
    }
    
    public void setNomdtoexList(List<Nomdtoex> nomdtoexList) {
        this.nomdtoexList = nomdtoexList;
    }
