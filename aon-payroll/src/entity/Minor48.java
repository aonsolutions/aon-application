...
/**
 * Minor48 generated by Expand 2.0.1
 */
@Entity
@Table(name="minor_48")
public class Minor48  implements java.io.Serializable {

     private Minor48Id id;
     private Date fecfin;
    ...
    public Minor48(Minor48Id id, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minAyuda, BigDecimal minGranminus) {
        this.id = id;
    ...
    public Minor48(Minor48Id id, Date fecfin, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minAyuda, BigDecimal minGranminus) {
       this.id = id;
       this.fecfin = fecfin;
       this.desdeImporte = desdeImporte;
       this.hastaImporte = hastaImporte;
    ...
    public Minor48Id getId() {
        return this.id;
    }
    
    public void setId(Minor48Id id) {
        this.id = id;
    }
