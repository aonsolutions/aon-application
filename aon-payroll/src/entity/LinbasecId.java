 ...
 */
@Embeddable
public class LinbasecId  implements java.io.Serializable {
    ...
    public LinbasecId(String cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LinbasecId) ) return false;
		 LinbasecId castOther = ( LinbasecId ) other; 
