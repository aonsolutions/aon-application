...
/**
 * ParteitnuId generated by Expand 2.0.1
 */
@Embeddable
public class ParteitnuId  implements java.io.Serializable {
    ...
    public ParteitnuId(int cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ParteitnuId) ) return false;
		 ParteitnuId castOther = ( ParteitnuId ) other; 
