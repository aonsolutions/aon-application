...
/**
 * Cuota20 generated by Expand 2.0.1
 */
@Entity
@Table(name="cuota_20")
public class Cuota20  implements java.io.Serializable {

     private Cuota20Id id;
     private Date fecfin;
    ...
    public Cuota20(Cuota20Id id, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal h0, BigDecimal h1, BigDecimal h2, BigDecimal h3, BigDecimal h4, BigDecimal h5, BigDecimal h6) {
        this.id = id;
    ...
    public Cuota20(Cuota20Id id, Date fecfin, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal h0, BigDecimal h1, BigDecimal h2, BigDecimal h3, BigDecimal h4, BigDecimal h5, BigDecimal h6) {
       this.id = id;
       this.fecfin = fecfin;
       this.desdeImporte = desdeImporte;
       this.hastaImporte = hastaImporte;
    ...
    public Cuota20Id getId() {
        return this.id;
    }
    
    public void setId(Cuota20Id id) {
        this.id = id;
    }
