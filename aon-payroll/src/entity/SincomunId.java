...
/**
 * SincomunId generated by Expand 2.0.1
 */
@Embeddable
public class SincomunId  implements java.io.Serializable {
    ...
    public SincomunId(int cdg, Date fecha) {
       this.cdg = cdg;
       this.fecha = fecha;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SincomunId) ) return false;
		 SincomunId castOther = ( SincomunId ) other; 
