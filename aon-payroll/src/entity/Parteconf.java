 ...
 */
@Entity
@Lines(joinProperty="parteit")
@Table(name="parteconf")
public class Parteconf  implements java.io.Serializable {
    ...
    public Parteconf(ParteconfId id, Date fecconf, String parproc) {
        this.id = id;
        this.fecconf = fecconf;
        this.parproc = parproc;
    }

    public Parteconf(ParteconfId id, String numcol, String cias, Date fecconf, String parproc, Parteit parteit) {
       this.id = id;
       this.numcol = numcol;
       this.cias = cias;
       this.fecconf = fecconf;
