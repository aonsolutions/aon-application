...
/**
 * LinelemId generated by Expand 2.0.1
 */
@Embeddable
public class LinelemId  implements java.io.Serializable {
    ...
    public LinelemId(String cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LinelemId) ) return false;
		 LinelemId castOther = ( LinelemId ) other; 
