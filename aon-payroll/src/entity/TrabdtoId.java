...
/**
 * TrabdtoId generated by Expand 2.0.1
 */
@Embeddable
public class TrabdtoId  implements java.io.Serializable {
    ...
    public TrabdtoId(int cdg, int orden) {
       this.cdg = cdg;
       this.orden = orden;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TrabdtoId) ) return false;
		 TrabdtoId castOther = ( TrabdtoId ) other; 
