...
/**
 * LinprestacionId generated by Expand 2.0.1
 */
@Embeddable
public class LinprestacionId  implements java.io.Serializable {

     private int cdg;
     private Date fecini;

    public LinprestacionId() {
    }

    public LinprestacionId(int cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }


	@DataDefinition(label="Código de Domicilio")
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LinprestacionId) ) return false;
		 LinprestacionId castOther = ( LinprestacionId ) other; 
