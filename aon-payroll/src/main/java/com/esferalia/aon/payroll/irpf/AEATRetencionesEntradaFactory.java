...
import net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenedorEntrada2025;
...
public class AEATRetencionesEntradaFactory {
	...
	public static AEATRetencionesEntrada2024 create2024(
		IIrpfCalculatorContext ctx) throws SQLException,
		ExpressionException {

        	AEATRetencionesEntrada2024 entrada2024 = new AEATRetencionesEntrada2024();
        
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenciones tipoRetenciones = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenciones();
        	tipoRetenciones.setEjercicio(2024);
        	tipoRetenciones.setCodModelo("RET");
        	entrada2024.setIdDoc(tipoRetenciones);
        
        	List<TipoRetenedorEntrada2024> retenedores = entrada2024.getRetenedor();
        	TipoRetenedorEntrada2024 retenedor = new TipoRetenedorEntrada2024();
        
        	retenedor.setNif(ctx.getRetenedorNif());
        	retenedor.setApellidosNombre(ctx.getRetenedorApellidosNombre());
        	retenedores.add(retenedor);
        
        	List<TipoRetenidoEntrada2024> retenidos = retenedor.getRetenido();
        	TipoRetenidoEntrada2024 retenido = newTipoRetenidoEntrada2024(ctx);
        	retenidos.add(retenido);
        
        	return entrada2024;
        }

	public static AEATRetencionesEntrada2025 create2025(
			IIrpfCalculatorContext ctx) throws SQLException,
			ExpressionException {

	        	AEATRetencionesEntrada2025 entrada2025 = new AEATRetencionesEntrada2025();
	        
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenciones tipoRetenciones = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenciones();
	        	tipoRetenciones.setEjercicio(2025);
	        	tipoRetenciones.setCodModelo("RET");
	        	entrada2025.setIdDoc(tipoRetenciones);
	        
	        	List<TipoRetenedorEntrada2025> retenedores = entrada2025.getRetenedor();
	        	TipoRetenedorEntrada2025 retenedor = new TipoRetenedorEntrada2025();
	        
	        	retenedor.setNif(ctx.getRetenedorNif());
	        	retenedor.setApellidosNombre(ctx.getRetenedorApellidosNombre());
	        	retenedores.add(retenedor);
	        
	        	List<TipoRetenidoEntrada2025> retenidos = retenedor.getRetenido();
	        	TipoRetenidoEntrada2025 retenido = newTipoRetenidoEntrada2025(ctx);
	        	retenidos.add(retenido);
	        
	        	return entrada2025;
	        }

	public static AEATRetencionesEntrada2026 create2026(
			IIrpfCalculatorContext ctx) throws SQLException,
			ExpressionException {

	        	AEATRetencionesEntrada2026 entrada2026 = new AEATRetencionesEntrada2026();
	        
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenciones tipoRetenciones = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenciones();
	        	tipoRetenciones.setEjercicio(2026);
	        	tipoRetenciones.setCodModelo("RET");
	        	entrada2026.setIdDoc(tipoRetenciones);
	        
	        	List<TipoRetenedorEntrada2026> retenedores = entrada2026.getRetenedor();
	        	TipoRetenedorEntrada2026 retenedor = new TipoRetenedorEntrada2026();
	        
	        	retenedor.setNif(ctx.getRetenedorNif());
	        	retenedor.setApellidosNombre(ctx.getRetenedorApellidosNombre());
	        	retenedores.add(retenedor);
	        
	        	List<TipoRetenidoEntrada2026> retenidos = retenedor.getRetenido();
	        	TipoRetenidoEntrada2026 retenido = newTipoRetenidoEntrada2026(ctx);
	        	retenidos.add(retenido);
	...
	private static TipoRetenidoEntrada2024 newTipoRetenidoEntrada2024(
		IIrpfCalculatorContext ctx) {

        	TipoRetenidoEntrada2024 retenido = new TipoRetenidoEntrada2024();
        	// ------------------------------------ Datos personales
        
        	retenido.setNif(ctx.getNif());
        	retenido.setApellidosNombre(ctx.getApellidosNombre());
        	retenido.setNacimiento(getAñoNacimiento(ctx, 2024));
        
        	if (ctx.getResidenciaCeutaMelilla()) {
        
        		retenido.setResidenciaCeutaMelilla(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.ResidenciaCeutaMelilla());
        	}
        	retenido.setDiscapacidad(getAeat15Discapacidad2024(ctx.getDiscapacidad(),
        			ctx.getMovilidadReducida()));
        	retenido.setSituacionFamiliar(getAeat15Situacionfamiliar2024(
        			ctx.getSituacionFamiliar(), ctx.getNifConyuge()));
        	retenido.setSituacionLaboral(getAeat15SituacionLaboral2024(
        			ctx.getSituacionLaboral(), ctx.getContrato(),
        			ctx.getMovilidadGeografica(), ctx.getProlongacionLaboral()));
        	// --------------------------------------- Descendientes
        	List<net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Descendiente> descendientes = retenido.getDescendiente();
        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente descendiente : ctx
        			.getDescendientes()) {
        		descendientes.add(getAeat15Descendiente2024(descendiente));
        	}
        	// ---------------------------------------- Ascendientes
        	List<net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Ascendiente> ascendientes = retenido.getAscendiente();
        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente ascendiente : ctx
        			.getAscendientes()) {
        		ascendientes.add(getAeat15Ascendiente2024(ascendiente));
        	}
        	...
        	BigDecimal irregularidad2 = ctx.getIrregularidad2();
        	if (irregularidad1 != null || irregularidad2 != null) {
        		net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Reducciones reducciones = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Reducciones();
        		reducciones.setIrregularidad1(irregularidad1);
        		reducciones.setIrregularidad2(irregularidad2);
        		retenido.setReducciones(reducciones);
        	}
        	...
        	if (ctx.getRdtosObtenidosCeutaMelilla())
        		retenido.setRdtosObtenidosCeutaMelilla(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.RdtosObtenidosCeutaMelilla());
        	retenido.setPensionCompensatoria(ctx.getPensionCompensatoria());
        	retenido.setAnualidadesHijos(ctx.getAnualidadesHijos());
        	if (ctx.getPagoPrestamosVivienda())
        		retenido.setPagoPrestamosVivienda(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.PagoPrestamosVivienda());
        
        	// -------------------------------------- Regularización
        	CausaRegularizacion causaRegularizacion = ctx.getCausaRegularizacion();
        	if (causaRegularizacion != null) {
        		net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Regularizacion regularizacion = 
        				new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Regularizacion();
        		List<Integer> causas = regularizacion.getCausa();
        		causas.add(causaRegularizacion.getValue());
        		...
        		if (ctx.getResidenciaInicialCeutaMelilla())
        			regularizacion
        					.setResidenciaInicialCeutaMelilla(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Regularizacion.ResidenciaInicialCeutaMelilla());
        		regularizacion.setBaseRetencion(ctx.getBaseRetencion());
        		regularizacion.setMinimoPersonalFamiliarInicial(ctx
        				.getMinimoPersonalFamiliarInicial());
        		regularizacion.setTipoRetencion(ctx.getTipoRetencion());
	...
	private static TipoRetenidoEntrada2025 newTipoRetenidoEntrada2025(
			IIrpfCalculatorContext ctx) {

	        	TipoRetenidoEntrada2025 retenido = new TipoRetenidoEntrada2025();
	        	// ------------------------------------ Datos personales
	        
	        	retenido.setNif(ctx.getNif());
	        	retenido.setApellidosNombre(ctx.getApellidosNombre());
	        	retenido.setNacimiento(getAñoNacimiento(ctx, 2025));
	        
	        	if (ctx.getResidenciaCeutaMelilla()) {
	        
	        		retenido.setResidenciaCeutaMelilla(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.ResidenciaCeutaMelilla());
	        	}
	        	retenido.setDiscapacidad(getAeat15Discapacidad2025(ctx.getDiscapacidad(),
	        			ctx.getMovilidadReducida()));
	        	retenido.setSituacionFamiliar(getAeat15Situacionfamiliar2025(
	        			ctx.getSituacionFamiliar(), ctx.getNifConyuge()));
	        	retenido.setSituacionLaboral(getAeat15SituacionLaboral2025(
	        			ctx.getSituacionLaboral(), ctx.getContrato(),
	        			ctx.getMovilidadGeografica(), ctx.getProlongacionLaboral()));
	        	// --------------------------------------- Descendientes
	        	List<net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Descendiente> descendientes = retenido.getDescendiente();
	        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente descendiente : ctx
	        			.getDescendientes()) {
	        		descendientes.add(getAeat15Descendiente2025(descendiente));
	        	}
	        	// ---------------------------------------- Ascendientes
	        	List<net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Ascendiente> ascendientes = retenido.getAscendiente();
	        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente ascendiente : ctx
	        			.getAscendientes()) {
	        		ascendientes.add(getAeat15Ascendiente2025(ascendiente));
	        	}
	        	...
	        	BigDecimal irregularidad2 = ctx.getIrregularidad2();
	        	if (irregularidad1 != null || irregularidad2 != null) {
	        		net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Reducciones reducciones = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Reducciones();
	        		reducciones.setIrregularidad1(irregularidad1);
	        		reducciones.setIrregularidad2(irregularidad2);
	        		retenido.setReducciones(reducciones);
	        	}
	        	...
	        	if (ctx.getRdtosObtenidosCeutaMelilla())
	        		retenido.setRdtosObtenidosCeutaMelilla(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.RdtosObtenidosCeutaMelilla());
	        	retenido.setPensionCompensatoria(ctx.getPensionCompensatoria());
	        	retenido.setAnualidadesHijos(ctx.getAnualidadesHijos());
	        	if (ctx.getPagoPrestamosVivienda())
	        		retenido.setPagoPrestamosVivienda(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.PagoPrestamosVivienda());
	        
	        	// -------------------------------------- Regularización
	        	CausaRegularizacion causaRegularizacion = ctx.getCausaRegularizacion();
	        	if (causaRegularizacion != null) {
	        		net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Regularizacion regularizacion = 
	        				new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Regularizacion();
	        		List<Integer> causas = regularizacion.getCausa();
	        		causas.add(causaRegularizacion.getValue());
	        		...
	        		if (ctx.getResidenciaInicialCeutaMelilla())
	        			regularizacion
	        					.setResidenciaInicialCeutaMelilla(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Regularizacion.ResidenciaInicialCeutaMelilla());
	        		regularizacion.setBaseRetencion(ctx.getBaseRetencion());
	        		regularizacion.setMinimoPersonalFamiliarInicial(ctx
	        				.getMinimoPersonalFamiliarInicial());
	        		regularizacion.setTipoRetencion(ctx.getTipoRetencion());
	...
	private static TipoRetenidoEntrada2026 newTipoRetenidoEntrada2026(
			IIrpfCalculatorContext ctx) {

	        	TipoRetenidoEntrada2026 retenido = new TipoRetenidoEntrada2026();
	        	// ------------------------------------ Datos personales
	        	...
	        	if (ctx.getResidenciaCeutaMelilla()) {
	        		...
	        		retenido.setResidenciaCeutaMelilla(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.ResidenciaCeutaMelilla());
	        	}
	        	retenido.setDiscapacidad(getAeat15Discapacidad2026(ctx.getDiscapacidad(),
	        			ctx.getMovilidadReducida()));
	        	retenido.setSituacionFamiliar(getAeat15Situacionfamiliar2026(
	        			ctx.getSituacionFamiliar(), ctx.getNifConyuge()));
	        	retenido.setSituacionLaboral(getAeat15SituacionLaboral2026(
	        			ctx.getSituacionLaboral(), ctx.getContrato(),
	        			ctx.getMovilidadGeografica(), ctx.getProlongacionLaboral()));
	        	// --------------------------------------- Descendientes
	        	List<net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Descendiente> descendientes = retenido.getDescendiente();
	        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente descendiente : ctx
	        			.getDescendientes()) {
	        		descendientes.add(getAeat15Descendiente2026(descendiente));
	        	}
	        	// ---------------------------------------- Ascendientes
	        	List<net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Ascendiente> ascendientes = retenido.getAscendiente();
	        	for (com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente ascendiente : ctx
	        			.getAscendientes()) {
	        		ascendientes.add(getAeat15Ascendiente2026(ascendiente));
	        	}
	        	...
	        	BigDecimal irregularidad2 = ctx.getIrregularidad2();
	        	if (irregularidad1 != null || irregularidad2 != null) {
	        		net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Reducciones reducciones = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Reducciones();
	        		reducciones.setIrregularidad1(irregularidad1);
	        		reducciones.setIrregularidad2(irregularidad2);
	        		retenido.setReducciones(reducciones);
	        	}
	        	...
	        	if (ctx.getRdtosObtenidosCeutaMelilla())
	        		retenido.setRdtosObtenidosCeutaMelilla(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.RdtosObtenidosCeutaMelilla());
	        	retenido.setPensionCompensatoria(ctx.getPensionCompensatoria());
	        	retenido.setAnualidadesHijos(ctx.getAnualidadesHijos());
	        	if (ctx.getPagoPrestamosVivienda())
	        		retenido.setPagoPrestamosVivienda(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.PagoPrestamosVivienda());
	        
	        	// -------------------------------------- Regularización
	        	CausaRegularizacion causaRegularizacion = ctx.getCausaRegularizacion();
	        	if (causaRegularizacion != null) {
	        		net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Regularizacion regularizacion = 
	        				new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Regularizacion();
	        		List<Integer> causas = regularizacion.getCausa();
	        		causas.add(causaRegularizacion.getValue());
	        		...
	        		if (ctx.getResidenciaInicialCeutaMelilla())
	        			regularizacion
	        					.setResidenciaInicialCeutaMelilla(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Regularizacion.ResidenciaInicialCeutaMelilla());
	        		regularizacion.setBaseRetencion(ctx.getBaseRetencion());
	        		regularizacion.setMinimoPersonalFamiliarInicial(ctx
	        				.getMinimoPersonalFamiliarInicial());
	        		regularizacion.setTipoRetencion(ctx.getTipoRetencion());
	...
	private static net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad getAeat15Discapacidad2024(
		Discapacidad discapacidad, boolean movilidadReducida) {
        	if (discapacidad == Discapacidad.GRADO0)
        		return null;
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad tipoDiscapacidad = new net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad();
        	if (discapacidad == Discapacidad.GRADO1) {
        		net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad.Grado1 grado1 = new net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad.Grado1();
        		if (movilidadReducida) {
        			grado1.setMovilidadReducida(new net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad.Grado1.MovilidadReducida());
        		}
        		tipoDiscapacidad.setGrado1(grado1);
        	} else if (discapacidad == Discapacidad.GRADO2) {
        		tipoDiscapacidad.setGrado2(new net.aonsolutions.core.aeat.v2024.jaxb.TipoDiscapacidad.Grado2());
        	}
        	return tipoDiscapacidad;
	}

	private static net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad getAeat15Discapacidad2025(
			Discapacidad discapacidad, boolean movilidadReducida) {
	        	if (discapacidad == Discapacidad.GRADO0)
	        		return null;
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad tipoDiscapacidad = new net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad();
	        	if (discapacidad == Discapacidad.GRADO1) {
	        		net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad.Grado1 grado1 = new net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad.Grado1();
	        		if (movilidadReducida) {
	        			grado1.setMovilidadReducida(new net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad.Grado1.MovilidadReducida());
	        		}
	        		tipoDiscapacidad.setGrado1(grado1);
	        	} else if (discapacidad == Discapacidad.GRADO2) {
	        		tipoDiscapacidad.setGrado2(new net.aonsolutions.core.aeat.v2025.jaxb.TipoDiscapacidad.Grado2());
	        	}
	        	return tipoDiscapacidad;
		}

	private static net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad getAeat15Discapacidad2026(
			Discapacidad discapacidad, boolean movilidadReducida) {
	        	if (discapacidad == Discapacidad.GRADO0)
	        		return null;
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad tipoDiscapacidad = new net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad();
	        	if (discapacidad == Discapacidad.GRADO1) {
	        		net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad.Grado1 grado1 = new net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad.Grado1();
	        		if (movilidadReducida) {
	        			grado1.setMovilidadReducida(new net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad.Grado1.MovilidadReducida());
	        		}
	        		tipoDiscapacidad.setGrado1(grado1);
	        	} else if (discapacidad == Discapacidad.GRADO2) {
	        		tipoDiscapacidad.setGrado2(new net.aonsolutions.core.aeat.v2026.jaxb.TipoDiscapacidad.Grado2());
	        	}
	        	return tipoDiscapacidad;
		}
	...
	private static net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar getAeat15Situacionfamiliar2024(
		SituacionFamiliar _situacionFamiliar, String nifConyuge) {
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar situacionFamiliar = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar();
        	if (SituacionFamiliar.UNO == _situacionFamiliar) {
        		situacionFamiliar.setSituacion1(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar.Situacion1());
        	} else if (SituacionFamiliar.DOS == _situacionFamiliar) {
        		net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar.Situacion2 situacion2 = 
        				new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar.Situacion2();
        		situacion2.setNifConyuge(nifConyuge);
        		situacionFamiliar.setSituacion2(situacion2);
        	} else {
        		situacionFamiliar.setSituacion3(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionFamiliar.Situacion3());
        	}
        	return situacionFamiliar;
	}

	private static net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar getAeat15Situacionfamiliar2025(
			SituacionFamiliar _situacionFamiliar, String nifConyuge) {
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar situacionFamiliar = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar();
	        	if (SituacionFamiliar.UNO == _situacionFamiliar) {
	        		situacionFamiliar.setSituacion1(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar.Situacion1());
	        	} else if (SituacionFamiliar.DOS == _situacionFamiliar) {
	        		net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar.Situacion2 situacion2 = 
	        				new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar.Situacion2();
	        		situacion2.setNifConyuge(nifConyuge);
	        		situacionFamiliar.setSituacion2(situacion2);
	        	} else {
	        		situacionFamiliar.setSituacion3(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionFamiliar.Situacion3());
	        	}
	        	return situacionFamiliar;
		}

	private static net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar getAeat15Situacionfamiliar2026(
			SituacionFamiliar _situacionFamiliar, String nifConyuge) {
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar situacionFamiliar = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar();
	        	if (SituacionFamiliar.UNO == _situacionFamiliar) {
	        		situacionFamiliar.setSituacion1(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar.Situacion1());
	        	} else if (SituacionFamiliar.DOS == _situacionFamiliar) {
	        		net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar.Situacion2 situacion2 = 
	        				new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar.Situacion2();
	        		situacion2.setNifConyuge(nifConyuge);
	        		situacionFamiliar.setSituacion2(situacion2);
	        	} else {
	        		situacionFamiliar.setSituacion3(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionFamiliar.Situacion3());
	        	}
	        	return situacionFamiliar;
		}
	...
	private static net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Descendiente getAeat15Descendiente2024(
		com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente _descendiente) {
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Descendiente descendiente = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Descendiente();
        	descendiente.setNacimiento(_descendiente.getAñoNacimiento());
        	descendiente.setAdopcion(_descendiente.getAñoAdopcion());
        	descendiente.setDiscapacidad(getAeat15Discapacidad2024(
        			_descendiente.getDiscapacidad(),
        			_descendiente.getMovilidadReducida()));
        	if (_descendiente.getComputadoEntero())
        		descendiente.setComputadoEntero(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Descendiente.ComputadoEntero());
        	return descendiente;
	}

	private static net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Descendiente getAeat15Descendiente2025(
			com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente _descendiente) {
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Descendiente descendiente = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Descendiente();
	        	descendiente.setNacimiento(_descendiente.getAñoNacimiento());
	        	descendiente.setAdopcion(_descendiente.getAñoAdopcion());
	        	descendiente.setDiscapacidad(getAeat15Discapacidad2025(
	        			_descendiente.getDiscapacidad(),
	        			_descendiente.getMovilidadReducida()));
	        	if (_descendiente.getComputadoEntero())
	        		descendiente.setComputadoEntero(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Descendiente.ComputadoEntero());
	        	return descendiente;
		}

	private static net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Descendiente getAeat15Descendiente2026(
			com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Descendiente _descendiente) {
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Descendiente descendiente = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Descendiente();
	        	descendiente.setNacimiento(_descendiente.getAñoNacimiento());
	        	descendiente.setAdopcion(_descendiente.getAñoAdopcion());
	        	descendiente.setDiscapacidad(getAeat15Discapacidad2026(
	        			_descendiente.getDiscapacidad(),
	        			_descendiente.getMovilidadReducida()));
	        	if (_descendiente.getComputadoEntero())
	        		descendiente.setComputadoEntero(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Descendiente.ComputadoEntero());
	        	return descendiente;
		}
	...
	private static net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Ascendiente getAeat15Ascendiente2024(
		com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente _ascendiente) {
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Ascendiente ascendiente = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.Ascendiente();
        	ascendiente.setNacimiento(_ascendiente.getAñoNacimiento());
        	ascendiente.setDiscapacidad(getAeat15Discapacidad2024(
        			_ascendiente.getDiscapacidad(),
        			_ascendiente.getMovilidadReducida()));
        	Convivencia convivencia = _ascendiente.getConvivecia();
        	if (convivencia == null) {
	...
	private static net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Ascendiente getAeat15Ascendiente2025(
			com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente _ascendiente) {
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Ascendiente ascendiente = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.Ascendiente();
	        	ascendiente.setNacimiento(_ascendiente.getAñoNacimiento());
	        	ascendiente.setDiscapacidad(getAeat15Discapacidad2025(
	        			_ascendiente.getDiscapacidad(),
	        			_ascendiente.getMovilidadReducida()));
	        	Convivencia convivencia = _ascendiente.getConvivecia();
	        	if (convivencia == null) {
	...
	private static net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Ascendiente getAeat15Ascendiente2026(
			com.esferalia.aon.payroll.irpf.IIrpfCalculatorContext.Ascendiente _ascendiente) {
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Ascendiente ascendiente = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.Ascendiente();
	        	ascendiente.setNacimiento(_ascendiente.getAñoNacimiento());
	        	ascendiente.setDiscapacidad(getAeat15Discapacidad2026(
	        			_ascendiente.getDiscapacidad(),
	        			_ascendiente.getMovilidadReducida()));
	        	Convivencia convivencia = _ascendiente.getConvivecia();
	        	if (convivencia == null) {
	...
	private static net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral getAeat15SituacionLaboral2024(
		SituacionLaboral _situacionLaboral, Contrato contrato,
		boolean movilidadGeografica, boolean prolongacionLaboral) {
        	net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral situacionLaboral = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral();
        	if (SituacionLaboral.DESEMPLEADO == _situacionLaboral) {
        		situacionLaboral.setDesempleado(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.Desempleado());
        	} else if (SituacionLaboral.PENSIONISTA == _situacionLaboral) {
        		situacionLaboral.setPensionista(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.Pensionista());
        	} else if (SituacionLaboral.TRABAJADOR_ACTIVO == _situacionLaboral) {
        		net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.TrabajadorActivo trabajadorActivo = new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.TrabajadorActivo();
        		if (contrato == null)
        			contrato = Contrato.UNO;
        		trabajadorActivo.setContrato(contrato.getValue());
        		if (movilidadGeografica)
        			trabajadorActivo
        					.setMovilidadGeografica(new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.TrabajadorActivo.MovilidadGeografica());
        		
        		situacionLaboral.setTrabajadorActivo(trabajadorActivo);
        	} else {
        		situacionLaboral.setOtraSituacion( new net.aonsolutions.core.aeat.v2024.jaxb.TipoRetenidoEntrada2024.SituacionLaboral.OtraSituacion());
        	}
        	return situacionLaboral;
        }

	private static net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral getAeat15SituacionLaboral2025(
			SituacionLaboral _situacionLaboral, Contrato contrato,
			boolean movilidadGeografica, boolean prolongacionLaboral) {
	        	net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral situacionLaboral = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral();
	        	if (SituacionLaboral.DESEMPLEADO == _situacionLaboral) {
	        		situacionLaboral.setDesempleado(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.Desempleado());
	        	} else if (SituacionLaboral.PENSIONISTA == _situacionLaboral) {
	        		situacionLaboral.setPensionista(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.Pensionista());
	        	} else if (SituacionLaboral.TRABAJADOR_ACTIVO == _situacionLaboral) {
	        		net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.TrabajadorActivo trabajadorActivo = new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.TrabajadorActivo();
	        		if (contrato == null)
	        			contrato = Contrato.UNO;
	        		trabajadorActivo.setContrato(contrato.getValue());
	        		if (movilidadGeografica)
	        			trabajadorActivo
	        					.setMovilidadGeografica(new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.TrabajadorActivo.MovilidadGeografica());
	        		
	        		situacionLaboral.setTrabajadorActivo(trabajadorActivo);
	        	} else {
	        		situacionLaboral.setOtraSituacion( new net.aonsolutions.core.aeat.v2025.jaxb.TipoRetenidoEntrada2025.SituacionLaboral.OtraSituacion());
	        	}
	        	return situacionLaboral;
	        }

	private static net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral getAeat15SituacionLaboral2026(
			SituacionLaboral _situacionLaboral, Contrato contrato,
			boolean movilidadGeografica, boolean prolongacionLaboral) {
	        	net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral situacionLaboral = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral();
	        	if (SituacionLaboral.DESEMPLEADO == _situacionLaboral) {
	        		situacionLaboral.setDesempleado(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.Desempleado());
	        	} else if (SituacionLaboral.PENSIONISTA == _situacionLaboral) {
	        		situacionLaboral.setPensionista(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.Pensionista());
	        	} else if (SituacionLaboral.TRABAJADOR_ACTIVO == _situacionLaboral) {
	        		net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.TrabajadorActivo trabajadorActivo = new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.TrabajadorActivo();
	        		if (contrato == null)
	        			contrato = Contrato.UNO;
	        		trabajadorActivo.setContrato(contrato.getValue());
	        		if (movilidadGeografica)
	        			trabajadorActivo
	        					.setMovilidadGeografica(new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.TrabajadorActivo.MovilidadGeografica());
	        		
	        		situacionLaboral.setTrabajadorActivo(trabajadorActivo);
	        	} else {
	        		situacionLaboral.setOtraSituacion( new net.aonsolutions.core.aeat.v2026.jaxb.TipoRetenidoEntrada2026.SituacionLaboral.OtraSituacion());
	        	}
	        	return situacionLaboral;
	        }
