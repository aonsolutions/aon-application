...
/** 
 * Enumeration for represent SOCIAL SECURITY T1 table codes.
...
public enum T1 implements IPayrollTablesEnum {
	...
	T1( String code, String description, String startDate, String endDate ) {
		this.code = code;
	...
	public static T1 getEnumByValue(String expression) {
		for( T1 o : T1.values() ) {
