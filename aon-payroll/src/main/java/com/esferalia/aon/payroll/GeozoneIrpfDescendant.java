...
public class GeozoneIrpfDescendant implements ITransferObject {
	
	private static final long serialVersionUID = -7085041063539004017L;
    ...
    @ForeignKey(name = "FK_GEOZONE_IRPF_DESCENDANT_GEOZONE_IRPF")
    @Index(name = "IDX_GEOZONE_IRPF_DESCENDANT_GEOZONE_IRPF")
	...
	public boolean equals(Object obj) {
		...
		final GeozoneIrpfDescendant o =  (GeozoneIrpfDescendant) obj;
		if (o.getId() == null && getId() == null) {
			return new EqualsBuilder()
				.append(this.geozoneIrpf, o.geozoneIrpf)			
				.append(this.descendant, o.descendant)			
