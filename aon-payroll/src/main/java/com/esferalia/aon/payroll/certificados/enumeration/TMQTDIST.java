...
/** 
 * Enumeration for represent Certificados (S.E.P.E.) TMQTDIST table codes.
...
public enum TMQTDIST {
	...
	TMQTDIST( String code, String description, String startDate, String endDate ) {
		this.code = code;
	...
	public static TMQTDIST getEnumByValue(String expression) {
		for( TMQTDIST o : TMQTDIST.values() ) {
