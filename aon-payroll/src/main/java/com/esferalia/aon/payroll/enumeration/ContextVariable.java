...
public enum ContextVariable implements IResourceable {
	...
	PAYMENTS("NUM_PAGAS", VariableType.INTEGER, false), REAL_DAYS("DIAS_REALES", VariableType.INTEGER, false),
	STRIKE_DAYS("DIAS_HUELGA", VariableType.INTEGER, false), ERE_DAYS("DIAS_ERE", VariableType.INTEGER, false),
	GUARANTEED_DAYS("DIAS_GARANTIZADOS", VariableType.INTEGER, false),
	ACTIVE_DAYS("DIAS_ALTA", VariableType.INTEGER, false), MONDAY_DAYS("DIAS_LUNES", VariableType.DOUBLE, false),
	TUESDAY_DAYS("DIAS_MARTES", VariableType.DOUBLE, false),
	WEDNESDAY_DAYS("DIAS_MIERCOLES", VariableType.DOUBLE, false),
	THURSDAY_DAYS("DIAS_JUEVES", VariableType.DOUBLE, false), FRIDAY_DAYS("DIAS_VIERNES", VariableType.DOUBLE, false),
	SATURDAY_DAYS("DIAS_SABADO", VariableType.DOUBLE, false), SUNDAY_DAYS("DIAS_DOMINGO", VariableType.DOUBLE, false),
	PARTY_DAYS("DIAS_FESTIVOS", VariableType.DOUBLE, false), OFF_DAYS("DIAS_INACTIVIDAD", VariableType.DOUBLE, false),
	...
	ERE_BASE("BASE_ERE", VariableType.DOUBLE), DIRECT_BASE("BASE_PAGO_DIRECTO", VariableType.DOUBLE),
...
//	GUARANTEED("GARANTIZADO", VariableType.DOUBLE, false),
	...
	ERE("ERE", VariableType.BOOLEAN), MATERNITY("MTNAD", VariableType.BOOLEAN),
