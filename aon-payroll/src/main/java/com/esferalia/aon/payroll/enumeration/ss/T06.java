...
/** 
 * Enumeration for represent SOCIAL SECURITY T06 table codes.
 ...
 *  ------------------------------------------------------------------------
 */ 
public enum T06 implements ISSEnum {

	T06_00( "00", "Solicitud cuota total", null, null ),
	T06_01( "01", "Solucitud cuota aportación del trabajador", null, null ),
	;
	public static final String TABLE_NAME = "T06";
	public static final String TABLE_DESCRIPTION = "T06.txt";
	...
	T06( String code, String description, String startDate, String endDate ) {
		this.code = code;
	...
	public static T06 getEnumByValue(String expression) {
		for( T06 o : T06.values() ) {
