...
/** 
 * Enumeration for represent Certific@2 (S.E.P.E.) TAICLAOC table codes.
 ...
 *  ------------------------------------------------------------------------
 */ 
public enum TAICLAOC implements IPayrollTablesEnum {

	;
	public static final String TABLE_NAME = "TAICLAOC";
	...
	TAICLAOC( String code, String description, String startDate, String endDate ) {
		this.code = code;
	...
	public static TAICLAOC getEnumByValue(String expression) {
		for( TAICLAOC o : TAICLAOC.values() ) {
