...
class TestDomainDefaults {
	...
	private TestDomainDefaults() {
	}
	
	static void insertGeozones(AONContext ctx, Domain domain) {
	...
	static void insertTaxes(AONContext ctx, Domain domain) {
	...
	static void insertAccounts(AONContext ctx, Domain domain) {
