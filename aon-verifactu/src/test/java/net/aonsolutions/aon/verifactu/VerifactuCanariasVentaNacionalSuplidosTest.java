...
class VerifactuCanariasVentaNacionalSuplidosTest extends AbstractVerifactuTest {
...
//	    assertNotNull( dt0 );
//	    assertEquals( TipoImpuesto.IGIC.getValue() , dt0.getImpuesto() );
...
//	    assertNull( dt0.getCuotaRecargoEquivalencia() );
	    ...
	    assertNotNull( dt1 );
	    assertEquals( TipoImpuesto.IGIC.getValue() , dt1.getImpuesto() );
