...
public enum PaymentMeans2 {
	...
	PaymentMeans2( String value ) {
		this( value, null );
	}

	PaymentMeans2( String value, PayMethodType payMethodType ) {
		this.value = value;
	...
	public static PaymentMeans2 getPaymentMeans( PayMethodType payMethodType ) {
		for( PaymentMeans2 pm : values() ) {
