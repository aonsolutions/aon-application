...
import static net.aonsolutions.aon.in.pdf.api.toolkit.PDFToolkit.drawBorderedBox;
...
/**
 * <p>
 * <b>Description:</b> <i>This class represents a box in the PDF file. </i>
 * </p>
 * 
 * @author akrck02
 * @version 0.2-AK
...
public class PdfBox {
	...
	/**
	 * <p>
	 * <b>Description:</b> <i>Draws the box. </i>
	 * </p>
	 */
	public void draw() throws IOException {
		drawBox(stream, x, y, width, height, color);
	}

	/**
	 * <p>
	 * <b>Description:</b> <i>Draws the box border. </i>
	 * </p>
	 */
	public void border() throws IOException {
		drawBorderedBox(stream, x, y, width, height, color);
	}
