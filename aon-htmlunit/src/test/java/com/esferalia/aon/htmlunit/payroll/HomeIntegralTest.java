...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 284.00);
		assertValue("cgcBaseLabel", 284.00);
		...
		assertValue("cgpBaseLabel", 296.00);
		assertValue("cgcBaseLabel", 296.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 405.00);
		assertValue("cgcBaseLabel", 405.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 423.00);
		assertValue("cgcBaseLabel", 423.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 559.00);
		assertValue("cgcBaseLabel", 559.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 584.00);
		assertValue("cgcBaseLabel", 584.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 729.00);
		assertValue("cgcBaseLabel", 729.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 761.00);
		assertValue("cgcBaseLabel", 761.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 901.00);
		assertValue("cgcBaseLabel", 901.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 1069.00);
		assertValue("cgcBaseLabel", 1069.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 1116.00);
		assertValue("cgcBaseLabel", 1116.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 1323.01);
		assertValue("cgcBaseLabel", 1323.01);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 1381.21);
		assertValue("cgcBaseLabel", 1381.21);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
...
//		assertText("desmpl_bonus", (cgpBase*5.2/100.00)*0.80);
		calculate(Calendar.JANUARY, 2023);
		assertValue("cgpBaseLabel", 1273.01);
		assertValue("cgcBaseLabel", 1273.01);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2024);
		assertValue("cgpBaseLabel", 1373.00);
		assertValue("cgcBaseLabel", 1373.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
		...
		assertText("desmpl_bonus", (cgpBase*5.7/100.00)*0.80);
		calculate(Calendar.JANUARY, 2025);
		assertValue("cgpBaseLabel", 1393.00);
		assertValue("cgcBaseLabel", 1393.00);
		cgcBase = getValue("cgcBaseLabel");
		cgpBase = getValue("cgcBaseLabel");
		assertText("common_contingency", cgcBase*4.70/100.00);
		assertText("unemployment", cgpBase*1.55/100.00);
