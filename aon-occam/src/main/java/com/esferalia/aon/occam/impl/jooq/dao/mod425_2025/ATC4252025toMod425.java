...
public class ATC4252025toMod425 {

	private static final DateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");

	private ATC4252025toMod425() {

	}

	public static void populate(Mod4252025 mod425, AEATIVA2024 iva) throws ParseException {
		...
		if (!mod425.isLegalEntity()) {
			...
			mod425.setName(tipf.getNombre());
			mod425.setFirstSurname(tipf.getApe1());
			mod425.setSecondSurname(tipf.getApe2());
		} else {
			TipoPersonaJuridica tpj = datIdent.getPersJuridica();
			TipoIdentificacionPersonaJuridica tipj = tpj.getIdentPersJuridica();
			mod425.setName(tipj.getRazonSocial());
		}
		mod425.setContactPhone(datIdent.getTelefono());

		Devengo devengo = iva.getDevengo();
		TipoConcursoUltPer tipo = devengo.getConcursoAcreedoresSI();
		if (tipo != null) {
			mod425.setInsolvencyStateThisYear(true);
			if (tipo.getConcursoUltPerSI() != null) {
				mod425.setInsolvencyStateLastPeriod(true);
			}
		}

		mod425.setTaxRefund(devengo.getRegDevMensual() != null);
		TipoGrupoEntidades tge = devengo.getRegGrupoEntidades();
		if (tge != null) {
			mod425.setSpecialGroupRegime(true);
			mod425.setGroupNumber(tge.getNumGrupo());
			mod425.setGroupDependent(tge.getDependiente() != null);
			mod425.setGroupDependent(tge.getDominante() == null);
			if (tge.getArt65SI() != null) {
				mod425.setGroupRegimeType(true);
				mod425.setGroupDocument(tge.getNIFEntidadDominante());
			} else {
				mod425.setGroupRegimeType(false);
			}
			mod425.setGroupDeclarations(tge.getUltAutoliquidSI() != null);
		}
		if (devengo.getRegCriterioCajaSI() != null) {
			mod425.setAccrualRegime(true);
		}
		if (devengo.getDestRegCriterioCajaSI() != null) {
			mod425.setAccrualRegimeTarget(true);
		}
		...
		if (dat.getPral() != null) {
			...
			mod425.setMainActivity(activity);
		}
		int i = 1;
		for (Otras otras : dat.getOtras()) {
			if (otras != null) {
				...
				if (i == 1) {
					mod425.setActivity1(activity);
				} else if (i == 2) {
					mod425.setActivity2(activity);
				} else if (i == 3) {
					mod425.setActivity3(activity);
				} else if (i == 4) {
					mod425.setActivity4(activity);
				} else if (i == 5) {
					mod425.setActivity5(activity);
				}
			}
			++i;
		}
		mod425.setMod347(dat.getOpTercerasPax() != null);
		if (dat.getConjunta() != null) {
			mod425.setMergedDeclarationDocument(dat.getConjunta().getNIF());
			mod425.setMergedDeclarationName(dat.getConjunta().getRazonSocial());
		}
		...
		if (list != null && !list.isEmpty()) {
			for (TipoRepresentanteJuridica trj : list) {
				...
				if (i == 1) {
					mod425.setLegalRepr1(lg);
				} else if (i == 2) {
					mod425.setLegalRepr2(lg);
				} else if (i == 3) {
					mod425.setLegalRepr3(lg);
				}
				i++;
			}
		}

		Map<Mod4252025DetailKey, Mod425Detail> map = new TreeMap<>();
		...
		if (iva.getRegGeneral() != null) {
			...
			if (b != null) {
				if (b.getRegOrdinario() != null) {
					put(mod425, Mod4252025DetailKey.C0701, b.getRegOrdinario().getTipo0());
					put(mod425, Mod4252025DetailKey.C0668, b.getRegOrdinario().getTipo2());
					put(mod425, Mod4252025DetailKey.C0002, b.getRegOrdinario().getTipo4());
					put(mod425, Mod4252025DetailKey.C0703, b.getRegOrdinario().getTipo5());
					put(mod425, Mod4252025DetailKey.C0670, b.getRegOrdinario().getTipo75());
					put(mod425, Mod4252025DetailKey.C0004, b.getRegOrdinario().getTipo10());
					put(mod425, Mod4252025DetailKey.C0006, b.getRegOrdinario().getTipo21());
				}
				if (b.getOpIntragrupo() != null) {
					put(mod425, Mod4252025DetailKey.C0705, b.getOpIntragrupo().getTipo0());
					put(mod425, Mod4252025DetailKey.C0672, b.getOpIntragrupo().getTipo2());
					put(mod425, Mod4252025DetailKey.C0501, b.getOpIntragrupo().getTipo4());
					put(mod425, Mod4252025DetailKey.C0707, b.getOpIntragrupo().getTipo5());
					put(mod425, Mod4252025DetailKey.C0674, b.getOpIntragrupo().getTipo75());
					put(mod425, Mod4252025DetailKey.C0503, b.getOpIntragrupo().getTipo10());
					put(mod425, Mod4252025DetailKey.C0505, b.getOpIntragrupo().getTipo21());
				}
				if (b.getRegCriterioCaja() != null) {
					put(mod425, Mod4252025DetailKey.C0709, b.getRegCriterioCaja().getTipo0());
					put(mod425, Mod4252025DetailKey.C0676, b.getRegCriterioCaja().getTipo2());
					put(mod425, Mod4252025DetailKey.C0644, b.getRegCriterioCaja().getTipo4());
					put(mod425, Mod4252025DetailKey.C0711, b.getRegCriterioCaja().getTipo5());
					put(mod425, Mod4252025DetailKey.C0678, b.getRegCriterioCaja().getTipo75());
					put(mod425, Mod4252025DetailKey.C0646, b.getRegCriterioCaja().getTipo10());
					put(mod425, Mod4252025DetailKey.C0648, b.getRegCriterioCaja().getTipo21());
				}
				if (b.getRegBienesUsados() != null) {
					put(mod425, Mod4252025DetailKey.C0713, b.getRegBienesUsados().getTipo0());
					put(mod425, Mod4252025DetailKey.C0680, b.getRegBienesUsados().getTipo2());
					put(mod425, Mod4252025DetailKey.C0008, b.getRegBienesUsados().getTipo4());
					put(mod425, Mod4252025DetailKey.C0715, b.getRegBienesUsados().getTipo5());
					put(mod425, Mod4252025DetailKey.C0682, b.getRegBienesUsados().getTipo75());
					put(mod425, Mod4252025DetailKey.C0010, b.getRegBienesUsados().getTipo10());
					put(mod425, Mod4252025DetailKey.C0012, b.getRegBienesUsados().getTipo21());
				}
				if (b.getRegAgViajes() != null) {
					put(mod425, Mod4252025DetailKey.C0014, b.getRegAgViajes().getTipo21());
				}
				if (b.getAdqIntracomBienes() != null) {
					put(mod425, Mod4252025DetailKey.C0717, b.getAdqIntracomBienes().getTipo0());
					put(mod425, Mod4252025DetailKey.C0684, b.getAdqIntracomBienes().getTipo2());
					put(mod425, Mod4252025DetailKey.C0022, b.getAdqIntracomBienes().getTipo4());
					put(mod425, Mod4252025DetailKey.C0719, b.getAdqIntracomBienes().getTipo5());
					put(mod425, Mod4252025DetailKey.C0686, b.getAdqIntracomBienes().getTipo75());
					put(mod425, Mod4252025DetailKey.C0024, b.getAdqIntracomBienes().getTipo10());
					put(mod425, Mod4252025DetailKey.C0026, b.getAdqIntracomBienes().getTipo21());
				}
				if (b.getAdqIntracomServicios() != null) {
					put(mod425, Mod4252025DetailKey.C0721, b.getAdqIntracomServicios().getTipo0());
					put(mod425, Mod4252025DetailKey.C0688, b.getAdqIntracomServicios().getTipo2());
					put(mod425, Mod4252025DetailKey.C0546, b.getAdqIntracomServicios().getTipo4());
					put(mod425, Mod4252025DetailKey.C0723, b.getAdqIntracomServicios().getTipo5());
					put(mod425, Mod4252025DetailKey.C0690, b.getAdqIntracomServicios().getTipo75());
					put(mod425, Mod4252025DetailKey.C0548, b.getAdqIntracomServicios().getTipo10());
					put(mod425, Mod4252025DetailKey.C0552, b.getAdqIntracomServicios().getTipo21());
				}
				if (b.getIVAdevengadoInversionSP() != null) {
					put(mod425, Mod4252025DetailKey.C0028, b.getIVAdevengadoInversionSP().getTipoX());
				}
				if (b.getModBasesyCuotas() != null) {
					put(mod425, Mod4252025DetailKey.C0030, b.getModBasesyCuotas().getTipoX());
				}
				if (b.getModBasesyCuotasConcursoAcreedores() != null) {
					put(mod425, Mod4252025DetailKey.C0032, b.getModBasesyCuotasConcursoAcreedores().getTipoX());
				}
				if (b.getTotalBasesyCuotasIVA() != null) {
					put(mod425, Mod4252025DetailKey.C0034, b.getTotalBasesyCuotasIVA().getTipoX());
				}
				if (b.getRecargoEquivalencia() != null) {
					put(mod425, Mod4252025DetailKey.C0664, b.getRecargoEquivalencia().getTipo0());
					put(mod425, Mod4252025DetailKey.C0692, b.getRecargoEquivalencia().getTipo026());
					put(mod425, Mod4252025DetailKey.C0036, b.getRecargoEquivalencia().getTipo05());
					put(mod425, Mod4252025DetailKey.C0666, b.getRecargoEquivalencia().getTipo062());
					put(mod425, Mod4252025DetailKey.C0694, b.getRecargoEquivalencia().getTipo1());
					put(mod425, Mod4252025DetailKey.C0600, b.getRecargoEquivalencia().getTipo14());
					put(mod425, Mod4252025DetailKey.C0602, b.getRecargoEquivalencia().getTipo52());
					put(mod425, Mod4252025DetailKey.C0042, b.getRecargoEquivalencia().getTipo175());					
				}
				if (b.getModRecargoEquivalencia() != null) {
					put(mod425, Mod4252025DetailKey.C0044, b.getModRecargoEquivalencia().getTipoX());
				}
				if (b.getModRecargoEquivalenciaConcursoAcreedores() != null) {
					put(mod425, Mod4252025DetailKey.C0046, b.getModRecargoEquivalenciaConcursoAcreedores().getTipoX());
				}
				if (b.getTotalCuotasIVA() != null) {
					put(mod425, Mod4252025DetailKey.C0047, b.getTotalCuotasIVA());
				}
			}
			...
			if (iva.getRegGeneral().getDeducciones() != null) {
				...
				if (d.getOpInterioresBienesServiciosCorrientes() != null) {
					put(mod425, Mod4252025DetailKey.C0696, d.getOpInterioresBienesServiciosCorrientes().getTipo2());
					put(mod425, Mod4252025DetailKey.C0191, d.getOpInterioresBienesServiciosCorrientes().getTipo4());
					put(mod425, Mod4252025DetailKey.C0725, d.getOpInterioresBienesServiciosCorrientes().getTipo5());
					put(mod425, Mod4252025DetailKey.C0698, d.getOpInterioresBienesServiciosCorrientes().getTipo75());
					put(mod425, Mod4252025DetailKey.C0604, d.getOpInterioresBienesServiciosCorrientes().getTipo10());
					put(mod425, Mod4252025DetailKey.C0606, d.getOpInterioresBienesServiciosCorrientes().getTipo21());
					put(mod425, Mod4252025DetailKey.C0049, d.getOpInterioresBienesServiciosCorrientes().getTotal());
				}
				if (d.getOpIntragrupoCorrientes() != null) {
					put(mod425, Mod4252025DetailKey.C0746, d.getOpIntragrupoCorrientes().getTipo2());
					put(mod425, Mod4252025DetailKey.C0507, d.getOpIntragrupoCorrientes().getTipo4());
					put(mod425, Mod4252025DetailKey.C0727, d.getOpIntragrupoCorrientes().getTipo5());
					put(mod425, Mod4252025DetailKey.C0748, d.getOpIntragrupoCorrientes().getTipo75());
					put(mod425, Mod4252025DetailKey.C0608, d.getOpIntragrupoCorrientes().getTipo10());
					put(mod425, Mod4252025DetailKey.C0610, d.getOpIntragrupoCorrientes().getTipo21());
					put(mod425, Mod4252025DetailKey.C0513, d.getOpIntragrupoCorrientes().getTotal());
				}
				if (d.getOpInterioresBienesInversion() != null) {
					put(mod425, Mod4252025DetailKey.C0750, d.getOpInterioresBienesInversion().getTipo2());
					put(mod425, Mod4252025DetailKey.C0197, d.getOpInterioresBienesInversion().getTipo4());
					put(mod425, Mod4252025DetailKey.C0729, d.getOpInterioresBienesInversion().getTipo5());
					put(mod425, Mod4252025DetailKey.C0752, d.getOpInterioresBienesInversion().getTipo75());
					put(mod425, Mod4252025DetailKey.C0612, d.getOpInterioresBienesInversion().getTipo10());
					put(mod425, Mod4252025DetailKey.C0614, d.getOpInterioresBienesInversion().getTipo21());
					put(mod425, Mod4252025DetailKey.C0051, d.getOpInterioresBienesInversion().getTotal());
				}
				if (d.getOpIntragrupoBienesInversion() != null) {
					put(mod425, Mod4252025DetailKey.C0754, d.getOpIntragrupoBienesInversion().getTipo2());
					put(mod425, Mod4252025DetailKey.C0515, d.getOpIntragrupoBienesInversion().getTipo4());
					put(mod425, Mod4252025DetailKey.C0731, d.getOpIntragrupoBienesInversion().getTipo5());
					put(mod425, Mod4252025DetailKey.C0756, d.getOpIntragrupoBienesInversion().getTipo75());
					put(mod425, Mod4252025DetailKey.C0616, d.getOpIntragrupoBienesInversion().getTipo10());
					put(mod425, Mod4252025DetailKey.C0618, d.getOpIntragrupoBienesInversion().getTipo21());
					put(mod425, Mod4252025DetailKey.C0521, d.getOpIntragrupoBienesInversion().getTotal());
				}
				if (d.getImportacionesBienesCorrientes() != null) {
					put(mod425, Mod4252025DetailKey.C0758, d.getImportacionesBienesCorrientes().getTipo2());
					put(mod425, Mod4252025DetailKey.C0203, d.getImportacionesBienesCorrientes().getTipo4());
					put(mod425, Mod4252025DetailKey.C0733, d.getImportacionesBienesCorrientes().getTipo5());
					put(mod425, Mod4252025DetailKey.C0760, d.getImportacionesBienesCorrientes().getTipo75());
					put(mod425, Mod4252025DetailKey.C0620, d.getImportacionesBienesCorrientes().getTipo10());
					put(mod425, Mod4252025DetailKey.C0622, d.getImportacionesBienesCorrientes().getTipo21());
					put(mod425, Mod4252025DetailKey.C0053, d.getImportacionesBienesCorrientes().getTotal());
				}
				if (d.getImportacionesBienesInversion() != null) {
					put(mod425, Mod4252025DetailKey.C0762, d.getImportacionesBienesInversion().getTipo2());
					put(mod425, Mod4252025DetailKey.C0209, d.getImportacionesBienesInversion().getTipo4());
					put(mod425, Mod4252025DetailKey.C0735, d.getImportacionesBienesInversion().getTipo5());
					put(mod425, Mod4252025DetailKey.C0764, d.getImportacionesBienesInversion().getTipo75());
					put(mod425, Mod4252025DetailKey.C0624, d.getImportacionesBienesInversion().getTipo10());
					put(mod425, Mod4252025DetailKey.C0626, d.getImportacionesBienesInversion().getTipo21());
					put(mod425, Mod4252025DetailKey.C0055, d.getImportacionesBienesInversion().getTotal());
				}
				if (d.getAdqIntracomunitariasBienesCorrientes() != null) {
					put(mod425, Mod4252025DetailKey.C0766, d.getAdqIntracomunitariasBienesCorrientes().getTipo2());
					put(mod425, Mod4252025DetailKey.C0215, d.getAdqIntracomunitariasBienesCorrientes().getTipo4());
					put(mod425, Mod4252025DetailKey.C0737, d.getAdqIntracomunitariasBienesCorrientes().getTipo5());
					put(mod425, Mod4252025DetailKey.C0768, d.getAdqIntracomunitariasBienesCorrientes().getTipo75());
					put(mod425, Mod4252025DetailKey.C0628, d.getAdqIntracomunitariasBienesCorrientes().getTipo10());
					put(mod425, Mod4252025DetailKey.C0630, d.getAdqIntracomunitariasBienesCorrientes().getTipo21());
					put(mod425, Mod4252025DetailKey.C0057, d.getAdqIntracomunitariasBienesCorrientes().getTotal());
				}
				if (d.getAdqIntracomunitariasBienesInversion() != null) {
					put(mod425, Mod4252025DetailKey.C0770, d.getAdqIntracomunitariasBienesInversion().getTipo2());
					put(mod425, Mod4252025DetailKey.C0221, d.getAdqIntracomunitariasBienesInversion().getTipo4());
					put(mod425, Mod4252025DetailKey.C0739, d.getAdqIntracomunitariasBienesInversion().getTipo5());
					put(mod425, Mod4252025DetailKey.C0772, d.getAdqIntracomunitariasBienesInversion().getTipo75());
					put(mod425, Mod4252025DetailKey.C0632, d.getAdqIntracomunitariasBienesInversion().getTipo10());
					put(mod425, Mod4252025DetailKey.C0634, d.getAdqIntracomunitariasBienesInversion().getTipo21());
					put(mod425, Mod4252025DetailKey.C0059, d.getAdqIntracomunitariasBienesInversion().getTotal());
				}
				if (d.getAdqIntracomunitariasServicios() != null) {
					put(mod425, Mod4252025DetailKey.C0774, d.getAdqIntracomunitariasServicios().getTipo2());
					put(mod425, Mod4252025DetailKey.C0588, d.getAdqIntracomunitariasServicios().getTipo4());
					put(mod425, Mod4252025DetailKey.C0741, d.getAdqIntracomunitariasServicios().getTipo5());
					put(mod425, Mod4252025DetailKey.C0776, d.getAdqIntracomunitariasServicios().getTipo75());
					put(mod425, Mod4252025DetailKey.C0636, d.getAdqIntracomunitariasServicios().getTipo10());
					put(mod425, Mod4252025DetailKey.C0638, d.getAdqIntracomunitariasServicios().getTipo21());
					put(mod425, Mod4252025DetailKey.C0598, d.getAdqIntracomunitariasServicios().getTotal());
				}
				if (d.getComRegAgricGanadPesca() != null) {
					put(mod425, Mod4252025DetailKey.C0061, d.getComRegAgricGanadPesca().getTipoX());
				}
				if (d.getRectifDeducciones() != null) {
					put(mod425, Mod4252025DetailKey.C0062, d.getRectifDeducciones().getTipoX());
				}
				if (d.getRectifOpIntragrupo() != null) {
					put(mod425, Mod4252025DetailKey.C0652, d.getRectifOpIntragrupo().getTipoX());
				}
				if (d.getRegularizInversiones() != null) {
					put(mod425, Mod4252025DetailKey.C0063, d.getRegularizInversiones());
				}
				if (d.getRegularizPorcProrrata() != null) {
					put(mod425, Mod4252025DetailKey.C0522, d.getRegularizPorcProrrata());
				}
				if (d.getSumDeducciones() != null) {
					put(mod425, Mod4252025DetailKey.C0064, d.getSumDeducciones());
				}
			...
			if (AonStringUtils.isNotEmpty(res)) {
				try {
					...
					put(mod425, Mod4252025DetailKey.C0065, BigDecimal.valueOf(val));
				} catch (NumberFormatException e) {
					// Nothing
				}
			}
		...
		if (reg != null) {
			...
			if (!reg.getActAgricGanadForest().isEmpty()) {
				...
				mod425.setFarmerRegime1(sra);
			}
			if (reg.getActAgricGanadForest().size() > 1) {
				ActAgricGanadForest actividad = reg.getActAgricGanadForest().get(1);
				FarmerRegimeActivity sra = getFarmerRegimeActivity(actividad);
				mod425.setFarmerRegime2(sra);
			}
			if (reg.getActAgricGanadForest().size() > 2) {
				ActAgricGanadForest actividad = reg.getActAgricGanadForest().get(2);
				FarmerRegimeActivity sra = getFarmerRegimeActivity(actividad);
				mod425.setFarmerRegime3(sra);
			}
			if (reg.getActAgricGanadForest().size() > 3) {
				ActAgricGanadForest actividad = reg.getActAgricGanadForest().get(3);
				FarmerRegimeActivity sra = getFarmerRegimeActivity(actividad);
				mod425.setFarmerRegime4(sra);
			}
			if (reg.getActAgricGanadForest().size() > 4) {
				ActAgricGanadForest actividad = reg.getActAgricGanadForest().get(4);
				FarmerRegimeActivity sra = getFarmerRegimeActivity(actividad);
				mod425.setFarmerRegime5(sra);
			}
			IvaDevengado ivaDev = reg.getIvaDevengado();
			if (ivaDev != null) {
				mod425.setBox74(ensureBigDecimal(ivaDev.getSumaCuotasNoAgric()));
				mod425.setBox75(ensureBigDecimal(ivaDev.getSumaCuotasAgric()));
				mod425.setBox76(ensureBigDecimal(ivaDev.getAdqIntracomunitarias()));
				mod425.setBox77(ensureBigDecimal(ivaDev.getInversionSujetoPasivo()));
				mod425.setBox78(ensureBigDecimal(ivaDev.getEntregasActivosFijos()));
				mod425.setBox79(ensureBigDecimal(ivaDev.getTotalCuota()));
			}
			IvaDeducible ivaDed = reg.getIvaDeducible();
			if (ivaDed != null) {
				mod425.setBox80(ensureBigDecimal(ivaDed.getIVASoportadoAdqActivosFijos()));
				mod425.setBox81(ensureBigDecimal(ivaDed.getRegBienesInversion()));
				mod425.setBox82(ensureBigDecimal(ivaDed.getSumaDeducciones()));
			}
			mod425.setBox83(ensureBigDecimal(reg.getResRegimenSimplificado()));
		} else {
		...
		if (adm == null) {
			...
			if (liq != null) {
				mod425.setBox658(ensureBigDecimal(liq.getRegCuotas()));
				mod425.setBox84(ensureBigDecimal(liq.getSumResultados()));
				mod425.setBox659(ensureBigDecimal(liq.getIvaAduana()));
				mod425.setBox85(ensureBigDecimal(liq.getCompCuotasEjercicioAnterior()));
				mod425.setBox86(ensureBigDecimal(liq.getResLiquidacion()));
			}
		} else {
			if (adm != null) {
				mod425.setBox658(ensureBigDecimal(adm.getRegCuotas()));
				mod425.setBox87(ensureBigDecimal(adm.getComun()));
				mod425.setBox88(ensureBigDecimal(adm.getArabaAlava()));
				mod425.setBox89(ensureBigDecimal(adm.getGipuzkoa()));
				mod425.setBox90(ensureBigDecimal(adm.getBizkaia()));
				mod425.setBox91(ensureBigDecimal(adm.getNavarra()));
				mod425.setBox84(ensureBigDecimal(adm.getSumResultados()));
				mod425.setBox659(ensureBigDecimal(adm.getIvaAduana()));
				mod425.setBox92(ensureBigDecimal(adm.getResTerrComun()));
				mod425.setBox93(ensureBigDecimal(adm.getComCuotasEjercicioAnteriorTerrComun()));
				mod425.setBox94(ensureBigDecimal(adm.getResLiqAnualTerrComun()));
			}
		}
		...
		if (res != null) {
			...
			if (perNo != null) {
				mod425.setBox95(ensureBigDecimal(perNo.getTotIngresosIVA()));
				mod425.setBox96(ensureBigDecimal(perNo.getTotDevIVASPRegDevMensual()));
				mod425.setBox524(ensureBigDecimal(perNo.getTotDevAdqElemTrans()));
				mod425.setBox97(ensureBigDecimal(perNo.getImporteACompensarUltimoPeriodo()));
				mod425.setBox98(ensureBigDecimal(perNo.getImporteADevolverUltimoPeriodo()));
				mod425.setBox662(ensureBigDecimal(perNo.getCuotasPendCompensar()));
			}
			PerSiRegGrupos perSi = res.getPerSiRegGrupos();
			if (perNo != null) {
				mod425.setBox525(ensureBigDecimal(perSi.getTotResulPositivos322()));
				mod425.setBox526(ensureBigDecimal(perSi.getTotResulNegativos322()));
			}
		}
		VolOperaciones vol = iva.getVolOperaciones();
		if (vol != null) {
			mod425.setBox99(ensureBigDecimal(vol.getOpRegGeneral()));
			mod425.setBox653(ensureBigDecimal(vol.getOpRegEspCriterioCaja()));
			mod425.setBox103(ensureBigDecimal(vol.getEntregasIntracomunitariasExentas()));
			mod425.setBox104(ensureBigDecimal(vol.getExportacionesExentasConDrchoDeduccion()));
			mod425.setBox105(ensureBigDecimal(vol.getOpExentasSinDrchoDeduccion()));
			mod425.setBox110(ensureBigDecimal(vol.getOpNoSujetas()));
			mod425.setBox125(ensureBigDecimal(vol.getBox125()));
			mod425.setBox126(ensureBigDecimal(vol.getBox126()));
			mod425.setBox127(ensureBigDecimal(vol.getBox127()));
			mod425.setBox128(ensureBigDecimal(vol.getBox128()));
			mod425.setBox100(ensureBigDecimal(vol.getOpRegSimplificado()));
			mod425.setBox101(ensureBigDecimal(vol.getOpRegEspAgricPescGanad()));
			mod425.setBox102(ensureBigDecimal(vol.getOpRegEspRecEquivalencia()));
			mod425.setBox227(ensureBigDecimal(vol.getOpRegEspBienesUsados()));
			mod425.setBox228(ensureBigDecimal(vol.getOpRegEspAgViajes()));
			mod425.setBox106(ensureBigDecimal(vol.getEntregasBienesInmuebles()));
			mod425.setBox107(ensureBigDecimal(vol.getEntregasBienesInversion()));
			mod425.setBox108(ensureBigDecimal(vol.getTotalVolOp()));
		}
		OpEspecificas op = iva.getOpEspecificas();
		if (op != null) {
			mod425.setBox230(ensureBigDecimal(op.getAdqInterioresExentas()));
			mod425.setBox109(ensureBigDecimal(op.getAdqIntracomunitariasExentas()));
			mod425.setBox231(ensureBigDecimal(op.getImportacionesExentas()));
			mod425.setBox232(ensureBigDecimal(op.getBasesIVASoportadoNoDeducible()));
			mod425.setBox111(ensureBigDecimal(op.getOpSujetas()));
			mod425.setBox113(ensureBigDecimal(op.getEntregasInteriores()));
			mod425.setBox523(ensureBigDecimal(op.getServInversionSP()));
			if (op.getEntregasCriterioCajaBase() != null && op.getEntregasCriterioCajaBase().getTipoX() != null) {
				mod425.setBox654(ensureBigDecimal(op.getEntregasCriterioCajaBase().getTipoX().getBI()));
				mod425.setBox655(ensureBigDecimal(op.getEntregasCriterioCajaBase().getTipoX().getCuota()));
			}
			if (op.getAdqCriterioCajaBase() != null && op.getAdqCriterioCajaBase().getTipoX() != null) {
				mod425.setBox656(ensureBigDecimal(op.getAdqCriterioCajaBase().getTipoX().getBI()));
				mod425.setBox657(ensureBigDecimal(op.getAdqCriterioCajaBase().getTipoX().getCuota()));
			}
		}
	...
	private static void put(Mod4252025 mod425, Mod4252025DetailKey key, TipoBaseImponibleYCuota tipo) {
		if (tipo != null) {
			Mod425Detail detail = new Mod425Detail();
			detail.setKey(key);
			...
			mod425.getGeneralRegime().put(key, detail);
		}

	}

	private static void put(Mod4252025 mod390, Mod4252025DetailKey key, BigDecimal quota) {
		if (quota != null) {
			Mod425Detail detail = new Mod425Detail();
			detail.setKey(key);
			detail.setPercent(key.getPercent());
