...
enum Mod190File2025Gipuzkoa {
	...
	private Mod190File2025Gipuzkoa(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2025Gipuzkoa.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2025Gipuzkoa.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
