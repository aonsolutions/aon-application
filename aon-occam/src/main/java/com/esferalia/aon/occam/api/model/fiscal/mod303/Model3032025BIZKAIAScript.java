...
public enum Model3032025BIZKAIAScript implements IModelScript<Mod303Key> {
...
//	,DVG04 (DVG02.getLabel()		,new Mod303Key[]{Mod303Key.BZ_C110	,Mod303Key.BZ_X110	,Mod303Key.BZ_C111},MODEL_INVOICE_VAT_BREAKDOWN)
	...
	private Model3032025BIZKAIAScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
