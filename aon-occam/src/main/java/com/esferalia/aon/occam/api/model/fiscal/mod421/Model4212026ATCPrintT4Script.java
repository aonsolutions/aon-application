...
public enum Model4212026ATCPrintT4Script implements IModelScript<Mod421Key> {
	...
	private Model4212026ATCPrintT4Script(String label, Mod421Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
