...
public class Mod140Writer {
	@FunctionalInterface
	private interface IRecordFiller {

		void fill(Writer writer, Mod140Context ctx, Mod140 invoice, String account, Integer vatIdx)
				throws IOException;
	}

	private interface IMod140Record {
	...
	private static enum Record4Bizkaia2015 implements Serializable,IMod140Record {
		 TIPO_DE_REGISTRO (
...
//						 , 14 ));}
	...
	private static enum Record5Bizkaia2015 implements Serializable,IMod140Record {
		 TIPO_DE_REGISTRO (
