...
enum Mod190File2025Bizkaia {
	TYPE_1 (new IPropertyFiller[] { 
	   ...
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getPreferredContributionsOver36(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getPreferredContributionsTotal(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getPreferredGrossAnnualSalary(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getPreferredContributionsPercentage1(), 4, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getPreferredContributionsPercentage2(), 4, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getOtherContributionsUnder36(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getOtherContributionsOver36(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getOtherContributionsTotal(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getOtherGrossAnnualSalary(), 13, 2))
	   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getOtherContributionsPercentage(), 4, 2))
	   ,(wr, mod190,detail) -> wr.append(AonStringUtils.repeat(' ', 71))
	...
	,TYPE_2 (new IPropertyFiller[] { 
	   ...
	   ,(wr, mod190,detail) -> wr.append(AonStringUtils.repeat(' ', 5))
	   ...
	   ,(wr, mod190,detail) -> wr.append(AonStringUtils.repeat(' ', 1))
	   ,(wr, mod190,detail) -> wr.append(detail.isEntrepreneurship() ? "1" : "0") // Rendimientos del trabajo obtenidos por la gestión de fondos vinculados al emprendimiento
	...
	private Mod190File2025Bizkaia(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2025Bizkaia.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2025Bizkaia.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
}
