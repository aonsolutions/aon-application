...
//	private static final long serialVersionUID = 6202543820337953651L;
    ...
    private double amount1;   // FALTA - En el XML solo aparecen las unidades, si queremos mostrarlo en pantalla, habría que calcularlo al mostrar las unidades 
...
//  private int    moduleIndex3;    
	...
	public SimpliedRegimeActivity425 setAmount1(double amount1) {
	...
	public SimpliedRegimeActivity425 setAmount2(double amount2) {
	...
	public SimpliedRegimeActivity425 setAmount3(double amount3) {
	...
	public SimpliedRegimeActivity425 setAmount4(double amount4) {
	...
	public SimpliedRegimeActivity425 setAmount5(double amount5) {
	...
	public SimpliedRegimeActivity425 setAmount6(double amount6) {
	...
	public SimpliedRegimeActivity425 setAmount7(double amount7) {
	...
	public SimpliedRegimeActivity425 setAmount(int line, double value) {
