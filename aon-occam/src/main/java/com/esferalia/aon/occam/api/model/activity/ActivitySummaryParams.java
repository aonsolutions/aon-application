...
public class ActivitySummaryParams implements Serializable {
	...
	public String toString() {
		return "ActivitySummaryParams [childomain=" + childomain + ", description=" + description + ", start=" + start
				+ ", end=" + end + ", startContract=" + startContract + ", endContract=" + endContract + ", salary="
				+ salary + ", extra=" + extra + ", settle=" + settle + ", delay=" + delay + ", itCD=" + itCD + ", itOD="
				+ itOD + ", itMP=" + itMP + ", itOT=" + itOT + ", limit=" + limit + ", offset=" + offset + ", orderBy="
				+ orderBy + ", asc=" + asc + "]";
	}
