...
public enum Mod3902015DetailKey implements Serializable {
	...
	private Mod3902015DetailKey(int box, Double percent, Integer year, boolean taxableBaseAvailable, boolean readonly) {
		this(box, percent, year, taxableBaseAvailable, readonly, false);	
	}
	
	private Mod3902015DetailKey(int box, Double percent, Integer year, boolean taxableBaseAvailable, boolean readonly, boolean prorrata) {
