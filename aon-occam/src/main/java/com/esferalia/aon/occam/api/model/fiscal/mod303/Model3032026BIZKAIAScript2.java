...
public enum Model3032026BIZKAIAScript2 implements IModelScript<Mod303Key> {
	...
	,LQ001("Diferencia"												,new Mod303Key[]{Mod303Key.BZ_C031},null,COMPUTE)
	...
	,LQ044(Mod303Key.BZ_C044.getDescription()						,new Mod303Key[]{Mod303Key.BZ_C044},null,NONE)
...
//	,LQ010("A ingresar"												,new Mod303Key[]{Mod303Key.BZ_C040},COMPUTE)
	...
	private Model3032026BIZKAIAScript2(String label, Mod303Key[] keys,KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
