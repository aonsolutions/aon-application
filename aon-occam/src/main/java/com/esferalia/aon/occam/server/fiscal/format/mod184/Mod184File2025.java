...
enum Mod184File2025 {
	...
	TYPE_1 (new IPropertyFiller[] {
	   ...
	   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.unsigned(mod184.getIncomes().size(),9,0)) // Número total de registros de entidad
	   ,(wr, mod184,prt,inc) -> wr.append(AonStringUtils.repeat(' ', 258))
	...
	private Mod184File2025(IPropertyFiller[] pf) {
