...
public class RegistryItemJSON {
	...
	public static RegistryItem fromJSON(JSONObject json) {
		...
		RegistryItem ritem = new RegistryItem()
				...
				.setDiscountExpr(JsonUtils.getString(json, "discount_expr"))
	...
	public static JSONObject toJSON(RegistryItem item) {
		...
		return new JSONObject()
				...
				.put("discount_expr", item.getDiscountExpr())
				...
				.put(IJsonNames.START_DATE, item.getStartDate())
				.put(IJsonNames.END_DATE, item.getEndDate())
