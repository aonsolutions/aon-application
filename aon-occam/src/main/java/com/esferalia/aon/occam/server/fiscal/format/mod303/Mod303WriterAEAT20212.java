...
class Mod303WriterAEAT20212 implements IMod303Writer{
	...
	private enum Mod303File {
		...
		,AEAT_2021_REG_3 (mod303 -> true ,new IPropertyFiller[] {
			   ...
			   ,(wr, mod) -> wr.append(mod.getDeclarationResultType() == FiscalModelDeclarationType.PAYBACK?"1":" ")				// Devolución - Marca SEPA
