...
public enum Model3902017ARABAAdditionalDataScript implements IModelScript<Mod390Key> {
	...
	,ADC03 (Mod390Key.AR_C154.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C154},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC04 (Mod390Key.AR_C155.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C155},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC05 (Mod390Key.AR_C156.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C156},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC06 (Mod390Key.AR_C157.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C157},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC07 (Mod390Key.AR_C158.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C158},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC08 (Mod390Key.AR_C210.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C210},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC09 (Mod390Key.AR_C211.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C211},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC10 (Mod390Key.AR_C212.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C212},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC11 (Mod390Key.AR_C161.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C161},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC12 (Mod390Key.AR_C162.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C162},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC13 (Mod390Key.AR_C163.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C163},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC14 (Mod390Key.AR_C167.getDescription() ,new Mod390Key[]{null,Mod390Key.AR_C167},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
