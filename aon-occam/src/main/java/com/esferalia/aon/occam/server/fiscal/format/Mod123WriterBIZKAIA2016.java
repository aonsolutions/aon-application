...
public class Mod123WriterBIZKAIA2016 implements IMod123Writer{ 

	private static enum Mod123File {
		
		BIZKAIA_R01_2016 ( mod123 -> true ,new IPropertyFiller[] {
		...
		,BIZKAIA_R02_2016 ( mod123 -> true ,new IPropertyFiller[] {
		...
		,BIZKAIA_RA3_2016 ( mod123 -> true ,new IPropertyFiller[] {
		...
		,BIZKAIA_R05_2016 ( mod123 -> true ,new IPropertyFiller[] {
		...
		,BIZKAIA_P00_2016 ( mod123 -> true ,new IPropertyFiller[] {
