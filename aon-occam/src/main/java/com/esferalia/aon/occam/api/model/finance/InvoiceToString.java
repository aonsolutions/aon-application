...
public class InvoiceToString {
	...
	private static boolean ABBRV = true;

	private InvoiceToString() {
		
	}
	
	private static int getLineSize() {
		return ABBRV ? 110 : 172;
	}
	
	public static StringBuilder print (Invoice invoice) {
	...
	private static final DecimalFormat FMT_BASE = new DecimalFormat("#,##0.0000");

	private static void header(Invoice invoice, StringBuilder out) {
		...
		buf.append(VERTICAL_BAR);
		buf.append(" Fecha: ");
		buf.append( invoice.getIssueDate() == null
			? "SIN FECHA"
			:DATE_FORMAT.format(invoice.getIssueDate()));
		buf.append(AonStringUtils.SPACE);
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.SPACE);
	...
	private static void details(Invoice invoice, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.SPACE);
		buf.append(TOP_LEFT_CORNER);
		buf.append(AonStringUtils.repeat(HORIZONTAL_BAR, getLineSize() - buf.length()));
	...
	private static void detail(InvoiceDetail detail, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.SPACE);
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.SPACE);
		...
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(FMT_BASE.format(detail.getTaxableBase()), 17));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(" ", getLineSize() - buf.length()));
		buf.append(VERTICAL_BAR);
		println(out,buf.toString());
	...
	private static void invoiceTax(InvoiceTax tax, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.SPACE);
		buf.append(VERTICAL_BAR);
		buf.append(">>>>");
		...
		buf.append(" [Base:");
		buf.append(AonStringUtils.leftPad(FMT_BASE.format(tax.getBase()), 17));
		buf.append("] ");
		buf.append("[Cuota:");
	...
	private static void vatBreakdown(Invoice invoice, StringBuilder out) {
	...
	private static void withholding(Invoice invoice, StringBuilder out) {
		...
		if (iw.isPresent()) {
			...
			buf.append(AonStringUtils.leftPad(FMT_BASE.format(iw.get().getBase()), 16));
	...
	private static void vatInvoiceBreakdown(InvoiceBreakdown tax, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.spaces(40));
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.spaces(1));
		buf.append(AonStringUtils.rightPad(tax.getTaxType().getName2(), 5));
		buf.append(AonStringUtils.leftPad(FMT_BASE.format(tax.getBase()), 16));
	...
	private static void totals(Invoice invoice, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		...
		buf.append(AonStringUtils.spaces(38));
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.center(FMT_BASE.format(invoice.getTaxableBase()), 17));
		buf.append(VERTICAL_BAR);
		...
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.center(FMT.format(invoice.getTotal()), 17));
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.spaces(getLineSize() - buf.length()));
		println(out,buf.toString());
	...
	private static void finances(Invoice invoice, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.SPACE);
		buf.append(TOP_LEFT_CORNER);
		buf.append(AonStringUtils.repeat(HORIZONTAL_BAR, getLineSize() - buf.length()));
	...
	private static void finance(Finance finance, StringBuilder out) {
		StringBuilder buf = new StringBuilder();
		buf.append(AonStringUtils.SPACE);
		buf.append(VERTICAL_BAR);
		buf.append(AonStringUtils.SPACE);
		...
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(FMT_BASE.format(finance.getAmount()), 17));
		buf.append(AonStringUtils.SPACE);
		buf.append(AonStringUtils.leftPad(" ", getLineSize() - buf.length()));
		buf.append(VERTICAL_BAR);
		println(out,buf.toString());
	...
	private static void fiscal(Invoice invoice, StringBuilder out) {
	...
	private static void doc(Invoice invoice, StringBuilder out) {
		invoice.getDoc()
			.ifPresent( d -> {
	...
	private static void messages(Invoice invoice, StringBuilder out) {
