...
import com.esferalia.aon.occam.server.fiscal.format.mod180.Mod180Writer.IPropertyFiller;
...
enum Mod180File2014 {
	...
	static void fill(Mod180 mod180, Writer wr) throws IOException {
		TYPE_1.fillPage(mod180, null, wr);
		for (Mod180Detail detail : mod180.getDetails()) {
			TYPE_2.fillPage(mod180, detail, wr);	
		}
	}
