...
enum Mod190File2025Araba {
	TYPE_1 (new IPropertyFiller[] { 
	   ...
	   ,(wr, mod190,detail) -> wr.append(AonStringUtils.repeat(' ', 58))
	...
	private Mod190File2025Araba(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2025Araba.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2025Araba.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
