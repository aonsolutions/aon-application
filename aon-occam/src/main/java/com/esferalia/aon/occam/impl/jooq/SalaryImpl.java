...
public class SalaryImpl implements ISalary {
	...
	@Override
	public Stream<SalaryAccountEntry> getSalaryAccountEntries(AONContext ctx,Integer enterprise
			,Date from, Date to, String concept, Integer registryBank) {
		return SalaryDAO.getSalaryEntries(ctx, enterprise, from, to, concept, registryBank);
	}
