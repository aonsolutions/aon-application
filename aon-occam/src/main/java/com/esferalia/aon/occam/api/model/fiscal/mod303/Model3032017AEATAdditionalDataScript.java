...
public enum Model3032017AEATAdditionalDataScript implements IModelScript<Mod303Key> {
	...
	,ADC03 ("Operaciones no sujetas o con inversi\u00F3n del sujeto pasivo que originan el derecho a deducci\u00F3n"
		,new Mod303Key[]{null					,Mod303Key.CT_C61},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	...
	private Model3032017AEATAdditionalDataScript(String label, Mod303Key[] keys, KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
