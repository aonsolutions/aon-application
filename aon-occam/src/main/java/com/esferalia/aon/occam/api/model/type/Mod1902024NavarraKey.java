...
public enum Mod1902024NavarraKey {
	...
	,L ("L - Rentas exentas y dietas exceptuadas de gravamen."
		,new String[] { "01", "02", "03", "04", "05", "06" , "07", "08", "09", "10", "11", "12" , "13", "14", "15", "16", "17", "19", "20", "22", "23", "24", "25", "26", "28", "29", "30", "31", "32", "33" }
	)
	...
	private Mod1902024NavarraKey(String description, String[] subKeys) {
	...
	public static Mod1902024NavarraKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902024NavarraKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902024NavarraKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902024NavarraKey.G.subKeys[2];
	}
	public static Mod1902024NavarraKey getDefaultKeyForFarmerRetentions() {
		return Mod1902024NavarraKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902024NavarraKey.H.subKeys[0];
	}
	public static Mod1902024NavarraKey getDefaultKeyForTransportRetentions() {
		return Mod1902024NavarraKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902024NavarraKey.H.subKeys[3];
	}
}
