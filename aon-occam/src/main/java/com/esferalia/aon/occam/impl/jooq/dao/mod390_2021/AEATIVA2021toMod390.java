package com.esferalia.aon.occam.impl.jooq.dao.mod390_2021;
...
import com.esferalia.aon.occam.api.model.fiscal.Mod3902021.DeductionRegime;
...
import com.esferalia.aon.occam.api.model.fiscal.Mod3902021.Prorrata;
...
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.Administraciones;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.DatEstadisticos;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.DatEstadisticos.Otras;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.DatIdent;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.Devengo;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.LiqAnual;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.OpEspecificas;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.Prorratas;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.Prorratas.Pro;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegGeneral.BaseImponibleyCuota;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegGeneral.Deducciones;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado.ActAgricGanadForest;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado.Actividad;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado.Actividad.Modulo;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado.IvaDeducible;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.RegSimplificado.IvaDevengado;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.ResLiquidaciones;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.ResLiquidaciones.PerNoRegGrupos;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.ResLiquidaciones.PerSiRegGrupos;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2021.AEATIVA2021.VolOperaciones;
import com.esferalia.aon.watson.util.AonStringUtils;

public class AEATIVA2021toMod390 {

	private static final DateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");

	public static void populate(Mod3902021 mod390, AEATIVA2021 iva)
		...
		Map<Mod3902021DetailKey, Mod390Detail> map = new TreeMap<Mod3902021DetailKey, Mod390Detail>();
		...
		if (iva.getRegGeneral() != null) {
			...
			if (b != null) {
				if (b.getRegOrdinario() != null) {
					put(mod390, Mod3902021DetailKey.C0002, b.getRegOrdinario()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0004, b.getRegOrdinario()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0006, b.getRegOrdinario()
							.getTipo21());
				}
				if (b.getRegCriterioCaja() != null) {
					put(mod390, Mod3902021DetailKey.C0644, b.getRegCriterioCaja().getTipo4());
					put(mod390, Mod3902021DetailKey.C0646, b.getRegCriterioCaja().getTipo10());
					put(mod390, Mod3902021DetailKey.C0648, b.getRegCriterioCaja().getTipo21());
				}
				if (b.getOpIntragrupo() != null) {
					put(mod390, Mod3902021DetailKey.C0501, b.getOpIntragrupo()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0503, b.getOpIntragrupo()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0505, b.getOpIntragrupo()
							.getTipo21());
				}
				if (b.getRegBienesUsados() != null) {
					put(mod390, Mod3902021DetailKey.C0008, b.getRegBienesUsados()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0010, b.getRegBienesUsados()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0012, b.getRegBienesUsados()
							.getTipo21());
				}
				if (b.getRegAgViajes() != null) {
					put(mod390, Mod3902021DetailKey.C0014, b.getRegAgViajes()
							.getTipo21());
				}
				if (b.getAdqIntracomBienes() != null) {
					put(mod390, Mod3902021DetailKey.C0022, b
							.getAdqIntracomBienes().getTipo4());
					put(mod390, Mod3902021DetailKey.C0024, b
							.getAdqIntracomBienes().getTipo10());
					put(mod390, Mod3902021DetailKey.C0026, b
							.getAdqIntracomBienes().getTipo21());
				}
				if (b.getAdqIntracomServicios() != null) {
					put(mod390, Mod3902021DetailKey.C0546, b
							.getAdqIntracomServicios().getTipo4());
					put(mod390, Mod3902021DetailKey.C0548, b
							.getAdqIntracomServicios().getTipo10());
					put(mod390, Mod3902021DetailKey.C0552, b
							.getAdqIntracomServicios().getTipo21());
				}
				if (b.getIVAdevengadoInversionSP() != null) {
					put(mod390, Mod3902021DetailKey.C0028, b
							.getIVAdevengadoInversionSP().getTipoX());
				}
				if (b.getModBasesyCuotas() != null) {
					put(mod390, Mod3902021DetailKey.C0030, b.getModBasesyCuotas()
							.getTipoX());
				}
				if (b.getModBasesyCuotasConcursoAcreedores() != null) {
					put(mod390, Mod3902021DetailKey.C0032, b
							.getModBasesyCuotasConcursoAcreedores().getTipoX());
				}
				if (b.getTotalBasesyCuotasIVA() != null) {
					put(mod390, Mod3902021DetailKey.C0034, b
							.getTotalBasesyCuotasIVA().getTipoX());
				}
				if (b.getRecargoEquivalencia() != null) {
					put(mod390, Mod3902021DetailKey.C0036, b
							.getRecargoEquivalencia().getTipo05());
					put(mod390, Mod3902021DetailKey.C0600, b
							.getRecargoEquivalencia().getTipo14());
					put(mod390, Mod3902021DetailKey.C0042, b
							.getRecargoEquivalencia().getTipo175());
					put(mod390, Mod3902021DetailKey.C0602, b
							.getRecargoEquivalencia().getTipo52());
				}
				if (b.getModRecargoEquivalencia() != null) {
					put(mod390, Mod3902021DetailKey.C0044, b
							.getModRecargoEquivalencia().getTipoX());
				}
				if (b.getModRecargoEquivalenciaConcursoAcreedores() != null) {
					put(mod390, Mod3902021DetailKey.C0046, b
							.getModRecargoEquivalenciaConcursoAcreedores()
							.getTipoX());
				}
				if (b.getTotalCuotasIVA() != null) {
					put(mod390, Mod3902021DetailKey.C0047, b.getTotalCuotasIVA());
				}
			}
			if (iva.getRegGeneral().getDeducciones() != null) {
				...
				if (d.getOpInterioresBienesServiciosCorrientes() != null) {
					put(mod390, Mod3902021DetailKey.C0191, d
							.getOpInterioresBienesServiciosCorrientes()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0604, d
							.getOpInterioresBienesServiciosCorrientes()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0606, d
							.getOpInterioresBienesServiciosCorrientes()
							.getTipo21());
					put(mod390, Mod3902021DetailKey.C0049, d
							.getOpInterioresBienesServiciosCorrientes()
							.getTotal());
				}
				if (d.getOpIntragrupoCorrientes() != null) {
					put(mod390, Mod3902021DetailKey.C0507, d
							.getOpIntragrupoCorrientes().getTipo4());
					put(mod390, Mod3902021DetailKey.C0608, d
							.getOpIntragrupoCorrientes().getTipo10());
					put(mod390, Mod3902021DetailKey.C0610, d
							.getOpIntragrupoCorrientes().getTipo21());
					put(mod390, Mod3902021DetailKey.C0513, d
							.getOpIntragrupoCorrientes()
							.getTotal());
				}
				if (d.getOpInterioresBienesInversion() != null) {
					put(mod390, Mod3902021DetailKey.C0197, d
							.getOpInterioresBienesInversion().getTipo4());
					put(mod390, Mod3902021DetailKey.C0612, d
							.getOpInterioresBienesInversion().getTipo10());
					put(mod390, Mod3902021DetailKey.C0614, d
							.getOpInterioresBienesInversion().getTipo21());
					put(mod390, Mod3902021DetailKey.C0051, d
							.getOpInterioresBienesInversion()
							.getTotal());
				}
				if (d.getOpIntragrupoBienesInversion() != null) {
					put(mod390, Mod3902021DetailKey.C0515, d
							.getOpIntragrupoBienesInversion().getTipo4());
					put(mod390, Mod3902021DetailKey.C0616, d
							.getOpIntragrupoBienesInversion().getTipo10());
					put(mod390, Mod3902021DetailKey.C0618, d
							.getOpIntragrupoBienesInversion().getTipo21());
					put(mod390, Mod3902021DetailKey.C0521, d
							.getOpIntragrupoBienesInversion()
							.getTotal());
				}
				if (d.getImportacionesBienesCorrientes() != null) {
					put(mod390, Mod3902021DetailKey.C0203, d
							.getImportacionesBienesCorrientes().getTipo4());
					put(mod390, Mod3902021DetailKey.C0620, d
							.getImportacionesBienesCorrientes().getTipo10());
					put(mod390, Mod3902021DetailKey.C0622, d
							.getImportacionesBienesCorrientes().getTipo21());
					put(mod390, Mod3902021DetailKey.C0053, d
							.getImportacionesBienesCorrientes()
							.getTotal());
				}
				if (d.getImportacionesBienesInversion() != null) {
					put(mod390, Mod3902021DetailKey.C0209, d
							.getImportacionesBienesInversion().getTipo4());
					put(mod390, Mod3902021DetailKey.C0624, d
							.getImportacionesBienesInversion().getTipo10());
					put(mod390, Mod3902021DetailKey.C0626, d
							.getImportacionesBienesInversion().getTipo21());
					put(mod390, Mod3902021DetailKey.C0055, d
							.getImportacionesBienesInversion()
							.getTotal());
				}
				if (d.getAdqIntracomunitariasBienesCorrientes() != null) {
					put(mod390, Mod3902021DetailKey.C0215, d
							.getAdqIntracomunitariasBienesCorrientes()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0628, d
							.getAdqIntracomunitariasBienesCorrientes()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0630, d
							.getAdqIntracomunitariasBienesCorrientes()
							.getTipo21());
					put(mod390, Mod3902021DetailKey.C0057, d
							.getAdqIntracomunitariasBienesCorrientes()
							.getTotal());
				}
				if (d.getAdqIntracomunitariasBienesInversion() != null) {
					put(mod390, Mod3902021DetailKey.C0221, d
							.getAdqIntracomunitariasBienesInversion()
							.getTipo4());
					put(mod390, Mod3902021DetailKey.C0632, d
							.getAdqIntracomunitariasBienesInversion()
							.getTipo10());
					put(mod390, Mod3902021DetailKey.C0634, d
							.getAdqIntracomunitariasBienesInversion()
							.getTipo21());
					put(mod390, Mod3902021DetailKey.C0059, d
							.getAdqIntracomunitariasBienesInversion()
							.getTotal());
				}
				if (d.getAdqIntracomunitariasServicios() != null) {
					put(mod390, Mod3902021DetailKey.C0588, d
							.getAdqIntracomunitariasServicios().getTipo4());
					put(mod390, Mod3902021DetailKey.C0636, d
							.getAdqIntracomunitariasServicios().getTipo10());
					put(mod390, Mod3902021DetailKey.C0638, d
							.getAdqIntracomunitariasServicios().getTipo21());
					put(mod390, Mod3902021DetailKey.C0598, d
							.getAdqIntracomunitariasServicios()
							.getTotal());
				}
				if (d.getComRegAgricGanadPesca() != null) {
					put(mod390, Mod3902021DetailKey.C0061, d
							.getComRegAgricGanadPesca().getTipoX());
				}
				if (d.getRectifDeducciones() != null) {
					put(mod390, Mod3902021DetailKey.C0062, d.getRectifDeducciones()
							.getTipoX());
				}
				if (d.getRectifOpIntragrupo() != null) {
					put(mod390, Mod3902021DetailKey.C0652, d.getRectifOpIntragrupo()
							.getTipoX());
				}
				if (d.getRegularizInversiones() != null) {
					put(mod390, Mod3902021DetailKey.C0063,
							d.getRegularizInversiones());
				}
				if (d.getRegularizPorcProrrata() != null) {
					put(mod390, Mod3902021DetailKey.C0522,
							d.getRegularizPorcProrrata());
				}
				if (d.getSumDeducciones() != null) {
					put(mod390, Mod3902021DetailKey.C0064, d.getSumDeducciones());
				}
			...
			if (AonStringUtils.isNotEmpty(res)) {
				try {
					...
					put(mod390, Mod3902021DetailKey.C0065, new BigDecimal(val));
				} catch (NumberFormatException e) {
					// Nothing
				}
			}
	...
	private static void put(Mod3902021 mod390, Mod3902021DetailKey key,
	...
	private static void put(Mod3902021 mod390, Mod3902021DetailKey key, BigDecimal quota) {
		if (quota != null) {
			Mod390Detail detail = new Mod390Detail();
			detail.setKey(key);
			detail.setPercent(key.getPercent());
