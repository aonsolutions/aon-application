...
public enum Mod3902025DetailKey implements Serializable {
...
//	 ,C0776	(776,	 7.50,true ,false,true)
	...
	private Mod3902025DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly) {
		this(box, percent, taxableBaseAvailable, readonly, false);	
	}
	
	private Mod3902025DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly, boolean prorrata) {
