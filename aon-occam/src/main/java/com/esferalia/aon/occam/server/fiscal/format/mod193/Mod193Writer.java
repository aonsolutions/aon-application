	...
	private enum Writers {
		Mod193_File2025 {
			...
			void fill(Mod193 mod193, Writer wr) throws IOException {
				Mod193File2025.fill(mod193, wr);
			}
			
			@Override
			boolean accept(Mod193 mod193) {
				return mod193.getYear() >= 2025;				
			}
		},
		Mod193_File2024 {
			...
			@Override
			void fill(Mod193 mod193, Writer wr) throws IOException {
				Mod193File2024.fill(mod193, wr);
			}
			
			@Override
			boolean accept(Mod193 mod193) {
				return mod193.getYear() == 2024;				
			}
		},
		Mod193_File2023 {
			...
			@Override
			void fill(Mod193 mod193, Writer wr) throws IOException {
				Mod193File2023.fill(mod193, wr);
			}
			
			@Override
			boolean accept(Mod193 mod193) {
				return mod193.getYear() == 2023;				
			}
		},
		Mod193_File2016 {
			...
			@Override
			boolean accept(Mod193 mod193) {
				return mod193.getYear() >= 2016 && mod193.getYear() < 2023;				
			}
		},
		Mod193_File2014 {
