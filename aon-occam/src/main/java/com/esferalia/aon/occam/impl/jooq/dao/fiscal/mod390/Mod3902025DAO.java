...
import com.esferalia.aon.occam.api.model.fiscal.mod390.Mod3902025.Mod390Detail;
import com.esferalia.aon.occam.api.model.fiscal.mod390.Mod3902025DetailKey;
...
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2025.AEATIVA2025;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2025.AEATIVA2025toMod390;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2025.Mod390toAEATIVA2025;
...
//	public static final double SURCHARGE_PERCENT10 = 1.0;
	...
	public static interface IMod390DetailKey {
		boolean accept(Mod3902025 mod,VatContext vc);
	}

	private static class KeyedVatContext  {
		private Mod3902025DetailKeyDAO key;
		private VatContext vc;
		
		private KeyedVatContext(Mod3902025DetailKeyDAO key,VatContext vc) {
			this.key = key;
			this.vc = vc;
		}
		public Mod3902025DetailKeyDAO getKey() {
			return key;
		}
	...
	public enum Mod3902025DetailKeyDAO implements Serializable {
		// IVA devengado
	 	// Régimen ordinario
		  C0701	(Mod3902025DetailKey.C0701, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent0(vc))
//		 ,C0668 (Mod3902025DetailKey.C0668, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent2(vc))
		 ,C0002 (Mod3902025DetailKey.C0002, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent4(vc))		
//		 ,C0703	(Mod3902025DetailKey.C0703, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent5(vc))
//		 ,C0670 (Mod3902025DetailKey.C0670, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent75(vc))
		 ,C0004	(Mod3902025DetailKey.C0004, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent10(vc))
		 ,C0006	(Mod3902025DetailKey.C0006, (mod, vc) -> isCommonNationalSales(vc, mod) && !vc.isVatAccrualRegime() && hasPercent21(vc))
	 	// Operaciones intragrupo
		 ,C0705	(Mod3902025DetailKey.C0705, null)
//		 ,C0672	(Mod3902025DetailKey.C0672, null)
		 ,C0501	(Mod3902025DetailKey.C0501, null)
//		 ,C0707	(Mod3902025DetailKey.C0707, null)
//		 ,C0674	(Mod3902025DetailKey.C0674, null)
		 ,C0503	(Mod3902025DetailKey.C0503, null)
		 ,C0505	(Mod3902025DetailKey.C0505, null)		 
		 // Régimen especial del criterio de caja
		 ,C0709	(Mod3902025DetailKey.C0709, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent0(vc))
//		 ,C0676 (Mod3902025DetailKey.C0676, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent2(vc))
		 ,C0644 (Mod3902025DetailKey.C0644, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent4(vc))		
//		 ,C0711	(Mod3902025DetailKey.C0711, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent5(vc))
//		 ,C0678 (Mod3902025DetailKey.C0678, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent75(vc))
		 ,C0646	(Mod3902025DetailKey.C0646, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent10(vc))
		 ,C0648	(Mod3902025DetailKey.C0648, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isVatAccrualRegime() && hasPercent21(vc))
	 	// Régimen especial de bienes usados, objetos de arte, antigüedades y objetos de colección
		 ,C0713	(Mod3902025DetailKey.C0713, null)
//		 ,C0680	(Mod3902025DetailKey.C0680, null)
		 ,C0008	(Mod3902025DetailKey.C0008, null)
//		 ,C0715	(Mod3902025DetailKey.C0715, null)
//		 ,C0682	(Mod3902025DetailKey.C0682, null)
		 ,C0010	(Mod3902025DetailKey.C0010, null)
		 ,C0012	(Mod3902025DetailKey.C0012, null)
	 	// Régimen especial de agencias de viaje
		 ,C0014	(Mod3902025DetailKey.C0014, null)
	 	// Adquisiciones intracomunitarias de bienes
		 ,C0717	(Mod3902025DetailKey.C0717, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent0(vc))
//		 ,C0684	(Mod3902025DetailKey.C0684, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent2(vc))
		 ,C0022	(Mod3902025DetailKey.C0022, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent4(vc))
//		 ,C0719	(Mod3902025DetailKey.C0719, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent5(vc))
//		 ,C0686	(Mod3902025DetailKey.C0686, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent75(vc))
		 ,C0024	(Mod3902025DetailKey.C0024, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent10(vc))
		 ,C0026	(Mod3902025DetailKey.C0026, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent21(vc))
	 	// Adquisiciones intracomunitarias de servicios
		 ,C0721	(Mod3902025DetailKey.C0721, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent0(vc))
//		 ,C0688	(Mod3902025DetailKey.C0688, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent2(vc))
		 ,C0546	(Mod3902025DetailKey.C0546, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent4(vc))
//		 ,C0723	(Mod3902025DetailKey.C0723, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent5(vc))
//		 ,C0690	(Mod3902025DetailKey.C0690, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent75(vc))
		 ,C0548	(Mod3902025DetailKey.C0548, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent10(vc))
		 ,C0552	(Mod3902025DetailKey.C0552, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent21(vc))
	 	// IVA devengado en otros supuestos de inversión del sujeto pasivo
		 ,C0028	(Mod3902025DetailKey.C0028, (mod, vc) -> isOperacionesISPFilter(vc) && !vc.isRectification()) 
	 	// Modificación de bases y cuotas
		 ,C0030	(Mod3902025DetailKey.C0030, (mod, vc) -> modificacionBasesYCuotasFilter(vc))
	 	// Modificación de bases y cuotas de operaciones intragrupo
		 ,C0650 (Mod3902025DetailKey.C0650, null)	
	 	// Modificación de bases y cuotas por auto de declaración de concurso de acreedores
		 ,C0032	(Mod3902025DetailKey.C0032, null)
	 	// Total bases y cuotas IVA
		 ,C0034	(Mod3902025DetailKey.C0034, null)
	 	// Recargo de equivalencia
//		 ,C0664 (Mod3902025DetailKey.C0664, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent00(vc))
//		 ,C0692 (Mod3902025DetailKey.C0692, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent026(vc))
		 ,C0036 (Mod3902025DetailKey.C0036, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent05(vc))
//		 ,C0666 (Mod3902025DetailKey.C0666, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent062(vc))
//		 ,C0694 (Mod3902025DetailKey.C0694, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent10(vc))
		 ,C0600 (Mod3902025DetailKey.C0600, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent14(vc))
		 ,C0602 (Mod3902025DetailKey.C0602, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent52(vc))
		 ,C0042	(Mod3902025DetailKey.C0042, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent175(vc))
		 ,C0044	(Mod3902025DetailKey.C0044, (mod, vc) -> isCommonNationalSalesRECT(vc, mod) && vc.isSurcharge())
	 	// Modificación recargo equivalencia
		 ,C0046	(Mod3902025DetailKey.C0046, null)
	 	//  Total cuotas IVA y recargo de equivalencia
		 ,C0047	(Mod3902025DetailKey.C0047, null)

		 // IVA deducible
		 // Operaciones interiores corrientes
		 // IVA deducible en operaciones interiores de bienes y servicios corrientes
		 ,C0696	(Mod3902025DetailKey.C0696, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent2(vc)))
		 ,C0191	(Mod3902025DetailKey.C0191, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0725	(Mod3902025DetailKey.C0725, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0698	(Mod3902025DetailKey.C0698, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0604	(Mod3902025DetailKey.C0604, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0606	(Mod3902025DetailKey.C0606, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en operaciones interiores de bienes y servicios corrientes
		 ,C0049	(Mod3902025DetailKey.C0049, null)
		 // IVA deducible en operaciones intragrupo de bienes y servicios corrientes
		 ,C0746	(Mod3902025DetailKey.C0746, null)
		 ,C0507	(Mod3902025DetailKey.C0507, null)
		 ,C0727	(Mod3902025DetailKey.C0727, null)
		 ,C0748	(Mod3902025DetailKey.C0748, null)
		 ,C0608	(Mod3902025DetailKey.C0608, null)
		 ,C0610	(Mod3902025DetailKey.C0610, null)
		 // Total bases imponibles y cuotas deducibles en operaciones intragrupo de bienes y servicios corrientes
		 ,C0513	(Mod3902025DetailKey.C0513, null)
...
//		 ,C0756	(Mod3902025DetailKey.C0756, null)
		 ...
		 ,C0733	(Mod3902025DetailKey.C0733, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0760	(Mod3902025DetailKey.C0760, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0620	(Mod3902025DetailKey.C0620, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0622	(Mod3902025DetailKey.C0622, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent21(vc)))
...
//		 ,C0764	(Mod3902025DetailKey.C0764, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent75(vc)))
		 ...
		 ,C0055	(Mod3902025DetailKey.C0055, null)
		 
		 // IVA deducible en adquisiciones intracomunitarias de bienes corrientes
		 ,C0766	(Mod3902025DetailKey.C0766, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent2(vc)))
		 ,C0215	(Mod3902025DetailKey.C0215, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0737	(Mod3902025DetailKey.C0737, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0768	(Mod3902025DetailKey.C0768, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0628	(Mod3902025DetailKey.C0628, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0630	(Mod3902025DetailKey.C0630, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent21(vc)))
...
//		 ,C0776	(Mod3902025DetailKey.C0776, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent75(vc)))
		 ...
		 ,C0598	(Mod3902025DetailKey.C0598, null)

		 // Compensación en régimen especial de la agricultura, ganaderia y pesca
		 ,C0061	(Mod3902025DetailKey.C0061, ((mod, vc) -> compensacionesRegAgrarioFilter(vc)))
		 // Cuotas deducibles en virtud de resolución administrativa o sentencia firmes con tipos no vigentes
		 ,C0661	(Mod3902025DetailKey.C0661, null)
		 // Rectificación de deducciones
		 ,C0062	(Mod3902025DetailKey.C0062, ((mod, vc) -> vc.isRectification() && (vc.isPurchase() || vc.isExpenses()) && AonMathUtils.isNotZero(vc.getPercentage())))
		 // Rectificación de deducciones por operaciones intragrupo
		 ,C0652	(Mod3902025DetailKey.C0652, null)
		 // Regularización de bienes de inversión
		 ,C0063	(Mod3902025DetailKey.C0063, null)
		 // Regularización por aplicación porcentaje definitivo de prorrata
		 ,C0522	(Mod3902025DetailKey.C0522, null)
		 // Suma de deducciones
		 ,C0064	(Mod3902025DetailKey.C0064, null)
		 
		 // Resultado régimen general
		 ,C0065	(Mod3902025DetailKey.C0065, null)
		 
		 // Operaciones en régimen general
		 ,C0099	 (Mod3902025DetailKey.C0099, ((mod, vc) -> (vc.isNationalSales() && !vc.isVatAccrualRegime() && vc.isVatGeneralRegime(mod.isSimplifiedRegime()?VATRegime.SIMPLIFIED:VATRegime.GENERAL))))
		 ...
		 ,C0653	 (Mod3902025DetailKey.C0653, null) // Se obtiene en getDetails()
		 // Entregas intracomunitarias de bienes y servicios
		 ,C0103	 (Mod3902025DetailKey.C0103, ((mod, vc) -> ( vc.isIntracommunitySales() && !vc.isWithoutRightDeductionType())))
		 // Exportaciones y otras operaciones exentas con derecho a deducción
		 ,C0104	 (Mod3902025DetailKey.C0104, ((mod, vc) -> (vc.isSales() && !vc.isWithoutRightDeductionType() && vc.isExtracommunity() && !vc.isService())))
		 ...
		 ,C0105	 (Mod3902025DetailKey.C0105, ((mod, vc) -> ((vc.isSales() && !vc.isNational() && vc.isWithoutRightDeductionType()) || (vc.isNationalSales() && AonMathUtils.isZero(vc.getPercentage()) && vc.getVatRegime() != null && vc.isActivityVatExempt()))))
		 ...
		 ,C0110	 (Mod3902025DetailKey.C0110, ((mod, vc) -> (vc.isSales() && !vc.isWithoutRightDeductionType() && ((vc.isOtherISP() && !vc.isSpainDocumentCountry()) || vc.isCanCeuMel() || (vc.isExtracommunity() && vc.isService())))))
		 // Operaciones sujetas con inversión del sujeto pasivo (Ventas ISP de clientes españoles)
		 ,C0125	 (Mod3902025DetailKey.C0125, ((mod, vc) -> vc.isOtherISPSales() && vc.isSpainDocumentCountry()))
		 // Operaciones no sujetas por reglas de localización acogidas a los regímenes especiales de ventanilla única
		 ,C0126	 (Mod3902025DetailKey.C0126, ((mod, vc) -> (vc.isSalesOSS() && !vc.isSpainDocumentCountry())))
		 // Operaciones sujetas y acogidas a los regímenes especiales de ventanilla única
		 ,C0127	 (Mod3902025DetailKey.C0127, ((mod, vc) -> (vc.isSalesOSS() && vc.isSpainDocumentCountry())))
		 // Operaciones intragrupo valoradas conforme a lo dispuesto en los arts. 78 y 79 LIVA
		 ,C0128	 (Mod3902025DetailKey.C0128, null)
		 // Operaciones en régimen simplificado
		 ,C0100	 (Mod3902025DetailKey.C0100, ((mod, vc) -> (vc.isNationalSales() && vc.isVatSimplifiedRegime())))
		 // Operaciones en régimen especial de la agricultura, ganadería y pesca
		 ,C0101	 (Mod3902025DetailKey.C0101, null)
		 // Operaciones realizadas por sujetos pasivos acogidos al régimen especial del recargo de equivalencia
		 ,C0102	 (Mod3902025DetailKey.C0102, ((mod, vc) -> (vc.isNationalSales() && vc.isVatSurchargeRegime())))
		 // Operaciones en Régimen especial de bienes usados, objetos de arte, antigüedades y objetos de colección
		 ,C0227	 (Mod3902025DetailKey.C0227, null)
		 // Operaciones en régimen especial de Agencias de Viajes
		 ,C0228	 (Mod3902025DetailKey.C0228, null)
		 // Entregas de bienes inmuebles, operaciones financieras y relativas al oro de inversión no habituales
		 ,C0106	 (Mod3902025DetailKey.C0106, null)
		 // Entregas de bienes de inversión
		 ,C0107	 (Mod3902025DetailKey.C0107, ((mod, vc) -> (vc.isNationalSales() && vc.isInvestment())))
		 // Total volumen de operaciones 
		 ,C0108	 (Mod3902025DetailKey.C0108, null)
		 // Operaciones específicas - Adquisiciones interiores de bienes y servicios exentas 
		 ,C0230	 (Mod3902025DetailKey.C0230, ((mod, vc) -> operacionesInterioresExentasFilter(vc)))
		 ;		 
		 
		private Mod3902025DetailKey key;
		private IMod390DetailKey accept;
			
		private Mod3902025DetailKeyDAO(Mod3902025DetailKey key, IMod390DetailKey accept) {
			this.key = key;
			this.accept = accept;
		}

		public Mod3902025DetailKey getKey() {
			return key;
		}
		public boolean accept(Mod3902025 mod, VatContext vc) {
			return accept!=null && accept.accept(mod,vc);
		}
		
	}

	private static EnumMap<Mod3902025DetailKey, Mod390Detail> getDetails(AONContext ctx, Mod3902025 mod390 ) {
		EnumMap<Mod3902025DetailKey, Mod390Detail> map = new EnumMap<>(Mod3902025DetailKey.class);
		Arrays.stream( Mod3902025DetailKey.values() )
			.forEach(key ->  map.put(key, new Mod390Detail().setKey(key).setPercent(key.getPercent())));
		VATDAO.getVatBreakdown(ctx, mod390)
			.flatMap(vt -> Arrays.stream( Mod3902025DetailKeyDAO.values() )
			...
			.forEach(Mod3902025DAO::add );
		
		// Regimen especial de criterio de caja.
		double vatAccBase = getVatAccrualPaymentOutputBase(ctx, mod390); 
		map.get(Mod3902025DetailKey.C0653).setTaxableBase( vatAccBase );
		map.get(Mod3902025DetailKey.C0654).setTaxableBase( vatAccBase );
		map.get(Mod3902025DetailKey.C0654).setQuota( getVatAccrualPaymentOutputQuota(ctx, mod390) );
		map.get(Mod3902025DetailKey.C0656).setTaxableBase( getVatAccrualPaymentInputBase(ctx, mod390) );
		map.get(Mod3902025DetailKey.C0656).setQuota( getVatAccrualPaymentInputQuota(ctx, mod390) );
		...
		Mod303DAO.getEffectiveModels(ctx, mod390, cond)
			...
			.forEach( r -> map.computeIfAbsent(Mod3902025DetailKey.C0522, k -> new Mod390Detail().setKey(k)).setQuota(r))
		;
		return map;
	}
	...
	private static void add(Pair<KeyedVatContext, Mod390Detail> pair) {
		...
		Mod3902025DetailKey key = kvt.getKey().getKey();
	...
	private static void fillGeneralDeclarationResults(AONContext ctx, Mod3902025 mod390) {
	...
	private static void fillFromConfiguration(AONContext ctx, Mod3902025 mod390) {
	...
	// **********************************************************************************************
	// **********************************************************************************************
	public static Mod3902025 create(AONContext ctx, Mod390 model) {
		Mod3902025 mod390 =  new Mod3902025();
	...
	public static Mod3902025 getById(AONContext ctx, int id) {
		ctx.checkRead();
		Mod3902025 mod390 = new Mod3902025();
		ctx.getDslContext()
	...
	private static void populate(FsModel390Record rec, Mod3902025 mod390)  {
		mod390
		...
		if (AonStringUtils.contains(model, "<AEATIVA2025>"))  {
			StringReader reader = new StringReader(rec.getValue(FS_MODEL390.MODEL));
			try {
				if (mod390.getYear() >= 2025) {
					JAXBContext context = JAXBContext.newInstance(AEATIVA2025.class);
					Unmarshaller um = context.createUnmarshaller();
					AEATIVA2025 iva = (AEATIVA2025) um.unmarshal(reader);
					AEATIVA2025toMod390.populate(mod390, iva);
					mod390.setXmlFormat("AEAT_2025");
				} else {
	...
	public static Mod3902025 save(AONContext ctx, Mod3902025 mod390)  {
		if (mod390.getId() == null) {
	...
	private static String getXMLModel( Mod3902025 mod390 ) {
		try {
			if (mod390.getYear() >= 2025) {
				AEATIVA2025 iva = Mod390toAEATIVA2025.getAEATIVA2025(mod390);
	...
	private static Mod3902025 insert(AONContext ctx, Mod3902025 mod390) {
		validate(ctx, mod390);
	...
	private static Mod3902025 update(AONContext ctx, Mod3902025 mod390) {
		validate(ctx, mod390);
		mod390.calculate();
		ctx.getDslContext()
			.update(FS_MODEL390)
	...
	private static void validate(AONContext ctx, Mod3902025 mod390) {
...
//					.and(FS_MODEL390.RECEIPT.equal(mod390.getReplacedReceipt()))
					.and(FS_MODEL390.ADMINISTRATION.equal(mod390.getAdministration().value()))
					)
					.fetch()
					.stream()
					.findFirst()
	...
	public static void delete(AONContext ctx, Mod3902025 mod390) {
		ctx.checkWrite();
		ctx.getDslContext().delete(FS_MODEL390)
				.where(FS_MODEL390.ID.equal(mod390.getId())).execute();
	}
	
	private static Mod3902025 fillGeneralRegimeData(AONContext ctx, Mod3902025 mod390) {
		try {
			Mod390Detail det = null;
			EnumMap<Mod3902025DetailKey, Mod390Detail> map = getDetails(ctx, mod390);
			mod390.setBox99 (map.get(Mod3902025DetailKey.C0099).getTaxableBase());
			mod390.setBox100(map.get(Mod3902025DetailKey.C0100).getTaxableBase());
			mod390.setBox101(map.get(Mod3902025DetailKey.C0101).getTaxableBase());
			mod390.setBox102(map.get(Mod3902025DetailKey.C0102).getTaxableBase());
			mod390.setBox103(map.get(Mod3902025DetailKey.C0103).getTaxableBase());
			mod390.setBox104(map.get(Mod3902025DetailKey.C0104).getTaxableBase());
			mod390.setBox105(map.get(Mod3902025DetailKey.C0105).getTaxableBase());
			mod390.setBox106(map.get(Mod3902025DetailKey.C0106).getTaxableBase());
			mod390.setBox107(map.get(Mod3902025DetailKey.C0107).getTaxableBase());
			mod390.setBox108(map.get(Mod3902025DetailKey.C0108).getTaxableBase());
			mod390.setBox110(map.get(Mod3902025DetailKey.C0110).getTaxableBase());
			mod390.setBox125(map.get(Mod3902025DetailKey.C0125).getTaxableBase());
			mod390.setBox126(map.get(Mod3902025DetailKey.C0126).getTaxableBase());
			mod390.setBox127(map.get(Mod3902025DetailKey.C0127).getTaxableBase());
			mod390.setBox128(map.get(Mod3902025DetailKey.C0128).getTaxableBase());
			
			mod390.setBox227(map.get(Mod3902025DetailKey.C0227).getTaxableBase());
			mod390.setBox228(map.get(Mod3902025DetailKey.C0228).getTaxableBase());
			mod390.setBox653(map.get(Mod3902025DetailKey.C0653).getTaxableBase());
			mod390.setBox654(map.get(Mod3902025DetailKey.C0654).getTaxableBase());
			mod390.setBox655(map.get(Mod3902025DetailKey.C0654).getQuota());
			mod390.setAccrualRegime( ( map.get(Mod3902025DetailKey.C0654).getTaxableBase()  != 0 || map.get(Mod3902025DetailKey.C0654).getQuota() != 0 ) );
			mod390.setBox656(map.get(Mod3902025DetailKey.C0656).getTaxableBase());
			mod390.setBox657(map.get(Mod3902025DetailKey.C0656).getQuota());
			mod390.setAccrualRegimeTarget((map.get(Mod3902025DetailKey.C0656).getTaxableBase()  != 0 || map.get(Mod3902025DetailKey.C0656).getQuota() != 0 ));
			mod390.setBox230(map.get(Mod3902025DetailKey.C0230).getTaxableBase());
			...
			if (mod390.isSimplifiedRegime()) {
				map = new EnumMap<>(Mod3902025DetailKey.class);
				for (Mod3902025DetailKey key : Mod3902025DetailKey.values() ) {
...
//		boolean fill(SimplifedRegimeContext src,Mod3902025 mod390);
		void fill(SimplifedRegimeContext src, Mod3902025 mod390);
	}
...
//		;
	...
	enum SimplifiedRegimeFiller {
		...
		CAG1     (Mod303Key.CT_SA11, (src,mod390) -> mod390.getFarmerRegime1().setCodigo(AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(),"-")))), 
		CAG1_V1  (Mod303Key.CT_SA12, (src,mod390) -> mod390.getFarmerRegime1().setIncomes(src.getAmount())),
		CAG1_V2  (Mod303Key.CT_SA13, (src,mod390) -> mod390.getFarmerRegime1().setQuotaIndex( AonMathUtils.round(src.getAmount() / 10000 ,5))),
		CAG1_V3  (Mod303Key.CT_SA14, (src,mod390) -> mod390.getFarmerRegime1().setAccrualQuota(src.getAmount())),
//		CAG1_V4  (Mod303Key.CT_SA1R, (src,mod390) -> {mod390.getFarmerRegime1().setDanaReduction(src.getAmount());}),
		CAG1_V6  (Mod303Key.CT_SA1A, (src,mod390) -> mod390.getFarmerRegime1().setInputQuotas(src.getAmount())),
		CAG1_V7  (Mod303Key.CT_SA18, (src,mod390) -> mod390.getFarmerRegime1().setQuota(src.getAmount())),
		                             
		CAG2     (Mod303Key.CT_SA21, (src,mod390) -> mod390.getFarmerRegime2().setCodigo(AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(), "-")))),
		CAG2_V1  (Mod303Key.CT_SA22, (src,mod390) -> mod390.getFarmerRegime2().setIncomes(src.getAmount())),
		CAG2_V2  (Mod303Key.CT_SA23, (src,mod390) -> mod390.getFarmerRegime2().setQuotaIndex(AonMathUtils.round(src.getAmount() / 10000 ,5))),
		CAG2_V3  (Mod303Key.CT_SA24, (src,mod390) -> mod390.getFarmerRegime2().setAccrualQuota(src.getAmount())),
//		CAG2_V4  (Mod303Key.CT_SA2R, (src,mod390) -> mod390.getFarmerRegime2().setDanaReduction(src.getAmount());}),
		CAG2_V6  (Mod303Key.CT_SA2A, (src,mod390) -> mod390.getFarmerRegime2().setInputQuotas(src.getAmount())),
		CAG2_V7  (Mod303Key.CT_SA28, (src,mod390) -> mod390.getFarmerRegime2().setQuota(src.getAmount())),
		                             
		CAG3     (Mod303Key.CT_SA31, (src,mod390) -> mod390.getFarmerRegime3().setCodigo(AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(), "-")))),
		CAG3_V1  (Mod303Key.CT_SA32, (src,mod390) -> mod390.getFarmerRegime3().setIncomes(src.getAmount())),
		CAG3_V2  (Mod303Key.CT_SA33, (src,mod390) -> mod390.getFarmerRegime3().setQuotaIndex(AonMathUtils.round(src.getAmount() / 10000 ,5))),
		CAG3_V3  (Mod303Key.CT_SA34, (src,mod390) -> mod390.getFarmerRegime3().setAccrualQuota(src.getAmount())),
//		CAG3_V4  (Mod303Key.CT_SA3R, (src,mod390) -> mod390.getFarmerRegime3().setDanaReduction(src.getAmount());}),
		CAG3_V6  (Mod303Key.CT_SA3A, (src,mod390) -> mod390.getFarmerRegime3().setInputQuotas(src.getAmount())),
		CAG3_V7  (Mod303Key.CT_SA38, (src,mod390) -> mod390.getFarmerRegime3().setQuota(src.getAmount())),
		                             
		CAG4     (Mod303Key.CT_SA41, (src,mod390) -> mod390.getFarmerRegime4().setCodigo(AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(), "-")))),
		CAG4_V1  (Mod303Key.CT_SA42, (src,mod390) -> mod390.getFarmerRegime4().setIncomes(src.getAmount())),
		CAG4_V2  (Mod303Key.CT_SA43, (src,mod390) -> mod390.getFarmerRegime4().setQuotaIndex(AonMathUtils.round(src.getAmount() / 10000 ,5))),
		CAG4_V3  (Mod303Key.CT_SA44, (src,mod390) -> mod390.getFarmerRegime4().setAccrualQuota(src.getAmount())),
//		CAG4_V4  (Mod303Key.CT_SA4R, (src,mod390) -> mod390.getFarmerRegime4().setDanaReduction(src.getAmount());}),
		CAG4_V6  (Mod303Key.CT_SA4A, (src,mod390) -> mod390.getFarmerRegime4().setInputQuotas(src.getAmount())),
		CAG4_V7  (Mod303Key.CT_SA48, (src,mod390) -> mod390.getFarmerRegime4().setQuota(src.getAmount())),
		
		CAC1     (Mod303Key.CT_S101, (src,mod390) -> mod390.getSimpRegime1().setEpigrafe(AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(), "-")))),
		CAC1_M1U (Mod303Key.CT_S11I, (src,mod390) -> mod390.getSimpRegime1().setUnit1(src.getAmount())),
		CAC1_M1I (Mod303Key.CT_S11R, (src,mod390) -> mod390.getSimpRegime1().setAmount1(src.getAmount())),
		CAC1_M2U (Mod303Key.CT_S12I, (src,mod390) -> mod390.getSimpRegime1().setUnit2(src.getAmount())),
		CAC1_M2I (Mod303Key.CT_S12R, (src,mod390) -> mod390.getSimpRegime1().setAmount2(src.getAmount())),
		CAC1_M3U (Mod303Key.CT_S13I, (src,mod390) -> mod390.getSimpRegime1().setUnit3(src.getAmount())),
		CAC1_M3I (Mod303Key.CT_S13R, (src,mod390) -> mod390.getSimpRegime1().setAmount3(src.getAmount())),
		CAC1_M4U (Mod303Key.CT_S14I, (src,mod390) -> mod390.getSimpRegime1().setUnit4(src.getAmount())),
		CAC1_M4I (Mod303Key.CT_S14R, (src,mod390) -> mod390.getSimpRegime1().setAmount4(src.getAmount())),
		CAC1_M5U (Mod303Key.CT_S15I, (src,mod390) -> mod390.getSimpRegime1().setUnit5(src.getAmount())),
		CAC1_M5I (Mod303Key.CT_S15R, (src,mod390) -> mod390.getSimpRegime1().setAmount5(src.getAmount())),
		CAC1_M6U (Mod303Key.CT_S16I, (src,mod390) -> mod390.getSimpRegime1().setUnit6(src.getAmount())),
		CAC1_M6I (Mod303Key.CT_S16R, (src,mod390) -> mod390.getSimpRegime1().setAmount6(src.getAmount())),
		CAC1_M7U (Mod303Key.CT_S17I, (src,mod390) -> mod390.getSimpRegime1().setUnit7(src.getAmount())),
		CAC1_M7I (Mod303Key.CT_S17R, (src,mod390) -> mod390.getSimpRegime1().setAmount7(src.getAmount())),
		CAC1_C   (Mod303Key.CT_S117, (src,mod390) -> {
			mod390.getSimpRegime1().setBoxC(src.getAmount());
			mod390.setBox74( AonMathUtils.round(mod390.getBox74() + src.getAmount()));
			}),
		
//		CAC1_C1  (Mod303Key.CT_S1R1, (src,mod390) -> {mod390.getSimpRegime1().setBoxC1(src.getAmount());}),
//		CAC1_C2  (Mod303Key.CT_S1R2, (src,mod390) -> {mod390.getSimpRegime1().setBoxC2(src.getAmount());}),
		CAC1_D   (Mod303Key.CT_S118, null),
		CAC1_Z   (Mod303Key.CT_S119, null),
//		CAC1_ZA  (Mod303Key.CAC1_ZA , null),
//		CAC1_ZD  (Mod303Key.CAC1_ZD , null),
		...
		CAC1_F   (Mod303Key.CT_S121 , null),
//		CAC1_G0  (Mod303Key.CAC1_G0 , (src,mod390) -> {mod390.getSimpRegime1().setBoxD(
//				AonMathUtils.round(mod390.getSimpRegime1().getBoxD() + src.getAmount()));}),
		CAC1_G   (Mod303Key.CT_S122 , (src,mod390) -> mod390.getSimpRegime1().setBoxD(
				AonMathUtils.round(mod390.getSimpRegime1().getBoxD() + src.getAmount()))),
		CAC1_H   (Mod303Key.CT_S123 , (src,mod390) -> mod390.getSimpRegime1().setBoxE(src.getAmount())),
//		CAC1_HA  (Mod303Key.CAC1_HA , null),
//		CAC1_HD  (Mod303Key.CAC1_HD , null),
//		CAC1_HT  (Mod303Key.CAC1_HT , null),
		CAC1_I   (Mod303Key.CT_S124 , (src,mod390) -> mod390.getSimpRegime1().setBoxF(src.getAmount())),
		CAC1_J   (Mod303Key.CT_S125 , (src,mod390) -> mod390.getSimpRegime1().setBoxG(src.getAmount())),
		CAC1_K   (Mod303Key.CT_S126 , null),
		CAC1_L   (Mod303Key.CT_S127 , (src,mod390) -> mod390.getSimpRegime1().setBoxI(src.getAmount())),
		CAC1_M   (Mod303Key.CT_S128 , (src,mod390) -> mod390.getSimpRegime1().setBoxJ(src.getAmount())),
		
		CAC2     (Mod303Key.CT_S201    , (src,mod390) -> {
			String code = AonStringUtils.trim(AonStringUtils.substringBefore(src.getDescription(), "-"));					
			mod390.getSimpRegime2().setEpigrafe(code);
			}),
		CAC2_M1U (Mod303Key.CT_S21I, (src,mod390) -> mod390.getSimpRegime2().setUnit1(src.getAmount())),
		CAC2_M1I (Mod303Key.CT_S21R, (src,mod390) -> mod390.getSimpRegime2().setAmount1(src.getAmount())),
		CAC2_M2U (Mod303Key.CT_S22I, (src,mod390) -> mod390.getSimpRegime2().setUnit2(src.getAmount())),
		CAC2_M2I (Mod303Key.CT_S22R, (src,mod390) -> mod390.getSimpRegime2().setAmount2(src.getAmount())),
		CAC2_M3U (Mod303Key.CT_S23I, (src,mod390) -> mod390.getSimpRegime2().setUnit3(src.getAmount())),
		CAC2_M3I (Mod303Key.CT_S23R, (src,mod390) -> mod390.getSimpRegime2().setAmount3(src.getAmount())),
		CAC2_M4U (Mod303Key.CT_S24I, (src,mod390) -> mod390.getSimpRegime2().setUnit4(src.getAmount())),
		CAC2_M4I (Mod303Key.CT_S24R, (src,mod390) -> mod390.getSimpRegime2().setAmount4(src.getAmount())),
		CAC2_M5U (Mod303Key.CT_S25I, (src,mod390) -> mod390.getSimpRegime2().setUnit5(src.getAmount())),
		CAC2_M5I (Mod303Key.CT_S25R, (src,mod390) -> mod390.getSimpRegime2().setAmount5(src.getAmount())),
		CAC2_M6U (Mod303Key.CT_S26I, (src,mod390) -> mod390.getSimpRegime2().setUnit6(src.getAmount())),
		CAC2_M6I (Mod303Key.CT_S26R, (src,mod390) -> mod390.getSimpRegime2().setAmount6(src.getAmount())),
		CAC2_M7U (Mod303Key.CT_S27I, (src,mod390) -> mod390.getSimpRegime2().setUnit7(src.getAmount())),
		CAC2_M7I (Mod303Key.CT_S27R, (src,mod390) -> mod390.getSimpRegime2().setAmount7(src.getAmount())),
		CAC2_C   (Mod303Key.CT_S217, (src,mod390) -> {
			mod390.getSimpRegime2().setBoxC(src.getAmount());
			mod390.setBox74( AonMathUtils.round(mod390.getBox74() + src.getAmount()));
		}),
//		CAC2_C1  (Mod303Key.CT_S2R1 , (src,mod390) -> {mod390.getSimpRegime2().setBoxC1(src.getAmount());}),
//		CAC2_C2  (Mod303Key.CT_S2R2 , (src,mod390) -> {mod390.getSimpRegime2().setBoxC2(src.getAmount());}),
		CAC2_D   (Mod303Key.CT_S218, null),
		CAC2_Z   (Mod303Key.CT_S219 , null),
//		CAC2_ZA  (Mod303Key.CAC2_ZA , null),
//		CAC2_ZD  (Mod303Key.CAC2_ZD , null),
...
//		CAC2_G0  (Mod303Key.CAC2_G0 , (src,mod390) -> {mod390.getSimpRegime2().setBoxD(
//				AonMathUtils.round(mod390.getSimpRegime2().getBoxD() + src.getAmount()));}),
		CAC2_G   (Mod303Key.CT_S222 , (src,mod390) -> mod390.getSimpRegime2().setBoxD(
				AonMathUtils.round(mod390.getSimpRegime2().getBoxD() + src.getAmount()))),
		CAC2_H   (Mod303Key.CT_S223 , (src,mod390) -> mod390.getSimpRegime2().setBoxE(src.getAmount())),
//		CAC2_HA  (Mod303Key.CAC2_HA , null),
//		CAC2_HD  (Mod303Key.CAC2_HD , null),
//		CAC2_HT  (Mod303Key.CAC2_HT , null),
		CAC2_I   (Mod303Key.CT_S224 , (src,mod390) -> mod390.getSimpRegime2().setBoxF(src.getAmount())),
		CAC2_J	 (Mod303Key.CT_S225 , (src,mod390) -> mod390.getSimpRegime2().setBoxG(src.getAmount())),
		CAC2_K   (Mod303Key.CT_S226 , null),
		CAC2_L   (Mod303Key.CT_S227 , (src,mod390) -> mod390.getSimpRegime2().setBoxI(src.getAmount())),
		CAC2_M   (Mod303Key.CT_S228 , (src,mod390) -> mod390.getSimpRegime2().setBoxJ(src.getAmount()))
...
//		PBK      (Mod303Key.PBK     , null),
		...
		public static void fill(SimplifedRegimeContext src,Mod3902025 mod390) {
	...
	private static Mod3902025 fillSimplifedRegimeData(AONContext ctx, Mod3902025 mod390) {
		...
		ctx.getDslContext().select(FS_MODEL_DETAIL.TYPE
			...
			.and(FS_MODEL.ADMINISTRATION.equal(mod390.getAdministration().value()))
		.fetch()
		.stream()
		.forEach( rec -> {
	...
	private static void fillSimplifiedDeclarationResults(AONContext ctx, Mod3902025 mod390) {
		...
		Record1<BigDecimal> rec = ctx.getDslContext()
			...
			.and(FS_MODEL_DETAIL.TYPE.equal("303-71")) // ESTA CASILA NO EXISTE AHORA
			.and(FS_MODEL.ADMINISTRATION.equal(mod390.getAdministration().value()))
			.fetchOne();
		if (rec != null) {
	...
	public static Mod3902025 changeStatus(AONContext ctx, Mod3902025 mod390, FiscalStatus newStatus) {
		try {
			ctx.checkWrite();
			if (mod390.getId() != null) {
	...
	// *******************
	public static Mod3902025 aeatPresentation(AONContext ctx, Mod3902025 mod, String aeatResponse) {
...
//	}
	...
	private static boolean isCommonNationalSales(VatContext vat, Mod3902025 mod) {
	...
	private static boolean isCommonNationalSalesRECT(VatContext vat, Mod3902025 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& vat.isNational()
			&& vat.isSales() 
	...
	private static boolean isIntracommunityPurchase(VatContext vat, Mod3902025 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& !vat.isRectification() 
			&& vat.isIntracommunityPurchase();
	}
	private static boolean isIntracommunityExpenses(VatContext vat, Mod3902025 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& !vat.isRectification() 
	...
	private static boolean fillFromPreviousYear(AONContext ctx, Mod3902025 mod390) {
		return Mod390DAO.getByDomain(ctx, ctx.getDomainId())
				.stream()
				.filter(m390 -> m390.getYear() <= mod390.getYear()-1 && m390.getAdministration() == mod390.getAdministration())
				.map(m390 -> {
					switch (m390.getYear()) {
						case 2018, 2019, 2020:
