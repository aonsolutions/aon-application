	...
	public static Stream<OperationBreakdown> getOperationBreakdown(final AONContext ctx, int domain, OperationParams params) {
		...
		Condition conditionIDA = 
				INVOICE.ID.isNull().orExists(ctx.getDslContext()
						...
						// AQUI LO CAMBIO PARA COMPROBAR SIMPLEMENTE QUE EXISTA UNA FILA ASOCIADA A LA FACTURA, AUNQUE LA CUENTA SEA DISTINTA, PORQUE SI MODIFICO EL ASIENTO
						// ENTONCES NO SALE LA FACTURA EN LOS LIBROS (POR EJEMPLO LOS GASTOS NO DEDUCIBLES NO SALEN EN EL LIBRO DE IRPF)
