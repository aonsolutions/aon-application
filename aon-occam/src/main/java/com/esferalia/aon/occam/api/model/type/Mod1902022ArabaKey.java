...
public enum Mod1902022ArabaKey {
	...
	,L ("L - Rentas exentas y dietas exceptuadas de gravamen."
		,new String[] { 
			...
			"22", "23", "24", "27", "28" , "29", "30", "35", "36", "41", "42", "44"}
	)
	...
	private Mod1902022ArabaKey(String description, String[] subKeys) {
	...
	public static Mod1902022ArabaKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902022ArabaKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902022ArabaKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902022ArabaKey.G.subKeys[2];
	}
	public static Mod1902022ArabaKey getDefaultKeyForFarmerRetentions() {
		return Mod1902022ArabaKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902022ArabaKey.H.subKeys[0];
	}
	public static Mod1902022ArabaKey getDefaultKeyForTransportRetentions() {
		return Mod1902022ArabaKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902022ArabaKey.H.subKeys[3];
	}
}
