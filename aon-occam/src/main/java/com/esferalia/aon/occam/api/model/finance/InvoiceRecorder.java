...
//				if (account == null) {
//					account = vat.getInvoiceDetail().getExpAccount();
//				}
//				if (account == null
//				 || vat.getInvoiceDetail().getExpAccount() == null
//				 || !AonNumberUtils.equals(account.getId(),vat.getInvoiceDetail().getExpAccount().getId())) {
//					account = null;
//					break;
//				}
//			}
...
//									id = vat.getInvoiceDetail().getExpAccount().getId();
//									code = vat.getInvoiceDetail().getExpAccount().getCode();
//									description = vat.getInvoiceDetail().getExpAccount().getDescription();
//								}
//							} else {
...
//					&& invoice.getVats() != null) {
//					for (InvoiceVAT vat : invoice.getVats()) {
//						if (vat.getInvoiceDetail().getInvestAsset().isPresent()
//							&& vat.getInvoiceDetail().getInvestAsset().get().getId() != null
...
//						if (vat.getInvoiceDetail().getExpAccount() != null 
//							&& vat.getInvoiceDetail().getExpAccount().getId() != null
//							&& AonMathUtils.isNotZero(amount)) {
//							AccountEntryDetail detail = map.get(vat.getInvoiceDetail().getExpAccount().getId());
//							if (detail == null) {
//								detail = new AccountEntryDetail()
//									.setAccount(vat.getInvoiceDetail().getExpAccount().getId())
//									.setAccountCode(vat.getInvoiceDetail().getExpAccount().getCode())
//									.setAccountDescription(vat.getInvoiceDetail().getExpAccount().getDescription())
//									.setBalancingAccount(obtainRegistryAccount(invoice))
//									.setBalancingAccountCode(obtainRegistryAccountCode(invoice))
//									.setBalancingAccountDescription(obtainRegistryAccountDescription(invoice));
//								map.put(vat.getInvoiceDetail().getExpAccount().getId(), detail);
//							}
//							detail.addCredit( amount );		
//						}
//					}
...
//		AccountEntry ae = invoice.getAccountEntry() == null
//			?new AccountEntry()
//			:AccountEntry.clone(invoice.getAccountEntry());
