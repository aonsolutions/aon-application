...
public enum Model3032022BIZKAIAScript2 implements IModelScript<Mod303Key> {
...
//	,LQ010("A ingresar"												,new Mod303Key[]{Mod303Key.BZ_C040},COMPUTE)
	...
	private Model3032022BIZKAIAScript2(String label, Mod303Key[] keys,KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
