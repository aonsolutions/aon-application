...
public class Mod123DAO extends FiscalModelDAO {
	...
	public static Mod123 get(AONContext ctx,int id) {
		ctx.checkRead();
		return FiscalModelDAO.get(ctx,Mod123::new,id);
	}
	...
	public static Mod123 reset(AONContext ctx,Mod123 mod123) {
		mod123.setMap(null);
	...
	public static Stream<Mod123> getMod123s(AONContext ctx,int domain, FiscalModelFilter filter) {
		return getModelRecords(ctx, domain,FiscalModelType.M123,filter)
