...
public class Modules2016 {
	...
	public enum Epigraph implements Serializable, IEpigraph {
		E____("---","Producci\u00F3n de mejill\u00F3n en batea"
			...
			,5
			,40000.00
			,new Module[] {new Module(1, ModuleInfo.M01, "Persona", 5500.00),
		...
		, E_314("314","Carpinter\u00EDa met\u00E1lica y fabricaci\u00F3n de estructuras met\u00E1licas y calderer\u00EDa."
			...
			,4
			,32475.62
			,new Module[] {new Module(1, ModuleInfo.M01, "Persona", 3577.61),
					new Module(2, ModuleInfo.M02, "Persona",17044.03),
					new Module(3, ModuleInfo.M03,"100 Kwh", 61.10),
					new Module(4, ModuleInfo.M24, "CVF", 170.06) }
			,new Module[] {new Module(1, ModuleInfo.M26, "Persona", 5968.73),
					new Module(2, ModuleInfo.M03,"100 Kwh", 43.81),
					new Module(3, ModuleInfo.M24, "CVF", 289.34) }		 
			 )
		...
		,E_316_2 ("316.2","Fabricaci\u00F3n de art\u00EDculos de ferreter\u00EDa, cerrajer\u00EDa, torniller\u00EDa, derivados del alambre, menaje y otros art\u00EDculos en metales n.c.o.p."
				...
				,5
				,32752.76
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3678.39)
					,new Module(2,ModuleInfo.M02,"Persona",16351.18)
					,new Module(3,ModuleInfo.M03,"100 Kwh",62.98)
					,new Module(4,ModuleInfo.M24,"CVF",125.97)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",8010.65)
					,new Module(2,ModuleInfo.M03,"100 Kwh",42.16)
					,new Module(3,ModuleInfo.M24,"CVF",28.10)}
				)				
		...
		,E_419_1 ("419.1","Industrias del pan y de la boller\u00EDa."
				...
				,6
				,41602.30
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6248.22)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",1693.54)
		...
		,E_419_2 ("419.2","Industrias de la boller\u00EDa, pasteler\u00EDa y galletas."
				...
				,6
				,33760.53
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6657.63)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3064.67)
		...
		,E_419_3 ("419.3","Industrias de elaboraci\u00F3n de masas fritas."
				...
				,6
				,19670.55
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4238.96)
					,new Module(2,ModuleInfo.M02,"Persona",12301.18)
					,new Module(3,ModuleInfo.M09,"Metro cua.",25.82)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2550.92)
		...
		,E_423_9 ("423.9","Elaboraci\u00F3n de patatas fritas, palomitas de ma\u00EDz y similares."
				...
				,6
				,19670.55
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4390.12)
		...
		,E_453A  ("453"  ,"Confecci\u00F3n en serie de prendas de vestir y sus complementos, excepto cuando su ejecuci\u00F3n se realice mayoritariamente por encargo a terceros."
				...
				,5
				,38969.48
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3382.36)
					,new Module(2,ModuleInfo.M02,"Persona",13730.96)
					,new Module(3,ModuleInfo.M03,"100 Kwh",125.97)
					,new Module(4,ModuleInfo.M24,"CVF",529.08)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5232.96)
					,new Module(2,ModuleInfo.M03,"100 Kwh",25.62)
					,new Module(3,ModuleInfo.M24,"CVF",198.40)}
				)
		,E_453B  ("453"  ,"Confecci\u00F3n en serie de prendas de vestir y sus complementos, ejecutada directamente por la propia empresa, cuando se realice exclusivamente para terceros y por encargo."
				...
				,5
				,29225.54
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2538.34)
					,new Module(2,ModuleInfo.M02,"Persona",10298.22)
					,new Module(3,ModuleInfo.M03,"100 Kwh",94.48)
					,new Module(4,ModuleInfo.M24,"CVF",396.81)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3926.79)
					,new Module(2,ModuleInfo.M03,"100 Kwh",19.01)
					,new Module(3,ModuleInfo.M24,"CVF",148.80)}
				)
		,E_463   ("463"  ,"Fabricaci\u00F3n en serie de piezas de carpinter\u00EDa, parqu\u00E9 y estructuras de madera para la construcci\u00F3n."
				...
				,5
				,28463.40
				,new Module[]{new Module(1,ModuleInfo.M01,"Personas",4037.41)
					,new Module(2,ModuleInfo.M02,"Personas",18404.53)
					,new Module(3,ModuleInfo.M03,"100 Kwh",62.98)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",8126.38)
					,new Module(2,ModuleInfo.M03,"100 Kwh",13.23)}
				)
		,E_468   ("468"  ,"Industria del mueble de madera."
				...
				,4
				,29534.17
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2947.75)
					,new Module(2,ModuleInfo.M02,"Persona",16300.79)
					,new Module(3,ModuleInfo.M03,"100 Kwh",49.76)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5522.30)
					,new Module(2,ModuleInfo.M03,"100 Kwh",28.10)}
				)
		,E_474_1 ("474.1","Impresi\u00F3n de textos o im\u00E1genes."
				...
				,4
				,40418.16
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",5208.95)
					,new Module(2,ModuleInfo.M02,"Persona",21534.93)
					,new Module(3,ModuleInfo.M08,"Kw cont.",484.99)
					,new Module(4,ModuleInfo.M24,"CVF",680.25)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",7861.85)
					,new Module(2,ModuleInfo.M08,"Kw cont.",165.34)
					,new Module(3,ModuleInfo.M24,"CVF",264.53)}
				)
		,E_501_3 ("501.3","Alba\u00F1iler\u00EDa y peque\u00F1os trabajos de construcci\u00F3n en general."
				...
				,6
				,32078.80
				,new Module[]{new Module(1,ModuleInfo.M01,"Personas",3640.59)
					,new Module(2,ModuleInfo.M02,"Personas",17988.83)
					,new Module(3,ModuleInfo.M09,"Metro cua.",46.60)
					,new Module(4,ModuleInfo.M24,"CVF",201.55)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3401.25)
					,new Module(2,ModuleInfo.M09,"Metro cua.",23.03)
					,new Module(3,ModuleInfo.M24,"CVF",76.18)}
				)
		,E_504_1 ("504.1","Instalaciones y montajes (excepto fontaner\u00EDa, fr\u00EDo, calor y acondicionamiento de aire)."
				...
				,3
				,40002.45
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6575.75)
					,new Module(2,ModuleInfo.M02,"Persona",20854.69)
					,new Module(3,ModuleInfo.M03,"100 Kwh",69.28)
					,new Module(4,ModuleInfo.M24,"CVF",132.27)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",4601.93)
					,new Module(2,ModuleInfo.M03,"100 Kwh",30.31)
					,new Module(3,ModuleInfo.M24,"CVF",3.70)}
				)
		,E_504_2 ("504.2","Instalaciones de fontaner\u00EDa, fr\u00EDo, calor y acondicionamiento de aire."
				...
				,4
				,33332.23
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",8238.58)
					,new Module(2,ModuleInfo.M02,"Persona",22360.05)
					,new Module(3,ModuleInfo.M03,"100 Kwh",138.57)
					,new Module(4,ModuleInfo.M24,"CVF",138.57)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",4775.14)
					,new Module(2,ModuleInfo.M03,"100 Kwh",50.61)
					,new Module(3,ModuleInfo.M24,"CVF",2.96)}
				)
		...
		,E_505_1 ("505.1","Revestimientos, solados y pavimentos y colocaci\u00F3n de aislamientos."
				...
				,4
				,30038.06
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4112.99)
					,new Module(2,ModuleInfo.M02,"Persona",20325.60)
					,new Module(3,ModuleInfo.M09,"Metro cua.",21.41)
					,new Module(4,ModuleInfo.M24,"CVF",245.64)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2432.84)
					,new Module(2,ModuleInfo.M09,"Metro cua.",5.91)
					,new Module(3,ModuleInfo.M24,"CVF",59.05)}
				)
		...
		,E_505_5 ("505.5","Carpinter\u00EDa y cerrajer\u00EDa."
				...
				,4
				,28356.33
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6689.12)
					,new Module(2,ModuleInfo.M02,"Persona",19154.07)
					,new Module(3,ModuleInfo.M24,"CVF",144.87)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3354.01)
					,new Module(2,ModuleInfo.M24,"CVF",16.93)}
				)
		,E_505_6 ("505.6","Pintura de cualquier tipo y clase y revestimiento con papel, tejidos o pl\u00E1sticos y terminaci\u00F3n y decoraci\u00F3n de edificios y locales."
				...
				,3
				,26687.20
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6027.77)
					,new Module(2,ModuleInfo.M02,"Persona",17648.70)
					,new Module(3,ModuleInfo.M24,"CVF",144.87)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2629.68)
					,new Module(2,ModuleInfo.M24,"CVF",14.18)}
				)
		...
		,E_641 ("641","Comercio al por menor de frutas, verduras, hortalizas y tub\u00E9rculos."
				...
				,5
				,16867.67
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2387.18)
		...
		,E_642_1 ("642.1","Comercio al por menor de carne y despojos; de productos y derivados c\u00E1rnicos elaborados, salvo casquer\u00EDas."
				...
				,5
				,21635.71
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2355.68)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",1753.76)
		...
		,E_642_5 ("642.5","Comerciantes minoristas matriculados en el ep\u00EDgrafe 642.5 por el asado de pollos."
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",673.16)
		...
		,E_642_6 ("642.6","Comercio al por menor, en casquer\u00EDas, de v\u00EDsceras y despojos procedentes de animales de abasto, frescos y congelados."
				...
				,5
				,16237.81
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2254.90)
		...
		,E_643_1 ("643.1","Comercio al por menor de pescados y otros productos de la pesca y de la acuicultura y de caracoles."
				...
				,5
				,24551.97
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3823.25)
		...
		,E_644_1 ("644.1","Comercio al por menor de pan, pasteler\u00EDa, confiter\u00EDa y similares y de leche y productos l\u00E1cteos."
				...
				,6
				,43605.26
				,new Module[]{new Module(1,ModuleInfo.M15,"Persona",6248.22)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2090.35)
					,new Module(2,ModuleInfo.M09,"Metro cua.",8.86)
		...
		,E_644_2 ("644.2","Despachos de pan, panes especiales y boller\u00EDa."
				...
				,6
				,42925.01
				,new Module[]{new Module(1,ModuleInfo.M15,"Persona",6134.85)
		...
		,E_644_3 ("644.3","Comercio al por menor de productos de pasteler\u00EDa, boller\u00EDa y confiter\u00EDa."
				...
				,6
				,33760.53
				,new Module[]{new Module(1,ModuleInfo.M15,"Persona",6367.89)
		...
		,E_644_6 ("644.6","Comercio al por menor de masas fritas, con o sin coberturas o rellenos, patatas fritas, productos de aperitivo, frutos secos, golosinas, preparados de chocolate y bebidas refrescantes."
				...
				,6
				,19670.55
				,new Module[]{new Module(1,ModuleInfo.M15,"Persona",6852.88)
		...
		,E_647_1 ("647.1","Comerciantes minoristas matriculados en el ep\u00EDgrafe 647.1 por el servicio de comercializaci\u00F3n de loter\u00EDas."
				...
				,5
				,15822.10
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1026.67)
				...
				,new Module[]{new Module(1,ModuleInfo.M58,"Euro",0.21)}
				)
		,E_647_2 ("647.2","Comerciantes minoristas matriculados en el ep\u00EDgrafe 647.2 y 3 por el servicio de comercializaci\u00F3n de loter\u00EDas."
				...
				,4
				,25219.62
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1788.80)
		...
		,E_651_1 ("651.1","Comercio al por menor de productos textiles, confecciones para el hogar, alfombras y similares y art\u00EDculos de tapicer\u00EDa."
				...
				,4
				,23638.67
				,new Module[]{new Module(1,ModuleInfo.M01,"Personas",3010.74)
		...
		,E_651_2 ("651.2","Comercio al por menor de toda clase de prendas para el vestido y tocado."
				...
				,5
				,24848.00
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2569.83)
		...
		,E_651_3 ("651.3","Comercio al por menor de lencer\u00EDa, corseter\u00EDa y prendas especiales."
				...
				,3
				,19626.46
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2198.21)
		...
		,E_651_4 ("651.4","Comercio al por menor de art\u00EDculos de mercer\u00EDa y paqueter\u00EDa."
				...
				,4
				,14862.05
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1902.18)
		...
		,E_651_6 ("651.6","Comercio al por menor de calzado, art\u00EDculos de piel e imitaci\u00F3n o productos sustitutivos, cinturones, carteras, bolsos, maletas y art\u00EDculos de viaje en general."
				...
				,5
				,24306.32
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3130.41)
		...
		,E_652_2 ("652.2","Comerciantes minoristas matriculados en el ep\u00EDgrafe 652.2 y 3 por el servicio de comercializaci\u00F3n de loter\u00EDas."
				...
				,4
				,25333.00
				,new Module[]{new Module(1,ModuleInfo.M01,"Personas",3722.48)
		...
		,E_653_1 ("653.1","Comercio al por menor de muebles."
				...
				,4
				,30718.31
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4075.20)
		...
		,E_653_2 ("653.2","Comercio al por menor de material y aparatos el\u00E9ctricos, electr\u00F3nicos, electrodom\u00E9sticos y otros aparatos de uso dom\u00E9stico accionados por otro tipo de energ\u00EDa distinta de la el\u00E9ctrica, as\u00ED como muebles de cocina"
				...
				,3
				,26189.61
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2884.77)
				...
				,new Module[]{new Module(1,ModuleInfo.M27,"Persona",5819.91)
		...
		,E_653_3 ("653.3","Comercio al por menor de art\u00EDculos de menaje, ferreter\u00EDa, adorno, regalo, o reclamo (incluyendo bisuter\u00EDa y peque\u00F1os electrodom\u00E9sticos)."
				...
				,4
				,24470.09
				,new Module[]{new Module(1,ModuleInfo.M01,"Personas",3709.88)
		...
		,E_653_4 ("653.4","Comercio al por menor de materiales de construcci\u00F3n, art\u00EDculos y mobiliario de saneamiento, puertas, ventanas, persianas, etc."
				...
				,3
				,26454.15
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3061.12)
					,new Module(2,ModuleInfo.M02,"Persona",16527.55)
					,new Module(3,ModuleInfo.M03,"100 Kwh",94.48)
					,new Module(4,ModuleInfo.M09,"Metro cua.",8.81)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",12317.71)
		...
		,E_653_9 ("653.9","Comercio al por menor de otros art\u00EDculos para el equipamiento del hogar n.c.o.p."
				...
				,3
				,32765.35
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4950.71)
		...
		,E_654_2 ("654.2","Comercio al por menor de accesorios y piezas de recambio para veh\u00EDculos terrestres."
				...
				,4
				,32815.74
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3098.92)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",15558.35)
		...
		,E_654_5 ("654.5","Comercio al por menor de toda clase de maquinaria (excepto aparatos del hogar, de oficina, m\u00E9dicos, ortop\u00E9dicos, \u00F3pticos y fotogr\u00E1ficos)."
				...
				,3
				,31367.06
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",9422.71)
					,new Module(2,ModuleInfo.M02,"Persona",18858.03)
					,new Module(3,ModuleInfo.M03,"100 Kwh",39.05)
					,new Module(4,ModuleInfo.M24,"CVF",132.27)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",18021.89)
		...
		,E_654_6 ("654.6","Comercio al por menor de cubiertas, bandas o bandajes y c\u00E1maras de aire para toda clase de veh\u00EDculos, excepto las actividades de comercio al por mayor de los art\u00EDculos citados."
				...
				,4
				,26970.63
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2746.19)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",14152.98)
		...
		,E_659_2 ("659.2","Comercio al por menor de muebles de oficina y de m\u00E1quinas y equipos de oficina."
				...
				,4
				,30718.31
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4157.08)
		...
		,E_659_3 ("659.3","Comerciantes minoristas matriculados en el ep\u00EDgrafe 659.3 por el servicio de recogida de negativos y otro material fotogr\u00E1fico impresionado para su procesado en laboratorio de terceros y la entrega de las correspondientes copias y ampliaciones."
				...
				,3
				,35524.14
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",7174.12)
					,new Module(2,ModuleInfo.M02,"Persona",19273.74)
					,new Module(3,ModuleInfo.M03,"100 Kwh",119.67)
					,new Module(4,ModuleInfo.M24,"CVF",1070.76)}
				,new Module[]{new Module(1,ModuleInfo.M62,"Persona",14533.25)
		...
		,E_659_4A("659.4","Comercio al por menor de libros, peri\u00F3dicos, art\u00EDculos de papeler\u00EDa y escritorio y art\u00EDculos de dibujo y bellas artes, excepto en quioscos situados en la v\u00EDa p\u00FAblica."
				...
				,3
				,25207.02
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4648.37)
		...
		,E_659_4B("659.4","Comercio al por menor de prensa, revistas y libros en quioscos situados en la v\u00EDa p\u00FAblica."
				...
				,2
				,28860.22
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3476.83)
		...
		,E_659_6 ("659.6","Comercio al por menor de juguetes, art\u00EDculos de deporte, prendas deportivas de vestido, calzado y tocado, armas, cartucher\u00EDa y art\u00EDculos de pirotecnia."
				...
				,3
				,24948.78
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2916.26)
		...
		,E_659_7 ("659.7","Comercio al por menor de semillas, abonos, flores y plantas y peque\u00F1os animales."
				...
				,4
				,23978.80
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4988.50)
		...
		,E_662_2 ("662.2","Comerciantes minoristas matriculados en el ep\u00EDgrafe 662.2 por el servicio de comercializaci\u00F3n de loter\u00EDas."
				...
				,3
				,16395.27
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4868.82)
		...
		,E_663_1 ("663.1","Comercio al por menor fuera de un establecimiento comercial permanente dedicado exclusivamente a la comercializaci\u00F3n de masas fritas, con o sin coberturas o rellenos, patatas fritas, productos de aperitivo, frutos secos, golosinas, preparaci\u00F3n de chocolate y bebidas refrescantes y facultado para la elaboraci\u00F3n de los productos propios de churrer\u00EDa y patatas fritas en la propia instalaci\u00F3n o veh\u00EDculo."
				...
				,2
				,14379.72
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1398.29)
					,new Module(2,ModuleInfo.M02,"Persona",13989.21)
					,new Module(3,ModuleInfo.M24,"CVF",113.37)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5881.32)
		...
		,E_663_2 ("663.2","Comercio al por menor fuera de un establecimiento comercial permanente de art\u00EDculos textiles y de confecci\u00F3n."
				...
				,2
				,19059.58
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2991.84)
		...
		,E_663_3 ("663.3","Comercio al por menor fuera de un establecimiento comercial permanente de calzado, pieles y art\u00EDculos de cuero."
				...
				,2
				,17081.82
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2613.92)
		...
		,E_663_9 ("663.9","Comercio al por menor fuera de un establecimiento comercial permanente de otras clases de mercanc\u00EDas n.c.o.p."
				...
				,2
				,18354.14
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",5448.29)
		...
		,E_671_4 ("671.4","Restaurantes de dos tenedores."
				...
				,10
				,51617.08
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3709.88)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2993.81)
		...
		,E_671_5 ("671.5","Restaurantes de un tenedor."
				...
				,10
				,38081.38
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3602.80)
					...
					,new Module(5,ModuleInfo.M06,"Maquina A",1077.06)
					,new Module(6,ModuleInfo.M07,"Maquina B",3810.65)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2400.36)
		...
		,E_672_1 ("672.1","Cafeter\u00EDas."
				...
				,8
				,39070.26
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1448.68)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2356.07)
		...
		,E_673_1 ("673.1","Caf\u00E9s y bares de categor\u00EDa especial."
				...
				,8
				,30586.03
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4056.30)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3294.97)
		...
		,E_673_2 ("673.2","Otros caf\u00E9s y bares."
				...
				,8
				,19084.78
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1643.93)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2577.52)
		...
		,E_675   ("675"	 ,"Servicios en quioscos, cajones, barracas u otros locales an\u00E1logos."
				...
				,3
				,16596.83
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2802.88)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",4357.86)
		...
		,E_676   ("676"	 ,"Servicios en chocolater\u00EDas, helader\u00EDas y horchater\u00EDas."
				...
				,3
				,25528.25
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2418.67)
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3817.55)
		...
		,E_681   ("681"	 ,"Servicio de hospedaje en hoteles y moteles de una o dos estrellas."
				...
				,10
				,61512.19
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",6223.02)
					,new Module(2,ModuleInfo.M02,"Persona",20438.98)
					,new Module(3,ModuleInfo.M20,"Plaza",371.62)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2604.09)
		...
		,E_682   ("682"	 ,"Servicio de hospedaje en hostales y pensiones."
				...
				,8
				,32840.94
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",5145.96)
					,new Module(2,ModuleInfo.M02,"Persona",17541.62)
					,new Module(3,ModuleInfo.M20,"Plaza",270.85)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2533.22)
		...
		,E_683   ("683"	 ,"Servicio de hospedaje en fondas y casas de hu\u00E9spedes."
				...
				,8
				,16256.70
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4478.31)
					,new Module(2,ModuleInfo.M02,"Persona",14587.57)
					,new Module(3,ModuleInfo.M20,"Plaza",132.27)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",1762.62)
		...
		,E_691_1 ("691.1","Reparaci\u00F3n de art\u00EDculos el\u00E9ctricos para el hogar."
				...
				,3
				,21585.33
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4314.54)
					,new Module(2,ModuleInfo.M02,"Persona",15538.66)
					,new Module(3,ModuleInfo.M09,"Metro cua.",17.01)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5819.91)
		...
		,E_691_2 ("691.2","Reparaci\u00F3n de veh\u00EDculos autom\u00F3viles, bicicletas y otros veh\u00EDculos."
				...
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",8556.27)
		...
		,E_691_9A("691.9","Reparaci\u00F3n de calzado."
				...
				,2
				,16552.74
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1845.50)
					,new Module(2,ModuleInfo.M02,"Persona",10014.78)
					,new Module(3,ModuleInfo.M03,"100 Kwh",125.97)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3000.89)
		...
		,E_691_9B("691.9","Reparaci\u00F3n de otros bienes de consumo n.c.o.p. (excepto reparaci\u00F3n de calzado, restauraci\u00F3n de obras de arte, muebles, antig\u00FCedades e instrumentos musicales)."
				...
				,2
				,24803.91
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4094.10)
					,new Module(2,ModuleInfo.M02,"Persona",16187.42)
					,new Module(3,ModuleInfo.M09,"Metro cua.",45.35)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5381.76)
		...
		,E_692   ("692"	 ,"Reparaci\u00F3n de maquinaria industrial."
				...
				,2
				,30352.99
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4409.02)
					,new Module(2,ModuleInfo.M02,"Persona",18146.29)
					,new Module(3,ModuleInfo.M09,"Metro cua.",94.48)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",9721.90)
		...
		,E_699   ("699"	 ,"Otras reparaciones n.c.o.p."
				...
				,2
				,23607.18
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3703.58)
					,new Module(2,ModuleInfo.M02,"Persona",15230.03)
					,new Module(3,ModuleInfo.M09,"Metro cua.",88.18)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",7671.69)
		...
		,E_721_1 ("721.1","Transporte urbano colectivo y de viajeros por carretera."
				...
				,5
				,35196.62
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2981.02)
					,new Module(2,ModuleInfo.M02,"Persona",16016.97)
					,new Module(3,ModuleInfo.M21,"Asiento",121.40)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",1700.62)
		...
		,E_721_2 ("721.2","Transporte por autotaxis."
				...
				,3
				,9999999.99
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1346.27)
					,new Module(2,ModuleInfo.M02,"Persona",7656.89)
					,new Module(3,ModuleInfo.M12,"1000 Km",45.08)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",903.46)
		...
		,E_722A  ("722"	 ,"Transporte de mercanc\u00EDas por carretera, expto residuos"
				...
				,5
				,33640.86
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2728.59)
					,new Module(2,ModuleInfo.M02,"Persona",10090.99)
					,new Module(3,ModuleInfo.M23,"Tonelada",126.21)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",4149.99)
		...
		,E_722B  ("722"	 ,"Transporte de residuos por carretera."
				...
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2728.59)
					,new Module(2,ModuleInfo.M02,"Persona",10090.99)
					,new Module(3,ModuleInfo.M23,"Tonelada",126.21)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",1948.64)
		...
		,E_751_5 ("751.5","Engrase y lavado de veh\u00EDculos."
				...
				,5
				,28280.74
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4667.27)
		...
		,E_757   ("757"	 ,"Servicios de mudanzas."
				...
				,5
				,33640.86
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",2566.32)
					,new Module(2,ModuleInfo.M02,"Persona",10175.13)
					,new Module(3,ModuleInfo.M23,"Tonelada",48.08)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",5712.43)
		...
		,E_933_1 ("933.1","Ense\u00F1anza de conducci\u00F3n de veh\u00EDculos terrestres, acu\u00E1ticos, aeron\u00E1uticos, etc."
				...
				,4
				,47233.25
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3067.42)
		...
		,E_933_9 ("933.9","Otras actividades de ense\u00F1anza, tales como idiomas, corte y confecci\u00F3n, mecanograf\u00EDa, taquigraf\u00EDa, preparaci\u00F3n de ex\u00E1menes y oposiciones y similares n.c.o.p."
				...
				,5
				,33697.55
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",1253.49)
					,new Module(2,ModuleInfo.M02,"Persona",15727.62)
					,new Module(3,ModuleInfo.M09,"Metro cua.",62.36)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2413.95)
		...
		,E_967_2 ("967.2","Escuelas y servicios de perfeccionamiento del deporte."
				...
				,3
				,37067.30
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",7035.55)
					,new Module(2,ModuleInfo.M02,"Persona",14215.95)
					,new Module(3,ModuleInfo.M09,"Metro cua.",34.01)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3441.10)
		...
		,E_971_1 ("971.1","Tinte, limpieza en seco, lavado y planchado de ropas hechas y de prendas y art\u00EDculos del hogar usados."
				...
				,4
				,37224.77
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4553.90)
					,new Module(2,ModuleInfo.M02,"Persona",16773.19)
					,new Module(3,ModuleInfo.M03,"100 Kwh",45.98)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",3844.13)
		...
		,E_972_1 ("972.1","Servicios de peluquer\u00EDa de se\u00F1ora y caballero."
				...
				,6
				,18051.81
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",3161.90)
					,new Module(2,ModuleInfo.M02,"Persona",9649.47)
					,new Module(3,ModuleInfo.M09,"Metro cua.",94.48)
					,new Module(4,ModuleInfo.M03,"100 Kwh",81.88)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",2562.75)
		...
		,E_973_3 ("973.3","Servicios de copias de documentos con m\u00E1quinas fotocopiadoras."
				...
				,4
				,24192.95
				,new Module[]{new Module(1,ModuleInfo.M01,"Persona",4125.59)
					,new Module(2,ModuleInfo.M02,"Persona",17044.03)
					,new Module(3,ModuleInfo.M08,"Kw cont.",541.68)}
				,new Module[]{new Module(1,ModuleInfo.M26,"Persona",13136.13)
