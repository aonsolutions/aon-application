...
public class ContractType {
	...
	public ContractType() {
		...
		this.contractTypes.put(520, new ContractTypeRecord("TEMPORAL, TIEMPO PARCIAL, PRACTICAS", "Temporal, TP/Prácticas", "P", null));
		this.contractTypes.put(521, new ContractTypeRecord("TEMPORAL TIEMPO PARCIAL. FORMACIÓN EN ALTERNANCIA", "Temporal, TP/Formacion alternancia", "P", null));
		...
		this.contractTypes.put(552, new ContractTypeRecord("TEMPORAL, TIEMPO PARCIAL, FOMENTO DEL EMPLEO", "Temporal, TP/Desempleados en Emp.Inserción", "P", null));
