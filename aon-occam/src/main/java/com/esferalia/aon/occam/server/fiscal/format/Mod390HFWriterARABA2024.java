...
public class Mod390HFWriterARABA2024 implements IMod390HFWriter {

	private enum Mod390HFFile {
			ARABA_2024_RC ( mod -> true ,new IPropertyFiller[] {
			...
			,ARABA_2024_RD ( mod -> true ,new IPropertyFiller[] {
				...
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(17)) 						// Clave de actividad: 1 (Modelo 391)  X(17)
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(17)) 						// Clave de actividad: 11 (Modelo 391) X(17)
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(16)) 						// Clave de actividad: 21 (Modelo 391) X(16)
					
				// CLAVES-IMPORTES declaración (260 ocurrencias.) - Las claves posibles del modelo 390
				// Todas llevan el importe con signo (blanco o N) + importe (15 enteros y 2 decimales), 
				...
				,(wr, mod) -> wr.append(mod.isReplacement() ? "902"+AonStringUtils.SPACE+AonFiscalFileUtils.unsigned(mod.getReplacedNumber(),17,2) : "000"+AonStringUtils.SPACE+AonFiscalFileUtils.zeros(17)) // [902] Sustitutiva Numero declaracion anterior (año y numero) - solo si se ha presentado por internet 
				...
				// IVA Devengado
				,(wr, mod) -> wr.append("202" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C202),18))  
				,(wr, mod) -> wr.append("203" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C203),18))
				,(wr, mod) -> wr.append("204" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C204),18))
				,(wr, mod) -> wr.append("380" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C380),18))  
				,(wr, mod) -> wr.append("381" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C381),18))
				,(wr, mod) -> wr.append("382" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C382),18))
				...
				,(wr, mod) -> wr.append("205" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C205),18))  
				,(wr, mod) -> wr.append("206" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C206),18))
				,(wr, mod) -> wr.append("207" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C207),18))
				,(wr, mod) -> wr.append("383" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C383),18))  
				,(wr, mod) -> wr.append("384" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C384),18))
				,(wr, mod) -> wr.append("385" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C385),18))
				...
				,(wr, mod) -> wr.append("810" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C810),18))  
				,(wr, mod) -> wr.append("811" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C811),18))
				,(wr, mod) -> wr.append("812" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C812),18))
				,(wr, mod) -> wr.append("386" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C386),18))  
				,(wr, mod) -> wr.append("387" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C387),18))
				,(wr, mod) -> wr.append("388" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C388),18))				
				...
				,(wr, mod) -> wr.append("819" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C819),18))  
				,(wr, mod) -> wr.append("820" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C820),18))
				,(wr, mod) -> wr.append("821" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C821),18))
				,(wr, mod) -> wr.append("389" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C389),18))  
				,(wr, mod) -> wr.append("390" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C390),18))
				,(wr, mod) -> wr.append("391" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C391),18))
				...
				,(wr, mod) -> wr.append("234" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C234),18))
				,(wr, mod) -> wr.append("235" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C235),18))
				,(wr, mod) -> wr.append("236" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C236),18))
				,(wr, mod) -> wr.append("392" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C392),18))
				,(wr, mod) -> wr.append("393" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C393),18))
				,(wr, mod) -> wr.append("394" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C394),18))
				...
				,(wr, mod) -> wr.append("231" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C231),18))
				,(wr, mod) -> wr.append("232" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C232),18))
				,(wr, mod) -> wr.append("233" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C233),18))
				,(wr, mod) -> wr.append("395" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C395),18))
				,(wr, mod) -> wr.append("396" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C396),18))
				,(wr, mod) -> wr.append("397" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C397),18))
				...
				// Deducciones
				,(wr, mod) -> wr.append("533" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C533),18))
				,(wr, mod) -> wr.append("534" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C534),18))
				,(wr, mod) -> wr.append("535" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C535),18))
				...
				,(wr, mod) -> wr.append("116" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C116),18))
				,(wr, mod) -> wr.append("117" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C117),18))
				,(wr, mod) -> wr.append("118" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C118),18))
				,(wr, mod) -> wr.append("536" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C536),18))
				,(wr, mod) -> wr.append("537" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C537),18))
				,(wr, mod) -> wr.append("538" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C538),18))
				...
				,(wr, mod) -> wr.append("146" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C146),18))
				,(wr, mod) -> wr.append("147" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C147),18))
				,(wr, mod) -> wr.append("148" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C148),18))
				...
				,(wr, mod) -> wr.append("539" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C539),18))
				,(wr, mod) -> wr.append("540" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C540),18))
				,(wr, mod) -> wr.append("541" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C541),18))
				...
				,(wr, mod) -> wr.append("173" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C173),18))
				,(wr, mod) -> wr.append("174" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C174),18))
				,(wr, mod) -> wr.append("175" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C175),18))
				,(wr, mod) -> wr.append("542" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C542),18))
				,(wr, mod) -> wr.append("543" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C543),18))
				,(wr, mod) -> wr.append("544" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C544),18))
				...
				,(wr, mod) -> wr.append("176" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C176),18))
				,(wr, mod) -> wr.append("177" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C177),18))
				,(wr, mod) -> wr.append("178" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C178),18))
				...
				,(wr, mod) -> wr.append("545" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C545),18))
				,(wr, mod) -> wr.append("546" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C546),18))
				,(wr, mod) -> wr.append("547" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C547),18))
				...
				,(wr, mod) -> wr.append("179" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C179),18))
				,(wr, mod) -> wr.append("180" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C180),18))
				,(wr, mod) -> wr.append("181" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C181),18))
				,(wr, mod) -> wr.append("548" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C548),18))
				,(wr, mod) -> wr.append("549" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C549),18))
				,(wr, mod) -> wr.append("550" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C550),18))
				...
				,(wr, mod) -> wr.append("241" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C241),18))
				,(wr, mod) -> wr.append("242" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C242),18))
				,(wr, mod) -> wr.append("243" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C243),18))
				...
				// Volumen de Operaciones, va con 5 decimales. Se pone el numero (incluido los decimales) en la parte entera
				...
				// Resto de casillas hasta completar las 260 (21)				
				,(wr, mod) -> {					
					for (int i=1;i<=21;i++) {
						wr.append("000" + AonFiscalFileUtils.signedSpace(0.0,18));
					}
				...
				,(wr, mod) -> wr.append(AonFiscalFileUtils.convertDateZero(mod.getDescription(Mod390Key.AR_C908)))  // Fecha auto juez				
				...
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(393)) // Libre a blancos X(393) y fin de registro
				,(wr, mod) -> wr.append(AonStringUtils.CR_LF) 			//  Fin de registro
