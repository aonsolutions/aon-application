...
public enum Model3032022AEATResultScript implements IModelScript<Mod303Key> {
...
//			,new Mod303Key[]{Mod303Key.CT_C67},COMPUTE_KEY)
	...
	private Model3032022AEATResultScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
