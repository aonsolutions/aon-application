...
public class Mod202WriterAEAT2025 implements IMod202Writer{ 
	...
	private enum Mod202File {
		...
		AEAT_1 ( mod202 -> true,new IPropertyFiller[] { 
			...
			,(wr,mod) -> wr.append(AonFiscalFileUtils.mark(mod.getAmount(Mod202Key.X13)))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.mark(mod.getAmount(Mod202Key.X11)))
			...
			,(wr,mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod202Key.C67),17))
			...
			,(wr,mod) -> wr.append(AonFiscalFileUtils.spaces(251))
			,(wr,mod) -> wr.append("</T20201000>")
		}),
		...
		AEAT_2 ( mod202 -> true,new IPropertyFiller[] { 
			...
			,(wr,mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod202Key.C61),17))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod202Key.C62),5))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod202Key.C63),17))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod202Key.C64),17))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod202Key.C65),5))
			,(wr,mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod202Key.C66),17))
			...
			,(wr,mod) -> wr.append(AonFiscalFileUtils.spaces(116))
