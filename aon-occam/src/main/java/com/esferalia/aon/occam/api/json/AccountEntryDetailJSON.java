...
public class AccountEntryDetailJSON {
	...
	public static AccountEntryDetail fromJSON(JSONObject json, Supplier<AccountEntryDetail> supp) {
		...
		return supp.get()
			...
			.setBalancingAccountId(JsonUtils.getInteger(json, IJsonNames.BALANCING_ACCOUNT))
	...
	public static JSONObject toJSON(AccountEntryDetail aed) {
		...
		return new JSONObject()
			...
			.put(IJsonNames.ACCOUNT, aed.getAccountId())
			...
			.put(IJsonNames.BALANCING_ACCOUNT, aed.getBalancingAccountId())
