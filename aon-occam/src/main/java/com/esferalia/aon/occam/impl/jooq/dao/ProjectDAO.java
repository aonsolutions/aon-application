...
public class ProjectDAO {
	...
	protected static class ProjectCommercialPropertiesDAO implements ProjectCommercialProperties {
		...
		@Override public Property<java.util.Date> getStatusDateProperty() {return new FilterDAO.LocalDatePropertyDAO(PROJECT_COMMERCIAL.STATUS_DATE);}
	...
	protected static class ProjectReservationPropertiesDAO implements ProjectReservationProperties {
		...
		@Override public Property<java.util.Date> getStartDateProperty() {return new FilterDAO.LocalDatePropertyDAO(PROJECT_RESERVATION.START_DATE);}
		@Override public Property<Timestamp> getStartTimeProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.START_TIME);}
		@Override public Property<java.util.Date> getEndDateProperty() {return new FilterDAO.LocalDatePropertyDAO(PROJECT_RESERVATION.END_DATE);}
		@Override public Property<Timestamp> getEndTimeProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.END_TIME);}
		...
		@Override public Property<Timestamp> getCreationDateProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.CREATION_DATE);}
		...
		@Override public Property<Timestamp> getModificationDateProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.MODIFICATION_DATE);}
		...
		@Override public Property<Timestamp> getCancellationDateProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.CANCELLATION_DATE);}
		...
		@Override public Property<Timestamp> getPenaltyDateProperty() {return new FilterDAO.LocalDateTimePropertyDAO(PROJECT_RESERVATION.PENALTY_DATE);}
	...
	public static Integer insertProject(AONContext ctx, Project project){
		return ctx.getDslContext().insertInto(PROJECT, PROJECT.ACTIVE, PROJECT.ALIAS,
				...
				.values(project.isActive()?(byte)1:(byte)0, project.getAlias(), project.isCommercial()?(byte)1:(byte)0,
						AonDateUtils.toLocalDate(project.getDate()), project.getDomain(), project.getName(), project.getProjectTypeId(),
	...
	public static Integer insertProjectCommercial(AONContext ctx, ProjectCommercial pc){
		ctx.getDslContext().insertInto(PROJECT_COMMERCIAL, PROJECT_COMMERCIAL.PROJECT, PROJECT_COMMERCIAL.DOMAIN, PROJECT_COMMERCIAL.TARGET, PROJECT_COMMERCIAL.SELLER,
				...
				.values(pc.getId(), ctx.getDomainId(), pc.getTarget(), pc.getSeller(), pc.getSource(), pc.getComments(), pc.getStatus(), AonDateUtils.toLocalDate(pc.getStatusDate())).execute();
	...
	private static class FullProjectReservationFiller implements Function<ProjectReservationRecord, ProjectReservation> {
		...
		public ProjectReservation apply(ProjectReservationRecord r) {
			return new ProjectReservation().setAdvance(r.getAdvance())
					...
					.setCancellationDate(AonDateUtils.toDate(r.getCancellationDate()))
					...
					.setEndTime(AonDateUtils.toDate(r.getEndTime()))
					.setHotel(r.getHotel())
					...
					.setStartTime(AonDateUtils.toDate(r.getStartTime()))
					...
					.setPenaltyDate(AonDateUtils.toDate(r.getPenaltyDate()));
		}
	...
	public static class ProjectFiller extends Filler implements Function<Record, Project> {
		...
		public static Project build(Record r) {
			return new Project()
				...
				.setDate(AonDateUtils.toDate(r.getValue(PROJECT.DATE)))
	...
	private static class FullProjectCommercialFiller implements Function<Record, ProjectCommercial> {
		...
		public ProjectCommercial apply(Record r) {
			...
			pc.setDate(AonDateUtils.toDate(r.getValue(PROJECT.DATE)));
			...
			return pc.setTarget(r.getValue(PROJECT_COMMERCIAL.TARGET))
					...
					.setStatusDate(AonDateUtils.toDate(r.getValue(PROJECT_COMMERCIAL.STATUS_DATE)));	
		}
