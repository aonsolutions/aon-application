...
enum Mod190File2022Aeat {
	...
	private Mod190File2022Aeat(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2022Aeat.TYPE_1.fillPage(mod190, null, wr);
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2022Aeat.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
}
