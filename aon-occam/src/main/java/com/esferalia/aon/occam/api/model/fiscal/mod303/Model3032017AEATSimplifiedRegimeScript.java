...
public enum Model3032017AEATSimplifiedRegimeScript implements IModelScript<Mod303Key> {
	...
	private Model3032017AEATSimplifiedRegimeScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
