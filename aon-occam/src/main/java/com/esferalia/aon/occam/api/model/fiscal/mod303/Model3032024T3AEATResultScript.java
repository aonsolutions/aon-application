...
public enum Model3032024T3AEATResultScript implements IModelScript<Mod303Key> {
	...
	private Model3032024T3AEATResultScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
