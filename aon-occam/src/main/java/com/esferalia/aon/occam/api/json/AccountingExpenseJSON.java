...
public class AccountingExpenseJSON {
	...
	public static Optional<AccountingExpense> from(JSONObject json) {
		return from(json, AccountingExpense::new );
	}
	public static Optional<AccountingExpense> from(JSONObject json, Supplier<AccountingExpense> supp) {
	...
	public static Optional<JSONObject> to(AccountingExpense a) {
