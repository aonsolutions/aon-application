...
class Mod303WriterAEAT2016 implements IMod303Writer{ 

	private enum Mod303File {
		
		// **************************************************************** AEAT < 2017 - 4T 									
		AEAT_2017_REG_0_START (mod303 -> true ,new IPropertyFiller[] { 
			(wr, mod) -> wr.append("<T")
		...
		,AEAT_2017_REG_1 (mod303 -> true ,new IPropertyFiller[] {
		   ...
		   ,(wr, mod) -> wr.append(mod.getAmount(Mod303Key.CT_A06)==0?" ":"1")
		...
		,AEAT_2017_REG_2 (mod303 -> mod303.getAmount(Mod303Key.CT_A02) < 2 /* Simplificado */ ,new IPropertyFiller[] {
		...
		,AEAT_2017_REG_3 (mod303 -> true ,new IPropertyFiller[] {
		...
		,AEAT_2017_REG_0_END (mod303 -> true ,new IPropertyFiller[] { 
		    (wr, mod) -> wr.append("</T")
		   ,(wr, mod) -> wr.append("303")
		   ,(wr, mod) -> wr.append("0")
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getYear(), 4,0))
