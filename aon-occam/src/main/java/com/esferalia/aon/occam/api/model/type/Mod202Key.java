...
public enum Mod202Key implements IFiscalModelKey{
	 P00("202-P00",null,"IBAN")
	,P01("202-P01",null,"Tipo de declaraci\u00F3n")
	,P02("202-P02",null,"Fecha de inicio del per\u00EDodo impositivo")
	,P03("202-P03",null,"C.N.A.E. actividad principal")
	
	,X01("202-X01",null,"Entidad que aplica el r\u00E9gimen de la Ley 49/2002 de 23 de diciembre")
	,X02("202-X02",null,"Entidad que aplica el r\u00E9gimen de la Ley 11/2009 de 26 de octubre")
	,X03("202-X03",null,"Volumen de operaciones superior a 6.010.121 euros")
	,X04("202-X04",null,"Entidad que aplica el r\u00E9gimen de las entidades navieras en funci\u00F3n del tonelaje")
	,X05("202-X05",null,"Entidades que aplican incentivos de empresa de reducida dimensi\u00F3n")
	,X06("202-X06",null,"Cifra de negocios de los 12 meses anteriores a la fecha de inicio del per\u00EDodo impositivo > 6.000.000  \u20AC")
	,X07("202-X07",null,"Cooperativa fiscalmente protegida u Otras entidades con posibilidad de aplicar dos tipos impositivos (ej. entidades ZEC)")
	,X08("202-X08",null,"Tipo de gravamen del Impuesto sobre Sociedades del ejercicio en curso")
	,X09("202-X09",null,"Importe neto de la cifra de negocios")
	,X10("202-X10",null,"Entidades en las que al menos el 85% de ingresos del periodo impositivo")
	,X00("202-X00",null,"Modalidad de c\u00E1lculo")
	
	,C01("202-C01","01","Base del pago fraccionado")
	,C02("202-C02","02","Resultado de la declaraci\u00F3n anterior (complementarias)")
	,C03("202-C03","03","A Ingresar")
	
	,C04("202-C04","04","Resultado contable despu\u00E9s del IS")
	,C05("202-C05","05","Correcciones al resultado contable - por Impuesto sobre Sociedades - Aumentos")
	,C06("202-C06","06","Correcciones al resultado contable - por Impuesto sobre Sociedades - Disminuciones")
	...
	,C07("202-C07","07","Resto correcciones al resultado contable, excepto comp. - Aumentos")
	,C08("202-C08","08","Resto correcciones al resultado contable, excepto comp. - Disminuciones")
	,C38("202-C38","38","TOTAL. - Aumentos")
	,C39("202-C39","39","TOTAL - Disminuciones")
	,C09("202-C09","09","25% del importe de los dividendos y rentas devengadas de fuente extranjera")
	...
	,A01("202-A01",null,"Comunicaci\u00F3n de datos adicionales a la declaraci\u00F3n")
	,A02("202-A02",null,"Numero de Referencia de Sociedades (NRS)")
	,A03("202-A03",null,"Importe excluido por operaciones de quita o espera")
	,A04("202-A04",null,"Parte integrada en la base imponible por operaciones de quita o espera")
	;
	...
	private Mod202Key(String value,String box,String description) {
    	this.value = value;
    	this.box = box;
