...
enum Model111Bizkaia2023Script implements IModelScript<Mod111Key> {
	...
	private Model111Bizkaia2023Script(String label, Mod111Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
