...
public class Mod303WriterGIPUZKOA2023 implements IMod303Writer{
...
//			el Porcentaje de Gipuzkoa, que se compone de 3 posiciones enteras y 4 posiciones decimales			
            ...
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.signed(mod.getAmount(Mod303Key.GP_C055),15))     
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.signed(mod.getAmount(Mod303Key.GP_C056),14))     
            ...
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.signed(mod.getAmount(Mod303Key.GP_C057),15))
            ...
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.signed(mod.getAmount(Mod303Key.GP_C058),15))
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.signed(mod.getAmount(Mod303Key.GP_C059),14))
            ...
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.isToDeposit()?mod.getAmount(Mod303Key.GP_C036):0.0,11))  		// [36] A ingresar N11 
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.isToCompensate()?mod.getAmount(Mod303Key.GP_C037):0.0,11))  	// [37] A compensar N11 
            ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.isToPayback()?mod.getAmount(Mod303Key.GP_C038)*(-1):0.0,11))    // [38] A devolver N11
