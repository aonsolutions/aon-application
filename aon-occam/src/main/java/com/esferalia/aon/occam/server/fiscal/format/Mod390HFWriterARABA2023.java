...
public class Mod390HFWriterARABA2023 implements IMod390HFWriter {
	...
	private static enum Mod390HFFile {
		ARABA_2019_RC ( mod -> true ,new IPropertyFiller[] {
			...
			,ARABA_2019_RD ( mod -> true ,new IPropertyFiller[] {
				...
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(50))
				...
				,(wr, mod) -> wr.append(AonFiscalFileUtils.spaces(393))
				,(wr, mod) -> wr.append(AonStringUtils.CR_LF)
