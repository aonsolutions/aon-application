...
public class FinanceDAO {
	...
	protected static class FinancePropertiesDAO implements FinanceProperties {
		...
		@Override public Property<String> getBankAliasProperty() {return new FilterDAO.PropertyDAO<>(FINANCE.BANK_ALIAS);}
	}
	...
	public static Integer insert(AONContext ctx, Finance finance) {
		...
		FinanceRecord record = ctx.getDslContext()
			.insertInto(FINANCE)
				...
				.set(FINANCE.RDOCUMENT_TYPE, DocumentType.value( finance.getRegistryDocumentType() ) )
