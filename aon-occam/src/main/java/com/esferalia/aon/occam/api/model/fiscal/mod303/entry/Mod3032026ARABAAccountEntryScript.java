...
public class Mod3032026ARABAAccountEntryScript extends AccountEntryDetailExpressionScript<Mod303> {
	
	private static final long serialVersionUID = 3230991587604937473L;
...
//				.setExpression("C38")); 
	...
	public boolean accept(Mod303 mod) {
		return mod.isAraba() && mod.getYear() >= 2026;
	}
	...
	public IFiscalModelKey getAccruedKey() {
		return Mod303Key.AR_C028;
	}

	@Override
	public IFiscalModelKey getDeductibleKey() {
		return Mod303Key.AR_C038;
	}
