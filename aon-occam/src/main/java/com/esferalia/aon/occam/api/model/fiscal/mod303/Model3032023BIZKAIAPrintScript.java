...
public enum Model3032023BIZKAIAPrintScript implements IModelScript<Mod303Key> {
	
	
	 DVG01 ("IVA DEVENGADO"				,null,TITLE)
	,DVG02 (null						,new Mod303Key[]{BZ_C048	,BZ_X048	,BZ_C049})
	,DVG03 (null						,new Mod303Key[]{BZ_C003	,BZ_X003	,BZ_C004})
	,DVG04 (null						,new Mod303Key[]{BZ_C110	,BZ_X110	,BZ_C111})
	,DVG05 (getDescription(BZ_C005)		,new Mod303Key[]{BZ_C005	,BZ_X005	,BZ_C006})
	,DVG06 (null						,new Mod303Key[]{BZ_C007	,BZ_X007	,BZ_C008})
	,DVG07 (null						,new Mod303Key[]{BZ_C009	,BZ_X009	,BZ_C010})
	,DVG08 (getDescription(BZ_C011)		,new Mod303Key[]{BZ_C011	,BZ_X011	,BZ_C012})
	,DVG09 (null						,new Mod303Key[]{BZ_C013	,BZ_X013	,BZ_C014})
	,DVG10 (null						,new Mod303Key[]{BZ_C015	,BZ_X015	,BZ_C016})
	,DVG11 (getDescription(BZ_C017) 	,new Mod303Key[]{BZ_C017	,null		,BZ_C018})
	,DVG12 (getDescription(BZ_C019)		,new Mod303Key[]{BZ_C019	,null		,BZ_C020})
	,DVG13 (getDescription(BZ_C021)		,new Mod303Key[]{BZ_C021	,null		,BZ_C022})
	,DVG14 (getDescription(BZ_C046)		,new Mod303Key[]{BZ_C046	,null		,BZ_C047})
	,DVG15 (BZ_C023.getDescription()	,new Mod303Key[]{null		,null		,BZ_C023})
	,EMPTY0(null						,null)
	...
	,AD03 ("5%"							,new Mod303Key[]{BZ_C112	,BZ_C113	,BZ_C114})
	,AD04 ("10%"						,new Mod303Key[]{BZ_C053	,BZ_C054	,BZ_C055})
	,AD05 ("21%"						,new Mod303Key[]{BZ_C056	,BZ_C057	,BZ_C058})
	,AD06 (null							,new Mod303Key[]{BZ_C059	,BZ_C060	,BZ_C061})
	,AD07 (null							,new Mod303Key[]{BZ_C062	,BZ_C063	,BZ_C064})
	,AD08 ("Total"						,new Mod303Key[]{BZ_C065	,BZ_C066	,BZ_C067})
	,AD09 ("Gastos",null,TITLE)
	,AD10 ("4%"							,new Mod303Key[]{BZ_C068	,BZ_C069	,BZ_C070})
	,AD11 ("5%"							,new Mod303Key[]{BZ_C115	,BZ_C116	,BZ_C117})
	,AD12 ("10%"						,new Mod303Key[]{BZ_C071	,BZ_C072	,BZ_C073})
	,AD13 ("21%"						,new Mod303Key[]{BZ_C074	,BZ_C075	,BZ_C076})
	,AD14 (null							,new Mod303Key[]{BZ_C077	,BZ_C078	,BZ_C079})
	,AD15 ("Total"						,new Mod303Key[]{BZ_C080	,BZ_C081	,BZ_C082})
	,AD16 ("Bienes de inversi\u00F3n",null,TITLE)
	,AD17 ("4%"							,new Mod303Key[]{BZ_C083	,BZ_C084	,BZ_C085})
	,AD18 ("10%"						,new Mod303Key[]{BZ_C086	,BZ_C087	,BZ_C088})
	,AD19 ("21%"						,new Mod303Key[]{BZ_C089	,BZ_C090	,BZ_C091})
	,AD20 (null							,new Mod303Key[]{BZ_C092	,BZ_C093	,BZ_C094})
	,AD21 ("Total"						,new Mod303Key[]{BZ_C095	,BZ_C096	,BZ_C097})
	,AD22 ("Totales"					,new Mod303Key[]{BZ_C098	,BZ_C099	,BZ_C100})
	...
	,OPE06 (BZ_C109.getDescription()	,new Mod303Key[]{BZ_C109,null		,null		})
	...
	private Model3032023BIZKAIAPrintScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
