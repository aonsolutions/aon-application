...
public enum Model123Araba2022Script implements IModelScript<Mod123Key> {
	...
	,R04 ("Retenciones e ingresos a cuenta",new Mod123Key[]{Mod123Key.AR_C01,Mod123Key.AR_C02,Mod123Key.AR_C03},MODEL_INVOICE_IRPF_BREAKDOWN)
	...
	,R08 ("Ajustes",new Mod123Key[]{Mod123Key.AR_C07},COMPUTE_KEY)
	...
	private Model123Araba2022Script(String label, Mod123Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
