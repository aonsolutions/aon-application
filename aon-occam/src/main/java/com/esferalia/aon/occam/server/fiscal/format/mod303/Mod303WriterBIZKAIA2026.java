...
public class Mod303WriterBIZKAIA2026 implements IMod303Writer{
		...
		,BIZKAIA_2025_P00 ( mod -> true ,new IPropertyFiller[] {				
			    (wr, mod) -> {
			    	if (mod.isComplementary()) {
			    		wr.append("P00TX0001");
			    		wr.append(AonFiscalFileUtils.mark(mod.isComplementary()));
			    		wr.append(AonFiscalFileUtils.spaces( 39));
			    		wr.append(AonStringUtils.CR_LF);
			    	}
			    }
			   ,(wr, mod) -> {
				   if (AonNumberUtils.equals(mod.getAmount(Mod303Key.CM_002),1)) {
					   wr.append("P00TX0002");
					   wr.append(AonFiscalFileUtils.mark(mod.getAmount(Mod303Key.CM_002)));
					   wr.append(AonFiscalFileUtils.spaces(39));
					   wr.append(AonStringUtils.CR_LF);
				   }
			   } 
			   ...
			   ,(wr, mod) -> wr.append("P00IM0044"),(wr, mod) -> wr.append(AonFiscalFileUtils.signedStandard(mod.getAmount(Mod303Key.BZ_C044),16,2)),(wr, mod) -> wr.append(AonStringUtils.CR_LF)
