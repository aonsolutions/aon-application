...
public enum Model123Gipuzkoa2022Script implements IModelScript<Mod123Key> {
	
	 R00 ("Rentas o rendimientos dinerarios",new Mod123Key[]{Mod123Key.GP_C01,Mod123Key.GP_C02,Mod123Key.GP_C03},MODEL_INVOICE_IRPF_BREAKDOWN)
	...
	private Model123Gipuzkoa2022Script(String label, Mod123Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
