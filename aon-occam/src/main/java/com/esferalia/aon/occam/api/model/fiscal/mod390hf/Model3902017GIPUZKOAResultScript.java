...
public enum Model3902017GIPUZKOAResultScript implements IModelScript<Mod390Key> {
	...
	private Model3902017GIPUZKOAResultScript(String label, Mod390Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
