...
enum Mod190File2024Navarra {
	...
	private Mod190File2024Navarra(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2024Navarra.TYPE_1.fillPage(mod190, null, wr);
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2024Navarra.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
}
