...
public class AON {
	...
	public static LinkedList<User> getUsersByScope(String domainName, Integer domainId, String userName,
			Integer scope) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, userName);
	...
	public static LinkedList<Domain> getCompaniesByScope(String domainName, Integer domainId, String userName,
			Integer scope) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, userName);
	...
	public static void updateUserPassword(String domainName, int domainId, String login, Integer userId,
			String password) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static UserScope getUserScope(String domainName, Integer domainId, String login, Integer userId,
			Integer scope) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Integer[] getUserScopes(String domainName, int domainId, String login, Integer userId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteUserScope(String domainName, Integer domainId, String login, Integer userId,
			Integer scope) {
		deleteUserScope(domainName, domainId, login,
				f -> f.getScopeProperty().eq(scope).and(f.getUserIdProperty().eq(userId)));
	}
	...
	public static Scope getScope(String domainName, Integer domainId, String login, Integer scopeId) {
		return getScopeStream(domainName, domainId, login, f -> f.getIdProperty().eq(scopeId)).findFirst()
				.orElse(new Scope());
	}
	...
	public static Stream<Scope> getUserScopeStream(String domainName, Integer domainId, String login, Integer userId,
			ScopeFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Domain getDomain(String domainName, Integer domainId, String user, DomainFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static Domain getCompanyDomain(String domainName, Integer domainId, String user, String document) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<Domain> getDriveDomainList(String domainName, Integer domainId, String login) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Domain insertDomain(String domainName, int parentDomain, String cifEnterprise, String nameEnterprise,
			List<String> messages) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, parentDomain, null);
			return getCommon().insertDomain(ctx, parentDomain, cifEnterprise, nameEnterprise, messages);
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static DomainGserviceaccount getGeneralDomainGserviceaccount(String domainName, Integer domainId,
			String login) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static HashMap<Integer, DomainGserviceaccount> getDomainGserviceaccountMap(String domainName,
			Integer domainId, String login, Integer parent) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<DomainGserviceaccount> getDomainGserviceaccountList(String domainName, Integer domainId,
			String login) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<ApplicationParameter> getApplicationParameterStream(String domainName, Integer domainId,
			String login, ApplicationParameterFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static ApplicationParameter getApplicationParameter(String domainName, Integer domainId, String login,
			String id) {
		return getApplicationParameterStream(domainName, domainId, login,
				f -> f.getDomainProperty().eq(domainId).and(f.getNameProperty().eq(id)).perPage(1)).findFirst()
				.orElse(new ApplicationParameter()); // TODO Devolver Optional
	}
	...
	public static ApplicationParameter insertApplicationParameter(String domainName, Integer domainId, String login,
			AppParam param, String value) {
	...
	public static ApplicationParameter updateApplicationParameter(String domainName, Integer domainId, String login,
			ApplicationParameter applicationParameter, ApplicationParameterFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteApplicationParameter(String domainName, Integer domainId, String login,
			ApplicationParameterFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Person> getPersonStream(String domainName, Integer domainId, String login,
			PersonFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Person> getPersonList(String domainName, Integer domainId, String login,
			PersonFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getRegistry().getPersonStream(ctx, filter).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static EnterpriseActivity getEnterpriseActivity(String domainName, Integer domainId, String login,
			Integer id) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<EnterpriseActivity> getEnterpriseActivities(String domainName, Integer domainId,
			String login) { // , EnterpriseActivityFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getCommon().getEnterpriseActivities(ctx, domainId, new Date());
		}
	}

	public static Stream<Company> getUserCompanyStream(String domainName, Integer domainId, String login,
			Integer[] scopes) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Company> getUserCompanyStream(String domainName, Integer domainId, String login,
			Integer[] scopes, CompanyFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Company> getCompanyStream(String domainName, Integer domainId, String login,
	...
	public static Stream<Company> getCompanyStream(String domainName, Integer domainId, String login,
			CompanyFilter filter, Integer page, Integer perPage) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Company getCompany(String domainName, Integer domainId, String login, CompanyFilter filter) {
		return getCompanyStream(domainName, domainId, login, filter).findFirst().orElse(new Company());
	}
	...
	public static LinkedList<CompanyBank> getCompanyBanks(String domainName, int domain, String login) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, login);
	...
	public static Stream<RDirStaff> getRDirStaffStream(String domainName, Integer domainId, String login,
			RDirStaffFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static RDirStaff getRDirStaff(String domainName, Integer domainId, String login, RDirStaffFilter filter) {
		return getRDirStaffStream(domainName, domainId, login, filter).findFirst().orElse(new RDirStaff());
	}
	...
	public static Workplace getWorkplace(String domainName, Integer domainId, String login, WorkplaceFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static PayrollWorkplace savePayrollWorkplace(Domain domain, String login,
			PayrollWorkplace payrollWorkplace) {
		return savePayrollWorkplace(domain.getName(), domain.getId(), login, payrollWorkplace);
	}

	public static PayrollWorkplace savePayrollWorkplace(String domainName, Integer domainId, String login,
			PayrollWorkplace payrollWorkplace) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<Signature> getSignatureList(String domainName, Integer domainId, String login,
	...
	public static LinkedList<OldProduct> getProductList(String domainName, Integer domainId, String login,
			ProductFilter filter) {
		return getProductStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<OldProduct> getProductStream(String domainName, Integer domainId, String login,
			ProductFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<ProductTag> getProductTagStream(String domainName, Integer domainId, String login,
	...
	public static Map<Integer, String[]> getProductTagMap(String domainName, int domainId, String login) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	@Deprecated
	public static LinkedList<OldItem> getItemList(String domainName, Integer domainId, String login,
			ItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getProduct().getItemStream(ctx, filter).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	@Deprecated
	public static LinkedList<OldItem> getFullItemList(String domainName, Integer domainId, String login,
			ItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getProduct().getFullItemStream(ctx, filter).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static OldItem getItem(String domainName, Integer domainId, String login, Integer itemId) {
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getProduct().getItemStream(ctx, f -> f.getIdProperty().eq(itemId).perPage(1)).findFirst()
					.orElse(new OldItem());
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static OldItem getItem(String domainName, Integer domainId, String login, ItemFilter filter) {
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getProduct().getItemStream(ctx, filter).findFirst().orElse(new OldItem());
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	@Deprecated
	public static Optional<OldItem> getItemOptional(String domainName, Integer domainId, String login,
			ItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<ItemComposition> getItemCompositionStream(Domain domain, String login,
			ItemCompositionFilter filter) {
		return getItemCompositionStream(domain.getName(), domain.getId(), login, filter);
	}

	public static Stream<ItemComposition> getItemCompositionStream(String domainName, Integer domainId, String login,
			ItemCompositionFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static List<ItemComposition> getItemCompositionList(String domainName, Integer domainId, String login,
			Integer itemId) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Optional<ItemAddInfo> getItemAddInfo(String domainName, Integer domainId, String login,
			ItemAddInfoFilter filter) {
		return getItemAddInfoStream(domainName, domainId, login, filter).findFirst();
	}

	public static Stream<ItemAddInfo> getItemAddInfoStream(String domainName, Integer domainId, String login,
			ItemAddInfoFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Optional<RegistryAddInfo> getRegistryAddInfo(String domainName, Integer domainId, String login,
			RegistryAddInfoFilter filter) {
		return getRegistryAddInfoStream(domainName, domainId, login, filter).findFirst();
	}

	public static Stream<RegistryAddInfo> getRegistryAddInfoStream(String domainName, Integer domainId, String login,
			RegistryAddInfoFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void insertRegistryAddInfo(String domainName, Integer domainId, String login,
			RegistryAddInfo raddinfo) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void updateRegistryAddInfo(String domainName, Integer domainId, String login,
			RegistryAddInfo raddinfo) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Brand getBrand(String domainName, Integer domainId, String login, String name) {
		return getBrand(domainName, domainId, login,
				f -> f.getNameProperty().eq(name).and(f.getDomainProperty().eq(domainId)));
	}
	...
	public static Stream<ProductCategory> getProductCategoryStream(String domainName, Integer domainId, String login,
	...
	public static ProductCategory getProductCategory(String domainName, Integer domainId, String login,
			ProductCategoryFilter filter) {
		return getProductCategoryStream(domainName, domainId, login, filter).findFirst().orElse(new ProductCategory());
	}

	public static LinkedList<ProductCategory> getProductCategoryList(String domainName, Integer domainId, String login,
			ProductCategoryFilter filter) {
		return getProductCategoryStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static ProductCategory saveProductCategory(String domainName, Integer domainId, String login,
	...
	public static Stream<Invoice> getInvoiceStream(String domainName, Integer domainId, String login,
	...
	public static InvoiceDetail insertInvoiceDetail(String domainName, Integer domainId, String login,
	...
	public static Stream<Invoice> getSiiInvoiceStream(String domainName, Integer domainId, String login,
			InvoiceFilter filter, Boolean pending, Boolean aceptada, Boolean aceptadaErrores, Boolean incorrecta,
			Boolean anulada, String sii) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getFinance().getSiiInvoiceStream(ctx, filter, pending, aceptada, aceptadaErrores, incorrecta,
					anulada, sii);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static LinkedList<Invoice> getInvoiceList(String domainName, Integer domainId, String login,
			InvoiceFilter filter) {
		return getInvoiceStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public static Invoice getInvoice(Occam occam, InvoiceFilter filter) {
		return getInvoiceStream(occam, filter).findFirst().orElse(new Invoice());
	}

	public static Invoice getInvoice(String domainName, Integer domainId, String login, InvoiceFilter filter) {
		return getInvoiceStream(domainName, domainId, login, filter).findFirst().orElse(new Invoice());
	}
	...
	public static Stream<InvoiceDetail> getInvoiceDetails(String domainName, Integer domainId, String login,
			InvoiceFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static ArrayList<InvoiceDetail> getInvoiceDetailsList(String domainName, Integer domainId, String login,
			InvoiceFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static InvoiceDetail getLastInvoiceDetail(String domainName, Integer domainId, String user, OldItem item,
	...
	public static InvoiceDetail getLastInvoiceDetailUntilDate(String domainName, Integer domainId, String user,
			OldItem item, Integer workplaceId, Integer warehouseId, Date date) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<InvoiceDetail> getLastInvoiceDetailList(String domainName, Integer domainId, String user,
			OldItem item, String months, Integer workplaceId, Integer warehouseId) {
	...
	public static LinkedList<InvoiceDetail> getLastInvoiceDetailListUntilDate(String domainName, Integer domainId,
			String user, OldItem item, String months, Integer workplaceId, Integer warehouseId, Date date) {
		Calendar calendar = Calendar.getInstance();
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
			return getFinance().getLastInvoiceDetailListUntilDate(ctx, item, calendar.getTime(), workplaceId,
					warehouseId, date);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static LinkedList<InvoiceDetail> getInvoiceDetailList(String domainName, Integer domainId, String user,
			OldItem item, Integer workplaceId, Integer warehouseId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<InvoiceDetail> getInvoiceDetailListUntilDate(String domainName, Integer domainId,
			String user, OldItem item, Integer workplaceId, Integer warehouseId, Date date) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static void rectifyInvoice(String domainName, Integer domainId, String login, Integer rectifierInvoice,
			Integer rectifiedInvoice) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static InvoicingGroup getInvoicingGroup(String domainName, Integer domainId, String login,
			InvoicingGroupFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static InvoicingGroup save(String domainName, Integer domainId, String login,
			InvoicingGroup invoicingGroup) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getFinance().save(ctx, invoicingGroup);
		}
	}

	public static Integer getInvoiceNextNumber(String domainName, Integer domainId, String login, Byte[] types,
			String series) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Integer getInvoiceMinNumber(String domainName, Integer domainId, String login, InvoiceType type,
			String series) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<InvoiceDetail> getBoughtProductStream(String domainName, Integer domainId, String login,
			InvoiceFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Finance> getFinances(String domainName, int domain, String user, FinanceParams params,
			int offset, int limit) {
		return getFinancesStream(domainName, domain, user, p -> FinanceUtils.getFilter(p, params), offset, limit)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Finance> getFinancesStream(String domainName, int domain, String user, FinanceParams params,
			int offset, int limit) {
		return getFinancesStream(domainName, domain, user, p -> FinanceUtils.getFilter(p, params), offset, limit);
	}

	public static Stream<Finance> getFinancesStream(String domainName, int domain, String user, FinanceFilter filter,
			int offset, int limit) {
		CloseableAONContext ctx = null;
		try {
	...
	public static Stream<Finance> getFinanceStream(String domainName, Integer domainId, String login,
	...
	public static LinkedList<Finance> getFinanceList(String domainName, Integer domainId, String login,
			FinanceFilter filter) {
		return getFinanceStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Finance> getSiiFinanceStream(String domainName, Integer domainId, String login,
			FinanceFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Finance> getSiiFinanceList(String domainName, Integer domainId, String login,
			FinanceFilter filter) {
	...
	public static Stream<OfferDetail> getOfferDetails(String domainName, Integer domainId, String login,
			OfferFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static OfferDetail insertOfferDetail(String domainName, Integer domainId, String login,
	...
	public static Sales getSales(String domainName, Integer domainId, String login, SalesFilter filter,
			Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<SalesDetail> getSalesDetailStream(String domainName, Integer domainId, String login,
			SalesDetailFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getManagement().getSalesDetailStream(ctx, filter);
		}
	}

	public static Stream<SalesDetail> getSalesDetails(String domainName, Integer domainId, String login,
			SalesFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<Purchase> getPurchaseStream(String domainName, Integer domainId, String login,
	...
	public static LinkedList<Purchase> getPurchaseList(String domainName, Integer domainId, String login,
			PurchaseFilter filter) {
		return getPurchaseStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Purchase getPurchase(String domainName, Integer domainId, String login, PurchaseFilter filter) {
		return getPurchaseStream(domainName, domainId, login, filter).findFirst().orElse(new Purchase());
	}

	public static Purchase getPurchase(String domainName, Integer domainId, String login, Integer id) {
	...
	public static Stream<PurchaseDetail> getPurchaseDetailStream(String domainName, Integer domainId, String login,
	...
	public static Stream<PurchaseDetail> getPurchaseDetails(String domainName, Integer domainId, String login,
			PurchaseFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<PurchaseDetail> getPurchaseDetailList(String domainName, Integer domainId, String login,
			PurchaseDetailFilter filter) {
		return getPurchaseDetailStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static PurchaseDetail getPurchaseDetail(String domainName, Integer domainId, String login,
			PurchaseDetailFilter filter) {
		return getPurchaseDetailStream(domainName, domainId, login, filter).findFirst().orElse(new PurchaseDetail());
	}

	public static PurchaseDetail getPurchaseDetail(String domainName, Integer domainId, String login, Integer id) {
		return getPurchaseDetail(domainName, domainId, login, f -> f.getIdProperty().eq(id));
	}

	public static Integer insertPurchaseDetail(String domainName, Integer domainId, String login,
	...
	public static PurchaseDetail updatePurchaseDetail(String domainName, Integer domainId, String login,
			PurchaseDetail purchaseDetail, PurchaseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static PurchaseDetail updatePurchaseDetail(String domainName, Integer domainId, String login,
			PurchaseDetail purchaseDetail) {
		return updatePurchaseDetail(domainName, domainId, login, purchaseDetail,
				f -> f.getIdProperty().eq(purchaseDetail.getId()));
	}

	public static void deletePurchaseDetail(String domainName, Integer domainId, String login,
			PurchaseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Delivery> getDeliveryStream(String domainName, Integer domainId, String login,
			DeliveryFilter filter, Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Delivery getDelivery(String domainName, Integer domainId, String login, DeliveryFilter filter,
			Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<DeliveryDetail> getDeliveryDetails(String domainName, Integer domainId, String login,
			DeliveryFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<DeliveryDetail> getDeliveryDetailList(String domainName, Integer domainId, String login,
			DeliveryDetailFilter filter) {
		return getDeliveryDetailStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static DeliveryDetail getDeliveryDetail(String domainName, Integer domainId, String login,
			DeliveryDetailFilter filter) {
		return getDeliveryDetailStream(domainName, domainId, login, filter).findFirst().orElse(new DeliveryDetail());
	}

	public static DeliveryDetail getDeliveryDetail(String domainName, Integer domainId, String login, Integer id) {
		return getDeliveryDetail(domainName, domainId, login, f -> f.getIdProperty().eq(id));
	}

	public static DeliveryDetail insertDeliveryDetail(String domainName, Integer domainId, String login,
	...
	public static Stream<Salary> getContractData(AONContext ctx, SalaryFilter filter) {
		return getSalary().getSalaryData(ctx, filter, Salary::new);
	}

	public static Stream<Bonus> getAvailableBonuses(AONContext ctx, BonusFilter filter) {
	...
	public static Map<String, Workplace> getWorkplacesSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<String, Seller> getSellersSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<String, InvoicingGroup> getInvoicingGroupsSuggestion(String domainName, int domainId,
	...
	public static Map<String, Project> getProjectsSuggestion(String domainName, int domainId, String login,
			Integer customerId, String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getFinance().getProjectsSuggestion(ctx, domainId, customerId, query);
		}
	}

	public static Map<String, OldItem> getProductsSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<String, Integer> getProductCategoriesSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<String, Integer> getProductTagsSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<String, Customer> getCustomersSuggestion(String domainName, int domainId, String login,
			String query) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Map<Integer, Integer> getCustomerProductsUpdates(String domainName, int domainId, String login,
			CustomerFeeParams customerFeeParams) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Fee getFee(String domainName, Integer domainId, String login, FeeFilter filter) {
		return getFeeStream(domainName, domainId, login, filter).findFirst().orElse(new Fee());
	}

	public static LinkedList<Fee> getFeeList(String domainName, Integer domainId, String login,
			CustomerFeeParams customerFeeParams) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<Fee> getFullFeeList(String domainName, Integer domainId, String login,
			CustomerFeeParams customerFeeParams) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<Fee> getFeeList(String domainName, Integer domainId, String login, FeeFilter filter) {
		return getFeeStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public static Integer saveMassiveFees(String domainName, Integer domainId, String login, Fee fee,
			CustomerFeeParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static User getUser(Integer domainId, String domainName, String userName, Integer userId) {
		return getUserStream(domainName, domainId, userName, f -> f.getIdProperty().eq(userId)).findFirst()
				.orElse(new User());
	}
	...
	public static Stream<User> getDomainUserStream(Domain domain, User user, Integer page, Integer perPage,
			UserFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, user)) {
	...
	public static Stream<Registry> getRegistryStream(String domainName, Integer domainId, String login,
	...
	public static Stream<Registry> getAonRegistryStream(String domainName, Integer domainId, String login,
			RegistryFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	@Deprecated
	public static void insertNotificationInfo(String domainName, Integer domainId, String login, String data,
			AppParam appParam) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	// ****************************** GROUPWARE **
	// ********************************************
	public static Notice getNotice(String domainName, Integer domainId, String login, Integer noticeId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Integer insertNotice(Integer domainId, String domainName, String userName, Notice notice)
			throws Exception {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, userName);
	...
	public static Alarm getAlarm(String domainName, Integer domainId, String login, Integer alarmId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Integer insertAlarm(Integer domainId, String domainName, String userName, Alarm alarm)
			throws Exception {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, userName);
	...
	public static Attach getAttach(String domainName, Integer domainId, String login, AttachFilter filter,
	...
	public static Attach getRawdocAttach(String domainName, Integer domainId, String login, RawdocFilter filter,
			AttachType attachType) {
	...
	public static LinkedList<Attach> getAttachList(String domainName, Integer domainId, String login,
			AttachFilter filter, AttachType attachType, Boolean withData) {
		return getAttachStream(domainName, domainId, login, filter, attachType, withData)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Attach> getDocumentalAttachStream(String domainName, Integer domainId, String login,
			AttachFilter filter, AttachType attachType, Boolean withData, Options... options) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void setAttach(String domainName, Integer domainId, String login, byte[] data, Integer attachId,
			AttachType attachType) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Attach> getAttachStream(String domainName, Integer domainId, String login, AttachFilter filter,
			AttachType attachType, Boolean withData) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Attach> getRawdocAttachStream(String domainName, Integer domainId, String login,
			RawdocFilter filter, AttachType attachType) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void updateAttach(String domainName, Integer domainId, String login, Attach attach) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void updateAttachData(String domainName, Integer domainId, String login, Attach attach) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void updateAttachDriveId(String domainName, Integer domainId, String login, Integer attachId,
			String driveId, AttachType attachType) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			if (attachType.equals(AttachType.REGISTRY))
	...
	@Deprecated
	public static void delete(String domainName, Integer domainId, String login, AttachFilter filter,
			AttachType attachType) {
		deleteAttach(domainName, domainId, login, filter, attachType);
	}

	public static void deleteAttach(String domainName, Integer domainId, String login, AttachFilter filter,
			AttachType attachType) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Tag> getRegistryAttachTag(String domainName, Integer domainId, String login,
			Integer rattachId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	@Deprecated
	public static RattachTag insertRegistryAttachTag(String domainName, Integer domainId, String login,
			Integer rattachId, Integer tagId) {
		RattachTag rt = new RattachTag().setDomain(domainId).setRattach(rattachId).setTag(new Tag().setId(tagId));
		return save(new Domain().setName(domainName).setId(domainId), login, rt);
	}

	public static void deleteRegistryAttachTag(String domainName, Integer domainId, String login, Integer rattachId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteTagRegistryAttach(String domainName, Integer domainId, String login, Integer tagId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Warehouse> getWarehouseStream(String domainName, Integer domainId, String login,
	...
	public static Stream<IncomeDetail> getIncomeDetails(String domainName, Integer domainId, String login,
			IncomeFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Income> getIncomeStream(String domainName, Integer domainId, String login,
			IncomeFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Income> getIncomeList(String domainName, Integer domainId, String login,
			IncomeFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getWarehouse().getIncomeStream(ctx, filter).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static Optional<IncomeDetail> insertIncomeDetail(String domainName, Integer domainId, String login,
	...
	public static Optional<IncomeDetail> updateIncomeDetail(String domainName, Integer domainId, String login,
			IncomeDetail incomeDetail) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Optional<IncomeDetail> deleteIncomeDetail(String domainName, Integer domainId, String login,
			Integer id) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Optional<IncomeDetail> getIncomeDetail(String domainName, Integer domainId, String login,
			IncomeDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getWarehouse().getIncomeDetailStream(ctx, filter).findFirst();
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static IncomeDetail getLastIncomeDetail(String domainName, Integer domainId, String user, OldItem item,
			Integer workplaceId, Integer warehouseId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static IncomeDetail getLastIncomeDetailUntilDate(String domainName, Integer domainId, String user,
			OldItem item, Integer workplaceId, Integer warehouseId, Date date) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<IncomeDetail> getLastIncomeDetailList(String domainName, Integer domainId, String user,
			OldItem item, String months, Integer workplaceId, Integer warehouseId) {
		Calendar calendar = Calendar.getInstance();
		Integer m = Integer.parseInt(months);
		calendar.add(Calendar.MONTH, -m);
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
			return getWarehouse().getLastIncomeDetailList(ctx, item, calendar.getTime(), workplaceId, warehouseId);
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static LinkedList<IncomeDetail> getLastIncomeDetailListUntilDate(String domainName, Integer domainId,
			String user, OldItem item, String months, Integer workplaceId, Integer warehouseId, Date date) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
		Integer m = Integer.parseInt(months);
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
			return getWarehouse().getLastIncomeDetailListUntilDate(ctx, item, calendar.getTime(), workplaceId,
					warehouseId, date);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static LinkedList<IncomeDetail> getIncomeDetailList(String domainName, Integer domainId, String user,
			OldItem item, Integer workplaceId, Integer warehouseId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<IncomeDetail> getIncomeDetailListUntilDate(String domainName, Integer domainId,
			String user, OldItem item, Integer workplaceId, Integer warehouseId, Date date) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static Stream<InventoryDetail> getInventoryDetailStream(String domainName, Integer domainId, String login,
	...
	public static LinkedList<InventoryDetail> getInventoryDetailList(String domainName, Integer domainId, String user,
			Integer inventoryId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static Department getDepartment(String domainName, Integer domainId, String login, Integer workplaceId,
	...
	public static LinkedList<Series> getSeriesList(String domainName, Integer domainId, String login,
			SeriesFilter filter) {
		return getSeriesStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Series> getSeriesStream(String domainName, Integer domainId, String login,
			SeriesFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static StatData<String, String, Double> getStatData(String domainName, Integer domainId, String user,
			StatParams params) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static StatData<String, String, Double> getFinanceStat(String domainName, Integer domainId, String user,
	...
	public static Stream<OldTask> getStatTaskStream(String domainName, Integer domainId, String login,
			StatParams params) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static StatData<Integer, String, Double> getProductStat(String domainName, Integer domainId, String login,
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getStats().getProductStat(ctx, productFilter, itemFilter, invoiceFilter, deliveryFilter, salesFilter,
					purchaseFilter);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static StatData<Integer, String, Double> getProductMovements(String domainName, Integer domainId,
			String login, ProductFilter productFilter, ItemFilter itemFilter, InvoiceFilter invoiceFilter,
			DeliveryFilter deliveryFilter, IncomeFilter incomeFilter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getStats().getProductMovements(ctx, productFilter, itemFilter, invoiceFilter, deliveryFilter,
					incomeFilter);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static StatData<Integer, String, Double> getItemMovements(String domainName, Integer domainId, String login,
			ProductFilter productFilter, ItemFilter itemFilter, InvoiceFilter invoiceFilter,
			DeliveryFilter deliveryFilter, IncomeFilter incomeFilter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getStats().getItemMovements(ctx, productFilter, itemFilter, invoiceFilter, deliveryFilter,
					incomeFilter);
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static StatData<Integer, String, Double> getElaborationMovements(String domainName, Integer domainId,
			String login, ProductFilter productFilter, ItemFilter itemFilter, ElaborationFilter elaborationFilter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Project> getProjectStream(Domain domain, User user, ProjectFilter filter, Integer page,
			Integer perPage) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, user)) {
	...
	public static Stream<Project> getProjectStream(String domainName, Integer domainId, String login,
	...
	public static LinkedList<Project> getProjectList(String domainName, Integer domainId, String login,
			ProjectFilter filter) {
		return getProjectStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}
	...
	/**
	 * @deprecated Replaced by com.esferalia.aon.occam.api.AON.saveProject(Domain
	 *             domain0, User user, Project project)
	 */
	@Deprecated(forRemoval = true)
	public static Integer insertProject(String domainName, Integer domainId, String login, Project project) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	/**
	 * @deprecated Replaced by com.esferalia.aon.occam.api.AON.getProjectType(String
	 *             domainName, Integer domainId, String login, ProjectTypeFilter
	 *             filter)
	 */
	@Deprecated(forRemoval = true)
	public static ProjectType getProjectType(String domainName, Integer domainId, String login, String description) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getProject().getProjectType(ctx,
					f -> f.getDomainProperty().eq(domainId).and(f.getDescriptionProperty().eq(description)));
		}
	}

	public static ProjectType getProjectType(String domainName, Integer domainId, String login,
	...
	public static ProjectType saveProjectType(String domainName, Integer domainId, String login,
	...
	public static ProjectHolder getProjectHolder(String domainName, Integer domainId, String login,
			ProjectHolderFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<ProjectHolder> getProjectHolderStream(Domain domain, String login,
			ProjectHolderFilter filter) {
		return getProjectHolderStream(domain.getName(), domain.getId(), login, filter);
	}

	public static Stream<ProjectHolder> getProjectHolderStream(String domainName, Integer domainId, String login,
			ProjectHolderFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static List<ProjectHolder> getProjectHolderList(String domainName, Integer domainId, String login,
			ProjectHolderFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<ProjectActivity> getProjectActivityStream(Domain domain, User user,
			ProjectActivityFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain.getName(), domain.getId(), user.getLogin())) {
	...
	public static Integer insertProjectCommercial(String domainName, Integer domainId, String login,
	...
	public static ProjectReservation getProjectReservation(String domainName, Integer domainId, String login,
			ProjectReservationFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<ProjectReservation> getProjectReservationStream(String domainName, Integer domainId,
			String login, ProjectReservationFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<ProjectCommercial> getProjectCommercialStream(String domainName, Integer domainId,
			String login, ProjectCommercialFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<ProjectCommercial> getProjectCommercialList(String domainName, Integer domainId,
			String login, ProjectCommercialFilter filter) {
		return getProjectCommercialStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static ProjectCommercial getProjectCommercial(String domainName, Integer domainId, String login,
			ProjectCommercialFilter filter) {
		return getProjectCommercialStream(domainName, domainId, login, filter).findFirst()
	...
	private static Double stock(Domain domain, String login, Integer item, Double quantity, Integer warehouse) {
		Double q = quantity;
		Optional<Stock> stockOptional = getStockStream(domain.getName(), domain.getId(), login,
				f -> f.getDomainProperty().eq(domain.getId()).and(f.getItemProperty().eq(item))
		...
		if (stockOptional.isPresent()) {
			...
			Stock stock = new Stock().setDomain(domain.getId()).setItem(item).setQuantity(quantity)
	...
	public static Integer getWarehouseTransferNextNumber(String domainName, Integer domainId, String login,
			String serie) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<WarehouseTransfer> getWarehouseTransferStream(String domainName, Integer domainId,
			String login, WarehouseTransferFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static WarehouseTransfer getWarehouseTransfer(String domainName, Integer domainId, String login,
			WarehouseTransferFilter filter) {
		return getWarehouseTransferStream(domainName, domainId, login, filter).findFirst()
				.orElse(new WarehouseTransfer());
	}

	public static LinkedList<WarehouseTransfer> getWarehouseTransferList(String domainName, Integer domainId,
			String login, WarehouseTransferFilter filter) {
		return getWarehouseTransferStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public static Stream<WarehouseTransferDetail> getWarehouseTransferDetailStream(String domainName, Integer domainId,
			String login, WarehouseTransferFilter filter, ProductFilter pFilter, ItemFilter iFilter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void updateInventory(String domainName, Integer domainId, String login, Inventory inventory) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteInventory(String domainName, Integer domainId, String login, Integer inventoryId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Supplier> getSupplierStream(String domainName, Integer domainId, String login,
	...
	public static Stream<Supplier> getSupplierStream(String domainName, Integer domainId, String login,
			SupplierFilter filter, int offset, int limit) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getSupplierStream(ctx, filter, offset, limit);
		}
	}

	public static LinkedList<Supplier> getSupplierList(String domainName, Integer domainId, String login,
			SupplierFilter filter) {
		return getSupplierStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Optional<Supplier> getSupplier(String domainName, Integer domainId, String login,
			SupplierFilter filter) {
		return getSupplierStream(domainName, domainId, login, filter).findFirst();
	}
	...
	public static Stream<Target> getTargetStream(String domainName, Integer domainId, String login,
			TargetFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Optional<Target> getTarget(String domainName, Integer domainId, String login, TargetFilter filter) {
		return getTargetStream(domainName, domainId, login, filter).findFirst();
	}
	...
	public static Stream<Carrier> getCarrierStream(Domain domain, String login, CarrierFilter filter,
			Options... options) {
		return getCarrierStream(domain, login, filter, options);
	}

	public static Stream<Carrier> getCarrierStream(String domainName, Integer domainId, String login,
			CarrierFilter filter, Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static List<CarrierPacking> getCarrierPackingList(Occam occam, CarrierPackingFilter filter,
			Options... options) {
		return getCarrierPackingList(occam.getDomainName(), occam.getDomain(), occam.getUser(), filter, options);
	}

	public static List<CarrierPacking> getCarrierPackingList(Domain domain, User user, CarrierPackingFilter filter,
			Options... options) {
		return getCarrierPackingList(domain.getName(), domain.getId(), user.getLogin(), filter, options);
	}

	public static List<CarrierPacking> getCarrierPackingList(Domain domain, String login, CarrierPackingFilter filter,
			Options... options) {
		return getCarrierPackingList(domain.getName(), domain.getId(), login, filter, options);
	}

	public static List<CarrierPacking> getCarrierPackingList(String domainName, Integer domainId, String login,
			CarrierPackingFilter filter, Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<CarrierPacking> getCarrierPackingStream(String domainName, Integer domainId, String login,
	...
	public static LinkedList<CarrierPacking> getCarrierPackingList(String domainName, Integer domainId, String login,
			CarrierPackingFilter filter) {
		return getCarrierPackingStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static CarrierPacking getCarrierPacking(String domainName, Integer domainId, String login,
			CarrierPackingFilter filter) {
		return getCarrierPackingStream(domainName, domainId, login, filter).findFirst().orElse(new CarrierPacking());
	}
	...
	public static Integer insertCarrierPacking(String domainName, Integer domainId, String login,
	...
	public static CarrierPacking updateCarrierPacking(String domainName, Integer domainId, String login,
			CarrierPacking carrierPacking, CarrierPackingFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static CarrierPacking updateCarrierPacking(String domainName, Integer domainId, String login,
			CarrierPacking carrierPacking) {
		return updateCarrierPacking(domainName, domainId, login, carrierPacking,
				f -> f.getIdProperty().eq(carrierPacking.getId()));
	}

	public static void deleteCarrierPacking(String domainName, Integer domainId, String login,
			CarrierPackingFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Elaboration getElaboration(Domain domain, String login, ElaborationFilter filter,
			Options... options) {
		return getElaboration(domain.getName(), domain.getId(), login, filter, options);
	}

	public static Elaboration getElaboration(String domainName, Integer domainId, String login,
			ElaborationFilter filter, Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static List<Elaboration> getElaborationList(Domain domain, User user, ElaborationFilter filter,
			Options... options) {
		return getElaborationList(domain.getName(), domain.getId(), user.getLogin(), filter, options);
	}

	public static List<Elaboration> getElaborationList(Domain domain, String login, ElaborationFilter filter,
			Options... options) {
	...
	public static Elaboration getFullElaboration(String domainName, Integer domainId, String login, Integer id) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			Elaboration e = getWarehouse().getElaboration(ctx, id);

			Item item = getItem(new Domain().setName(domainName).setId(domainId), login,
					f -> f.getIdProperty().eq(e.getItem().getId()));
			e.setItem(item);

			e.setWarehouse(
					getWarehouse(domainName, domainId, login, f -> f.getIdProperty().eq(e.getWarehouse().getId())));
			return e;
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static Elaboration saveElaboration(String domainName, Integer domainId, String login,
	 ...
	 */
	@Deprecated(forRemoval = true)
	public static Integer insertElaboration(String domainName, Integer domainId, String login,
			Elaboration elaboration) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	 ...
	 */
	@Deprecated(forRemoval = true)
	public static Elaboration updateElaboration(String domainName, Integer domainId, String login,
			Elaboration elaboration) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Elaboration deleteElaboration(String domainName, Integer domainId, String login,
	...
	public static Stream<ElaborationDetail> getElaborationDetailStream(String domainName, Integer domainId,
			String login, ElaborationDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			...
			list.forEach(detail -> {
				Item item = getItem(new Domain().setName(domainName).setId(domainId), login,
						f -> f.getIdProperty().eq(detail.getItem().getId()));
				detail.setItem(item);

				detail.setWarehouse(getWarehouse(domainName, domainId, login,
						f -> f.getIdProperty().eq(detail.getWarehouse().getId())));
			});
			return list.stream();
		} finally {
			if (ctx != null)
	...
	public static ElaborationDetail getFullElaborationDetail(String domainName, Integer domainId, String login,
			Integer id) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			...
			Item item = getItem(new Domain().setName(domainName).setId(domainId), login,
					f -> f.getIdProperty().eq(d.getItem().getId()));
			d.setItem(item);

			d.setWarehouse(
					getWarehouse(domainName, domainId, login, f -> f.getIdProperty().eq(d.getWarehouse().getId())));
			return d;
		} finally {
			if (ctx != null)
				ctx.close();
	...
	public static Integer insertElaborationDetail(String domainName, Integer domainId, String login,
		...
		try {
			...
			if (detail.getWarehouse() != null) {
				AON.addStock(getDomain(domainName, domainId, login), login, detail.getItem().getId(),
						detail.getQuantity(), detail.getWarehouse().getId());
				return id;
			}
			return null;
		} finally {
	...
	public static ElaborationDetail updateElaborationDetail(String domainName, Integer domainId, String login,
			ElaborationDetail detail) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			...
			if (detail.getWarehouse() != null) {
				...
				Double oldQuantity = AON
						.getElaborationStream(domainName, domainId, login, f -> f.getIdProperty().eq(id)).findFirst()
						.get().getQuantity();
				AON.substractStock(getDomain(domainName, domainId, login), login, detail.getItem().getId(), oldQuantity,
	...
	public static ElaborationDetail deleteElaborationDetail(String domainName, Integer domainId, String login,
	...
	public static ElaborationDetail deleteElaborationDetail(String domainName, Integer domainId, String login,
		...
		try {
			...
			// substractStock
			if (detail.getWarehouse() != null) {
				AON.substractStock(getDomain(domainName, domainId, login), login, detail.getItem().getId(),
						detail.getQuantity(), detail.getWarehouse().getId());
				return detail;
			}
			return null;
	...
	public static List<ElaborationDetailComposition> getElaborationDetailCompositionList(String domainName,
			Integer domainId, String login, Integer elaborationDetailId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			List<ElaborationDetailComposition> list = getWarehouse().getElaborationDetailCompositionList(ctx,
					elaborationDetailId);
			list.forEach(composition -> {
				Item item = getItem(new Domain().setName(domainName).setId(domainId), login,
						f -> f.getIdProperty().eq(composition.getItem().getId()));
				composition.setItem(item);

				composition.setWarehouse(getWarehouse(domainName, domainId, login,
						f -> f.getIdProperty().eq(composition.getWarehouse().getId())));
			});
			return list;
		} finally {
			if (ctx != null)
	...
	public static Integer insertElaborationDetailComposition(String domainName, Integer domainId, String login,
		...
		try {
			...
			if (composition.getWarehouse() != null) {
				AON.substractStock(getDomain(domainName, domainId, login), login, composition.getItem().getId(),
						composition.getQuantity(), composition.getWarehouse().getId());
				return id;
			}
			return null;
		} finally {
		...
		try {
			...
			if (composition.getWarehouse() != null) {
				Double oldQuantity = AON.getElaborationDetailCompositionList(domainName, domainId, login,
						composition.getElaborationDetail().getId()).get(0).getQuantity();
				AON.substractStock(getDomain(domainName, domainId, login), login, composition.getItem().getId(),
						oldQuantity, composition.getWarehouse().getId());
				AON.addStock(getDomain(domainName, domainId, login), login, composition.getItem().getId(),
						composition.getQuantity(), composition.getWarehouse().getId());
				return composition;
			}
			return null;
	...
	public static ElaborationDetailComposition deleteElaborationDetailComposition(String domainName, Integer domainId,
		...
		if (list != null) {
			list.forEach(composition -> deleteElaborationDetailComposition(domainName, domainId, login,
					composition.getId()));
		}
		return null;
	}
	...
	public static ElaborationDetailComposition deleteElaborationDetailComposition(String domainName, Integer domainId,
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			ElaborationDetailComposition composition = getWarehouse().getElaborationDetailComposition(ctx,
					compositionId);
	...
	/**
	 * @deprecated Replaced by com.esferalia.aon.occam.api.AON.save(String
	 *             domainName, Integer domainId, String login, Registry registry)
	 */
	@Deprecated(forRemoval = true)
	...
	public static Stream<Customer> getCustomerStream(String domainName, Integer domainId, String login,
	...
	public static Stream<Customer> getCustomerStream(String domainName, Integer domainId, String login,
			CustomerFilter filter, int ofs, int limit) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getCustomers(ctx, filter, ofs, limit);
		}
	}

	public static LinkedList<Customer> getCustomerList(String domainName, Integer domainId, String login,
			CustomerFilter filter) {
		return getCustomerStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Customer getCustomer(String domainName, Integer domainId, String login, CustomerFilter filter) {
		return getCustomerStream(domainName, domainId, login, filter).findFirst().orElse(new Customer());
	}
	...
	public static Stream<Seller> getSellerStream(String domainName, Integer domainId, String login,
			SellerFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Seller> getSellerList(String domainName, Integer domainId, String login,
			SellerFilter filter) {
		return getSellerStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Seller getSeller(String domainName, Integer domainId, String login, SellerFilter filter) {
		return getSellerStream(domainName, domainId, login, filter).findFirst().orElse(new Seller());
	}
	...
	public static Stream<RegistrySeller> getRegistrySellerStream(Domain domain, String login,
			RegistrySellerFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, login)) {
	...
	public static Stream<RegistrySeller> getRegistrySellerStream(Domain domain, String login,
			RegistrySellerFilter filter, int offset, int limit) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, login)) {
	 ...
	 */
	public static Category getCategory(String domainName, Integer domainId, String login, Integer categoryId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	 ...
	 */
	public static Stream<Category> getCategoryStream(String domainName, Integer domainId, String login,
	 ...
	 */
	public static Stream<RegistryBank> getRBankStream(String domainName, Integer domainId, String login,
			RegistryBankFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static RegistryBank getRBank(String domainName, Integer domainId, String login, RegistryBankFilter filter) {
		return getRBankStream(domainName, domainId, login, filter).findFirst().orElse(new RegistryBank());
	}

	public static LinkedList<RegistryBank> getRBankList(String domainName, Integer domainId, String login,
			RegistryBankFilter filter) {
		return getRBankStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}
	 ...
	 */
	public static Stream<RegistryPayMethod> getRPayMethodStream(String domainName, Integer domainId, String login,
			RegistryPayMethodFilter filter) {
	 ...
	 */
	public static RegistryPayMethod getRPayMethod(String domainName, Integer domainId, String login,
			RegistryPayMethodFilter filter) {
	 ...
	 */
	public static RegistryPayMethod insertRPayMethod(String domainName, Integer domainId, String login,
			RegistryPayMethod rpaymethod) {
	...
	public static RegistryPayMethod getRegistryPayMethod(String domainName, Integer domainId, String login,
			RegistryPayMethodFilter filter, Options... options) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getRegistryPayMethod(ctx, filter, options);
		}
	}

	public static Stream<RegistryPayMethod> getRegistryPayMethodStream(String domainName, Integer domainId,
			String login, RegistryPayMethodFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getRegistryPayMethodStream(ctx, filter);
		}
	}

	public static RegistryPayMethod saveRegistryPayMethod(Domain domain, User user,
			RegistryPayMethod registryPayMethod) {
		return saveRegistryPayMethod(domain.getName(), domain.getId(), user.getLogin(), registryPayMethod);
	}

	public static RegistryPayMethod saveRegistryPayMethod(Domain domain, String login,
			RegistryPayMethod registryPayMethod) {
		return saveRegistryPayMethod(domain.getName(), domain.getId(), login, registryPayMethod);
	}

	public static RegistryPayMethod saveRegistryPayMethod(String domainName, Integer domainId, String login,
			RegistryPayMethod registryPayMethod) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<RegistryMedia> getStream(String domainName, Integer domainId, String login,
			RegistryMediaFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static RegistryMedia getRMedia(String domainName, Integer domainId, String login,
			RegistryMediaFilter filter) {
		return getRMediaStream(domainName, domainId, login, filter).findFirst().orElse(new RegistryMedia());
	}
	...
	public static LinkedList<RegistryMedia> getRMediaList(String domainName, Integer domainId, String login,
			RegistryMediaFilter filter) {
		return getRMediaStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public static RegistryNote getRegistryNote(String domainName, Integer domainId, String login,
	...
	public static Stream<RegistryNote> getRegistryNoteStream(String domainName, Integer domainId, String login,
			RegistryNoteFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static List<RegistryNote> getRegistryNoteList(String domainName, Integer domainId, String login,
			RegistryNoteFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<RegistryItem> getRItemStream(String domainName, Integer domainId, String login,
			RegistryItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<RegistryItem> getRItemList(String domainName, Integer domainId, String login,
			RegistryItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getRegistry().getRItemStream(ctx, filter).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static LinkedList<RegistryItem> getRItemList(String domainName, Integer domainId, String login,
			RegistryItemFilter filter, int limit, int offset) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static RegistryItem getRItem(String domainName, Integer domainId, String login, RegistryItemFilter filter) {
		...
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getRegistry().getRItemStream(ctx, filter).findFirst().orElse(new RegistryItem());
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static Stream<RegistrySegment> getRegistrySegmentStream(Domain domain, User user,
			RegistrySegmentFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain.getName(), domain.getId(), user.getLogin())) {
	...
	public static Integer[] getRSegmentStream(String domainName, Integer domainId, String login,
			RegistrySegmentFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
...
//	}
	...
	public static Stream<Seller> getRSellerStream(String domainName, Integer domainId, String login,
			Integer registryId) {
		return getRSellerStream(domainName, domainId, login,
				f -> f.getDomainProperty().eq(domainId).and(f.getRegistryProperty().eq(registryId)));
	}
	...
	public static RAddress getRAddress(String domainName, Integer domainId, String login,
			RegistryAddressFilter filter) {
		return getRAddressStream(domainName, domainId, login, filter).findFirst().orElse(new RAddress());
	}

	public static RAddress getRAddres(String domainName, Integer domainId, String login, Integer registryId) {
		return getRAddressStream(domainName, domainId, login, f -> f.getRegistryProperty().eq(registryId)).findFirst()
				.orElse(new RAddress());
	}
	...
	public static Stream<RegistryAddress> getStream(String domainName, Integer domainId, String login,
			RegistryAddressFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getStream(ctx, filter);
		}
	...
	public static Stream<RecordData> getRecordDataStream(String domainName, Integer domainId, String login,
			RecordDataFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static RecordData getRecordData(String domainName, Integer domainId, String login, RecordDataFilter filter) {
		return getRecordDataStream(domainName, domainId, login, filter).findFirst().orElse(new RecordData());
	}
	...
	public static Stream<Creditor> getCreditorStream(String domainName, Integer domainId, String login,
	...
	public static Stream<Creditor> getCreditorStream(String domainName, Integer domainId, String login,
			CreditorFilter filter, int offset, int limit) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getRegistry().getCreditorStream(ctx, filter, offset, limit);
		}
	}

	public static LinkedList<Creditor> getCreditorList(String domainName, Integer domainId, String login,
			CreditorFilter filter) {
		return getCreditorStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Optional<Creditor> getCreditor(String domainName, Integer domainId, String login,
			CreditorFilter filter) {
		return getCreditorStream(domainName, domainId, login, filter).findFirst();
	}
	...
	public static Stream<CommercialTracking> getCommercialTrackingStream(String domainName, Integer domainId,
			String login, CommercialTrackingFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<CommercialTracking> getCommercialTrackingList(String domainName, Integer domainId,
			String login, CommercialTrackingFilter filter) {
		return getCommercialTrackingStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static void updateEventId(String domainName, Integer domainId, String login, Integer ctId, String eventId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<CommercialActivity> getCommercialActivityList(String domainName, Integer domainId,
			String login, CommercialActivityFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<InvoiceSeries> getInvoiceSeries(String domainName, int domainId, String login, Date from,
			Date to, boolean taxDate) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Contact getContact(String domainName, Integer domainId, String login, ContactFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static String getContactEmail(String domainName, Integer domainId, String login, Integer contactDataId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Tax getTax(String domainName, Integer domainId, String login, String name) {
		return getTax(domainName, domainId, login,
				f -> f.getDomainProperty().eq(domainId).and(f.getNameProperty().eq(name)));
	}
	...
	public static Tag getTag(String domainName, Integer domainId, String login, TagFilter filter) {
		return getTagStream(domainName, domainId, login, filter).findFirst().orElse(new Tag());
	}

	public static LinkedList<Tag> getTagList(String domainName, Integer domainId, String login, TagFilter filter) {
		return getTagStream(domainName, domainId, login, filter).collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Tag> getTagStream(String domainName, Integer domainId, String login, TagFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<OldTask> getDuplicateTaskStream(String domainName, Integer domainId, String login,
			Integer parent) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Integer[] getTaskCount(String domainName, Integer domainId, String login, TaskFilter filter,
			IssueFilter issueFilter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<OldTask> getTaskList(String domainName, Integer domainId, String login, TaskFilter filter,
			IssueFilter issueFilter) {
		return getTaskStream(domainName, domainId, login, filter, issueFilter)
				.collect(Collectors.toCollection(LinkedList::new));
	}

	public static Stream<Tag> getTaskLabelStream(String domainName, Integer domainId, String login,
			TaskTagFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Tag> getTaskLabelList(String domainName, Integer domainId, String login,
			TaskTagFilter filter) {
	...
	public static Stream<TaskComment> getTaskCommentStream(String domainName, Integer domainId, String login,
			TaskCommentFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static TaskComment getTaskComment(String domainName, Integer domainId, String login,
			TaskCommentFilter filter) {
		return getTaskCommentStream(domainName, domainId, login, filter).findFirst().orElse(new TaskComment());
	}

	public static LinkedList<TaskComment> getTaskCommentList(String domainName, Integer domainId, String login,
			TaskCommentFilter filter) {
		return getTaskCommentStream(domainName, domainId, login, filter)
				.collect(Collectors.toCollection(LinkedList::new));
	}
	...
	public static TaskComment getTaskComment(String domainName, Integer domainId, String login, Integer taskCommentId) {
		return getTaskCommentStream(domainName, domainId, login, f -> f.getIdProperty().eq(taskCommentId)).findFirst()
				.orElse(new TaskComment());
	}

	public static TaskComment createTaskComment(String domainName, Integer domainId, String login,
			TaskComment taskComment, Integer taskId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static TaskComment updateTaskComment(String domainName, Integer domainId, String login,
	...
	public static TaskEvent getLastTaskEvent(String domainName, Integer domainId, String login,
			TaskEventFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static TaskEvent createTaskEvent(String domainName, Integer domainId, String login, TaskEvent taskEvent,
			Integer taskId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static TaskEvent updateTaskEvent(String domainName, Integer domainId, String login, TaskEvent taskEvent,
			Integer taskCommentId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<TaskEvent> getTaskEventStream(String domainName, Integer domainId, String login,
			Integer taskId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<TaskEvent> getTaskEventList(String domainName, Integer domainId, String login,
			Integer taskEventId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
			return getTask().getTaskEventStream(ctx, taskEventId).collect(Collectors.toCollection(LinkedList::new));
		} finally {
			if (ctx != null)
				ctx.close();
		}
	...
	public static Stream<TaskHolder> getTaskMemberWStream(String domainName, Integer domainId, String login,
			String filter, Integer workgroupId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Workgroup> getTaskWorkgroupStream(String domainName, Integer domainId, String login,
			String filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Workgroup> getTaskWorkgroupList(String domainName, Integer domainId, String login,
			String filter) {
	...
	public static Stream<Customer> getFilterCustomerStream(String domainName, Integer domainId, String login,
			String filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Customer> getFilterCustomerList(String domainName, Integer domainId, String login,
			String filter) {
	...
	public static Stream<TaskHolder> getTaskHolderStream(String domainName, Integer domainId, String login,
			TaskHolderFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<TaskHolder> getTaskHolderWorkgroupStream(Domain domain, User user, TaskHolderFilter filter,
			Integer workgroupId) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, user)) {
	...
	public static TaskHolder updateTaskHolder(String domainName, Integer domainId, String login,
	...
	public static Boolean isTaskHolderWorkgroup(String domainName, Integer domainId, String login,
			TaskHolderWorkgroupFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void insertTaskHolderWorkgroup(String domainName, Integer domainId, String login,
			Integer taskHolderId, Integer workgroupId) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteTaskHolderWorkgroup(String domainName, Integer domainId, String login,
			TaskHolderWorkgroupFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Workgroup> getTaskHolderWorkgroupStream(String domainName, Integer domainId, String login,
			TaskHolderWorkgroupFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Workgroup> getTaskHolderWorkgroupList(String domainName, Integer domainId, String login,
			TaskHolderWorkgroupFilter filter) {
	...
	public static Stream<UserWorkgroup> getUserWorkgroupStream(String domainName, Integer domainId, String login,
			UserWorkgroupFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<Workgroup> getWorkgroupStream(String domainName, Integer domainId, String login,
			WorkgroupFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getCommon().getWorkgroupStream(ctx, filter);
		}
	}

	public static Stream<Workgroup> getWorkgroupByTaskHolderStream(String domainName, Integer domainId, String login,
			WorkgroupFilter filter, Integer taskHolder) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getCommon().getWorkgroupByTaskHolderStream(ctx, filter, taskHolder);
		}
	}

	public static List<Workgroup> getWorkgroupList(String domainName, Integer domainId, String login,
			WorkgroupFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<com.esferalia.aon.occam.api.model.registry.Question> getRegistryQuestionStream(
			String domainName, Integer domainId, String login, Integer registry) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<RegistryProfile> getRegistryProfileStream(String domainName, Integer domainId, String login,
			Integer question, Integer registry) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Certificate getCertificate(String domainName, Integer domainId, String login, Integer userId,
		...
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			...
			throw new IllegalArgumentException(
					"El certificado no se ha podido obtener. Revise que los certificados esten en vigor");
		}
	}
	...
	public static Certificate insertCertificate(String domainName, Integer domainId, String login, Integer userId,
	...
	public static List<Certificate> getCertificates(String domainName, Integer domainId, String login, Integer userId)
	...
	public static List<Certificate> getCertificatesWithParent(String domainName, Integer domainId,
			Integer parentDomainId, String login, Integer userId) throws IllegalArgumentException {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getCommon().getCertificatesWithParent(ctx, domainId, parentDomainId, userId);
		}
	}

	public static Certificate getCertificate(String domainName, Integer domainId, String login,
	...
	public static CertificateInfo getCertificateInfo(String domainName, Integer domainId, String login,
			AttachFilter attachFilter) throws IllegalArgumentException {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static void deleteCertificate(String domainName, Integer domainId, String login, Integer attachId,
			AttachFilter attachFilter, RegistryAddInfoFilter raddinfoFilter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			getCommon().deleteCertificate(ctx, attachId, attachFilter, raddinfoFilter);
		}
	}

	public static void saveCertificate(String domainName, Integer domainId, String login, Integer userId,
			Certificate certificate) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<DataRequest> getDataRequestStream(String domainName, Integer domainId, String login,
			DataRequestFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getCommon().getDataRequestStream(ctx, filter);
		}
	}

	public static DataRequest getDataRequest(String domainName, Integer domainId, String login,
			DataRequestFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static DataRequest saveDataRequest(String domainName, Integer domainId, String login,
	...
	public static Stream<DataResponse> getDataResponseStream(String domainName, Integer domainId, String login,
			DataResponseSource source, DataResponseFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponse getDataResponse(String domainName, Integer domainId, String login,
			DataResponseFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static DataResponse insertDataResponse(String domainName, Integer domainId, String login,
	...
	public static Integer updateDataResponse(String domainName, Integer domainId, String login,
			DataResponse dataResponse, DataResponseFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponse deleteDataResponse(String domainName, Integer domainId, String login,
			DataResponseFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<DataResponseDetail> getDataResponseDetailStream(String domainName, Integer domainId,
			String login, DataResponseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponse getLastDataResponse(String domainName, Integer domainId, String login,
			DataResponseFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<DataResponseDetail> getLastDataResponseDetailStream(String domainName, Integer domainId,
			String login, DataResponseFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Optional<DataResponseDetail> getDataResponseDetail(String domainName, Integer domainId, String login,
			DataResponseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponseDetail insertDataResponseDetail(String domainName, Integer domainId, String login,
			DataResponseDetail dataResponseDetail) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponseDetail updateDataResponseDetail(String domainName, Integer domainId, String login,
			DataResponseDetail dataResponseDetail, DataResponseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static DataResponseDetail deleteDataResponseDetail(String domainName, Integer domainId, String login,
			DataResponseDetailFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<OldProduct> getInvoiceProducts(String domainName, int domain, String loggedUser,
			ProductFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, loggedUser);
	...
	public static Stream<Commission> getCommissionStream(String domainName, Integer domainId, String login,
	...
	public static Stream<CommissionType> getCommissionTypeStream(String domainName, Integer domainId, String login,
			CommissionTypeFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<CommissionTypeCommission> getCommissionTypeCommissionStream(String domainName,
			Integer domainId, String login, CommissionTypeCommissionFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<CommissionItem> getCommissionItemStream(String domainName, Integer domainId, String login,
			CommissionItemFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<CommissionCategory> getCommissionCategoryStream(String domainName, Integer domainId,
			String login, CommissionCategoryFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<OfferDetailCommission> getOfferDetailCommissionStream(String domainName, Integer domainId,
			String login, OfferDetailCommissionFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static OfferDetailCommission getOfferDetailCommission(String domainName, Integer domainId, String login,
			OfferDetailCommissionFilter filter) {
		return getOfferDetailCommissionStream(domainName, domainId, login, filter).findFirst().orElse(null);
	}

	public static OfferDetailCommission insertOfferDetailCommission(String domainName, Integer domainId, String login,
			OfferDetailCommission odc) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static OfferDetailCommission updateOfferDetailCommission(String domainName, Integer domainId, String login,
			OfferDetailCommission odc) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<InvoiceDetailCommission> getInvoiceDetailCommissionStream(String domainName, Integer domainId,
			String login, InvoiceDetailCommissionFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static InvoiceDetailCommission getInvoiceDetailCommission(String domainName, Integer domainId, String login,
			InvoiceDetailCommissionFilter filter) {
		return getInvoiceDetailCommissionStream(domainName, domainId, login, filter).findFirst().orElse(null);
	}

	public static InvoiceDetailCommission insertInvoiceDetailCommission(String domainName, Integer domainId,
			String login, InvoiceDetailCommission idc) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static InvoiceDetailCommission updateInvoiceDetailCommission(String domainName, Integer domainId,
			String login, InvoiceDetailCommission idc) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static void deleteInvoiceDetailCommission(String domainName, Integer domainId, String login,
			InvoiceDetailCommissionFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static MailTemplate getMailTemplate(String domainName, Integer domainId, String login,
	...
	public static Stream<MailTemplate> getMailTemplateStream(String domainName, Integer domainId, String login,
			MailTemplateFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<UdapaQuality> getUdapaQualityStream(String domainName, Integer domainId, String login,
	...
	public static Stream<PaturpatQuality> getPaturpatQualityStream(String domainName, Integer domainId, String login,
			Map<String, String[]> map) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Expedient> getResumeExpedientStream(String domainName, Integer domainId, String login,
			ProjectFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static Stream<Expedient> getFullExpedientStream(String domainName, Integer domainId, String login,
			ProjectFilter filter) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, login);
	...
	public static LinkedList<Finance> getFinancesForInvoice(String domainName, int domainId, String user,
			Invoice invoice) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static FinanceTracking returnFinance(String domainName, int domainId, String user,
			FinanceTracking tracking) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domainId, user);
	...
	public static LinkedList<RegistryBank> getRegistryBanks(String domainName, int domainId, String user,
			Integer registry) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, user)) {
	...
	public static Stream<com.esferalia.aon.occam.api.model.Module> getDomainModules(String domainName, Integer domainId,
			String login) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<RawdocDomainData> getRawdocDomainData(String domainName, int domain, String user,
			int searchDomain) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, user);
	...
	public static Stream<Customer> getCustomers(Occam occam, RegistryParams params, int ofs, int limit) {
		...
		try (CloseableAONContext ctx = AONContext.getAONContext(occam.getDomainName(), occam.getDomain(),
				occam.getUser())) {
			return getRegistry().getCustomers(ctx, p -> RegistryUtils.getFilter(p, params), ofs, limit);
		}
	}

	public static LinkedList<Customer> getCustomers(String domainName, int domain, String user, RegistryParams params,
			int ofs, int limit) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, user);
...
//				e.printStackTrace();
	...
	public static Stream<Creditor> getCreditors(Occam occam, RegistryParams params, int ofs, int limit) {
	...
	public static CreditorFull getCreditorFull(Occam occam, Integer id) {
		try (CloseableAONContext ctx = AONContext.getAONContext(occam.getDomainName(), occam.getDomain(),
				occam.getUser())) {
	...
	public static LinkedList<Creditor> getCreditors(String domainName, int domain, String user, RegistryParams params,
			int ofs, int limit) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, user);
	...
	public static Stream<Supplier> getSuppliers(Occam occam, RegistryParams params, int ofs, int limit) {
	...
	public static SupplierFull getSupplierFull(Occam occam, Integer id) {
		try (CloseableAONContext ctx = AONContext.getAONContext(occam.getDomainName(), occam.getDomain(),
				occam.getUser())) {
	...
	public static LinkedList<Supplier> getSuppliers(String domainName, int domain, String user, RegistryParams params,
			int ofs, int limit) {
		CloseableAONContext ctx = null;
		try {
			ctx = AONContext.getAONContext(domainName, domain, user);
	...
	public static InvofoxConfiguration saveInvofoxConfiguration(Domain domain, String login,
			InvofoxConfiguration config) {
		return saveInvofoxConfiguration(domain.getName(), domain.getId(), login, config);
	}

	public static InvofoxConfiguration saveInvofoxConfiguration(String domainName, Integer domainId, String login,
			InvofoxConfiguration config) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static TbaiConfiguration saveTbaiConfiguration(String domainName, Integer domainId, String login,
			TbaiConfiguration config) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static SiiConfiguration saveSiiConfiguration(String domainName, Integer domainId, String login,
	...
	public static void saveInvoiceFiscal(String domainName, Integer domainId, String login, AonConfiguration config,
			Invoice invoice) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<EnterpriseCCC> getEnterpriseCCCStream(Domain domain, String login,
			EnterpriseCCCFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain.getName(), domain.getId(), login)) {
	...
	public static void assignInvestAsset2Invoice(String domainName, Integer domainId, String login,
			Integer investAssetId, Invoice invoice) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static Stream<InvestAsset> getInvestAssetStream(String domainName, Integer domainId, String login,
			InvestAssetFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getNewProduct().getInvestAssetStream(ctx, filter);
		}
	}
	...
	public static void saveFacturaeCodeAsignacion(Domain domain, User user, Integer invoice, Integer registry,
			String code) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domain, user)) {
	...
	public static List<DomainLinked> getDomainLinkedList(String domainName, Integer domainId, String login,
			Integer registry) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static DomainLinked saveDomainLinked(String domainName, Integer domainId, String login,
			DomainLinked domainLinked) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
	...
	public static LinkedList<EnterpriseData> getEnterpriseDataList(String domainName, Integer domainId, String login,
			EnterpriseDataFilter filter) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			return getEnterprise().getEnterpriseDataList(ctx, filter);
		}
	}

	public static void insertEnterpriseData(String domainName, Integer domainId, String login,
			List<EnterpriseData> enterpriseData) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, login)) {
			getEnterprise().insertEnterpriseData(ctx, enterpriseData);
		}
	}

	public static void updateEnterpriseData(String domainName, Integer domainId, String login,
	...
	public static List<InvestAsset> getInvestAssetList(InvestAssetParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(params.getDomainName(), params.getDomain(),
				params.getUser())) {
	...
	public static void saveRegistryProfile(Domain domain, String user, Integer registryId, String questionAlias,
			String value) {
	...
	public static LinkedList<BookingCheck> getBookingWithoutFeeList(String domainName, int domain, String user,
			CustomerFeeParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domain, user)) {
	...
	public static LinkedList<BookingCheck> getFeeWithoutBookingList(String domainName, int domain, String user,
			CustomerFeeParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domain, user)) {
	...
	public static LinkedList<BookingCheck> getBookingCheckList(String domainName, int domain, String user,
			CustomerFeeParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domain, user)) {
	...
	public static LinkedList<BookingCheck> getCustomerBookingCheckList(String domainName, int domain, String user,
			CustomerFeeParams params) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domain, user)) {
	...
	public static void deleteBookingList(String domainName, int domain, String user,
			LinkedList<BookingCheck> selectedBookings) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domain, user)) {
	...
	public static LinkedList<FBatch> getFBatches(String domainName, int domainId, String user, FBatchParams params,
			int offset, int limit) {
		try (CloseableAONContext ctx = AONContext.getAONContext(domainName, domainId, user)) {
