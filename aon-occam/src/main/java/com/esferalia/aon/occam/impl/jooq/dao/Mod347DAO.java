...
//				.setBdns(record.getValue(FS_MOD347_DETAIL.BDNS)) // FALTA - Nuevo campo 2025: N�mero de convocatoria BDNS
				;
		}
	}
...
//			.set(FS_MOD347_DETAIL.BDNS, declared.getBdns()) // FALTA - Nuevo campo 2025: N�mero de convocatoria BDNS
			.execute();
...
//								}	
						...
						if (vat.isVatAccrualRegime()) {
							...
							// Acumular el importe seg�n RECC (La base y las cuotas tienen lo declarado seg�n los cobros/pagos realizados)
