...
public enum Model3032017GIPUZKOAAdditionalDataScript implements IModelScript<Mod303Key> {
	...
	,ADC01 (Mod303Key.GP_C030.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C030},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC02 (Mod303Key.GP_C031.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C031},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC03 (Mod303Key.GP_C032.getDescription() ,new Mod303Key[]{null,Mod303Key.GP_C032},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	...
	,ADC05 ("Importes de las entregas de bienes y prestaciones de servicios a las que habi\u00E9ndoles sido aplicado el R\u00E9gimen especial del criterio de caja hubieran resultado devengadas conforme a la regla general de devengo"
			,new Mod303Key[]{Mod303Key.GP_C047,Mod303Key.GP_C048},NONE)	
	,ADC06 ("Importes de adquisiciones de bienes y servicios a las que sea de aplicaci\u00F3n o afecte el R\u00E9gimen especial del criterio de caja"
			,new Mod303Key[]{Mod303Key.GP_C049,Mod303Key.GP_C050},NONE)
	;
