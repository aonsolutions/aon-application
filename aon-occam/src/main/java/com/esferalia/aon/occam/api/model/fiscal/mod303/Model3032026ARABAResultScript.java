...
public enum Model3032026ARABAResultScript implements IModelScript<Mod303Key> {
	...
	,R064 (Mod303Key.AR_C064.getDescription(),new Mod303Key[]{Mod303Key.AR_C064},NONE)
	...
	private Model3032026ARABAResultScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
