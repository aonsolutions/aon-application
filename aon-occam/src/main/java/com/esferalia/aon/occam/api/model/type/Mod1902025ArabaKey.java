...
//	)
	...
	private Mod1902025ArabaKey(String description, String[] subKeys) {
	...
	public static Mod1902025ArabaKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902025ArabaKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902025ArabaKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902025ArabaKey.G.subKeys[2];
	}
	public static Mod1902025ArabaKey getDefaultKeyForFarmerRetentions() {
		return Mod1902025ArabaKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902025ArabaKey.H.subKeys[0];
	}
	public static Mod1902025ArabaKey getDefaultKeyForTransportRetentions() {
		return Mod1902025ArabaKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902025ArabaKey.H.subKeys[3];
	}
}
