...
public class Mod190Writer {
	...
	private enum Mod190File2017Araba {
		TYPE_1 (new IPropertyFiller[] { 
			(wr, mod190,detail) -> wr.append("1")
		   ,(wr, mod190,detail) -> wr.append("190")
		   ,(wr, mod190,detail) -> wr.append(AonFiscalFileUtils.unsigned(mod190.getYear(), 4,0))
		...
		private Mod190File2017Araba(IPropertyFiller[] pf) {
			this.propertyFillers = pf;
		}
	...
	private enum Mod190File2017Gipuzkoa {
	...
	public static void fillWriter(Mod190 mod190, Writer wr) throws IOException {
		if (mod190.isGipuzkoa()) {
			...
			} else if (mod190.getYear() == 2016) {
				fillWriterGipuzkoa2016(mod190, wr);
			} else {
				fillWriterGipuzkoa2017(mod190, wr);
			}
			...
			if (mod190.getYear() < 2017) {
				fillWriterAraba2016(mod190, wr);
			} else {
				fillWriterAraba2017(mod190, wr);
			}
		} else {
			if (mod190.getYear() < 2016) {
	...
	private static void fillWriterGipuzkoa2017(Mod190 mod190, Writer wr) throws IOException {
	...
	private static void fillWriterAraba2016(Mod190 mod190, Writer wr) throws IOException {
	...
	private static void fillWriterAraba2017(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2017Araba.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2017Araba.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
