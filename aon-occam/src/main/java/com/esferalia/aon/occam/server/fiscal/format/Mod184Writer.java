...
public class Mod184Writer {
	...
	private enum Mod184File2016 {
		...
		,TYPE_2 (new IPropertyFiller[] { 
		   ...
		   ,(wr, mod184,prt,inc) -> wr.append(AonStringUtils.repeat(' ', 186))
		   ,(wr, mod184,prt,inc) -> wr.append("\r\n")
		})
		,TYPE_3 (new IPropertyFiller[] { 
			(wr, mod184,prt,inc) -> wr.append("2")
		...
		private Mod184File2016(IPropertyFiller[] pf) {
			this.propertyFillers = pf;
		}
	...
	public static void fillWriter(Mod184 mod184, Writer writer) throws IOException {
		if (mod184.getYear() >= 2019) {
			Mod184File2019.TYPE_1.fillPage(mod184, null, null, writer);
			for (Mod184Income inc : mod184.getIncomes()) {
				Mod184File2019.TYPE_2.fillPage(mod184, null, inc, writer);	
			}
			for (Mod184Partner prt : mod184.getPartners()) {
				Mod184File2019.TYPE_3.fillPage(mod184, prt, null, writer);	
			}
		} else if (mod184.getYear() >= 2016 && mod184.getYear() <= 2018) {
