...
public class Mod2002014Behaviour {
	...
	static { 	
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.LQ500.toString(),new Boolean[]{TRUE,FALSE});
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.LQ501.toString(),new Boolean[]{TRUE,FALSE});
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.I0417.toString(),new Boolean[]{TRUE,FALSE});
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.D0418.toString(),new Boolean[]{TRUE,FALSE});
		...
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.BN582.toString(),new Boolean[]{TRUE,FALSE});
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.BN592.toString(),new Boolean[]{TRUE,FALSE});
	...
	static { // LIMITACIÓN EN LA DEDUCIBILIDAD DE GASTOS FINANCIEROS.
		...
		BEHAVIOUR_KEYS_MAP.put(Mod2002014Key.LM272.toString(),new Boolean[]{FALSE,TRUE});
