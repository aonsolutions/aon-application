...
public class Mod2002013 implements IFiscalModel, IMod200 {
	...
	private EnumMap<Mod2002013Key,DoubleVariable2013> keysMap = new EnumMap<Mod2002013Key,DoubleVariable2013>(Mod2002013Key.class);
	private EnumMap<Mod2002013Key,DoubleVariable2013> draftMap = new EnumMap<Mod2002013Key,DoubleVariable2013>(Mod2002013Key.class);
	private EnumMap<Mod2002013Key,Boolean> visibleMap = new EnumMap<Mod2002013Key,Boolean>(Mod2002013Key.class);

	private List<ValidationMessage2013> messages;
	...
	public void setKeysMap(EnumMap<Mod2002013Key, DoubleVariable2013> keysMap) {
		this.keysMap = keysMap;
	}
	public EnumMap<Mod2002013Key, DoubleVariable2013> getDraftMap() {
		return draftMap;
	}
	public void setDraftMap(EnumMap<Mod2002013Key, DoubleVariable2013> draftMap) {
		this.draftMap = draftMap;
	}
	public EnumMap<Mod2002013Key, Boolean> getVisibleMap() {
		return visibleMap;
	}
	...
	public void setVisibleMap(EnumMap<Mod2002013Key, Boolean> visibleMap) {
	...
	public List<ValidationMessage2013> getMessages() {
		return messages;
	}
	public void setMessages(List<ValidationMessage2013> messages) {
		this.messages = messages;
	}
	public DoubleVariable2013 getKey(Mod2002013Key key) {
		return keysMap.get(key);
	}
	public boolean isChecked(Mod2002013Key key) {
		DoubleVariable2013 dv = keysMap.get(key); 
		return dv != null && (AonMathUtils.round(dv.getValue()) == 1.0);
	}
	
	public void addVariable(DoubleVariable2013 t) {
		keysMap.put( t.getKey(), t);
	}
	public void removeVariable(DoubleVariable2013 t) {
		keysMap.remove(t.getKey());
	}
	public void addDraftVariable(DoubleVariable2013 t) {
		draftMap.put( t.getKey(), t);
	}
	public void removeDraftariable(DoubleVariable2013 t) {
		draftMap.remove(t.getKey());
	}

	public DoubleVariable2013 getVariable(Mod2002013Key key) {
		DoubleVariable2013 var = getDraftMap().get(key);
		if (var == null ) {
	...
	public Double getDoubleValue(Mod2002013Key key) {
		...
		DoubleVariable2013 v = keysMap.get(key);
		if (v==null) {
			return new Double(0);
		}
		Object o = v.getValue();
	...
	public void listDraftVariables() {
		for (DoubleVariable2013 dv : getDraftMap().values()) {
