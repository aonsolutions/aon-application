...
public class DomainInvoiceStatJSON {
	...
	public static Optional<DomainInvoiceStat> fromJSON(JSONObject json) {
		...
		return Optional.of(new DomainInvoiceStat()
			...
			.setCompanyId(JsonUtils.getInteger(json, IJsonNames.COMPANY_ID))
			...
			.setUnrecordedPurchased(JsonUtils.getInt(json, IJsonNames.UNRECORDED_PURCHASED))
			.setUnrecordedExpensed(JsonUtils.getInt(json, IJsonNames.UNRECORDED_EXPENSED))
	...
	public static Optional<JSONObject> toJSON(DomainInvoiceStat dis) {
		...
		return Optional.of(new JSONObject()
			...
			.putOpt(IJsonNames.COMPANY_ID, dis.getCompanyId())
			...
			.put(IJsonNames.UNRECORDED_EXPENSED, dis.getUnrecordedExpensed())
			.put(IJsonNames.UNRECORDED_PURCHASED, dis.getUnrecordedPurchased())
