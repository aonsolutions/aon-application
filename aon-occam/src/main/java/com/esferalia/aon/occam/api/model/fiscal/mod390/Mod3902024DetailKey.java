...
public enum Mod3902024DetailKey implements Serializable {
	// IVA devengado (cuotas)
	 ...
	 ,C0680	(680,	 2.00,true,false)
	 ,C0008	(  8,	 4.00,true,false)
	 ,C0715	(715,	 5.00,true,false)
	 ,C0682	(682,	 7.50,true,false)
	 ...
	 ,C0692 (692,	 0.26,true,false)
	 ,C0036 ( 36,	 0.50,true,false)
	 ,C0666 (666,	 0.62,true,false)
	 ,C0694 (694,	 1.00,true,false)
	...
	// Modificación recargo equivalencia
	 ...
	 ,C0696	(696,	 2.00,true ,false,true)
	 ,C0191	(191,	 4.00,true ,false,true)
	 ,C0725	(725,	 5.00,true ,false,true)
	 ,C0698	(698,	 7.50,true ,false,true)
	 ...
	 ,C0746	(746,	 2.00,true ,false,true)
	 ,C0507	(507,	 4.00,true ,false,true)
	 ,C0727	(727,	 5.00,true ,false,true)
	 ,C0748	(748,	 7.50,true ,false,true)
	 ...
	 ,C0760	(760,	 7.50,true ,false,true)
	 ...
	 ,C0766	(766,	 2.00,true ,false,true)
	 ,C0215	(215,    4.00,true ,false,true)
	 ,C0737	(737,	 5.00,true ,false,true)
	 ,C0768	(768,	 7.50,true ,false,true)
	...
	private Mod3902024DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly) {
		this(box, percent, taxableBaseAvailable, readonly, false);	
	}
	
	private Mod3902024DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly, boolean prorrata) {
