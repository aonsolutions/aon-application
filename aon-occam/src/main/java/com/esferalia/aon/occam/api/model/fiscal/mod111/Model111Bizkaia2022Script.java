...
enum Model111Bizkaia2022Script implements IModelScript<Mod111Key> {
	...
	private Model111Bizkaia2022Script(String label, Mod111Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
