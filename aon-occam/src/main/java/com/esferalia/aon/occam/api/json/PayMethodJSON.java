...
public class PayMethodJSON {
	...
	public static LinkedList<PayMethod> fromJSON(JSONArray json) {
...
//				.setType()
	...
	public static JSONArray toJSON(LinkedList<PayMethod> paymethods) {
...
//				.put(IJsonNames.TYPE, paymethod.getType())
