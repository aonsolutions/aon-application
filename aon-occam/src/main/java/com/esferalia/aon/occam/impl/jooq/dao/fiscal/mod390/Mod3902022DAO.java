...
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2022.AEATIVA2022;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2022.AEATIVA2022toMod390;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2022.Mod390toAEATIVA2022;
...
public class Mod3902022DAO {
	...
	public static interface IMod390DetailKey {
		boolean accept(Mod3902022 mod,VatContext vc);
	}

	private static class KeyedVatContext  {
		private Mod3902022DetailKeyDAO key;
		private VatContext vc;
		
		private KeyedVatContext(Mod3902022DetailKeyDAO key,VatContext vc) {
			this.key = key;
			this.vc = vc;
		}
		public Mod3902022DetailKeyDAO getKey() {
			return key;
		}
	...
	public enum Mod3902022DetailKeyDAO implements Serializable {
		// IVA devengado
	 	// Régimen ordinario
		  C0701	(Mod3902022DetailKey.C0701, (mod, vc) -> isCommonNationalSales(vc, mod) && hasPercent0(vc))
		 ,C0002 (Mod3902022DetailKey.C0002, (mod, vc) -> isCommonNationalSales(vc, mod) && hasPercent4(vc))		
		 ,C0703	(Mod3902022DetailKey.C0703, (mod, vc) -> isCommonNationalSales(vc, mod) && hasPercent5(vc))
		 ,C0004	(Mod3902022DetailKey.C0004, (mod, vc) -> isCommonNationalSales(vc, mod) && hasPercent10(vc))
		 ,C0006	(Mod3902022DetailKey.C0006, (mod, vc) -> isCommonNationalSales(vc, mod) && hasPercent21(vc))
	 	// Operaciones intragrupo
		 ,C0705	(Mod3902022DetailKey.C0705, null)
		 ,C0501	(Mod3902022DetailKey.C0501, null)
		 ,C0707	(Mod3902022DetailKey.C0707, null)
		 ,C0503	(Mod3902022DetailKey.C0503, null)
		 ,C0505	(Mod3902022DetailKey.C0505, null)
	 	// Régimen especial de bienes usados, objetos de arte, antigüedades y objetos de colección
		 ,C0713	(Mod3902022DetailKey.C0713, null)
		 ,C0008	(Mod3902022DetailKey.C0008, null)
		 ,C0715	(Mod3902022DetailKey.C0715, null)
		 ,C0010	(Mod3902022DetailKey.C0010, null)
		 ,C0012	(Mod3902022DetailKey.C0012, null)
	 	// Régimen especial de agencias de viaje
		 ,C0014	(Mod3902022DetailKey.C0014, null)
	 	// Adquisiciones intracomunitarias de bienes
		 ,C0717	(Mod3902022DetailKey.C0717, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent0(vc))
		 ,C0022	(Mod3902022DetailKey.C0022, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent4(vc))
		 ,C0719	(Mod3902022DetailKey.C0719, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent5(vc))
		 ,C0024	(Mod3902022DetailKey.C0024, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent10(vc))
		 ,C0026	(Mod3902022DetailKey.C0026, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent21(vc))
	 	// Adquisiciones intracomunitarias de servicios
		 ,C0721	(Mod3902022DetailKey.C0721, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent0(vc))
		 ,C0546	(Mod3902022DetailKey.C0546, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent4(vc))
		 ,C0723	(Mod3902022DetailKey.C0723, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent5(vc))
		 ...
		 ,C0650 (Mod3902022DetailKey.C0650, null)	
	 	// Modificación de bases y cuotas por auto de declaración de concurso de acreedores
		 ,C0032	(Mod3902022DetailKey.C0032, null)
	 	// Total bases y cuotas IVA
		 ,C0034	(Mod3902022DetailKey.C0034, null)
	 	// Recargo de equivalencia
		 ,C0036 (Mod3902022DetailKey.C0036, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent05(vc))
		 ,C0600 (Mod3902022DetailKey.C0600, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent14(vc))
		 ,C0602 (Mod3902022DetailKey.C0602, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent52(vc))
		 ,C0042	(Mod3902022DetailKey.C0042, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent175(vc))
		 ,C0044	(Mod3902022DetailKey.C0044, (mod, vc) -> isCommonNationalSalesRECT(vc, mod) && vc.isSurcharge())
	 	// Modificación recargo equivalencia
		 ,C0046	(Mod3902022DetailKey.C0046, null)
	 	//  Total cuotas IVA y recargo de equivalencia
		 ,C0047	(Mod3902022DetailKey.C0047, null)

		 // IVA deducible
		 // Operaciones interiores corrientes
		 // IVA deducible en operaciones interiores de bienes y servicios corrientes
		 ,C0191	(Mod3902022DetailKey.C0191, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0725	(Mod3902022DetailKey.C0725, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0604	(Mod3902022DetailKey.C0604, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0606	(Mod3902022DetailKey.C0606, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en operaciones interiores de bienes y servicios corrientes
		 ,C0049	(Mod3902022DetailKey.C0049, null)
		 // IVA deducible en operaciones intragrupo de bienes y servicios corrientes
		 ,C0507	(Mod3902022DetailKey.C0507, null)
		 ,C0727	(Mod3902022DetailKey.C0727, null)
		 ,C0608	(Mod3902022DetailKey.C0608, null)
		 ,C0610	(Mod3902022DetailKey.C0610, null)
		 // Total bases imponibles y cuotas deducibles en operaciones intragrupo de bienes y servicios corrientes
		 ,C0513	(Mod3902022DetailKey.C0513, null)
		 
		 // Operaciones interiores de bienes de inversión
		 // IVA deducible en operaciones interiores de bienes de inversión	 
		 ,C0197	(Mod3902022DetailKey.C0197, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent4(vc)))
		 ,C0729	(Mod3902022DetailKey.C0729, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent5(vc)))
		 ,C0612	(Mod3902022DetailKey.C0612, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent10(vc)))
		 ,C0614	(Mod3902022DetailKey.C0614, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en operaciones interiores de bienes de inversión
		 ,C0051	(Mod3902022DetailKey.C0051, null)

		 // IVA deducible en operaciones intragrupo de bienes de inversión
		 ,C0515	(Mod3902022DetailKey.C0515, null)
		 ,C0731	(Mod3902022DetailKey.C0731, null)
		 ,C0616	(Mod3902022DetailKey.C0616, null)
		 ,C0618	(Mod3902022DetailKey.C0618, null)
		 // Total bases imponibles y cuotas deducibles en operaciones intragrupo de bienes de inversión
		 ,C0521	(Mod3902022DetailKey.C0521, null)
		 
		 // Importaciones y adquisiciones intracomunitarias de bienes y servicio
		 // IVA deducible en importaciones de bienes corrientes
		 ,C0203	(Mod3902022DetailKey.C0203, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0733	(Mod3902022DetailKey.C0733, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0620	(Mod3902022DetailKey.C0620, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0622	(Mod3902022DetailKey.C0622, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en importaciones de bienes corrientes
		 ,C0053	(Mod3902022DetailKey.C0053, null)
		 
		 // IVA deducible en importaciones de bienes de inversión
		 ,C0209	(Mod3902022DetailKey.C0209, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent4(vc)))
		 ,C0735	(Mod3902022DetailKey.C0735, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent5(vc)))
		 ,C0624	(Mod3902022DetailKey.C0624, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent10(vc)))
		 ,C0626	(Mod3902022DetailKey.C0626, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en importaciones de bienes de inversión
		 ,C0055	(Mod3902022DetailKey.C0055, null)
		 
		 // IVA deducible en adquisiciones intracomunitarias de bienes corrientes
		 ,C0215	(Mod3902022DetailKey.C0215, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0737	(Mod3902022DetailKey.C0737, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0628	(Mod3902022DetailKey.C0628, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0630	(Mod3902022DetailKey.C0630, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en adquisiciones intracomunitarias de bienes corrientes
		 ,C0057	(Mod3902022DetailKey.C0057, null)

		 // IVA deducible en adquisiciones intracomunitarias de bienes de inversión
		 ,C0221	(Mod3902022DetailKey.C0221, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent4(vc)))
		 ,C0739	(Mod3902022DetailKey.C0739, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent5(vc)))
		 ,C0632	(Mod3902022DetailKey.C0632, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent10(vc)))
		 ,C0634	(Mod3902022DetailKey.C0634, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en adquisiciones intracomunitarias de bienes de inversión
		 ,C0059	(Mod3902022DetailKey.C0059, null)
		 
		 // IVA deducible en adquisiciones intracomunitarias de servicios
		 ,C0588	(Mod3902022DetailKey.C0588, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent4(vc)))
		 ,C0741	(Mod3902022DetailKey.C0741, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent5(vc)))
		 ,C0636	(Mod3902022DetailKey.C0636, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent10(vc)))
		 ,C0638	(Mod3902022DetailKey.C0638, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent21(vc)))
		 ...
		 ,C0062	(Mod3902022DetailKey.C0062, ((mod, vc) -> vc.isRectification() && (vc.isPurchase() || vc.isExpenses() )))
		 // Rectificación de deducciones por operaciones intragrupo
		 ,C0652	(Mod3902022DetailKey.C0652, null)
		 // Regularización de bienes de inversión
		 ,C0063	(Mod3902022DetailKey.C0063, null)
		 // Regularización por aplicación porcentaje definitivo de prorrata
		 ,C0522	(Mod3902022DetailKey.C0522, null)
		 // Suma de deducciones
		 ,C0064	(Mod3902022DetailKey.C0064, null)
		 
		 // Resultado régimen general
		 ,C0065	(Mod3902022DetailKey.C0065, null)
		 ...
		 ,C0102	 (Mod3902022DetailKey.C0102, ((mod, vc) -> (vc.isNationalSales() && vc.isSurcharge())))
		 // Operaciones en Régimen especial de bienes usados, objetos de arte, antigüedades y objetos de colección
		 ,C0227	 (Mod3902022DetailKey.C0227, null)
		 // Operaciones en régimen especial de Agencias de Viajes
		 ,C0228	 (Mod3902022DetailKey.C0228, null)
		 // Entregas de bienes inmuebles, operaciones financieras y relativas al oro de inversión no habituales
		 ,C0106	 (Mod3902022DetailKey.C0106, null)
		 // Entregas de bienes de inversión
		 ,C0107	 (Mod3902022DetailKey.C0107, ((mod, vc) -> (vc.isNationalSales() && vc.isInvestment())))
		 // Total volumen de operaciones 
		 ,C0108	 (Mod3902022DetailKey.C0108, null)
		 
		 ;		 
		 
		private Mod3902022DetailKey key;
		private IMod390DetailKey accept;
			
		private Mod3902022DetailKeyDAO(Mod3902022DetailKey key, IMod390DetailKey accept) {
			this.key = key;
			this.accept = accept;
		}

		public Mod3902022DetailKey getKey() {
			return key;
		}
		public boolean accept(Mod3902022 mod, VatContext vc) {
			return accept!=null && accept.accept(mod,vc);
		}
		
//		public static Mod3902022DetailKey[] getKeys(Mod3902022 mod, VatContext vc) {
//			List<Mod3902022DetailKey> list = new LinkedList<>();
//			for (Mod3902022DetailKeyDAO key : Mod3902022DetailKeyDAO.values()) {
//				if (key.accept(mod,vc)) {
//					list.add(key.getKey()); 
//				}
//			}
//			return list.isEmpty()?null:list.toArray(new Mod3902022DetailKey[list.size()]);
//		}
	}

	
	private static EnumMap<Mod3902022DetailKey, Mod390Detail> getDetails(AONContext ctx, Mod3902022 mod390 ) {
		EnumMap<Mod3902022DetailKey, Mod390Detail> map = new EnumMap<>(Mod3902022DetailKey.class);
		Arrays.stream( Mod3902022DetailKey.values() )
			.forEach(key ->  map.put(key, new Mod390Detail().setKey(key).setPercent(key.getPercent())));
		VATDAO.getVatBreakdown(ctx, mod390)
			.flatMap(vt -> Arrays.stream( Mod3902022DetailKeyDAO.values() )
	...
	private static void add(Pair<KeyedVatContext, Mod390Detail> pair) {
		...
		Mod3902022DetailKey key = kvt.getKey().getKey();
	...
	private static void fillGeneralDeclarationResults(AONContext ctx, Mod3902022 mod390) {
	...
	private static void fillFromConfiguration(AONContext ctx, Mod3902022 mod390) {
	...
	// **********************************************************************************************
	// **********************************************************************************************
	public static Mod3902022 create(AONContext ctx, Mod390 model) {
		Mod3902022 mod390 =  new Mod3902022();
	...
	public static Mod3902022 getMod3902022(AONContext ctx, Mod390 m390) {
		if (m390.getId() == null) {
	...
	public static Mod3902022 getById(AONContext ctx, int id) {
		ctx.checkRead();
		Mod3902022 mod390 = new Mod3902022();
		ctx.getDslContext()
	...
	private static void populate(FsModel390Record rec, Mod3902022 mod390)  {
		mod390
		...
		if (AonStringUtils.contains(model, "<AEATIVA2022>"))  {
			...
			try {
				if (mod390.getYear() == 2022) {
					...
					AEATIVA2022toMod390.populate(mod390, iva);
					mod390.setXmlFormat("AEAT_2022");
				} else {
	...
	public static Mod3902022 save(AONContext ctx, Mod3902022 mod390)  {
		if (mod390.getId() == null) {
	...
	private static Mod3902022 insert(AONContext ctx, Mod3902022 mod390) {
		validate(ctx, mod390);
	...
	private static void validate(AONContext ctx, Mod3902022 mod390) {
...
//					.and(FS_MODEL390.RECEIPT.equal(mod390.getReplacedReceipt()))
	...
	public static void delete(AONContext ctx, Mod3902022 mod390) {
		ctx.checkWrite();
		ctx.getDslContext().delete(FS_MODEL390)
				.where(FS_MODEL390.ID.equal(mod390.getId())).execute();
	}
	
	private static Mod3902022 fillGeneralRegimeData(AONContext ctx, Mod3902022 mod390) {
		try {
			...
			mod390.setBox104(map.get(Mod3902022DetailKey.C0104).getTaxableBase());
			mod390.setBox105(map.get(Mod3902022DetailKey.C0105).getTaxableBase());
			mod390.setBox106(map.get(Mod3902022DetailKey.C0106).getTaxableBase());
			...
			mod390.setBox656(map.get(Mod3902022DetailKey.C0656).getTaxableBase());
			mod390.setBox657(map.get(Mod3902022DetailKey.C0656).getQuota());
			mod390.setAccrualRegimeTarget((map.get(Mod3902022DetailKey.C0656).getTaxableBase()  != 0 || map.get(Mod3902022DetailKey.C0656).getQuota() != 0 ));
			...
			if (mod390.isSimplifiedRegime()) {
				map = new EnumMap<>(Mod3902022DetailKey.class);
				for (Mod3902022DetailKey key : Mod3902022DetailKey.values() ) {
	...
	static interface ISimplifiedRegimeFiller {
		boolean fill(SimplifedRegimeContext src,Mod3902022 mod390);
	}
...
//		PBK      (Mod303Key.PBK     , null),
		...
		public static void fill(SimplifedRegimeContext src,Mod3902022 mod390) {
	...
	private static Mod3902022 fillSimplifedRegimeData(AONContext ctx, Mod3902022 mod390) {
	...
	private static void fillSimplifiedDeclarationResults(AONContext ctx, Mod3902022 mod390) {
	...
	public static Mod3902022 changeStatus(AONContext ctx, Mod3902022 mod390, FiscalStatus newStatus) {
		try {
			ctx.checkWrite();
			if (mod390.getId() != null) {
