...
public enum Aeat2016Record2 implements Serializable,IMod202Record{
	...
	,C24((writer,mod202) -> writer.append(AonFiscalFileUtils.spaces(17)))
	...
	private IRecordFiller filler;
	 ...
	 private Aeat2016Record2(IRecordFiller filler) {
		 this.filler = filler;
	 }
