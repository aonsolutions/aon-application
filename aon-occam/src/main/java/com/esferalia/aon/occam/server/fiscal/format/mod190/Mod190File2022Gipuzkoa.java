...
enum Mod190File2022Gipuzkoa {
	...
	,TYPE_2 (new IPropertyFiller[] { 
			(wr, mod190,detail) -> wr.append("2")
			   ...
			   ,(wr, mod190,detail) -> wr.append(AonStringUtils.repeat(' ', 178))		
			   ,(wr, mod190,detail) -> wr.append("\r\n")
		})
	;
	...
	private Mod190File2022Gipuzkoa(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2022Gipuzkoa.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2022Gipuzkoa.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
