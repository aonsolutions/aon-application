...
public class Mod303WriterAEAT2021_2 implements IMod303Writer{
	...
	private static enum Mod303File {
		...
		,AEAT_2021_REG_4 (mod303 -> mod303.isLastPeriod() ,new IPropertyFiller[] {
		...
		,AEAT_2021_REG_5_END (mod303 -> mod303.isLastPeriod() ,new IPropertyFiller[] {
	...
	public void fillWriter(Mod303 mod303, Writer wr) throws IOException {
		...
		for (Mod303File format : Mod303File.values()) {
			if (format.accept(mod303)) {
				...
				filled = true;
				if (format == Mod303File.AEAT_2021_REG_2) {
