...
public class InvoiceCommunicationConfiguration implements Serializable{
	...
	/**
	 * Listado histórico de configuraciones de SIF (Sistema Informótico de Facturación).
	 */
	private List<EnterpriseData> sifDataHistory; 

	/**
	 * Estado actual de la configuración de SIF (Sistema Informótico de Facturación).
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en Ticket Bai.
	 * @return true si la empresa estó dada de alta en Ticket Bai actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en Ticket Bai en modo test.
	 * @return true si la empresa estó dada de alta en Ticket Bai en modo test, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en LROE.
	 * @return true si la empresa estó dada de alta en LROE actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en LROE en modo test.
	 * @return true si la empresa estó dada de alta en LROE en modo test, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en SII.
	 * @return true si la empresa estó dada de alta en SII actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en SII en modo test.
	 * @return true si la empresa estó dada de alta en SII en modo test, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en Verifactu.
	 * @return true si la empresa estó dada de alta en Verifactu actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en Verifactu en modo test.
	 * @return true si la empresa estó dada de alta en Verifactu en modo test, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en No Verifactu.
	 * @return true si la empresa estó dada de alta en No Verifactu actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en SIF.
	 * @return true si la empresa estó dada de alta en SIF actualmente, false en caso contrario.
	 */
	...
	/**
	 * Determina si la empresa estó dada de alta en NO SIF.
	 * @return true si la empresa estó dada de alta en NO SIF actualmente, false en caso contrario.
	 */
