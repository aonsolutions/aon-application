...
public enum Model3032017ARABAAdditionalDataScript implements IModelScript<Mod303Key> {
	...
	,ADC01 (Mod303Key.AR_C050.getDescription() ,new Mod303Key[]{null,Mod303Key.AR_C050},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC02 (Mod303Key.AR_C051.getDescription() ,new Mod303Key[]{null,Mod303Key.AR_C051},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	,ADC03 (Mod303Key.AR_C052.getDescription() ,new Mod303Key[]{null,Mod303Key.AR_C052},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},NONE)
	...
	,ADC05 ("Importes de las entregas de bienes y prestaciones de servicios a las que habi\u00E9ndoles sido aplicado el R\u00E9gimen especial del criterio de caja hubieran resultado devengadas conforme a la regla general de devengo"
			,new Mod303Key[]{Mod303Key.AR_C180,Mod303Key.AR_C181},NONE)	
	,ADC06 ("Importes de adquisiciones de bienes y servicios a las que sea de aplicaci\u00F3n o afecte el R\u00E9gimen especial del criterio de caja"
			,new Mod303Key[]{Mod303Key.AR_C182,Mod303Key.AR_C183},NONE)
	;
