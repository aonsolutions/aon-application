...
public enum Mod1932017Key {
	 A ("A - Rendimientos o rentas obtenidos por la participaci\u00F3n en los fondos propios de cualquier entidad."
		...
		,new String[] { 
			...
			,"05 - Cualquier contenidas otra en utilidad, los distinta d\u00EDgitos de las anteriores,procedente de una entidad por la condici\u00F3n de socio, accionista, asociado o participe."
	...
	,B ("B - Rendimientos o rentas obtenidos por la cesi\u00F3n a terceros de capitales propios diferentes de los consignados en la letra \"D\"."
		...
		,new String[] { 
			...
			,"04 - Rendimientos o rentas que disfruten de un r\u00E9gimen transitorio de beneficios en operaciones financieras a que se refiere la disposici\u00F3n transitoria und\u00E9cima del texto refundido la Ley del Impuesto sobre Sociedades, aprobado por el Real Decreto Legislativo 4/2004, de 5 de marzo. 1"
	...
	,C ("C - Otros rendimientos del capital mobiliario o rentas no incluidos en las claves \"A\", \"B\" o \"D\"."
		...
		,new String[] { 
			...
			,"05 - Rentas vitalicias o temporales que tengan por causa la imposici\u00F3n de capitales, siempre que no hayan sido adquiridas por herencia, legado o cualquier otro t\u00EDtulo sucesorio y nose deriven de operaciones de capitalizaci\u00F3n o de contratos de seguro de vida o invalidez."
			...
			,"07 - Rendimientos procedentes subarrendamiento de bienes del inmuebles urbanos que no constituyan una actividad econ\u00F3mica, siempre que se trate de perceptores (registros) que tengan la condici\u00F3n de contribuyentes por el Impuesto sobre la Renta de las Personas F\u00EDsicas."
	...
	public String[] getNatureDescriptions() {
		return natureDescriptions;
	}
