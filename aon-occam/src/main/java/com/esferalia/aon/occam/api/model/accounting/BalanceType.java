...
public enum BalanceType implements Serializable {
	...
	,BALANCE_ASOC_ABBREV(false,"Balance PYMESFL","https://www.boe.es/boe/dias/2013/04/09/pdfs/BOE-A-2013-3736.pdf")
		{ @Override public void visit(IBalanceTypeVisitor visitor) { visitor.visitBalanceAsocAbbreviate(); }}
	,PYG_ASOC_ABBREV(true,"Cuenta de resultados PYMESFL","https://www.boe.es/boe/dias/2013/04/09/pdfs/BOE-A-2013-3736.pdf")
