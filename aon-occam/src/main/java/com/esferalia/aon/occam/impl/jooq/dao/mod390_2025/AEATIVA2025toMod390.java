...
public class AEATIVA2025toMod390 {

	private static final DateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");

	private AEATIVA2025toMod390() {

	}

	public static void populate(Mod3902025 mod390, AEATIVA2025 iva) throws ParseException {
		...
		Map<Mod3902025DetailKey, Mod390Detail> map = new TreeMap<>();
		...
		if (iva.getRegGeneral() != null) {
			...
			if (b != null) {
				if (b.getRegOrdinario() != null) {
					put(mod390, Mod3902025DetailKey.C0701, b.getRegOrdinario().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0668, b.getRegOrdinario().getTipo2());
					put(mod390, Mod3902025DetailKey.C0002, b.getRegOrdinario().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0703, b.getRegOrdinario().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0670, b.getRegOrdinario().getTipo75());
					put(mod390, Mod3902025DetailKey.C0004, b.getRegOrdinario().getTipo10());
					put(mod390, Mod3902025DetailKey.C0006, b.getRegOrdinario().getTipo21());
				}
				if (b.getOpIntragrupo() != null) {
					put(mod390, Mod3902025DetailKey.C0705, b.getOpIntragrupo().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0672, b.getOpIntragrupo().getTipo2());
					put(mod390, Mod3902025DetailKey.C0501, b.getOpIntragrupo().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0707, b.getOpIntragrupo().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0674, b.getOpIntragrupo().getTipo75());
					put(mod390, Mod3902025DetailKey.C0503, b.getOpIntragrupo().getTipo10());
					put(mod390, Mod3902025DetailKey.C0505, b.getOpIntragrupo().getTipo21());
				}
				if (b.getRegCriterioCaja() != null) {
					put(mod390, Mod3902025DetailKey.C0709, b.getRegCriterioCaja().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0676, b.getRegCriterioCaja().getTipo2());
					put(mod390, Mod3902025DetailKey.C0644, b.getRegCriterioCaja().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0711, b.getRegCriterioCaja().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0678, b.getRegCriterioCaja().getTipo75());
					put(mod390, Mod3902025DetailKey.C0646, b.getRegCriterioCaja().getTipo10());
					put(mod390, Mod3902025DetailKey.C0648, b.getRegCriterioCaja().getTipo21());
				}
				if (b.getRegBienesUsados() != null) {
					put(mod390, Mod3902025DetailKey.C0713, b.getRegBienesUsados().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0680, b.getRegBienesUsados().getTipo2());
					put(mod390, Mod3902025DetailKey.C0008, b.getRegBienesUsados().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0715, b.getRegBienesUsados().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0682, b.getRegBienesUsados().getTipo75());
					put(mod390, Mod3902025DetailKey.C0010, b.getRegBienesUsados().getTipo10());
					put(mod390, Mod3902025DetailKey.C0012, b.getRegBienesUsados().getTipo21());
				}
				if (b.getRegAgViajes() != null) {
					put(mod390, Mod3902025DetailKey.C0014, b.getRegAgViajes().getTipo21());
				}
				if (b.getAdqIntracomBienes() != null) {
					put(mod390, Mod3902025DetailKey.C0717, b.getAdqIntracomBienes().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0684, b.getAdqIntracomBienes().getTipo2());
					put(mod390, Mod3902025DetailKey.C0022, b.getAdqIntracomBienes().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0719, b.getAdqIntracomBienes().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0686, b.getAdqIntracomBienes().getTipo75());
					put(mod390, Mod3902025DetailKey.C0024, b.getAdqIntracomBienes().getTipo10());
					put(mod390, Mod3902025DetailKey.C0026, b.getAdqIntracomBienes().getTipo21());
				}
				if (b.getAdqIntracomServicios() != null) {
					put(mod390, Mod3902025DetailKey.C0721, b.getAdqIntracomServicios().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0688, b.getAdqIntracomServicios().getTipo2());
					put(mod390, Mod3902025DetailKey.C0546, b.getAdqIntracomServicios().getTipo4());
//					put(mod390, Mod3902025DetailKey.C0723, b.getAdqIntracomServicios().getTipo5());
//					put(mod390, Mod3902025DetailKey.C0690, b.getAdqIntracomServicios().getTipo75());
					put(mod390, Mod3902025DetailKey.C0548, b.getAdqIntracomServicios().getTipo10());
					put(mod390, Mod3902025DetailKey.C0552, b.getAdqIntracomServicios().getTipo21());
				}
				if (b.getIVAdevengadoInversionSP() != null) {
					put(mod390, Mod3902025DetailKey.C0028, b.getIVAdevengadoInversionSP().getTipoX());
				}
				if (b.getModBasesyCuotas() != null) {
					put(mod390, Mod3902025DetailKey.C0030, b.getModBasesyCuotas().getTipoX());
				}
				if (b.getModBasesyCuotasConcursoAcreedores() != null) {
					put(mod390, Mod3902025DetailKey.C0032, b.getModBasesyCuotasConcursoAcreedores().getTipoX());
				}
				if (b.getTotalBasesyCuotasIVA() != null) {
					put(mod390, Mod3902025DetailKey.C0034, b.getTotalBasesyCuotasIVA().getTipoX());
				}
				if (b.getRecargoEquivalencia() != null) {
//					put(mod390, Mod3902025DetailKey.C0664, b.getRecargoEquivalencia().getTipo0());
//					put(mod390, Mod3902025DetailKey.C0692, b.getRecargoEquivalencia().getTipo026());
					put(mod390, Mod3902025DetailKey.C0036, b.getRecargoEquivalencia().getTipo05());
//					put(mod390, Mod3902025DetailKey.C0666, b.getRecargoEquivalencia().getTipo062());
//					put(mod390, Mod3902025DetailKey.C0694, b.getRecargoEquivalencia().getTipo1());
					put(mod390, Mod3902025DetailKey.C0600, b.getRecargoEquivalencia().getTipo14());
					put(mod390, Mod3902025DetailKey.C0602, b.getRecargoEquivalencia().getTipo52());
					put(mod390, Mod3902025DetailKey.C0042, b.getRecargoEquivalencia().getTipo175());					
				}
				if (b.getModRecargoEquivalencia() != null) {
					put(mod390, Mod3902025DetailKey.C0044, b.getModRecargoEquivalencia().getTipoX());
				}
				if (b.getModRecargoEquivalenciaConcursoAcreedores() != null) {
					put(mod390, Mod3902025DetailKey.C0046, b.getModRecargoEquivalenciaConcursoAcreedores().getTipoX());
				}
				if (b.getTotalCuotasIVA() != null) {
					put(mod390, Mod3902025DetailKey.C0047, b.getTotalCuotasIVA());
				}
			}
			...
			if (iva.getRegGeneral().getDeducciones() != null) {
				...
				if (d.getOpInterioresBienesServiciosCorrientes() != null) {
					put(mod390, Mod3902025DetailKey.C0696, d.getOpInterioresBienesServiciosCorrientes().getTipo2());
					put(mod390, Mod3902025DetailKey.C0191, d.getOpInterioresBienesServiciosCorrientes().getTipo4());
					put(mod390, Mod3902025DetailKey.C0725, d.getOpInterioresBienesServiciosCorrientes().getTipo5());
					put(mod390, Mod3902025DetailKey.C0698, d.getOpInterioresBienesServiciosCorrientes().getTipo75());
					put(mod390, Mod3902025DetailKey.C0604, d.getOpInterioresBienesServiciosCorrientes().getTipo10());
					put(mod390, Mod3902025DetailKey.C0606, d.getOpInterioresBienesServiciosCorrientes().getTipo21());
					put(mod390, Mod3902025DetailKey.C0049, d.getOpInterioresBienesServiciosCorrientes().getTotal());
				}
				if (d.getOpIntragrupoCorrientes() != null) {
					put(mod390, Mod3902025DetailKey.C0746, d.getOpIntragrupoCorrientes().getTipo2());
					put(mod390, Mod3902025DetailKey.C0507, d.getOpIntragrupoCorrientes().getTipo4());
					put(mod390, Mod3902025DetailKey.C0727, d.getOpIntragrupoCorrientes().getTipo5());
					put(mod390, Mod3902025DetailKey.C0748, d.getOpIntragrupoCorrientes().getTipo75());
					put(mod390, Mod3902025DetailKey.C0608, d.getOpIntragrupoCorrientes().getTipo10());
					put(mod390, Mod3902025DetailKey.C0610, d.getOpIntragrupoCorrientes().getTipo21());
...
//					put(mod390, Mod3902025DetailKey.C0756, d.getOpIntragrupoBienesInversion().getTipo75());
				...
				if (d.getImportacionesBienesCorrientes() != null) {
					put(mod390, Mod3902025DetailKey.C0758, d.getImportacionesBienesCorrientes().getTipo2());
					put(mod390, Mod3902025DetailKey.C0203, d.getImportacionesBienesCorrientes().getTipo4());
					put(mod390, Mod3902025DetailKey.C0733, d.getImportacionesBienesCorrientes().getTipo5());
					put(mod390, Mod3902025DetailKey.C0760, d.getImportacionesBienesCorrientes().getTipo75());
					put(mod390, Mod3902025DetailKey.C0620, d.getImportacionesBienesCorrientes().getTipo10());
					put(mod390, Mod3902025DetailKey.C0622, d.getImportacionesBienesCorrientes().getTipo21());
...
//					put(mod390, Mod3902025DetailKey.C0764, d.getImportacionesBienesInversion().getTipo75());
				...
				if (d.getAdqIntracomunitariasBienesCorrientes() != null) {
					put(mod390, Mod3902025DetailKey.C0766, d.getAdqIntracomunitariasBienesCorrientes().getTipo2());
					put(mod390, Mod3902025DetailKey.C0215, d.getAdqIntracomunitariasBienesCorrientes().getTipo4());
					put(mod390, Mod3902025DetailKey.C0737, d.getAdqIntracomunitariasBienesCorrientes().getTipo5());
					put(mod390, Mod3902025DetailKey.C0768, d.getAdqIntracomunitariasBienesCorrientes().getTipo75());
					put(mod390, Mod3902025DetailKey.C0628, d.getAdqIntracomunitariasBienesCorrientes().getTipo10());
					put(mod390, Mod3902025DetailKey.C0630, d.getAdqIntracomunitariasBienesCorrientes().getTipo21());
...
//					put(mod390, Mod3902025DetailKey.C0776, d.getAdqIntracomunitariasServicios().getTipo75());
				...
				if (d.getComRegAgricGanadPesca() != null) {
					put(mod390, Mod3902025DetailKey.C0061, d.getComRegAgricGanadPesca().getTipoX());
				}
				if (d.getRectifDeducciones() != null) {
					put(mod390, Mod3902025DetailKey.C0062, d.getRectifDeducciones().getTipoX());
				}
				if (d.getRectifOpIntragrupo() != null) {
					put(mod390, Mod3902025DetailKey.C0652, d.getRectifOpIntragrupo().getTipoX());
				}
				if (d.getRegularizInversiones() != null) {
					put(mod390, Mod3902025DetailKey.C0063, d.getRegularizInversiones());
				}
				if (d.getRegularizPorcProrrata() != null) {
					put(mod390, Mod3902025DetailKey.C0522, d.getRegularizPorcProrrata());
				}
				if (d.getSumDeducciones() != null) {
					put(mod390, Mod3902025DetailKey.C0064, d.getSumDeducciones());
				}
			...
			if (AonStringUtils.isNotEmpty(res)) {
				try {
					...
					put(mod390, Mod3902025DetailKey.C0065, BigDecimal.valueOf(val));
				} catch (NumberFormatException e) {
					// Nothing
				}
			}
...
//		sra.setBoxC2(ensureBigDecimal(act.getDana()));
	...
	private static void put(Mod3902025 mod390, Mod3902025DetailKey key, TipoBaseImponibleYCuota tipo) {
		if (tipo != null) {
	...
	private static void put(Mod3902025 mod390, Mod3902025DetailKey key, BigDecimal quota) {
		if (quota != null) {
			Mod390Detail detail = new Mod390Detail();
			detail.setKey(key);
			detail.setPercent(key.getPercent());
