...
public class Aeat20162Mod202Calculator {
			...
			if (x00 == 1) {
				...
				if ( year == 2016 ) {
					if (!x06) {
						...
						if (x09 == 1) {
							c17 = AonMathUtils.ceil(15.0/20.0 * x08,0);
						} else if (x09 == 2) {
							c17 = AonMathUtils.ceil(17.0/20.0 * x08,0);
						} else if (x09 == 3) {
							c17 = AonMathUtils.ceil(19.0/20.0 * x08,0);
						} else {
							c17 = AonMathUtils.ceil(5.0/7.0 * x08,0);
						}
					}
...
//							if (x09 == 1) {
//								c21 = AonMathUtils.ceil(15.0/20.0 * x08_1,0);
//							} else if (x09 == 2) {
//								c21 = AonMathUtils.ceil(17.0/20.0 * x08_1,0);
//							} else if (x09 == 3) {
								c21 = AonMathUtils.ceil(19.0/20.0 * x08_1,0);
//							} else {
//								c21 = AonMathUtils.ceil(5.0/7.0 * x08_1,0);
//							}
						}
						mod202.putAmount(Mod202Key.C21, c21);	
					}
				} else {
					mod202.putAmount(Mod202Key.C21, 0.0);
				}
...
//						}
			...
			double c33 = mod202.getAmount(Mod202Key.C33);
			double c34 = c32>c33?c32:c33;
