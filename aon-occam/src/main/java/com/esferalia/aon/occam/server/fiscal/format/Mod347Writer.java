...
public class Mod347Writer {
	...
	private enum Mod347File2014 {
		...
		,TYPE_1_CANARIAS (new IPropertyFiller[] { 
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.A).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave A - Importe total de las operaciones
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.B).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave B - Importe total de las operaciones
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.C).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave C - Importe total de las operaciones
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.D).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave D - Importe total de las operaciones
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.E).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave E - Importe total de las operaciones
		   ...
		   ,(line, mod347, declared, asset) -> line.append(AonFiscalFileUtils.signedSpace((mod347.getDeclared()==null ? 0.0 : mod347.getDeclared().stream().filter(det -> det.getType() == Mod347Key.F).mapToDouble(det -> det.getAmount()).sum()), 16, 2)) // Clave F - Importe total de las operaciones
