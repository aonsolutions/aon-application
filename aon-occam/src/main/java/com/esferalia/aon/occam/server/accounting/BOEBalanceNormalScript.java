	...
	private static enum AccBOEBalanceNormalKey implements IBalanceKey {
		...
		,PC			(0,HEADER0, "C)", "PASIVO CORRIENTE", null, "PCI+PCII+PCIII+PCIV+PCV+PCVI")
			...
			,PCIII		(1, HEADER1, "III", "Deudas a corto plazo", null, "PCIII1+PCIII2+PCIII3+PCIII4+PCIII5")
				...
				,PCIII5		(2, LEAF, "5", "Otros pasivos financieros","sab({194,509,5115,5135,5145,521,522,523,525,526,528,5525,555,5565,5566,560,561,569})+sabPositivo(551)-sdb({1034,1044,190,192})",null)
