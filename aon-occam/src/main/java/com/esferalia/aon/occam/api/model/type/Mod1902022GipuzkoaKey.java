...
public enum Mod1902022GipuzkoaKey {
	...
	,B ("B - Rendimientos del trabajo: Pensionistas y perceptores de haberes pasivos y dem\u00E1s ...."
		,new String[] { "01", "02", "03", "10", "11", "12", "13", "14"
	...
	private Mod1902022GipuzkoaKey(String description, String[] subKeys) {
	...
	public static Mod1902022GipuzkoaKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902022GipuzkoaKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902022GipuzkoaKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902022GipuzkoaKey.G.subKeys[2];
	}
	public static Mod1902022GipuzkoaKey getDefaultKeyForFarmerRetentions() {
		return Mod1902022GipuzkoaKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902022GipuzkoaKey.H.subKeys[0];
	}
	public static Mod1902022GipuzkoaKey getDefaultKeyForTransportRetentions() {
		return Mod1902022GipuzkoaKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902022GipuzkoaKey.H.subKeys[3];
	}
}
