...
class Mod303WriterAEAT2018T4 implements IMod303Writer{
	...
	private enum Mod303File {
		...
		,AEAT_2017_4T_REG_1 (mod303 -> true ,new IPropertyFiller[] {
		   ...
		   ,(wr, mod) -> wr.append(AonStringUtils.repeat(' ', 579))
		...
		,AEAT_2017_4T_REG_4 (IFiscalModel::isLastPeriod ,new IPropertyFiller[] {
