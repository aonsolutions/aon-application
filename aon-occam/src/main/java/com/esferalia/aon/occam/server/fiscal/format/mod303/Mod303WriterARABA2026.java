...
public class Mod303WriterARABA2026 implements IMod303Writer {
	...
	private enum Mod303File {
		...
		,ARABA_RD ( mod -> true ,new IPropertyFiller[] {
			...
			,(wr, mod) -> wr.append("913" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod303Key.AR_C913),18))  // [913] Sujeto pasivo con derecho a deducir pago a cuenta de entregas de gasolinas, gasóleos y biocarburantes posteriores a la ultimación del régimen de depósito distinto del aduanero
...
//			,(wr, mod) -> wr.append(print(mod, Mod303Key.AR_C233))
			...
			,(wr, mod) -> wr.append(print(mod, Mod303Key.AR_C064))
			...
			// Resto de casillas hasta completar las 200 (hasta ahora van 91)			
			,(wr, mod) -> {
				for (int i=0; i<(200-91); i++) {
					wr.append("000" + AonFiscalFileUtils.signedSpace(0.0,18));
				}
			}
