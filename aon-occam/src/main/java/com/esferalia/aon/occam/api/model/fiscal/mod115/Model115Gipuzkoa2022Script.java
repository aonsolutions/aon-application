...
public enum Model115Gipuzkoa2022Script implements IModelScript<Mod115Key> {
	
	 R00 ("Rendimientos dinerarios",new Mod115Key[]{Mod115Key.GP_C01,Mod115Key.GP_C02,Mod115Key.GP_C03},MODEL_INVOICE_IRPF_BREAKDOWN)
	...
	private Model115Gipuzkoa2022Script(String label, Mod115Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
