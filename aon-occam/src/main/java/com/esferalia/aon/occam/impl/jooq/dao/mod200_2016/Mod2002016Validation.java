...
//			+ "19/1994, ni las deducciones por inversiones";
	...
	static { // PAGE 08
		...
		for (Mod2002016CorrectionKey ck : Mod2002016CorrectionKey.values()) {
			Mod2002016Key key = ck.getIncrease();
			if (key != null) {
				VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,key
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,I0417
				,MessageFormat.format(CHECK_SIGN_MSG,I0417.getDescription())
				,MessageFormat.format(MUST_POSITIVE_EXP,I0417.toString())));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,D0418
...
//			,"(round(D0400) == 0.0) || (round(D0400) > 0.0 && (C0017 || C0018 || C0019))"));
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,LQ301
		...
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,LQ302
...
//		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,I0369
...
//		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,D0370
//				,MessageFormat.format(INCOMPATIBLE_MSG,D0370.getDescription()
//					,C0013.getDescription() +"\" y/o \"" + C0014.getDescription())
//				,"round(D0370) != 0.0?(C0013 || C0014):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,I0256
				,MessageFormat.format(INCOMPATIBLE_MSG,I0256.getDescription()
					,C0013.getDescription() +"\" y/o \"" + C0014.getDescription())
				,"round(I0256) != 0.0?(C0013 || C0014):true"));
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE08,D0278
...
//				,MessageFormat.format(EQUAL_LESS_EXP,BN712.toString(),BN711.toString()))); 
	...
	static {	// PAGE 12
		VALIDATION_EXPRESSION_LIST.add(new ValidationMessage2016(PAGE12,ID653
