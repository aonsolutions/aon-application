...
public class Mod390HFWriterARABA2025 implements IMod390HFWriter {

	private enum Mod390HFFile {
			ARABA_2025_RC ( mod -> true ,new IPropertyFiller[] {
			...
			,ARABA_2025_RD ( mod -> true ,new IPropertyFiller[] {
...
//				,(wr, mod) -> wr.append("397" + AonFiscalFileUtils.signedSpace(mod.getAmount(Mod390Key.AR_C397),18))
				...
				// Resto de casillas hasta completar las 260 (51)				
				,(wr, mod) -> {					
					for (int i=1;i<=51;i++) {
						wr.append("000" + AonFiscalFileUtils.signedSpace(0.0,18));
					}
