...
public enum Model110BizkaiaScript implements IModelScript<Mod111Key> {
	...
	,R07 ("Rendimientos de actividades econ\u00F3micas en estimaci\u00F3n objetiva, modalidad de signos, \u00EDndices o m\u00F3dulos"
			,new Mod111Key[]{Mod111Key.BZ_C50,Mod111Key.BZ_C51,Mod111Key.BZ_C52},INVOICE,DIFF_INVOICE)
	...
	private Model110BizkaiaScript(String label, Mod111Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
