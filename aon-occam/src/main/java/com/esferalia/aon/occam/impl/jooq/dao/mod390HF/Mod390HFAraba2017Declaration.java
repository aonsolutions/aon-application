...
public class Mod390HFAraba2017Declaration extends Mod390HFArabaDeclaration {
	
	protected Mod390HFAraba2017Declaration() {
	...
	private static enum Mod390KeyDAO implements IMod390KeyDAO {
		...
		,AR_C054	(Mod390Key.AR_C054
			,(mod,vat) -> importacionesCorrientesFilter(vat) && hasPercent4(vat)
		...
		,AR_C857	(Mod390Key.AR_C857
			,(mod,vat) -> importacionesCorrientesFilter(vat) && hasPercent10(vat)
		...
		,AR_C860	(Mod390Key.AR_C860
			,(mod,vat) -> importacionesCorrientesFilter(vat) && hasPercent21(vat)
		...
		,AR_C087	(Mod390Key.AR_C076
			,(mod,vat) -> importacionesInversionFilter(vat) && hasPercent4(vat)
		...
		,AR_C890	(Mod390Key.AR_C890
			,(mod,vat) -> importacionesInversionFilter(vat) && hasPercent10(vat)
		...
		,AR_C893	(Mod390Key.AR_C893
			,(mod,vat) -> importacionesInversionFilter(vat) && hasPercent21(vat)
