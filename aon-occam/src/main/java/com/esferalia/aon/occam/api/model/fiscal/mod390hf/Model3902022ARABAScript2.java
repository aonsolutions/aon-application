...
public enum Model3902022ARABAScript2 implements IModelScript<Mod390Key> {
	...
	private Model3902022ARABAScript2(String label, Mod390Key[] keys,KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
