...
public class Mod303WriterARABA2022 implements IMod303Writer {
	...
	private enum Mod303File {
		...
		,ARABA_2016_RD ( mod -> true ,new IPropertyFiller[] {
			...
			,(wr, mod) -> wr.append(AonFiscalFileUtils.signedSpace(mod.getAmount(Mod303Key.AR_C080),18))  // Resultado de la declaración: Signo (blanco ó N) + Resultado 9(12) V99
			...
			// Resto de casillas hasta completar las 200 (total 117, ya que hasta ahora van 83)			
			,(wr, mod) -> {
				for (int i=1;i<=117;i++)
					wr.append("000" + AonFiscalFileUtils.signedSpace(0.0,18));
			}
