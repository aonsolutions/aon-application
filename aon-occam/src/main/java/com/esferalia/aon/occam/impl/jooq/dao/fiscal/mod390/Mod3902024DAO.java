...
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2024.AEATIVA2024toMod390;
import com.esferalia.aon.occam.impl.jooq.dao.mod390_2024.Mod390toAEATIVA2024;
...
public class Mod3902024DAO {
	...
	public static interface IMod390DetailKey {
		boolean accept(Mod3902024 mod,VatContext vc);
	}

	private static class KeyedVatContext  {
		private Mod3902024DetailKeyDAO key;
		private VatContext vc;
		
		private KeyedVatContext(Mod3902024DetailKeyDAO key,VatContext vc) {
			this.key = key;
			this.vc = vc;
		}
		public Mod3902024DetailKeyDAO getKey() {
			return key;
		}
	...
	public enum Mod3902024DetailKeyDAO implements Serializable {
		// IVA devengado
		 ...
		 ,C0501	(Mod3902024DetailKey.C0501, null)
		 ...
		 ,C0008	(Mod3902024DetailKey.C0008, null)
		 ,C0715	(Mod3902024DetailKey.C0715, null)
		 ,C0682	(Mod3902024DetailKey.C0682, null)
		 ,C0010	(Mod3902024DetailKey.C0010, null)
		 ,C0012	(Mod3902024DetailKey.C0012, null)
	 	// Régimen especial de agencias de viaje
		 ,C0014	(Mod3902024DetailKey.C0014, null)
	 	// Adquisiciones intracomunitarias de bienes
		 ,C0717	(Mod3902024DetailKey.C0717, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent0(vc))
		 ,C0684	(Mod3902024DetailKey.C0684, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent2(vc))
		 ,C0022	(Mod3902024DetailKey.C0022, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent4(vc))
		 ,C0719	(Mod3902024DetailKey.C0719, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent5(vc))
		 ,C0686	(Mod3902024DetailKey.C0686, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent75(vc))
		 ,C0024	(Mod3902024DetailKey.C0024, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent10(vc))
		 ,C0026	(Mod3902024DetailKey.C0026, (mod, vc) -> isIntracommunityPurchase(vc, mod) && hasPercent21(vc))
	 	// Adquisiciones intracomunitarias de servicios
		 ,C0721	(Mod3902024DetailKey.C0721, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent0(vc))
		 ,C0688	(Mod3902024DetailKey.C0688, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent2(vc))
		 ,C0546	(Mod3902024DetailKey.C0546, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent4(vc))
		 ,C0723	(Mod3902024DetailKey.C0723, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent5(vc))
		 ,C0690	(Mod3902024DetailKey.C0690, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent75(vc))
		 ,C0548	(Mod3902024DetailKey.C0548, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent10(vc))
		 ,C0552	(Mod3902024DetailKey.C0552, (mod, vc) -> isIntracommunityExpenses(vc, mod) && hasPercent21(vc))
	 	// IVA devengado en otros supuestos de inversión del sujeto pasivo
		 ,C0028	(Mod3902024DetailKey.C0028, (mod, vc) -> isOperacionesISPFilter(vc))
	 	// Modificación de bases y cuotas
		 ,C0030	(Mod3902024DetailKey.C0030, (mod, vc) -> modificacionBasesYCuotasFilter(vc))
	 	// Modificación de bases y cuotas de operaciones intragrupo
		 ,C0650 (Mod3902024DetailKey.C0650, null)	
	 	// Modificación de bases y cuotas por auto de declaración de concurso de acreedores
		 ,C0032	(Mod3902024DetailKey.C0032, null)
	 	// Total bases y cuotas IVA
		 ,C0034	(Mod3902024DetailKey.C0034, null)
	 	// Recargo de equivalencia
		 ,C0664 (Mod3902024DetailKey.C0664, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent00(vc))
		 ,C0692 (Mod3902024DetailKey.C0692, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent026(vc))
		 ,C0036 (Mod3902024DetailKey.C0036, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent05(vc))
		 ,C0666 (Mod3902024DetailKey.C0666, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent062(vc))
		 ,C0694 (Mod3902024DetailKey.C0694, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent10(vc))
		 ,C0600 (Mod3902024DetailKey.C0600, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent14(vc))
		 ,C0602 (Mod3902024DetailKey.C0602, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent52(vc))
		 ,C0042	(Mod3902024DetailKey.C0042, (mod, vc) -> isCommonNationalSales(vc, mod) && vc.isSurcharge() && hasSurchargePercent175(vc))
		 ,C0044	(Mod3902024DetailKey.C0044, (mod, vc) -> isCommonNationalSalesRECT(vc, mod) && vc.isSurcharge())
	 	// Modificación recargo equivalencia
		 ,C0046	(Mod3902024DetailKey.C0046, null)
	 	//  Total cuotas IVA y recargo de equivalencia
		 ,C0047	(Mod3902024DetailKey.C0047, null)

		 // IVA deducible
		 // Operaciones interiores corrientes
		 // IVA deducible en operaciones interiores de bienes y servicios corrientes
		 ,C0696	(Mod3902024DetailKey.C0696, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent2(vc)))
		 ,C0191	(Mod3902024DetailKey.C0191, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0725	(Mod3902024DetailKey.C0725, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0698	(Mod3902024DetailKey.C0698, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0604	(Mod3902024DetailKey.C0604, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0606	(Mod3902024DetailKey.C0606, ((mod, vc) -> operacionesInterioresCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en operaciones interiores de bienes y servicios corrientes
		 ,C0049	(Mod3902024DetailKey.C0049, null)
		 // IVA deducible en operaciones intragrupo de bienes y servicios corrientes
		 ,C0746	(Mod3902024DetailKey.C0746, null)
		 ,C0507	(Mod3902024DetailKey.C0507, null)
		 ,C0727	(Mod3902024DetailKey.C0727, null)
		 ,C0748	(Mod3902024DetailKey.C0748, null)
		 ,C0608	(Mod3902024DetailKey.C0608, null)
		 ,C0610	(Mod3902024DetailKey.C0610, null)
		 // Total bases imponibles y cuotas deducibles en operaciones intragrupo de bienes y servicios corrientes
		 ,C0513	(Mod3902024DetailKey.C0513, null)
		 
		 // Operaciones interiores de bienes de inversión
		 // IVA deducible en operaciones interiores de bienes de inversión	 
		 ,C0750	(Mod3902024DetailKey.C0750, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent2(vc)))
		 ,C0197	(Mod3902024DetailKey.C0197, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent4(vc)))
		 ,C0729	(Mod3902024DetailKey.C0729, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent5(vc)))
		 ,C0752	(Mod3902024DetailKey.C0752, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent75(vc)))
		 ,C0612	(Mod3902024DetailKey.C0612, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent10(vc)))
		 ,C0614	(Mod3902024DetailKey.C0614, ((mod, vc) -> operacionesInterioresInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en operaciones interiores de bienes de inversión
		 ,C0051	(Mod3902024DetailKey.C0051, null)

		 // IVA deducible en operaciones intragrupo de bienes de inversión
		 ,C0754	(Mod3902024DetailKey.C0754, null)
		 ,C0515	(Mod3902024DetailKey.C0515, null)
		 ,C0731	(Mod3902024DetailKey.C0731, null)
		 ,C0756	(Mod3902024DetailKey.C0756, null)
		 ,C0616	(Mod3902024DetailKey.C0616, null)
		 ,C0618	(Mod3902024DetailKey.C0618, null)
		 // Total bases imponibles y cuotas deducibles en operaciones intragrupo de bienes de inversión
		 ,C0521	(Mod3902024DetailKey.C0521, null)
		 
		 // Importaciones y adquisiciones intracomunitarias de bienes y servicio
		 // IVA deducible en importaciones de bienes corrientes
		 ,C0758	(Mod3902024DetailKey.C0758, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent2(vc)))
		 ,C0203	(Mod3902024DetailKey.C0203, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0733	(Mod3902024DetailKey.C0733, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0760	(Mod3902024DetailKey.C0760, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0620	(Mod3902024DetailKey.C0620, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0622	(Mod3902024DetailKey.C0622, ((mod, vc) -> importacionesCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en importaciones de bienes corrientes
		 ,C0053	(Mod3902024DetailKey.C0053, null)
		 
		 // IVA deducible en importaciones de bienes de inversión
		 ,C0762	(Mod3902024DetailKey.C0762, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent2(vc)))
		 ,C0209	(Mod3902024DetailKey.C0209, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent4(vc)))
		 ,C0735	(Mod3902024DetailKey.C0735, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent5(vc)))
		 ,C0764	(Mod3902024DetailKey.C0764, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent75(vc)))
		 ,C0624	(Mod3902024DetailKey.C0624, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent10(vc)))
		 ,C0626	(Mod3902024DetailKey.C0626, ((mod, vc) -> importacionesInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en importaciones de bienes de inversión
		 ,C0055	(Mod3902024DetailKey.C0055, null)
		 
		 // IVA deducible en adquisiciones intracomunitarias de bienes corrientes
		 ,C0766	(Mod3902024DetailKey.C0766, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent2(vc)))
		 ,C0215	(Mod3902024DetailKey.C0215, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent4(vc)))
		 ,C0737	(Mod3902024DetailKey.C0737, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent5(vc)))
		 ,C0768	(Mod3902024DetailKey.C0768, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent75(vc)))
		 ,C0628	(Mod3902024DetailKey.C0628, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent10(vc)))
		 ,C0630	(Mod3902024DetailKey.C0630, ((mod, vc) -> adqIntracomunitariasCorrientesFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en adquisiciones intracomunitarias de bienes corrientes
		 ,C0057	(Mod3902024DetailKey.C0057, null)

		 // IVA deducible en adquisiciones intracomunitarias de bienes de inversión
		 ,C0770	(Mod3902024DetailKey.C0770, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent2(vc)))
		 ,C0221	(Mod3902024DetailKey.C0221, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent4(vc)))
		 ,C0739	(Mod3902024DetailKey.C0739, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent5(vc)))
		 ,C0772	(Mod3902024DetailKey.C0772, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent75(vc)))
		 ,C0632	(Mod3902024DetailKey.C0632, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent10(vc)))
		 ,C0634	(Mod3902024DetailKey.C0634, ((mod, vc) -> adqIntracomunitariasInversionFilter(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en adquisiciones intracomunitarias de bienes de inversión
		 ,C0059	(Mod3902024DetailKey.C0059, null)
		 
		 // IVA deducible en adquisiciones intracomunitarias de servicios
		 ,C0774	(Mod3902024DetailKey.C0774, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent2(vc)))
		 ,C0588	(Mod3902024DetailKey.C0588, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent4(vc)))
		 ,C0741	(Mod3902024DetailKey.C0741, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent5(vc)))
		 ,C0776	(Mod3902024DetailKey.C0776, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent75(vc)))
		 ,C0636	(Mod3902024DetailKey.C0636, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent10(vc)))
		 ,C0638	(Mod3902024DetailKey.C0638, ((mod, vc) -> adqIntracomunitariasServicios(vc) && hasPercent21(vc)))
		 // Total bases imponibles y cuotas deducibles en adquisiciones intracomunitarias de servicios
		 ,C0598	(Mod3902024DetailKey.C0598, null)

		 // Compensación en régimen especial de la agricultura, ganaderia y pesca
		 ,C0061	(Mod3902024DetailKey.C0061, ((mod, vc) -> compensacionesRegAgrarioFilter(vc)))
		 ...
		 ,C0063	(Mod3902024DetailKey.C0063, null)
		 // Regularización por aplicación porcentaje definitivo de prorrata
		 ,C0522	(Mod3902024DetailKey.C0522, null)
		 // Suma de deducciones
		 ,C0064	(Mod3902024DetailKey.C0064, null)
		 ...
		 ,C0127	 (Mod3902024DetailKey.C0127, null)
		 // Operaciones intragrupo valoradas conforme a lo dispuesto en los arts. 78 y 79 LIVA
		 ,C0128	 (Mod3902024DetailKey.C0128, null)
		 // Operaciones en régimen simplificado
		 ,C0100	 (Mod3902024DetailKey.C0100, ((mod, vc) -> (vc.isNationalSales() && vc.isVatSimplifiedRegime())))
		...
		private Mod3902024DetailKeyDAO(Mod3902024DetailKey key, IMod390DetailKey accept) {
			this.key = key;
			this.accept = accept;
		}

		public Mod3902024DetailKey getKey() {
			return key;
		}
		public boolean accept(Mod3902024 mod, VatContext vc) {
			return accept!=null && accept.accept(mod,vc);
		}
		
//		public static Mod3902024DetailKey[] getKeys(Mod3902024 mod, VatContext vc) {
//			List<Mod3902024DetailKey> list = new LinkedList<>();
//			for (Mod3902024DetailKeyDAO key : Mod3902024DetailKeyDAO.values()) {
//				if (key.accept(mod,vc)) {
//					list.add(key.getKey()); 
//				}
//			}
//			return list.isEmpty()?null:list.toArray(new Mod3902024DetailKey[list.size()]);
//		}
	}

	
	private static EnumMap<Mod3902024DetailKey, Mod390Detail> getDetails(AONContext ctx, Mod3902024 mod390 ) {
		EnumMap<Mod3902024DetailKey, Mod390Detail> map = new EnumMap<>(Mod3902024DetailKey.class);
		Arrays.stream( Mod3902024DetailKey.values() )
		...
		map.get(Mod3902024DetailKey.C0653).setTaxableBase( vatAccBase );
		map.get(Mod3902024DetailKey.C0654).setTaxableBase( vatAccBase );
		map.get(Mod3902024DetailKey.C0654).setQuota( getVatAccrualPaymentOutputQuota(ctx, mod390) );
		map.get(Mod3902024DetailKey.C0656).setTaxableBase( getVatAccrualPaymentInputBase(ctx, mod390) );
		map.get(Mod3902024DetailKey.C0656).setQuota( getVatAccrualPaymentInputQuota(ctx, mod390) );
		...
		Mod303DAO.getEffectiveModels(ctx, mod390, cond)
			...
			.forEach( r -> map.computeIfAbsent(Mod3902024DetailKey.C0522, k -> new Mod390Detail().setKey(k)).setQuota(r))
		;
		return map;
	}
	...
	private static void add(Pair<KeyedVatContext, Mod390Detail> pair) {
		...
		Mod3902024DetailKey key = kvt.getKey().getKey();
	...
	private static void fillGeneralDeclarationResults(AONContext ctx, Mod3902024 mod390) {
	...
	private static void fillFromConfiguration(AONContext ctx, Mod3902024 mod390) {
	...
	// **********************************************************************************************
	// **********************************************************************************************
	public static Mod3902024 create(AONContext ctx, Mod390 model) {
		Mod3902024 mod390 =  new Mod3902024();
	...
	public static Mod3902024 getMod3902024(AONContext ctx, Mod390 m390) {
		if (m390.getId() == null) {
	...
	public static Mod3902024 getById(AONContext ctx, int id) {
		ctx.checkRead();
		Mod3902024 mod390 = new Mod3902024();
		ctx.getDslContext()
	...
	private static void populate(FsModel390Record rec, Mod3902024 mod390)  {
		mod390
	...
	public static Mod3902024 save(AONContext ctx, Mod3902024 mod390)  {
		if (mod390.getId() == null) {
	...
	private static String getXMLModel( Mod3902024 mod390 ) {
		try {
			if (mod390.getYear() >= 2024) {
				AEATIVA2024 iva = Mod390toAEATIVA2024.getAEATIVA2024(mod390);
	...
	private static Mod3902024 insert(AONContext ctx, Mod3902024 mod390) {
		validate(ctx, mod390);
	...
	private static Mod3902024 update(AONContext ctx, Mod3902024 mod390) {
		validate(ctx, mod390);
		mod390.calculate();
		ctx.getDslContext()
			.update(FS_MODEL390)
	...
	private static void validate(AONContext ctx, Mod3902024 mod390) {
...
//					.and(FS_MODEL390.RECEIPT.equal(mod390.getReplacedReceipt()))
	...
	public static void delete(AONContext ctx, Mod3902024 mod390) {
		ctx.checkWrite();
		ctx.getDslContext().delete(FS_MODEL390)
				.where(FS_MODEL390.ID.equal(mod390.getId())).execute();
	}
	
	private static Mod3902024 fillGeneralRegimeData(AONContext ctx, Mod3902024 mod390) {
		try {
			Mod390Detail det = null;
			EnumMap<Mod3902024DetailKey, Mod390Detail> map = getDetails(ctx, mod390);
			mod390.setBox99 (map.get(Mod3902024DetailKey.C0099).getTaxableBase());
			mod390.setBox100(map.get(Mod3902024DetailKey.C0100).getTaxableBase());
			mod390.setBox101(map.get(Mod3902024DetailKey.C0101).getTaxableBase());
			mod390.setBox102(map.get(Mod3902024DetailKey.C0102).getTaxableBase());
			mod390.setBox103(map.get(Mod3902024DetailKey.C0103).getTaxableBase());
			mod390.setBox104(map.get(Mod3902024DetailKey.C0104).getTaxableBase());
			mod390.setBox105(map.get(Mod3902024DetailKey.C0105).getTaxableBase());
			mod390.setBox106(map.get(Mod3902024DetailKey.C0106).getTaxableBase());
			mod390.setBox107(map.get(Mod3902024DetailKey.C0107).getTaxableBase());
			mod390.setBox108(map.get(Mod3902024DetailKey.C0108).getTaxableBase());
			mod390.setBox110(map.get(Mod3902024DetailKey.C0110).getTaxableBase());
			mod390.setBox125(map.get(Mod3902024DetailKey.C0125).getTaxableBase());
			mod390.setBox126(map.get(Mod3902024DetailKey.C0126).getTaxableBase());
			mod390.setBox127(map.get(Mod3902024DetailKey.C0127).getTaxableBase());
			mod390.setBox128(map.get(Mod3902024DetailKey.C0128).getTaxableBase());
			
			mod390.setBox227(map.get(Mod3902024DetailKey.C0227).getTaxableBase());
			mod390.setBox228(map.get(Mod3902024DetailKey.C0228).getTaxableBase());
			mod390.setBox653(map.get(Mod3902024DetailKey.C0653).getTaxableBase());
			mod390.setBox654(map.get(Mod3902024DetailKey.C0654).getTaxableBase());
			mod390.setBox655(map.get(Mod3902024DetailKey.C0654).getQuota());
			mod390.setAccrualRegime( ( map.get(Mod3902024DetailKey.C0654).getTaxableBase()  != 0 || map.get(Mod3902024DetailKey.C0654).getQuota() != 0 ) );
			...
			if (mod390.isSimplifiedRegime()) {
				map = new EnumMap<>(Mod3902024DetailKey.class);
				for (Mod3902024DetailKey key : Mod3902024DetailKey.values() ) {
	...
	static interface ISimplifiedRegimeFiller {
		boolean fill(SimplifedRegimeContext src,Mod3902024 mod390);
	}
...
//		PBK      (Mod303Key.PBK     , null),
		...
		public static void fill(SimplifedRegimeContext src,Mod3902024 mod390) {
	...
	private static Mod3902024 fillSimplifedRegimeData(AONContext ctx, Mod3902024 mod390) {
	...
	private static void fillSimplifiedDeclarationResults(AONContext ctx, Mod3902024 mod390) {
	...
	public static Mod3902024 changeStatus(AONContext ctx, Mod3902024 mod390, FiscalStatus newStatus) {
		try {
			ctx.checkWrite();
			if (mod390.getId() != null) {
	...
	// *******************
	public static Mod3902024 aeatPresentation(AONContext ctx, Mod3902024 mod, String aeatResponse) {
	...
	private static boolean isCommonNationalSales(VatContext vat, Mod3902024 mod) {
	...
	private static boolean isCommonNationalSalesRECT(VatContext vat, Mod3902024 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& vat.isNational()
			&& vat.isSales() 
	...
	private static boolean isIntracommunityPurchase(VatContext vat, Mod3902024 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& !vat.isRectification() 
			&& vat.isIntracommunityPurchase();
	}
	private static boolean isIntracommunityExpenses(VatContext vat, Mod3902024 mod) {
		return vat.isVatGeneralRegime(VATRegime.GENERAL) 
			&& !vat.isVatSurchargeRegime() 
			&& !vat.isRectification() 
