...
class Mod303WriterAEAT2022 implements IMod303Writer{
	...
	private enum Mod303File {
		...
		,AEAT_2021_REG_1 (mod303 -> true ,new IPropertyFiller[] {
		...
		,AEAT_2021_REG_2 (mod303 -> mod303.getAmount(Mod303Key.CT_A02) < 2 ,new IPropertyFiller[] {
		...
		,AEAT_2021_REG_2_BIS (mod303 -> mod303.getAmount(Mod303Key.CT_A02) < 2
		...
		,AEAT_2021_REG_3 (mod303 -> true ,new IPropertyFiller[] {
			   ...
			   ,(wr, mod) -> wr.append(mod.getDeclarationResultType() == FiscalModelDeclarationType.PAYBACK?"1":"0")				// Devolución - Marca SEPA
			   ,(wr, mod) -> wr.append(AonStringUtils.repeat(' ', 600)) // Reservado para la AEAT
			   
			   ,(wr, mod) -> wr.append("</T30303000>")
		})
		
		,AEAT_2021_REG_4 (IFiscalModel::isLastPeriod ,new IPropertyFiller[] {
		...
		,AEAT_2021_REG_5_END (IFiscalModel::isLastPeriod ,new IPropertyFiller[] {
		...
		,AEAT_2021_REG_0_END (mod303 -> true ,new IPropertyFiller[] { 
		    (wr, mod) -> wr.append("</T")
		   ,(wr, mod) -> wr.append("303")
		   ,(wr, mod) -> wr.append("0")
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getYear(), 4,0))
