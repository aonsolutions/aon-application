...
public class AEATIVA2022toMod390 {

	private static final DateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy");

	private AEATIVA2022toMod390() {

	}

	public static void populate(Mod3902022 mod390, AEATIVA2022 iva) throws ParseException {
		...
		Map<Mod3902022DetailKey, Mod390Detail> map = new TreeMap<>();
		...
		if (iva.getRegGeneral() != null) {
			...
			if (b != null) {
				if (b.getRegOrdinario() != null) {
					put(mod390, Mod3902022DetailKey.C0701, b.getRegOrdinario().getTipo0());
					put(mod390, Mod3902022DetailKey.C0002, b.getRegOrdinario().getTipo4());
					put(mod390, Mod3902022DetailKey.C0703, b.getRegOrdinario().getTipo5());
					put(mod390, Mod3902022DetailKey.C0004, b.getRegOrdinario().getTipo10());
					put(mod390, Mod3902022DetailKey.C0006, b.getRegOrdinario().getTipo21());
				}
				if (b.getOpIntragrupo() != null) {
					put(mod390, Mod3902022DetailKey.C0705, b.getOpIntragrupo().getTipo0());
					put(mod390, Mod3902022DetailKey.C0501, b.getOpIntragrupo().getTipo4());
					put(mod390, Mod3902022DetailKey.C0707, b.getOpIntragrupo().getTipo0());
					put(mod390, Mod3902022DetailKey.C0503, b.getOpIntragrupo().getTipo10());
					put(mod390, Mod3902022DetailKey.C0505, b.getOpIntragrupo().getTipo21());
				}
				if (b.getRegCriterioCaja() != null) {
					put(mod390, Mod3902022DetailKey.C0709, b.getRegCriterioCaja().getTipo0());
					put(mod390, Mod3902022DetailKey.C0644, b.getRegCriterioCaja().getTipo4());
					put(mod390, Mod3902022DetailKey.C0711, b.getRegCriterioCaja().getTipo5());
					put(mod390, Mod3902022DetailKey.C0646, b.getRegCriterioCaja().getTipo10());
					put(mod390, Mod3902022DetailKey.C0648, b.getRegCriterioCaja().getTipo21());
				}
				if (b.getRegBienesUsados() != null) {
					put(mod390, Mod3902022DetailKey.C0713, b.getRegBienesUsados().getTipo0());
					put(mod390, Mod3902022DetailKey.C0008, b.getRegBienesUsados().getTipo4());
					put(mod390, Mod3902022DetailKey.C0715, b.getRegBienesUsados().getTipo5());
					put(mod390, Mod3902022DetailKey.C0010, b.getRegBienesUsados().getTipo10());
					put(mod390, Mod3902022DetailKey.C0012, b.getRegBienesUsados().getTipo21());
				}
				if (b.getRegAgViajes() != null) {
					put(mod390, Mod3902022DetailKey.C0014, b.getRegAgViajes().getTipo21());
				}
				if (b.getAdqIntracomBienes() != null) {
					put(mod390, Mod3902022DetailKey.C0717, b.getAdqIntracomBienes().getTipo0());
					put(mod390, Mod3902022DetailKey.C0022, b.getAdqIntracomBienes().getTipo4());
					put(mod390, Mod3902022DetailKey.C0719, b.getAdqIntracomBienes().getTipo5());
					put(mod390, Mod3902022DetailKey.C0024, b.getAdqIntracomBienes().getTipo10());
					put(mod390, Mod3902022DetailKey.C0026, b.getAdqIntracomBienes().getTipo21());
				}
				if (b.getAdqIntracomServicios() != null) {
					put(mod390, Mod3902022DetailKey.C0721, b.getAdqIntracomServicios().getTipo0());
					put(mod390, Mod3902022DetailKey.C0546, b.getAdqIntracomServicios().getTipo4());
					put(mod390, Mod3902022DetailKey.C0723, b.getAdqIntracomServicios().getTipo5());
					put(mod390, Mod3902022DetailKey.C0548, b.getAdqIntracomServicios().getTipo10());
					put(mod390, Mod3902022DetailKey.C0552, b.getAdqIntracomServicios().getTipo21());
				}
				if (b.getIVAdevengadoInversionSP() != null) {
					put(mod390, Mod3902022DetailKey.C0028, b.getIVAdevengadoInversionSP().getTipoX());
				}
				if (b.getModBasesyCuotas() != null) {
					put(mod390, Mod3902022DetailKey.C0030, b.getModBasesyCuotas().getTipoX());
				}
				if (b.getModBasesyCuotasConcursoAcreedores() != null) {
					put(mod390, Mod3902022DetailKey.C0032, b.getModBasesyCuotasConcursoAcreedores().getTipoX());
				}
				if (b.getTotalBasesyCuotasIVA() != null) {
					put(mod390, Mod3902022DetailKey.C0034, b.getTotalBasesyCuotasIVA().getTipoX());
				}
				if (b.getRecargoEquivalencia() != null) {
					put(mod390, Mod3902022DetailKey.C0036, b.getRecargoEquivalencia().getTipo05());
					put(mod390, Mod3902022DetailKey.C0600, b.getRecargoEquivalencia().getTipo14());
					put(mod390, Mod3902022DetailKey.C0042, b.getRecargoEquivalencia().getTipo175());
					put(mod390, Mod3902022DetailKey.C0602, b.getRecargoEquivalencia().getTipo52());
				}
				if (b.getModRecargoEquivalencia() != null) {
					put(mod390, Mod3902022DetailKey.C0044, b.getModRecargoEquivalencia().getTipoX());
				}
				if (b.getModRecargoEquivalenciaConcursoAcreedores() != null) {
					put(mod390, Mod3902022DetailKey.C0046, b.getModRecargoEquivalenciaConcursoAcreedores().getTipoX());
				}
				if (b.getTotalCuotasIVA() != null) {
					put(mod390, Mod3902022DetailKey.C0047, b.getTotalCuotasIVA());
				}
			}
			...
			if (iva.getRegGeneral().getDeducciones() != null) {
				...
				if (d.getOpInterioresBienesServiciosCorrientes() != null) {
					put(mod390, Mod3902022DetailKey.C0191, d.getOpInterioresBienesServiciosCorrientes().getTipo4());
					put(mod390, Mod3902022DetailKey.C0725, d.getOpInterioresBienesServiciosCorrientes().getTipo5());
					put(mod390, Mod3902022DetailKey.C0604, d.getOpInterioresBienesServiciosCorrientes().getTipo10());
					put(mod390, Mod3902022DetailKey.C0606, d.getOpInterioresBienesServiciosCorrientes().getTipo21());
					put(mod390, Mod3902022DetailKey.C0049, d.getOpInterioresBienesServiciosCorrientes().getTotal());
				}
				if (d.getOpIntragrupoCorrientes() != null) {
					put(mod390, Mod3902022DetailKey.C0507, d.getOpIntragrupoCorrientes().getTipo4());
					put(mod390, Mod3902022DetailKey.C0727, d.getOpIntragrupoCorrientes().getTipo5());
					put(mod390, Mod3902022DetailKey.C0608, d.getOpIntragrupoCorrientes().getTipo10());
					put(mod390, Mod3902022DetailKey.C0610, d.getOpIntragrupoCorrientes().getTipo21());
					put(mod390, Mod3902022DetailKey.C0513, d.getOpIntragrupoCorrientes().getTotal());
				}
				if (d.getOpInterioresBienesInversion() != null) {
					put(mod390, Mod3902022DetailKey.C0197, d.getOpInterioresBienesInversion().getTipo4());
					put(mod390, Mod3902022DetailKey.C0729, d.getOpInterioresBienesInversion().getTipo5());
					put(mod390, Mod3902022DetailKey.C0612, d.getOpInterioresBienesInversion().getTipo10());
					put(mod390, Mod3902022DetailKey.C0614, d.getOpInterioresBienesInversion().getTipo21());
					put(mod390, Mod3902022DetailKey.C0051, d.getOpInterioresBienesInversion().getTotal());
				}
				if (d.getOpIntragrupoBienesInversion() != null) {
					put(mod390, Mod3902022DetailKey.C0515, d.getOpIntragrupoBienesInversion().getTipo4());
					put(mod390, Mod3902022DetailKey.C0731, d.getOpIntragrupoBienesInversion().getTipo5());
					put(mod390, Mod3902022DetailKey.C0616, d.getOpIntragrupoBienesInversion().getTipo10());
					put(mod390, Mod3902022DetailKey.C0618, d.getOpIntragrupoBienesInversion().getTipo21());
					put(mod390, Mod3902022DetailKey.C0521, d.getOpIntragrupoBienesInversion().getTotal());
				}
				if (d.getImportacionesBienesCorrientes() != null) {
					put(mod390, Mod3902022DetailKey.C0203, d.getImportacionesBienesCorrientes().getTipo4());
					put(mod390, Mod3902022DetailKey.C0733, d.getImportacionesBienesCorrientes().getTipo5());
					put(mod390, Mod3902022DetailKey.C0620, d.getImportacionesBienesCorrientes().getTipo10());
					put(mod390, Mod3902022DetailKey.C0622, d.getImportacionesBienesCorrientes().getTipo21());
					put(mod390, Mod3902022DetailKey.C0053, d.getImportacionesBienesCorrientes().getTotal());
				}
				if (d.getImportacionesBienesInversion() != null) {
					put(mod390, Mod3902022DetailKey.C0209, d.getImportacionesBienesInversion().getTipo4());
					put(mod390, Mod3902022DetailKey.C0735, d.getImportacionesBienesInversion().getTipo5());
					put(mod390, Mod3902022DetailKey.C0624, d.getImportacionesBienesInversion().getTipo10());
					put(mod390, Mod3902022DetailKey.C0626, d.getImportacionesBienesInversion().getTipo21());
					put(mod390, Mod3902022DetailKey.C0055, d.getImportacionesBienesInversion().getTotal());
				}
				if (d.getAdqIntracomunitariasBienesCorrientes() != null) {
					put(mod390, Mod3902022DetailKey.C0215, d.getAdqIntracomunitariasBienesCorrientes().getTipo4());
					put(mod390, Mod3902022DetailKey.C0737, d.getAdqIntracomunitariasBienesCorrientes().getTipo5());
					put(mod390, Mod3902022DetailKey.C0628, d.getAdqIntracomunitariasBienesCorrientes().getTipo10());
					put(mod390, Mod3902022DetailKey.C0630, d.getAdqIntracomunitariasBienesCorrientes().getTipo21());
					put(mod390, Mod3902022DetailKey.C0057, d.getAdqIntracomunitariasBienesCorrientes().getTotal());
				}
				if (d.getAdqIntracomunitariasBienesInversion() != null) {
					put(mod390, Mod3902022DetailKey.C0221, d.getAdqIntracomunitariasBienesInversion().getTipo4());
					put(mod390, Mod3902022DetailKey.C0739, d.getAdqIntracomunitariasBienesInversion().getTipo5());
					put(mod390, Mod3902022DetailKey.C0632, d.getAdqIntracomunitariasBienesInversion().getTipo10());
					put(mod390, Mod3902022DetailKey.C0634, d.getAdqIntracomunitariasBienesInversion().getTipo21());
					put(mod390, Mod3902022DetailKey.C0059, d.getAdqIntracomunitariasBienesInversion().getTotal());
				}
				if (d.getAdqIntracomunitariasServicios() != null) {
					put(mod390, Mod3902022DetailKey.C0588, d.getAdqIntracomunitariasServicios().getTipo4());
					put(mod390, Mod3902022DetailKey.C0741, d.getAdqIntracomunitariasServicios().getTipo5());
					put(mod390, Mod3902022DetailKey.C0636, d.getAdqIntracomunitariasServicios().getTipo10());
					put(mod390, Mod3902022DetailKey.C0638, d.getAdqIntracomunitariasServicios().getTipo21());
					put(mod390, Mod3902022DetailKey.C0598, d.getAdqIntracomunitariasServicios().getTotal());
				}
				if (d.getComRegAgricGanadPesca() != null) {
					put(mod390, Mod3902022DetailKey.C0061, d.getComRegAgricGanadPesca().getTipoX());
				}
				if (d.getRectifDeducciones() != null) {
					put(mod390, Mod3902022DetailKey.C0062, d.getRectifDeducciones().getTipoX());
				}
				if (d.getRectifOpIntragrupo() != null) {
					put(mod390, Mod3902022DetailKey.C0652, d.getRectifOpIntragrupo().getTipoX());
				}
				if (d.getRegularizInversiones() != null) {
					put(mod390, Mod3902022DetailKey.C0063, d.getRegularizInversiones());
				}
				if (d.getRegularizPorcProrrata() != null) {
					put(mod390, Mod3902022DetailKey.C0522, d.getRegularizPorcProrrata());
				}
				if (d.getSumDeducciones() != null) {
					put(mod390, Mod3902022DetailKey.C0064, d.getSumDeducciones());
				}
			...
			if (AonStringUtils.isNotEmpty(res)) {
				try {
					...
					put(mod390, Mod3902022DetailKey.C0065, BigDecimal.valueOf(val));
				} catch (NumberFormatException e) {
					// Nothing
				}
			}
	...
	private static void put(Mod3902022 mod390, Mod3902022DetailKey key, TipoBaseImponibleYCuota tipo) {
		if (tipo != null) {
	...
	private static void put(Mod3902022 mod390, Mod3902022DetailKey key, BigDecimal quota) {
		if (quota != null) {
			Mod390Detail detail = new Mod390Detail();
			detail.setKey(key);
			detail.setPercent(key.getPercent());
