...
/**
 * @author ecastellano
 * @deprecated Use Mod303DAO
 */
@Deprecated
public class PrevMod303DAO extends FiscalModelDAO {
	...
	public static Mod303 getMod303(AONContext ctx,int id) {
		ctx.checkRead();
		final Mod303 mod303 = FiscalModelDAO.get(ctx,Mod303::new,id);
...
//	}
	private static void breakdownInitialization(AONContext ctx, Mod303 mod303, Mod303Declaration dec) {
		PrevMod303DAO.getVatBreakdown(ctx,mod303)
...
//			if (key != null && key.getKey().isDiffEnabled()) {
	...
	private static String getComputeKey(AONContext ctx, Mod303 mod303, IModelScript<Mod303Key> script,IMod303KeyDAO keyDAO) {
		...
		mvelCtx.put("periodModels", getSamePeriodModels(ctx, mod303, Mod303::new).collect(Collectors.toCollection(LinkedList::new)));
		mvelCtx.put("lastPeriodModels", getLastPeriodModels(ctx, mod303, Mod303::new).collect(Collectors.toCollection(LinkedList::new)));
