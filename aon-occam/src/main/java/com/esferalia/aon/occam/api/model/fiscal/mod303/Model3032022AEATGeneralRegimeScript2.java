...
public enum Model3032022AEATGeneralRegimeScript2 implements IModelScript<Mod303Key> {
	
	 DED01 ("R\u00E9gimen general. IVA deducible",null,null,TITLE)
	,DED02 ("Por cuotas soportadas en operaciones interiores corrientes"
		,new Mod303Key[]{Mod303Key.CT_C28	,Mod303Key.CT_C29},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED03 ("Por cuotas soportadas en operaciones interiores con bienes de inversi\u00F3n" 
		,new Mod303Key[]{Mod303Key.CT_C30	,Mod303Key.CT_C31},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED04 ("Por cuotas soportadas en las importaciones de bienes corrientes"
		,new Mod303Key[]{Mod303Key.CT_C32	,Mod303Key.CT_C33},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED05 ("Por cuotas soportadas en las importaciones de bienes de inversi\u00F3n"
		,new Mod303Key[]{Mod303Key.CT_C34	,Mod303Key.CT_C35},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED06 ("En adquisiciones intracomunitarias de bienes y servicios corrientes"
		,new Mod303Key[]{Mod303Key.CT_C36	,Mod303Key.CT_C37},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED07 ("En adquisiciones intracomunitarias de bienes de inversi\u00F3n"
		,new Mod303Key[]{Mod303Key.CT_C38	,Mod303Key.CT_C39},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED08 ("Rectificaci\u00F3n de deducciones"
		,new Mod303Key[]{Mod303Key.CT_C40	,Mod303Key.CT_C41},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	,DED09 ("Compensaciones R\u00E9gimen Especial A.G. y P."
		,new Mod303Key[]{null				,Mod303Key.CT_C42},new KeyTypes[]{KeyTypes.BASE,KeyTypes.DEDUCTIBLE_QUOTA},PRORRATED_MODEL_INVOICE_VAT_BREAKDOWN)
	...
	private Model3032022AEATGeneralRegimeScript2(String label, Mod303Key[] keys,KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
