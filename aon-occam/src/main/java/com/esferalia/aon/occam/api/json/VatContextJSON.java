...
public class VatContextJSON {
	...
	public static VatContext fromJSON(JSONObject json) {
		return new VatContext()
			...
			.setVatUnion( json.optBoolean(IJsonNames.VAT_UNION))
			.setVatUnionExternal( json.optBoolean(IJsonNames.VAT_UNION_EXTERNAL))
	...
	public static JSONObject toJSON(VatContext vat) {
		return new JSONObject()
			...
			.put(IJsonNames.VAT_UNION, vat.isVatUnion() )
			.put(IJsonNames.VAT_UNION_EXTERNAL, vat.isVatUnionExternal() )
