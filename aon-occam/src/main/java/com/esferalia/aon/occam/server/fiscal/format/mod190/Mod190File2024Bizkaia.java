...
enum Mod190File2024Bizkaia {
	...
	private Mod190File2024Bizkaia(IPropertyFiller[] pf) {
	...
	static void fill(Mod190 mod190, Writer wr) throws IOException {
		Mod190File2024Bizkaia.TYPE_1.fillPage(mod190, null, wr);	
		for (Mod190Detail detail : mod190.getDetails()) {
			Mod190File2024Bizkaia.TYPE_2.fillPage(mod190, detail, wr);	
		}
	}
}
