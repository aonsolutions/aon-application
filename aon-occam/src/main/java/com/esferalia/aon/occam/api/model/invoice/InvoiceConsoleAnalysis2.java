...
public class InvoiceConsoleAnalysis2 implements Serializable {
	...
	public InvoiceConsoleAnalysis2 setCommunicationConfiguration(InvoiceCommunicationConfiguration icc) {
		this.icc = icc;
		return this;
	}
	...
	public InvoiceConsoleAnalysis2 addMessage(InvoiceErrorLevel level, String message) {
		this.messages.add(
	...
	public InvoiceConsoleAnalysis2 addInvoice( Invoice invoice ) {
	...
	public static InvoiceConsoleAnalysis2 fromError(String msg) {
		InvoiceConsoleAnalysis2 analysis = new InvoiceConsoleAnalysis2();
