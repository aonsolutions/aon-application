...
public enum Model3032022ARABAPrintScript implements IModelScript<Mod303Key> {
	...
	private Model3032022ARABAPrintScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
