...
public enum Mod111DeclarationType {
	...
	private Mod111DeclarationType(String value,String description,boolean mustCreateFinance,boolean bankRequired) {
		this.value = value;
	...
	public static Mod111DeclarationType safeValueOf( String value ) {
		if (value == null) return null;
		for (Mod111DeclarationType t : Mod111DeclarationType.values()) {
