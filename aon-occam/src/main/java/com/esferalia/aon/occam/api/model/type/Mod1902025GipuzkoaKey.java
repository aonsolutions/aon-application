...
public enum Mod1902025GipuzkoaKey {
	...
	,L ("L - Rentas exentas y dietas exceptuadas de gravamen."
		,new String[] { 
			...
			"22", "23", "24", "27", "28" , "29", "35", "36", "37", "42", "44", "45", "46", "99"}
	)
	;
	...
	private Mod1902025GipuzkoaKey(String description, String[] subKeys) {
	...
	public static Mod1902025GipuzkoaKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902025GipuzkoaKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902025GipuzkoaKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902025GipuzkoaKey.G.subKeys[2];
	}
	public static Mod1902025GipuzkoaKey getDefaultKeyForFarmerRetentions() {
		return Mod1902025GipuzkoaKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902025GipuzkoaKey.H.subKeys[0];
	}
	public static Mod1902025GipuzkoaKey getDefaultKeyForTransportRetentions() {
		return Mod1902025GipuzkoaKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902025GipuzkoaKey.H.subKeys[3];
	}
}
