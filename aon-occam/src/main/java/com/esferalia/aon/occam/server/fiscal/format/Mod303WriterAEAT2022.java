...
public class Mod303WriterAEAT2022 implements IMod303Writer{
	...
	private static enum Mod303File {
		...
		,AEAT_2021_REG_3 (mod303 -> true ,new IPropertyFiller[] {
			   ...
			   ,(wr, mod) -> wr.append(mod.getDeclarationType() == FiscalModelDeclarationType.PAYBACK?"1":"0")				// Devolución - Marca SEPA
