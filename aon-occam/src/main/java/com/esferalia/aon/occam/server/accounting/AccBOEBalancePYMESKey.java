...
public enum AccBOEBalancePYMESKey implements IBalanceKey{
	...
	,AC(0,false,"B)","ACTIVO CORRIENTE",null,"ACI+ACII+ACIII+ACIV+ACV+ACVI")
		...
		,ACIII(1,false,"III","Inversiones en empresas del grupo y asociadas a corto plazo","sdb({5303,5304,5313,5314, 5323, 5324,5333, 5334, 5343,5344, 5353, 5354})+sdbPositivo({5523,5524})-sab({5393,5394,593,5943,5944,5953,5954})",null)
...
//PASIVO Y PATRIMONIO
	...
	,PC(0,false,"C)","PASIVO CORRIENTE",null,"PCI+PCII+PCIII+PCIV+PCV")
		...
		,PCIII(1,false,"IV","Deudas con empresas del grupo y asociadas a corto plazo","sab({5103,5104,5113,5114,5123,5124,5133,5134,5143,5144,5563,5564})+sabPositivo({5523,5524})",null)
