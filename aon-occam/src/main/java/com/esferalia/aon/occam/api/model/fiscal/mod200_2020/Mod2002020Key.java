...
//                                                                                      //
// IMPORTANTE:                                                                          //   
// Además de este enumerado, tambien existe el enumerado Mod2002020KeyDC que lleva      //
...
public enum Mod2002020Key implements IMod200Key {
...
// --------------- PAGINAS 12 Y 13 --------------- //	
	...
	// SE PONEN EN OTRO ENUMERADO (Mod2002020KeyDC) PORQUE SI LOS AÑADIMOS AQUI TENEMOS ERROR DE CODE TOO LARGE
...
// --------------- PAGINA 20 BIS --------------- //
	...
	,LQ2410		,LQ2411		,LQ2412	
	,LQ1034A 	,LQ1730		,LQ1731
	,LQ1147  				,LQ1149
...
// --------------- PAGINA 20 TER --------------- //
	...
	,LM2418	,LM2419	,LM2420	,LM2421	,LM2422			,LM2423	,LM2424	,LM2425	,LM2426	
...
// --------------- PAGINA 26 --------------- //	
	...
	public String getCode() {
		...
		String code = Mod2002020Code.CODE_MAP.get(this);
	...
	public String getDescription() {
		return Mod2002020Description.DESCRIPTION_MAP.get(this);
	}
	
	public static Mod2002020Key safeValueOf( String str ) {
		for (Mod2002020Key key : values()) {
