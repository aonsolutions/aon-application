	...
	private static enum AccBOEBalanceAbbreviateKey implements IBalanceKey{
		...
		,AC(0,HEADER0,"B)","ACTIVO CORRIENTE",null,"ACI+ACII+ACIII+ACIV+ACV+ACVI+ACVII")
			...
			,ACIII(1,HEADER1,"III","Deudores comerciales y otras cuentas a cobrar",null,"ACIII1+ACIII2+ACIII3")
				,ACIII1(2,LEAF,"1","Clientes por ventas y prestaciones de servicios","sdb({430,431,432,435,436})-sab({437,490,493})",null)
			...
			,ACV(1,LEAF,"V","Inversiones financieras a corto plazo","sdb({5305,540,5325,5345,542,543,547,5315,5335,541,546,5590,5593,5355,545,548,5525,565,566})-sab({5955,598,5945,597,5395,549})+sdbPositivo({551})",null)
	...
	// PASIVO Y PATRIMONIO
		,PN(0,HEADER0,"A)","PATRIMONIO NETO",null,"PNA1+PNA2+PNA3")
			,PNA1(1,HEADER1,"A-1)","Fondos propios",null,"PNA1I+PNA1II+PNA1III+PNA1IV+PNA1V+PNA1VI+PNA1VII+PNA1VIII+PNA1IX")
				,PNA1I(2,HEADER2,"I","Capital",null,"PNA1I1+PNA1I2")
					...
					,PNA1I2(3,LEAF,"2","(Capital no exigido)","sdb({1030,1040})",null)
				,PNA1II(2,LEAF,"II","Prima de emisi\u00F3n","sab({110})"	,null)
				,PNA1III(2,LEAF,"III","Reservas","sab({112,113,114,115,119})",null)
				,PNA1IV(2,LEAF,"IV","(Acciones y participaciones en patrimonio propias)","sdb({108,109})",null)
		...
		,PC(0,HEADER0,"C)","PASIVO CORRIENTE",null,"PCI+PCII+PCIII+PCIV+PCV+PCVI")
			...
			,PCIII(1,HEADER1,"III","Deudas a corto plazo",null,"PCIII1+PCIII2+PCIII3")
				...
				,PCIII3(2,LEAF,"3","Otras deudas a corto plazo","sab({194,500,501,505,506,509,5115,5135,5145,521,522,523,525,526,528,525,555,5565,5566,5595,5598,560,561,569})+sabPositivo(551)-sdb({1034,1044,190,192})",null)
			,PCIV(1,LEAF,"IV","Deudas con empresas del grupo y asociadas a corto plazo","sab({5103,5104,5113,5114,5123,5124,5133,5134,5143,5144,5563,5564})+sabPositivo({5523,5524})",null)
