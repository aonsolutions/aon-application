...
public class BOEBalanceAbbreviateScript extends BalanceScript {
	...
	private static enum AccBOEBalanceAbbreviateKey implements IBalanceKey{
		...
		,AC(0,HEADER0,"B)","ACTIVO CORRIENTE",null,"ACI+ACII+ACIII+ACIV+ACV+ACVI+ACVII")
			...
			,ACV(1,LEAF,"V","Inversiones financieras a corto plazo","sdb({5305,5315,5325,5335,5345,5355,540,541,542,543,545,546,547,548,5590,5593,565,566})-sab({5955,598,5945,597,5395,549})+sdbPositivo({551})+sdbPositivo({5525})",null)
