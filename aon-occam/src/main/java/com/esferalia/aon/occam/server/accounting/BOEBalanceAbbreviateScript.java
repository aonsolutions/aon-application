...
public class BOEBalanceAbbreviateScript extends BalanceScript {
	...
	private static enum AccBOEBalanceAbbreviateKey implements IBalanceKey{
		...
		,AC(0,HEADER0,"B)","ACTIVO CORRIENTE",null,"ACI+ACII+ACIII+ACIV+ACV+ACVI+ACVII")
			...
			,ACV(1,LEAF,"V","Inversiones financieras a corto plazo","sdb({5305,5315,5325,5335,5345,5355,540,541,542,543,545,546,547,548,554,5590,5593,565,566})-sab({5955,598,5945,597,5395,549})+sdbPositivo({551})+sdbPositivo({5525})",null)
	...
	// PASIVO Y PATRIMONIO
		...
		,PC(0,HEADER0,"C)","PASIVO CORRIENTE",null,"PCI+PCII+PCIII+PCIV+PCV+PCVI+PCVII")
			...
			,PCIII(1,HEADER1,"III","Deudas a corto plazo",null,"PCIII1+PCIII2+PCIII3")
				...
				,PCIII3(2,LEAF,"3","Otras deudas a corto plazo","sab({194,500,501,505,506,509,5115,5135,5145,521,522,523,525,526,528,555,5565,5566,5595,5598,560,561,569})+sabPositivo({551})+sabPositivo({5525})-sdb({1034,1044,190,192})",null)
