...
public enum Model3032022AEATSimplifiedRegimeScript implements IModelScript<Mod303Key> {
	
	  DV001 (Mod303Key.CT_S47.getDescription(),new Mod303Key[]{Mod303Key.CT_S47},COMPUTE)
	 ,DV002 ("Cuotas devengadas",null,TITLE)
	 ,DV003 (Mod303Key.CT_S51.getDescription(),new Mod303Key[]{Mod303Key.CT_S51},MODEL_INVOICE_VAT_BREAKDOWN)
	 ,DV004 (Mod303Key.CT_S52.getDescription(),new Mod303Key[]{Mod303Key.CT_S52},MODEL_INVOICE_VAT_BREAKDOWN)
	 ,DV005 (Mod303Key.CT_S53.getDescription(),new Mod303Key[]{Mod303Key.CT_S53},MODEL_INVOICE_VAT_BREAKDOWN)
	 ,DV006 (Mod303Key.CT_S54.getDescription(),new Mod303Key[]{Mod303Key.CT_S54},COMPUTE)
	 
	 ,DCG01 ("IVA deducible",null,TITLE)
	 ,DC002 (Mod303Key.CT_S55.getDescription(),new Mod303Key[]{Mod303Key.CT_S55},MODEL_INVOICE_VAT_BREAKDOWN)
	...
	private Model3032022AEATSimplifiedRegimeScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
