...
public enum Mod1902024BizkaiaKey {
	...
	,L ("L - Rentas exentas y dietas exceptuadas de gravamen."
		,new String[] { 
			...
			"22", "23", "24", "27", "28", "29", "35", "36", "40", "41", "42", "44", "99"}
	)
	...
	private Mod1902024BizkaiaKey(String description, String[] subKeys) {
	...
	public static Mod1902024BizkaiaKey getDefaultKeyForProfessionalRetentions() {
		return Mod1902024BizkaiaKey.G;
	}
	public static String getDefaultSubkeyForProfessionalRetentions() {
		return Mod1902024BizkaiaKey.G.subKeys[0];
	}
	public static String getDefaultSubkeyForNewProfessionalRetentions() {
		return Mod1902024BizkaiaKey.G.subKeys[2];
	}
	public static Mod1902024BizkaiaKey getDefaultKeyForFarmerRetentions() {
		return Mod1902024BizkaiaKey.H;
	}
	public static String getDefaultSubkeyForFarmerRetentions() {
		return Mod1902024BizkaiaKey.H.subKeys[0];
	}
	public static Mod1902024BizkaiaKey getDefaultKeyForTransportRetentions() {
		return Mod1902024BizkaiaKey.H;
	}
	public static String getDefaultSubkeyForTransportRetentions() {
		return Mod1902024BizkaiaKey.H.subKeys[3];
	}
}
