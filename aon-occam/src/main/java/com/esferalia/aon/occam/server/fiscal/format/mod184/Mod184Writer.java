...
public class Mod184Writer {
	...
	private enum Mod184File2016 {
		...
		,TYPE_3 (new IPropertyFiller[] { 
		   ...
		   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.text(prt.getNature(),1))
		   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.text(prt.getLocation(),1))
		   ...
		   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.unsigned(prt.getAssetPercent(),5,4))
