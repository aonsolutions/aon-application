...
public class Mod202DAO extends FiscalModelDAO {
	...
	private static enum Mod202KeyInfoDAO {
	...
	private static enum Mod202KeyDAO {
		// *************************************************************************
		// **************************************************** COMMON TERRITORY ***
		// *************************************************************************
		 P00(Mod202Key.P00,(mod -> mod.isAEAT()),null,null,null)
		,P01(Mod202Key.P01,(mod -> mod.isAEAT()),null,null,null)
		,P02(Mod202Key.P02,(mod -> mod.isAEAT()),null,null,null)
		,P03(Mod202Key.P03,(mod -> mod.isAEAT())
				,(ctx,mod) -> mod.putDescription(Mod202Key.P03,Mod202DAO.getMainActivityCNAE( ctx, mod ))
				,null,null)
		,X01(Mod202Key.X01,(mod -> mod.isAEAT()),null,null,null)
		,X02(Mod202Key.X02,(mod -> mod.isAEAT()),null,null,null)
		,X03(Mod202Key.X03,(mod -> mod.isAEAT() && mod.getYear() < 2017),null,null,null)
		,X04(Mod202Key.X04,(mod -> mod.isAEAT()),null,null,null)
		,X05(Mod202Key.X05,(mod -> mod.isAEAT()),null,null,null)
		,X06(Mod202Key.X06,(mod -> mod.isAEAT()),null,null,null)
		,X07(Mod202Key.X07,(mod -> mod.isAEAT() && mod.getYear() < 2017),null,null,null)
		,X08(Mod202Key.X08,(mod -> mod.isAEAT()),null,null,null)
		,X09(Mod202Key.X09,(mod -> mod.isAEAT() && mod.getYear() < 2017),null,null,null)
		,X10(Mod202Key.X10,(mod -> mod.isAEAT()),null,null,null)
		,X11(Mod202Key.X11,(mod -> mod.isAEAT()),null,null,null)
		...
		,C02(Mod202Key.C02,(mod -> mod.isAEAT()),null,"isMethodA()?C02:0.0",null)
		,C03(Mod202Key.C03,(mod -> mod.isAEAT()),null,"isMethodA()?((C01-C02)*18/100):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es A) :</li>"
			+"<li>18% de @{C01} menos @{C02} igual <b>@{C03}</b></li>"
			)
		,C04(Mod202Key.C04,(mod -> mod.isAEAT())
			,(ctx,mod) -> mod.putAmount(Mod202Key.C04, getInitialC04(ctx,mod))
			,"isMethodB()?C04:0.0",null)
		,C05(Mod202Key.C05,(mod -> mod.isAEAT()),null,"isMethodB()?C05:0.0",null)
		,C06(Mod202Key.C06,(mod -> mod.isAEAT()),null,"isMethodB()?C06:0.0",null)
		,C36(Mod202Key.C36,(mod -> mod.isAEAT() && mod.getYear() < 2017),null,null,null)
		,C37(Mod202Key.C37,(mod -> mod.isAEAT()),null,"isMethodB()?C37:0.0",null)
		,C07(Mod202Key.C07,(mod -> mod.isAEAT()),null,"isMethodB()?C07:0.0",null)
		,C08(Mod202Key.C08,(mod -> mod.isAEAT()),null,"isMethodB()?C08:0.0",null)
		,C38(Mod202Key.C38,(mod -> mod.isAEAT()),null,"isMethodB()?(C05+C07):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.1) ó B.2) :</li>"
			+"<li>@{C05} m\u00E1s @{C07} igual <b>@{C38}</b></li>"
		)
		,C39(Mod202Key.C39,(mod -> mod.isAEAT()),null,"isMethodB()?(C06+C37+C08):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.1) ó B.2) :</li>"
		...
		,C13(Mod202Key.C13,(mod -> mod.isAEAT()),null,"isMethodB()?(C04+C38-C39):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.1) ó B.2) :</li>"
			+"<li>@{C04} m\u00E1s @{C38} menos @{C39} igual <b>@{C13}</b></li>"
		)
		,C44(Mod202Key.C44,(mod -> mod.isAEAT()),null,"isMethodB()?C44:0.0",null)
		,C14(Mod202Key.C14,(mod -> mod.isAEAT()),null,"isMethodB()?C14:0.0",null)
		,C45(Mod202Key.C45,(mod -> mod.isAEAT()),null,"isMethodB()?C45:0.0",null)
		,C46(Mod202Key.C46,(mod -> mod.isAEAT()),null,"isMethodB()?C46:0.0",null)
		,C16(Mod202Key.C16,(mod -> mod.isAEAT()),null,"isMethodB1()?((C13-C14+C45-C46)>0?(C13-C14+C45-C46):0.0):0.0"
		...
		,C47(Mod202Key.C47,(mod -> mod.isAEAT()),null,"isMethodB1()?C47:0.0",null)
		,C40(Mod202Key.C40,(mod -> mod.isAEAT()),null,"isMethodB1()?C40:0.0",null)
		,C48(Mod202Key.C48,(mod -> mod.isAEAT()),null,"isMethodB1()?C48:0.0",null)
		,C49(Mod202Key.C49,(mod -> mod.isAEAT()),null,"isMethodB1()?C49:0.0",null)
		,C18(Mod202Key.C18,(mod -> mod.isAEAT()),null,"isMethodB1()?((C16*C17/100)+C47-C40+C48-C49):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.1) :</li>"
			+"<li>(@{C16} por @{C17} / 100) m\u00E1s @{C47} menos @{C40} m\u00E1s @{C48} menos @{C49}, igual <b>@{C18}</b></li>"		
		)
		,C19(Mod202Key.C19,(mod -> mod.isAEAT()),null,"isMethodB2()?((C13-C44-C14+C45)>0?(C13-C44-C14+C45):0.0):0.0"
		...
		,C20(Mod202Key.C20,(mod -> mod.isAEAT()),null,"isMethodB2()?(C20):0.0",null)
		
		,C21(Mod202Key.C21,(mod -> mod.isAEAT()),null,"isMethodB2()?computeC21():0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"@if{X09 > 0 }"
		...
		,C22(Mod202Key.C22,(mod -> mod.isAEAT()),null,"isMethodB2()?(C20*C21/100):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"<li>@{C20} por @{C21} partido 100 igual <b>@{C22}</b></li>"
		)
		,C23(Mod202Key.C23,(mod -> mod.isAEAT()),null,"isMethodB2()?(C19-C20):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"<li>@{C19} menos @{C20} igual <b>@{C23}</b></li>"
		)
		,C24(Mod202Key.C24,(mod -> mod.isAEAT()),null,"isMethodB2()?computeC24():0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"@if{X09 > 0 }"
		...
		,C25(Mod202Key.C25,(mod -> mod.isAEAT()),null,"isMethodB2()?(C23*C24/100):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"<li>@{C23} por @{C24} partido 100 igual <b>@{C25}</b></li>"
		)
		,C50(Mod202Key.C50,(mod -> mod.isAEAT()),null,"isMethodB2()?C50:0.0",null)
		,C42(Mod202Key.C42,(mod -> mod.isAEAT()),null,"isMethodB2()?C42:0.0",null)
		,C51(Mod202Key.C51,(mod -> mod.isAEAT()),null,"isMethodB2()?C51:0.0",null)
		,C52(Mod202Key.C52,(mod -> mod.isAEAT()),null,"isMethodB2()?C52:0.0",null)
		,C26(Mod202Key.C26,(mod -> mod.isAEAT()),null,"isMethodB2()?(C22+C25+C50-C42+C51-C52):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.2) :</li>"
			+"<li>@{C22} m\u00E1s @{C25} m\u00E1s @{C50} menos @{C42} m\u00E1s @{C51} menos @{C52} igual <b>@{C26}</b></li>"
		)
		,C27(Mod202Key.C27,(mod -> mod.isAEAT()),null,"isMethodB()?C27:0.0",null)
		,C28(Mod202Key.C28,(mod -> mod.isAEAT()),null,"isMethodB()?C28:0.0",null)
		,C29(Mod202Key.C29,(mod -> mod.isAEAT()),null,"isMethodB()?C29:0.0",null)
		,C30(Mod202Key.C30,(mod -> mod.isAEAT()),null,"isMethodB()?C30:0.0",null)
		,C31(Mod202Key.C31,(mod -> mod.isAEAT()),null,"isMethodB()?C31:0.0",null)
		,C32(Mod202Key.C32,(mod -> mod.isAEAT()),null,"(((isMethodB1()?C18:(isMethodB2()?C26:0.0))-C27-C28)*C29/100)-C30-C31"
			,"@if{X00 == 0 }"
			+	"<li>Si la modalidad de c\u00E1lculo es A) :</li>"
			+	"<li>Cero,<b>@{C32}</b></li>"
			+"@elseif{X00 == 1 }"
		...
		,C33(Mod202Key.C33,(mod -> mod.isAEAT()),null,"isMethodB()?C33:0.0",null)
		,C34(Mod202Key.C34,(mod -> mod.isAEAT()),null,"isMethodB()?(C32>C33?C32:C33):0.0"
			,"<li>Si la modalidad de c\u00E1lculo es B.1) o B.2) :</li>"
			+"<li>La cantidad mayor entre [032] y  [033], igual <b>@{C34}</b></li>"
		)
		,A01(Mod202Key.A01,(mod -> mod.isAEAT()),null,null,null)
		,A02(Mod202Key.A02,(mod -> mod.isAEAT()),null,null,null)
		,A03(Mod202Key.A03,(mod -> mod.isAEAT()),null,null,null)
		,A04(Mod202Key.A04,(mod -> mod.isAEAT()),null,null,null)
		,A05(Mod202Key.A05,(mod -> mod.isAEAT()),null,null,null)
		,A06(Mod202Key.A06,(mod -> mod.isAEAT()),null,null,null)
		,A07(Mod202Key.A07,(mod -> mod.isAEAT()),null,null,null)
		,A08(Mod202Key.A08,(mod -> mod.isAEAT()),null,null,null)
		,A09(Mod202Key.A09,(mod -> mod.isAEAT()),null,null,null)
		,A10(Mod202Key.A10,(mod -> mod.isAEAT()),null,null,null)
		,A11(Mod202Key.A11,(mod -> mod.isAEAT()),null,null,null)
		,A12(Mod202Key.A12,(mod -> mod.isAEAT()),null,null,null)
		;
		...
		if (x00 == 0) {
			if (mod.getYear() == 2017) {
				if (mod.getPeriod() == Period.T1) {
					Mod2002015 soci2015 = Mod2002015DAO.getByYear(ctx, 2015);
					if (soci2015 != null) {
						return soci2015.getVariable(Mod2002015Key.BN599).getValue();
					}
				} else {
					Mod2002016 soci2016 = Mod2002016DAO.getByYear(ctx, 2016);
					if (soci2016 != null) {
						return soci2016.getVariable(Mod2002016Key.BN599).getValue();
					}
				}
				...
				if (mod.getPeriod() == Period.T1) {
					...
					Mod2002017 soci2017 = Mod2002017DAO.getByYear(ctx, 2017);
					if (soci2017 != null) {
						return soci2017.getVariable(Mod2002017Key.BN599).getValue();
					}						
				}
				...
				if (mod.getPeriod() == Period.T1) {
					...
					// SOCIEDADES 2018
					Mod2002018 soci2018 = Mod2002018DAO.getByYear(ctx, 2018);
					if (soci2018 != null) {
						return soci2018.getVariable(Mod2002018Key.BN599).getValue();
					}						
				}
...
//					// SOCIEDADES 2020
					Mod2002020 soci2020 = Mod2002020DAO.getByYear(ctx, 2020);
					if (soci2020 != null) {
	...
	public static Mod202 calculateMod202(AONContext ctx, Mod202 mod202) {
		return  mod202.getYear()<2016
					...
					:(mod202.getYear()==2016 && mod202.getPeriod() == Period.T1) 
						...
						:Aeat20162Mod202Calculator.calculate(ctx, mod202);
	}
*/
