...
public enum Model3032017GIPUZKOAPrintScript implements IModelScript<Mod303Key> {
	...
	private Model3032017GIPUZKOAPrintScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
