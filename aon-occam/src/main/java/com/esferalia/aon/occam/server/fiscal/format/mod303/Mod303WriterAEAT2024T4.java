...
class Mod303WriterAEAT2024T4 implements IMod303Writer{
	...
	private enum Mod303File {
		...
		,T30301000 (mod303 -> true ,new IPropertyFiller[] {
		   ...
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C165),17,2))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C166), 5,2))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C167),17,2))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C168),17,2))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C169), 5,2))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_C170),17,2))
		   
		   ,(wr, mod) -> wr.append(AonStringUtils.repeat(' ', 522))
...
// ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(!mod.isLastPeriod()?0.0:mod.getAmount(Mod303Key.CT_S1Y2) ,3,0))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(0.0,2,0))
		   // DANA
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S1X6),1,0))
...
//		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(!mod.isLastPeriod()?0.0:mod.getAmount(Mod303Key.CT_S2Y2) ,3,0))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(0.0,2,0))
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S2X6) ,1,0))  // DANA
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S2X4) ,1,0))  // Lorca
		   ...
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA1X), 1,0)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 1 - Si en el ejercicio realiza la actividad en municipios afectados por la DANA (ver anexo del RD-ley 6/2024), seleccione lo que proceda
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA1R),17,2)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 1 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA2X), 1,0)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 2 - Si en el ejercicio realiza la actividad en municipios afectados por la DANA (ver anexo del RD-ley 6/2024), seleccione lo que proceda
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA2R),17,2)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 2 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S1R1),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 1 - Reducción por actividad realizada en el municipio de Lorca
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S1R2),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 1 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S2R1),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 2 - Reducción por actividad realizada en el municipio de Lorca
		   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S2R2),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 2 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
		   
		   ,(wr, mod) -> wr.append(AonStringUtils.repeat(' ', 160))
		   ,(wr, mod) -> wr.append("</T30302000>")
		})
		...
		,T30302002 (mod303 -> mod303.getAmount(Mod303Key.CT_A02) < 2
               ...
               // AQUI ESTO NO VA EN LAS COMPLEMENTARIAS
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(  mod.getAmount(Mod303Key.CT_S47)  ,17,2))
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod303Key.CT_S48)  ,17,2))
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(  mod.getAmount(Mod303Key.CT_S49)  ,17,2))
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod303Key.CT_S50)  ,17,2))
...
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod303Key.CT_S57)  ,17,2))
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.signedZero(mod.getAmount(Mod303Key.CT_S58)  ,17,2))
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.zeros(17))
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.zeros(17))
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.zeros(17))
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.zeros(17))
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.zeros(17))
...
//			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(!mod.isLastPeriod()?0.0:mod.getAmount(Mod303Key.CT_S3Y2) ,3,0))
			   ,(wr, mod) -> wr.append("00")
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S3X6) ,1,0))  // DANA
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S3X4) ,1,0))  // Lorca
			  ...
			  // ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(!mod.isLastPeriod()?0.0:mod.getAmount(Mod303Key.CT_S4Y2) ,3,0))
			   ,(wr, mod) -> wr.append("00")
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S4X6) ,1,0))  // DANA
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S4X4) ,1,0))  // Lorca
			   ...
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA3X), 1,0)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 1 - Si en el ejercicio realiza la actividad en municipios afectados por la DANA (ver anexo del RD-ley 6/2024), seleccione lo que proceda
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA3R),17,2)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 1 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA4X), 1,0)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 2 - Si en el ejercicio realiza la actividad en municipios afectados por la DANA (ver anexo del RD-ley 6/2024), seleccione lo que proceda
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_SA4R),17,2)) // Liquidación (3) - RS - (A) Actividades agrícolas, ganaderas y forestales - Actividad 2 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S3R1),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 1 - Reducción por actividad realizada en el municipio de Lorca
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S3R2),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 1 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S4R1),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 2 - Reducción por actividad realizada en el municipio de Lorca
			   ,(wr, mod) -> wr.append(AonFiscalFileUtils.unsigned(mod.getAmount(Mod303Key.CT_S4R2),17,2)) // Liquidación (3) - RS - (B) Actividades en RS (exc. a, g y f) - Actividad 2 - Reducción por actividad realizada en municipios afectados por la DANA (ver anexo del RD-ley 6/2024)
