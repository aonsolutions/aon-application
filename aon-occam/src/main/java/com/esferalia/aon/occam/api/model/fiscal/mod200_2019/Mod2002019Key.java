...
//                                                                                      //
// IMPORTANTE:                                                                          //   
// Además de este enumerado, tambien existe el enumerado Mod2002019KeyDC que lleva      //
...
public enum Mod2002019Key implements IMod200Key {
	
	// CODIGO ESPECIALES	
     X0000 // Tipo de ejercicio
    
    ,X0001  // Declaración correspondiente al Art. 124.1 LIS sin aprobar cuentas anuales (0,1)
    ,X0002  // Nueva declaración según RDLey 19/2020 (0,1)
	...
	// Desglose - Régimen especial de la reserva para inversiones en Canarias (Ley 19/1994)
		,RC089		,RC094		,RC095
		,RC097		,RC098		,RC047		,RC048
		,RC524		,RC525		,RC526		,RC527
		,RC922		,RC923		,RC924		,RC925
		,RC927		,RC928		,RC938		,RC996
					,RC020		,RC021
	...
	// SE PONEN EN OTRO ENUMERADO (Mod2002019KeyDC) PORQUE SI LOS AÑADIMOS AQUI TENEMOS ERROR DE CODE TOO LARGE
	...
	,LQ1033
	,LQ1034
		,LQ1141		,LQ1142		,LQ1143
		,LQ1144		,LQ1145		,LQ1146
		,LQ1455		,LQ1456		,LQ1457
		,LQ1961		,LQ1962		,LQ1963
		,LQ2238		,LQ2239		,LQ2240
					,LQ1730		,LQ1731
		,LQ1147  				,LQ1149
		
		,LQ1150		,LQ1151		,LQ1152		,LQ1153
	...
	,BN588 // Deducciones con límite del Capítulo IV Título VI y DT 24.3 LIS		
		...
		,BN1081	,BN1082	,BN1083
		,BN1087	,BN1088	,BN1089		
		,BN1372	,BN1373	,BN1374
		,BN1375	,BN1376	,BN1377				
		,BN1417	,BN1418	,BN1419		
		,BN1623	,BN1624	,BN1625
		,BN1626	,BN1627	,BN1628
		,BN1629	,BN1630	,BN1631
		,BN1632	,BN1633	,BN1634
		,BN1635	,BN1636	,BN1637
		,BN1638	,BN1639	,BN1640
		,BN1641	,BN1642	,BN1643
		,BN1644	,BN1645	,BN1646
		,BN1647	,BN1648	,BN1649
		,BN1650	,BN1651	,BN1652		
		,BN1659	,BN1660	,BN1661		
		,BN1665	,BN1666	,BN1667		
		,BN1671	,BN1672	,BN1673
		,BN1674	,BN1675	,BN1676
		,BN1677	,BN1678	,BN1679
		,BN1689	,BN1690	,BN1691		
		,BN1695	,BN1696	,BN1697
		,BN1698	,BN1699	,BN1700
		,BN1707	,BN1708	,BN1709
		,BN1800	,BN1801	,BN1802
		,BN1856	,BN1857	,BN1858
		,BN1859	,BN1860	,BN1861
		,BN1862	,BN1863	,BN1864
		,BN1865	,BN1866	,BN1867
		,BN1868	,BN1869	,BN1870
		,BN1874	,BN1875	,BN1876
		,BN1877	,BN1878	,BN1879
		,BN1880	,BN1881	,BN1882
		,BN1883	,BN1884	,BN1885
		,BN1886	,BN1887	,BN1888
		...
		,BN1937	,BN1938	,BN1939
		,BN1940	,BN1941	,BN1942
		,BN1943	,BN1944	,BN1945
	...
	,BN565 // Deducción donaciones a entidades sin fines de lucro (Ley 49/2002)		
		...
		,BN598	        ,BN895	
		,BN974
		,BN565A  // Deducción donativos entidades sin fines de lucro. Ley 49/2002. Indique si entre las deducciones que se van a aplicar hay actividades prioritarias de mecenazgo 
		,BN565B  // Deducción donativos entidades sin fines de lucro. Ley 49/2002. Indique si en los dos períodos impositivos inmediatos anteriores hubieran realizado donaciones o aportaciones con derecho a deducción a favor de una misma entidad por importe igual o superior en cada uno de ellos, al del período impositivo anterior
	...
	,DC2301 ,DC2302
	,DC2303 ,DC2304 ,DC2305  ,DC2306
	,DC2307 ,DC2308 ,DC2309  ,DC2310
	,I0417B, D0418B ,DC2295  ,DC2296
   ...
   // vinculados con el contribuyente y otras del art. 11.12 LIS con posibilidad de conversión en crédito exigible
	...
	,NUMPER	,LM1515	,LM1516	,LM1585	,LM1517
	...
	,LM2268	,LM2269	,LM2270	,LM2271	,LM2272			,LM2273	,LM2274	,LM2275	,LM2276
	...
	,LM1575	,LM1576	,LM1577
	,LM1763	,LM1764	,LM1765	,LM1766
	,LM2109	,LM2110	,LM2111	,LM2112
