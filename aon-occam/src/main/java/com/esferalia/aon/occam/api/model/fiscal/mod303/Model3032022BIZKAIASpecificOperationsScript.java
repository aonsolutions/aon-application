...
public enum Model3032022BIZKAIASpecificOperationsScript implements IModelScript<Mod303Key> {
	...
	,ADC01 ("Importes de las entregas de bienes y prestaciones de servicios a las que habi\u00E9ndoles sido aplicado el r\u00E9gimen "+ 
			...
			"en el art\u00EDculo 75 NFIVA"		,new Mod303Key[]{Mod303Key.BZ_C200,Mod303Key.BZ_C201},MODEL_OUT_VAT_ACCRUAL_INVOICE)	
	,ADC02 ("Importes de las adquisiciones de bienes y servicios a las que sea aplicable o afecte el r\u00E9gimen "+
			"especial del criterio de caja"		,new Mod303Key[]{Mod303Key.BZ_C202,Mod303Key.BZ_C203},MODEL_IN_VAT_ACCRUAL_INVOICE)
	,OPE00 ("Operaciones espec\u00EDficas",null,TITLE)
	,OPE01 (Mod303Key.BZ_C104.getDescription()	,new Mod303Key[]{null,Mod303Key.BZ_C104},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},MODEL_INVOICE_VAT_BREAKDOWN)
	,OPE02 (Mod303Key.BZ_C105.getDescription()	,new Mod303Key[]{null,Mod303Key.BZ_C105},new KeyTypes[]{KeyTypes.NONE,KeyTypes.BASE},MODEL_INVOICE_VAT_BREAKDOWN)
	...
	private Model3032022BIZKAIASpecificOperationsScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this(label,keys,null,infoKeys);	
	}
	
	private Model3032022BIZKAIASpecificOperationsScript(String label, Mod303Key[] keys, KeyTypes[] keyTypes,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
