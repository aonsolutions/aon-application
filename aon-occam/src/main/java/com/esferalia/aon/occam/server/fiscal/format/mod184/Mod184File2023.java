...
enum Mod184File2023 {
	...
	,TYPE_3 (new IPropertyFiller[] { 
	   ...
	   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.unsigned(prt.getAssetDays(),3))
	   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.unsigned(prt.getRendNetoPrevio(),13,2))
	   ,(wr, mod184,prt,inc) -> wr.append(AonFiscalFileUtils.signedSpace(prt.getRendNetoMinorado(),14,2))
	   
	   ,(wr, mod184,prt,inc) -> wr.append(AonStringUtils.repeat(' ', 271))
	   ,(wr, mod184,prt,inc) -> wr.append("\r\n")
			})
	;
	...
	private Mod184File2023(IPropertyFiller[] pf) {
