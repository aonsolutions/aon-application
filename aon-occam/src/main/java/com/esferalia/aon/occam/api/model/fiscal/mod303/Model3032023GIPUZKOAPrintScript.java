...
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_C055;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_X055;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_C056;
...
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_C057;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_X057;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_Q057;
...
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_C058;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_X058;
import static com.esferalia.aon.occam.api.model.type.Mod303Key.GP_C059;
...
public enum Model3032023GIPUZKOAPrintScript implements IModelScript<Mod303Key> {

	 DVG01 ("IVA devengado",null,TITLE)
	,DVG02 (getDescription(GP_C004)		,new Mod303Key[]{GP_C002	,GP_X002	,GP_C003})
	,DVG03 (getDescription(GP_C004)		,new Mod303Key[]{GP_C004	,GP_X004	,GP_C005})
	,DVG04 (getDescription(GP_C055)		,new Mod303Key[]{GP_C055	,GP_X055	,GP_C056})
	,DVG05 (getDescription(GP_C004)		,new Mod303Key[]{GP_C006	,GP_X006	,GP_C007})
	,DVG06 (getDescription(GP_C004)		,new Mod303Key[]{GP_C057	,GP_X057	,GP_Q057})
	
	,DVG07 (getDescription(GP_C039)		,new Mod303Key[]{GP_C039	,null		,GP_C040})
	
	,DVG08 (getDescription(GP_C010)		,new Mod303Key[]{GP_C008	,GP_X008	,GP_C009})
	,DVG09 (getDescription(GP_C010)		,new Mod303Key[]{GP_C058	,GP_X058	,GP_C059})
	,DVG10 (getDescription(GP_C010)		,new Mod303Key[]{GP_C010	,GP_X010	,GP_C011})
	,DVG11 (getDescription(GP_C010)		,new Mod303Key[]{GP_C012	,GP_X012	,GP_C013})
	
	,DVG12 (getDescription(GP_C041)		,new Mod303Key[]{GP_C041	,null		,GP_C042})
	,DVG13 (getDescription(GP_C014)		,new Mod303Key[]{GP_C014	,null		,GP_C015})
	,DVG14 (getDescription(GP_C043)		,new Mod303Key[]{GP_C043	,null		,GP_C044})
	,DVG15 (GP_C016.getDescription()	,new Mod303Key[]{null		,null	  	,GP_C016})
	,EMPTY0(null						,null)
	...
	private Model3032023GIPUZKOAPrintScript(String label, Mod303Key[] keys,FiscalModelKeyInfo ... infoKeys) {
		this.label = label;
		this.keys = keys;
