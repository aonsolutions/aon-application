...
public enum Mod303Key implements IFiscalModelKey  {
	...
	,NF_194("303-NF194",false,"194","Operaciones acogidas al criterio de caja")
	,NF_171("303-NF171",false,"171","Otras operaciones")
	
	,NF_003("303-NF003",false,"003","Operaciones al tipo general. Base.")
	,NF_X03("303-NFX03",false,null,"Operaciones al tipo general. %.")
	,NF_013("303-NF013",false,"013","Operaciones al tipo general. Cuota")
	,NF_004("303-NF004",false,"004","Operaciones al tipo reducido. Base.")
	,NF_X04("303-NFX04",false,null,"Operaciones al tipo reducido. %.")
	,NF_014("303-NF014",false,"014","Operaciones al tipo reducido. Cuota")
	,NF_005("303-NF005",false,"005","Operaciones al tipo superreducido. Base.")
	,NF_X05("303-NFX05",false,null,"Operaciones al tipo superreducido. %.")
	,NF_015("303-NF015",false,"015","Operaciones al tipo superreducido. Cuota")
	
	,NF_006("303-NF006",false,"006","Recargo de equivalencia. Base.")
	,NF_X06("303-NFX06",false,null,"Recargo de equivalencia. %.")
	,NF_016("303-NF016",false,"016","Recargo de equivalencia. Cuota")
	,NF_051("303-NF051",false,"051",NF_006.getDescription())
	,NF_X51("303-NFX51",false,null,NF_X06.getDescription())
	,NF_052("303-NF052",false,"052",NF_016.getDescription())
	,NF_007("303-NF007",false,"007",NF_006.getDescription())
	,NF_X07("303-NFX07",false,null,NF_X06.getDescription())
	,NF_017("303-NF017",false,"017",NF_016.getDescription())
	,NF_008("303-NF008",false,"008",NF_006.getDescription())
	,NF_X08("303-NFX08",false,null,NF_X06.getDescription())
	,NF_018("303-NF018",false,"018",NF_016.getDescription())
	
	,NF_009("303-NF009",false,"009",CT_C10.getDescription())
	,NF_019("303-NF019",false,"019",CT_C11.getDescription())
	,NF_172("303-NF172",false,"172","Operaciones con inversi\u00F3n de sujeto pasivo - Base imponible")
	,NF_173("303-NF173",false,"173","Operaciones con inversi\u00F3n de sujeto pasivo - Cuota")
	,NF_176("303-NF176",false,"176","Modificaci\u00F3n de bases y cuotas - Base imponible")
	,NF_177("303-NF177",false,"177","Modificaci\u00F3n de bases y cuotas - Cuota")
	
	,NF_020("303-NF020",false,"020","Total IVA devengado")
	
	,NF_031("303-NF031",false,"031","Por cuotas soportadas en operaciones interiores corrientes. Base imponible.")
	,NF_041("303-NF041",false,"041","Por cuotas soportadas en operaciones interiores corrientes. Cuota.")
	,NF_131("303-NF131",false,"131","Por cuotas soportadas en operaciones de bienes de inversi\u00F3n. Base imponible.")
	,NF_141("303-NF141",false,"141","Por cuotas soportadas en operaciones de bienes de inversi\u00F3n. Cuota.")
	,NF_032("303-NF032",false,"032","Por cuotas soportadas en importaciones. Base imponible.")
	,NF_042("303-NF042",false,"042","Por cuotas soportadas en importaciones. Cuota.")
	,NF_039("303-NF039",false,"039","Adquisiciones instracomunitarias de bienes y servicios. Base")
	,NF_049("303-NF049",false,"049","Adquisiciones instracomunitarias de bienes y servicios. Cuota")
	,NF_170("303-NF170",false,"170","Compensaciones R\u00E9gimen Especial Agricultura, Ganader\u00EDa y  Pesca. Base imponible.")
	,NF_043("303-NF043",false,"043","Compensaciones R\u00E9gimen Especial Agricultura, Ganader\u00EDa y  Pesca. Cuota.")
	,NF_174("303-NF174",false,"174",NF_172.getDescription())
	,NF_175("303-NF175",false,"175",NF_173.getDescription())
	,NF_178("303-NF178",false,"178",NF_176.getDescription())
	,NF_179("303-NF179",false,"179",NF_177.getDescription())
	,NF_045("303-NF045",false,"045","Regularizaci\u00F3n de inversiones")
