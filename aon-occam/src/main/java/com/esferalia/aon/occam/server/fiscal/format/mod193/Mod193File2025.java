...
enum Mod193File2025 {
	...
	,TYPE_2 (new IPropertyFiller[] { 
	   ...
	   ,(wr, mod193,detail) -> wr.append(AonFiscalFileUtils.text(detail.getIsin(),12)) // Código ISIN
	   ,(wr, mod193,detail) -> wr.append(AonStringUtils.repeat(' ', 3)) // Blancos
	...
	private Mod193File2025(IPropertyFiller[] pf) {
	...
	static void fill(Mod193 mod193, Writer wr) throws IOException {
		orderNumber = 0;
		Mod193File2025.TYPE_1.fillPage(mod193, null, wr);
		for (Mod193Detail detail : mod193.getDetails()) {
			Mod193File2025.TYPE_2.fillPage(mod193, detail, wr);	
		}
	}
}
