...
public enum Mod3902022DetailKey implements Serializable {
	// IVA devengado
 	// Régimen ordinario
	...
	private Mod3902022DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly) {
		this(box, percent, taxableBaseAvailable, readonly, false);	
	}
	
	private Mod3902022DetailKey(int box, Double percent, boolean taxableBaseAvailable, boolean readonly, boolean prorrata) {
