...
//"Procesos de transformación, elaboración o manufactura de productos naturales, vegetales o animales, que requieran el alta en un epígrafe correspondiente a actividades industriales en las Tarifas del Impuesto sobre Actividades Económicas y  se realicen por los titulares de las explotaciones de las cuales se obtengan directamente dichos productos naturales."
	...
	public enum Epigraph implements Serializable {
		  E____("---","Producci\u00F3n de mejill\u00F3n en batea"
				...
				,40000.00
				,new Module[] {
					 new Module(1, FiscalActivityInfoKey.M01, "Persona", 5500.00)
		 ...
		 ,E_419_1 ("419.1","Industrias del pan y de la boller\u00EDa."
				...
				,41602.30
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",6248.22)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",1693.54)
		...
		,E_419_2 ("419.2","Industrias de la boller\u00EDa, pasteler\u00EDa y galletas."
				...
				,33760.53
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",6657.63)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",3064.67)
		...
		,E_423_9 ("423.9","Elaboraci\u00F3n de patatas fritas, palomitas de ma\u00EDz y similares."
				...
				,19670.55
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4390.12)
		...
		,E_641 ("641","Comercio al por menor de frutas, verduras, hortalizas y tub\u00E9rculos."
				...
				,16867.67
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2387.18)
		...
		,E_642_1 ("642.1","Comercio al por menor de carne y despojos; de productos y derivados c\u00E1rnicos elaborados.."
				...
				,21635.71
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2355.68)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",1753.76)
		...
		,E_642_5 ("642.5","Comercio al por menor de huevos, aves, conejos de granja, caza; y de productos derivados de los mismos"
				...
				,20136.65
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3382.36)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",673.16)
		...
		,E_642_6 ("642.6","Comercio al por menor, en casquer\u00EDas, de v\u00EDsceras y despojos procedentes de animales de abasto, frescos y congelados."
				...
				,16237.81
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2254.90)
		...
		,E_643_1 ("643.1","Comercio al por menor de pescados y otros productos de la pesca y de la acuicultura y de caracoles."
				...
				,24551.97
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3823.25)
		...
		,E_644_1 ("644.1","Comercio al por menor de pan, pasteler\u00EDa, confiter\u00EDa y similares y de leche y productos l\u00E1cteos."
				...
				,43605.26
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M15,"Persona",6248.22)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2090.35)
					,new Module(2,FiscalActivityInfoKey.M09,"Metro cua.",8.86)
		...
		,E_644_2 ("644.2","Despachos de pan, panes especiales y boller\u00EDa."
				...
				,42925.01
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M15,"Persona",6134.85)
		...
		,E_644_3 ("644.3","Comercio al por menor de productos de pasteler\u00EDa, boller\u00EDa y confiter\u00EDa."
				...
				,33760.53
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M15,"Persona",6367.89)
		...
		,E_644_6 ("644.6","Comercio al por menor de masas fritas, con o sin coberturas o rellenos, patatas fritas, productos de aperitivo, frutos secos, golosinas, preparados de chocolate y bebidas refrescantes."
				...
				,19670.55
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M15,"Persona",6852.88)
		...
		,E_647_1 ("647.1","Comercio al por menor de cualquier clase de productos alimenticios y de bebidas en establecimientos con vendedor."
				...
				,15822.10
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1026.67)
				...
				,new Module[]{
						new Module(1,FiscalActivityInfoKey.M58,"Euro",0.21)}
				)
		,E_647_2 ("647.2","Comercio al por menor de cualquier clase de productos alimenticios y bebidas en régimen de autoservicio o mixto en establecimientos cuya sala de ventas tenga una superficie inferior a 400 metros cuadrados."
				...
				,25219.62
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1788.80)
		...
		,E_651_1 ("651.1","Comercio al por menor de productos textiles, confecciones para el hogar, alfombras y similares y art\u00EDculos de tapicer\u00EDa."
				...
				,23638.67
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Personas",3010.74)
		...
		,E_651_2 ("651.2","Comercio al por menor de toda clase de prendas para el vestido y tocado."
				...
				,24848.00
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2569.83)
		...
		,E_651_3 ("651.3","Comercio al por menor de lencer\u00EDa, corseter\u00EDa y prendas especiales."
				...
				,19626.46
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2198.21)
		...
		,E_651_4 ("651.4","Comercio al por menor de art\u00EDculos de mercer\u00EDa y paqueter\u00EDa."
				...
				,14862.05
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1902.18)
		...
		,E_651_6 ("651.6","Comercio al por menor de calzado, art\u00EDculos de piel e imitaci\u00F3n o productos sustitutivos, cinturones, carteras, bolsos, maletas y art\u00EDculos de viaje en general."
				...
				,24306.32
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3130.41)
		...
		,E_652_2 ("652.2","Comercio al por menor de productos de droguería, perfumería y cosmética, limpieza, pinturas, barnices, disolventes, papeles y otros productos para la decoración y de productos químicos, y de artículos para la higiene y el aseo personal."
				...
				,25333.00
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Personas",3722.48)
		...
		,E_653_1 ("653.1","Comercio al por menor de muebles."
				...
				,30718.31
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4075.20)
		...
		,E_653_2 ("653.2","Comercio al por menor de material y aparatos el\u00E9ctricos, electr\u00F3nicos, electrodom\u00E9sticos y otros aparatos de uso dom\u00E9stico accionados por otro tipo de energ\u00EDa distinta de la el\u00E9ctrica, as\u00ED como muebles de cocina"
				...
				,26189.61
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2884.77)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M27,"Persona",5819.91)
		...
		,E_653_3 ("653.3","Comercio al por menor de art\u00EDculos de menaje, ferreter\u00EDa, adorno, regalo, o reclamo (incluyendo bisuter\u00EDa y peque\u00F1os electrodom\u00E9sticos)."
				...
				,24470.09
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Personas",3709.88)
		...
		,E_653_4 ("653.4","Comercio al por menor de materiales de construcci\u00F3n, art\u00EDculos y mobiliario de saneamiento, puertas, ventanas, persianas, etc."
				...
				,26454.15
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3061.12)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",12317.71)
		...
		,E_653_9 ("653.9","Comercio al por menor de otros art\u00EDculos para el equipamiento del hogar n.c.o.p."
				...
				,32765.35
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4950.71)
		...
		,E_654_2 ("654.2","Comercio al por menor de accesorios y piezas de recambio para veh\u00EDculos terrestres."
				...
				,32815.74
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3098.92)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",15558.35)
		...
		,E_654_5 ("654.5","Comercio al por menor de toda clase de maquinaria (excepto aparatos del hogar, de oficina, m\u00E9dicos, ortop\u00E9dicos, \u00F3pticos y fotogr\u00E1ficos)."
				...
				,31367.06
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",9422.71)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",18021.89)
		...
		,E_654_6 ("654.6","Comercio al por menor de cubiertas, bandas o bandajes y c\u00E1maras de aire para toda clase de veh\u00EDculos, excepto las actividades de comercio al por mayor de los art\u00EDculos citados."
				...
				,26970.63
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2746.19)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",14152.98)
		...
		,E_659_2 ("659.2","Comercio al por menor de muebles de oficina y de m\u00E1quinas y equipos de oficina."
				...
				,30718.31
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4157.08)
		...
		,E_659_3 ("659.3","Comercio al por menor de aparatos e instrumentos médicos, ortopédicos, ópticos y fotográficos."
				...
				,35524.14
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",7174.12)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",19273.74)
					,new Module(3,FiscalActivityInfoKey.M03,"100 Kwh",119.67)
					,new Module(4,FiscalActivityInfoKey.M24,"CVF",1070.76)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M62,"Persona",14533.25)
		...
		,E_659_4A("659.4","Comercio al por menor de libros, peri\u00F3dicos, art\u00EDculos de papeler\u00EDa y escritorio y art\u00EDculos de dibujo y bellas artes, excepto en quioscos situados en la v\u00EDa p\u00FAblica."
				...
				,25207.02
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4648.37)
		...
		,E_659_4B("659.4","Comercio al por menor de prensa, revistas y libros en quioscos situados en la v\u00EDa p\u00FAblica."
				...
				,28860.22
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3476.83)
		...
		,E_659_6 ("659.6","Comercio al por menor de juguetes, art\u00EDculos de deporte, prendas deportivas de vestido, calzado y tocado, armas, cartucher\u00EDa y art\u00EDculos de pirotecnia."
				...
				,24948.78
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2916.26)
		...
		,E_659_7 ("659.7","Comercio al por menor de semillas, abonos, flores y plantas y peque\u00F1os animales."
				...
				,23978.80
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4988.50)
		...
		,E_662_2 ("662.2","Comercio al por menor de toda clase de artículos, incluyendo alimentación y bebidas, en establecimientos distintos de los especificados en el grupo 661 y en el epígrafe 662.1."
				...
				,16395.27
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4868.82)
		...
		,E_663_1 ("663.1","Comercio al por menor fuera de un establecimiento comercial permanente de productos alimenticios, incluso bebidas y helados."
				...
				,14379.72
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1398.29)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",13989.21)
					,new Module(3,FiscalActivityInfoKey.M24,"CVF",113.37)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",5881.32)
		...
		,E_663_2 ("663.2","Comercio al por menor fuera de un establecimiento comercial permanente de art\u00EDculos textiles y de confecci\u00F3n."
				...
				,19059.58
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2991.84)
		...
		,E_663_3 ("663.3","Comercio al por menor fuera de un establecimiento comercial permanente de calzado, pieles y art\u00EDculos de cuero."
				...
				,17081.82
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2613.92)
		...
		,E_663_4 ("663.4","Comercio al por menor fuera de un establecimiento comercial permanente de art\u00EDculos de droguer\u00EDa y cosm\u00E9ticos y de productos qu\u00EDmicos en general."
				...
				,16886.56
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3678.39)
		...
		,E_663_9 ("663.9","Comercio al por menor fuera de un establecimiento comercial permanente de otras clases de mercanc\u00EDas n.c.o.p."
				...
				,18354.14
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",5448.29)
		...
		,E_671_4 ("671.4","Restaurantes de dos tenedores."
				...
				,51617.08
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3709.88)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2993.81)
		...
		,E_671_5 ("671.5","Restaurantes de un tenedor."
				...
				,38081.38
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3602.80)
					...
					,new Module(6,FiscalActivityInfoKey.M07,"Maquina B",3810.65)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2400.36)
		...
		,E_672_1 ("672.1","Cafeter\u00EDas."
				...
				,39070.26
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1448.68)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2356.07)
		...
		,E_673_1 ("673.1","Caf\u00E9s y bares de categor\u00EDa especial."
				...
				,30586.03
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4056.30)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",3294.97)
		...
		,E_673_2 ("673.2","Otros caf\u00E9s y bares."
				...
				,19084.78
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1643.93)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2577.52)
		...
		,E_675   ("675"	 ,"Servicios en quioscos, cajones, barracas u otros locales an\u00E1logos."
				...
				,16596.83
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2802.88)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",4357.86)
		...
		,E_676   ("676"	 ,"Servicios en chocolater\u00EDas, helader\u00EDas y horchater\u00EDas."
				...
				,25528.25
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2418.67)
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",3817.55)
		...
		,E_681   ("681"	 ,"Servicio de hospedaje en hoteles y moteles de una o dos estrellas."
				...
				,61512.19
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",6223.02)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",20438.98)
					,new Module(3,FiscalActivityInfoKey.M20,"Plaza",371.62)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2604.09)
		...
		,E_682   ("682"	 ,"Servicio de hospedaje en hostales y pensiones."
				...
				,32840.94
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",5145.96)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",17541.62)
					,new Module(3,FiscalActivityInfoKey.M20,"Plaza",270.85)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2533.22)
		...
		,E_683   ("683"	 ,"Servicio de hospedaje en fondas y casas de hu\u00E9spedes."
				...
				,16256.70
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4478.31)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",14587.57)
					,new Module(3,FiscalActivityInfoKey.M20,"Plaza",132.27)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",1762.62)
		...
		,E_691_1 ("691.1","Reparaci\u00F3n de art\u00EDculos el\u00E9ctricos para el hogar."
				...
				,21585.33
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4314.54)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",15538.66)
					,new Module(3,FiscalActivityInfoKey.M09,"Metro cua.",17.01)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",5819.91)
		...
		,E_691_2 ("691.2","Reparaci\u00F3n de veh\u00EDculos autom\u00F3viles, bicicletas y otros veh\u00EDculos."
				...
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",8556.27)
		...
		,E_691_9A("691.9","Reparaci\u00F3n de calzado."
				...
				,16552.74
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1845.50)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",10014.78)
					,new Module(3,FiscalActivityInfoKey.M03,"100 Kwh",125.97)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",3000.89)
		...
		,E_691_9B("691.9","Reparaci\u00F3n de otros bienes de consumo n.c.o.p. (excepto reparaci\u00F3n de calzado, restauraci\u00F3n de obras de arte, muebles, antig\u00FCedades e instrumentos musicales)."
				...
				,24803.91
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4094.10)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",16187.42)
					,new Module(3,FiscalActivityInfoKey.M09,"Metro cua.",45.35)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",5381.76)
		...
		,E_721_1 ("721.1","Transporte urbano colectivo y de viajeros por carretera."
				...
				,35196.62
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2981.02)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",16016.97)
					,new Module(3,FiscalActivityInfoKey.M21,"Asiento",121.40)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",1700.62)
		...
		,E_721_2 ("721.2","Transporte por autotaxis."
				...
				,9999999.99
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",1346.27)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",7656.89)
					,new Module(3,FiscalActivityInfoKey.M12,"1000 Km",45.08)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",903.46)
		...
		,E_722B  ("722"	 ,"Transporte de residuos por carretera."
				...
				,new Module[]{
					...
					,new Module(3,FiscalActivityInfoKey.M23,"Tonelada",126.21)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",1948.64)
		...
		,E_751_5 ("751.5","Engrase y lavado de veh\u00EDculos."
				...
				,28280.74
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4667.27)
		...
		,E_757   ("757"	 ,"Servicios de mudanzas."
				...
				,33640.86
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",2566.32)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",10175.13)
					,new Module(3,FiscalActivityInfoKey.M23,"Tonelada",48.08)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",5712.43)
		...
		,E_933_1 ("933.1","Ense\u00F1anza de conducci\u00F3n de veh\u00EDculos terrestres, acu\u00E1ticos, aeron\u00E1uticos, etc."
				...
				,47233.25
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3067.42)
		...
		,E_971_1 ("971.1","Tinte, limpieza en seco, lavado y planchado de ropas hechas y de prendas y art\u00EDculos del hogar usados."
				...
				,37224.77
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4553.90)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",16773.19)
					,new Module(3,FiscalActivityInfoKey.M03,"100 Kwh",45.98)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",3844.13)
		...
		,E_972_1 ("972.1","Servicios de peluquer\u00EDa de se\u00F1ora y caballero."
				...
				,18051.81
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",3161.90)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",9649.47)
					,new Module(3,FiscalActivityInfoKey.M09,"Metro cua.",94.48)
					,new Module(4,FiscalActivityInfoKey.M03,"100 Kwh",81.88)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",2562.75)
		...
		,E_973_3 ("973.3","Servicios de copias de documentos con m\u00E1quinas fotocopiadoras."
				...
				,24192.95
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M01,"Persona",4125.59)
					,new Module(2,FiscalActivityInfoKey.M02,"Persona",17044.03)
					,new Module(3,FiscalActivityInfoKey.M08,"Kw cont.",541.68)}
				,new Module[]{
					 new Module(1,FiscalActivityInfoKey.M26,"Persona",13136.13)
