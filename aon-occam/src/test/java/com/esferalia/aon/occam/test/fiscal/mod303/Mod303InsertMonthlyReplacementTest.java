...
public class Mod303InsertMonthlyReplacementTest extends Mod303AbstractTest {
	...
	public void mod303InsertMonthlyReplacementTest() {
		...
		for (Period period : Period.values()) {
			if (period.isMonthPeriod()) {
				...
				mod303InsertMonthlyReplacement(params.setIssueDate(AonRandom.getRangeDate(start,end)) );
			}
		}
	}
	
	public void mod303InsertMonthlyReplacement(FiscalFakerParams params) {
