...
public class ValidationSurnameLengthTest extends AbstractOccamTest {
	...
	public void test() {
		...
		int length = FS_MODEL.SURNAME.getDataType().length();
		model.setSurname( AonStringUtils.repeat("X", length + 2));
