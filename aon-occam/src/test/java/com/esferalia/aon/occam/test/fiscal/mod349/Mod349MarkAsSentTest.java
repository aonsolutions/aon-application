...
public class Mod349MarkAsSentTest extends AbstractOccamTest {
	
	@Test
	public void mod349MarkAsSentTest() {
		for (Mod349 model : MODEL349.getMod349s(getOccam()) ) {
			...
			assertEquals("Status not SENT", FiscalStatus.SENT, mod349Bis.getStatus());
		}
	}
