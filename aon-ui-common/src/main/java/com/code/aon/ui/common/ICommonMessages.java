...
public interface ICommonMessages {
	...
	String ACADEMY_BUNDLE = "academyBundle";
	String ACCOUNT_BUNDLE = "accountBundle";
	String ACCOUNTING_BUNDLE = "accountingBundle";
	String ADMIN_BUNDLE = "adminBundle";
	String ASSET_BUNDLE = "assetBundle";
	String AUDIT_BUNDLE = "auditBundle";	
	String COMMERCIAL_BUNDLE = "commercialBundle";
	String COMPANY_BUNDLE = "companyBundle";
	String CONFIG_BUNDLE = "configBundle";
	String CUSTOMER_BUNDLE = "customerBundle";
	String FINANCE_BUNDLE = "financeBundle";
	String FISCAL_BUNDLE = "fiscalBundle";
	String GROUPWARE_BUNDLE = "groupwareBundle";
	String INFOWEB_BUNDLE = "infowebBundle";
	String MARKETING_BUNDLE = "marketingBundle";
	String MESSAGING_BUNDLE = "smsBundle";
	String PAYROLL_BUNDLE = "payrollBundle";
	String PMS_BUNDLE = "pmsBundle";
	String PRODUCT_BUNDLE = "productBundle";
	String PUBLISHER_BUNDLE = "publisherBundle";
	String PURCHASE_BUNDLE = "purchaseBundle";
	String REGISTRY_BUNDLE = "registryBundle";
	String SALES_BUNDLE = "salesBundle";
	String STAT_BUNDLE = "statBundle";
	String WAREHOUSE_BUNDLE = "warehouseBundle";
