...
public interface ICommonMessages {
	...
	String PMS_ROOMS_ABBRV = "report_reservation_room_count_abrv";
	...
	String PMS_RESERVATION_FINANCE_BATCH_PROCESS_ERROR="pms_reservation_finance_batch_process_error";
	...
	String PMS_GUEST = "report_guest";
	String PMS_AGENCY = "report_agency";
	String PMS_CHECKIN = "report_checkin";
	String PMS_CHECKOUT = "report_checkout";
	String PMS_CHECKIN_ABBRV = "report_checkin_abbrv";
	String PMS_CHECKOUT_ABBRV = "report_checkout_abbrv";
	String PMS_PAX = "report_pax";
	String PMS_REGIME_ABBRV = "pms_regime_abbrv";
