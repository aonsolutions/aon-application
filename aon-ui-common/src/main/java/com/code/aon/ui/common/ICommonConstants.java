...
public interface ICommonConstants {
	...
	String AON_CUSTOMIZE_HERITABLE_ID = "AON_CUSTOMIZE_HERITABLE_ID";
	
	String AON_CUSTOMIZE_TITLE = "AON_CUSTOMIZE_TITLE";
	
	String AON_CUSTOMIZE_COLOR = "AON_CUSTOMIZE_FONT_COLOR";
	
	String AON_CUSTOMIZE_SUPPORT_PHONE = "AON_CUSTOMIZE_SUPPORT_PHONE";
	
	String AON_CUSTOMIZE_SUPPORT_EMAIL = "AON_CUSTOMIZE_SUPPORT_EMAIL";
	
	String AON_HIDE_TRADEMARK = "AON_HIDE_TRADEMARK";
	
	String AON_SUPPORT_ENABLED = "AON_SUPPORT_ENABLED";
