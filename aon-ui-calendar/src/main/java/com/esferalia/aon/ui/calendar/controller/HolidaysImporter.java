...
public class HolidaysImporter {
	private static final String RULES_FILE = "amortizationType_import_digester.xml";
	private static Digester DIGESTER;
	private AonFile aonFile;

	private static final Digester getDigester() {
		if (DIGESTER == null) {
			DIGESTER = DigesterLoader.createDigester(HolidaysImporter.class.getResource(RULES_FILE));
		}
		return DIGESTER;
	}
