...
public class GithubLoginCallbackServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String statepass="";
		if (username !=  null)
			statepass = SessionInfo.table.get(key).getUsers().get(username).getGithubUsers().get(email).getState();
