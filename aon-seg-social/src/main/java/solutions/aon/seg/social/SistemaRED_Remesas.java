...
public class SistemaRED_Remesas {

	public static void draftRequest(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, final String ccc, final SistemaRED_I.Regime regime, 
			Date dateFrom, Date dateTo, final SistemaRED_I.LiquidationType liqType, final boolean recoverPreviousMonthBases, final boolean receptionQuery) throws SegSocialException {
	...
	public static void confirmationRequest(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, final String ccc, final SistemaRED_I.Regime regime, 
			Date dateFrom, Date dateTo, final SistemaRED_I.LiquidationType liqType, final boolean receptionQuery) throws SegSocialException {
		InvalidCertificateException.checkCertificate(certificateInputStream);
	...
	public static void confirmationRequest(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, final String ccc, final SistemaRED_I.Regime regime) throws SegSocialException {
		InvalidCertificateException.checkCertificate(certificateInputStream);
