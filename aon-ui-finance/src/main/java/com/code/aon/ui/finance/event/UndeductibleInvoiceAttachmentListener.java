...
public class UndeductibleInvoiceAttachmentListener extends ControllerAdapter implements IAttachmentController {
	 ...
	 */
	public UndeductibleInvoiceAttachmentListener() {
		this.maximumSize = -1;
	}
	...
	public void afterBeanSelected(ControllerEvent event)
			throws ControllerListenerException {
		UndeductibleInvoiceController controller = (UndeductibleInvoiceController) event.getController();
