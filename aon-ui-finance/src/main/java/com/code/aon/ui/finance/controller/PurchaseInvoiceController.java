...
public class PurchaseInvoiceController extends InvoiceController implements ISignatureController, IFinanceConstants, IFinanceMessages {
	...
	public String getAddress() {
		...
		BasicController addressController = (BasicController)FormUtil.getController(PURCHASE_INVOICE_ADDRESS_CONTROLLER_NAME);
	...
	public double getToInvoiceFinanceTotal() throws ManagerBeanException {
		...
		IController feeFinanceController = FormUtil.getController(PURCHASE_INVOICE_FINANCE_CONTROLLER_NAME);
	...
	public boolean isRemovable() {
		PurchaseInvoiceDetailController purchaseInvoiceDetailController = (PurchaseInvoiceDetailController)FormUtil.getController(PURCHASE_INVOICE_DETAIL_CONTROLLER_NAME);
		if (purchaseInvoiceDetailController.getTo() == null && InvoiceStatus.PENDING == getInvoice().getStatus()) {
			return true;
		}
		return false;
	}
