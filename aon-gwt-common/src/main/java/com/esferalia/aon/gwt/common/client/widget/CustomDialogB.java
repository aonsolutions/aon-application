...
public class CustomDialogB extends PopupPanel implements CustomDialogBar.Listener{
	 ...
	 */
	public abstract class MouseDragHandler implements MouseMoveHandler,
	...
	private class WindowMoveHandler extends MouseDragHandler {
		...
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(absX, absY);
		}
	}
	...
	private class NWindowResizeHandler extends MouseDragHandler {
		...
		@Override
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(0, absY);
			CustomDialogB.this.incrementPixelSize(0, (-1)*absY);
		}
	}
	...
	private class NWWindowResizeHandler extends MouseDragHandler {
		...
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(absX, absY);
			CustomDialogB.this.incrementPixelSize((-1)*absX, (-1)*absY);
		}
	}
	...
	private class NEWindowResizeHandler extends MouseDragHandler {
		...
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(0, absY);
			CustomDialogB.this.incrementPixelSize(absX, (-1)*absY);
		}
	}
	...
	private class SWWindowResizeHandler extends MouseDragHandler {
		...
		@Override
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(absX, 0);
			CustomDialogB.this.incrementPixelSize((-1)*absX, absY);
		}
	}
	...
	private class SWindowResizeHandler extends MouseDragHandler {
		...
		@Override
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.incrementPixelSize(0, absY);
		}
	}
	...
	private class SEWindowResizeHandler extends MouseDragHandler {
		...
		@Override
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.incrementPixelSize(absX, absY);
		}
	}
	...
	private class EWindowResizeHandler extends MouseDragHandler {
		...
		@Override
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.incrementPixelSize(absX, 0);
		}
	}
	...
	private class WWindowResizeHandler extends MouseDragHandler {
		...
		public void handleDrag(int absX, int absY) {
			CustomDialogB.this.handleMove(absX, 0);
			CustomDialogB.this.incrementPixelSize((-1)*absX, 0);
		}
	}
	...
	private class WindowResizeHandler {
		...
		private void init(String left, String top, String width, String height,
			...
			Element dialogElement = CustomDialogB.this.getElement();
