...
public class AonCloseTab extends Composite implements HasCloseHandlers<Integer> {

	public AonCloseTab(final String label, final boolean canClose) {
		...
		if (canClose) {
			Image closeButton = new Image( AON.AON_SOLUTIONS_RESOURCES.aonIconClose().getSafeUri() );
