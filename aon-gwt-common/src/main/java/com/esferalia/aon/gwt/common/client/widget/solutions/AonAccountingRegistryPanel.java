...
public class AonAccountingRegistryPanel extends SimpleLayoutPanel implements Focusable {
	
	private static class AccRegTypeListBox extends ListBox {
		
		public AccRegTypeListBox() {
			setWidth("120px");
			addItem("","------");
	...
	public static interface AonAccountingRegistryPanelCallback {
	...
	public void show(final String domainName,final int domain
			...
			public void onKeyUp(KeyUpEvent event) {
				if (event.getNativeKeyCode() == KeyCodes.KEY_ESCAPE) {
					if (reg.isDirty()) {
						...
						cd.confirm("Cancelar?", "Cancelar",new AonConfirmDialogCallback() {
		...
		phone.setStyleName(AON.CSS.aonInputText());
		...
		cellular.setStyleName(AON.CSS.aonInputText());
		...
		fax.setStyleName(AON.CSS.aonInputText());
		...
		email.setStyleName(AON.CSS.aonInputText());
		...
		web.setStyleName(AON.CSS.aonInputText());
		...
		addressPanel.setStyleName(AON.CSS.aonNowrap());
		...
		address.setStyleName(AON.CSS.aonInputText());
		address.addStyleName(AON.CSS.aonMarginLeftSep());
		...
		InlineLabel numberLabel = new InlineLabel(AON.MSG.numberAbbrv());
		numberLabel.setStyleName(AON.CSS.aonMarginLeftSep());
		addressPanel.add(numberLabel);
		final TextBox addressNumber = new TextBox();
		addressNumber.setValue(reg.getAddressNumber());
		addressNumber.setStyleName(AON.CSS.aonInputText());
		addressNumber.addStyleName(AON.CSS.aonMarginLeftSep());
		...
		addressTown.setStyleName(AON.CSS.aonInputText());
		...
		addressZIP.setStyleName(AON.CSS.aonInputText());
		...
		table.getCellFormatter().setStyleName(row, 0, AON.CSS.aonTableLabel());
		final AonAccountBox account = new AonAccountBox(domainName,domain,user);
    	...
    	updateButton.setStyleName(AON.CSS.aonOkButton());    	
	...
	private void checkRegistryDocument(String domainName, int domain, String user ,AonConfiguration config
			, AonAccountingRegistryPanelCallback callback
