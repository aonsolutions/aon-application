...
public class AonDateBox extends com.google.gwt.user.datepicker.client.DateBox {
	...
	public static class DefaultFormat implements Format {
			...
			try {
				...
				if (!parsed) {
					try {
						...
						if (reportError) {
							dateBox.addStyleName(AON.CSS.aonInputTextError() );
						}
						return null;
					}
				}
		...
		public void reset(DateBox dateBox, boolean abandon) {
			dateBox.removeStyleName(AON.CSS.aonInputTextError() );
		}
	}
