...
public class AonMainCertificates extends DeckPanel {
	...
	private static enum COLS {
		...
		TGS("TGSS", "3rem", ""), SEP("SEPE", "3rem", ""), AEA("AEAT", "3rem", ""),
	...
	private static enum COLS_ENTERPRISE {
		...
		TYP(AON.MSG.alias(), "14rem", "white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"),
		TGS("TGSS", "3rem", ""), SEP("SEPE", "3rem", ""), AEA("AEAT", "3rem", ""),
		ACT(AonStringUtils.EMPTY, "3rem", ""), BUT(AonStringUtils.EMPTY, "10rem", "");
	...
	public void onModuleLoad() {
		getDomainUserRoles(domainUserRole -> {
	...
	private void updateTabTitle() {
		tabLayoutPanel.setTabText(0,
				"Personales (" + getUserCertificateList().size() + ")");
		tabLayoutPanel.setTabText(1,
				"Compartidos (" + getEnterpriseCertificateList().size() + ")");
	}
	...
	private void createUserCertDataTableRows() {
		List<Certificate> userCertificateList = getUserCertificateList();
	...
	private void createEnterpriseCertDataTableRows() {
		List<Certificate> enterpriseCertificateList = getEnterpriseCertificateList();
