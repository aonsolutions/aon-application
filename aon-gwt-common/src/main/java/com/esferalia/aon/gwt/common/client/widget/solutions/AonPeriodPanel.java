...
public class AonPeriodPanel extends FlowPanel {
	
	public static interface AonPeriodPanelCallback {
		void onAccept(Date start, Date end);
	}
	...
	public AonPeriodPanel(AonPeriodPanelCallback callback) {
    	...
    	okButton.addClickHandler(e -> {
    		...
    		if(null == getStartDate()) {
    			...
    			callback.onAccept(getStartDate(), getEndDate());
    	});
