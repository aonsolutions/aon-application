...
public interface AonCSS extends CssResource {
	...
	@ClassName("aon-group-title")
	String aonGroupTitle();

	@ClassName("aon-group-body")
	String aonGroupBody();
	...
	@ClassName("aon-block-right")
	String aonBlockRight();
	
	@ClassName("aon-block-left")
	String aonBlockLeft();
	...
	@ClassName("aon-padding-left10-important")
	String aonPaddingLeft10Important();
	...
	@ClassName("aon-icon-duplicate")
	String aonIconDuplicate();
	...
	@ClassName("aon-icon-issue-duplicated")
	String aonIconIssueDuplicated();
	...
	@ClassName("commentHeader-background")
	String commentHeaderBackground();
