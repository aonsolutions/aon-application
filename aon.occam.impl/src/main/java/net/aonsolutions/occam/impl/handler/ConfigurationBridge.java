...
public class ConfigurationBridge {
	...
	public static Optional<AccountPeriod> getDefaultAccountPeriod(AONContext ctx, Configuration configuration ) {
		return ConfigurationHandler.getDefaultAccountPeriod( ctx, configuration);
	}
	...
	public static Stream<AccountPeriod> getPeriods(AONContext ctx, Configuration configuration) {
		return ConfigurationHandler.getPeriods( ctx, configuration);
	}
	...
	public static boolean hasConfidentialityRole(AONContext ctx, Configuration configuration) {
		return ConfigurationHandler.hasConfidentialityRole( ctx, configuration);
	}
	public static boolean hasAccountingRole(AONContext ctx, Configuration configuration) {
		return ConfigurationHandler.hasAccountingRole( ctx, configuration);
	}
