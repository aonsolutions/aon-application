...
export class AonNewCheckbox extends AonElement {
...
if(!window.customElements.get(TAG.AON_NEW_CHECKBOX)){
	window.customElements.define(TAG.AON_NEW_CHECKBOX,  AonNewCheckbox);
}
