package net.aonsolutions.aon.gwt.communication.client.ingenet;
...
import net.aonsolutions.aon.gwt.communication.shared.IngenetAttachStatus;
...
public class ContentGridIngenet extends ResizeComposite implements RequiresResize {
	...
	@UiField(provided = true) public CustomDataGrid<JsAttachFile> dataGrid; 
	...
	public ContentGridIngenet(CommunicationPrincipal parent) {
		this(parent, new LinkedList<>());	
	}

	public ContentGridIngenet(CommunicationPrincipal parent, List<JsAttachFile> list) {
		this.parent = parent;		
...
//				}
	...
	private void processIngenetDeliveries() {
		...
		getAPI().getCommunication().processIngenetAttach(map, new AsyncCallback<JSON<JsObject>>() {
			@Override
