 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RegistroLRBajaRecibidas" type="{http://www.bizkaia.eus/ogasuna/sii/documentos/SuministroLR.xsd}LRBajaRecibidasType" maxOccurs="10000"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "BajaLRFacturasRecibidas")
public class BajaLRFacturasRecibidas
    extends SuministroInformacionBaja
{

    @XmlElement(name = "RegistroLRBajaRecibidas", required = true)
