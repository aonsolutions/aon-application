 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IdentificacionBien" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}TextMax40Type"/&gt;
 *         &lt;element name="FechaInicioUtilizacion" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}fecha"/&gt;
 *         &lt;element name="ProrrataAnualDefinitiva" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}Tipo2.2Type"/&gt;
 *         &lt;element name="RegularizacionAnualDeduccion" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}ImporteSgn12.2Type" minOccurs="0"/&gt;
 *         &lt;element name="IdentificacionEntrega" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}TextMax40Type" minOccurs="0"/&gt;
 *         &lt;element name="RegularizacionDeduccionEfectuada" type="{https://sii.araba.eus/documentos/SuministroInformacion.xsd}ImporteSgn12.2Type" minOccurs="0"/&gt;
