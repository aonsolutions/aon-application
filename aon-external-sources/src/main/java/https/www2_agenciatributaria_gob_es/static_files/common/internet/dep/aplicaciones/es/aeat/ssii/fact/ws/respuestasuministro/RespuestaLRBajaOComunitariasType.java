 ...
 * 
 * <p>Clase Java para RespuestaLRBajaOComunitariasType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RespuestaLinea" type="{https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/ssii/fact/ws/RespuestaSuministro.xsd}RespuestaComunitariaBajaType" maxOccurs="10000" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "RespuestaLRBajaOComunitariasType", propOrder = {
    "respuestaLinea"
})
public class RespuestaLRBajaOComunitariasType
    extends RespuestaComunBajaType
{

    @XmlElement(name = "RespuestaLinea")
    protected List<RespuestaComunitariaBajaType> respuestaLinea;
     ...
     * {@link RespuestaComunitariaBajaType }
     * 
     * 
     */
    public List<RespuestaComunitariaBajaType> getRespuestaLinea() {
        if (respuestaLinea == null) {
            respuestaLinea = new ArrayList<RespuestaComunitariaBajaType>();
        }
