 ...
 *       &lt;sequence>
 *         &lt;element name="IDDestinatario" type="{urn:ticketbai:emision}IDDestinatario" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Destinatarios {
    ...
    protected List<IDDestinatario> idDestinatario;
     ...
     * 
     */
    public List<IDDestinatario> getIDDestinatario() {
        if (idDestinatario == null) {
            idDestinatario = new ArrayList<IDDestinatario>();
        }
