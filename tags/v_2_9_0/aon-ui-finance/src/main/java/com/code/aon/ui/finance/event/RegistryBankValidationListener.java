...
public class RegistryBankValidationListener extends ControllerAdapter {

	@Override
	public void beforeBeanAdded(ControllerEvent event) throws ControllerListenerException {
		IBankAccountContainer rBankController = (IBankAccountContainer)event.getController();
		if(!rBankController.getControl().equals(calculaDC(rBankController.getEntity(), rBankController.getOffice(), rBankController.getAccount()))){
