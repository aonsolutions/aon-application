...
public class MinoracionGuipuzcoaController extends PayrollBasicController {
	...
	public void onSearch(ActionEvent event) {
		...
		try {
			if(searchFecini != null){
				getCriteria().addEqualExpression(getFieldName(IPayrollAlias.MINORACIONES_GUIPUZCOA_ID_FECINI), searchFecini);
			}
