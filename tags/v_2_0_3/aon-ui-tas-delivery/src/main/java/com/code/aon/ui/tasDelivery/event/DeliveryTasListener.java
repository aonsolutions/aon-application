...
public class DeliveryTasListener extends ControllerAdapter {
	...
	public void afterBeanAdded(ControllerEvent event) throws ControllerListenerException {
		...
		if(deliveryController.getSupportOrderId() != null){
			...
			try {
				...
				closeStatuses(tasDelivery.getSupportOrder(), tasDelivery.getOffer());
	 ...
	 */
	private void closeStatuses(SupportOrder supportOrder, Offer offer) {
		try {
			IManagerBean supportOrderBean = BeanManager.getManagerBean(SupportOrder.class);
            ...
            if (offer != null) {
                Expression offerExpr = ExpressionUtilities.getNotEqualExpression(tasOfferBean.getFieldName(ITasCommercialAlias.TAS_OFFER_OFFER_ID), offer.getId());
