...
public class TasDeliveryImport {
	 ...
	 */
	public static DeliveryWrapper onImport(Integer supportOrder_Id, Integer offer_Id) throws ManagerBeanException {
		...
		if (offer != null){
			deliveryWrapper = createDeliveryWrapper(offer);
		}else{
