 ...
 */
@Embeddable
public class PorcentajePK implements Serializable {

	private static final long serialVersionUID = -6617321486343128501L;
	...
	public boolean equals(Object other) {
		...
		if ( !(other instanceof PorcentajePK) ) return false;
		PorcentajePK castOther = (PorcentajePK) other; 
