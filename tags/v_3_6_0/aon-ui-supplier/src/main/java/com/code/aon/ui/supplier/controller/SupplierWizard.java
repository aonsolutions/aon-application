...
public class SupplierWizard extends AbstractWizard {
	...
	static {
		try {
			IManagerBean customerBean = BeanManager.getManagerBean(Supplier.class);
			ID = customerBean.getFieldName(ISupplierAlias.SUPPLIER_ID);
			NAME = customerBean.getFieldName(ISupplierAlias.SUPPLIER_REGISTRY_NAME);
			SURNAME = customerBean.getFieldName(ISupplierAlias.SUPPLIER_REGISTRY_SURNAME);
			DOCUMENT = customerBean.getFieldName(ISupplierAlias.SUPPLIER_REGISTRY_DOCUMENT);
			ALIAS = customerBean.getFieldName(ISupplierAlias.SUPPLIER_REGISTRY_ALIAS);
			STATUS = customerBean.getFieldName(ISupplierAlias.SUPPLIER_STATUS);
