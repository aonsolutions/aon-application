...
public class AccountLevelChangeController extends BasicController implements IProgression {
	...
	private boolean changeAccount(Account sourceAccount, Account targetAccount) throws ManagerBeanException {
		...
		updated = updateReferencedAccounts(Leasing.class.getName(), "fixedAssetAccount", sourceAccount, targetAccount) || updated;
		updated = updateReferencedAccounts(LeasingAccount.class.getName(), "account", sourceAccount, targetAccount) || updated;
