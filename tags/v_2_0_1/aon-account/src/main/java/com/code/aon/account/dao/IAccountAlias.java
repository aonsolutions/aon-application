...
public interface IAccountAlias {
	...
	*/
	String  LEASING_AMOUNT = LEASING_ENTRY.getAliasNames()[0];
	...
	*/
	String  LEASING_SUPPLIER_DOCUMENT = LEASING_ENTRY.getAliasNames()[9];

	/** 
	* Alias value: Leasing_supplierName
	* Hibernate value: Leasing.supplierName
	*/
	String  LEASING_SUPPLIER_NAME = LEASING_ENTRY.getAliasNames()[10];
