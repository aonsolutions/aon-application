...
public class AccountControllerCascadeListener extends ControllerAdapter {
	...
	private boolean accountSummaryRemovable(Account account) throws ManagerBeanException {
		...
		Expression creditExpression = ExpressionUtilities.getGreaterThanExpression(accountSummaryBean.getFieldName(IAccountAlias.ACCOUNT_SUMMARY_CREDIT), new Double(0.0));
		Expression debitExpression = ExpressionUtilities.getGreaterThanExpression(accountSummaryBean.getFieldName(IAccountAlias.ACCOUNT_SUMMARY_DEBIT), new Double(0.0));
