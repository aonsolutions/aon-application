...
public class RegistryAliasWriter {
	...
	public static void main(String[] args) throws IOException {
		...
		classes[4] = RegistryBank.class.getName();
		classes[5] = RegistryPayMethod.class.getName();
		classes[6] = RegistryMedia.class.getName();
		classes[7] = Relationship.class.getName();
		classes[8] = RegistryRelationship.class.getName();
		classes[9] = RegistryNote.class.getName();
		classes[10] = RegistryDirStaff.class.getName();
		classes[11] = RecordData.class.getName();
