...
# Version: 1.0.0
# Created by: girazu
# Creation Date: 26/09/2007 12:08
...
CREATE TABLE `account_entry_fbatch` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `account_entry` int(4) NOT NULL COMMENT 'Asiento Contable',
  `fbatch` int(4) NOT NULL COMMENT 'Remesa',
  PRIMARY KEY  (`id`),
  KEY `account_entry` (`account_entry`),
  KEY `fbatch` (`fbatch`),
...
CREATE TABLE `invoice` (
  ...
  `series` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie de la Factura',
...
CREATE TABLE `account_entry_finance_tracking` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `account_entry` int(4) NOT NULL COMMENT 'Asiento Contable',
  `finance_tracking` int(4) NOT NULL COMMENT 'Seguimiento de Vencimientos',
  PRIMARY KEY  (`id`),
  KEY `account_entry` (`account_entry`),
...
CREATE TABLE `user` (
  `registry` int(4) NOT NULL auto_increment COMMENT 'Registry asociado al Usuario',
  ...
  PRIMARY KEY  (`registry`),
  CONSTRAINT `user_fk` FOREIGN KEY (`registry`) REFERENCES `registry` (`id`)
...
CREATE TABLE `task` (
  ...
  CONSTRAINT `task_fk_1` FOREIGN KEY (`user`) REFERENCES `user` (`registry`),
  ...
  CONSTRAINT `task_fk_4` FOREIGN KEY (`sender`) REFERENCES `user` (`registry`),
...
CREATE TABLE `alarm` (
  ...
  PRIMARY KEY  (`id`),
  KEY `user` (`user`),
  CONSTRAINT `alarm_fk` FOREIGN KEY (`user`) REFERENCES `user` (`registry`)
...
CREATE TABLE `course_evaluation` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `course` int(4) NOT NULL COMMENT 'Curso',
  `quality_skill` int(4) NOT NULL COMMENT 'Quality Skill',
  `evaluation` double(15,3) default '0.000' COMMENT 'Evaluation',
...
CREATE TABLE `course_observation` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `course` int(4) NOT NULL COMMENT 'Curso',
  `observation` varchar(64) character set latin1 collate latin1_spanish_ci default NULL COMMENT 'Descripcion',
  PRIMARY KEY  (`id`),
  KEY `course` (`course`),
...
CREATE TABLE `cv_evaluate_summary` (
  ...
  `curriculum` int(11) default NULL COMMENT 'Identificador del Curriculum Vitae',
  PRIMARY KEY  (`id`),
  KEY `curriculum` (`curriculum`),
...
CREATE TABLE `daily_tracking` (
  ...
  `employee` int(4) NOT NULL COMMENT 'Identificador del Empleado que realiza el Parte',
  ...
  KEY `customer` (`customer`),
  CONSTRAINT `daily_tracking_fk_1` FOREIGN KEY (`employee`) REFERENCES `employee` (`registry`),
...
CREATE TABLE `delivery` (
  ...
  `series` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie del Albaran',
...
CREATE TABLE `sales` (
  ...
  `customer` int(4) NOT NULL default '0' COMMENT 'Identificador del Cliente',
  `series` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie del Pedido',
...
CREATE TABLE `mail_account` (
  ...
  KEY `employee` (`email`),
  KEY `mail_user` (`user`),
  CONSTRAINT `mail_account_fk` FOREIGN KEY (`user`) REFERENCES `user` (`registry`)
...
#
# Structure for the `employee_workgroup` table : 
#

CREATE TABLE `employee_workgroup` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador unico de Relacion entre Empleados y Grupos de Trabajo',
  `employee` int(4) NOT NULL COMMENT 'Identificado del Empleado',
  `workgroup` int(4) NOT NULL COMMENT 'Identificador del Grupo de Trabajo',
  PRIMARY KEY  (`id`),
  KEY `employee` (`employee`),
  KEY `workgroup` (`workgroup`),
  CONSTRAINT `employee_workgroup_fk_1` FOREIGN KEY (`employee`) REFERENCES `employee` (`registry`),
  CONSTRAINT `employee_workgroup_fk_2` FOREIGN KEY (`workgroup`) REFERENCES `workgroup` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Relacion entre Empleados y Grupos de Trabajo';
...
CREATE TABLE `evaluation_observation` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `alumn` int(4) NOT NULL,
  `evaluation` tinyint(2) NOT NULL,
...
CREATE TABLE `favorite_category` (
  ...
  PRIMARY KEY  (`id`),
  KEY `user` (`user`),
  CONSTRAINT `favorite_category_fk` FOREIGN KEY (`user`) REFERENCES `user` (`registry`)
...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT `favorite_fk1` FOREIGN KEY (`user`) REFERENCES `user` (`registry`)
...
CREATE TABLE `mark` (
  `id` int(4) NOT NULL auto_increment COMMENT 'Identificador Unico',
  `subject` int(4) NOT NULL COMMENT 'Asignatura',
  `alumn` int(4) NOT NULL,
  `evaluation` tinyint(2) NOT NULL,
  `mark` double(15,3) default '0.000',
  PRIMARY KEY  (`id`),
...
CREATE TABLE `note` (
  ...
  PRIMARY KEY  (`id`),
  KEY `owner` (`owner`),
  CONSTRAINT `note_fk` FOREIGN KEY (`owner`) REFERENCES `user` (`registry`)
...
CREATE TABLE `notice` (
  ...
  CONSTRAINT `notice_fk` FOREIGN KEY (`sender`) REFERENCES `user` (`registry`),
  CONSTRAINT `notice_fk1` FOREIGN KEY (`recipient`) REFERENCES `user` (`registry`),
...
CREATE TABLE `offer` (
  ...
  `series` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie del Presupuesto',
...
CREATE TABLE `rdir_staff` (
  ...
  `share_number` int(11) default '0' COMMENT 'Numero de Acciones',
...
CREATE TABLE `scale` (
  ...
  `serie` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie de Albaran para la importacion de albaranes',
...
CREATE TABLE `support_order` (
  ...
  `target` int(4) NOT NULL COMMENT 'Identificador del Cliente Potencial',
  `series` char(3) collate latin1_spanish_ci default NULL COMMENT 'Serie de la Orden de Reparacion',
