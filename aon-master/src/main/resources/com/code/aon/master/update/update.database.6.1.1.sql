...
(3, 'MTNAD', 7, '0'																
															, 'MTNDAD.DIAS * MTNDAD.BR'	, '0'		, 'PREST. MATERNIDAD Y/O R.E'						,1 ),
...
(payment_concept, type, expression, irpf_expression, quote_expression,  description, description_decorable, start_date, end_date, month,  salary_type ) 
VALUES 
