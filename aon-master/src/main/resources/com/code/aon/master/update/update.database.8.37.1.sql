...
INSERT INTO `holiday` (`domain`, `description`, `holiday`, `editable`) (SELECT  `domain`, CONCAT ( `description`, '(', `id` , ')'), `holiday`, 0  from `calendar` WHERE `id` IN ( SELECT `calendar` FROM `calendar_holiday` ));
