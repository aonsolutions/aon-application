...
UPDATE `geozone_irpf` SET `end_date` = '2017-12-31' WHERE end_date = '2016-12-31';

DELETE FROM `system_data`
WHERE  `domain`="0" AND `name`="SMI" AND `start_date`="2017-01-01";

UPDATE `system_data` 
SET `end_date` = "2016-12-31" 
WHERE `domain`="0" AND `name`="SMI" AND `start_date`="2016-01-01" AND `end_date` IS NULL;
...
,"BASE_CGC_MIN"
,"[
 \"01\":(TIEMPO_COMPLETO ? ( 1056.90 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 6.37 * 1.08 ) * HORAS_NOMINA)
,\"02\":(TIEMPO_COMPLETO ? ( 885.30 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 5.33 * 1.08 ) * HORAS_NOMINA)
,\"03\":(TIEMPO_COMPLETO ? ( 770.10 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.64 * 1.08 ) * HORAS_NOMINA)
,\"04\":(TIEMPO_COMPLETO ? ( 764.40 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"05\":(TIEMPO_COMPLETO ? ( 764.40 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"06\":(TIEMPO_COMPLETO ? ( 764.40 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"07\":(TIEMPO_COMPLETO ? ( 764.40 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"08\":(TIEMPO_COMPLETO ? ( 25.48 * 1.08 ) * DIAS_NOMINA : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"09\":(TIEMPO_COMPLETO ? ( 25.48 * 1.08 ) * DIAS_NOMINA : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"10\":(TIEMPO_COMPLETO ? ( 25.48 * 1.08 ) * DIAS_NOMINA : ( 4.60 * 1.08 ) * HORAS_NOMINA)
,\"11\":(TIEMPO_COMPLETO ? ( 25.48 * 1.08 ) * DIAS_NOMINA : ( 4.60 * 1.08 ) * HORAS_NOMINA)]
[GRUPO_COTIZACION]
"
,"2017-01-01"
,NULL
...
,"BASE_CGC_MAX"
,"[
 \"01\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"02\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"03\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"04\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"05\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"06\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"07\":(( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30))
,\"08\":(( 121.40 * 1.03 ) * (DIAS_NOMINA > 30 ? 30 : DIAS_NOMINA))
,\"09\":(( 121.40 * 1.03 ) * (DIAS_NOMINA > 30 ? 30 : DIAS_NOMINA))
,\"10\":(( 121.40 * 1.03 ) * (DIAS_NOMINA > 30 ? 30 : DIAS_NOMINA))
,\"11\":(( 121.40 * 1.03 ) * (DIAS_NOMINA > 30 ? 30 : DIAS_NOMINA))]
[GRUPO_COTIZACION]
"
,"2017-01-01"
,NULL
...
("0",
"BASE_CGP_MAX",
"( 3642.00 * 1.03 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30)",
"2017-01-01",
NULL,
"0",
...
("0",
"BASE_CGP_MIN",
"TIEMPO_COMPLETO ? ( 764.40 * 1.08 ) * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : ( 4.60 * 1.08 ) * HORAS_NOMINA ",
"2017-01-01",
NULL,
"0",
...
"BASE_CGC_MIN",
"($ in [
 [( 174.64 * 1.08 ) *,( 149.34 * 1.08 ) *],
 [( 272.80 * 1.08 ) *,( 247.07 * 1.08 ) *],
 [( 371.10 * 1.08 ) *,( 344.81 * 1.08 ) *],
 [( 469.30 * 1.08 ) *,( 442.56 * 1.08 ) *],
 [( 567.50 * 1.08 ) *,( 540.30 * 1.08 ) *],
 [( 665.00 * 1.08 ) *,( 638.05 * 1.08 ) *],
 [( 764.40 * 1.08 ) *,( 764.40 * 1.08 ) *], [Double.MAX_VALUE,( 798.56 * 1.08 ) *] ] if $[0] >= BASE_CGC )[0][1]",
"2017-01-01",
NULL,
"1",
NULL);
...
,\"09\":( 764.40 * 1.08 ) *
,\"10\":( 764.40 * 1.08 ) *
,\"11\":( 764.40 * 1.08 ) *][GRUPO_COTIZACION] * ( DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30 )",
"2017-01-01",
NULL,
"1",
NULL);
...
"[
 ...
 \"09\":( 33.23 * 1.08 ) *,
 \"10\":( 33.23 * 1.08 ) *,
 \"11\":( 33.23 * 1.08 ) *][GRUPO_COTIZACION]  * JORNADAS_REALES",
"2017-01-01",
NULL,
"1",
NULL);
...
("-107"
,"REDUCCION_CGC_E_02"
,"COTIZACION_MENSUAL ? ((BASE_CGC <= 986.70) ? 6.83 : ((BASE_CGC <= 3642.00) ? (( 6.83 * 1.08 ) * ( 1 + (BASE_CGC - 986.70)/ BASE_CGC * ( 2.52 * 1.08 ) * 6.15 / 6.83)) : 0.00)) : ((BASE_CGC / JORNADAS_REALES <= 42.90) ? 6.83 : ((BASE_CGC / JORNADAS_REALES <= 158.35)? (( 6.83 * 1.08 ) * ( 1 + (BASE_CGC / JORNADAS_REALES - 42.90) / ( BASE_CGC / JORNADAS_REALES ) * ( 2.52 * 1.08 ) * 6.15 / 6.83)) : 0.00))"
,"2017-01-01"
,NULL
,"1"
,NULL);
...
,`type`
,`code`) 
VALUES ("-101","2017-01-01",NULL,NULL,"30.98","0","CGC_E");
...
,`type`
,`code`) 
VALUES ("-101","2017-01-01",NULL,NULL,"42.04","2","DESMPL_E");
...
,`type`
,`code`) 
VALUES ("-101","2017-01-01",NULL,NULL,"2.35","10","FOGASA_E");
...
,`type`
,`code`) 
VALUES ("-101","2017-01-01",NULL,NULL,"1.14","3","FP_E");
...
,`type`
,`code`) 
VALUES ("-105","2017-01-01",NULL,NULL,"30.98","0","CGC_E");
...
UPDATE `db_version` SET `version_number` = '8.85.0';
