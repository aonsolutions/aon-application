...
,"BASE_CGC_MIN"
,"[
 \"01\":(TIEMPO_COMPLETO ? 1152.90 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 6.95 * HORAS_NOMINA)
,\"02\":(TIEMPO_COMPLETO ?  956.10 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 5.76 * HORAS_NOMINA)
,\"03\":(TIEMPO_COMPLETO ?  831.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 5.01 * HORAS_NOMINA)
,\"04\":(TIEMPO_COMPLETO ?  825.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 4.97 * HORAS_NOMINA)
,\"05\":(TIEMPO_COMPLETO ?  825.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 4.97 * HORAS_NOMINA)
,\"06\":(TIEMPO_COMPLETO ?  825.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 4.97 * HORAS_NOMINA)
,\"07\":(TIEMPO_COMPLETO ?  825.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 4.97 * HORAS_NOMINA)
,\"08\":(TIEMPO_COMPLETO ?   27.52 * DIAS_NOMINA : 4.97 * HORAS_NOMINA)
,\"09\":(TIEMPO_COMPLETO ?   27.52 * DIAS_NOMINA : 4.97 * HORAS_NOMINA)
,\"10\":(TIEMPO_COMPLETO ?   27.52 * DIAS_NOMINA : 4.97 * HORAS_NOMINA)
,\"11\":(TIEMPO_COMPLETO ?   27.52 * DIAS_NOMINA : 4.97 * HORAS_NOMINA)]
[GRUPO_COTIZACION]
"
,"2017-01-01"
,NULL
...
("0",
"BASE_CGP_MIN",
"TIEMPO_COMPLETO ? 825.60 * (DIAS_NOMINA == DIAS_MES ? 1 : DIAS_NOMINA/30) : 4.97 * HORAS_NOMINA ",
"2017-01-01",
 NULL,
"0",
...
UPDATE `db_version` SET `version_number` = '8.91.1';
