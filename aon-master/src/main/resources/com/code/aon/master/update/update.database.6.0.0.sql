...
UPDATE `registry` SET `document_type` = 2 WHERE SUBSTR(`document`, 1, 1) IN ('A','B','C','D','E','F','G','H','I','J');

UPDATE `registry` SET `document_type` = 1 WHERE SUBSTR(`document`, 1, 1) IN ('K','L','M','X','Y','Z');
