...
UPDATE `system_cost` SET `end_date`="2014-12-31" WHERE `domain`=-101 AND `code`="CGC_E"; 

INSERT INTO `system_cost` 
(`domain`	,`start_date`	,`end_date`	,`description`	,`expression`	,`type`	,`code`) VALUES 
("-101"		,"2015-01-01"	,NULL		,NULL		,"2.36"		,"1"	,"IT_E");
UPDATE `system_cost` SET `end_date`="2014-12-31" WHERE `domain`=-101 AND `code`="IT_E"; 

INSERT INTO `system_cost` 
(`domain`	,`start_date`	,`end_date`	,`description`	,`expression`	,`type`	,`code`) VALUES 
("-101"		,"2015-01-01"	,NULL		,NULL		,"1.86"		,"1"	,"IMS_E");
UPDATE `system_cost` SET `end_date`="2014-12-31" WHERE `domain`=-101 AND `code`="IMS_E"; 

INSERT INTO `system_cost` 
(`domain`	,`start_date`	,`end_date`	,`description`	,`expression`	,`type`	,`code`) VALUES 
("-101"		,"2015-01-01"	,NULL		,NULL		,"2.33"		,"10"	,"FOGASA_E");
UPDATE `system_cost` SET `end_date`="2014-12-31" WHERE `domain`=-101 AND `code`="FOGASA_E"; 
...
UPDATE `system_deduction` SET `end_date`="2014-12-31" WHERE `domain`=-101 AND `deduction_concept`="6299";
