...
(-107	, 'BASE_CGP_MIN_MES'		, '764.40 * JORNADAS_REALES / 30'			
							,'2016-01-01'	, NULL			, 1	, NULL ),
(-107	, 'BASE_CGP_MIN_DIA'		, '( TIEMPO_COMPLETO ) ? 764.40 * ((DIAS_COTIZADOS == DIAS_MES) ? 1 : DIAS_COTIZADOS/30) : 4.60 * HORAS_NOMINA'			
							,'2016-01-01'	, NULL			, 1	, NULL ),
