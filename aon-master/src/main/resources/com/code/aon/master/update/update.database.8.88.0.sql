...
ALTER TABLE `fs_model184_detail` ADD `nature` varchar(1) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Naturaleza del inmueble';
ALTER TABLE `fs_model184_detail` ADD `asset_percent` double(15,3) DEFAULT '0.000' COMMENT 'Porc. titularidad inmueble';
