...
CREATE TABLE `fs_model184_detail` (
  ...
  `reparacion_conservacion` double(15,3) DEFAULT '0.000' COMMENT 'Reparaciones y conservación',
  ...
  `inm_amort_mueb` double(15,3) DEFAULT '0.000' COMMENT 'Amortización de bienes muebles',
  `inm_otr_gas_ded` double(15,3) DEFAULT '0.000' COMMENT 'Otros gastos deducibles',
  `inm_num_dias_arr` int(4) DEFAULT '0' COMMENT 'Número de días de arrendamiento o cesión de uso y disfrute',
