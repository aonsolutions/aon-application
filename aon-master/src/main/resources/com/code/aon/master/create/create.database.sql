...
CREATE TABLE `fs_model190` (
  ...
  `preferred_contributions_under36` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Preferentes. Contribuciones empresariales a favor de personas menores de 36 a�os',
  `preferred_contributions_over36` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Preferentes. Contribuciones empresariales a favor de personas de 36 a�os o mas',
  `preferred_gross_annual_salary` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Preferentes. Salario bruto anual de la entidad',
  `other_contributions_under36` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Resto sistemas de empleo. Contribuciones empresariales a favor de personas menores de 36 a�os',
  `other_contributions_over36` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Resto sistemas de empleo. Contribuciones empresariales a favor de personas de 36 a�os o mas',
