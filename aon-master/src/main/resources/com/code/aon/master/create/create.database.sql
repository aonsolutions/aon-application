...
CREATE TABLE `domain` (
  ...
  `maxDocumentSize` int(4) DEFAULT NULL COMMENT 'Tamaï¿½o Maximo de los Documentos',
...
CREATE TABLE `academic_year` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico del Aï¿½o Academico',
  `domain` int(4) NOT NULL DEFAULT '1' COMMENT 'Identificador del Dominio',
  `description` varchar(9) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Descripcion del Aï¿½o Academico',
  PRIMARY KEY (`id`),
...
CREATE TABLE `course` (
  ...
  `academic_year` int(4) NOT NULL COMMENT 'Aï¿½o Academico del Curso',
...
CREATE TABLE `bank_statement` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `rbank` int(4) NOT NULL COMMENT 'Identificador de Banco de la Compaï¿½ia',
...
CREATE TABLE `fbatch` (
  ...
  `rbank` int(4) DEFAULT NULL COMMENT 'Banco de la Compaï¿½ia utilizado en la Remesa',
...
CREATE TABLE `finance_tracking` (
  ...
  `rbank` int(4) DEFAULT NULL COMMENT 'Identificador de la Cuenta Bancaria de la Compaï¿½ia',
  `bank_statement_link` int(4) DEFAULT NULL COMMENT 'Identificador de la Linea del Extracto bancario',
...
CREATE TABLE `user` (
  ...
  `password` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Contraseï¿½a del Usuario',
  `passwordExpiration` date DEFAULT NULL COMMENT 'Fecha de Expiracion de la Contraseï¿½a',
...
CREATE TABLE `session` (
  ...
  `session_id` varchar(128) COLLATE latin1_spanish_ci NOT NULL DEFAULT '' COMMENT 'Identificador web de la sesiï¿½n',
...
CREATE TABLE `balance_detail` (
  ...
  `description` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Descripciï¿½n del detalle de balance',
...
CREATE TABLE `project_reservation` (
  ...
  `credit_card_expiration_year` varchar(2) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Aï¿½o de expiracion de la tarjeta de credito',
...
CREATE TABLE `project_reservation_room` (
  ...
  `children` smallint(2) DEFAULT '0' COMMENT 'Numero de niï¿½os',
  `creation_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de creacion',
  `creation_date` datetime DEFAULT NULL COMMENT 'Fecha de creacion',
  `modification_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de modificacion',
  `modification_date` datetime DEFAULT NULL COMMENT 'Fecha de modificacion',
...
CREATE TABLE `campaign` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico de la Campaï¿½a',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `campaign_type` int(4) DEFAULT NULL COMMENT 'Identificador del Tipo de Campaï¿½a',
  `description` varchar(64) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Descripcion de la Campaï¿½a',
  `process` int(4) NOT NULL COMMENT 'Identificador del Proceso',
  `start_date` date NOT NULL COMMENT 'Fecha de inicio de la Campaï¿½a',
  `end_date` date NOT NULL COMMENT 'Fecha de finalizacion de la Campaï¿½a',
  `workgroup` int(4) NOT NULL COMMENT 'Grupo de Trabajo supervisor de la Campaï¿½a',
  `manual` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipo de Campaï¿½a',
  `status` tinyint(2) DEFAULT NULL COMMENT 'Estado de la Campaï¿½a',
  PRIMARY KEY (`id`),
...
CREATE TABLE `campaign_project` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico de la Relacion de Campaï¿½as y Expedientes',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `campaign` int(4) NOT NULL COMMENT 'Identificador de la Campaï¿½a',
...
CREATE TABLE `cashflow_forecast` (
  ...
  `rbank` int(4) DEFAULT NULL COMMENT 'Identificador de Banco de la Compaï¿½ia',
  `amount` double(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Importe',
...
CREATE TABLE `contract` (
  ...
  `registration` int(4) DEFAULT NULL COMMENT 'Nï¿½mero libro de matricula',
  ...
  `agreement_level` int(4) DEFAULT NULL COMMENT 'Identificador unico de la Categoria Profesional',
  ...
  KEY `IDX_CONTRACT_AGREEMENT_LEVEL` (`agreement_level`),
...
CREATE TABLE `certifica2_batch_detail` (
  ...
  `ere_number` varchar(15) COLLATE latin1_spanish_ci DEFAULT NULL  COMMENT 'Numero de ERE',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cnae2009_rate` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador ï¿½nico',
...
CREATE TABLE `commercial_term` (
  ...
  `term_general` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Condiciï¿½n es particular o general',
  PRIMARY KEY (`id`),
...
CREATE TABLE `company` (
  `registry` int(4) NOT NULL DEFAULT '1' COMMENT 'Registro de la Compaï¿½ia',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `active` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compaï¿½ia es activa o inactiva',
  `surcharge` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compaï¿½ia tiene de recargo de equivalencia',
  `withholding` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compaï¿½ia aplica retencion de impuestos',
  `vat_accrual_payment` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compaï¿½ia esta acogida al Regimen Especial de Criterio de Caja',
  `e_invoice` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compaï¿½ia desea emitir Facturas electronicas',
  PRIMARY KEY (`registry`),
...
CREATE TABLE `contact_data` (
  ...
  `organization` varchar(64) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Organizaciï¿½n',
  `title` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Cargo',
  `organizationAddress` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direcciï¿½n de la Organizaciï¿½n',
  `organizationPostalCode` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Codigo postal de la Organizaciï¿½n',
  `organizationCity` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Localidad de la Organizaciï¿½n',
  `organizationState` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Estado de la Organizaciï¿½n',
  `organizationPhone` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Telefono de la Organizaciï¿½n',
  `organizationFax` varchar(32) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Fax de la Organizaciï¿½n',
...
CREATE TABLE `contact` (
  ...
  `contact_data` int(4) DEFAULT NULL COMMENT 'Identificador de la Informaciï¿½n del Contacto',
  PRIMARY KEY (`id`),
...
CREATE TABLE `contract_bonus` (
  ...
  `description` varchar(64) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Descripcion',
  `expression` varchar(128) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Fï¿½rmula',
  `start_date` date NOT NULL COMMENT 'Fecha de inicio ',
  `end_date` date DEFAULT NULL COMMENT 'Fecha de finalizacion',
...
CREATE TABLE `contract_deduction` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `type` tinyint(2) DEFAULT NULL COMMENT 'Tipo de Deducciï¿½n',
...
CREATE TABLE `contract_payment` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `type` tinyint(2) DEFAULT NULL COMMENT 'Tipo de Percepciï¿½n Salarial',
  `contract` int(4) NOT NULL COMMENT 'Contrato',
  `payment_concept` int(4) DEFAULT NULL COMMENT 'Identificador unico del concepto',
  `description` varchar(64) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Descripcion',
  `description_decorable` tinyint(2) NOT NULL DEFAULT '0',
...
CREATE TABLE `customer_fee` (
  ...
  `billing_date` date DEFAULT NULL COMMENT 'Proxima fecha de facturaciï¿½n de la Cuota',
...
CREATE TABLE `offer_detail` (
  ...
  `item` int(4) DEFAULT NULL COMMENT 'Identificador del Articulo',
  `description` varchar(1024) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Descripciï¿½n del Articulo',
...
CREATE TABLE `fs_model184_detail` (
  ...
  `serv_prof_indep` double(15,3) DEFAULT '0.000' COMMENT 'Servicios profesionales independientes',
  `suministros` double(15,3) DEFAULT '0.000' COMMENT 'Suministros',
  ...
  `inm_trib_rec` double(15,3) DEFAULT '0.000' COMMENT 'Tributos y recargos',
  `inm_sald_dud_cobr` double(15,3) DEFAULT '0.000' COMMENT 'Saldos de dudoso cobro',
  `inm_cant_dev_ter` double(15,3) DEFAULT '0.000' COMMENT 'Cantidades devengadas por terceros',
  `inm_prim_seg` double(15,3) DEFAULT '0.000' COMMENT 'Primas de seguros',
  `inm_amort` double(15,3) DEFAULT '0.000' COMMENT 'Amortizacion del inmueble',
...
CREATE TABLE `fs_model190_detail` (
  ...
  `spousal_support` double(15,3) DEFAULT NULL COMMENT 'Pension compensatoria a favor del cï¿½nyuge.',
  ...
  `perception_il` double(15,3) DEFAULT '0.000' COMMENT 'Percepciï¿½n Integra/valoracion derivada de incapacidad laboral',
  ...
  `in_kind_perception_il` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Percepciï¿½n especie Integra/valoracion derivada de incapacidad laboral',
...
CREATE TABLE `fs_model200_registry` (
  ...
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `fs_model200` int(4) NOT NULL COMMENT 'Identificador del modelo 200',
  `document` varchar(20) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'NIF',
  `name` varchar(45) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Nombre',
  ...
  `dd_value` double(15,3) DEFAULT NULL COMMENT 'Eliminacion del deterioro de valores',
  `e_value` double(15,3) DEFAULT NULL COMMENT 'Ajuste por la disminucion de valor',
...
CREATE TABLE `fs_vat_declaration` (
  ...
  `rbank` int(4) DEFAULT NULL COMMENT 'Banco de la Compaï¿½ia',
...
CREATE TABLE `irpf_data` (
  ...
  `issue_date` date NOT NULL COMMENT 'Fecha de emisiï¿½n',
  `annual_remuneration` double(15,3) DEFAULT NULL COMMENT 'Retribuciones totales (dinerarias y en especie). Importe ï¿½ntegro',
  `irregular_18_2_reduction` double(15,3) DEFAULT NULL COMMENT 'Reducciones por irregularidad ( Atr. 18.2 LIRPF)',
  `irregular_18_3_reduction` double(15,3) DEFAULT NULL COMMENT 'Reducciones por irregularidad ( Atr. 18.3: Disposiciones transitorias 11ï¿½ y 12 ï¿½ de la LIRPF)',
  ...
  `spousal_support` double(15,3) DEFAULT NULL COMMENT 'Pension compensatoria a favor del cï¿½nyuge. Importe fijado judicialmente',
  ...
  `deduct_home_loan` tinyint(2) DEFAULT NULL COMMENT 'Comunicaciï¿½n de pagos por la adquisiï¿½n o rehabilitaciï¿½n de la vivienda habitual utilizando financiaciï¿½n ajena',
  `request_irpf` double(15,2) DEFAULT NULL COMMENT 'Tipo de retenciï¿½n solicitado',
  `contract_type` tinyint(2) NOT NULL DEFAULT '0' COMMENT 'Contrato o relaciï¿½n',
  `ceuta_melilla` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Los datos anteriores corresponden a rendimientos obtenidos en Ceuta o Melilla',
  PRIMARY KEY (`id`),
...
CREATE TABLE `irpf_regularization` (
  ...
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `contract` int(4) NOT NULL COMMENT 'Identificador del contrato',
  `reason` tinyint(2) DEFAULT NULL COMMENT 'Causa de regularizaciï¿½n',
  `effective_date` date NOT NULL COMMENT 'Fecha de entrada en vigor',
  `paid_irpf` double(15,3) DEFAULT NULL COMMENT 'Retenciones practicadas con anterioridad a la regularizaciï¿½n.',
  `paid_remuneration` double(15,3) DEFAULT NULL COMMENT 'Retribuciones ya satisfechas con anterioridad a la regularizaciï¿½n.',
  `prior_annual_irpf` double(15,3) DEFAULT NULL COMMENT 'Retenciones anuales anteriores a la regularizaciï¿½n.',
  `prior_annual_remuneration` double(15,3) DEFAULT NULL COMMENT 'Retribucines anulaes consideradas con anterioridad a la regularizaciï¿½n.',
  `prior_base_irpf` double(15,3) DEFAULT NULL COMMENT 'Base para calcular el tipo de retenciï¿½n determinado antes de la regularizaciï¿½n.',
  `prior_irpf` double(15,2) DEFAULT NULL COMMENT 'Tipo de retenciï¿½n aplicado antes de la regularizaciï¿½n.',
  `prior_in_ceuta_melilla` tinyint(1) DEFAULT NULL COMMENT 'Los rendimientos anteriores a la regularizaciï¿½n fueron obtenidos en Ceuta o Melilla',
  `prior_minimun_personal_family` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo personal y familiar para calcular el tipo de retenciï¿½n determinado antes de la regularizaciï¿½n.',
  `prior_deduct_home_loan` tinyint(2) DEFAULT NULL COMMENT 'En algï¿½n momento antes de la regularizaciï¿½n se aplico la minoraciï¿½n por pagos por la adquisiï¿½n o rehabilitaciï¿½n de la vivienda',
  `prior_deduct_home_loan_amount` double(15,3) DEFAULT NULL COMMENT 'Importe de la minoraciï¿½n por pagos por la adquisiï¿½n o rehabilitaciï¿½n de la vivienda antes de la regularizaciï¿½n',
  PRIMARY KEY (`id`),
...
CREATE TABLE `irpf_result` (
  ...
  `contract` int(4) NOT NULL COMMENT 'Identificador del contrato',
  `effective_date` date NOT NULL COMMENT 'Fecha de entrada en vigor',
  `base_irpf` double(15,3) DEFAULT NULL COMMENT 'Base para calcular el tipo de retenciï¿½n',
  `minimun_personal_family` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo personal y familiar para calcular el tipo de retenciï¿½n',
  `deduct_home_loan_amount` double(15,3) DEFAULT NULL COMMENT 'Minoraciï¿½n por pagos de prï¿½stamo para vivienda habitual',
  `deduct_80_bis` double(15,3) DEFAULT NULL COMMENT 'Deduccion Arttï¿½culo 80 bis LIRPF',
  `irpf` double(15,2) DEFAULT NULL COMMENT 'Tipo retenciï¿½n apliclabe ',
  `annual_irpf` double(15,3) DEFAULT NULL COMMENT 'Importe anual de las retenciones e ingresos a cuenta',
  `annual_remuneration` double(15,3) DEFAULT NULL COMMENT 'Retribuciones anuales. Importe ï¿½ntegro',
  `irregular_18_2_reduction` double(15,3) DEFAULT NULL COMMENT 'Reducciones por irregularidad ( Art. 18.2 LIRPF). Importe',
  `irregular_18_3_reduction` double(15,3) DEFAULT NULL COMMENT 'Reducciones por irregularidad ( Art. 18.3: DD.TT 11ï¿½ y 12 ï¿½ de la LIRPF). Importe',
  ...
  `work_prolongation_reduction` double(15,3) DEFAULT NULL COMMENT 'Reducciones por prolongaciï¿½n de la actividad ',
  ...
  `two_or_more_descendents_min` double(15,3) DEFAULT NULL COMMENT 'Por tener mï¿½s de dos descendientes con derecho a mï¿½nimo',
  `spousal_support` double(15,3) DEFAULT NULL COMMENT 'Pension compensatoria a favor del cï¿½nyuge. Importe anual',
  `food_annuity` double(15,3) DEFAULT NULL COMMENT 'Anualidades por alimentos en favor de los hijos. Importe anual',
  `minimun_personal` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo personal',
  `minimun_ascendents` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo por descendientes',
  `minimun_descendents` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo por descendientes',
  `minimun_disability` double(15,3) DEFAULT NULL COMMENT 'Mï¿½nimo por discapacidad',
  `descendents_minor_3_total` tinyint(2) DEFAULT NULL COMMENT 'Descendientes computados menores de tres aï¿½os. Total',
  `descendents_minor_3_entirely` tinyint(2) DEFAULT NULL COMMENT 'Descendientes computados menores de tres aï¿½os. Por entero',
  ...
  `descendents_first` tinyint(2) DEFAULT NULL COMMENT 'Detalle del cï¿½mputo de descendientes. Hijo 1ï¿½',
  `descendents_second` tinyint(2) DEFAULT NULL COMMENT 'Detalle del cï¿½mputo de descendientes. Hijo 2ï¿½',
  `descendents_third` tinyint(2) DEFAULT NULL COMMENT 'Detalle del cï¿½mputo de descendientes. Hijo 3ï¿½',
  `descendents_fourth_subsequent_total` tinyint(2) DEFAULT NULL COMMENT 'Detalle del cï¿½mputo de descendientes. Hijo 4ï¿½ y sucesivos. Total',
  `descendents_fourth_subsequent_entirely` tinyint(2) DEFAULT NULL COMMENT 'Detalle del cï¿½mputo de descendientes. Hijo 4ï¿½ y sucesivos. Por entero',
  `ascendents_minor_75_total` tinyint(2) DEFAULT NULL COMMENT 'Ascendientes computados menores de 75 aï¿½os. Total',
  `ascendents_minor_75_entirely` tinyint(2) DEFAULT NULL COMMENT 'Ascendientes computados menores de 75 aï¿½os. Por entero',
  `ascendents_mayor_75_total` tinyint(2) DEFAULT NULL COMMENT 'Ascendientes computados mayores de 75 aï¿½os. Total',
  `ascendents_mayor_75_entirely` tinyint(2) DEFAULT NULL COMMENT 'Ascendientes computados mayores de 75 aï¿½os. Por entero',
...
CREATE TABLE `mail_account` (
  ...
  `incoming_security` tinyint(2) NOT NULL DEFAULT '0' COMMENT 'Seguridad de conexiï¿½n del correo entrante',
  ...
  `outgoing_security` tinyint(2) NOT NULL DEFAULT '0' COMMENT 'Seguridad de conexiï¿½n del correo saliente',
...
CREATE TABLE `mk_campaign` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `active` tinyint(1) NOT NULL COMMENT 'Indica si la Campaï¿½a esta activa o no',
  `description` varchar(64) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Descripcion de la Campaï¿½a',
  `scope` int(4) NOT NULL COMMENT 'Identificador del Ambito',
  PRIMARY KEY (`id`),
...
CREATE TABLE `mk_action` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `campaign` int(11) NOT NULL COMMENT 'Identificador de la Campaï¿½a',
...
CREATE TABLE `survey_response` (
  ...
  `campaign_action` int(4) DEFAULT NULL COMMENT 'Identificador de la Accion de la Campaï¿½a',
  PRIMARY KEY (`id`),
...
CREATE TABLE `mk_action_target` (
  ...
  `target` int(4) NOT NULL COMMENT 'Identificador del Cliente Potencial',
  `status` tinyint(2) NOT NULL COMMENT 'Estado del Cliente Potencial de la Accion de Campaï¿½a',
...
CREATE TABLE `process_task` (
  `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico de la Relacion entre Campaï¿½as, Actividades y Tareas',
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `campaign` int(4) DEFAULT NULL COMMENT 'Identificador de la Campaï¿½a',
...
CREATE TABLE `rrelationship` (
  ...
  `relationship` int(4) NOT NULL COMMENT 'Identificador del Tipo de Relaciï¿½n',
...
CREATE TABLE `salary` (
  ...
  `contract` int(4) NOT NULL COMMENT 'Contrato',
  `start_date` date NOT NULL COMMENT 'Fecha de inicio liquidaciï¿½n',
  `end_date` date NOT NULL COMMENT 'Fecha de finalizacion liquidaciï¿½n',
  ...
  `seniority_date` date DEFAULT NULL COMMENT 'Fecha de antiguedad',
  `quote_group` varchar(2) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Grupo de Cotizaciï¿½n',
  `category` varchar(64) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Categoria o grupo profesional',
  `registration` int(4) NOT NULL COMMENT 'Nï¿½mero libro de matricula',
  ...
  `issue_date` date NOT NULL COMMENT 'Fecha de emisiï¿½n',
  `remuneration` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Remuneraciï¿½n mensual',
  ...
  `money_irpf_base` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Salario en dinero sujeto a retenciï¿½n I.R.P.F',
  `inkind_irpf_base` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Salario en especie sujeto a retenciï¿½n I.R.P.F',
  `irpf_base` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Base sujeta a retenciï¿½n I.R.P.F',
  `social_security_contributions` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Aportaciones a la Seguridad Social',
  `total_irpf` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Total retenciï¿½n aplicada ',
...
CREATE TABLE `salary_deduction` (
  ...
  `domain` int(4) NOT NULL COMMENT 'Identificador del Dominio',
  `salary` int(4) NOT NULL COMMENT 'Recibo del pago de salarios',
  `type` tinyint(2) DEFAULT NULL COMMENT 'Tipo de deducciï¿½n Salarial',
...
CREATE TABLE `system_cost` (
  ...
  `code` varchar(10) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Cï¿½digo',
  PRIMARY KEY (`id`),
...
CREATE TABLE `system_deduction` (
  ...
  `start_date` date NOT NULL COMMENT 'Fecha de inicio ',
  `end_date` date DEFAULT NULL COMMENT 'Fecha de finalizacion',
  `month` tinyint(2) DEFAULT NULL COMMENT 'Mes de la deducciï¿½n',
  PRIMARY KEY (`id`),
...
CREATE TABLE `timecontrol` (
    ...
    `modification_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de modificacion',
    `modification_date` datetime DEFAULT NULL COMMENT 'Fecha de modificacion',
    `modificated_timecontrol` int(4) DEFAULT NULL COMMENT 'id timecontrol modificado',
    `cause` tinyint(2) DEFAULT 0 COMMENT 'causa de fichaje',
	PRIMARY KEY (`id`),
