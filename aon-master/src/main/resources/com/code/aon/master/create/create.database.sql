...
CREATE TABLE `fs_mod347_detail` (
  ...
  `asset_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones',
  `asset_first_quarter_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones primer trimestre',
  `asset_second_quarter_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones segundo trimestre',
  `asset_third_quarter_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones tercer trimestre',
  `asset_fourth_quarter_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones cuarto trimestre',
  `cash_amount` double(15,3) DEFAULT '0.000' COMMENT 'Importe de las operaciones',
  ...
  `asset_street_type` varchar(4) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Tipo de via',
  `asset_street` VARCHAR(50) CHARACTER SET 'latin1' COLLATE 'latin1_spanish_ci' NULL COMMENT 'Nombre de la via',
  ...
  `asset_street_block` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direccio. Bloque.',
  `asset_street_hall` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direccio. Portal.',
  `asset_street_stair` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direccio. Escalera.',
  `asset_street_floor` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direccio. Planta.',
  `asset_street_door` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Direccio. Puerta.',
