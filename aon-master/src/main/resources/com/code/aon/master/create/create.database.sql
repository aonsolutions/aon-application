...
CREATE TABLE `cnae2009` (
  ...
  `title` varchar(255) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Titulo del CNAE',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='CNAE 2009. Clasificaci�n Nacional de Actividades Econ�micas ';
...
#
# Structure for the `invoice_info` table : 
#
...
CREATE TABLE `auth` (
  ...
  `phone` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'N�mero de telefono movil del usuario.',
  PRIMARY KEY (`id`)
...
CREATE TABLE `agreement` (
  ...
  `creation_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de creacion',
  `creation_date` date DEFAULT NULL COMMENT 'Fecha de creacion',
  `modification_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de modificacion',
  `modification_date` date DEFAULT NULL COMMENT 'Fecha de ultima modificacion',
  PRIMARY KEY (`id`),
...
CREATE TABLE `project_reservation` (
  ...
  `credit_card_expiration_year` varchar(2) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'A�o de expiracion de la tarjeta de credito',
...
CREATE TABLE `company` (
  ...
  `vat_accrual_payment` tinyint(1) DEFAULT '0' COMMENT 'Indica si la Compa�ia esta acogida al Regimen Especial de Criterio de Caja',
...
CREATE TABLE `data_request` (
  ...
  `black_box` text COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Informaci�n necesaria para replicar la petici�n',
...
CREATE TABLE `fs_model184_detail` (
  ...
  `reparacion_conservacion` double(15,3) DEFAULT '0.000' COMMENT 'Reparaciones y conservaci�n',
  ...
  `inm_amort_mueb` double(15,3) DEFAULT '0.000' COMMENT 'Amortizaci�n de bienes muebles',
  `inm_otr_gas_ded` double(15,3) DEFAULT '0.000' COMMENT 'Otros gastos deducibles',
  `inm_num_dias_arr` int(4) DEFAULT '0' COMMENT 'N�mero de d�as de arrendamiento o cesi�n de uso y disfrute',
...
CREATE TABLE `fs_model190_detail` (
  ...
  `spousal_support` double(15,3) DEFAULT NULL COMMENT 'Pension compensatoria a favor del c�nyuge.',
  ...
  `in_kind_perception_il` double(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Percepci�n especie Integra/valoracion derivada de incapacidad laboral',
...
CREATE TABLE `location` (
	...
	`description` varchar(64) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Descripci�n de la Ubicaci�n',
   	`radio` int(4) DEFAULT 50 COMMENT 'Radio de la Ubicaci�n',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Ubicaci�n';
...
CREATE TABLE `timecontrol` (
	...
	`location` int(4) DEFAULT NULL COMMENT 'Ubicaci�n del Operario',
	`latitude` double DEFAULT NULL COMMENT 'Latitud de las coordenadas.',
	`longitude` double DEFAULT NULL COMMENT 'Longitud de las coordenadas.',
	`creation_user` varchar(16) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Usuario de creacion',
    `creation_date` datetime DEFAULT NULL COMMENT 'Fecha de creacion',
