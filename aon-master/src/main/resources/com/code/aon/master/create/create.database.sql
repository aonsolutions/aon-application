...
CREATE TABLE `fs_model184_detail` (
  ...
  `rend_neto_previo` decimal(15,3) NOT NULL DEFAULT '0',
  `rend_neto_minora` decimal(15,3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `fs_model190_detail` (
  ...
  `perception_il` decimal(15,3) DEFAULT '0.000' COMMENT 'Percepcion Integra/valoracion derivada de incapacidad laboral',
  ...
  `common_retention` decimal(15,3) NOT NULL DEFAULT '0.000',
  `navarra_retention` decimal(15,3) NOT NULL DEFAULT '0.000',
  ...
  `entrepreneurship` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Rendimientos del trabajo obtenidos por la gestion de fondos vinculados al emprendimiento',
  `retirement_pension` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipos de prestaciones Clave B01. Jubilacion',
  `widowhood_pension` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipos de prestaciones Clave B01. Viudedad',
  `permanent_disability_pension` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipos de prestaciones Clave B01. Pension por incapacidad permanente, total o parcial',
  `non_contributory_pension` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipos de prestaciones Clave B01. Pension no contributiva por invalidez o jubilacion',
  `other_non_exempt_pensions` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Tipos de prestaciones Clave B01. Resto de prestaciones del art.17.2.a.1 de la Ley IRPF, no exentas, distintas de las anteriores',
  `forecast_plan_contributions` decimal(15,3) NOT NULL DEFAULT '0.000' COMMENT 'Contribuciones empresariales a planes de pensiones, planes de prevision social empresarial y mutualidades de prevision social',
  PRIMARY KEY (`id`),
...
CREATE TABLE `fs_model193_detail` (
  ...
  `bizkaia_retention` decimal(15,3) NOT NULL DEFAULT '0.000',
  `gipuzkoa_retention` decimal(15,3) NOT NULL DEFAULT '0.000',
  `previous_payer_document` varchar(9) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'NIF del pagador anterior',
  `accrual_date` date DEFAULT NULL COMMENT 'Fecha de devengo',
  `market_key` varchar(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Clave de mercado',
  `isin` varchar(12) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Codigo ISIN',
  PRIMARY KEY (`id`),
...
CREATE TABLE `fs_model200_registry` (
  ...
  `u_value` decimal(15,3) DEFAULT NULL,
  `v_value` decimal(15,3) DEFAULT NULL,
  `w_value` decimal(15,3) DEFAULT NULL,
  `x_value` decimal(15,3) DEFAULT NULL,
  `y_value` decimal(15,3) DEFAULT NULL,
  `z_value` decimal(15,3) DEFAULT NULL,  
  PRIMARY KEY (`id`),
...
CREATE TABLE `record_data` (
  ...
  `type` tinyint NOT NULL DEFAULT '3' COMMENT 'Tipo de Dato Registral',
  `type_0_unique` tinyint GENERATED ALWAYS AS (IF(`type` = 0, 1, NULL)) VIRTUAL COMMENT 'Columna virtual para garantizar un unico registro con type=0 por dupla (domain, registry)',
  `irus` varchar(13) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Codigo IRUS del Dato Registral',
  `commercial_registry_code` tinyint DEFAULT NULL COMMENT 'Codigo de Registro Mercantil',  
  PRIMARY KEY (`id`),
  KEY `IDX_RECORD_DATA_RATTACH` (`attach`),
  KEY `IDX_RECORD_DATA_REGISTRY` (`registry`),
  KEY `IDX_RECORD_DATA_DOMAIN` (`domain`),
  UNIQUE KEY `UNQ_RECORD_DATA_DOMAIN_REGISTRY_TYPE0` (`domain`, `registry`, `type_0_unique`),
...
CREATE TABLE `task_holder_workgroup` (
  ...
  `task_holder_workgroup_type` tinyint(4) DEFAULT 0 COMMENT 'Tipo operario del grupo de trabajo',
  `start_date` datetime DEFAULT NULL COMMENT 'Fecha inicio del operario en el grupo de trabajo',
  `end_date` datetime DEFAULT NULL COMMENT 'Fecha fin del operario en el grupo de trabajo',
  PRIMARY KEY (`id`),
...
#
# Table structure for table `fs_model369`
#

CREATE TABLE `fs_model369` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int NOT NULL COMMENT 'Identificador del Dominio',
  `year` int NOT NULL COMMENT 'Ejercicio de la Declaracion',
  `period` tinyint NOT NULL DEFAULT '0' COMMENT 'Periodo de la Declaracion',
  ...
  `regime` tinyint DEFAULT '0' COMMENT 'Regimen',
  `result` decimal(17,2) DEFAULT '0' COMMENT 'Resultado a ingresar',  
  `pay_type` tinyint DEFAULT '0' COMMENT 'Tipo de Pago',
...
#
# Table structure for table `fs_model369_detail`
#

CREATE TABLE `fs_model369_detail` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Identificador unico',
  `domain` int NOT NULL COMMENT 'Identificador del Dominio',
  `fs_model369` int NOT NULL COMMENT 'Identificador del modelo 369',
  `detail_type` tinyint DEFAULT '0' COMMENT 'Tipo de detalle',
  ...
  `vat_type` tinyint DEFAULT '0' COMMENT 'Tipo de IVA',
  ...
  `correction_period` tinyint DEFAULT NULL COMMENT 'Periodo de la correccion',
  ...
  `original_country` varchar(2) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Valor Original Codigo pais de consumo',
  `original_vat_percent` decimal(5,2) DEFAULT NULL COMMENT 'Valor Original Porcentaje de IVA',
  `original_base` decimal(17,2) DEFAULT NULL COMMENT 'Valor Original Base Imponible',
  `original_quota` decimal(17,2) DEFAULT NULL COMMENT 'Valor Original Cuota IVA',
  PRIMARY KEY (`id`),
...
CREATE TABLE rdoc (
	...
	size              INT NULL COMMENT 'tama�o en bytes del documento',
