...
CREATE TABLE `fs_model369` (
  ...
  `nrc` varchar(13) CHARACTER SET latin1 COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'NRC',
...
CREATE TABLE `fs_model369_detail` (
  ...
  `correction_year` int NOT NULL COMMENT 'Ejercicio de la correccion',
  `correction_period` tinyint(2) DEFAULT '0' COMMENT 'Periodo de la correccion',
