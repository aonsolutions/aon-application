...
CREATE TABLE `nordigen_call_log` (
  ...
  `was_rate_limited` BOOLEAN DEFAULT FALSE COMMENT 'Indica si se alcanz� el l�mite de llamadas',
  `retry_after` DATETIME NULL COMMENT 'Cu�ndo se puede volver a intentar en caso de rate limit',
  `retry_count` int DEFAULT 4 COMMENT 'N�mero de intentos restantes en el d�a',
  PRIMARY KEY (`id`)
