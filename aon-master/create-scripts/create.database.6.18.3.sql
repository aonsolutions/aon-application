...
CREATE TABLE `project_activity` (
  ...
  KEY `IDX_PRJ_ACT_WORKGROUP` (`workgroup`),
  CONSTRAINT `FK_PRJ_ACT_WORKGROUP` FOREIGN KEY (`workgroup`) REFERENCES `workgroup` (`id`),
...
INSERT INTO `db_version` (`version_number`) VALUES ('6.18.3');
