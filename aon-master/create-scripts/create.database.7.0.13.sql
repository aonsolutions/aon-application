...
# Version: 7.0.13
# Created by: girazu
# Creation Date: 26/04/2012 10:45
...
#
# Structure for the `contact_group` table : 
#
...
#
# Structure for the `contact_group_detail` table : 
#
...
CREATE TABLE `project_reservation` (
  ...
  `no_show` tinyint(1) NOT NULL default '0' COMMENT 'No show',
...
INSERT INTO `db_version` (`version_number`) VALUES ('7.0.13');
