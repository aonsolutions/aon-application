...
# Version: 6.4.0
# Created by: girazu
# Creation Date: 10/05/2011 10:22
...
CREATE TABLE `series` (
  ...
  `offer` tinyint(1) default '1' COMMENT 'Indica si es una Serie para Presupuestos',
  `sales` tinyint(1) default '1' COMMENT 'Indica si es una Serie para Pedidos',
  `delivery` tinyint(1) default '1' COMMENT 'Indica si es una Serie para Albaranes',
  `invoice` tinyint(1) default '1' COMMENT 'Indica si es una Serie para Facturas',
...
INSERT INTO `db_version` (`version_number`) VALUES ('6.4.0');
