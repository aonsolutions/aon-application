...
public class IssueCell extends AbstractCell<Issue> {
	...
	@Override
	public void render(Context context, Issue value, SafeHtmlBuilder sb) {
		/*
		...
		// attacks.
		SafeHtml safeValue = SafeHtmlUtils.fromString(value.getSubject());
