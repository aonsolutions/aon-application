package com.esferalia.aon.gwt.callcenter.client.tree;
...
public class NoticeTree extends MainEntryPoint {
...
//	}
	...
	interface NoticeTreeBinder extends UiBinder<Widget, NoticeTree> {
	}

	private static final NoticeTreeBinder BINDER = GWT.create(NoticeTreeBinder.class);
...
//	}
	...
	public void onModuleLoad() {
		Window.alert("start onModuleLoad");
...
//		sidebar.scrollToLeft();
	...
	public static Widget renderBreadcrumb(final NoticeTree fiscalTree, TreeItem item) {
	...
	public class NewMod200Command implements ScheduledCommand {
		...
		@Override
		public void execute() {
//			NoticeTree.FISCAL_SERVICE.initializeMod202(NoticeTree.getCurrentDomainName()
...
//							.getInstance()
//							.render(fiscalModelsNode, NoticeTree.this, mod202);
//						fiscalModelsNode.setState(true);
//						NoticeTree.this.tree.setSelectedItem(node);
//					}
//
//					@Override
//					public void onFailure(Throwable caught) {
