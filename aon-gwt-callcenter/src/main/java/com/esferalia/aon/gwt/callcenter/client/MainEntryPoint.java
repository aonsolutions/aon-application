...
import com.esferalia.aon.gwt.callcenter.client.callcenter.Callcenter;
import com.esferalia.aon.gwt.callcenter.client.tree.NoticeTree;
...
public class MainEntryPoint implements EntryPoint {
	...
	private static final String CALLCENTER = "CAllcenter";
	
	
	@Override
	public void onModuleLoad() {
		String entryPoint = getParameter(GWT.getModuleName(), ENTRY_POINT_PARAM);
		if ( entryPoint.equalsIgnoreCase(NOTICE)) {
			NoticeTree tree = new NoticeTree();
			tree.onModuleLoad();
		} else if ( entryPoint.equalsIgnoreCase(CALLCENTER)) {
