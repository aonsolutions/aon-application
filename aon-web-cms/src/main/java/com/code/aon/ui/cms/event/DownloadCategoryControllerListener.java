...
public class DownloadCategoryControllerListener extends ControllerAdapter {
	...
	public void afterBeanRemoved(ControllerEvent event)
		...
		DownloadCategoryController controller = (DownloadCategoryController) event.getController();
		try {
	...
	public void beforeBeanAdded(ControllerEvent event) throws ControllerListenerException {
		DownloadCategoryController controller = (DownloadCategoryController)event.getController();
		DownloadCategory downloadCategory = (DownloadCategory)controller.getTo();
		downloadCategory.setActive(true);
		downloadCategory.setPosition(controller.orderedControllerSupport.getLastPosition(controller));
		assignSection(event);
	}
