...
import com.esferalia.aon.gwt.mod200.client.mod200.e2018.ParticipationPanel.ParticipationPanelCallback;
...
public class Page02 extends PageAbs {
	...
	protected void calculate() {
		populate();
		callback.getMod200Object().doubleValueChanged(Mod2002018Key.P1501,
				callback.getMod200Object().getDoubleValue(Mod2002018Key.P1501));
	}
	...
	protected void initializeTable() {
		...
		cf.setWidth(1, "250px");
		int row = 0;
		for (final Mod2002018Key key : Mod2002018Constants.PARTICIPATION_KEYS) {
		...
		paintKey(table1,Mod2002018Key.POR51,0);
		paintKey(table1,Mod2002018Key.PORES,1);
	}
