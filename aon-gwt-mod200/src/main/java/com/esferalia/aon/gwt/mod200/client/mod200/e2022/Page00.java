...
import static com.esferalia.aon.occam.mod200.api.model.mod200_2022.Mod2002022Character.CHARACTER_ALSO_CHECK_MAP;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2022.Mod2002022Character.CHARACTER_INCOMPATIBILITY_MAP;
...
public class Page00 extends PageAbs {
	...
	static {
		...
		NOT_SUPPORTED_CHARACTERS.add(Mod2002022Key.C0008); 
		...
		NOT_SUPPORTED_CHARACTERS.add(Mod2002022Key.C0025);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002022Key.C0035);
	...
	public static final Mod2002022Key[] DECLARATION_CHARACTERS_BLOCK2 = new Mod2002022Key[] {
		...
		Mod2002022Key.C0064,
		Mod2002022Key.C0057,
		Mod2002022Key.C0012R,		
		Mod2002022Key.C0062,
		Mod2002022Key.C0020
	};
	
	public static final Mod2002022Key[] DECLARATION_CHARACTERS_BLOCK3 = new Mod2002022Key[] {
		Mod2002022Key.C0007,
		Mod2002022Key.C0009,
		Mod2002022Key.C0010,
		Mod2002022Key.C0081,
	...
	private Map<Mod2002022Key, CheckBox> inputsCheckBox;
	...
	public void dump() {
		...
		if (callback.getMod200Object().getMod200().getBalanceType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0051, true);
		}
		...
		if (callback.getMod200Object().getMod200().getPygType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0054, true);
		}		
		...
		DoubleVariableEx sv = callback.getMod200Object().getMod200().getVariable(Mod2002022Key.C0027);
    ...
    protected void setEnabled() {
		...
		if (enabled)
			for (Mod2002022Key key : CHARACTERS_KEYS) {
		...
		if (inputsCheckBox.containsKey(Mod2002022Key.C0027)) {
			inputsCheckBox.get(Mod2002022Key.C0027).setEnabled(false);
		}
	...
	private void paint() {
		...
		balanceSheetType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0050, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0051, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0052, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.PYMES));
			callback.markAsDirty();
		});
		...
		ecpnType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0075, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0076, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0077, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.PYMES));
			callback.markAsDirty();
		});
		...
		profitAndLossType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0053, (callback.getMod200Object().getMod200().getPygType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0054, (callback.getMod200Object().getMod200().getPygType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002022Key.C0055, (callback.getMod200Object().getMod200().getPygType() == BalanceType.PYMES));
			callback.markAsDirty();
		});	
		...
		c041.setValue(callback.getMod200Object().getMod200().getDoubleValue(Mod2002022Key.C0041));
		c041.addValueChangeHandler(event -> {			
			callback.getMod200Object().getMod200().setDoubleValue(Mod2002022Key.C0041, c041.getValue());
			callback.markAsDirty();
		});
		...
		c042.setValue(callback.getMod200Object().getMod200().getDoubleValue(Mod2002022Key.C0042));
		c042.addValueChangeHandler(event -> {
			callback.getMod200Object().getMod200().setDoubleValue(Mod2002022Key.C0042, c042.getValue());
			callback.markAsDirty();
		});
		...
		inputsCheckBox = new HashMap<Mod2002022Key, CheckBox>();
	...
	private void initializeCharactersTable(FlexTable table, Mod2002022Key[] declarationCharactersBlock) {
		table.setWidth("100%");
		...
		for (final Mod2002022Key key : declarationCharactersBlock ) {
			if (key != Mod2002022Key.C0012R) {
	...
	private void changeAvailability(Mod2002022Key key) {
		...
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002022Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002022Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
