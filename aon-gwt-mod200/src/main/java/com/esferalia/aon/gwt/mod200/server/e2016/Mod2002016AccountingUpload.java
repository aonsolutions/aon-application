...
@WebServlet(name = "Mod200 - 2016 Accounting Upload ", urlPatterns = { "/aon_gwt_mod200/Mod2002016AccountingUpload" })
public class Mod2002016AccountingUpload extends UploadAction {
		...
		for (FileItem item : sessionFiles) {
			if (false == item.isFormField()) {
				try {
					...
					MOD2002016 xml = (MOD2002016) um.unmarshal(input);
					request.getSession().setAttribute("Mod2002016Accounting", xml);
				} catch (Exception ex) {
