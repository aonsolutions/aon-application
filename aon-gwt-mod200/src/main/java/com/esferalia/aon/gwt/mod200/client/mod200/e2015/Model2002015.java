...
import com.esferalia.aon.occam.mod200.api.model.mod200_2015.ValidationMessage2015;
...
public class Model2002015 extends ResizeComposite  {
	
	interface Model2002015Binder extends
			UiBinder<Widget, Model2002015> {
	}

	private static final Model2002015Binder binder = GWT
			.create(Model2002015Binder.class);

	protected Mod2002015Object mod200Object;
	...
	public Model2002015(Model200ModuleOptions options,Model200Callback mod200Callback) {
	...
	protected void paintHeaderTable(final Mod2002015 mod200) {
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002015> {
		PopupPanel popup;
	...
	public void startModel(final Mod2002015Object modObject ) {
	...
	private void populatePages(Mod2002015Object mod200Object) {
		page00.populate(mod200Object);
...
*/
	public void validationMessageSelected(ValidationMessage2015 msg) {
		if ( msg.getPage() >= 0 ) {
	...
	void onAeatAccountingFileButtonClick(ClickEvent event) {
		...
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002015AccountingFile");
	...
	void onAeatFileButtonClick(ClickEvent event) {
		Window.alert(
				...
				+ "El fichero se genera a partir de los datos guardados.");
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002015File");
		modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
		domainIdHidden.setValue(String.valueOf(options.getDomain()));
		domainNameHidden.setValue(options.getDomainName());
		diskForm.submit();
	...
	void onAeatPrintButtonClick(ClickEvent event) {
		...
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002015Print");
		modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
		domainIdHidden.setValue(String.valueOf(options.getDomain()));
		domainNameHidden.setValue(options.getDomainName());
		diskForm.submit();
