...
public class Page20 extends PageAbs {
	...
	public Page20( Model2002025PageCallback callback ) {
		super(callback);
	}
	...
	protected boolean isAvailable() {
		return super.isAvailable() && 
				     (callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0021) || 
				      callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0039) ||
				      callback.getMod200Object().getMod200().isChecked(Mod2002025Key.X0001) );
	}
	...
	private void paint() {
		...
		paintKey(tab1, Mod2002025Key.CN987, 0);
		...
		paintKey(tab21, Mod2002025Key.CN1897, 0);
		paintKey(tab21, Mod2002025Key.CN1901, 1);
		
		// No residentes con más de un establecimiento permanente
		
		FlexTable tab3 = addTable(AON.MSG.bussinessAmount2());
		paintKey(tab3, Mod2002025Key.CN988, 0);
		paintKey(tab3, Mod2002025Key.CNEST, 1);
