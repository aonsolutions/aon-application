...
public class ParticipationPanel extends CustomDialog {
	...
	public void dump(Mod200CompanyParticipation cp) {
		...
		this.cValue.setValue(companyParticipation.getCorrectionEffect());
		this.dValue.setValue(companyParticipation.getCorrectionsBalance());
	...
	public void onClose() {
		...
		companyParticipation.setCorrectionEffect(this.cValue.getValue());
		companyParticipation.setCorrectionsBalance(this.dValue.getValue());
