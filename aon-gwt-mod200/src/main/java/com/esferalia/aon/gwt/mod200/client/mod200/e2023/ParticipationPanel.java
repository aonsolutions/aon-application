...
public class ParticipationPanel extends AonCustomDialog {	
	...
	private void paint() {
		...
		addRow(tab2, Mod2002023Key.P1502.getDescription(), bookValue);
		addRow(tab2, Mod2002023Key.P1503.getDescription()+" (*)", incomes);
		...
		addRow(tab3, Mod2002023Key.P1809.getDescription(), cValue);
		addRow(tab3, Mod2002023Key.P1810.getDescription(), dValue);
		addRow(tab3, Mod2002023Key.P1507.getDescription(), eValue);
		addRow(tab3, Mod2002023Key.P1508.getDescription(), fValue);
