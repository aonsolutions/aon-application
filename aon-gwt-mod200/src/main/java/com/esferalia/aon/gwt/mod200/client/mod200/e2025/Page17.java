...
public class Page17 extends PageAbs {
	...
	public Page17( Model2002025PageCallback callback ) {
		super(callback);
	}
	...
	protected void initializeTable() {
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0029)) {
			...
			// Importe de la dotación RIC con cargo a beneficios de 2025 (Casilla 927)
			...
			row = 0;
			paintKey(table2, Mod2002025Key.RC927, row);
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0086)) {
			...
			table1.getFlexCellFormatter().setColSpan(row, 2, 4);
			row++;
			paintKeysProvider(Mod2002025RIIB_1Key.values(), table1, row, false, 
					"",
			...
			// Importe de la dotación RIIB con cargo a beneficios de 2025 (Casilla 02918)
			...
			table2.getColumnFormatter().setWidth(1, "200px");
			row = 0;
			paintKey(table2, Mod2002025Key.RB2918, row);
			
			// RIIB - Inversiones anticipadas
	
			paintKeysProvider(Mod2002025RIIB_2Key.values(), addTable("", 4, "150px"), 0, false, 
					"",
	...
	protected boolean isAvailable() {		
		return super.isAvailable() && (isCheckedOr(Mod2002025Key.C0029,Mod2002025Key.C0086));
	}
