...
public class Page19 extends PageAbs {
	...
	protected void initializeTable() {
		...
		paintKey(table, Mod2002017Key.CN987, 0);
		
		
		table1.setWidth("100%");
		table1.setCellSpacing(0);
		table1.getColumnFormatter().setWidth(1, "200px");
		paintKey(table1, Mod2002017Key.CN988, 0);
		paintKey(table1, Mod2002017Key.CNEST, 1);
		
		table2.setWidth("100%");
		table2.setCellSpacing(0);
		table2.getColumnFormatter().setWidth(1, "200px");
		paintKey(table2, Mod2002017Key.CN989, 0);
	}
	...
	protected boolean isAvailable() {
		boolean av = super.isAvailable()
  		  && (callback.getMod200Object().getMod200().isChecked(Mod2002017Key.C0021) 
		   || callback.getMod200Object().getMod200().isChecked(Mod2002017Key.C0039))
  		  ;
		return av;
	}
