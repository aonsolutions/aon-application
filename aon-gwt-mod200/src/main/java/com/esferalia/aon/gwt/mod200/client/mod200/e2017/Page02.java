...
import com.esferalia.aon.gwt.mod200.client.mod200.e2017.ParticipationPanel.ParticipationPanelCallback;
...
public class Page02 extends PageAbs {
	...
	protected void calculate() {
		populate();
		callback.getMod200Object().doubleValueChanged(Mod2002017Key.P1501,
				callback.getMod200Object().getDoubleValue(Mod2002017Key.P1501));
	}
	...
	protected void initializeTable() {
		...
		cf.setWidth(1, "250px");
		int row = 0;
		for (final Mod2002017Key key : Mod2002017Constants.PARTICIPATION_KEYS) {
		...
		paintKey(table1,Mod2002017Key.POR51,0);
		paintKey(table1,Mod2002017Key.PORES,1);
	}
