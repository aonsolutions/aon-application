...
public class Model2002024 extends DockLayoutPanel {
	
	protected interface Model2002024PageCallback extends IModel200PageCallback {	
		public Mod2002024Object getMod200Object();
	}
	
	private PageAbs[] pages = new PageAbs[23];
	private WestFocusPanel westFocusPanelAEAT = null;
	
	protected Mod2002024Object mod200Object;
	...
	public Model2002024(Model200Callback mod200Callback, Mod2002024 mod200) {
		...
		mod200Object = new Mod2002024Object(options, mod200);
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002024> {
		PopupPanel popup;
	...
	private PageAbs ensurePage(int i) {
		...
		Model2002024PageCallback cbk = new Model2002024PageCallback(){
			...
			public void markAsDirty() {
				Model2002024.this.markAsDirty();
			}
			
			@Override
			public String getCheckAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002024CheckAEAT";
			}

			@Override
			public String getCheckDataResponseDataAction() {
				return GWT.getHostPageBaseURL() +"/aon_gwt_mod200/ms/Mod2002024CheckDataResponseData";
			}
			...
			public String getDownloadFileAction() {
				return "/aon_gwt_mod200/ms/Model2002024File";
			}
			...
			public String getExportAccountingAction() {
				return "/aon_gwt_mod200/ms/Model2002024AccountingFile";
			}
			...
			public Model200ModuleOptions getOptions() {
				return Model2002024.this.options;
			}

			@Override
			public String getValidatePrintAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002024ValidatePrintAEAT";
			}

			@Override
			public String getSendAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002024SendAEAT";
			}
			...
			public void sendSuccessfully() {
				...
				Model200.getMod2002024Service().getMod2002024ById(options.getOccam(), mod200Object.getMod200().getId()
			...
			public boolean isDirty() {
				return Model2002024.this.isDirty();
			}
			...
			public void importAccountingFile() {
				...
				Upload upload = new Upload() {
					...
					protected void onUpload(String data, String type) {
						mod200Object.fillMod2002024AccountingData(data, new AsyncCallback<Mod2002024>() {
							@Override public void onSuccess(Mod2002024 result) {	
								Model2002024.this.markAsDirty();
							}
			...
			public boolean validateBalance() {
				...
				double diferencia = AonMathUtils.absRounded(mod200Object.getDoubleValue(Mod2002024Key.BA180) - mod200Object.getDoubleValue(Mod2002024Key.BP252));				
	...
	private Widget getToolbar() {
		...
		initializeButton.addClickHandler(event -> {
			mod200Callback.cleanErrorPanel();
			popup.center();
			mod200Object.initializeMod200(new AsyncCallback<Mod2002024>() {
				@Override
				public void onSuccess(Mod2002024 result) {
					popup.hide();
					dumpP00();
					...
					try {
						...
						mod200Object.delete(new AsyncCallback<Void>() {
							...
							public void onSuccess(Void result) {
								...
								Model200.getMod2002024Service().createMod2002024(options.getOccam(), 2024
										, new AsyncCallback<Mod2002024>() {
