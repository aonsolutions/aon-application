...
public class Mod2002023Object implements Serializable {

	public static interface IMod200ChangeListener {
		void mod200Changed( Mod2002023 mod200 );
	}
	...
	public Mod2002023Object(Model200ModuleOptions options, Mod2002023 mod200) {
	...
	private void fireMod200Changed(Mod2002023 mod2002) {
		if (changeListeners != null) {
	...
	public void initializeMod200(final AsyncCallback<Mod2002023> callback) {
		Model200.getMod2002023Service().initializeMod2002023(options.getOccam(), mod200, new AsyncCallback<Mod2002023>() {
	...
	public void save(final AsyncCallback<Mod2002023> callback) {
		Model200.getMod2002023Service().saveMod2002023(options.getOccam(), mod200, new AsyncCallback<Mod2002023>() {
	...
	public void delete(final AsyncCallback<Void> callback) {
		Model200.getMod2002023Service().deleteMod2002023(options.getOccam(), mod200, new AsyncCallback<Void>() {
	...
	public void fillMod2002023AccountingData(String data, final AsyncCallback<Mod2002023> callback) {
		Model200.getMod2002023Service().fillMod2002023AccountingData(options.getOccam(), mod200, data, new AsyncCallback<Mod2002023>() {
	...
	public Mod2002023 getMod200() {
		return mod200;
	}

	public void setMod200(Mod2002023 mod200) {
		this.mod200 = mod200;
		fireMod200Changed(mod200);
	}
	...
	public boolean isVisible(Mod2002023Key key) {
	...
	public void calculate() {
		Model200.getMod2002023Service().calculateMod2002023(mod200, new AsyncCallback<Mod2002023>() {
	...
	public void getCompanyBanks(final AsyncCallback<LinkedList<CompanyBank>> callback) {
		Model200.getMod2002023Service().getCompanyBanks(options.getOccam(), new AsyncCallback<LinkedList<CompanyBank>>() {
