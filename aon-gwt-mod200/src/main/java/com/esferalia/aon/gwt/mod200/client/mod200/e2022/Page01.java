...
public class Page01 extends PageAbs {
	...
	private void paint() {
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002022Key.C0009) || 
			...
			if (callback.getMod200Object().getMod200().isChecked(Mod2002022Key.C0010)) {
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002022Key.C0081)) {
