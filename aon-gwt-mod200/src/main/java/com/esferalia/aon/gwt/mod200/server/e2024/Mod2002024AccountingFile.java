...
import com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2024.jaxb.Mod2002024toMOD2002024;
import com.esferalia.aon.occam.server.fiscal.format.AonFiscalFileUtils;

@SuppressWarnings("serial")
@WebServlet(name = "Mod200 - 2024 Accounting File", urlPatterns = { "/aon_gwt_mod200/ms/Model2002024AccountingFile" })
public class Mod2002024AccountingFile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Occam occam = new Occam().setDomainName(domainName)
									.setDomain(domainId)
									.setUser(user);
			Mod2002024 mod200 = MODEL2002024.getMod2002024ById(occam,id);

			MOD2002024 mod = Mod2002024toMOD2002024.getMOD2002024(mod200);
