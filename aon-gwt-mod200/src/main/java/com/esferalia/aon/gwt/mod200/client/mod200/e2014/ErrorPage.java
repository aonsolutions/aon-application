...
public class ErrorPage extends ResizeComposite {
	...
	public ErrorPage( ) {
		table = new CellTable<ValidationMessage2014>(1, Model200Table.TABLE_STYLE);
	...
	public void addSelectionListener(Model2002014 handler) {
		// From Mod200 dump()
		this.handler = handler;
	}
	
	public void addErrorMsg(List<ValidationMessage2014> messages) {
