...
public class Model2002025 extends DockLayoutPanel {
	
	protected interface Model2002025PageCallback extends IModel200PageCallback {	
		public Mod2002025Object getMod200Object();
	}
	...
	public Model2002025(Model200Callback mod200Callback, Mod2002025 mod200) {
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002025> {
		PopupPanel popup;
	...
	private PageAbs ensurePage(int i) {
		...
		Model2002025PageCallback cbk = new Model2002025PageCallback(){
			...
			public void markAsDirty() {
				Model2002025.this.markAsDirty();
			}
			
			@Override
			public String getCheckAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002025CheckAEAT";
			}

			@Override
			public String getCheckDataResponseDataAction() {
				return GWT.getHostPageBaseURL() +"/aon_gwt_mod200/ms/Mod2002025CheckDataResponseData";
			}
			...
			public String getDownloadFileAction() {
				return "/aon_gwt_mod200/ms/Model2002025File";
			}
			...
			public String getExportAccountingAction() {
				return "/aon_gwt_mod200/ms/Model2002025AccountingFile";
			}
			...
			public Model200ModuleOptions getOptions() {
				return Model2002025.this.options;
			}

			@Override
			public String getValidatePrintAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002025ValidatePrintAEAT";
			}

			@Override
			public String getSendAction() {
				return GWT.getHostPageBaseURL() +"aon_gwt_mod200/ms/Mod2002025SendAEAT";
			}
			...
			public void sendSuccessfully() {
				...
				Model200.getMod2002025Service().getMod2002025ById(options.getOccam(), mod200Object.getMod200().getId()
						, new AsyncCallback<Mod2002025>() {

							@Override
							public void onSuccess(Mod2002025 mod200) {
			...
			public boolean isDirty() {
				return Model2002025.this.isDirty();
			}
			...
			public void importAccountingFile() {
				...
				Upload upload = new Upload() {
					...
					protected void onUpload(String data, String type) {
						mod200Object.fillMod2002025AccountingData(data, new AsyncCallback<Mod2002025>() {
							@Override public void onSuccess(Mod2002025 result) {	
								Model2002025.this.markAsDirty();
							}
			...
			public boolean validateBalance() {
				...
				double diferencia = AonMathUtils.absRounded(mod200Object.getDoubleValue(Mod2002025Key.BA180) - mod200Object.getDoubleValue(Mod2002025Key.BP252));				
	...
	private Widget getToolbar() {
		...
		initializeButton.addClickHandler(event -> {
			mod200Callback.cleanErrorPanel();
			popup.center();
			mod200Object.initializeMod200(new AsyncCallback<Mod2002025>() {
				@Override
				public void onSuccess(Mod2002025 result) {
					popup.hide();
					dumpP00();
					...
					try {
						...
						mod200Object.delete(new AsyncCallback<Void>() {
							...
							public void onSuccess(Void result) {
								...
								Model200.getMod2002025Service().createMod2002025(options.getOccam(), 2025
										, new AsyncCallback<Mod2002025>() {
