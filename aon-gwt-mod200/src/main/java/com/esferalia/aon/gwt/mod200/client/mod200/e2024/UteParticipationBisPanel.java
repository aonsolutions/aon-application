...
public class UteParticipationBisPanel extends AonCustomDialog {	
	...
	private void paint() {
		...
		addRow(tab2, Mod2002024Key.UT1279.getDescription(), c01279, AON.CSS.aonWidth440());
		addRow(tab2, Mod2002024Key.UT1455.getDescription(), c01455, AON.CSS.aonWidth440());
		addRow(tab2, Mod2002024Key.UT1456.getDescription(), c01456, AON.CSS.aonWidth440());
		...
		addRow(tab3, Mod2002024Key.UT1458.getDescription(), c01458);    
		addRow(tab3, Mod2002024Key.UT1459.getDescription(), c01459);   
		addRow(tab3, Mod2002024Key.UT1460.getDescription(), c01460);   
		addRow(tab3, Mod2002024Key.UT1461.getDescription(), c01461);   
		addRow(tab3, Mod2002024Key.UT1467.getDescription(), c01467);   
		addRow(tab3, Mod2002024Key.UT1468.getDescription(), c01468);   
		addRow(tab3, Mod2002024Key.UT1523.getDescription(), c01523);   
		addRow(tab3, Mod2002024Key.UT1601.getDescription(), c01601);   
		addRow(tab3, Mod2002024Key.UT1638.getDescription(), c01638);   
		addRow(tab3, Mod2002024Key.UT1639.getDescription(), c01639);   
		addRow(tab3, Mod2002024Key.UT1640.getDescription(), c01640);   
		addRow(tab3, Mod2002024Key.UT1743.getDescription(), c01743);   
		addRow(tab3, Mod2002024Key.UT1909.getDescription(), c01909);   
		addRow(tab3, Mod2002024Key.UT1910.getDescription(), c01910);   
		addRow(tab3, Mod2002024Key.UT1911.getDescription(), c01911);   
		addRow(tab3, Mod2002024Key.UT1912.getDescription(), c01912);   
		addRow(tab3, Mod2002024Key.UT1934.getDescription(), c01934); 
