package com.esferalia.aon.gwt.mod200.server.file;
/*
...
public class MOD2002013Writer {
	...
	public FileOutput createMOD200(Mod2002013 mod200) throws AonSQLException {
		try {
			...
			Mod2002013File mod200file = new Mod2002013File( mod200 ); 
			...
			FileFiller filler = new MOD2002013(mod200file, format, writer);
