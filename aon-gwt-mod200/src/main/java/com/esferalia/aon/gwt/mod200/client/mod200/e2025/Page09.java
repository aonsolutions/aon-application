...
public class Page09 extends PageAbs {
	...
	private enum CorrectionKey implements Serializable,IMod200KeysProvider {
		 DC01(false,Mod2002025Key.DC2305,Mod2002025Key.DC2306,"Saldo pendiente de correcciones temporarias a principio de ejercicio")
		,DC02(false,Mod2002025Key.DC2301,Mod2002025Key.DC2302,"Correcciones del ejercicio: Correcciones permanentes (excluidas las correcciones por IS y por IC)")
		,DC03(false,Mod2002025Key.DC2303,Mod2002025Key.DC2304,"Correcciones del ejercicio: Correcciones temporarias con origen en el ejercicio")
		,DC04(false,Mod2002025Key.DC2307,Mod2002025Key.DC2308,"Correcciones del ejercicio: Correcciones temporarias con origen en ejercicios anteriores")
		,DC05(true ,Mod2002025Key.I0417B,Mod2002025Key.D0418B,"Total correcciones al resultado de la cuenta de p\u00E9rdidas y ganancias del ejercicio")
		,DC06(false,Mod2002025Key.DC2309,Mod2002025Key.DC2310,"Saldo pendiente de correcciones temporarias a fin de ejercicio ")
		;
		...
		private CorrectionKey(boolean title,Mod2002025Key k1,Mod2002025Key k2,String description) {
			this.title = title;
			this.description = description; 
			this.keys = new Mod2002025Key[]{k1,k2};
		}
	...
	public Page09( Model2002025PageCallback callback ) {
		super(callback);
	}
	...
	protected void initializeTable() {
		...
		paintKeyDescription(tab1, Mod2002025Key.LQ301, row, 0);
		paintKeyField(tab1, Mod2002025Key.LQ301, row, 1);
		paintKeyField(tab1, Mod2002025Key.LQ302, row, 2);
		paintEmptyCell(tab1, row, 3);
		++row;
		
		paintKeyDescription(tab1, Mod2002025Key.LQ004, row, 0);
		paintKeyField(tab1, Mod2002025Key.LQ004, row, 1);
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0009) || callback.getMod200Object().getMod200().isChecked(Mod2002025Key.C0010) ) {
			...
			paintEmptyCell(tab1, row, 3);
			++row;
			paintDescription(tab1, Mod2002025Key.LQ1230.getDescription(), row, 0, false, 137);
			paintKeyField(tab1, Mod2002025Key.LQ1230, row, 1);
			paintKeyField(tab1, Mod2002025Key.LQ1231, row, 2);
			paintEmptyCell(tab1, row, 3);
		}
		...
		paintKeyDescription(tab2, Mod2002025Key.I0417, row, 0);
		paintKeyField(tab2, Mod2002025Key.I0417, row, 1, true);
		paintKeyField(tab2, Mod2002025Key.D0418, row, 2, true);
		...
		for (CorrectionKey ck : CorrectionKey.values()) {
			...
			int col = 1; 
			for (Mod2002025Key key : ck.getKeys() ) {
				if (key != null) {
