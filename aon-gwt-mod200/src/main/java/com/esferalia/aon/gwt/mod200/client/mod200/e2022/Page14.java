...
public class Page14 extends PageAbs {
	...
	protected void initializeTable() {
		...
		addTable("", Mod2002022Constants.INCOME_DISTRIBUTION_KEYS_1);
		...
		int row = 0;
		for (final Mod2002022Key key : Mod2002022Constants.INCOME_DISTRIBUTION_KEYS_2) {
			if (callback.getMod200Object().isVisible(key)) {
				row = paintKey(table1, key, row);
				if (key == Mod2002022Key.ID1270 || key == Mod2002022Key.ID1271 || key == Mod2002022Key.ID1522) {
