...
@WebServlet(name = "Mod200 - 2018 Accounting Upload ", urlPatterns = { "/aon_gwt_mod200/Mod2002018AccountingUpload" })
public class Mod2002018AccountingUpload extends UploadAction {
		...
		for (FileItem item : sessionFiles) {
			if (false == item.isFormField()) {
				try {
					...
					MOD2002018 xml = (MOD2002018) um.unmarshal(input);
					request.getSession().setAttribute("Mod2002018Accounting", xml);
				} catch (Exception ex) {
