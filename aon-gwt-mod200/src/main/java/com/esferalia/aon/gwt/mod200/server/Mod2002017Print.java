...
import com.esferalia.aon.occam.mod200.server.format.Mod2002017Writer;
import com.esferalia.aon.watson.server.io.AonIOUtils;

@SuppressWarnings("serial")
@WebServlet(name = "Mod200 - 2017 Print", urlPatterns = { "/aon_gwt_mod200/Model2002017Print" })
public class Mod2002017Print extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Mod2002017Writer.fillWriter(mod200, writer);
