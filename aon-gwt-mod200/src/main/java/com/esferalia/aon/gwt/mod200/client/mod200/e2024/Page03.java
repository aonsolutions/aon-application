...
import com.esferalia.aon.gwt.mod200.client.mod200.e2024.ParticipationPanel.ParticipationPanelCallback;
...
public class Page03 extends PageAbs {
	...
	public Page03( Model2002024PageCallback callback ) {
		super(callback);	
	...
	protected void calculate() {
		...
		callback.getMod200Object().doubleValueChanged(Mod2002024Key.P1501, callback.getMod200Object().getDoubleValue(Mod2002024Key.P1501));
	}
...
//		grid.addStyleName(AON.CSS.aonBlockCenter());
		...
		int row = 0;
		for (final Mod2002024Key key : Mod2002024Constants.PARTICIPATION_KEYS) {
		...
		paintKey(tab3, Mod2002024Key.POR51, 0);
		paintKey(tab3, Mod2002024Key.PORES, 1);
