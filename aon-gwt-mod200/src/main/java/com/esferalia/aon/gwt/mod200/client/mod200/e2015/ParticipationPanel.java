...
public class ParticipationPanel extends CustomDialog {
	...
	public void dump(Mod200CompanyParticipation cp) {
		...
		this.dValue.setValue(companyParticipation.getCorrectionEffect());
		this.eValue.setValue(companyParticipation.getCorrectionsBalance());
	...
	public void onClose() {
		...
		companyParticipation.setCorrectionEffect(this.dValue.getValue());
		companyParticipation.setCorrectionsBalance(this.eValue.getValue());
