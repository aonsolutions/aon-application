...
@WebServlet(name = "Mod2002024 Check AEAT", urlPatterns = { "/aon_gwt_mod200/ms/Mod2002024CheckAEAT" })
public class Mod2002024CheckAEAT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Model200AdmonUtils.checkAEAT(resp, aeatParams, mod2002024);
		} catch (Exception e) {
