...
@WebServlet(name = "Mod200 - 2023 File download", urlPatterns = { "/aon_gwt_mod200/ms/Model2002023File" })
public class Mod2002023File extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			Occam occam = new Occam().setDomainName(domainName)
									.setDomain(domainId)
									.setUser(user);
			Mod2002023 mod200 = MODEL2002023.getMod2002023ById(occam,id);
