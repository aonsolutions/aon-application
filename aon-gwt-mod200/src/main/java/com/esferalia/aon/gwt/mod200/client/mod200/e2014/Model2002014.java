...
public class Model2002014 extends ResizeComposite  {
	
	interface Model2002014Binder extends
			UiBinder<Widget, Model2002014> {
	}

	private static final Model2002014Binder binder = GWT
			.create(Model2002014Binder.class);

	protected Mod2002014Object mod200Object;
	...
	public Model2002014(Model200ModuleOptions options, Model200Callback mod200Callback) {
	...
	protected void paintHeaderTable(final Mod2002014 mod200) {
	...
	private class PopupAsyncCallback implements AsyncCallback<Mod2002014> {
		PopupPanel popup;
	...
	public void startModel(final Mod2002014Object modObject) {
	...
	private void populatePages(Mod2002014Object mod200Object) {
		page00.populate(mod200Object);
...
*/
	public void validationMessageSelected(ValidationMessage2014 msg) {
		if ( msg.getPage() >= 0 ) {
	...
	void onAeatAccountingFileButtonClick(ClickEvent event) {
		...
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002014AccountingFile");
	...
	void onAeatFileButtonClick(ClickEvent event) {
		Window.alert(
				...
				+ "El fichero se genera a partir de los datos guardados.");
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002014File");
		modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
		domainIdHidden.setValue(String.valueOf(options.getDomain()));
		domainNameHidden.setValue(options.getDomainName());
		diskForm.submit();
	...
	void onAeatPrintButtonClick(ClickEvent event) {
		...
		diskForm.setAction(GWT.getHostPageBaseURL()
				+ "/aon_gwt_mod200/Model2002014Print");
		modIdHidden.setValue(String.valueOf(mod200Object.getMod200().getId()));
		domainIdHidden.setValue(String.valueOf(options.getDomain()));
		domainNameHidden.setValue(options.getDomainName());
		diskForm.submit();
