...
@WebServlet(name = "Mod200 - 2015 Print", urlPatterns = { "/aon_gwt_mod200/Model2002015Print" })
public class Mod2002015Print extends HttpServlet {
	...
	private void downloadPDF(HttpServletRequest req, HttpServletResponse resp,
		...
		String urlParameters = "HID=SOV5200A"  
				+"&IDI=ES" 
				+"&LEV=000000000000"
				+"&FIC=" + encodedFile  
				+"&RUT="  
