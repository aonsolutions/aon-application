...
import com.esferalia.aon.occam.mod200.impl.jooq.dao.mod200_2023.jaxb.Mod2002023toMOD2002023;
import com.esferalia.aon.occam.server.fiscal.format.AonFiscalFileUtils;

@SuppressWarnings("serial")
@WebServlet(name = "Mod200 - 2023 Accounting File", urlPatterns = { "/aon_gwt_mod200/ms/Model2002023AccountingFile" })
public class Mod2002023AccountingFile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			MOD2002023 mod = Mod2002023toMOD2002023.getMOD2002023(mod200);
