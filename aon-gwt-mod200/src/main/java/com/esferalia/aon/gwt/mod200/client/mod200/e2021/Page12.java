...
public class Page12 extends PageAbs {
	...
	protected void initializeTable() {
		...
		paintTable(addTable(2), Mod2002021Constants.LIQUIDATION_V_KEYS_2, HEADERS_2);
		
		paintTable(addTable(AON.MSG.splittedPayments(), 2), Mod2002021Constants.LIQUIDATION_V_KEYS_3, HEADERS_2);
		
		paintTable(addTable(AON.MSG.netQuota(),2), Mod2002021Constants.LIQUIDATION_V_KEYS_4, HEADERS_2);
		paintTable(addTable(3), Mod2002021Constants.LIQUIDATION_V_KEYS_5, HEADERS_3);		
