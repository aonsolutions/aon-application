...
public class Page02 extends PageAbs {
	...
	protected void calculate() {
		callback.getMod200Object().doubleValueChanged(Mod2002022Key.P1501, callback.getMod200Object().getDoubleValue(Mod2002022Key.P1501));
	}
...
//		grid.addStyleName(AON.CSS.aonBlockCenter());
		...
		int row = 0;
		for (final Mod2002022Key key : Mod2002022Constants.PARTICIPATION_KEYS) {
		...
		paintKey(tab3, Mod2002022Key.POR51, 0);
		paintKey(tab3, Mod2002022Key.PORES, 1);
