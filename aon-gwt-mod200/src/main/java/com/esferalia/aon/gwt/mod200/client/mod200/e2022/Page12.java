...
public class Page12 extends PageAbs {
	...
	protected void initializeTable() {
		...
		paintTable(AON.MSG.yearQuota(), Mod2002022Constants.LIQUIDATION_V_KEYS_1, HEADERS_1, Mod2002022Key.LQ1766);
		paintTable("", Mod2002022Constants.LIQUIDATION_V_KEYS_2, HEADERS_2, Mod2002022Key.BN599);
		paintTable(AON.MSG.splittedPayments(), Mod2002022Constants.LIQUIDATION_V_KEYS_3, HEADERS_2, Mod2002022Key.BN611);
		paintTable("Resultado de la autoliquidaci\u00F3n", Mod2002022Constants.LIQUIDATION_V_KEYS_4, HEADERS_2, null);
		paintTable("", Mod2002022Constants.LIQUIDATION_V_KEYS_5, HEADERS_3, Mod2002022Key.LQ1586);
		...
		paintTable(AON.MSG.netQuota(), Mod2002022Constants.LIQUIDATION_V_KEYS_6, HEADERS_2, Mod2002022Key.BN621);
		paintTable("Opci\u00F3n de fraccionamiento en supuestos de cambios de residencia (art. 19.1 LIS)", Mod2002022Constants.LIQUIDATION_V_KEYS_7, HEADERS_2, Mod2002022Key.LQ2485);
		basePanel.add(getSubtitle("L\u00EDquido a ingresar"));
		paintTable("", Mod2002022Constants.LIQUIDATION_V_KEYS_8, HEADERS_2, Mod2002022Key.LQ2489);
		paintTable("Conversi\u00F3n de activos por impuesto diferido en cr\u00E9dito exigible frente a la Administraci\u00F3n tributaria (art. 130 LIS)", Mod2002022Constants.LIQUIDATION_V_KEYS_9, HEADERS_3, null);
		basePanel.add(getSubtitle(AON.MSG.netQuota()));
		paintTable("", Mod2002022Constants.LIQUIDATION_V_KEYS_10, HEADERS_3, null);
		
	}
	
	private void paintTable(String title, Mod2002022Key[][] liquidationKeys, String[] headers, Mod2002022Key boldKey) {
