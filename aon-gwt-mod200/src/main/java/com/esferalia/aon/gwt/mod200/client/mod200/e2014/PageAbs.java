...
import static com.esferalia.aon.occam.mod200.api.model.mod200_2014.Mod2002014Behaviour.BEHAVIOUR_KEYS_MAP;
...
import com.esferalia.aon.gwt.mod200.client.mod200.e2014.Mod2002014Object.IMod200ChangeListener;
...
public abstract class PageAbs extends ResizeComposite {
	...
	private HashMap<Mod2002014Key, DoubleBox> inputs = new HashMap<Mod2002014Key, DoubleBox>();
	private HashMap<Mod2002014Key, BoxLabel> labels = new HashMap<Mod2002014Key, BoxLabel>();
	...
	public Map<Mod2002014Key, BoxLabel> getLabels() {
		return labels;
	}
	
	protected int paintKey(final Mod2002014Key key,int row) {
	...
	protected boolean isTitle(Mod2002014Key key) {
		Boolean[] behaviour = BEHAVIOUR_KEYS_MAP.get(key.toString());
