...
import static com.esferalia.aon.occam.mod200.api.model.mod200_2025.Mod2002025Constants.UTE_KEYS_B7;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2025.Mod2002025Constants.UTE_KEYS_B8_1;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2025.Mod2002025Constants.UTE_KEYS_B8_2;
...
import com.esferalia.aon.gwt.mod200.client.mod200.e2025.UteParticipationBisPanel.UteParticipationBisPanelCallback;
...
public class Page19 extends PageAbs {
	...
	public Page19( Model2002025PageCallback callback ) {
		super(callback);
	...
	protected boolean isAvailable() {
		return super.isAvailable() && isCheckedOr(Mod2002025Key.C0013, Mod2002025Key.C0085, Mod2002025Key.C0014, Mod2002025Key.C0089);				
	}
	...
	private void paint() {
		...
		if (isCheckedOr(Mod2002025Key.C0013, Mod2002025Key.C0085)) {			
			paintKey(addTable(AON.MSG.ute1()), Mod2002025Key.UT060, 0);
		}

		// B) Datos Económicos
		if (isCheckedOr(Mod2002025Key.C0013, Mod2002025Key.C0085, Mod2002025Key.C0014)) {
		
			FlexTable table1 = addTable("B) Datos Econ\u00F3micos");
			int row = 0;
			paintKey(table1, Mod2002025Key.UT500 , row++);
			paintKey(table1, Mod2002025Key.UT1227, row++);
			paintKey(table1, Mod2002025Key.UT1228, row++);
			paintKey(table1, Mod2002025Key.UT552 , row++);
			paintKey(table1, Mod2002025Key.UT1330, row++);
			...
			paintKey(table1, Mod2002025Key.UT070, row++); table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
			paintKey(table1, Mod2002025Key.UT072, row++); table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
	...
	private void paintPar1Panel() {
		...
		for (int i = 0; i < callback.getMod200Object().getMod200().getUteParticipations().size(); i++) {
			...
			percent.addValueChangeHandler(event -> {
	    		...
	    		double c1330 = callback.getMod200Object().getMod200().getVariable(Mod2002025Key.UT1330).getValue();
