...
@WebServlet(name = "Mod2002025 Send AEAT", urlPatterns = { "/aon_gwt_mod200/ms/Mod2002025SendAEAT" })
public class Mod2002025SendAEAT extends HttpServlet {

	private static final long serialVersionUID = 1791764245316509853L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Model200AdmonUtils.send(resp, aeatParams, mod2002025);
		} catch (Exception e) {
