...
public class Page17 extends PageAbs {
	...
	public Page17( Model2002024PageCallback callback ) {
		super(callback);
	}
	...
	protected void initializeTable() {
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002024Key.C0029)) {
			...
			row++;
			paintKeysProvider(Mod2002024RIC_1Key.values(), table1, row, false, 
					"",
			...
			// Importe de la dotación RIC con cargo a beneficios de 2024 (Casilla 927)
			...
			row = 0;
			paintKey(table2, Mod2002024Key.RC927, row);
			
			// RIC - Inversiones anticipadas
	
			paintKeysProvider(Mod2002024RIC_2Key.values(), addTable("", 4, "150px"), 0, false, 
					"",
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002024Key.C0086)) {
			...
			table1.getFlexCellFormatter().setColSpan(row, 2, 4);
			row++;
			paintKeysProvider(Mod2002024RIIB_1Key.values(), table1, row, false, 
					"",
			...
			// Importe de la dotación RIIB con cargo a beneficios de 2024 (Casilla 02918)
			...
			table2.getColumnFormatter().setWidth(1, "200px");
			row = 0;
			paintKey(table2, Mod2002024Key.RB2918, row);
			
			// RIIB - Inversiones anticipadas
	
			paintKeysProvider(Mod2002024RIIB_2Key.values(), addTable("", 4, "150px"), 0, false, 
					"",
	...
	protected boolean isAvailable() {		
		return super.isAvailable() && (isCheckedOr(Mod2002024Key.C0029,Mod2002024Key.C0086));
	}
