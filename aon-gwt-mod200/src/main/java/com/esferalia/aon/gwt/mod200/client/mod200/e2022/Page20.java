...
public class Page20 extends PageAbs {
	...
	private void paint() {
		...
		int row = 0;		
		row = paintKey(table, Mod2002022Key.LQ552, row, false, true);
		row = paintKey(table, Mod2002022Key.LQ562, row, false, true);
		paintDescription(table, Mod2002022Key.BN621.getDescription() + ": Estado", row, 0, false);
		...
		paintKeyField(table2, Mod2002022Key.BN1020, 0, 1, true, "A", false);
		paintDescription(table2, "Compensaci\u00F3n por conversi\u00F3n de activos por impuesto diferido (art. 130 LIS)", 1, 0, true);
		paintKeyField(table2, Mod2002022Key.BN1021, 1, 1, true, "C", false);		
		paintDescription(table2, Mod2002022Key.LQ3318.getDescription(), 2, 0, false);
		paintKeyField(table2, Mod2002022Key.LQ3318, 2, 1, true, "3318", false);
		paintDescription(table2, Mod2002022Key.LQ2490.getDescription(), 3, 0, false);
		paintKeyField(table2, Mod2002022Key.LQ2490, 3, 1, true, "2490", false);
		paintDescription(table2, Mod2002022Key.LQ2493.getDescription(), 4, 0, false);
		paintKeyField(table2, Mod2002022Key.LQ2493, 4, 1, true, "2493", false);
	...
	private void dumpPay(Mod2002022 mod200) {
