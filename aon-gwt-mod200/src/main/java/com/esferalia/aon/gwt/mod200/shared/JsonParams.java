...
//		json.put(IRequestParamsNames.WITHHOLDING_TYPE_GROUP,params.getWithholdingTypeGroup() == null? JSON_NULL : new JSONNumber( params.getWithholdingTypeGroup().ordinal()));
