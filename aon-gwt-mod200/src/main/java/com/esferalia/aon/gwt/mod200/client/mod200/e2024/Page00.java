...
import static com.esferalia.aon.occam.mod200.api.model.mod200_2024.Mod2002024Character.CHARACTER_ALSO_CHECK_MAP;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2024.Mod2002024Character.CHARACTER_INCOMPATIBILITY_MAP;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2024.Mod2002024Character.NOT_SUPPORTED_CHARACTERS;
...
public class Page00 extends PageAbs {
	...
	public Page00( Model2002024PageCallback callback ) {
		super(callback);		
	}
	...
	public void dump() {
		...
		if (callback.getMod200Object().getMod200().getBalanceType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0051, true);
		}
		...
		if (callback.getMod200Object().getMod200().getPygType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0054, true);
		}		
		...
		for (Mod2002024Key key : inputsCheckBox.keySet()) {
		...
		DoubleVariableEx sv = callback.getMod200Object().getMod200().getVariable(Mod2002024Key.C0027);
		if (sv != null && inputsCheckBox.containsKey(Mod2002024Key.C0027)) {
    ...
    protected void setEnabled() {
		...
		if (inputsCheckBox.containsKey(Mod2002024Key.C0027)) {
			inputsCheckBox.get(Mod2002024Key.C0027).setEnabled(false);
		}
	...
	private void paint() {
		...
		agriculturalActivities.addClickHandler(event -> {			
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.X0001, agriculturalActivities.getValue());
			callback.markAsDirty();
		});
		...
		balanceSheetType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0050, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0051, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0052, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.PYMES));
			callback.markAsDirty();
		});
		...
		ecpnType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0075, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0076, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0077, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.PYMES));
			callback.markAsDirty();
		});
		...
		profitAndLossType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0053, (callback.getMod200Object().getMod200().getPygType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0054, (callback.getMod200Object().getMod200().getPygType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002024Key.C0055, (callback.getMod200Object().getMod200().getPygType() == BalanceType.PYMES));
			callback.markAsDirty();
		});	
	...
	private void initializeCharactersTable(FlexTable table, Mod2002024Key[] declarationCharactersBlock) {
		table.setWidth("100%");
		...
		for (final Mod2002024Key key : declarationCharactersBlock ) {
			if (key != Mod2002024Key.C0012R) {
	...
	private void changeAvailability(Mod2002024Key key) {
		...
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002024Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002024Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
