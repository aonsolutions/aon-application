...
import static com.esferalia.aon.occam.mod200.api.model.mod200_2018.Mod2002018Character.CHARACTERS_KEYS;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2018.Mod2002018Character.CHARACTER_ALSO_CHECK_MAP;
import static com.esferalia.aon.occam.mod200.api.model.mod200_2018.Mod2002018Character.CHARACTER_INCOMPATIBILITY_MAP;
...
import com.esferalia.aon.gwt.mod200.client.mod200.e2018.Mod2002018Object.IMod200ChangeListener;
...
public class Page00 extends PageAbs {
	public static final HashSet<Mod2002018Key> NOT_SUPPORTED_CHARACTERS = new HashSet<Mod2002018Key>();
	static {
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0003);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0004);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0007);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0024);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0025);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0035);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0036);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0058);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002018Key.C0061);
	};

	public static final Mod2002018Key[] DECLARATION_CHARACTERS_BLOCK1 = new Mod2002018Key[] {
		 Mod2002018Key.C0001,Mod2002018Key.C0002,Mod2002018Key.C0003
		,Mod2002018Key.C0004,Mod2002018Key.C0005,Mod2002018Key.C0011
		,Mod2002018Key.C0013,Mod2002018Key.C0014,Mod2002018Key.C0017
		,Mod2002018Key.C0018,Mod2002018Key.C0019,Mod2002018Key.C0021
		,Mod2002018Key.C0023,Mod2002018Key.C0024,Mod2002018Key.C0025
		,Mod2002018Key.C0031,Mod2002018Key.C0032,Mod2002018Key.C0036
		,Mod2002018Key.C0048,Mod2002018Key.C0058,Mod2002018Key.C0060
		,Mod2002018Key.C0066
	};

	public static final Mod2002018Key[] DECLARATION_CHARACTERS_BLOCK2 = new Mod2002018Key[] {
	 	 Mod2002018Key.C0006,Mod2002018Key.C0015,Mod2002018Key.C0015G,Mod2002018Key.C0022
	...
	public static final Mod2002018Key[] DECLARATION_CHARACTERS_BLOCK3 = new Mod2002018Key[] {
		 Mod2002018Key.C0007,Mod2002018Key.C0009,Mod2002018Key.C0010
		,Mod2002018Key.C0016,Mod2002018Key.C0026,Mod2002018Key.C0027
		,Mod2002018Key.C0030,Mod2002018Key.C0039,Mod2002018Key.C0043
		,Mod2002018Key.C0045,Mod2002018Key.C0063,Mod2002018Key.C0071
		,Mod2002018Key.C0059,Mod2002018Key.C0065,Mod2002018Key.C0067
		,Mod2002018Key.C0070,Mod2002018Key.C0072,Mod2002018Key.C0073
	};
	
	private Map<Mod2002018Key, CheckBox> inputs = new HashMap<Mod2002018Key, CheckBox>();
	...
	public Page00( Model200PageCallback callback ) {
		...
		callback.getMod200Object().register( new IMod200ChangeListener() {
			...
			public void mod200Changed(Mod2002018 mod200) {
				DoubleVariable2018 sv = mod200.getVariable(Mod2002018Key.C0027);
				if (sv != null && inputs.containsKey( Mod2002018Key.C0027 )) {
					inputs.get( Mod2002018Key.C0027 ).setValue( AonMathUtils.equals(sv.getValue() , 1.0) );
				}
			}
		});
	}
	...
	public void dump() {
		...
		DoubleVariable2018 dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002018Key.C0041);
		Double value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002018Key.C0042);
		value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		for (Mod2002018Key key : CHARACTERS_KEYS) {
			DoubleVariable2018 sv = callback.getMod200Object().getMod200().getKeysMap().get(key);
	...
	protected void initializeTable() {
		c061.setText(Mod2002018Key.C0061.getDescription());
		inputs.put(Mod2002018Key.C0061, c061);
	...
	private int initializeBlock(FlexTable table,int row, Mod2002018Key[] declarationCharatersBlock) {
	...
	private void changeAvailability(Mod2002018Key key) {
		boolean enabled = inputs.get(key).getValue();
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002018Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002018Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
