...
public class Page18 extends PageAbs {
	...
	private void paint() {
		...
		if (callback.getMod200Object().getMod200().isChecked(Mod2002022Key.C0013)) {
			paintKey(addTable(AON.MSG.ute1()), Mod2002022Key.UT060, 0);
		}
		...
		int row = 0;
		paintKey(table1, Mod2002022Key.UT500 , row++);
		paintKey(table1, Mod2002022Key.UT1227, row++);
		paintKey(table1, Mod2002022Key.UT1228, row++);
		paintKey(table1, Mod2002022Key.UT552 , row++);
		paintKey(table1, Mod2002022Key.UT1330, row++);
		...
		paintKey(table1, Mod2002022Key.UTC01, row++);
		paintDescription(table1, AON.MSG.ute4(), row++, 0, false);
		paintKey(table1, Mod2002022Key.UTC02, row++);
		table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table1, Mod2002022Key.UTC03, row++);
		table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table1, Mod2002022Key.UT062, row++);
		paintDescription(table1, AON.MSG.ute5(), row++, 0, false);
		paintKey(table1, Mod2002022Key.UTC04, row++);
		table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table1, Mod2002022Key.UTC05, row++);
		table1.getCellFormatter().addStyleName(row-1, 0, AON.AON_CSS.aonPadding2Left());
	...
	private void paintB11Panel() {
		...
		for (int i = 0; i < callback.getMod200Object().getMod200().getUteParticipations().size(); i++) {
			...
			percent.addValueChangeHandler(event -> {
	    		...
	    		double c1330 = callback.getMod200Object().getMod200().getVariable(Mod2002022Key.UT1330).getValue();
