...
public class Page18 extends PageAbs {
	...
	protected void initializeTable() {
		boolean c0013 = callback.getMod200Object().getMod200().isChecked(Mod2002017Key.C0013);
		groupPanelA.setVisible(c0013);
		if (c0013) {
			table.setWidth("100%");
			table.setCellSpacing(0);
			table.getColumnFormatter().setWidth(1, "200px");
			paintKey(table, Mod2002017Key.UT060, 0);
		} 
		...
		paintKey(table1, Mod2002017Key.UT500 , row++);
		paintKey(table1, Mod2002017Key.UT1227, row++);
		paintKey(table1, Mod2002017Key.UT1228, row++);
		paintKey(table1, Mod2002017Key.UT552 , row++);
		paintKey(table1, Mod2002017Key.UT1330, row++);

		table3.setWidth("100%");
		table3.setCellSpacing(0);
		table3.getColumnFormatter().setWidth(1, "200px");
		paintKey(table3, Mod2002017Key.UTC01, row++);
		paintDescription(table3, AON.MSG.ute4(), row++, 0, false);
		paintKey(table3, Mod2002017Key.UTC02, row++);
		table3.getCellFormatter().addStyleName(row, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table3, Mod2002017Key.UTC03, row++);
		table3.getCellFormatter().addStyleName(row, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table3, Mod2002017Key.UT062, row++);
		paintDescription(table3, AON.MSG.ute5(), row++, 0, false);
		paintKey(table3, Mod2002017Key.UTC04, row++);
		table3.getCellFormatter().addStyleName(row, 0, AON.AON_CSS.aonPadding2Left());
		paintKey(table3, Mod2002017Key.UTC05, row++);
		table3.getCellFormatter().addStyleName(row, 0, AON.AON_CSS.aonPadding2Left());
		...
		percentColumn.setFieldUpdater(new FieldUpdater<UteParticipation, String>() {
		    public void update(int index, UteParticipation cp, String value) {
		    	try {
		    		...
		    		double c1330 = callback.getMod200Object().getMod200().getVariable(Mod2002017Key.UT1330).getValue();
...
//		});		
	...
	protected boolean isAvailable() {
		boolean av = super.isAvailable()
  		  && (callback.getMod200Object().getMod200().isChecked(Mod2002017Key.C0013) 
		   || callback.getMod200Object().getMod200().isChecked(Mod2002017Key.C0014));
		return av;
	}
