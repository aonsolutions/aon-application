...
public class Page15 extends PageAbs {
	...
	protected void initializeTable() {
		...
		addTable("", Mod2002024Constants.INCOME_DISTRIBUTION_KEYS_1);
		...
		int row = 0;
		for (final Mod2002024Key key : Mod2002024Constants.INCOME_DISTRIBUTION_KEYS_2) {
			if (callback.getMod200Object().isVisible(key)) {
				row = paintKey(table1, key, row);
				if (key == Mod2002024Key.ID1270 || key == Mod2002024Key.ID1271 || key == Mod2002024Key.ID1522) {
