...
//		}
	...
	public void manageLinks() {
		// FALTA - PONER CADA UNO LO QUE CORRESPONDA
		...
		// FALTA - BORRADOR SE VE SIEMPRE ?? O CUANDO ESTA PENDIENTE o finalizado??
		validateLink.setVisible( !getCallback().isDirty() && (getCallback().getModel().getStatus() == FiscalStatus.PENDING || getCallback().getModel().getStatus() == FiscalStatus.FINISHED) );
