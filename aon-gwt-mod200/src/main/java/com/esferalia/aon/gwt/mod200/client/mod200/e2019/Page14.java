...
public class Page14 extends PageAbs {
	...
	protected void initializeTable() {
		...
		int row = 0;
		for (final Mod2002019Key key : Mod2002019Constants.INCOME_DISTRIBUTION_KEYS_1) {
		...
		row = 0;
		for (final Mod2002019Key key : Mod2002019Constants.INCOME_DISTRIBUTION_KEYS_2) {
			if (callback.getMod200Object().isVisible(key)) {
				row = paintKey(table1,key,row);
				if (key == Mod2002019Key.ID1270 || key == Mod2002019Key.ID1271 || key == Mod2002019Key.ID1522) {
