...
public class Page17 extends PageAbs {
	...
	protected void initializeTable() {
		...
		row++;
		paintKeysProvider(Mod2002021LM1494Key.values(), table, row, new String[] {
				AON.MSG.liquiMsg1(),
				AON.MSG.dot11(),
				AON.MSG.dot12(),
				AON.MSG.dot22(),
...
//		}
		...
		row++;
		paintKeysProvider(Mod2002021LM1535Key.values(), table2, row, new String[] {
				"",  
				AON.MSG.dot30(),
				AON.MSG.dot41(),
				AON.MSG.dot31(),
		...
		row++;
		paintKeysProvider(Mod2002021LM1561Key.values(), table3, row, new String[] {
				"",
				AON.MSG.dot40(),
				AON.MSG.dot41(),
				AON.MSG.dot42(),
		...
		paintKeysProvider(Mod2002021LM1579Key.values(), addTable(AON.MSG.damageAmount6(), 4), new String[] {
				"",
				AON.MSG.dot50(),
				AON.MSG.dot51(),
				AON.MSG.dot52(),
