...
public class ParticipationPanel extends AonCustomDialog {	
	...
	private void paint() {
		...
		addRow(tab2, Mod2002024Key.P1501.getDescription(), nominalValue);
		addRow(tab2, Mod2002024Key.P1502.getDescription(), bookValue);
		addRow(tab2, Mod2002024Key.P1503.getDescription()+" (*)", incomes);
