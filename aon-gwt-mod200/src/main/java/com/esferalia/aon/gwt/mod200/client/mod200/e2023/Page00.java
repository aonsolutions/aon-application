...
//	};
	...
	public Page00( Model2002023PageCallback callback ) {
		super(callback);		
	}
	...
	public void dump() {
		...
		agriculturalActivities.setValue(callback.getMod200Object().getMod200().getBooleanValue(Mod2002023Key.X0001));
		...
		if (callback.getMod200Object().getMod200().getBalanceType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0051, true);
		}
		...
		if (callback.getMod200Object().getMod200().getPygType() == null) {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0054, true);
		}		
		...
		for (Mod2002023Key key : inputsCheckBox.keySet()) {
		...
		DoubleVariableEx sv = callback.getMod200Object().getMod200().getVariable(Mod2002023Key.C0027);
		if (sv != null && inputsCheckBox.containsKey(Mod2002023Key.C0027)) {
    ...
    protected void setEnabled() {
		...
		if (inputsCheckBox.containsKey(Mod2002023Key.C0027)) {
			inputsCheckBox.get(Mod2002023Key.C0027).setEnabled(false);
		}
	...
	private void paint() {
		...
		agriculturalActivities.addClickHandler(event -> {			
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.X0001, agriculturalActivities.getValue());
			callback.markAsDirty();
		});
		...
		tab.addLabelWidgetRow(AON.MSG.document(), nif)
		   ...
		   .addLabelWidgetRow(Mod2002023Key.X0001.getDescription(), agriculturalActivities)
		...
		balanceSheetType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0050, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0051, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0052, (callback.getMod200Object().getMod200().getBalanceType() == BalanceType.PYMES));
			callback.markAsDirty();
		});
		...
		ecpnType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0075, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0076, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0077, (callback.getMod200Object().getMod200().getEcpnType() == EcpnType.PYMES));
			callback.markAsDirty();
		});
		...
		profitAndLossType.addChangeHandler( event -> {
			...
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0053, (callback.getMod200Object().getMod200().getPygType() == BalanceType.NORMAL));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0054, (callback.getMod200Object().getMod200().getPygType() == BalanceType.ABREVIADO));
			callback.getMod200Object().getMod200().setBooleanValue(Mod2002023Key.C0055, (callback.getMod200Object().getMod200().getPygType() == BalanceType.PYMES));
			callback.markAsDirty();
		});	
...
//		opeVol.addItem("3 - Al menos 60 millones de euros");
		...
		inputsCheckBox = new HashMap<Mod2002023Key, CheckBox>();
...
//		initializeCharactersTable(charactersTable3, DECLARATION_CHARACTERS_BLOCK3);
	...
	private void initializeCharactersTable(FlexTable table, Mod2002023Key[] declarationCharactersBlock) {
		table.setWidth("100%");
		...
		for (final Mod2002023Key key : declarationCharactersBlock ) {
			if (key != Mod2002023Key.C0012R) {
	...
	private void changeAvailability(Mod2002023Key key) {
		...
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002023Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002023Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
