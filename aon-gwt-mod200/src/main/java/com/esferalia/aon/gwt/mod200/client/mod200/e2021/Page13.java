...
//		basePanel.add(getTitle("Determinaci\u00F3n del resultado de la autoliquidaci\u00F3n en cada una de las Administraciones"));
...
//		int row = 1;
//		for (Mod2002021Key[] keys : Mod2002021Constants.COMBINED_TAXATION_3) {
...
//		}
	...
	protected boolean isAvailable() {
		boolean av = super.isAvailable()
  		  && (callback.getMod200Object().getMod200().isChecked(Mod2002021Key.C0028));
		return av;
	}
