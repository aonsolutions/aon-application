			...
			public void onValueChange(ValueChangeEvent<Double> event) {
				try {
					...
					if (k==Mod2002021Key.BN103A) {						
						AonDoubleBox db = getInputs().get(Mod2002021Key.BN103B);
						db.setValue(d,true);
					}
					else if (k==Mod2002021Key.BN103B) {						
						AonDoubleBox db = getInputs().get(Mod2002021Key.BN103C);
						db.setValue(d,true);						
					}
					else if (k==Mod2002021Key.BN103C) {						
						AonDoubleBox db = getInputs().get(Mod2002021Key.BN103D);
						db.setValue(d,true);
					}
					else if (k==Mod2002021Key.BN103D) {						
						AonDoubleBox db = getInputs().get(Mod2002021Key.BN103A);
						db.setValue(d,true);
					}
