...
public class ParticipationPanel extends AonCustomDialog {	
	...
	private void paint() {
		...
		addRow(tab2, Mod2002025Key.P1501.getDescription(), nominalValue);
		addRow(tab2, Mod2002025Key.P1502.getDescription(), bookValue);
		addRow(tab2, Mod2002025Key.P1503.getDescription()+" (*)", incomes);
		...
		addRow(tab3, Mod2002025Key.P1504.getDescription()+" (**)", aValue);
		addRow(tab3, Mod2002025Key.P2376.getDescription(), bValue);
		addRow(tab3, Mod2002025Key.P1506.getDescription(), cValue);
		addRow(tab3, Mod2002025Key.P1809.getDescription(), dValue);
		addRow(tab3, Mod2002025Key.P1810.getDescription(), eValue);
		addRow(tab3, Mod2002025Key.P1507.getDescription(), fValue);
		addRow(tab3, Mod2002025Key.P1508.getDescription(), gValue);
