...
public class Page00 extends PageAbs {
	...
	public static final HashSet<Mod2002019Key> NOT_SUPPORTED_CHARACTERS = new HashSet<Mod2002019Key>();
	static {
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0003);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0004);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0007);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0024);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0025);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0035);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0036);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0058);
		NOT_SUPPORTED_CHARACTERS.add(Mod2002019Key.C0061);
	};

	public static final Mod2002019Key[] DECLARATION_CHARACTERS_BLOCK1 = new Mod2002019Key[] {
		Mod2002019Key.C0001,
		Mod2002019Key.C0002,
		Mod2002019Key.C0080,
		Mod2002019Key.C0003,
	...
	public static final Mod2002019Key[] DECLARATION_CHARACTERS_BLOCK2 = new Mod2002019Key[] {
		Mod2002019Key.C0006,
		Mod2002019Key.C0015,
		//Mod2002019Key.C0015G,
		Mod2002019Key.C0079,
		Mod2002019Key.C0022,
		Mod2002019Key.C0028,
		Mod2002019Key.C0047,
		...
		Mod2002019Key.C0064,
		Mod2002019Key.C0057,
		Mod2002019Key.C0012R,
		Mod2002019Key.C0020,
		Mod2002019Key.C0062
	};
	
	public static final Mod2002019Key[] DECLARATION_CHARACTERS_BLOCK3 = new Mod2002019Key[] {
		Mod2002019Key.C0007,
		Mod2002019Key.C0009,
		Mod2002019Key.C0010,
		Mod2002019Key.C0081,
	...
	private Map<Mod2002019Key, CheckBox> inputs = new HashMap<Mod2002019Key, CheckBox>();
	...
	@UiField
    CheckBox withoutApproving;
	@UiField	
    CheckBox newDeclaration;
	...
	public Page00( Model200PageCallback callback ) {
		...
		withoutApproving = new CheckBox();
	    newDeclaration = new CheckBox();;
		...
		callback.getMod200Object().register( new IMod200ChangeListener() {
			...
			public void mod200Changed(Mod2002019 mod200) {
				DoubleVariable2019 sv = mod200.getVariable(Mod2002019Key.C0027);
				if (sv != null && inputs.containsKey( Mod2002019Key.C0027 )) {
					inputs.get( Mod2002019Key.C0027 ).setValue( AonMathUtils.equals(sv.getValue() , 1.0) );
				}
			}
		});
	}
	...
	public void dump() {
		...
		complementaryReceipt.setEnabled(complementary.getValue() || newDeclaration.getValue());
		...
		DoubleVariable2019 dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002019Key.C0041);
		Double value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002019Key.C0042);
		value = 0.0;
		if (dv != null) {
			value = dv.getValue();
		}
		...
		for (Mod2002019Key key : CHARACTERS_KEYS) {
			DoubleVariable2019 sv = callback.getMod200Object().getMod200().getKeysMap().get(key);
		...
		dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002019Key.X0001);
		if (dv != null && inputs.containsKey(Mod2002019Key.X0001)) {
			boolean checked = AonMathUtils.equals(dv.getValue() , 1.0);
			inputs.get(Mod2002019Key.X0001).setValue( checked);
		}
		
		dv = callback.getMod200Object().getMod200().getKeysMap().get(Mod2002019Key.X0002);
		if (dv != null && inputs.containsKey(Mod2002019Key.X0002)) {
			boolean checked = AonMathUtils.equals(dv.getValue() , 1.0);
			inputs.get(Mod2002019Key.X0002).setValue(checked);
		}
	...
	protected void initializeTable() {
		c061.setText(Mod2002019Key.C0061.getDescription());
		inputs.put(Mod2002019Key.C0061, c061);
		
		withoutApproving.setText(Mod2002019Key.X0001.getDescription());
		inputs.put(Mod2002019Key.X0001, withoutApproving);
		
		newDeclaration.setText(Mod2002019Key.X0002.getDescription());
		inputs.put(Mod2002019Key.X0002, newDeclaration);
	...
	private int initializeBlock(FlexTable table,int row, Mod2002019Key[] declarationCharatersBlock) {
		...
		for (final Mod2002019Key key : declarationCharatersBlock ) {
			
			//if (key != Mod2002019Key.C0015G && key != Mod2002019Key.C0012R) {
			if (key != Mod2002019Key.C0012R) {
			   BoxLabel l = new BoxLabel( key.getCode( adm ) , Model2002019.BOX_LENGTH );
	...
	private void changeAvailability(Mod2002019Key key) {
		boolean enabled = inputs.get(key).getValue();
		if (CHARACTER_INCOMPATIBILITY_MAP.get(key) != null) {
			for (Mod2002019Key incompatible : CHARACTER_INCOMPATIBILITY_MAP.get(key)) {
		...
		if (enabled && CHARACTER_ALSO_CHECK_MAP.get(key) != null) {
			for (Mod2002019Key alsoCheck : CHARACTER_ALSO_CHECK_MAP.get(key)) {
	...
	@UiHandler("newDeclaration")
	void onChangeNewDeclaration(ClickEvent event) {		
		complementaryReceipt.setEnabled(complementary.getValue() || newDeclaration.getValue());
	}
	...
	protected void enableCharacters( boolean enabled) {
		...
		// Los checks de "sin cuentas anuales" y "nueva declaración", siempre se dejan modificar
		withoutApproving.setEnabled(true);
		newDeclaration.setEnabled(true);
