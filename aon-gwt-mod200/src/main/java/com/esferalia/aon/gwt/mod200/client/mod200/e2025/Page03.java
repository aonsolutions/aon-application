...
import com.esferalia.aon.gwt.mod200.client.mod200.e2025.ParticipationPanel.ParticipationPanelCallback;
...
public class Page03 extends PageAbs {
	...
	public Page03( Model2002025PageCallback callback ) {
		super(callback);	
	...
	protected void calculate() {
		...
		callback.getMod200Object().doubleValueChanged(Mod2002025Key.P1501, callback.getMod200Object().getDoubleValue(Mod2002025Key.P1501));
	}
	...
	private void paint() {
		...
		int row = 0;
		for (final Mod2002025Key key : Mod2002025Constants.PARTICIPATION_KEYS) {
		...
		paintKey(tab3, Mod2002025Key.POR51, 0);
		paintKey(tab3, Mod2002025Key.PORES, 1);
