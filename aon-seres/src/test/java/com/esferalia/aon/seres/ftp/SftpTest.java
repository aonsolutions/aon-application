...
public class SftpTest {
	...
	public void testConnectHostNull() {
		...
		try {
			connect(info);
			fail("Host Nulo, no se deber�a de haber conectado");
		} catch (JSchException e) {
	...
	public void testConnectHostIncorrect() {
		...
		try {
			connect(info);
			fail("Host Erroneo, no se deber�a de haber conectado.");
		} catch (JSchException e) {
	...
	public void testConnectUserNull() {
		...
		try {
			connect(info);
			fail("Usuario Nulo, no se deber�a de haber conectado.");
		} catch (JSchException e) {
...
//			}
	...
	public void testConnectUserIncorrect() {
		...
		try {
			connect(info);
			fail("Usuario Erroneo, no se deber�a de haber conectado.");
		} catch (JSchException e) {
			if(!e.getMessage().contains("Auth fail")) {
				fail(e.getMessage());
			}
	...
	public void testConnectPasswordNull() {
		...
		try {
			connect(info);
			fail("Contrase�a Nula, no se deber�a de haber conectado.");
		} catch (JSchException e) {
			if(!e.getMessage().contains("Auth fail")) {
				fail(e.getMessage());
			}
	...
	public void testConnectPasswordIncorrect() {
		...
		try {
			connect(info);
			fail("Contrase�a Erroneo, no se deber�a de haber conectado.");
		} catch (JSchException e) {
			if(!e.getMessage().contains("Auth fail")) {
				fail(e.getMessage());
			}
