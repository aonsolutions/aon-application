...
/**
 * NomdfdtoId generated by Expand 2.0.1
 */
@Embeddable
public class NomdfdtoId  implements java.io.Serializable {
    ...
    public NomdfdtoId(int cdg, int linea) {
       this.cdg = cdg;
       this.linea = linea;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NomdfdtoId) ) return false;
		 NomdfdtoId castOther = ( NomdfdtoId ) other; 
