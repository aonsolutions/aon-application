...
/**
 * Nomdtoex generated by Expand 2.0.1
 */
@Entity
@Lines(joinProperty="nominaex")
@Table(name="nomdtoex")
public class Nomdtoex  implements java.io.Serializable {

     private NomdtoexId id;
    ...
    public Nomdtoex(NomdtoexId id, String concepto, BigDecimal importe) {
        this.id = id;
        this.concepto = concepto;
        this.importe = importe;
    }

    public Nomdtoex(NomdtoexId id, String concepto, BigDecimal importe, Date fecnew, Date hornew, Date fecmod, Date hormod, Nominaex nominaex) {
       this.id = id;
       this.concepto = concepto;
       this.importe = importe;
       this.fecnew = fecnew;
    ...
    public NomdtoexId getId() {
        return this.id;
    }
    
    public void setId(NomdtoexId id) {
        this.id = id;
    }
