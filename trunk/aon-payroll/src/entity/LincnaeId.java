...
/**
 * LincnaeId generated by Expand 2.0.1
 */
@Embeddable
public class LincnaeId  implements java.io.Serializable {
    ...
    public LincnaeId(String cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LincnaeId) ) return false;
		 LincnaeId castOther = ( LincnaeId ) other; 
