...
/**
 * NomdfdtoexId generated by Expand 2.0.1
 */
@Embeddable
public class NomdfdtoexId  implements java.io.Serializable {
    ...
    public NomdfdtoexId(int cdg, int numero, int linea) {
       this.cdg = cdg;
       this.numero = numero;
       this.linea = linea;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NomdfdtoexId) ) return false;
		 NomdfdtoexId castOther = ( NomdfdtoexId ) other; 
