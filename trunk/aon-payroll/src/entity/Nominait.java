...
/**
 * Nominait generated by Expand 2.0.1
 */
@Entity
@Lines(joinProperty="emprper")
@Table(name="nominait")
public class Nominait  implements java.io.Serializable {

     private NominaitId id;
     private Date fecfin;
    ...
    public Nominait(NominaitId id, Date fecfin, String tipoit, int diasit, int diasSs, int diasemp, int diasin, int dias60, int dias75, BigDecimal ptsSs, BigDecimal ptsemp, BigDecimal basecon, BigDecimal baseacc, BigDecimal baseconTotal, BigDecimal baseaccTotal) {
        this.id = id;
        this.fecfin = fecfin;
        this.tipoit = tipoit;
        this.diasit = diasit;
    ...
    public Nominait(NominaitId id, Date fecfin, String tipoit, int diasit, int diasSs, int diasemp, int diasin, int dias60, int dias75, BigDecimal ptsSs, BigDecimal ptsemp, BigDecimal basecon, BigDecimal baseacc, Integer totaldias, String simula, BigDecimal baseconTotal, BigDecimal baseaccTotal, String riesgo, Emprper emprper) {
       this.id = id;
       this.fecfin = fecfin;
       this.tipoit = tipoit;
       this.diasit = diasit;
    ...
    public NominaitId getId() {
        return this.id;
    }
    
    public void setId(NominaitId id) {
        this.id = id;
    }
