...
/**
 * LinocupacionId generated by Expand 2.0.1
 */
@Embeddable
public class LinocupacionId  implements java.io.Serializable {

     private String cdg;
     private Date fecini;

    public LinocupacionId() {
    }

    public LinocupacionId(String cdg, Date fecini) {
       this.cdg = cdg;
       this.fecini = fecini;
    }
	...
	@DataDefinition(label="Inicio de vigencia")
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LinocupacionId) ) return false;
		 LinocupacionId castOther = ( LinocupacionId ) other; 
