...
/**
 * Cuota31Id generated by Expand 2.0.1
 */
@Embeddable
public class Cuota31Id  implements java.io.Serializable {
    ...
    public Cuota31Id(int numTramo, Date fecini) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Cuota31Id) ) return false;
		 Cuota31Id castOther = ( Cuota31Id ) other; 
