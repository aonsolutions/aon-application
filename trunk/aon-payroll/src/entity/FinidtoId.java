...
/**
 * FinidtoId generated by Expand 2.0.1
 */
@Embeddable
public class FinidtoId  implements java.io.Serializable {
    ...
    public FinidtoId(int cdg, int orden) {
       this.cdg = cdg;
       this.orden = orden;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FinidtoId) ) return false;
		 FinidtoId castOther = ( FinidtoId ) other; 
