...
/**
 * Minor31 generated by Expand 2.0.1
 */
@Entity
@Table(name="minor_31")
public class Minor31  implements java.io.Serializable {

     private Minor31Id id;
     private Date fecfin;
    ...
    public Minor31(Minor31Id id, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minGranminus) {
        this.id = id;
    ...
    public Minor31(Minor31Id id, Date fecfin, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minGranminus) {
       this.id = id;
       this.fecfin = fecfin;
       this.desdeImporte = desdeImporte;
       this.hastaImporte = hastaImporte;
    ...
    public Minor31Id getId() {
        return this.id;
    }
    
    public void setId(Minor31Id id) {
        this.id = id;
    }
