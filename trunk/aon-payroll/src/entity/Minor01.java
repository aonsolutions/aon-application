...
@Entity
@Table(name="minor_01")
public class Minor01  implements java.io.Serializable {

     private Minor01Id id;
     private Date fecfin;
    ...
    public Minor01(Minor01Id id, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minAyuda, BigDecimal minGranminus) {
        this.id = id;
    ...
    public Minor01(Minor01Id id, Date fecfin, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal minMinus, BigDecimal minAyuda, BigDecimal minGranminus) {
       this.id = id;
       this.fecfin = fecfin;
       this.desdeImporte = desdeImporte;
       this.hastaImporte = hastaImporte;
    ...
    public Minor01Id getId() {
        return this.id;
    }
    
    public void setId(Minor01Id id) {
        this.id = id;
    }
