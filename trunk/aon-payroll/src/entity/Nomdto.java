...
@Table(name="nomdto")
public class Nomdto  implements java.io.Serializable {
    ...
    public Nomdto(NomdtoId id, String concepto, BigDecimal importe) {
        this.id = id;
        this.concepto = concepto;
        this.importe = importe;
    }

    public Nomdto(NomdtoId id, String concepto, BigDecimal importe, Date fecnew, Date hornew, Date fecmod, Date hormod, Nomina nomina) {
       this.id = id;
       this.concepto = concepto;
       this.importe = importe;
       this.fecnew = fecnew;
