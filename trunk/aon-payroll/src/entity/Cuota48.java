...
/**
 * Cuota48 generated by Expand 2.0.1
 */
@Entity
@Table(name="cuota_48")
public class Cuota48  implements java.io.Serializable {

     private Cuota48Id id;
     private Date fecfin;
    ...
    public Cuota48(Cuota48Id id, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal h0, BigDecimal h1, BigDecimal h2, BigDecimal h3, BigDecimal h4, BigDecimal h5, BigDecimal h6) {
        this.id = id;
    ...
    public Cuota48(Cuota48Id id, Date fecfin, BigDecimal desdeImporte, BigDecimal hastaImporte, BigDecimal h0, BigDecimal h1, BigDecimal h2, BigDecimal h3, BigDecimal h4, BigDecimal h5, BigDecimal h6) {
       this.id = id;
       this.fecfin = fecfin;
       this.desdeImporte = desdeImporte;
       this.hastaImporte = hastaImporte;
    ...
    public Cuota48Id getId() {
        return this.id;
    }
    
    public void setId(Cuota48Id id) {
        this.id = id;
    }
