...
/**
 * Cuota01Id generated by Expand 2.0.1
 */
@Embeddable
public class Cuota01Id  implements java.io.Serializable {
    ...
    public Cuota01Id(int numTramo, Date fecini) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Cuota01Id) ) return false;
		 Cuota01Id castOther = ( Cuota01Id ) other; 
