...
/**
 * NominaitnuId generated by Expand 2.0.1
 */
@Embeddable
public class NominaitnuId  implements java.io.Serializable {
    ...
    public NominaitnuId(int cdg, Date feciniit, Date fecini) {
       this.cdg = cdg;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NominaitnuId) ) return false;
		 NominaitnuId castOther = ( NominaitnuId ) other; 
