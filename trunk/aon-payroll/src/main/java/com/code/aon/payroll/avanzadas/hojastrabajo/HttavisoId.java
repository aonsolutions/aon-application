...
/**
 * HttavisoId generated by Expand 2.0.1
 */
@Embeddable
public class HttavisoId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof HttavisoId) ) return false;
		 HttavisoId castOther = ( HttavisoId ) other; 
