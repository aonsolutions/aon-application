...
/**
 * Transfer Object that represents the FanBatchAttachment.
 * 
 * @author Esferalia
 * @since 1.0
 */
...
public class FanBatchAttachment implements IAttachment, IScopable {
    ...
    /** The attachment type. */
    private FanBatchAttachmentType attachmentType;
    ...
    @ForeignKey(name = "FK_FAN_BATCH_ATTACH_FAN_BATCH")
    @Index(name = "IDX_FAN_BATCH_ATTACH_FAN_BATCH")
	public FanBatch getFanBatch() {
        return this.fanBatch;
    }

    /**
     * Sets the FanBatch.
     * 
     * @param contract the FanBatch
     */
	 ...
	 */
	@Column(name="type")
	public FanBatchAttachmentType getAttachmentType() {
	 ...
	 */
	public void setAttachmentType(FanBatchAttachmentType attachmentType) {
	...
	public boolean equals(Object obj) {
		...
		final FanBatchAttachment o = (FanBatchAttachment) obj;
