...
public class EditDataTableHandler extends AonComponentHandler {
	...
	private static final String TABLE_STYLE_CLASS = "aon-edit-table";
	private static final String HEADER_STYLE_CLASS = "aon-edit-table-header";
	private static final String FOOTER_STYLE_CLASS = "aon-edit-table-footer";
	private static final String ROW_STYLE_CLASSES = "aon-edit-table-row-odd, aon-edit-table-row-even";
