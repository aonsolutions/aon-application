...
public interface IAssetAlias {
	...
	*/
	String  ASSET_ACTIVITY_DATE = ASSET_ACTIVITY_ENTRY.getAliasNames()[1];

	/** 
	* Alias value: AssetActivity_fromTime
	* Hibernate value: AssetActivity.fromTime
	*/
	String  ASSET_ACTIVITY_FROM_TIME = ASSET_ACTIVITY_ENTRY.getAliasNames()[2];

	/** 
	* Alias value: AssetActivity_id
	* Hibernate value: AssetActivity.id
	*/
	String  ASSET_ACTIVITY_ID = ASSET_ACTIVITY_ENTRY.getAliasNames()[3];

	/** 
	* Alias value: AssetActivity_toTime
	* Hibernate value: AssetActivity.toTime
	*/
	String  ASSET_ACTIVITY_TO_TIME = ASSET_ACTIVITY_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: AssetActivity_who
	* Hibernate value: AssetActivity.who
	*/
	String  ASSET_ACTIVITY_WHO = ASSET_ACTIVITY_ENTRY.getAliasNames()[5];

	/** 
	* Alias value: AssetActivity_why
	* Hibernate value: AssetActivity.why
	*/
	String  ASSET_ACTIVITY_WHY = ASSET_ACTIVITY_ENTRY.getAliasNames()[6];
