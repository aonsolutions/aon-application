...
import com.code.aon.ui.infoweb.controller.CompanyController;
...
public class CompanyControllerListener extends ControllerAdapter {
	...
	public void afterBeanSelected(ControllerEvent event) throws ControllerListenerException {
		try {
			...
			String registryIdFieldName = beanMedia.getFieldName( "RegistryMedia_registry_id" );//IRegistryAlias.REGISTRY_MEDIA_REGISTRY_ID);
