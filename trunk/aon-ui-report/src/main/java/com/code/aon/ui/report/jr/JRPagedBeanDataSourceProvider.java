 ...
 * @see com.code.aon.common.IFinderBean#getList(Criteria,int,int)
 */
public class JRPagedBeanDataSourceProvider extends
	...
	public JRDataSource create(JasperReport report) throws JRException {
		try {
			return new JRPagedBeanDataSource(bean, criteria, count);
