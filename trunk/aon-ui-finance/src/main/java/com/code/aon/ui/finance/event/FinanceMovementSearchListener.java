...
public class FinanceMovementSearchListener extends ControllerSearchListener {
	...
	protected void completeCriteria(Criteria criteria) throws ManagerBeanException, ExpressionException {
		if(financeType==1){
			criteria.addEqualExpression(getController().getFieldName(IFinanceAlias.FINANCE_PAYMENT), false);
		}
		if(financeType==2){
			criteria.addEqualExpression(getController().getFieldName(IFinanceAlias.FINANCE_PAYMENT), true);
		}
