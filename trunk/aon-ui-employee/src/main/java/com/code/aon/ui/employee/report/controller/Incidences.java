...
public class Incidences implements ICollectionProvider, IEntityVisitor {
	...
	/*(non-Javadoc)
	 * @see com.code.aon.company.IEntityVisitor#visitEmployee(com.code.aon.company.resources.Employee)
	 */
	...
	/*(non-Javadoc)
	 * @see com.code.aon.company.IEntityVisitor#visitWorkActivity(com.code.aon.company.WorkActivity)
	 */
	...
	/*(non-Javadoc)
	 * @see com.code.aon.company.IEntityVisitor#visitWorkPlace(com.code.aon.company.WorkPlace)
	 */
