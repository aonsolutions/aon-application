...
# Version: 6.19.1
# Created by: girazu
# Creation Date: 06/12/2011 19:20
...
CREATE TABLE `account_period` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `IDX_ACCOUNT_PERIOD_NAME` (`name`)
...
CREATE TABLE `account_entry_detail` (
  ...
  KEY `IDX_ACCOUNT_ENTRY_DETAIL_BAL_ACCOUNT` (`balancing_account`),
  CONSTRAINT `FK_ACCOUNT_ENTRY_DETAIL_ACCOUNT` FOREIGN KEY (`account`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_ACCOUNT_ENTRY_DETAIL_BAL_ACCOUNT` FOREIGN KEY (`balancing_account`) REFERENCES `account` (`id`),
...
CREATE TABLE `account_summary` (
  ...
  `account_period` int(4) NOT NULL COMMENT 'Ejercicio Contable del Acumulado',
  `account` int(4) NOT NULL COMMENT 'Cuenta Contable del Acumulado',
  ...
  PRIMARY KEY  (`id`),
  KEY `IDX_ACCOUNT_SUMMARY_ACCOUNT` (`account`),
  KEY `IDX_ACCOUNT_SUMMARY_ACCOUNT_PERIOD` (`account_period`),
  CONSTRAINT `FK_ACCOUNT_SUMMARY_ACCOUNT_PERIOD` FOREIGN KEY (`account_period`) REFERENCES `account_period` (`id`),
  CONSTRAINT `FK_ACCOUNT_SUMMARY_ACCOUNT` FOREIGN KEY (`account`) REFERENCES `account` (`id`)
...
CREATE TABLE `amortization_type` (
  ...
  PRIMARY KEY  (`id`),
  KEY `IDX_AMORTIZATION_TYPE_FIX_ACCOUNT` (`fixed_asset_account`),
  KEY `IDX_AMORTIZATION_TYPE_ACC_ACCOUNT` (`accumulated_account`),
  KEY `IDX_AMORTIZATION_TYPE_ALL_ACCOUNT` (`allocation_account`),
  CONSTRAINT `FK_AMORTIZATION_TYPE_FIX_ACCOUNT` FOREIGN KEY (`fixed_asset_account`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_AMORTIZATION_TYPE_ACC_ACCOUNT` FOREIGN KEY (`accumulated_account`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_AMORTIZATION_TYPE_ALL_ACCOUNT` FOREIGN KEY (`allocation_account`) REFERENCES `account` (`id`)
...
CREATE TABLE `amortization` (
  ...
  KEY `IDX_AMORTIZATION_FIX_ACCOUNT` (`fixed_asset_account`),
  KEY `IDX_AMORTIZATION_ACC_ACCOUNT` (`accumulated_account`),
  KEY `IDX_AMORTIZATION_ALL_ACCOUNT` (`allocation_account`),
  CONSTRAINT `FK_AMORTIZATION_FIX_ACCOUNT` FOREIGN KEY (`fixed_asset_account`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_AMORTIZATION_ACC_ACCOUNT` FOREIGN KEY (`accumulated_account`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_AMORTIZATION_ALL_ACCOUNT` FOREIGN KEY (`allocation_account`) REFERENCES `account` (`id`),
...
CREATE TABLE `app_param` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `IDX_APP_PARAM_NAME` (`name`)
...
CREATE TABLE `leasing` (
  ...
  `security_level` tinyint(2) default '0' COMMENT 'Nivel de Seguridad',
  `fixed_asset_account` int(4) NOT NULL COMMENT 'Cuenta de inmobilizado',
  `vat` int(4) NOT NULL COMMENT 'IVA del leasing',
  PRIMARY KEY  (`id`),
  KEY `rbank` (`rbank`),
  KEY `IDX_LEASING_FIX_ACCOUNT` (`fixed_asset_account`),
  CONSTRAINT `FK_LEASING_FIX_ACCOUNT` FOREIGN KEY (`fixed_asset_account`) REFERENCES `account` (`id`),
...
CREATE TABLE `leasing_account` (
  ...
  PRIMARY KEY  (`id`),
  KEY `leasing` (`leasing`),
  KEY `IDX_LEASING_ACCOUNT_ACCOUNT` (`account`),
  CONSTRAINT `FK_LEASING_ACCOUNT_ACCOUNT` FOREIGN KEY (`account`) REFERENCES `account` (`id`),
...
INSERT INTO `db_version` (`version_number`) VALUES ('6.19.1');
