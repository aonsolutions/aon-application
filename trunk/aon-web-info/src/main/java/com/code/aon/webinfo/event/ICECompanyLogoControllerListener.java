 ...
 */
public class ICECompanyLogoControllerListener extends ControllerAdapter {
	
	/** The LOGGER. */
	private static final Logger LOGGER = Logger.getLogger(ICECompanyLogoControllerListener.class.getName());
	...
	public void afterBeanSelected(ControllerEvent event) throws ControllerListenerException {
		ICECompanyController companyController = (ICECompanyController)event.getController();
		companyController.setAttach(obtainCompanyLogo(((Company)companyController.getTo()).getId()));
	}
	...
	private RegistryAttachment obtainCompanyLogo(Integer id) {
		try {
		...
		newAttach.setCategory(new Category());
		return newAttach;
	}
}