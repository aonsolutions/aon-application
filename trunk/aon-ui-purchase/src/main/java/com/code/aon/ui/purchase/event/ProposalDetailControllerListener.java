...
public class ProposalDetailControllerListener extends ControllerAdapter {
	...
	public void beforeBeanAdded(ControllerEvent event) throws ControllerListenerException {
		...
		try {
			detail.setSupplier(getSupplier(detail.getItem()));
	...
	private Supplier getSupplier(Item item) throws ManagerBeanException {
		...
		return ((ItemSupplier) list.get(0)).getSupplier();
	}
