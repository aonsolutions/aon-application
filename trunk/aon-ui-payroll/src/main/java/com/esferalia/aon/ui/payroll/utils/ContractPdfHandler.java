...
public class ContractPdfHandler {
	
	private static ContractPdfHandler instance;
	...
	private ContractPdfHandler(){
	}
	
	public static ContractPdfHandler getInstance(){
		if (instance == null) {
			instance = new ContractPdfHandler();
		}
		return instance;
	}
	...
	public List<ContractPdfField> getContractPdfFields() {
...
//	    stamp.setFormFlattening(true);
	...
	private String getBottomCoordinates(AcroFields form, String key){
		return Float.toString(form.getFieldPositions(key)[2]-2);
	}
