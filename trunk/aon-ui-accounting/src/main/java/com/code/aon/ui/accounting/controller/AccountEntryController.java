...
//			setDocumentNumber( aei.getInvoice().getDocumentNumber() );
	...
	public boolean isStatementAvailable() {
		...
		// la opci�n de ir al extracto desde las l�neas de apuntes, porque se  
		// cambiar�a el contenido del controlador del extracto. 
	...
	public String searchAction() {
		try {
			...
			String msg = "No se pudo realizar la b�squeda.";
			AonUtil.addErrorMessage(msg);
