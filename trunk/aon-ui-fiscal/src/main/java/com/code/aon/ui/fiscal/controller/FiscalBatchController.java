...
import com.code.aon.ui.fiscal.controller.batch.FiscalBatchModelFactory;
import com.code.aon.ui.fiscal.controller.batch.IFiscalBatchModel;
...
public class FiscalBatchController extends BasicController {
	...
	private IFiscalBatchModel getBatchModel() {
		FiscalBatch fiscalBatch = (FiscalBatch) getTo();
