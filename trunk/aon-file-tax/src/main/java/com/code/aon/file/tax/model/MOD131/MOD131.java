...
public class MOD131 {
	...
	public List<Exception> create(List<Declaration> declarations, MOD131Format format,PrintWriter writer) {
		...
		try{
			MOD131FactoryManager factoryManger = MOD131FactoryManager.getInstance();
			IMOD131Factory factory = factoryManger.getFactory(format);
			if (factory == null) {
