...
public class Aeat2011MOD115Factory implements IMOD115Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2011MOD115 fileFiller = new Aeat2011MOD115(declarations,pw);
	...
	private class Aeat2011MOD115 extends AbstractFileFiller {
		...
		private static final String DECLARATION_METADATA = "/com/code/aon/file/tax/model/MOD115/2011_AEAT_Declaration.xml";
		
		
		private List<Declaration> declarations;
		
		public Aeat2011MOD115(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
			if (declarations == null || declarations.size() == 0)  {
				throw new IllegalArgumentException("Declaration can not be null!");
			}
			this.declarations = declarations;
			InputStream input = MOD115.class.getResourceAsStream(DECLARATION_METADATA);
