...
public class Aeat2011MOD111Factory implements IMOD111Factory {
	...
	public List<Exception> createDocument(List<Declaration> declarations, Writer out) {
		...
		try {
			Aeat2011MOD111 fileFiller = new Aeat2011MOD111(declarations,pw);
	...
	private class Aeat2011MOD111 extends AbstractFileFiller {
		...
		public Aeat2011MOD111(List<Declaration> declarations, PrintWriter out) throws FileNotFoundException, UnsupportedEncodingException {
			super(out);
