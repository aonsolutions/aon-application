...
public class MOD130 {
	...
	public List<Exception> create(List<Declaration> declarations, MOD130Format format,PrintWriter writer) {
		...
		try{
			MOD130FactoryManager factoryManger = MOD130FactoryManager.getInstance();
			IMOD130Factory factory = factoryManger.getFactory(format);
			if (factory == null) {
