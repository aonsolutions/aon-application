...
public class MOD310 {
	...
	public List<Exception> create(List<Declaration> declarations, MOD310Format format,PrintWriter writer) {
		...
		try{
			MOD310FactoryManager factoryManger = MOD310FactoryManager.getInstance();
			IMOD310Factory factory = factoryManger.getFactory(format);
			if (factory == null) {
