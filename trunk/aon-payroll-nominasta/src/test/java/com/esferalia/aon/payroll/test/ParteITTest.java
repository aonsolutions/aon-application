...
//			List<ITransferObject> list = bean.getList( criteria,0,10 );
			...
			for (ITransferObject to : list ) {
				...
				assertEquals(original.getBaseRetribucionPeriodoAnterior(), duplicado.getBaseRetribucionPeriodoAnterior());
				assertEquals(original.getBaseReguladoraDiaria(), duplicado.getBaseReguladoraDiaria());
				...
				assertEquals(original.getPrestacionDiaria60(), duplicado.getPrestacionDiaria60());
				assertEquals(original.getPrestacionDiaria75(), duplicado.getPrestacionDiaria75());
			}
