...
public interface IPayrollAlias {
	...
	*/
	...
	/** 
	* Alias value: Contrato_irpf
	* Hibernate value: Contrato.irpf
	*/
	String  CONTRATO_IRPF = CONTRATO_ENTRY.getAliasNames()[5];
	...
	*/
	...
	/** 
	* Alias value: Empleado_actividad_id
	* Hibernate value: Empleado.actividad.id
	*/
	String  EMPLEADO_ACTIVIDAD_ID = EMPLEADO_ENTRY.getAliasNames()[5];
	...
	*/
	String  REMESA_CERTIFICADO_EMPRESA_ID = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[0];
	...
	*/
	...
	/** 
	* Alias value: RemesaCertificadoEmpresa_empresa_name
	* Hibernate value: RemesaCertificadoEmpresa.empresa.name
	*/
	String  REMESA_CERTIFICADO_EMPRESA_EMPRESA_NAME = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[2];

	/** 
	* Alias value: RemesaCertificadoEmpresa_estado
	* Hibernate value: RemesaCertificadoEmpresa.estado
	*/
	String  REMESA_CERTIFICADO_EMPRESA_ESTADO = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[3];

	/** 
	* Alias value: RemesaCertificadoEmpresa_fecha
	* Hibernate value: RemesaCertificadoEmpresa.fecha
	*/
	String  REMESA_CERTIFICADO_EMPRESA_FECHA = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: RemesaCertificadoEmpresa_huella
	* Hibernate value: RemesaCertificadoEmpresa.huella
	*/
	String  REMESA_CERTIFICADO_EMPRESA_HUELLA = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[5];

	/** 
	* Alias value: RemesaCertificadoEmpresa_numeroCcc
	* Hibernate value: RemesaCertificadoEmpresa.numeroCcc
	*/
	String  REMESA_CERTIFICADO_EMPRESA_NUMERO_CCC = REMESA_CERTIFICADO_EMPRESA_ENTRY.getAliasNames()[6];
	...
	*/
	...
	/** 
	* Alias value: Trabajo_diasTP
	* Hibernate value: Trabajo.diasTP
	*/
	String  TRABAJO_DIAS_TP = TRABAJO_ENTRY.getAliasNames()[3];

	/** 
	* Alias value: Trabajo_empleado_id
	* Hibernate value: Trabajo.empleado.id
	*/
	String  TRABAJO_EMPLEADO_ID = TRABAJO_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: Trabajo_fecfin
	* Hibernate value: Trabajo.fecfin
	*/
	String  TRABAJO_FECFIN = TRABAJO_ENTRY.getAliasNames()[5];

	/** 
	* Alias value: Trabajo_fechaFinCont
	* Hibernate value: Trabajo.fechaFinCont
	*/
	String  TRABAJO_FECHA_FIN_CONT = TRABAJO_ENTRY.getAliasNames()[6];

	/** 
	* Alias value: Trabajo_fechaInicioCont
	* Hibernate value: Trabajo.fechaInicioCont
	*/
	String  TRABAJO_FECHA_INICIO_CONT = TRABAJO_ENTRY.getAliasNames()[7];

	/** 
	* Alias value: Trabajo_id_cdg
	* Hibernate value: Trabajo.id.cdg
	*/
	String  TRABAJO_ID_CDG = TRABAJO_ENTRY.getAliasNames()[8];

	/** 
	* Alias value: Trabajo_id_fecini
	* Hibernate value: Trabajo.id.fecini
	*/
	String  TRABAJO_ID_FECINI = TRABAJO_ENTRY.getAliasNames()[9];

	/** 
	* Alias value: Trabajo_tiempoContrato
	* Hibernate value: Trabajo.tiempoContrato
	*/
	String  TRABAJO_TIEMPO_CONTRATO = TRABAJO_ENTRY.getAliasNames()[10];

	/** 
	* Alias value: Trabajo_tipoTP
	* Hibernate value: Trabajo.tipoTP
	*/
	String  TRABAJO_TIPO_TP = TRABAJO_ENTRY.getAliasNames()[11];
