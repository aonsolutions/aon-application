...
public interface IGBPAlias {
	...
	*/
	String  CAMPAIGN_SUPPLIER_ID = CAMPAIGN_SUPPLIER_ENTRY.getAliasNames()[3];

	/** 
	* Alias value: CampaignSupplier_supplier_id
	* Hibernate value: CampaignSupplier.supplier.id
	*/
	String  CAMPAIGN_SUPPLIER_SUPPLIER_ID = CAMPAIGN_SUPPLIER_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: CampaignSupplier_supplier_name
	* Hibernate value: CampaignSupplier.supplier.name
	*/
	String  CAMPAIGN_SUPPLIER_SUPPLIER_NAME = CAMPAIGN_SUPPLIER_ENTRY.getAliasNames()[5];
