...
public class EnterpriseDocumentController extends BasicController implements IAttachmentController, IEnterpriseController {
	...
	public IManagerBean getManagerBean() throws ManagerBeanException {
		if ( this.alfrescoManagerBean == null ) {
			...
			this.alfrescoDAO = new EnterpriseDocumentDAO(mc.getAlfrescoUser(), mc.getAlfrescoPassword(), acc.getAlfrescoDAO(), mc.getUserManager());	
			ParentReference reference = null;
			if ( mc.isMainEnterprise() ) {
				reference = this.alfrescoDAO.getRootReference();
			} else {
				reference = this.alfrescoDAO.getEnterpriseReference(mc.getEnterprise());
			}
