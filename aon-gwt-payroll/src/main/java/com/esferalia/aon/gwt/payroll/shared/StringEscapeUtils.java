...
public class StringEscapeUtils {
	...
	private static final Map<String, String> ISO8859_1_ESCAPE_MAP = new HashMap<>();
    private static final Map<String, String> HTML40_EXTENDED_ESCAPE_MAP = new HashMap<>();

    static {
        String[][] ISO8859_1_ESCAPE = {
            {"\u00A0", "&nbsp;"}, {"\u00A1", "&iexcl;"}, {"\u00A2", "&cent;"}, {"\u00A3", "&pound;"},
        ...
        for (String[] escape : ISO8859_1_ESCAPE) {
            ISO8859_1_ESCAPE_MAP.put(escape[0], escape[1]);
        }

        for (String[] escape : HTML40_EXTENDED_ESCAPE) {
            HTML40_EXTENDED_ESCAPE_MAP.put(escape[0], escape[1]);
        }
    }
	...
	public static String escapeHtml(String input){
        ...
        for (char c : input.toCharArray()) {
            ...
            if (ISO8859_1_ESCAPE_MAP.containsKey(charAsString)) {
                escapedString.append(ISO8859_1_ESCAPE_MAP.get(charAsString));
            } else if (HTML40_EXTENDED_ESCAPE_MAP.containsKey(charAsString)) {
                escapedString.append(HTML40_EXTENDED_ESCAPE_MAP.get(charAsString));
            } else {
