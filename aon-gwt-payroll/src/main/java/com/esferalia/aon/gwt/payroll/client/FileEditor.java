...
public class FileEditor extends ResizeComposite {
	...
	@UiField CodeArea codeArea;

	@UiField MenuItem saveMenuItem;
	...
	private void save() {
		...
		anchor.setHref("data:text/" + ext +";charset=utf-8" + "," +URL.encode(codeArea.getText()));
		
		Window.alert(anchor.getHref());
