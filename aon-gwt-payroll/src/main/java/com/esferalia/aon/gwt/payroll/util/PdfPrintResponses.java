...
public class PdfPrintResponses {
	...
	private final static String PDF_ICON = 
		"<svg style='max-width:100px' version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"" + 
			...
			"<path style=\"fill:#F15642;\" d=\"M416,416c0,8.8-7.2,16-16,16H48c-8.8,0-16-7.2-16-16V256c0-8.8,7.2-16,16-16h352c8.8,0,16,7.2,16,16 V416z\"/>" + 
				"<g> <path style=\"fill:#FFFFFF;\" d=\"M101.744,303.152c0-4.224,3.328-8.832,8.688-8.832h29.552c16.64,0,31.616,11.136,31.616,32.48" + 
			...
			"</g> <path style=\"fill:#CAD1D8;\" d=\"M400,432H96v16h304c8.8,0,16-7.2,16-16v-16C416,424.8,408.8,432,400,432z\"/>" + 
	...
	public static String pdfPrintError(String msg) {
		return 
		"<html>" + 
			"<script>window.onload = () => document.body.style.opacity = '1';</script>" + CSS +
