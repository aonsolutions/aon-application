...
public class EnterpriseITObject {
	...
	public void sendEconomicData(ITEmployee itEmployee, IT it, ITPart part, Consumer<Void> success, Consumer<Throwable> failure) {
		impl.sendEconomicData(itEmployee, it, part, new AsyncCallback<Void>() {
