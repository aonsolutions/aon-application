...
import com.esferalia.aon.gwt.payroll.client.Employee.EmployeeDraftUiBinder;
...
//	interface Binder extends UiBinder<Widget, ContrataEmployeeDialog> {}
//	
...
//		setWidget(binder.createAndBindUi(this));
		...
		scrolledPanel.setHeight((height-160)+"px");
