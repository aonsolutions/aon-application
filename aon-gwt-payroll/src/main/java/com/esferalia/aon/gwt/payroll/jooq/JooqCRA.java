...
public class JooqCRA {
	...
	public static Period getMinMaxCraDate(Integer domainId, Integer userId, Connection connection) {
		...
		Date craMinDate = contractMinDateRecord.value1().before(craMinDateRecord.value1()) ? contractMinDateRecord.value1() : craMinDateRecord.value1();
		...
		Date craMaxDate = contractMaxDateRecord.value1().after(craMaxDateRecord.value1()) ? contractMaxDateRecord.value1() : craMaxDateRecord.value1();
