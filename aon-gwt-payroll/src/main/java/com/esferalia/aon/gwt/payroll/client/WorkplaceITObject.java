...
public class WorkplaceITObject {
	...
	public WorkplaceITObject(Integer workplaceId) {
		super();
	...
	public void getEmployeesInfo(Boolean allEmployees, Consumer<List<ITEmployee>> success, Consumer<Throwable> failure){
		...
		impl.getWorkplaceEmployeeITInfo(allEmployees, this.workplaceId, new AsyncCallback<List<ITEmployee>>() {
	...
	public void sendEconomicData(ITEmployee itEmployee, IT it, ITPart itPart, Consumer<Void> success, Consumer<Throwable> failure) {
