...
//		}
	...
	private static com.esferalia.aon.payroll.Salary getDBSalary(Connection connection, SalaryDraft salaryDraft)
		...
		java.sql.Date sqlChargeDate = new java.sql.Date(salaryDraft.getChargeDate().getTime());
		...
		if (salaryDraft.getType() == Salary.Type.DELAY)
			condition = condition.and(com.esferalia.aon.jooq.tables.Salary.SALARY.CHARGE_DATE.eq(sqlChargeDate));
...
//							.get(0));
	...
	public void generateCertifaca2(String domainName, String userLogin, Integer contractId) throws IllegalArgumentException {
		try (Connection connection = AonServletUtils.getConnection(domainName)) {
			Integer domainId = AonServletUtils.getDomainID(domainName);
			JooqCertifica2.createCertifica2DB(connection, domainName, userLogin, domainId, contractId, null, null, null);
		} catch (Exception e) {
			throw new IllegalArgumentException(e);
		}
	}
	...
	public void generateCertifaca2(String domainName, String userLogin, Integer contractId, Certifica2Info certifica2Info)
		...
		try (Connection connection = AonServletUtils.getConnection(domainName)) {
			...
			JooqCertifica2.createCertifica2DB(connection, domainName, userLogin, domainId, contractId, certifica2Info.getSuspensionCode(), certifica2Info.getErteCode(), certifica2Info.getErteEnd());
		} catch (Exception e) {
			throw new IllegalArgumentException(e);
		}
	}
...
//			System.out.println(employeeAux.getNss());
	...
	public void sendCertifica2(String domainName, String userLogin, Integer contractId, Certifica2Info certifica2Info) throws IllegalArgumentException {
		try (Connection connection = AonServletUtils.getConnection(domainName)) {
			...
			// Create certificates
			Certificates certificates = JooqCertifica2.createCertificates(connection, domainName, userLogin, contractId, certifica2Info.getSuspensionCode(), certifica2Info.getErteCode(), certifica2Info.getErteEnd());
	...
	public Certifica2Info getCertifica2Info(String domainName, String userLogin, Integer contractId) throws IllegalArgumentException {
		try (Connection connection = AonServletUtils.getConnection(domainName)) {
			Certifica2Info certifica2Info = JooqCertifica2.getCertifica2Info(connection, domainName, userLogin, contractId, null, null, null);
