...
public interface EmployeesServiceAsync extends AgreementServiceAsync, StatisticsServiceAsync,
	...
	void getEmployeeCbc(String currentDomainName, String currentUser, String document, Integer contractId, Date startDate, Date endDate, String sepeIde, String enterpriseCif, AsyncCallback<String> callback) throws IllegalArgumentException;
	...
	void getEmployeeCto(String currentDomainName, String currentUser, String cif, String document, Integer contractId, Date startDate, Date endDate, String sepeIde, AsyncCallback<String> callback) throws IllegalArgumentException;
