...
@WebServlet(name = "Settle-vallhala", 
	urlPatterns = { 
			"/aon_gwt_aio/vallhala/*",
			"/aon_gwt_payroll/vallhala/*" 
	})
public class SettlePrintServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(req.getParameter(PayrollPrintService.Parameter.ID.getName()) == null || true) {
			error(resp, out);
			return;
		}
		...
		} catch (CanNotCreatePdfException e) {error(resp,out);}
	}
