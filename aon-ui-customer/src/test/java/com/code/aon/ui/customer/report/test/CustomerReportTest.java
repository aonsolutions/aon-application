...
public class CustomerReportTest extends AbsReportPrintTest{

	/*
	<report id="customerReport" description="Customer report ">
		<template path="/com/code/aon/ui/registry/report/masterRegistryList.jasper" />
 ...
 */
	...
	private final String TEMPLATE = "/com/code/aon/ui/registry/report/masterRegistryList.jasper";
	...
	protected InputStream getReportTemplate() {
		InputStream in = CustomerReportTest.class.getResourceAsStream(TEMPLATE );  
		return in;
	}
