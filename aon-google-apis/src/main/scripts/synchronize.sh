...
case $COMMAND in
calendar) java -classpath $CLASSPATH com.code.aon.google.apis.CalendarUtils ;;
dsync) java -classpath $CLASSPATH com.code.aon.google.apis.DriveUtils ${*:2} ;;
ddelete) java -classpath $CLASSPATH com.code.aon.google.apis.drive.DeleteFiles ${*:2} ;;
dsearch) java -classpath $CLASSPATH com.code.aon.google.apis.drive.SearchFiles ${*:2};;
help) echo "	calendar 	Sincronizar agenda comercial con Google Calendaar.
	dsync		Sincronizar arhivos con Google Drive.
	ddelete		Borrar archivos de Google Drive.
	dsearch		Buscar archivos de Google Drive.
 	help		Ayuda." ;; 
