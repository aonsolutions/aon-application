#/bin/sh
#
# aon-rattach     This shell script takes care of manage rattach
#
...
case $1 in
  help)
  	...
  	echo "aon Rattach command-line client."
  ...
  upsize) 
	java -classpath $CLASSPATH com.code.aon.google.apis.rattach.UpSize ${*:2}
	;;
