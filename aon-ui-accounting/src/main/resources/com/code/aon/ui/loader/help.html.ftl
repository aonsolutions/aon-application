...
<#if factory.getKey() != "ASI" && factory.getKey() != "EMP" && factory.getKey() != "AMC" && factory.getKey() != "AML" && factory.getKey() != "MOC" && factory.getKey() != "MOL" && factory.getKey() != "BAN" && factory.getKey() != "REP" && factory.getKey() != "CON" && factory.getKey() != "CUO">
<tr>
