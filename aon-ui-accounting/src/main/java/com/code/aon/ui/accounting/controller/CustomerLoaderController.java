...
import com.code.aon.ui.accounting.invoice.CustomerLoaderManager;
import com.code.aon.ui.util.AonUtil;

public class CustomerLoaderController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(CustomerLoaderController.class.getName());
	...
	public void onLoad(ActionEvent event ) {
		...
		try {
			...
			CustomerLoaderManager m = new CustomerLoaderManager(getScope(),sl,getWorkPlace(), getLog() );
			...
			String msg = "Error recuperando clientes. " + e.getMessage();
			LOGGER.error(msg, e);
