...
import com.code.aon.ui.accounting.invoice.InvoiceLoaderManager;
import com.code.aon.ui.util.AonUtil;

public class InvoiceLoaderController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(InvoiceLoaderController.class.getName());
	...
	public void onLoad(ActionEvent event ) {
		...
		try {
			...
			InvoiceLoaderManager m = new InvoiceLoaderManager(getScope(),sl,getWorkPlace(), getCategory(), getLog() );
