...
import com.code.aon.ui.accounting.invoice.FinanceLoaderManager;
import com.code.aon.ui.util.AonUtil;

public class FinanceLoaderController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(FinanceLoaderController.class.getName());
	...
	public void onLoad(ActionEvent event ) {
		...
		try {
			...
			FinanceLoaderManager m = new FinanceLoaderManager(getScope(),sl,getWorkPlace(), getLog() );
