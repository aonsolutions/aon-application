...
public class Aeat2013Mod131Calculator extends FiscalModelDetailCalculator implements IMod131Calculator {
	...
	public void calculate(Mod131 mod131) throws AonException {
		...
		double c09 = mod131.getDetail( Mod131Key.C09 ).getAmount();
