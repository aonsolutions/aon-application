...
public enum VatTaxKey implements IResourceable, IStringEnum   {
	...
	A4	("A4"	,false	,false	,true	,false	,true	,false	,null,null),
	// A5=MODIFICACION BASES Y CUOTAS
	A5	("A5"	,false	,false	,true	,false	,true	,false	,null,null),
	// AT=TOTAL DEVENGADO
	...
	// FT=TOTAL A DEDUCIR
	FT	("FT"	,false	,false	,true	,false	,true	,true	,new VatTaxKey[]{VatTaxKey.BT,VatTaxKey.CT,VatTaxKey.DT,VatTaxKey.ET},null),
	// DF=DIFERENCIA
