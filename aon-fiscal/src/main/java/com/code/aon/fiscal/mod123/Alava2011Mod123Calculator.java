...
public class Alava2011Mod123Calculator extends FiscalModelDetailCalculator implements IMod123Calculator {
	...
	public void calculate(Mod123 mod123) throws AonException {
		...
		double c11 = mod123.getDetail( Mod123Key.C11 ).getAmount();
