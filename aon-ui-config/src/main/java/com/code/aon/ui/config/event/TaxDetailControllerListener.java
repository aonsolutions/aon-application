...
public class TaxDetailControllerListener extends ControllerAdapter {
	...
	public void beforeBeanUpdated(ControllerEvent event) throws ControllerListenerException {
		...
		try {
			...
			criteria.addEqualExpression(taxBean.getFieldName(IConfigAlias.TAX_ID), taxDetail.getTax().getId());
			criteria.addLessThanOrEqualExpression(taxBean.getFieldName(IConfigAlias.TAX_START_DATE), taxDetail.getEndDate());
