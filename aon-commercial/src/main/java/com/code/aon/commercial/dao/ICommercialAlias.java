...
public interface ICommercialAlias {
	...
	*/
	...
	/** 
	* Alias value: CommissionTypeCommission_commission_startDate
	* Hibernate value: CommissionTypeCommission.commission.startDate
	*/
	String  COMMISSION_TYPE_COMMISSION_COMMISSION_START_DATE = COMMISSION_TYPE_COMMISSION_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: CommissionTypeCommission_commission_endDate
	* Hibernate value: CommissionTypeCommission.commission.endDate
	*/
	String  COMMISSION_TYPE_COMMISSION_COMMISSION_END_DATE = COMMISSION_TYPE_COMMISSION_ENTRY.getAliasNames()[5];
	...
	*/
	...
	/** 
	* Alias value: Offer_externalReference
	* Hibernate value: Offer.externalReference
	*/
	String  OFFER_EXTERNAL_REFERENCE = OFFER_ENTRY.getAliasNames()[7];
	...
	*/
	String  OFFER_ISSUE_DATE = OFFER_ENTRY.getAliasNames()[9];

	/** 
	* Alias value: Offer_number
	* Hibernate value: Offer.number
	*/
	String  OFFER_NUMBER = OFFER_ENTRY.getAliasNames()[10];

	/** 
	* Alias value: Offer_numberOfPayments
	* Hibernate value: Offer.numberOfPayments
	*/
	String  OFFER_NUMBER_OF_PAYMENTS = OFFER_ENTRY.getAliasNames()[11];

	/** 
	* Alias value: Offer_payMethod_id
	* Hibernate value: Offer.payMethod.id
	*/
	String  OFFER_PAY_METHOD_ID = OFFER_ENTRY.getAliasNames()[12];
	...
	*/
	...
	/** 
	* Alias value: Offer_remarks
	* Hibernate value: Offer.remarks
	*/
	String  OFFER_REMARKS = OFFER_ENTRY.getAliasNames()[15];

	/** 
	* Alias value: Offer_scope_id
	* Hibernate value: Offer.scope.id
	*/
	String  OFFER_SCOPE_ID = OFFER_ENTRY.getAliasNames()[16];

	/** 
	* Alias value: Offer_securityLevel
	* Hibernate value: Offer.securityLevel
	*/
	String  OFFER_SECURITY_LEVEL = OFFER_ENTRY.getAliasNames()[17];

	/** 
	* Alias value: Offer_seller_id
	* Hibernate value: Offer.seller.id
	*/
	String  OFFER_SELLER_ID = OFFER_ENTRY.getAliasNames()[18];

	/** 
	* Alias value: Offer_series
	* Hibernate value: Offer.series
	*/
	String  OFFER_SERIES = OFFER_ENTRY.getAliasNames()[19];

	/** 
	* Alias value: Offer_signed
	* Hibernate value: Offer.signed
	*/
	String  OFFER_SIGNED = OFFER_ENTRY.getAliasNames()[20];

	/** 
	* Alias value: Offer_status
	* Hibernate value: Offer.status
	*/
	String  OFFER_STATUS = OFFER_ENTRY.getAliasNames()[21];

	/** 
	* Alias value: Offer_supplier_id
	* Hibernate value: Offer.supplier.id
	*/
	String  OFFER_SUPPLIER_ID = OFFER_ENTRY.getAliasNames()[22];

	/** 
	* Alias value: Offer_target_id
	* Hibernate value: Offer.target.id
	*/
	String  OFFER_TARGET_ID = OFFER_ENTRY.getAliasNames()[23];

	/** 
	* Alias value: Offer_tariff_id
	* Hibernate value: Offer.tariff.id
	*/
	String  OFFER_TARIFF_ID = OFFER_ENTRY.getAliasNames()[24];

	/** 
	* Alias value: Offer_type
	* Hibernate value: Offer.type
	*/
	String  OFFER_TYPE = OFFER_ENTRY.getAliasNames()[25];

	/** 
	* Alias value: Offer_version
	* Hibernate value: Offer.version
	*/
	String  OFFER_VERSION = OFFER_ENTRY.getAliasNames()[26];

	/** 
	* Alias value: Offer_workPlace_id
	* Hibernate value: Offer.workPlace.id
	*/
	String  OFFER_WORK_PLACE_ID = OFFER_ENTRY.getAliasNames()[27];
	...
	*/
	...
	/** 
	* Alias value: OfferDetail_offer
	* Hibernate value: OfferDetail.offer
	*/
	String  OFFER_DETAIL_OFFER = OFFER_DETAIL_ENTRY.getAliasNames()[1];

	/** 
	* Alias value: OfferDetail_offer_id
	* Hibernate value: OfferDetail.offer.id
	*/
	String  OFFER_DETAIL_OFFER_ID = OFFER_DETAIL_ENTRY.getAliasNames()[2];

	/** 
	* Alias value: OfferDetail_offer_target_id
	* Hibernate value: OfferDetail.offer.target.id
	*/
	String  OFFER_DETAIL_OFFER_TARGET_ID = OFFER_DETAIL_ENTRY.getAliasNames()[3];

	/** 
	* Alias value: OfferDetail_offer_issueDate
	* Hibernate value: OfferDetail.offer.issueDate
	*/
	String  OFFER_DETAIL_OFFER_ISSUE_DATE = OFFER_DETAIL_ENTRY.getAliasNames()[4];

	/** 
	* Alias value: OfferDetail_offer_address_geozone_id
	* Hibernate value: OfferDetail.offer.address.geozone.id
	*/
	String  OFFER_DETAIL_OFFER_ADDRESS_GEOZONE_ID = OFFER_DETAIL_ENTRY.getAliasNames()[5];

	/** 
	* Alias value: OfferDetail_offer_series
	* Hibernate value: OfferDetail.offer.series
	*/
	String  OFFER_DETAIL_OFFER_SERIES = OFFER_DETAIL_ENTRY.getAliasNames()[6];

	/** 
	* Alias value: OfferDetail_offer_number
	* Hibernate value: OfferDetail.offer.number
	*/
	String  OFFER_DETAIL_OFFER_NUMBER = OFFER_DETAIL_ENTRY.getAliasNames()[7];

	/** 
	* Alias value: OfferDetail_offer_seller_id
	* Hibernate value: OfferDetail.offer.seller.id
	*/
	String  OFFER_DETAIL_OFFER_SELLER_ID = OFFER_DETAIL_ENTRY.getAliasNames()[8];

	/** 
	* Alias value: OfferDetail_offer_securityLevel
	* Hibernate value: OfferDetail.offer.securityLevel
	*/
	String  OFFER_DETAIL_OFFER_SECURITY_LEVEL = OFFER_DETAIL_ENTRY.getAliasNames()[9];

	/** 
	* Alias value: OfferDetail_offer_status
	* Hibernate value: OfferDetail.offer.status
	*/
	String  OFFER_DETAIL_OFFER_STATUS = OFFER_DETAIL_ENTRY.getAliasNames()[10];

	/** 
	* Alias value: OfferDetail_offer_workPlace_id
	* Hibernate value: OfferDetail.offer.workPlace.id
	*/
	String  OFFER_DETAIL_OFFER_WORK_PLACE_ID = OFFER_DETAIL_ENTRY.getAliasNames()[11];

	/** 
	* Alias value: OfferDetail_line
	* Hibernate value: OfferDetail.line
	*/
	String  OFFER_DETAIL_LINE = OFFER_DETAIL_ENTRY.getAliasNames()[12];

	/** 
	* Alias value: OfferDetail_item_id
	* Hibernate value: OfferDetail.item.id
	*/
	String  OFFER_DETAIL_ITEM_ID = OFFER_DETAIL_ENTRY.getAliasNames()[13];

	/** 
	* Alias value: OfferDetail_item_product_product_category_id
	* Hibernate value: OfferDetail.item.product.category.id
	*/
	String  OFFER_DETAIL_ITEM_PRODUCT_PRODUCT_CATEGORY_ID = OFFER_DETAIL_ENTRY.getAliasNames()[14];

	/** 
	* Alias value: OfferDetail_item_product_type
	* Hibernate value: OfferDetail.item.product.type
	*/
	String  OFFER_DETAIL_ITEM_PRODUCT_TYPE = OFFER_DETAIL_ENTRY.getAliasNames()[15];

	/** 
	* Alias value: OfferDetail_description
	* Hibernate value: OfferDetail.description
	*/
	String  OFFER_DETAIL_DESCRIPTION = OFFER_DETAIL_ENTRY.getAliasNames()[16];

	/** 
	* Alias value: OfferDetail_quantity
	* Hibernate value: OfferDetail.quantity
	*/
	String  OFFER_DETAIL_QUANTITY = OFFER_DETAIL_ENTRY.getAliasNames()[17];

	/** 
	* Alias value: OfferDetail_price
	* Hibernate value: OfferDetail.price
	*/
	String  OFFER_DETAIL_PRICE = OFFER_DETAIL_ENTRY.getAliasNames()[18];

	/** 
	* Alias value: OfferDetail_discountExpression
	* Hibernate value: OfferDetail.discountExpression
	*/
	String  OFFER_DETAIL_DISCOUNT_EXPRESSION = OFFER_DETAIL_ENTRY.getAliasNames()[19];

	/** 
	* Alias value: OfferDetail_status
	* Hibernate value: OfferDetail.status
	*/
	String  OFFER_DETAIL_STATUS = OFFER_DETAIL_ENTRY.getAliasNames()[20];
	...
	*/
	String  OFFER_DETAIL_COMMISSION_OFFER_DETAIL_OFFER_WORK_PLACE_ID = OFFER_DETAIL_COMMISSION_ENTRY.getAliasNames()[20];
