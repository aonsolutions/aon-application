  function UpdateMessageLength() {
  	var messageBox = document.getElementById( 'aonContent:smsForm:SMS_message' );
    ...
    if ( currentCount < 161 ) {
	    ...
	    document.getElementById( 'aonContent:smsForm:messageLength' ).value = countDescription.replace('{0}', currentCount);
	} else {
