...
public class SepeException extends Exception {
	...
	public static final Map<Integer, ThrowSepeException> HTTP_MAP =
	new HashMap<Integer, ThrowSepeException>() {
		{
	...
	public static void throwSepeException(FailingHttpStatusCodeException e) throws SepeException{
		HTTP_MAP.getOrDefault(e.getStatusCode(), ex -> {throw new SepeException(ex); }).throwSepeException(e);
	}
