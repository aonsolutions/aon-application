...
public class Sepe {
	...
	public static byte[] getTransformationPdf(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, String ipf, String cif, Date fini)
			throws SepeException {
		return Contrata.getTransformationPdf(certificateInputStream, certificatePassword, certificateType, ipf, cif,
				fini, Optional.empty());
	}
	...
	public static byte[] getContractExtensionPdf(final InputStream certificateInputStream,
			...
			Date oldDateIniContract, Integer nprorroga, String sepeId) throws SepeException {
		return Contrata.getContractExtensionPdf(certificateInputStream, certificatePassword, certificateType, ipf, cif,
				oldDateIniContract, nprorroga, Optional.ofNullable(sepeId));
	}

	public static byte[] getTransformationCopyBasicPdf(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, String ipf, String cif, Date fini)
			throws SepeException {
		return Contrata.getTransformationCopyBasicPdf(certificateInputStream, certificatePassword, certificateType, ipf,
				cif, fini, Optional.empty());
	}
	...
	public static byte[] getTransformationPdf(final InputStream certificateInputStream,
		...
		return Contrata.getTransformationPdf(certificateInputStream, certificatePassword, certificateType, null, null,
				null, Optional.ofNullable(sepeId));
	}

	public static byte[] getTransformationCopyBasicPdf(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, String sepeId) throws SepeException {
		return Contrata.getTransformationCopyBasicPdf(certificateInputStream, certificatePassword, certificateType,
				null, null, null, Optional.ofNullable(sepeId));
	}
	...
	public static byte[] certEnterprisePdf(final InputStream certificateInputStream, final String certificatePassword,
		...
		return Certificado.getCertEnterprisePdf(certificateInputStream, certificatePassword, certificateType, nif,
				fecha);
	}
	...
	public static byte[] certEnterprise(final InputStream certificateInputStream, final String certificatePassword,
		...
		return Certificado.sendCertEnterprise(certificateInputStream, certificatePassword, certificateType,
				certificates);
	}
	...
	public static String sendTransformationCopyBasic(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, String ipf, Date fini, Date fend,
			CopyBasic.FirmType firmType, String workAddress, String restContract, String cif, Date startDateContract)
			throws SepeException {
		CopyBasic copyBasic = new CopyBasic().setIpf(ipf).setFini(fini).setFend(fend).setFirmType(firmType)
				.setWorkAddress(workAddress).setRestContract(restContract);
		return sendTransformationCopyBasic(certificateInputStream, certificatePassword, certificateType, copyBasic, cif,
				startDateContract);
	}

	public static String sendTransformationCopyBasic(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, CopyBasic copyBasic, String cif,
			Date startDateContract) throws SepeException {
		return Contrata.sendTransformationCopyBasic(certificateInputStream, certificatePassword, certificateType,
				copyBasic, cif, startDateContract);
	}
	...
	public static Contract getTransformationData(final InputStream certificateInputStream,
		...
		return Contrata.getTransformationData(certificateInputStream, certificatePassword, certificateType, ipf, cif,
	...
	public static Contract getContractExtensionData(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, String ipf, String cif,
			Date oldDateIniContract, Optional<String> sepeId) throws SepeException {
		return Contrata.getContractExtensionData(certificateInputStream, certificatePassword, certificateType, ipf, cif,
				oldDateIniContract, sepeId);
	}
	 ...
	 * @throws SepeException
	 */
	public static String sendContractExtension(final InputStream certificateInputStream,
			final String certificatePassword, final String certificateType, ContractExtension contractExtension)
			throws SepeException {
		return Contrata.sendContrataExtension(certificateInputStream, certificatePassword, certificateType,
				contractExtension);
	}
